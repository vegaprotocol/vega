...
type MarketData struct {
	...
	BestStaticOfferPrice uint64 `protobuf:"varint,7,opt,name=bestStaticOfferPrice,proto3" json:"bestStaticOfferPrice,omitempty"`
	// Arithmetic average of the best bid price and best offer price, as an integer, for example `123456` is a correctly
	//  // formatted price of `1.23456` assuming market configured to 5 decimal places.
	MidPrice uint64 `protobuf:"varint,8,opt,name=midPrice,proto3" json:"midPrice,omitempty"`
	...
	OpenInterest uint64 `protobuf:"varint,11,opt,name=openInterest,proto3" json:"openInterest,omitempty"`
	// Time in seconds until the end of the auction (0 if currently not in auction period).
	AuctionEnd int64 `protobuf:"varint,12,opt,name=auctionEnd,proto3" json:"auctionEnd,omitempty"`
	// Time until next auction (used in FBA's) - currently always 0.
	AuctionStart int64 `protobuf:"varint,13,opt,name=auctionStart,proto3" json:"auctionStart,omitempty"`
	// indicative price (zero if not in auction)
	IndicativePrice uint64 `protobuf:"varint,14,opt,name=indicativePrice,proto3" json:"indicativePrice,omitempty"`
	// indicative volume (zero if not in auction)
	IndicativeVolume uint64 `protobuf:"varint,15,opt,name=indicativeVolume,proto3" json:"indicativeVolume,omitempty"`
	// the current state of the market
	MarketState MarketState `protobuf:"varint,16,opt,name=marketState,proto3,enum=vega.MarketState" json:"marketState,omitempty"`
	// if the market is in auction state, this field indicates what triggered the auction
	Trigger AuctionTrigger `protobuf:"varint,17,opt,name=trigger,proto3,enum=vega.AuctionTrigger" json:"trigger,omitempty"`
	// the targeted stake for the given market
	TargetStake string `protobuf:"bytes,18,opt,name=targetStake,proto3" json:"targetStake,omitempty"`
	// the available stake fo the given market
	SuppliedStake        string   `protobuf:"bytes,19,opt,name=suppliedStake,proto3" json:"suppliedStake,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
var fileDescriptor_bb6b8173ee11af27 = []byte{
	...
	,
	...
	0x58, 0x47, 0x96, 0xab, 0x15, 0xc8, 0x65, 0xa8, 0xf1, 0xf6, 0x91, 0x41, 0x0f, 0x4d, 0xfc, 0xa4,
	...
	0xc4, 0x2b, 0x70, 0x49, 0xd2, 0x8c, 0xa6, 0x6b, 0x3d, 0x36, 0xb5, 0x82, 0x02, 0x33, 0x7f, 0xd0,
	...
	,
}
