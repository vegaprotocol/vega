...
var file_vega_events_v1_events_proto_rawDesc = []byte{
	...
	0x22, 0xaf, 0x12, 0x0a, 0x11, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e,
	...
	0x6f, 0x6e, 0x12, 0x4d, 0x0a, 0x07, 0x73, 0x75, 0x63, 0x63, 0x65, 0x73, 0x73, 0x18, 0xe9, 0x07,
	...
	0x6f, 0x6c, 0x55, 0x70, 0x67, 0x72, 0x61, 0x64, 0x65, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x22, 0xa9,
	0x23, 0x0a, 0x08, 0x42, 0x75, 0x73, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x12, 0x0e, 0x0a, 0x02, 0x69,
	...
	0x61, 0x74, 0x61, 0x50, 0x6f, 0x69, 0x6e, 0x74, 0x12, 0x36, 0x0a, 0x06, 0x6d, 0x61, 0x72, 0x6b,
	...
	0x68, 0x42, 0x07, 0x0a, 0x05, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x22, 0x49, 0x0a, 0x0d, 0x45, 0x78,
	...
	0x65, 0x72, 0x49, 0x64, 0x73, 0x2a, 0xdd, 0x01, 0x0a, 0x1d, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x63,
	...
	0x54, 0x45, 0x44, 0x10, 0x03, 0x2a, 0x8b, 0x12, 0x0a, 0x0c, 0x42, 0x75, 0x73, 0x45, 0x76, 0x65,
	...
	0x54, 0x41, 0x5f, 0x50, 0x4f, 0x49, 0x4e, 0x54, 0x10, 0x3e, 0x12, 0x19, 0x0a, 0x15, 0x42, 0x55,
...
var file_vega_events_v1_events_proto_depIdxs = []int32{
	...
	56,  // 38: vega.events.v1.TransactionResult.success:type_name -> vega.events.v1.TransactionResult.SuccessDetails
	57,  // 39: vega.events.v1.TransactionResult.failure:type_name -> vega.events.v1.TransactionResult.FailureDetails
	58,  // 40: vega.events.v1.TxErrorEvent.order_submission:type_name -> vega.commands.v1.OrderSubmission
	62,  // 41: vega.events.v1.TxErrorEvent.order_amendment:type_name -> vega.commands.v1.OrderAmendment
	63,  // 42: vega.events.v1.TxErrorEvent.order_cancellation:type_name -> vega.commands.v1.OrderCancellation
	64,  // 43: vega.events.v1.TxErrorEvent.proposal:type_name -> vega.commands.v1.ProposalSubmission
	65,  // 44: vega.events.v1.TxErrorEvent.vote_submission:type_name -> vega.commands.v1.VoteSubmission
	66,  // 45: vega.events.v1.TxErrorEvent.liquidity_provision_submission:type_name -> vega.commands.v1.LiquidityProvisionSubmission
	67,  // 46: vega.events.v1.TxErrorEvent.withdraw_submission:type_name -> vega.commands.v1.WithdrawSubmission
	68,  // 47: vega.events.v1.TxErrorEvent.delegate_submission:type_name -> vega.commands.v1.DelegateSubmission
	69,  // 48: vega.events.v1.TxErrorEvent.undelegate_submission:type_name -> vega.commands.v1.UndelegateSubmission
	70,  // 49: vega.events.v1.TxErrorEvent.liquidity_provision_cancellation:type_name -> vega.commands.v1.LiquidityProvisionCancellation
	71,  // 50: vega.events.v1.TxErrorEvent.liquidity_provision_amendment:type_name -> vega.commands.v1.LiquidityProvisionAmendment
	72,  // 51: vega.events.v1.TxErrorEvent.transfer:type_name -> vega.commands.v1.Transfer
	73,  // 52: vega.events.v1.TxErrorEvent.cancel_transfer:type_name -> vega.commands.v1.CancelTransfer
	74,  // 53: vega.events.v1.TxErrorEvent.announce_node:type_name -> vega.commands.v1.AnnounceNode
	75,  // 54: vega.events.v1.TxErrorEvent.oracle_data_submission:type_name -> vega.commands.v1.OracleDataSubmission
	76,  // 55: vega.events.v1.TxErrorEvent.protocol_upgrade_proposal:type_name -> vega.commands.v1.ProtocolUpgradeProposal
	77,  // 56: vega.events.v1.TxErrorEvent.issue_signatures:type_name -> vega.commands.v1.IssueSignatures
	78,  // 57: vega.events.v1.TxErrorEvent.batch_market_instructions:type_name -> vega.commands.v1.BatchMarketInstructions
	83,  // 58: vega.events.v1.EpochEvent.action:type_name -> vega.EpochAction
	84,  // 59: vega.events.v1.LedgerMovements.ledger_movements:type_name -> vega.LedgerMovement
	34,  // 60: vega.events.v1.SettlePosition.trade_settlements:type_name -> vega.events.v1.TradeSettlement
	85,  // 61: vega.events.v1.AuctionEvent.trigger:type_name -> vega.AuctionTrigger
	85,  // 62: vega.events.v1.AuctionEvent.extension_trigger:type_name -> vega.AuctionTrigger
	0,   // 63: vega.events.v1.ProtocolUpgradeEvent.status:type_name -> vega.events.v1.ProtocolUpgradeProposalStatus
	1,   // 64: vega.events.v1.BusEvent.type:type_name -> vega.events.v1.BusEventType
	29,  // 65: vega.events.v1.BusEvent.time_update:type_name -> vega.events.v1.TimeUpdate
	31,  // 66: vega.events.v1.BusEvent.ledger_movements:type_name -> vega.events.v1.LedgerMovements
	32,  // 67: vega.events.v1.BusEvent.position_resolution:type_name -> vega.events.v1.PositionResolution
	86,  // 68: vega.events.v1.BusEvent.order:type_name -> vega.Order
	87,  // 69: vega.events.v1.BusEvent.account:type_name -> vega.Account
	88,  // 70: vega.events.v1.BusEvent.party:type_name -> vega.Party
	89,  // 71: vega.events.v1.BusEvent.trade:type_name -> vega.Trade
	90,  // 72: vega.events.v1.BusEvent.margin_levels:type_name -> vega.MarginLevels
	91,  // 73: vega.events.v1.BusEvent.proposal:type_name -> vega.Proposal
	92,  // 74: vega.events.v1.BusEvent.vote:type_name -> vega.Vote
	93,  // 75: vega.events.v1.BusEvent.market_data:type_name -> vega.MarketData
	94,  // 76: vega.events.v1.BusEvent.node_signature:type_name -> vega.commands.v1.NodeSignature
	33,  // 77: vega.events.v1.BusEvent.loss_socialization:type_name -> vega.events.v1.LossSocialization
	35,  // 78: vega.events.v1.BusEvent.settle_position:type_name -> vega.events.v1.SettlePosition
	38,  // 79: vega.events.v1.BusEvent.settle_distressed:type_name -> vega.events.v1.SettleDistressed
	95,  // 80: vega.events.v1.BusEvent.market_created:type_name -> vega.Market
	96,  // 81: vega.events.v1.BusEvent.asset:type_name -> vega.Asset
	41,  // 82: vega.events.v1.BusEvent.market_tick:type_name -> vega.events.v1.MarketTick
	97,  // 83: vega.events.v1.BusEvent.withdrawal:type_name -> vega.Withdrawal
	98,  // 84: vega.events.v1.BusEvent.deposit:type_name -> vega.Deposit
	42,  // 85: vega.events.v1.BusEvent.auction:type_name -> vega.events.v1.AuctionEvent
	99,  // 86: vega.events.v1.BusEvent.risk_factor:type_name -> vega.RiskFactor
	100, // 87: vega.events.v1.BusEvent.network_parameter:type_name -> vega.NetworkParameter
	101, // 88: vega.events.v1.BusEvent.liquidity_provision:type_name -> vega.LiquidityProvision
	95,  // 89: vega.events.v1.BusEvent.market_updated:type_name -> vega.Market
	102, // 90: vega.events.v1.BusEvent.oracle_spec:type_name -> vega.OracleSpec
	103, // 91: vega.events.v1.BusEvent.oracle_data:type_name -> vega.OracleData
	25,  // 92: vega.events.v1.BusEvent.delegation_balance:type_name -> vega.events.v1.DelegationBalanceEvent
	24,  // 93: vega.events.v1.BusEvent.validator_score:type_name -> vega.events.v1.ValidatorScoreEvent
	30,  // 94: vega.events.v1.BusEvent.epoch_event:type_name -> vega.events.v1.EpochEvent
	43,  // 95: vega.events.v1.BusEvent.validator_update:type_name -> vega.events.v1.ValidatorUpdate
	18,  // 96: vega.events.v1.BusEvent.stake_linking:type_name -> vega.events.v1.StakeLinking
	23,  // 97: vega.events.v1.BusEvent.reward_payout:type_name -> vega.events.v1.RewardPayoutEvent
	21,  // 98: vega.events.v1.BusEvent.checkpoint:type_name -> vega.events.v1.CheckpointEvent
	45,  // 99: vega.events.v1.BusEvent.key_rotation:type_name -> vega.events.v1.KeyRotation
	48,  // 100: vega.events.v1.BusEvent.state_var:type_name -> vega.events.v1.StateVar
	104, // 101: vega.events.v1.BusEvent.network_limits:type_name -> vega.NetworkLimits
	13,  // 102: vega.events.v1.BusEvent.transfer:type_name -> vega.events.v1.Transfer
	44,  // 103: vega.events.v1.BusEvent.ranking_event:type_name -> vega.events.v1.ValidatorRankingEvent
	19,  // 104: vega.events.v1.BusEvent.erc20_multisig_signer_event:type_name -> vega.events.v1.ERC20MultiSigSignerEvent
	20,  // 105: vega.events.v1.BusEvent.erc20_multisig_set_threshold_event:type_name -> vega.events.v1.ERC20MultiSigThresholdSetEvent
	10,  // 106: vega.events.v1.BusEvent.erc20_multisig_signer_added:type_name -> vega.events.v1.ERC20MultiSigSignerAdded
	12,  // 107: vega.events.v1.BusEvent.erc20_multisig_signer_removed:type_name -> vega.events.v1.ERC20MultiSigSignerRemoved
	37,  // 108: vega.events.v1.BusEvent.position_state_event:type_name -> vega.events.v1.PositionStateEvent
	46,  // 109: vega.events.v1.BusEvent.ethereum_key_rotation:type_name -> vega.events.v1.EthereumKeyRotation
	47,  // 110: vega.events.v1.BusEvent.protocol_upgrade_event:type_name -> vega.events.v1.ProtocolUpgradeEvent
	49,  // 111: vega.events.v1.BusEvent.begin_block:type_name -> vega.events.v1.BeginBlock
	50,  // 112: vega.events.v1.BusEvent.end_block:type_name -> vega.events.v1.EndBlock
	51,  // 113: vega.events.v1.BusEvent.protocol_upgrade_started:type_name -> vega.events.v1.ProtocolUpgradeStarted
	36,  // 114: vega.events.v1.BusEvent.settle_market:type_name -> vega.events.v1.SettleMarket
	27,  // 115: vega.events.v1.BusEvent.transaction_result:type_name -> vega.events.v1.TransactionResult
	53,  // 116: vega.events.v1.BusEvent.core_snapshot_event:type_name -> vega.events.v1.CoreSnapshotData
	52,  // 117: vega.events.v1.BusEvent.protocol_upgrade_data_node_ready:type_name -> vega.events.v1.ProtocolUpgradeDataNodeReady
	39,  // 118: vega.events.v1.BusEvent.distressed_orders:type_name -> vega.events.v1.DistressedOrders
	55,  // 119: vega.events.v1.BusEvent.expired_orders:type_name -> vega.events.v1.ExpiredOrders
	40,  // 120: vega.events.v1.BusEvent.distressed_positions:type_name -> vega.events.v1.DistressedPositions
	9,   // 121: vega.events.v1.BusEvent.stop_order:type_name -> vega.events.v1.StopOrderEvent
	7,   // 122: vega.events.v1.BusEvent.funding_period:type_name -> vega.events.v1.FundingPeriod
	8,   // 123: vega.events.v1.BusEvent.funding_period_data_point:type_name -> vega.events.v1.FundingPeriodDataPoint
	26,  // 124: vega.events.v1.BusEvent.market:type_name -> vega.events.v1.MarketEvent
	28,  // 125: vega.events.v1.BusEvent.tx_err_event:type_name -> vega.events.v1.TxErrorEvent
