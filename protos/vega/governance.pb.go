...
const (
	...
	// Successor market did not specify a valid market to succeed.
	ProposalError_PROPOSAL_ERROR_INVALID_SUCCESSOR_MARKET ProposalError = 46
)
...
var (
	ProposalError_name = map[int32]string{
		...
		46: "PROPOSAL_ERROR_INVALID_SUCCESSOR_MARKET",
	}
	ProposalError_value = map[string]int32{
		...
		"PROPOSAL_ERROR_INVALID_SUCCESSOR_MARKET":               46,
	}
)
...
func (Proposal_State) EnumDescriptor() ([]byte, []int) {
	return file_vega_governance_proto_rawDescGZIP(), []int{18, 0}
}
...
func (Vote_Value) EnumDescriptor() ([]byte, []int) {
	return file_vega_governance_proto_rawDescGZIP(), []int{19, 0}
}
...
// Future product configuration for successor proposals.
type SuccessorFutureProduct struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *SuccessorFutureProduct) Reset() {
	*x = SuccessorFutureProduct{}
	if protoimpl.UnsafeEnabled {
...
func (x *SuccessorFutureProduct) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SuccessorFutureProduct) ProtoMessage() {}

func (x *SuccessorFutureProduct) ProtoReflect() protoreflect.Message {
	mi := &file_vega_governance_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SuccessorFutureProduct.ProtoReflect.Descriptor instead.
func (*SuccessorFutureProduct) Descriptor() ([]byte, []int) {
	return file_vega_governance_proto_rawDescGZIP(), []int{1}
}

func (x *SuccessorFutureProduct) GetDataSourceSpecForSettlementData() *DataSourceDefinition {
	if x != nil {
		return x.DataSourceSpecForSettlementData
	}
	return nil
...
func (x *SuccessorFutureProduct) GetDataSourceSpecForTradingTermination() *DataSourceDefinition {
	if x != nil {
		return x.DataSourceSpecForTradingTermination
	}
	return nil
...
func (x *SuccessorFutureProduct) GetDataSourceSpecBinding() *DataSourceSpecToFutureBinding {
	if x != nil {
		return x.DataSourceSpecBinding
	}
	return nil
...
type InstrumentConfiguration struct {
	...
	//	*InstrumentConfiguration_SuccessorFuture
...
func (x *InstrumentConfiguration) GetSuccessorFuture() *SuccessorFutureProduct {
	if x, ok := x.GetProduct().(*InstrumentConfiguration_SuccessorFuture); ok {
		return x.SuccessorFuture
	}
	return nil
}
...
func (*InstrumentConfiguration_SuccessorFuture) isInstrumentConfiguration_Product() {}
...
// Configuration of a new successor market
type SuccessorMarketConfiguration struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	// Types that are assignable to RiskParameters:
	//
	//	*SuccessorMarketConfiguration_Simple
	//	*SuccessorMarketConfiguration_LogNormal
	RiskParameters isSuccessorMarketConfiguration_RiskParameters `protobuf_oneof:"risk_parameters"`
	// Decimal places for order sizes, sets what size the smallest order / position on the market can be.
	PositionDecimalPlaces int64 `protobuf:"varint,6,opt,name=position_decimal_places,json=positionDecimalPlaces,proto3" json:"position_decimal_places,omitempty"`
	// Decimal places used for the market, sets the smallest price increment on the book.
	DecimalPlaces uint64 `protobuf:"varint,7,opt,name=decimal_places,json=decimalPlaces,proto3" json:"decimal_places,omitempty"`
	// Percentage move up and down from the mid price which specifies the range of
	// price levels over which automated liquidity provision orders will be deployed.
	LpPriceRange string `protobuf:"bytes,8,opt,name=lp_price_range,json=lpPriceRange,proto3" json:"lp_price_range,omitempty"`
	// Linear slippage factor is used to cap the slippage component of maintenance margin - it is applied to the slippage volume.
	...
	// Quadratic slippage factor is used to cap the slippage component of maintenance margin - it is applied to the square of the slippage volume.
	QuadraticSlippageFactor string `protobuf:"bytes,10,opt,name=quadratic_slippage_factor,json=quadraticSlippageFactor,proto3" json:"quadratic_slippage_factor,omitempty"`
	// Successor market instrument configuration.
	Instrument *InstrumentConfiguration `protobuf:"bytes,11,opt,name=instrument,proto3" json:"instrument,omitempty"`
}

func (x *SuccessorMarketConfiguration) Reset() {
	*x = SuccessorMarketConfiguration{}
	if protoimpl.UnsafeEnabled {
...
func (x *SuccessorMarketConfiguration) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SuccessorMarketConfiguration) ProtoMessage() {}

func (x *SuccessorMarketConfiguration) ProtoReflect() protoreflect.Message {
	mi := &file_vega_governance_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SuccessorMarketConfiguration.ProtoReflect.Descriptor instead.
func (*SuccessorMarketConfiguration) Descriptor() ([]byte, []int) {
	return file_vega_governance_proto_rawDescGZIP(), []int{4}
}

func (x *SuccessorMarketConfiguration) GetParentMarketId() string {
	if x != nil {
...
func (x *SuccessorMarketConfiguration) GetInsurancePoolFraction() string {
	if x != nil {
...
func (x *SuccessorMarketConfiguration) GetMetadata() []string {
	if x != nil {
		return x.Metadata
	}
	return nil
...
func (x *SuccessorMarketConfiguration) GetPriceMonitoringParameters() *PriceMonitoringParameters {
	if x != nil {
		return x.PriceMonitoringParameters
	}
	return nil
...
func (x *SuccessorMarketConfiguration) GetLiquidityMonitoringParameters() *LiquidityMonitoringParameters {
	if x != nil {
		return x.LiquidityMonitoringParameters
	}
	return nil
...
func (m *SuccessorMarketConfiguration) GetRiskParameters() isSuccessorMarketConfiguration_RiskParameters {
	if m != nil {
		return m.RiskParameters
	}
	return nil
...
func (x *SuccessorMarketConfiguration) GetSimple() *SimpleModelParams {
	if x, ok := x.GetRiskParameters().(*SuccessorMarketConfiguration_Simple); ok {
		return x.Simple
	}
	return nil
}

func (x *SuccessorMarketConfiguration) GetLogNormal() *LogNormalRiskModel {
	if x, ok := x.GetRiskParameters().(*SuccessorMarketConfiguration_LogNormal); ok {
		return x.LogNormal
	}
	return nil
}

func (x *SuccessorMarketConfiguration) GetPositionDecimalPlaces() int64 {
	if x != nil {
		return x.PositionDecimalPlaces
	}
	return 0
...
func (x *SuccessorMarketConfiguration) GetDecimalPlaces() uint64 {
	if x != nil {
		return x.DecimalPlaces
	}
	return 0
...
func (x *SuccessorMarketConfiguration) GetLpPriceRange() string {
	if x != nil {
		return x.LpPriceRange
	}
	return ""
...
func (x *SuccessorMarketConfiguration) GetLinearSlippageFactor() string {
	if x != nil {
		return x.LinearSlippageFactor
	}
	return ""
...
func (x *SuccessorMarketConfiguration) GetQuadraticSlippageFactor() string {
	if x != nil {
		return x.QuadraticSlippageFactor
	}
	return ""
...
func (x *SuccessorMarketConfiguration) GetInstrument() *InstrumentConfiguration {
	if x != nil {
		return x.Instrument
	}
	return nil
...
type isSuccessorMarketConfiguration_RiskParameters interface {
	isSuccessorMarketConfiguration_RiskParameters()
}

type SuccessorMarketConfiguration_Simple struct {
	// Simple risk model parameters, valid only if MODEL_SIMPLE is selected.
	Simple *SimpleModelParams `protobuf:"bytes,100,opt,name=simple,proto3,oneof"`
}

type SuccessorMarketConfiguration_LogNormal struct {
	// Log normal risk model parameters, valid only if MODEL_LOG_NORMAL is selected.
	LogNormal *LogNormalRiskModel `protobuf:"bytes,101,opt,name=log_normal,json=logNormal,proto3,oneof"`
}

func (*SuccessorMarketConfiguration_Simple) isSuccessorMarketConfiguration_RiskParameters() {}

func (*SuccessorMarketConfiguration_LogNormal) isSuccessorMarketConfiguration_RiskParameters() {}
...
type SuccessorMarket struct {
	...
	// Configuration of the successor market.
	Changes *SuccessorMarketConfiguration `protobuf:"bytes,1,opt,name=changes,proto3" json:"changes,omitempty"`
}
...
func (x *SuccessorMarket) GetChanges() *SuccessorMarketConfiguration {
	if x != nil {
		return x.Changes
	}
	return nil
...
func (x *ProposalTerms) GetSuccessorMarket() *SuccessorMarket {
	if x, ok := x.GetChange().(*ProposalTerms_SuccessorMarket); ok {
		return x.SuccessorMarket
	}
	return nil
}
...
func (*ProposalTerms_SuccessorMarket) isProposalTerms_Change() {}
...
var file_vega_governance_proto_rawDesc = []byte{
	...
	0x67, 0x61, 0x2f, 0x76, 0x65, 0x67, 0x61, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x95, 0x03,
	0x0a, 0x0d, 0x46, 0x75, 0x74, 0x75, 0x72, 0x65, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x12,
	0x29, 0x0a, 0x10, 0x73, 0x65, 0x74, 0x74, 0x6c, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x5f, 0x61, 0x73,
	0x73, 0x65, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0f, 0x73, 0x65, 0x74, 0x74, 0x6c,
	0x65, 0x6d, 0x65, 0x6e, 0x74, 0x41, 0x73, 0x73, 0x65, 0x74, 0x12, 0x1d, 0x0a, 0x0a, 0x71, 0x75,
	0x6f, 0x74, 0x65, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09,
	...
	0x61, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x76, 0x65, 0x67, 0x61, 0x2e, 0x44,
	...
	0x44, 0x61, 0x74, 0x61, 0x12, 0x71, 0x0a, 0x28, 0x64, 0x61, 0x74, 0x61, 0x5f, 0x73, 0x6f, 0x75,
	0x72, 0x63, 0x65, 0x5f, 0x73, 0x70, 0x65, 0x63, 0x5f, 0x66, 0x6f, 0x72, 0x5f, 0x74, 0x72, 0x61,
	0x64, 0x69, 0x6e, 0x67, 0x5f, 0x74, 0x65, 0x72, 0x6d, 0x69, 0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e,
	0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x76, 0x65, 0x67, 0x61, 0x2e, 0x44, 0x61,
	...
	,
	...
	0x65, 0x6e, 0x74, 0x5f, 0x64, 0x61, 0x74, 0x61, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1a,
	...
	0x65, 0x63, 0x5f, 0x62, 0x69, 0x6e, 0x64, 0x69, 0x6e, 0x67, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b,
	...
	0x65, 0x53, 0x70, 0x65, 0x63, 0x42, 0x69, 0x6e, 0x64, 0x69, 0x6e, 0x67, 0x22, 0xc7, 0x01, 0x0a,
	...
	,
	...
	0x61, 0x6d, 0x65, 0x74, 0x65, 0x72, 0x73, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x23, 0x2e,
	...
	0x6d, 0x61, 0x6c, 0x5f, 0x70, 0x6c, 0x61, 0x63, 0x65, 0x73, 0x18, 0x06, 0x20, 0x01, 0x28, 0x03,
	...
	0x69, 0x63, 0x65, 0x5f, 0x72, 0x61, 0x6e, 0x67, 0x65, 0x18, 0x08, 0x20, 0x01, 0x28, 0x09, 0x52,
	...
	0x72, 0x73, 0x22, 0xa1, 0x06, 0x0a, 0x1c, 0x53, 0x75, 0x63, 0x63, 0x65, 0x73, 0x73, 0x6f, 0x72,
	...
	0x6c, 0x61, 0x63, 0x65, 0x73, 0x12, 0x25, 0x0a, 0x0e, 0x64, 0x65, 0x63, 0x69, 0x6d, 0x61, 0x6c,
	0x5f, 0x70, 0x6c, 0x61, 0x63, 0x65, 0x73, 0x18, 0x07, 0x20, 0x01, 0x28, 0x04, 0x52, 0x0d, 0x64,
	...
	0x63, 0x74, 0x6f, 0x72, 0x12, 0x3d, 0x0a, 0x0a, 0x69, 0x6e, 0x73, 0x74, 0x72, 0x75, 0x6d, 0x65,
	0x6e, 0x74, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1d, 0x2e, 0x76, 0x65, 0x67, 0x61, 0x2e,
	...
	0x65, 0x6e, 0x74, 0x42, 0x11, 0x0a, 0x0f, 0x72, 0x69, 0x73, 0x6b, 0x5f, 0x70, 0x61, 0x72, 0x61,
	0x6d, 0x65, 0x74, 0x65, 0x72, 0x73, 0x22, 0x43, 0x0a, 0x09, 0x4e, 0x65, 0x77, 0x4d, 0x61, 0x72,
	...
	0x6f, 0x6e, 0x52, 0x07, 0x63, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x73, 0x22, 0x4f, 0x0a, 0x0f, 0x53,
	0x75, 0x63, 0x63, 0x65, 0x73, 0x73, 0x6f, 0x72, 0x4d, 0x61, 0x72, 0x6b, 0x65, 0x74, 0x12, 0x3c,
	0x0a, 0x07, 0x63, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32,
	0x22, 0x2e, 0x76, 0x65, 0x67, 0x61, 0x2e, 0x53, 0x75, 0x63, 0x63, 0x65, 0x73, 0x73, 0x6f, 0x72,
	0x4d, 0x61, 0x72, 0x6b, 0x65, 0x74, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x75, 0x72, 0x61, 0x74,
	...
	0x70, 0x61, 0x72, 0x61, 0x6d, 0x65, 0x74, 0x65, 0x72, 0x73, 0x22, 0x73, 0x0a, 0x1d, 0x55, 0x70,
	0x64, 0x61, 0x74, 0x65, 0x49, 0x6e, 0x73, 0x74, 0x72, 0x75, 0x6d, 0x65, 0x6e, 0x74, 0x43, 0x6f,
	...
	0x74, 0x75, 0x72, 0x65, 0x42, 0x09, 0x0a, 0x07, 0x70, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x22,
	0xf0, 0x02, 0x0a, 0x13, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x46, 0x75, 0x74, 0x75, 0x72, 0x65,
	...
	0x74, 0x65, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x69, 0x0a, 0x24, 0x64, 0x61, 0x74, 0x61, 0x5f, 0x73,
	0x6f, 0x75, 0x72, 0x63, 0x65, 0x5f, 0x73, 0x70, 0x65, 0x63, 0x5f, 0x66, 0x6f, 0x72, 0x5f, 0x73,
	0x65, 0x74, 0x74, 0x6c, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x5f, 0x64, 0x61, 0x74, 0x61, 0x18, 0x02,
	...
	0x61, 0x12, 0x71, 0x0a, 0x28, 0x64, 0x61, 0x74, 0x61, 0x5f, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65,
	0x5f, 0x73, 0x70, 0x65, 0x63, 0x5f, 0x66, 0x6f, 0x72, 0x5f, 0x74, 0x72, 0x61, 0x64, 0x69, 0x6e,
	0x67, 0x5f, 0x74, 0x65, 0x72, 0x6d, 0x69, 0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x03, 0x20,
	...
	,
	...
	0x74, 0x61, 0x6d, 0x70, 0x12, 0x2f, 0x0a, 0x13, 0x65, 0x6e, 0x61, 0x63, 0x74, 0x6d, 0x65, 0x6e,
	...
	0x73, 0x74, 0x61, 0x6d, 0x70, 0x12, 0x31, 0x0a, 0x14, 0x76, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74,
	0x69, 0x6f, 0x6e, 0x5f, 0x74, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x18, 0x03, 0x20,
	0x01, 0x28, 0x03, 0x52, 0x13, 0x76, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x54,
	...
	0x2d, 0x0a, 0x09, 0x6e, 0x65, 0x77, 0x5f, 0x61, 0x73, 0x73, 0x65, 0x74, 0x18, 0x68, 0x20, 0x01,
	0x28, 0x0b, 0x32, 0x0e, 0x2e, 0x76, 0x65, 0x67, 0x61, 0x2e, 0x4e, 0x65, 0x77, 0x41, 0x73, 0x73,
	0x65, 0x74, 0x48, 0x00, 0x52, 0x08, 0x6e, 0x65, 0x77, 0x41, 0x73, 0x73, 0x65, 0x74, 0x12, 0x36,
	0x0a, 0x0c, 0x6e, 0x65, 0x77, 0x5f, 0x66, 0x72, 0x65, 0x65, 0x66, 0x6f, 0x72, 0x6d, 0x18, 0x69,
	...
	,
	...
	0x04, 0x08, 0x03, 0x10, 0x04, 0x22, 0x86, 0x03, 0x0a, 0x0e, 0x47, 0x6f, 0x76, 0x65, 0x72, 0x6e,
	...
	0x6e, 0x74, 0x72, 0x79, 0x52, 0x07, 0x6e, 0x6f, 0x50, 0x61, 0x72, 0x74, 0x79, 0x1a, 0x47, 0x0a,
	0x0d, 0x59, 0x65, 0x73, 0x50, 0x61, 0x72, 0x74, 0x79, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x12, 0x10,
	...
	0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x1a, 0x46, 0x0a, 0x0c, 0x4e, 0x6f, 0x50, 0x61, 0x72, 0x74,
	...
	0x6f, 0x74, 0x65, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x9a,
	0x07, 0x0a, 0x08, 0x50, 0x72, 0x6f, 0x70, 0x6f, 0x73, 0x61, 0x6c, 0x12, 0x0e, 0x0a, 0x02, 0x69,
	...
	0x72, 0x65, 0x66, 0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x12, 0x19, 0x0a, 0x08, 0x70, 0x61, 0x72,
	0x74, 0x79, 0x5f, 0x69, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x70, 0x61, 0x72,
	0x74, 0x79, 0x49, 0x64, 0x12, 0x2a, 0x0a, 0x05, 0x73, 0x74, 0x61, 0x74, 0x65, 0x18, 0x04, 0x20,
	0x01, 0x28, 0x0e, 0x32, 0x14, 0x2e, 0x76, 0x65, 0x67, 0x61, 0x2e, 0x50, 0x72, 0x6f, 0x70, 0x6f,
	0x73, 0x61, 0x6c, 0x2e, 0x53, 0x74, 0x61, 0x74, 0x65, 0x52, 0x05, 0x73, 0x74, 0x61, 0x74, 0x65,
	...
	0x0a, 0x05, 0x74, 0x65, 0x72, 0x6d, 0x73, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x13, 0x2e,
	0x76, 0x65, 0x67, 0x61, 0x2e, 0x50, 0x72, 0x6f, 0x70, 0x6f, 0x73, 0x61, 0x6c, 0x54, 0x65, 0x72,
	0x6d, 0x73, 0x52, 0x05, 0x74, 0x65, 0x72, 0x6d, 0x73, 0x12, 0x30, 0x0a, 0x06, 0x72, 0x65, 0x61,
	0x73, 0x6f, 0x6e, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x13, 0x2e, 0x76, 0x65, 0x67, 0x61,
	0x2e, 0x50, 0x72, 0x6f, 0x70, 0x6f, 0x73, 0x61, 0x6c, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x48, 0x00,
	...
	0x28, 0x09, 0x48, 0x01, 0x52, 0x0c, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x44, 0x65, 0x74, 0x61, 0x69,
	...
	0x01, 0x28, 0x09, 0x48, 0x02, 0x52, 0x26, 0x72, 0x65, 0x71, 0x75, 0x69, 0x72, 0x65, 0x64, 0x4c,
	...
	0x75, 0x69, 0x64, 0x69, 0x74, 0x79, 0x5f, 0x70, 0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x72, 0x5f,
	0x6d, 0x61, 0x6a, 0x6f, 0x72, 0x69, 0x74, 0x79, 0x18, 0x0d, 0x20, 0x01, 0x28, 0x09, 0x48, 0x03,
	...
	0x69, 0x74, 0x79, 0x88, 0x01, 0x01, 0x22, 0xae, 0x01, 0x0a, 0x05, 0x53, 0x74, 0x61, 0x74, 0x65,
	...
	0x5f, 0x56, 0x4f, 0x54, 0x45, 0x10, 0x07, 0x42, 0x09, 0x0a, 0x07, 0x5f, 0x72, 0x65, 0x61, 0x73,
	...
	0x65, 0x72, 0x5f, 0x6d, 0x61, 0x6a, 0x6f, 0x72, 0x69, 0x74, 0x79, 0x22, 0x91, 0x03, 0x0a, 0x04,
	...
	0x68, 0x74, 0x22, 0x3b, 0x0a, 0x05, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x12, 0x15, 0x0a, 0x11, 0x56,
	...
	0x12, 0x0d, 0x0a, 0x09, 0x56, 0x41, 0x4c, 0x55, 0x45, 0x5f, 0x59, 0x45, 0x53, 0x10, 0x02, 0x2a,
	0xcd, 0x0e, 0x0a, 0x0d, 0x50, 0x72, 0x6f, 0x70, 0x6f, 0x73, 0x61, 0x6c, 0x45, 0x72, 0x72, 0x6f,
	...
	0x10, 0x2d, 0x12, 0x2b, 0x0a, 0x27, 0x50, 0x52, 0x4f, 0x50, 0x4f, 0x53, 0x41, 0x4c, 0x5f, 0x45,
	0x52, 0x52, 0x4f, 0x52, 0x5f, 0x49, 0x4e, 0x56, 0x41, 0x4c, 0x49, 0x44, 0x5f, 0x53, 0x55, 0x43,
	0x43, 0x45, 0x53, 0x53, 0x4f, 0x52, 0x5f, 0x4d, 0x41, 0x52, 0x4b, 0x45, 0x54, 0x10, 0x2e, 0x42,
...
var file_vega_governance_proto_msgTypes = make([]protoimpl.MessageInfo, 22)
var file_vega_governance_proto_goTypes = []interface{}{
	...
	(*SuccessorFutureProduct)(nil),        // 4: vega.SuccessorFutureProduct
	(*InstrumentConfiguration)(nil),       // 5: vega.InstrumentConfiguration
	(*NewMarketConfiguration)(nil),        // 6: vega.NewMarketConfiguration
	(*SuccessorMarketConfiguration)(nil),  // 7: vega.SuccessorMarketConfiguration
	(*NewMarket)(nil),                     // 8: vega.NewMarket
	(*SuccessorMarket)(nil),               // 9: vega.SuccessorMarket
	(*UpdateMarket)(nil),                  // 10: vega.UpdateMarket
	(*UpdateMarketConfiguration)(nil),     // 11: vega.UpdateMarketConfiguration
	(*UpdateInstrumentConfiguration)(nil), // 12: vega.UpdateInstrumentConfiguration
	(*UpdateFutureProduct)(nil),           // 13: vega.UpdateFutureProduct
	(*UpdateNetworkParameter)(nil),        // 14: vega.UpdateNetworkParameter
	(*NewAsset)(nil),                      // 15: vega.NewAsset
	(*UpdateAsset)(nil),                   // 16: vega.UpdateAsset
	(*NewFreeform)(nil),                   // 17: vega.NewFreeform
	(*ProposalTerms)(nil),                 // 18: vega.ProposalTerms
	(*ProposalRationale)(nil),             // 19: vega.ProposalRationale
	(*GovernanceData)(nil),                // 20: vega.GovernanceData
	(*Proposal)(nil),                      // 21: vega.Proposal
	(*Vote)(nil),                          // 22: vega.Vote
	nil,                                   // 23: vega.GovernanceData.YesPartyEntry
	nil,                                   // 24: vega.GovernanceData.NoPartyEntry
	(*DataSourceDefinition)(nil),          // 25: vega.DataSourceDefinition
	(*DataSourceSpecToFutureBinding)(nil), // 26: vega.DataSourceSpecToFutureBinding
	(*PriceMonitoringParameters)(nil),     // 27: vega.PriceMonitoringParameters
	(*LiquidityMonitoringParameters)(nil), // 28: vega.LiquidityMonitoringParameters
	(*SimpleModelParams)(nil),             // 29: vega.SimpleModelParams
	(*LogNormalRiskModel)(nil),            // 30: vega.LogNormalRiskModel
	(*NetworkParameter)(nil),              // 31: vega.NetworkParameter
	(*AssetDetails)(nil),                  // 32: vega.AssetDetails
	(*AssetDetailsUpdate)(nil),            // 33: vega.AssetDetailsUpdate
}
var file_vega_governance_proto_depIdxs = []int32{
	25, // 0: vega.FutureProduct.data_source_spec_for_settlement_data:type_name -> vega.DataSourceDefinition
	25, // 1: vega.FutureProduct.data_source_spec_for_trading_termination:type_name -> vega.DataSourceDefinition
	26, // 2: vega.FutureProduct.data_source_spec_binding:type_name -> vega.DataSourceSpecToFutureBinding
	25, // 3: vega.SuccessorFutureProduct.data_source_spec_for_settlement_data:type_name -> vega.DataSourceDefinition
	25, // 4: vega.SuccessorFutureProduct.data_source_spec_for_trading_termination:type_name -> vega.DataSourceDefinition
	26, // 5: vega.SuccessorFutureProduct.data_source_spec_binding:type_name -> vega.DataSourceSpecToFutureBinding
	3,  // 6: vega.InstrumentConfiguration.future:type_name -> vega.FutureProduct
	4,  // 7: vega.InstrumentConfiguration.successor_future:type_name -> vega.SuccessorFutureProduct
	5,  // 8: vega.NewMarketConfiguration.instrument:type_name -> vega.InstrumentConfiguration
	27, // 9: vega.NewMarketConfiguration.price_monitoring_parameters:type_name -> vega.PriceMonitoringParameters
	28, // 10: vega.NewMarketConfiguration.liquidity_monitoring_parameters:type_name -> vega.LiquidityMonitoringParameters
	29, // 11: vega.NewMarketConfiguration.simple:type_name -> vega.SimpleModelParams
	30, // 12: vega.NewMarketConfiguration.log_normal:type_name -> vega.LogNormalRiskModel
	27, // 13: vega.SuccessorMarketConfiguration.price_monitoring_parameters:type_name -> vega.PriceMonitoringParameters
	28, // 14: vega.SuccessorMarketConfiguration.liquidity_monitoring_parameters:type_name -> vega.LiquidityMonitoringParameters
	29, // 15: vega.SuccessorMarketConfiguration.simple:type_name -> vega.SimpleModelParams
	30, // 16: vega.SuccessorMarketConfiguration.log_normal:type_name -> vega.LogNormalRiskModel
	5,  // 17: vega.SuccessorMarketConfiguration.instrument:type_name -> vega.InstrumentConfiguration
	6,  // 18: vega.NewMarket.changes:type_name -> vega.NewMarketConfiguration
	7,  // 19: vega.SuccessorMarket.changes:type_name -> vega.SuccessorMarketConfiguration
	11, // 20: vega.UpdateMarket.changes:type_name -> vega.UpdateMarketConfiguration
	12, // 21: vega.UpdateMarketConfiguration.instrument:type_name -> vega.UpdateInstrumentConfiguration
	27, // 22: vega.UpdateMarketConfiguration.price_monitoring_parameters:type_name -> vega.PriceMonitoringParameters
	28, // 23: vega.UpdateMarketConfiguration.liquidity_monitoring_parameters:type_name -> vega.LiquidityMonitoringParameters
	29, // 24: vega.UpdateMarketConfiguration.simple:type_name -> vega.SimpleModelParams
	30, // 25: vega.UpdateMarketConfiguration.log_normal:type_name -> vega.LogNormalRiskModel
	13, // 26: vega.UpdateInstrumentConfiguration.future:type_name -> vega.UpdateFutureProduct
	25, // 27: vega.UpdateFutureProduct.data_source_spec_for_settlement_data:type_name -> vega.DataSourceDefinition
	25, // 28: vega.UpdateFutureProduct.data_source_spec_for_trading_termination:type_name -> vega.DataSourceDefinition
	26, // 29: vega.UpdateFutureProduct.data_source_spec_binding:type_name -> vega.DataSourceSpecToFutureBinding
	31, // 30: vega.UpdateNetworkParameter.changes:type_name -> vega.NetworkParameter
	32, // 31: vega.NewAsset.changes:type_name -> vega.AssetDetails
	33, // 32: vega.UpdateAsset.changes:type_name -> vega.AssetDetailsUpdate
	10, // 33: vega.ProposalTerms.update_market:type_name -> vega.UpdateMarket
	8,  // 34: vega.ProposalTerms.new_market:type_name -> vega.NewMarket
	14, // 35: vega.ProposalTerms.update_network_parameter:type_name -> vega.UpdateNetworkParameter
	15, // 36: vega.ProposalTerms.new_asset:type_name -> vega.NewAsset
	17, // 37: vega.ProposalTerms.new_freeform:type_name -> vega.NewFreeform
	16, // 38: vega.ProposalTerms.update_asset:type_name -> vega.UpdateAsset
	9,  // 39: vega.ProposalTerms.successor_market:type_name -> vega.SuccessorMarket
	21, // 40: vega.GovernanceData.proposal:type_name -> vega.Proposal
	22, // 41: vega.GovernanceData.yes:type_name -> vega.Vote
	22, // 42: vega.GovernanceData.no:type_name -> vega.Vote
	23, // 43: vega.GovernanceData.yes_party:type_name -> vega.GovernanceData.YesPartyEntry
	24, // 44: vega.GovernanceData.no_party:type_name -> vega.GovernanceData.NoPartyEntry
	1,  // 45: vega.Proposal.state:type_name -> vega.Proposal.State
	18, // 46: vega.Proposal.terms:type_name -> vega.ProposalTerms
	0,  // 47: vega.Proposal.reason:type_name -> vega.ProposalError
	19, // 48: vega.Proposal.rationale:type_name -> vega.ProposalRationale
	2,  // 49: vega.Vote.value:type_name -> vega.Vote.Value
	22, // 50: vega.GovernanceData.YesPartyEntry.value:type_name -> vega.Vote
	22, // 51: vega.GovernanceData.NoPartyEntry.value:type_name -> vega.Vote
...
func file_vega_governance_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_vega_governance_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SuccessorFutureProduct); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_vega_governance_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SuccessorMarketConfiguration); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_vega_governance_proto_msgTypes[2].OneofWrappers = []interface{}{
		...
		(*InstrumentConfiguration_SuccessorFuture)(nil),
	}
	...
	file_vega_governance_proto_msgTypes[4].OneofWrappers = []interface{}{
		(*SuccessorMarketConfiguration_Simple)(nil),
		(*SuccessorMarketConfiguration_LogNormal)(nil),
	}
	file_vega_governance_proto_msgTypes[8].OneofWrappers = []interface{}{
	...
	file_vega_governance_proto_msgTypes[15].OneofWrappers = []interface{}{
		...
		(*ProposalTerms_SuccessorMarket)(nil),
	}
