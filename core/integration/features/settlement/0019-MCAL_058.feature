Feature: Test funding margin for Perps market in isolated margin mode
  ...
  @Perpetual
  Scenario: (0019-MCAL-058, 0019-MCAL-054, 0019-MCAL-091) check funding margin for Perps market when clumps are 0.1 and 0.15
    ...
    And the following transfers should happen:
      | from   | to     | from account            | to account              | market id | amount  | asset |
      | aux    | market | ACCOUNT_TYPE_MARGIN     | ACCOUNT_TYPE_SETTLEMENT | ETH/DEC19 | 1650000 | USD   |
    ...
    Then the parties should have the following account balances:
      ...
      | party3 | USD   | ETH/DEC19 | 1350000 | 9198000 |              |
