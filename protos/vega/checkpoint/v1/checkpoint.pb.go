...
type MarketActivityTracker struct {
	...
	MakerFeesReceivedHistory     []*PartyFeeData       `protobuf:"bytes,10,rep,name=maker_fees_received_history,json=makerFeesReceivedHistory,proto3" json:"maker_fees_received_history,omitempty"`
	MakerFeesPaidHistory         []*PartyFeeData       `protobuf:"bytes,11,rep,name=maker_fees_paid_history,json=makerFeesPaidHistory,proto3" json:"maker_fees_paid_history,omitempty"`
	LpFeesHistory                []*PartyFeeData       `protobuf:"bytes,12,rep,name=lp_fees_history,json=lpFeesHistory,proto3" json:"lp_fees_history,omitempty"`
	TimeWeightedPositionHistory  []*TWPositionData     `protobuf:"bytes,13,rep,name=time_weighted_position_history,json=timeWeightedPositionHistory,proto3" json:"time_weighted_position_history,omitempty"`
	ReturnsData                  []*ReturnsData        `protobuf:"bytes,14,rep,name=returns_data,json=returnsData,proto3" json:"returns_data,omitempty"`
	TimeWeightedNotionalPosition []*TWNotionalPosition `protobuf:"bytes,15,rep,name=time_weighted_notional_position,json=timeWeightedNotionalPosition,proto3" json:"time_weighted_notional_position,omitempty"`
	TotalMakerFeesReceived       *DataWithHistory      `protobuf:"bytes,16,opt,name=total_maker_fees_received,json=totalMakerFeesReceived,proto3" json:"total_maker_fees_received,omitempty"`
	TotalMakerFeesPaid           *DataWithHistory      `protobuf:"bytes,17,opt,name=total_maker_fees_paid,json=totalMakerFeesPaid,proto3" json:"total_maker_fees_paid,omitempty"`
	TotalLpFees                  *DataWithHistory      `protobuf:"bytes,18,opt,name=total_lp_fees,json=totalLpFees,proto3" json:"total_lp_fees,omitempty"`
}
...
func (x *MarketActivityTracker) GetMakerFeesReceivedHistory() []*PartyFeeData {
	if x != nil {
...
func (x *MarketActivityTracker) GetMakerFeesPaidHistory() []*PartyFeeData {
	if x != nil {
...
func (x *MarketActivityTracker) GetLpFeesHistory() []*PartyFeeData {
	if x != nil {
...
func (x *MarketActivityTracker) GetTimeWeightedPositionHistory() []*TWPositionData {
	if x != nil {
		return x.TimeWeightedPositionHistory
	}
	return nil
}
...
func (x *MarketActivityTracker) GetTimeWeightedNotionalPosition() []*TWNotionalPosition {
	if x != nil {
...
func (x *MarketActivityTracker) GetTotalMakerFeesReceived() *DataWithHistory {
	if x != nil {
...
func (x *MarketActivityTracker) GetTotalMakerFeesPaid() *DataWithHistory {
	if x != nil {
...
func (x *MarketActivityTracker) GetTotalLpFees() *DataWithHistory {
	if x != nil {
		return x.TotalLpFees
	}
	return nil
}
...
type ReturnsData struct {
	...
	Party string           `protobuf:"bytes,1,opt,name=party,proto3" json:"party,omitempty"`
	Data  *DataWithHistory `protobuf:"bytes,2,opt,name=data,proto3" json:"data,omitempty"`
}
...
func (x *ReturnsData) GetData() *DataWithHistory {
	if x != nil {
		return x.Data
	}
	return nil
...
type TWNotionalPosition struct {
	...
	Price              []byte `protobuf:"bytes,4,opt,name=price,proto3" json:"price,omitempty"`
	TwNotionalPosition []byte `protobuf:"bytes,5,opt,name=tw_notional_position,json=twNotionalPosition,proto3" json:"tw_notional_position,omitempty"`
}

func (x *TWNotionalPosition) Reset() {
	*x = TWNotionalPosition{}
	if protoimpl.UnsafeEnabled {
...
func (x *TWNotionalPosition) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TWNotionalPosition) ProtoMessage() {}

func (x *TWNotionalPosition) ProtoReflect() protoreflect.Message {
	mi := &file_vega_checkpoint_v1_checkpoint_proto_msgTypes[32]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TWNotionalPosition.ProtoReflect.Descriptor instead.
func (*TWNotionalPosition) Descriptor() ([]byte, []int) {
	return file_vega_checkpoint_v1_checkpoint_proto_rawDescGZIP(), []int{32}
}

func (x *TWNotionalPosition) GetParty() string {
	if x != nil {
		return x.Party
	}
	return ""
...
func (x *TWNotionalPosition) GetPosition() []byte {
	if x != nil {
		return x.Position
	}
	return nil
...
func (x *TWNotionalPosition) GetTime() int64 {
	if x != nil {
		return x.Time
	}
	return 0
...
func (x *TWNotionalPosition) GetPrice() []byte {
	if x != nil {
		return x.Price
	}
	return nil
...
func (x *TWNotionalPosition) GetTwNotionalPosition() []byte {
	if x != nil {
		return x.TwNotionalPosition
	}
	return nil
}
...
type TWPositionData struct {
	...
	Position []byte           `protobuf:"bytes,2,opt,name=position,proto3" json:"position,omitempty"`
	Time     int64            `protobuf:"varint,3,opt,name=time,proto3" json:"time,omitempty"`
	Data     *DataWithHistory `protobuf:"bytes,4,opt,name=data,proto3" json:"data,omitempty"`
}
...
func (x *TWPositionData) GetPosition() []byte {
	if x != nil {
		return x.Position
	}
	return nil
...
func (x *TWPositionData) GetData() *DataWithHistory {
	if x != nil {
		return x.Data
	}
	return nil
...
type DataWithHistory struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	RunningTotal        []byte   `protobuf:"bytes,1,opt,name=running_total,json=runningTotal,proto3" json:"running_total,omitempty"`
	PreviousEpochs      [][]byte `protobuf:"bytes,2,rep,name=previous_epochs,json=previousEpochs,proto3" json:"previous_epochs,omitempty"`
	PreviousEpochsIndex uint64   `protobuf:"varint,3,opt,name=previous_epochs_index,json=previousEpochsIndex,proto3" json:"previous_epochs_index,omitempty"`
}

func (x *DataWithHistory) Reset() {
	*x = DataWithHistory{}
	if protoimpl.UnsafeEnabled {
...
func (x *DataWithHistory) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DataWithHistory) ProtoMessage() {}

func (x *DataWithHistory) ProtoReflect() protoreflect.Message {
	mi := &file_vega_checkpoint_v1_checkpoint_proto_msgTypes[34]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DataWithHistory.ProtoReflect.Descriptor instead.
func (*DataWithHistory) Descriptor() ([]byte, []int) {
	return file_vega_checkpoint_v1_checkpoint_proto_rawDescGZIP(), []int{34}
}

func (x *DataWithHistory) GetRunningTotal() []byte {
	if x != nil {
...
func (x *DataWithHistory) GetPreviousEpochs() [][]byte {
	if x != nil {
		return x.PreviousEpochs
	}
	return nil
}

func (x *DataWithHistory) GetPreviousEpochsIndex() uint64 {
	if x != nil {
		return x.PreviousEpochsIndex
	}
	return 0
}

type PartyFeeData struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *PartyFeeData) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PartyFeeData) ProtoMessage() {}

func (x *PartyFeeData) ProtoReflect() protoreflect.Message {
	mi := &file_vega_checkpoint_v1_checkpoint_proto_msgTypes[35]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PartyFeeData.ProtoReflect.Descriptor instead.
func (*PartyFeeData) Descriptor() ([]byte, []int) {
	return file_vega_checkpoint_v1_checkpoint_proto_rawDescGZIP(), []int{35}
}

func (x *PartyFeeData) GetParty() string {
	if x != nil {
		return x.Party
	}
	return ""
...
func (x *PartyFeeData) GetData() *DataWithHistory {
	if x != nil {
		return x.Data
	}
	return nil
...
var file_vega_checkpoint_v1_checkpoint_proto_rawDesc = []byte{
	...
	0xba, 0x09, 0x0a, 0x15, 0x4d, 0x61, 0x72, 0x6b, 0x65, 0x74, 0x41, 0x63, 0x74, 0x69, 0x76, 0x69,
	...
	,
	...
	,
	...
	,
	...
	0x65, 0x22, 0x5c, 0x0a, 0x0b, 0x52, 0x65, 0x74, 0x75, 0x72, 0x6e, 0x73, 0x44, 0x61, 0x74, 0x61,
	0x12, 0x14, 0x0a, 0x05, 0x70, 0x61, 0x72, 0x74, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x05, 0x70, 0x61, 0x72, 0x74, 0x79, 0x12, 0x37, 0x0a, 0x04, 0x64, 0x61, 0x74, 0x61, 0x18, 0x02,
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x23, 0x2e, 0x76, 0x65, 0x67, 0x61, 0x2e, 0x63, 0x68, 0x65, 0x63,
	0x6b, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x2e, 0x76, 0x31, 0x2e, 0x44, 0x61, 0x74, 0x61, 0x57, 0x69,
	0x74, 0x68, 0x48, 0x69, 0x73, 0x74, 0x6f, 0x72, 0x79, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x22,
	0xa2, 0x01, 0x0a, 0x12, 0x54, 0x57, 0x4e, 0x6f, 0x74, 0x69, 0x6f, 0x6e, 0x61, 0x6c, 0x50, 0x6f,
	...
	0x70, 0x6f, 0x73, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x08,
	...
	0x70, 0x72, 0x69, 0x63, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x05, 0x70, 0x72, 0x69,
	0x63, 0x65, 0x12, 0x30, 0x0a, 0x14, 0x74, 0x77, 0x5f, 0x6e, 0x6f, 0x74, 0x69, 0x6f, 0x6e, 0x61,
	0x6c, 0x5f, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0c,
	0x52, 0x12, 0x74, 0x77, 0x4e, 0x6f, 0x74, 0x69, 0x6f, 0x6e, 0x61, 0x6c, 0x50, 0x6f, 0x73, 0x69,
	0x74, 0x69, 0x6f, 0x6e, 0x22, 0x8f, 0x01, 0x0a, 0x0e, 0x54, 0x57, 0x50, 0x6f, 0x73, 0x69, 0x74,
	...
	,
	...
	0x22, 0x8d, 0x04, 0x0a, 0x0b, 0x41, 0x73, 0x73, 0x65, 0x74, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e,
...
var file_vega_checkpoint_v1_checkpoint_proto_msgTypes = make([]protoimpl.MessageInfo, 41)
var file_vega_checkpoint_v1_checkpoint_proto_goTypes = []interface{}{
	...
	(*TakerNotionalVolume)(nil),               // 30: vega.checkpoint.v1.TakerNotionalVolume
	(*ReturnsData)(nil),                       // 31: vega.checkpoint.v1.ReturnsData
	(*TWNotionalPosition)(nil),                // 32: vega.checkpoint.v1.TWNotionalPosition
	(*TWPositionData)(nil),                    // 33: vega.checkpoint.v1.TWPositionData
	(*DataWithHistory)(nil),                   // 34: vega.checkpoint.v1.DataWithHistory
	(*PartyFeeData)(nil),                      // 35: vega.checkpoint.v1.PartyFeeData
	(*PartyFees)(nil),                         // 36: vega.checkpoint.v1.PartyFees
	(*AssetAction)(nil),                       // 37: vega.checkpoint.v1.AssetAction
	(*ELSShare)(nil),                          // 38: vega.checkpoint.v1.ELSShare
	(*MarketState)(nil),                       // 39: vega.checkpoint.v1.MarketState
	(*ExecutionState)(nil),                    // 40: vega.checkpoint.v1.ExecutionState
	(*vega.AssetDetails)(nil),                 // 41: vega.AssetDetails
	(*vega.NetworkParameter)(nil),             // 42: vega.NetworkParameter
	(*vega.Proposal)(nil),                     // 43: vega.Proposal
	(*vega.Transfer)(nil),                     // 44: vega.Transfer
	(vega.AccountType)(0),                     // 45: vega.AccountType
	(*v1.Transfer)(nil),                       // 46: vega.events.v1.Transfer
	(v1.Transfer_Status)(0),                   // 47: vega.events.v1.Transfer.Status
	(*vega.NewTransferConfiguration)(nil),     // 48: vega.NewTransferConfiguration
	(*v1.ValidatorUpdate)(nil),                // 49: vega.events.v1.ValidatorUpdate
	(*vega.RankingScore)(nil),                 // 50: vega.RankingScore
	(*v1.StakeLinking)(nil),                   // 51: vega.events.v1.StakeLinking
	(*v1.ERC20MultiSigSignerEvent)(nil),       // 52: vega.events.v1.ERC20MultiSigSignerEvent
	(*v1.ERC20MultiSigThresholdSetEvent)(nil), // 53: vega.events.v1.ERC20MultiSigThresholdSetEvent
	(*vega.BuiltinAssetDeposit)(nil),          // 54: vega.BuiltinAssetDeposit
	(*vega.ERC20Deposit)(nil),                 // 55: vega.ERC20Deposit
	(*vega.ERC20AssetList)(nil),               // 56: vega.ERC20AssetList
	(*vega.ERC20AssetLimitsUpdated)(nil),      // 57: vega.ERC20AssetLimitsUpdated
	(*vega.Market)(nil),                       // 58: vega.Market
}
var file_vega_checkpoint_v1_checkpoint_proto_depIdxs = []int32{
	41, // 0: vega.checkpoint.v1.AssetEntry.asset_details:type_name -> vega.AssetDetails
	...
	42, // 4: vega.checkpoint.v1.NetParams.params:type_name -> vega.NetworkParameter
	43, // 5: vega.checkpoint.v1.Proposals.proposals:type_name -> vega.Proposal
	...
	44, // 11: vega.checkpoint.v1.ScheduledTransfer.transfer:type_name -> vega.Transfer
	45, // 12: vega.checkpoint.v1.ScheduledTransfer.account_type:type_name -> vega.AccountType
	46, // 13: vega.checkpoint.v1.ScheduledTransfer.oneoff_transfer:type_name -> vega.events.v1.Transfer
	17, // 14: vega.checkpoint.v1.ScheduledTransferAtTime.transfers:type_name -> vega.checkpoint.v1.ScheduledTransfer
	46, // 15: vega.checkpoint.v1.RecurringTransfers.recurring_transfers:type_name -> vega.events.v1.Transfer
	47, // 16: vega.checkpoint.v1.GovernanceTransfer.status:type_name -> vega.events.v1.Transfer.Status
	48, // 17: vega.checkpoint.v1.GovernanceTransfer.config:type_name -> vega.NewTransferConfiguration
	...
	37, // 22: vega.checkpoint.v1.Banking.asset_actions:type_name -> vega.checkpoint.v1.AssetAction
	...
	49, // 28: vega.checkpoint.v1.ValidatorState.validator_update:type_name -> vega.events.v1.ValidatorUpdate
	50, // 29: vega.checkpoint.v1.ValidatorState.ranking_score:type_name -> vega.RankingScore
	51, // 30: vega.checkpoint.v1.Staking.accepted:type_name -> vega.events.v1.StakeLinking
	52, // 31: vega.checkpoint.v1.MultisigControl.signers:type_name -> vega.events.v1.ERC20MultiSigSignerEvent
	53, // 32: vega.checkpoint.v1.MultisigControl.threshold_set:type_name -> vega.events.v1.ERC20MultiSigThresholdSetEvent
	29, // 33: vega.checkpoint.v1.MarketTracker.market_activity:type_name -> vega.checkpoint.v1.MarketActivityTracker
	30, // 34: vega.checkpoint.v1.MarketTracker.taker_notional_volume:type_name -> vega.checkpoint.v1.TakerNotionalVolume
	36, // 35: vega.checkpoint.v1.MarketActivityTracker.maker_fees_received:type_name -> vega.checkpoint.v1.PartyFees
	36, // 36: vega.checkpoint.v1.MarketActivityTracker.maker_fees_paid:type_name -> vega.checkpoint.v1.PartyFees
	36, // 37: vega.checkpoint.v1.MarketActivityTracker.lp_fees:type_name -> vega.checkpoint.v1.PartyFees
	35, // 38: vega.checkpoint.v1.MarketActivityTracker.maker_fees_received_history:type_name -> vega.checkpoint.v1.PartyFeeData
	35, // 39: vega.checkpoint.v1.MarketActivityTracker.maker_fees_paid_history:type_name -> vega.checkpoint.v1.PartyFeeData
	35, // 40: vega.checkpoint.v1.MarketActivityTracker.lp_fees_history:type_name -> vega.checkpoint.v1.PartyFeeData
	33, // 41: vega.checkpoint.v1.MarketActivityTracker.time_weighted_position_history:type_name -> vega.checkpoint.v1.TWPositionData
	31, // 42: vega.checkpoint.v1.MarketActivityTracker.returns_data:type_name -> vega.checkpoint.v1.ReturnsData
	32, // 43: vega.checkpoint.v1.MarketActivityTracker.time_weighted_notional_position:type_name -> vega.checkpoint.v1.TWNotionalPosition
	34, // 44: vega.checkpoint.v1.MarketActivityTracker.total_maker_fees_received:type_name -> vega.checkpoint.v1.DataWithHistory
	34, // 45: vega.checkpoint.v1.MarketActivityTracker.total_maker_fees_paid:type_name -> vega.checkpoint.v1.DataWithHistory
	34, // 46: vega.checkpoint.v1.MarketActivityTracker.total_lp_fees:type_name -> vega.checkpoint.v1.DataWithHistory
	34, // 47: vega.checkpoint.v1.ReturnsData.data:type_name -> vega.checkpoint.v1.DataWithHistory
	34, // 48: vega.checkpoint.v1.TWPositionData.data:type_name -> vega.checkpoint.v1.DataWithHistory
	34, // 49: vega.checkpoint.v1.PartyFeeData.data:type_name -> vega.checkpoint.v1.DataWithHistory
	54, // 50: vega.checkpoint.v1.AssetAction.builtin_deposit:type_name -> vega.BuiltinAssetDeposit
	55, // 51: vega.checkpoint.v1.AssetAction.erc20_deposit:type_name -> vega.ERC20Deposit
	56, // 52: vega.checkpoint.v1.AssetAction.asset_list:type_name -> vega.ERC20AssetList
	57, // 53: vega.checkpoint.v1.AssetAction.erc20_asset_limits_updated:type_name -> vega.ERC20AssetLimitsUpdated
	38, // 54: vega.checkpoint.v1.MarketState.shares:type_name -> vega.checkpoint.v1.ELSShare
	58, // 55: vega.checkpoint.v1.MarketState.market:type_name -> vega.Market
	39, // 56: vega.checkpoint.v1.ExecutionState.data:type_name -> vega.checkpoint.v1.MarketState
...
func file_vega_checkpoint_v1_checkpoint_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_vega_checkpoint_v1_checkpoint_proto_msgTypes[32].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TWNotionalPosition); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
