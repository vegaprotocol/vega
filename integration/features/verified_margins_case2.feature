Feature: CASE-2: Trader submits long order that will trade - new formula & low exit price
  ...
  Background:
    ...
    And traders place following orders with references:
      ...
      | buySideMM  | ETH/DEC19 | buy  | 15     | 8000000  | 0      | LIMIT | GTC | _buy3     |
      | buySideMM  | ETH/DEC19 | buy  | 50     | 7700000  | 0      | LIMIT | GTC | _buy4     |
  ...
  Scenario:
    ...
    Then traders place following orders:
      | trader     | market id | type | volume | price    | trades | type  | tif |
      | sellSideMM | ETH/DEC19 | sell | 1      | 10000000 | 0      | LIMIT | GTC |
      | buySideMM  | ETH/DEC19 | buy  | 1      | 10000000 | 1      | LIMIT | GTC |
    ...
    Then traders place following orders:
      | trader  | market id | type | volume | price   | trades | type  | tif |
      | trader1 | ETH/DEC19 | sell | 10     | 8000000 | 1      | LIMIT | GTC |
    And I expect the trader to have a margin:
      | trader  | asset | market id | margin  | general   |
    ...
    Then traders place following orders:
      | trader  | market id | type | volume | price   | trades | type  | tif |
      | trader1 | ETH/DEC19 | sell | 3      | 7000000 | 1      | LIMIT | GTC |
    And I expect the trader to have a margin:
      | trader  | asset | market id | margin | general   |
