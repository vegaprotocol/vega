...
var file_vega_snapshot_v1_snapshot_proto_rawDesc = []byte{
	...
	0x9a, 0x0b, 0x0a, 0x06, 0x4d, 0x61, 0x72, 0x6b, 0x65, 0x74, 0x12, 0x24, 0x0a, 0x06, 0x6d, 0x61,
	...
	0x4d, 0x61, 0x72, 0x67, 0x69, 0x6e, 0x46, 0x61, 0x63, 0x74, 0x6f, 0x72, 0x22, 0x4e, 0x0a, 0x11,
	0x50, 0x61, 0x72, 0x74, 0x79, 0x4d, 0x61, 0x72, 0x67, 0x69, 0x6e, 0x46, 0x61, 0x63, 0x74, 0x6f,
	0x72, 0x12, 0x14, 0x0a, 0x05, 0x70, 0x61, 0x72, 0x74, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x05, 0x70, 0x61, 0x72, 0x74, 0x79, 0x12, 0x23, 0x0a, 0x0d, 0x6d, 0x61, 0x72, 0x67, 0x69,
	0x6e, 0x5f, 0x66, 0x61, 0x63, 0x74, 0x6f, 0x72, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0c,
	0x6d, 0x61, 0x72, 0x67, 0x69, 0x6e, 0x46, 0x61, 0x63, 0x74, 0x6f, 0x72, 0x22, 0x42, 0x0a, 0x07,
...
var file_vega_snapshot_v1_snapshot_proto_goTypes = []interface{}{
	...
	(*PartyMarginFactor)(nil),                     // 65: vega.snapshot.v1.PartyMarginFactor
	(*Product)(nil),                               // 66: vega.snapshot.v1.Product
	(*DataPoint)(nil),                             // 67: vega.snapshot.v1.DataPoint
	(*AuctionIntervals)(nil),                      // 68: vega.snapshot.v1.AuctionIntervals
	(*TWAPData)(nil),                              // 69: vega.snapshot.v1.TWAPData
	(*Perps)(nil),                                 // 70: vega.snapshot.v1.Perps
	(*OrdersAtPrice)(nil),                         // 71: vega.snapshot.v1.OrdersAtPrice
	(*PricedStopOrders)(nil),                      // 72: vega.snapshot.v1.PricedStopOrders
	(*TrailingStopOrders)(nil),                    // 73: vega.snapshot.v1.TrailingStopOrders
	(*OrdersAtOffset)(nil),                        // 74: vega.snapshot.v1.OrdersAtOffset
	(*OffsetsAtPrice)(nil),                        // 75: vega.snapshot.v1.OffsetsAtPrice
	(*StopOrders)(nil),                            // 76: vega.snapshot.v1.StopOrders
	(*PeggedOrders)(nil),                          // 77: vega.snapshot.v1.PeggedOrders
	(*SLANetworkParams)(nil),                      // 78: vega.snapshot.v1.SLANetworkParams
	(*ExecutionMarkets)(nil),                      // 79: vega.snapshot.v1.ExecutionMarkets
	(*Successors)(nil),                            // 80: vega.snapshot.v1.Successors
	(*Position)(nil),                              // 81: vega.snapshot.v1.Position
	(*MarketPositions)(nil),                       // 82: vega.snapshot.v1.MarketPositions
	(*PartyPositionStats)(nil),                    // 83: vega.snapshot.v1.PartyPositionStats
	(*SettlementState)(nil),                       // 84: vega.snapshot.v1.SettlementState
	(*LastSettledPosition)(nil),                   // 85: vega.snapshot.v1.LastSettledPosition
	(*SettlementTrade)(nil),                       // 86: vega.snapshot.v1.SettlementTrade
	(*AppState)(nil),                              // 87: vega.snapshot.v1.AppState
	(*EpochState)(nil),                            // 88: vega.snapshot.v1.EpochState
	(*RewardsPendingPayouts)(nil),                 // 89: vega.snapshot.v1.RewardsPendingPayouts
	(*ScheduledRewardsPayout)(nil),                // 90: vega.snapshot.v1.ScheduledRewardsPayout
	(*RewardsPayout)(nil),                         // 91: vega.snapshot.v1.RewardsPayout
	(*RewardsPartyAmount)(nil),                    // 92: vega.snapshot.v1.RewardsPartyAmount
	(*LimitState)(nil),                            // 93: vega.snapshot.v1.LimitState
	(*VoteSpamPolicy)(nil),                        // 94: vega.snapshot.v1.VoteSpamPolicy
	(*PartyProposalVoteCount)(nil),                // 95: vega.snapshot.v1.PartyProposalVoteCount
	(*PartyTokenBalance)(nil),                     // 96: vega.snapshot.v1.PartyTokenBalance
	(*BlockRejectStats)(nil),                      // 97: vega.snapshot.v1.BlockRejectStats
	(*SpamPartyTransactionCount)(nil),             // 98: vega.snapshot.v1.SpamPartyTransactionCount
	(*SimpleSpamPolicy)(nil),                      // 99: vega.snapshot.v1.SimpleSpamPolicy
	(*NotarySigs)(nil),                            // 100: vega.snapshot.v1.NotarySigs
	(*Notary)(nil),                                // 101: vega.snapshot.v1.Notary
	(*StakeVerifierDeposited)(nil),                // 102: vega.snapshot.v1.StakeVerifierDeposited
	(*StakeVerifierRemoved)(nil),                  // 103: vega.snapshot.v1.StakeVerifierRemoved
	(*StakeVerifierPending)(nil),                  // 104: vega.snapshot.v1.StakeVerifierPending
	(*EthOracleVerifierLastBlock)(nil),            // 105: vega.snapshot.v1.EthOracleVerifierLastBlock
	(*EthContractCallResults)(nil),                // 106: vega.snapshot.v1.EthContractCallResults
	(*EthContractCallResult)(nil),                 // 107: vega.snapshot.v1.EthContractCallResult
	(*PendingKeyRotation)(nil),                    // 108: vega.snapshot.v1.PendingKeyRotation
	(*PendingEthereumKeyRotation)(nil),            // 109: vega.snapshot.v1.PendingEthereumKeyRotation
	(*Topology)(nil),                              // 110: vega.snapshot.v1.Topology
	(*ToplogySignatures)(nil),                     // 111: vega.snapshot.v1.ToplogySignatures
	(*PendingERC20MultisigControlSignature)(nil),  // 112: vega.snapshot.v1.PendingERC20MultisigControlSignature
	(*IssuedERC20MultisigControlSignature)(nil),   // 113: vega.snapshot.v1.IssuedERC20MultisigControlSignature
	(*ValidatorState)(nil),                        // 114: vega.snapshot.v1.ValidatorState
	(*HeartbeatTracker)(nil),                      // 115: vega.snapshot.v1.HeartbeatTracker
	(*PerformanceStats)(nil),                      // 116: vega.snapshot.v1.PerformanceStats
	(*ValidatorPerformance)(nil),                  // 117: vega.snapshot.v1.ValidatorPerformance
	(*LiquidityParameters)(nil),                   // 118: vega.snapshot.v1.LiquidityParameters
	(*LiquidityPendingProvisions)(nil),            // 119: vega.snapshot.v1.LiquidityPendingProvisions
	(*LiquidityPartiesLiquidityOrders)(nil),       // 120: vega.snapshot.v1.LiquidityPartiesLiquidityOrders
	(*PartyOrders)(nil),                           // 121: vega.snapshot.v1.PartyOrders
	(*LiquidityPartiesOrders)(nil),                // 122: vega.snapshot.v1.LiquidityPartiesOrders
	(*LiquidityProvisions)(nil),                   // 123: vega.snapshot.v1.LiquidityProvisions
	(*LiquidityScores)(nil),                       // 124: vega.snapshot.v1.LiquidityScores
	(*LiquidityScore)(nil),                        // 125: vega.snapshot.v1.LiquidityScore
	(*LiquidityV2Parameters)(nil),                 // 126: vega.snapshot.v1.LiquidityV2Parameters
	(*LiquidityV2PaidFeesStats)(nil),              // 127: vega.snapshot.v1.LiquidityV2PaidFeesStats
	(*LiquidityV2Provisions)(nil),                 // 128: vega.snapshot.v1.LiquidityV2Provisions
	(*LiquidityV2PendingProvisions)(nil),          // 129: vega.snapshot.v1.LiquidityV2PendingProvisions
	(*LiquidityV2Performances)(nil),               // 130: vega.snapshot.v1.LiquidityV2Performances
	(*LiquidityV2PerformancePerParty)(nil),        // 131: vega.snapshot.v1.LiquidityV2PerformancePerParty
	(*LiquidityV2Scores)(nil),                     // 132: vega.snapshot.v1.LiquidityV2Scores
	(*LiquidityV2Supplied)(nil),                   // 133: vega.snapshot.v1.LiquidityV2Supplied
	(*FloatingPointConsensus)(nil),                // 134: vega.snapshot.v1.FloatingPointConsensus
	(*StateVarInternalState)(nil),                 // 135: vega.snapshot.v1.StateVarInternalState
	(*FloatingPointValidatorResult)(nil),          // 136: vega.snapshot.v1.FloatingPointValidatorResult
	(*NextTimeTrigger)(nil),                       // 137: vega.snapshot.v1.NextTimeTrigger
	(*MarketTracker)(nil),                         // 138: vega.snapshot.v1.MarketTracker
	(*SignerEventsPerAddress)(nil),                // 139: vega.snapshot.v1.SignerEventsPerAddress
	(*ERC20MultiSigTopologyVerified)(nil),         // 140: vega.snapshot.v1.ERC20MultiSigTopologyVerified
	(*ERC20MultiSigTopologyPending)(nil),          // 141: vega.snapshot.v1.ERC20MultiSigTopologyPending
	(*ProofOfWork)(nil),                           // 142: vega.snapshot.v1.ProofOfWork
	(*BannedParty)(nil),                           // 143: vega.snapshot.v1.BannedParty
	(*ProofOfWorkParams)(nil),                     // 144: vega.snapshot.v1.ProofOfWorkParams
	(*ProofOfWorkState)(nil),                      // 145: vega.snapshot.v1.ProofOfWorkState
	(*ProofOfWorkBlockState)(nil),                 // 146: vega.snapshot.v1.ProofOfWorkBlockState
	(*ProofOfWorkPartyStateForBlock)(nil),         // 147: vega.snapshot.v1.ProofOfWorkPartyStateForBlock
	(*TransactionsAtHeight)(nil),                  // 148: vega.snapshot.v1.TransactionsAtHeight
	(*NonceRef)(nil),                              // 149: vega.snapshot.v1.NonceRef
	(*NonceRefsAtHeight)(nil),                     // 150: vega.snapshot.v1.NonceRefsAtHeight
	(*ProtocolUpgradeProposals)(nil),              // 151: vega.snapshot.v1.ProtocolUpgradeProposals
	(*AcceptedProtocolUpgradeProposal)(nil),       // 152: vega.snapshot.v1.AcceptedProtocolUpgradeProposal
	(*Teams)(nil),                                 // 153: vega.snapshot.v1.Teams
	(*Team)(nil),                                  // 154: vega.snapshot.v1.Team
	(*Membership)(nil),                            // 155: vega.snapshot.v1.Membership
	(*TeamSwitches)(nil),                          // 156: vega.snapshot.v1.TeamSwitches
	(*TeamSwitch)(nil),                            // 157: vega.snapshot.v1.TeamSwitch
	(*Vesting)(nil),                               // 158: vega.snapshot.v1.Vesting
	(*PartyReward)(nil),                           // 159: vega.snapshot.v1.PartyReward
	(*ReferralProgramData)(nil),                   // 160: vega.snapshot.v1.ReferralProgramData
	(*ReferralSet)(nil),                           // 161: vega.snapshot.v1.ReferralSet
	(*RunningVolume)(nil),                         // 162: vega.snapshot.v1.RunningVolume
	(*FactorByReferee)(nil),                       // 163: vega.snapshot.v1.FactorByReferee
	(*AssetLocked)(nil),                           // 164: vega.snapshot.v1.AssetLocked
	(*EpochBalance)(nil),                          // 165: vega.snapshot.v1.EpochBalance
	(*InVesting)(nil),                             // 166: vega.snapshot.v1.InVesting
	(*ActivityStreak)(nil),                        // 167: vega.snapshot.v1.ActivityStreak
	(*PartyActivityStreak)(nil),                   // 168: vega.snapshot.v1.PartyActivityStreak
	(*VolumeDiscountProgram)(nil),                 // 169: vega.snapshot.v1.VolumeDiscountProgram
	(*VolumeDiscountStats)(nil),                   // 170: vega.snapshot.v1.VolumeDiscountStats
	(*EpochPartyVolumes)(nil),                     // 171: vega.snapshot.v1.EpochPartyVolumes
	(*PartyVolume)(nil),                           // 172: vega.snapshot.v1.PartyVolume
	(*Liquidation)(nil),                           // 173: vega.snapshot.v1.Liquidation
...
var file_vega_snapshot_v1_snapshot_proto_depIdxs = []int32{
	...
	79,  // 20: vega.snapshot.v1.Payload.execution_markets:type_name -> vega.snapshot.v1.ExecutionMarkets
	82,  // 21: vega.snapshot.v1.Payload.market_positions:type_name -> vega.snapshot.v1.MarketPositions
	87,  // 22: vega.snapshot.v1.Payload.app_state:type_name -> vega.snapshot.v1.AppState
	88,  // 23: vega.snapshot.v1.Payload.epoch:type_name -> vega.snapshot.v1.EpochState
	89,  // 24: vega.snapshot.v1.Payload.rewards_pending_payouts:type_name -> vega.snapshot.v1.RewardsPendingPayouts
	45,  // 25: vega.snapshot.v1.Payload.governance_node:type_name -> vega.snapshot.v1.GovernanceNode
	93,  // 26: vega.snapshot.v1.Payload.limit_state:type_name -> vega.snapshot.v1.LimitState
	94,  // 27: vega.snapshot.v1.Payload.vote_spam_policy:type_name -> vega.snapshot.v1.VoteSpamPolicy
	99,  // 28: vega.snapshot.v1.Payload.simple_spam_policy:type_name -> vega.snapshot.v1.SimpleSpamPolicy
	101, // 29: vega.snapshot.v1.Payload.notary:type_name -> vega.snapshot.v1.Notary
	19,  // 30: vega.snapshot.v1.Payload.event_forwarder:type_name -> vega.snapshot.v1.EventForwarder
	102, // 31: vega.snapshot.v1.Payload.stake_verifier_deposited:type_name -> vega.snapshot.v1.StakeVerifierDeposited
	103, // 32: vega.snapshot.v1.Payload.stake_verifier_removed:type_name -> vega.snapshot.v1.StakeVerifierRemoved
	...
	110, // 35: vega.snapshot.v1.Payload.topology:type_name -> vega.snapshot.v1.Topology
	14,  // 36: vega.snapshot.v1.Payload.oracle_data:type_name -> vega.snapshot.v1.OracleDataBatch
	118, // 37: vega.snapshot.v1.Payload.liquidity_parameters:type_name -> vega.snapshot.v1.LiquidityParameters
	119, // 38: vega.snapshot.v1.Payload.liquidity_pending_provisions:type_name -> vega.snapshot.v1.LiquidityPendingProvisions
	120, // 39: vega.snapshot.v1.Payload.liquidity_parties_liquidity_orders:type_name -> vega.snapshot.v1.LiquidityPartiesLiquidityOrders
	122, // 40: vega.snapshot.v1.Payload.liquidity_parties_orders:type_name -> vega.snapshot.v1.LiquidityPartiesOrders
	123, // 41: vega.snapshot.v1.Payload.liquidity_provisions:type_name -> vega.snapshot.v1.LiquidityProvisions
	...
	134, // 44: vega.snapshot.v1.Payload.floating_point_consensus:type_name -> vega.snapshot.v1.FloatingPointConsensus
	138, // 45: vega.snapshot.v1.Payload.market_tracker:type_name -> vega.snapshot.v1.MarketTracker
	...
	140, // 48: vega.snapshot.v1.Payload.erc20_multisig_topology_verified:type_name -> vega.snapshot.v1.ERC20MultiSigTopologyVerified
	141, // 49: vega.snapshot.v1.Payload.erc20_multisig_topology_pending:type_name -> vega.snapshot.v1.ERC20MultiSigTopologyPending
	142, // 50: vega.snapshot.v1.Payload.proof_of_work:type_name -> vega.snapshot.v1.ProofOfWork
	24,  // 51: vega.snapshot.v1.Payload.pending_asset_updates:type_name -> vega.snapshot.v1.PendingAssetUpdates
	151, // 52: vega.snapshot.v1.Payload.protocol_upgrade_proposals:type_name -> vega.snapshot.v1.ProtocolUpgradeProposals
	36,  // 53: vega.snapshot.v1.Payload.banking_bridge_state:type_name -> vega.snapshot.v1.BankingBridgeState
	84,  // 54: vega.snapshot.v1.Payload.settlement_state:type_name -> vega.snapshot.v1.SettlementState
	124, // 55: vega.snapshot.v1.Payload.liquidity_scores:type_name -> vega.snapshot.v1.LiquidityScores
	...
	106, // 59: vega.snapshot.v1.Payload.eth_contract_call_results:type_name -> vega.snapshot.v1.EthContractCallResults
	105, // 60: vega.snapshot.v1.Payload.eth_oracle_verifier_last_block:type_name -> vega.snapshot.v1.EthOracleVerifierLastBlock
	128, // 61: vega.snapshot.v1.Payload.liquidity_v2_provisions:type_name -> vega.snapshot.v1.LiquidityV2Provisions
	129, // 62: vega.snapshot.v1.Payload.liquidity_v2_pending_provisions:type_name -> vega.snapshot.v1.LiquidityV2PendingProvisions
	130, // 63: vega.snapshot.v1.Payload.liquidity_v2_performances:type_name -> vega.snapshot.v1.LiquidityV2Performances
	133, // 64: vega.snapshot.v1.Payload.liquidity_v2_supplied:type_name -> vega.snapshot.v1.LiquidityV2Supplied
	132, // 65: vega.snapshot.v1.Payload.liquidity_v2_scores:type_name -> vega.snapshot.v1.LiquidityV2Scores
	7,   // 66: vega.snapshot.v1.Payload.holding_account_tracker:type_name -> vega.snapshot.v1.HoldingAccountTracker
	153, // 67: vega.snapshot.v1.Payload.teams:type_name -> vega.snapshot.v1.Teams
	156, // 68: vega.snapshot.v1.Payload.team_switches:type_name -> vega.snapshot.v1.TeamSwitches
	158, // 69: vega.snapshot.v1.Payload.vesting:type_name -> vega.snapshot.v1.Vesting
	160, // 70: vega.snapshot.v1.Payload.referral_program:type_name -> vega.snapshot.v1.ReferralProgramData
	167, // 71: vega.snapshot.v1.Payload.activity_streak:type_name -> vega.snapshot.v1.ActivityStreak
	169, // 72: vega.snapshot.v1.Payload.volume_discount_program:type_name -> vega.snapshot.v1.VolumeDiscountProgram
	126, // 73: vega.snapshot.v1.Payload.liquidity_v2_parameters:type_name -> vega.snapshot.v1.LiquidityV2Parameters
	127, // 74: vega.snapshot.v1.Payload.liquidity_v2_paid_fees_stats:type_name -> vega.snapshot.v1.LiquidityV2PaidFeesStats
	173, // 75: vega.snapshot.v1.Payload.liquidation:type_name -> vega.snapshot.v1.Liquidation
	...
	174, // 84: vega.snapshot.v1.OracleData.signers:type_name -> vega.data.v1.Signer
	16,  // 85: vega.snapshot.v1.OracleData.data:type_name -> vega.snapshot.v1.OracleDataPair
	175, // 86: vega.snapshot.v1.OracleData.meta_data:type_name -> vega.data.v1.Property
	18,  // 87: vega.snapshot.v1.Witness.resources:type_name -> vega.snapshot.v1.Resource
	176, // 88: vega.snapshot.v1.CollateralAccounts.accounts:type_name -> vega.Account
	177, // 89: vega.snapshot.v1.CollateralAssets.assets:type_name -> vega.Asset
	177, // 90: vega.snapshot.v1.ActiveAssets.assets:type_name -> vega.Asset
	177, // 91: vega.snapshot.v1.PendingAssets.assets:type_name -> vega.Asset
	177, // 92: vega.snapshot.v1.PendingAssetUpdates.assets:type_name -> vega.Asset
	178, // 93: vega.snapshot.v1.Withdrawal.withdrawal:type_name -> vega.Withdrawal
	179, // 94: vega.snapshot.v1.Deposit.deposit:type_name -> vega.Deposit
	...
	180, // 97: vega.snapshot.v1.BankingAssetActions.asset_action:type_name -> vega.checkpoint.v1.AssetAction
	181, // 98: vega.snapshot.v1.BankingRecurringTransfers.recurring_transfers:type_name -> vega.checkpoint.v1.RecurringTransfers
	182, // 99: vega.snapshot.v1.BankingScheduledTransfers.transfers_at_time:type_name -> vega.checkpoint.v1.ScheduledTransferAtTime
	183, // 100: vega.snapshot.v1.BankingRecurringGovernanceTransfers.recurring_transfers:type_name -> vega.checkpoint.v1.GovernanceTransfer
	184, // 101: vega.snapshot.v1.BankingScheduledGovernanceTransfers.transfers_at_time:type_name -> vega.checkpoint.v1.ScheduledGovernanceTransferAtTime
	185, // 102: vega.snapshot.v1.BankingBridgeState.bridge_state:type_name -> vega.checkpoint.v1.BridgeState
	186, // 103: vega.snapshot.v1.DelegationActive.delegations:type_name -> vega.Delegation
	186, // 104: vega.snapshot.v1.DelegationPending.delegations:type_name -> vega.Delegation
	186, // 105: vega.snapshot.v1.DelegationPending.undelegation:type_name -> vega.Delegation
	187, // 106: vega.snapshot.v1.ProposalData.proposal:type_name -> vega.Proposal
	188, // 107: vega.snapshot.v1.ProposalData.yes:type_name -> vega.Vote
	188, // 108: vega.snapshot.v1.ProposalData.no:type_name -> vega.Vote
	188, // 109: vega.snapshot.v1.ProposalData.invalid:type_name -> vega.Vote
	...
	187, // 112: vega.snapshot.v1.GovernanceNode.proposals:type_name -> vega.Proposal
	189, // 113: vega.snapshot.v1.StakingAccount.events:type_name -> vega.events.v1.StakeLinking
	46,  // 114: vega.snapshot.v1.StakingAccounts.accounts:type_name -> vega.snapshot.v1.StakingAccount
	190, // 115: vega.snapshot.v1.StakingAccounts.pending_stake_total_supply:type_name -> vega.StakeTotalSupply
	191, // 116: vega.snapshot.v1.MatchingBook.buy:type_name -> vega.Order
	191, // 117: vega.snapshot.v1.MatchingBook.sell:type_name -> vega.Order
	192, // 118: vega.snapshot.v1.NetParams.params:type_name -> vega.NetworkParameter
	193, // 119: vega.snapshot.v1.PriceBound.trigger:type_name -> vega.PriceMonitoringTrigger
	...
	194, // 128: vega.snapshot.v1.AuctionState.mode:type_name -> vega.Market.TradingMode
	194, // 129: vega.snapshot.v1.AuctionState.default_mode:type_name -> vega.Market.TradingMode
	195, // 130: vega.snapshot.v1.AuctionState.trigger:type_name -> vega.AuctionTrigger
	196, // 131: vega.snapshot.v1.AuctionState.end:type_name -> vega.AuctionDuration
	195, // 132: vega.snapshot.v1.AuctionState.extension:type_name -> vega.AuctionTrigger
	60,  // 133: vega.snapshot.v1.EquityShare.lps:type_name -> vega.snapshot.v1.EquityShareLP
	197, // 134: vega.snapshot.v1.SpotMarket.market:type_name -> vega.Market
	...
	77,  // 137: vega.snapshot.v1.SpotMarket.pegged_orders:type_name -> vega.snapshot.v1.PeggedOrders
	191, // 138: vega.snapshot.v1.SpotMarket.expiring_orders:type_name -> vega.Order
	...
	76,  // 141: vega.snapshot.v1.SpotMarket.stop_orders:type_name -> vega.snapshot.v1.StopOrders
	191, // 142: vega.snapshot.v1.SpotMarket.expiring_stop_orders:type_name -> vega.Order
	198, // 143: vega.snapshot.v1.SpotMarket.fees_stats:type_name -> vega.events.v1.FeesStats
	197, // 144: vega.snapshot.v1.Market.market:type_name -> vega.Market
	...
	77,  // 147: vega.snapshot.v1.Market.pegged_orders:type_name -> vega.snapshot.v1.PeggedOrders
	191, // 148: vega.snapshot.v1.Market.expiring_orders:type_name -> vega.Order
	...
	76,  // 151: vega.snapshot.v1.Market.stop_orders:type_name -> vega.snapshot.v1.StopOrders
	191, // 152: vega.snapshot.v1.Market.expiring_stop_orders:type_name -> vega.Order
	66,  // 153: vega.snapshot.v1.Market.product:type_name -> vega.snapshot.v1.Product
	198, // 154: vega.snapshot.v1.Market.fees_stats:type_name -> vega.events.v1.FeesStats
	65,  // 155: vega.snapshot.v1.Market.party_margin_factor:type_name -> vega.snapshot.v1.PartyMarginFactor
	70,  // 156: vega.snapshot.v1.Product.perps:type_name -> vega.snapshot.v1.Perps
	67,  // 157: vega.snapshot.v1.Perps.external_data_point:type_name -> vega.snapshot.v1.DataPoint
	67,  // 158: vega.snapshot.v1.Perps.internal_data_point:type_name -> vega.snapshot.v1.DataPoint
	69,  // 159: vega.snapshot.v1.Perps.external_twap_data:type_name -> vega.snapshot.v1.TWAPData
	69,  // 160: vega.snapshot.v1.Perps.internal_twap_data:type_name -> vega.snapshot.v1.TWAPData
	68,  // 161: vega.snapshot.v1.Perps.auction_intervals:type_name -> vega.snapshot.v1.AuctionIntervals
	71,  // 162: vega.snapshot.v1.PricedStopOrders.falls_bellow:type_name -> vega.snapshot.v1.OrdersAtPrice
	71,  // 163: vega.snapshot.v1.PricedStopOrders.rises_above:type_name -> vega.snapshot.v1.OrdersAtPrice
	75,  // 164: vega.snapshot.v1.TrailingStopOrders.falls_bellow:type_name -> vega.snapshot.v1.OffsetsAtPrice
	75,  // 165: vega.snapshot.v1.TrailingStopOrders.rises_above:type_name -> vega.snapshot.v1.OffsetsAtPrice
	74,  // 166: vega.snapshot.v1.OffsetsAtPrice.offsets:type_name -> vega.snapshot.v1.OrdersAtOffset
	199, // 167: vega.snapshot.v1.StopOrders.stop_orders:type_name -> vega.events.v1.StopOrderEvent
	72,  // 168: vega.snapshot.v1.StopOrders.priced_stop_orders:type_name -> vega.snapshot.v1.PricedStopOrders
	73,  // 169: vega.snapshot.v1.StopOrders.trailing_stop_orders:type_name -> vega.snapshot.v1.TrailingStopOrders
	...
	80,  // 174: vega.snapshot.v1.ExecutionMarkets.successors:type_name -> vega.snapshot.v1.Successors
	78,  // 175: vega.snapshot.v1.ExecutionMarkets.sla_network_params:type_name -> vega.snapshot.v1.SLANetworkParams
	81,  // 176: vega.snapshot.v1.MarketPositions.positions:type_name -> vega.snapshot.v1.Position
	83,  // 177: vega.snapshot.v1.MarketPositions.parties_records:type_name -> vega.snapshot.v1.PartyPositionStats
	85,  // 178: vega.snapshot.v1.SettlementState.last_settled_positions:type_name -> vega.snapshot.v1.LastSettledPosition
	86,  // 179: vega.snapshot.v1.SettlementState.trades:type_name -> vega.snapshot.v1.SettlementTrade
	90,  // 180: vega.snapshot.v1.RewardsPendingPayouts.scheduled_rewards_payout:type_name -> vega.snapshot.v1.ScheduledRewardsPayout
	91,  // 181: vega.snapshot.v1.ScheduledRewardsPayout.rewards_payout:type_name -> vega.snapshot.v1.RewardsPayout
	92,  // 182: vega.snapshot.v1.RewardsPayout.reward_party_amount:type_name -> vega.snapshot.v1.RewardsPartyAmount
	95,  // 183: vega.snapshot.v1.VoteSpamPolicy.party_to_vote:type_name -> vega.snapshot.v1.PartyProposalVoteCount
	143, // 184: vega.snapshot.v1.VoteSpamPolicy.banned_parties:type_name -> vega.snapshot.v1.BannedParty
	96,  // 185: vega.snapshot.v1.VoteSpamPolicy.token_balance:type_name -> vega.snapshot.v1.PartyTokenBalance
	97,  // 186: vega.snapshot.v1.VoteSpamPolicy.recent_blocks_reject_stats:type_name -> vega.snapshot.v1.BlockRejectStats
	98,  // 187: vega.snapshot.v1.SimpleSpamPolicy.party_to_count:type_name -> vega.snapshot.v1.SpamPartyTransactionCount
	143, // 188: vega.snapshot.v1.SimpleSpamPolicy.banned_parties:type_name -> vega.snapshot.v1.BannedParty
	96,  // 189: vega.snapshot.v1.SimpleSpamPolicy.token_balance:type_name -> vega.snapshot.v1.PartyTokenBalance
	100, // 190: vega.snapshot.v1.Notary.notary_sigs:type_name -> vega.snapshot.v1.NotarySigs
	104, // 191: vega.snapshot.v1.StakeVerifierDeposited.pending_deposited:type_name -> vega.snapshot.v1.StakeVerifierPending
	104, // 192: vega.snapshot.v1.StakeVerifierRemoved.pending_removed:type_name -> vega.snapshot.v1.StakeVerifierPending
	107, // 193: vega.snapshot.v1.EthContractCallResults.pending_contract_call_result:type_name -> vega.snapshot.v1.EthContractCallResult
	114, // 194: vega.snapshot.v1.Topology.validator_data:type_name -> vega.snapshot.v1.ValidatorState
	108, // 195: vega.snapshot.v1.Topology.pending_pub_key_rotations:type_name -> vega.snapshot.v1.PendingKeyRotation
	117, // 196: vega.snapshot.v1.Topology.validator_performance:type_name -> vega.snapshot.v1.ValidatorPerformance
	109, // 197: vega.snapshot.v1.Topology.pending_ethereum_key_rotations:type_name -> vega.snapshot.v1.PendingEthereumKeyRotation
	111, // 198: vega.snapshot.v1.Topology.signatures:type_name -> vega.snapshot.v1.ToplogySignatures
	109, // 199: vega.snapshot.v1.Topology.unsolved_ethereum_key_rotations:type_name -> vega.snapshot.v1.PendingEthereumKeyRotation
	112, // 200: vega.snapshot.v1.ToplogySignatures.pending_signatures:type_name -> vega.snapshot.v1.PendingERC20MultisigControlSignature
	113, // 201: vega.snapshot.v1.ToplogySignatures.issued_signatures:type_name -> vega.snapshot.v1.IssuedERC20MultisigControlSignature
	201, // 202: vega.snapshot.v1.ValidatorState.validator_update:type_name -> vega.events.v1.ValidatorUpdate
	115, // 203: vega.snapshot.v1.ValidatorState.heartbeat_tracker:type_name -> vega.snapshot.v1.HeartbeatTracker
	202, // 204: vega.snapshot.v1.ValidatorState.ranking_score:type_name -> vega.RankingScore
	116, // 205: vega.snapshot.v1.ValidatorPerformance.validator_perf_stats:type_name -> vega.snapshot.v1.PerformanceStats
	121, // 206: vega.snapshot.v1.LiquidityPartiesLiquidityOrders.party_orders:type_name -> vega.snapshot.v1.PartyOrders
	191, // 207: vega.snapshot.v1.PartyOrders.orders:type_name -> vega.Order
	121, // 208: vega.snapshot.v1.LiquidityPartiesOrders.party_orders:type_name -> vega.snapshot.v1.PartyOrders
	203, // 209: vega.snapshot.v1.LiquidityProvisions.liquidity_provisions:type_name -> vega.LiquidityProvision
	125, // 210: vega.snapshot.v1.LiquidityScores.scores:type_name -> vega.snapshot.v1.LiquidityScore
	...
	131, // 215: vega.snapshot.v1.LiquidityV2Performances.performance_per_party:type_name -> vega.snapshot.v1.LiquidityV2PerformancePerParty
	125, // 216: vega.snapshot.v1.LiquidityV2Scores.scores:type_name -> vega.snapshot.v1.LiquidityScore
	12,  // 217: vega.snapshot.v1.LiquidityV2Supplied.bid_cache:type_name -> vega.snapshot.v1.LiquidityOffsetProbabilityPair
	12,  // 218: vega.snapshot.v1.LiquidityV2Supplied.ask_cache:type_name -> vega.snapshot.v1.LiquidityOffsetProbabilityPair
	137, // 219: vega.snapshot.v1.FloatingPointConsensus.next_time_trigger:type_name -> vega.snapshot.v1.NextTimeTrigger
	135, // 220: vega.snapshot.v1.FloatingPointConsensus.state_variables:type_name -> vega.snapshot.v1.StateVarInternalState
	136, // 221: vega.snapshot.v1.StateVarInternalState.validators_results:type_name -> vega.snapshot.v1.FloatingPointValidatorResult
	...
	139, // 226: vega.snapshot.v1.ERC20MultiSigTopologyVerified.events_per_address:type_name -> vega.snapshot.v1.SignerEventsPerAddress
	...
	148, // 230: vega.snapshot.v1.ProofOfWork.tx_at_height:type_name -> vega.snapshot.v1.TransactionsAtHeight
	148, // 231: vega.snapshot.v1.ProofOfWork.tid_at_height:type_name -> vega.snapshot.v1.TransactionsAtHeight
	143, // 232: vega.snapshot.v1.ProofOfWork.banned:type_name -> vega.snapshot.v1.BannedParty
	144, // 233: vega.snapshot.v1.ProofOfWork.pow_params:type_name -> vega.snapshot.v1.ProofOfWorkParams
	145, // 234: vega.snapshot.v1.ProofOfWork.pow_state:type_name -> vega.snapshot.v1.ProofOfWorkState
	150, // 235: vega.snapshot.v1.ProofOfWork.nonce_refs_at_height:type_name -> vega.snapshot.v1.NonceRefsAtHeight
	146, // 236: vega.snapshot.v1.ProofOfWorkState.pow_state:type_name -> vega.snapshot.v1.ProofOfWorkBlockState
	147, // 237: vega.snapshot.v1.ProofOfWorkBlockState.party_state:type_name -> vega.snapshot.v1.ProofOfWorkPartyStateForBlock
	149, // 238: vega.snapshot.v1.NonceRefsAtHeight.refs:type_name -> vega.snapshot.v1.NonceRef
	211, // 239: vega.snapshot.v1.ProtocolUpgradeProposals.active_proposals:type_name -> vega.events.v1.ProtocolUpgradeEvent
	152, // 240: vega.snapshot.v1.ProtocolUpgradeProposals.accepted_proposal:type_name -> vega.snapshot.v1.AcceptedProtocolUpgradeProposal
	154, // 241: vega.snapshot.v1.Teams.teams:type_name -> vega.snapshot.v1.Team
	155, // 242: vega.snapshot.v1.Team.referrer:type_name -> vega.snapshot.v1.Membership
	155, // 243: vega.snapshot.v1.Team.referees:type_name -> vega.snapshot.v1.Membership
	157, // 244: vega.snapshot.v1.TeamSwitches.team_switches:type_name -> vega.snapshot.v1.TeamSwitch
	159, // 245: vega.snapshot.v1.Vesting.parties_reward:type_name -> vega.snapshot.v1.PartyReward
	164, // 246: vega.snapshot.v1.PartyReward.asset_locked:type_name -> vega.snapshot.v1.AssetLocked
	166, // 247: vega.snapshot.v1.PartyReward.in_vesting:type_name -> vega.snapshot.v1.InVesting
	163, // 248: vega.snapshot.v1.ReferralProgramData.factor_by_referee:type_name -> vega.snapshot.v1.FactorByReferee
	...
	161, // 251: vega.snapshot.v1.ReferralProgramData.sets:type_name -> vega.snapshot.v1.ReferralSet
	155, // 252: vega.snapshot.v1.ReferralSet.referrer:type_name -> vega.snapshot.v1.Membership
	155, // 253: vega.snapshot.v1.ReferralSet.referees:type_name -> vega.snapshot.v1.Membership
	162, // 254: vega.snapshot.v1.ReferralSet.running_volumes:type_name -> vega.snapshot.v1.RunningVolume
	165, // 255: vega.snapshot.v1.AssetLocked.epoch_balances:type_name -> vega.snapshot.v1.EpochBalance
	168, // 256: vega.snapshot.v1.ActivityStreak.parties_activity_streak:type_name -> vega.snapshot.v1.PartyActivityStreak
	171, // 257: vega.snapshot.v1.VolumeDiscountProgram.epoch_party_volumes:type_name -> vega.snapshot.v1.EpochPartyVolumes
	172, // 258: vega.snapshot.v1.VolumeDiscountProgram.average_party_volume:type_name -> vega.snapshot.v1.PartyVolume
	...
	170, // 261: vega.snapshot.v1.VolumeDiscountProgram.factors_by_party:type_name -> vega.snapshot.v1.VolumeDiscountStats
	172, // 262: vega.snapshot.v1.EpochPartyVolumes.party_volume:type_name -> vega.snapshot.v1.PartyVolume
...
func file_vega_snapshot_v1_snapshot_proto_init() {
	...
	file_vega_snapshot_v1_snapshot_proto_msgTypes[82].OneofWrappers = []interface{}{}
	file_vega_snapshot_v1_snapshot_proto_msgTypes[106].OneofWrappers = []interface{}{}
	type x struct{}
