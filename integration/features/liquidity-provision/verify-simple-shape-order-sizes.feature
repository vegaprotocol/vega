Feature: Verify the order size is correctly cumulated.
  ...
  Scenario: Order from liquidity provision and from normal order submission are correctly cumulated in order book's total size.
    ...
    Given the traders make the following deposits on asset's general account:
      ...
      | trader-lp-1 | ETH   | 10000000 |

    # Trigger an auction to set the mark price
    When traders place the following orders:
      | trader  | market id | side | volume | price    | resulting trades | type       | tif     | reference |
      | trader1 | ETH/DEC19 | buy  | 1      | 11000000 | 0                | TYPE_LIMIT | TIF_GTC | trader1-1 |
      | trader2 | ETH/DEC19 | sell | 1      | 13000000 | 0                | TYPE_LIMIT | TIF_GTC | trader2-1 |
    ...
    When the trader submits LP:
      ...
      | lp1 | trader-lp-1 | ETH/DEC19 | 10000             | 0.1 | buy        | BID             | 1                | -10          |
      | lp1 | trader-lp-1 | ETH/DEC19 | 10000             | 0.1 | sell       | ASK             | 1                | 10           |
    Then I see the LP events:
      | id  | party       | market    | commitment amount | status        |
      | lp1 | trader-lp-1 | ETH/DEC19 | 10000             | STATUS_PENDING |
