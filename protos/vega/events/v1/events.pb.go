...
var file_vega_events_v1_events_proto_rawDesc = []byte{
	...
	0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x22, 0xab, 0x2a, 0x0a, 0x08,
	...
	0x79, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6b, 0x12, 0x36, 0x0a, 0x06, 0x6d, 0x61, 0x72, 0x6b, 0x65,
	...
	0x45, 0x4a, 0x45, 0x43, 0x54, 0x45, 0x44, 0x10, 0x03, 0x2a, 0xa7, 0x15, 0x0a, 0x0c, 0x42, 0x75,
	...
	0x59, 0x5f, 0x53, 0x54, 0x52, 0x45, 0x41, 0x4b, 0x10, 0x48, 0x12, 0x19, 0x0a, 0x15, 0x42, 0x55,
...
var file_vega_events_v1_events_proto_msgTypes = make([]protoimpl.MessageInfo, 61)
var file_vega_events_v1_events_proto_goTypes = []interface{}{
	...
	(*BusEvent)(nil),                            // 65: vega.events.v1.BusEvent
	(*TransactionResult_SuccessDetails)(nil),    // 66: vega.events.v1.TransactionResult.SuccessDetails
	(*TransactionResult_FailureDetails)(nil),    // 67: vega.events.v1.TransactionResult.FailureDetails
	(*v1.OrderSubmission)(nil),                  // 68: vega.commands.v1.OrderSubmission
	(*vega.StopOrder)(nil),                      // 69: vega.StopOrder
	(vega.AccountType)(0),                       // 70: vega.AccountType
	(*vega.DispatchStrategy)(nil),               // 71: vega.DispatchStrategy
	(*v1.OrderAmendment)(nil),                   // 72: vega.commands.v1.OrderAmendment
	(*v1.OrderCancellation)(nil),                // 73: vega.commands.v1.OrderCancellation
	(*v1.ProposalSubmission)(nil),               // 74: vega.commands.v1.ProposalSubmission
	(*v1.VoteSubmission)(nil),                   // 75: vega.commands.v1.VoteSubmission
	(*v1.LiquidityProvisionSubmission)(nil),     // 76: vega.commands.v1.LiquidityProvisionSubmission
	(*v1.WithdrawSubmission)(nil),               // 77: vega.commands.v1.WithdrawSubmission
	(*v1.DelegateSubmission)(nil),               // 78: vega.commands.v1.DelegateSubmission
	(*v1.UndelegateSubmission)(nil),             // 79: vega.commands.v1.UndelegateSubmission
	(*v1.LiquidityProvisionCancellation)(nil),   // 80: vega.commands.v1.LiquidityProvisionCancellation
	(*v1.LiquidityProvisionAmendment)(nil),      // 81: vega.commands.v1.LiquidityProvisionAmendment
	(*v1.Transfer)(nil),                         // 82: vega.commands.v1.Transfer
	(*v1.CancelTransfer)(nil),                   // 83: vega.commands.v1.CancelTransfer
	(*v1.AnnounceNode)(nil),                     // 84: vega.commands.v1.AnnounceNode
	(*v1.OracleDataSubmission)(nil),             // 85: vega.commands.v1.OracleDataSubmission
	(*v1.ProtocolUpgradeProposal)(nil),          // 86: vega.commands.v1.ProtocolUpgradeProposal
	(*v1.IssueSignatures)(nil),                  // 87: vega.commands.v1.IssueSignatures
	(*v1.BatchMarketInstructions)(nil),          // 88: vega.commands.v1.BatchMarketInstructions
	(*v1.KeyRotateSubmission)(nil),              // 89: vega.commands.v1.KeyRotateSubmission
	(*v1.EthereumKeyRotateSubmission)(nil),      // 90: vega.commands.v1.EthereumKeyRotateSubmission
	(*v1.StopOrdersSubmission)(nil),             // 91: vega.commands.v1.StopOrdersSubmission
	(*v1.StopOrdersCancellation)(nil),           // 92: vega.commands.v1.StopOrdersCancellation
	(*v1.CreateReferralSet)(nil),                // 93: vega.commands.v1.CreateReferralSet
	(*v1.UpdateReferralSet)(nil),                // 94: vega.commands.v1.UpdateReferralSet
	(*v1.ApplyReferralCode)(nil),                // 95: vega.commands.v1.ApplyReferralCode
	(vega.EpochAction)(0),                       // 96: vega.EpochAction
	(*vega.LedgerMovement)(nil),                 // 97: vega.LedgerMovement
	(vega.AuctionTrigger)(0),                    // 98: vega.AuctionTrigger
	(*vega.ReferralProgram)(nil),                // 99: vega.ReferralProgram
	(*vega.Order)(nil),                          // 100: vega.Order
	(*vega.Account)(nil),                        // 101: vega.Account
	(*vega.Party)(nil),                          // 102: vega.Party
	(*vega.Trade)(nil),                          // 103: vega.Trade
	(*vega.MarginLevels)(nil),                   // 104: vega.MarginLevels
	(*vega.Proposal)(nil),                       // 105: vega.Proposal
	(*vega.Vote)(nil),                           // 106: vega.Vote
	(*vega.MarketData)(nil),                     // 107: vega.MarketData
	(*v1.NodeSignature)(nil),                    // 108: vega.commands.v1.NodeSignature
	(*vega.Market)(nil),                         // 109: vega.Market
	(*vega.Asset)(nil),                          // 110: vega.Asset
	(*vega.Withdrawal)(nil),                     // 111: vega.Withdrawal
	(*vega.Deposit)(nil),                        // 112: vega.Deposit
	(*vega.RiskFactor)(nil),                     // 113: vega.RiskFactor
	(*vega.NetworkParameter)(nil),               // 114: vega.NetworkParameter
	(*vega.LiquidityProvision)(nil),             // 115: vega.LiquidityProvision
	(*vega.OracleSpec)(nil),                     // 116: vega.OracleSpec
	(*vega.OracleData)(nil),                     // 117: vega.OracleData
	(*vega.NetworkLimits)(nil),                  // 118: vega.NetworkLimits
}
var file_vega_events_v1_events_proto_depIdxs = []int32{
	...
	68,  // 1: vega.events.v1.StopOrderEvent.submission:type_name -> vega.commands.v1.OrderSubmission
	69,  // 2: vega.events.v1.StopOrderEvent.stop_order:type_name -> vega.StopOrder
	...
	70,  // 4: vega.events.v1.Transfer.from_account_type:type_name -> vega.AccountType
	70,  // 5: vega.events.v1.Transfer.to_account_type:type_name -> vega.AccountType
	...
	71,  // 11: vega.events.v1.RecurringTransfer.dispatch_strategy:type_name -> vega.DispatchStrategy
	71,  // 12: vega.events.v1.RecurringGovernanceTransfer.dispatch_strategy:type_name -> vega.DispatchStrategy
	...
	68,  // 16: vega.events.v1.TransactionResult.order_submission:type_name -> vega.commands.v1.OrderSubmission
	72,  // 17: vega.events.v1.TransactionResult.order_amendment:type_name -> vega.commands.v1.OrderAmendment
	73,  // 18: vega.events.v1.TransactionResult.order_cancellation:type_name -> vega.commands.v1.OrderCancellation
	74,  // 19: vega.events.v1.TransactionResult.proposal:type_name -> vega.commands.v1.ProposalSubmission
	75,  // 20: vega.events.v1.TransactionResult.vote_submission:type_name -> vega.commands.v1.VoteSubmission
	76,  // 21: vega.events.v1.TransactionResult.liquidity_provision_submission:type_name -> vega.commands.v1.LiquidityProvisionSubmission
	77,  // 22: vega.events.v1.TransactionResult.withdraw_submission:type_name -> vega.commands.v1.WithdrawSubmission
	78,  // 23: vega.events.v1.TransactionResult.delegate_submission:type_name -> vega.commands.v1.DelegateSubmission
	79,  // 24: vega.events.v1.TransactionResult.undelegate_submission:type_name -> vega.commands.v1.UndelegateSubmission
	80,  // 25: vega.events.v1.TransactionResult.liquidity_provision_cancellation:type_name -> vega.commands.v1.LiquidityProvisionCancellation
	81,  // 26: vega.events.v1.TransactionResult.liquidity_provision_amendment:type_name -> vega.commands.v1.LiquidityProvisionAmendment
	82,  // 27: vega.events.v1.TransactionResult.transfer:type_name -> vega.commands.v1.Transfer
	83,  // 28: vega.events.v1.TransactionResult.cancel_transfer:type_name -> vega.commands.v1.CancelTransfer
	84,  // 29: vega.events.v1.TransactionResult.announce_node:type_name -> vega.commands.v1.AnnounceNode
	85,  // 30: vega.events.v1.TransactionResult.oracle_data_submission:type_name -> vega.commands.v1.OracleDataSubmission
	86,  // 31: vega.events.v1.TransactionResult.protocol_upgrade_proposal:type_name -> vega.commands.v1.ProtocolUpgradeProposal
	87,  // 32: vega.events.v1.TransactionResult.issue_signatures:type_name -> vega.commands.v1.IssueSignatures
	88,  // 33: vega.events.v1.TransactionResult.batch_market_instructions:type_name -> vega.commands.v1.BatchMarketInstructions
	89,  // 34: vega.events.v1.TransactionResult.key_rotate_submission:type_name -> vega.commands.v1.KeyRotateSubmission
	90,  // 35: vega.events.v1.TransactionResult.ethereum_key_rotate_submission:type_name -> vega.commands.v1.EthereumKeyRotateSubmission
	91,  // 36: vega.events.v1.TransactionResult.stop_order_submission:type_name -> vega.commands.v1.StopOrdersSubmission
	92,  // 37: vega.events.v1.TransactionResult.stop_order_cancellation:type_name -> vega.commands.v1.StopOrdersCancellation
	93,  // 38: vega.events.v1.TransactionResult.create_referral_set:type_name -> vega.commands.v1.CreateReferralSet
	94,  // 39: vega.events.v1.TransactionResult.update_referral_set:type_name -> vega.commands.v1.UpdateReferralSet
	95,  // 40: vega.events.v1.TransactionResult.apply_referral_code:type_name -> vega.commands.v1.ApplyReferralCode
	66,  // 41: vega.events.v1.TransactionResult.success:type_name -> vega.events.v1.TransactionResult.SuccessDetails
	67,  // 42: vega.events.v1.TransactionResult.failure:type_name -> vega.events.v1.TransactionResult.FailureDetails
	68,  // 43: vega.events.v1.TxErrorEvent.order_submission:type_name -> vega.commands.v1.OrderSubmission
	72,  // 44: vega.events.v1.TxErrorEvent.order_amendment:type_name -> vega.commands.v1.OrderAmendment
	73,  // 45: vega.events.v1.TxErrorEvent.order_cancellation:type_name -> vega.commands.v1.OrderCancellation
	74,  // 46: vega.events.v1.TxErrorEvent.proposal:type_name -> vega.commands.v1.ProposalSubmission
	75,  // 47: vega.events.v1.TxErrorEvent.vote_submission:type_name -> vega.commands.v1.VoteSubmission
	76,  // 48: vega.events.v1.TxErrorEvent.liquidity_provision_submission:type_name -> vega.commands.v1.LiquidityProvisionSubmission
	77,  // 49: vega.events.v1.TxErrorEvent.withdraw_submission:type_name -> vega.commands.v1.WithdrawSubmission
	78,  // 50: vega.events.v1.TxErrorEvent.delegate_submission:type_name -> vega.commands.v1.DelegateSubmission
	79,  // 51: vega.events.v1.TxErrorEvent.undelegate_submission:type_name -> vega.commands.v1.UndelegateSubmission
	80,  // 52: vega.events.v1.TxErrorEvent.liquidity_provision_cancellation:type_name -> vega.commands.v1.LiquidityProvisionCancellation
	81,  // 53: vega.events.v1.TxErrorEvent.liquidity_provision_amendment:type_name -> vega.commands.v1.LiquidityProvisionAmendment
	82,  // 54: vega.events.v1.TxErrorEvent.transfer:type_name -> vega.commands.v1.Transfer
	83,  // 55: vega.events.v1.TxErrorEvent.cancel_transfer:type_name -> vega.commands.v1.CancelTransfer
	84,  // 56: vega.events.v1.TxErrorEvent.announce_node:type_name -> vega.commands.v1.AnnounceNode
	85,  // 57: vega.events.v1.TxErrorEvent.oracle_data_submission:type_name -> vega.commands.v1.OracleDataSubmission
	86,  // 58: vega.events.v1.TxErrorEvent.protocol_upgrade_proposal:type_name -> vega.commands.v1.ProtocolUpgradeProposal
	87,  // 59: vega.events.v1.TxErrorEvent.issue_signatures:type_name -> vega.commands.v1.IssueSignatures
	88,  // 60: vega.events.v1.TxErrorEvent.batch_market_instructions:type_name -> vega.commands.v1.BatchMarketInstructions
	96,  // 61: vega.events.v1.EpochEvent.action:type_name -> vega.EpochAction
	97,  // 62: vega.events.v1.LedgerMovements.ledger_movements:type_name -> vega.LedgerMovement
	35,  // 63: vega.events.v1.SettlePosition.trade_settlements:type_name -> vega.events.v1.TradeSettlement
	98,  // 64: vega.events.v1.AuctionEvent.trigger:type_name -> vega.AuctionTrigger
	98,  // 65: vega.events.v1.AuctionEvent.extension_trigger:type_name -> vega.AuctionTrigger
	0,   // 66: vega.events.v1.ProtocolUpgradeEvent.status:type_name -> vega.events.v1.ProtocolUpgradeProposalStatus
	99,  // 67: vega.events.v1.ReferralProgramStarted.program:type_name -> vega.ReferralProgram
	99,  // 68: vega.events.v1.ReferralProgramUpdated.program:type_name -> vega.ReferralProgram
	1,   // 69: vega.events.v1.BusEvent.type:type_name -> vega.events.v1.BusEventType
	30,  // 70: vega.events.v1.BusEvent.time_update:type_name -> vega.events.v1.TimeUpdate
	32,  // 71: vega.events.v1.BusEvent.ledger_movements:type_name -> vega.events.v1.LedgerMovements
	33,  // 72: vega.events.v1.BusEvent.position_resolution:type_name -> vega.events.v1.PositionResolution
	100, // 73: vega.events.v1.BusEvent.order:type_name -> vega.Order
	101, // 74: vega.events.v1.BusEvent.account:type_name -> vega.Account
	102, // 75: vega.events.v1.BusEvent.party:type_name -> vega.Party
	103, // 76: vega.events.v1.BusEvent.trade:type_name -> vega.Trade
	104, // 77: vega.events.v1.BusEvent.margin_levels:type_name -> vega.MarginLevels
	105, // 78: vega.events.v1.BusEvent.proposal:type_name -> vega.Proposal
	106, // 79: vega.events.v1.BusEvent.vote:type_name -> vega.Vote
	107, // 80: vega.events.v1.BusEvent.market_data:type_name -> vega.MarketData
	108, // 81: vega.events.v1.BusEvent.node_signature:type_name -> vega.commands.v1.NodeSignature
	34,  // 82: vega.events.v1.BusEvent.loss_socialization:type_name -> vega.events.v1.LossSocialization
	36,  // 83: vega.events.v1.BusEvent.settle_position:type_name -> vega.events.v1.SettlePosition
	39,  // 84: vega.events.v1.BusEvent.settle_distressed:type_name -> vega.events.v1.SettleDistressed
	109, // 85: vega.events.v1.BusEvent.market_created:type_name -> vega.Market
	110, // 86: vega.events.v1.BusEvent.asset:type_name -> vega.Asset
	42,  // 87: vega.events.v1.BusEvent.market_tick:type_name -> vega.events.v1.MarketTick
	111, // 88: vega.events.v1.BusEvent.withdrawal:type_name -> vega.Withdrawal
	112, // 89: vega.events.v1.BusEvent.deposit:type_name -> vega.Deposit
	43,  // 90: vega.events.v1.BusEvent.auction:type_name -> vega.events.v1.AuctionEvent
	113, // 91: vega.events.v1.BusEvent.risk_factor:type_name -> vega.RiskFactor
	114, // 92: vega.events.v1.BusEvent.network_parameter:type_name -> vega.NetworkParameter
	115, // 93: vega.events.v1.BusEvent.liquidity_provision:type_name -> vega.LiquidityProvision
	109, // 94: vega.events.v1.BusEvent.market_updated:type_name -> vega.Market
	116, // 95: vega.events.v1.BusEvent.oracle_spec:type_name -> vega.OracleSpec
	117, // 96: vega.events.v1.BusEvent.oracle_data:type_name -> vega.OracleData
	26,  // 97: vega.events.v1.BusEvent.delegation_balance:type_name -> vega.events.v1.DelegationBalanceEvent
	25,  // 98: vega.events.v1.BusEvent.validator_score:type_name -> vega.events.v1.ValidatorScoreEvent
	31,  // 99: vega.events.v1.BusEvent.epoch_event:type_name -> vega.events.v1.EpochEvent
	44,  // 100: vega.events.v1.BusEvent.validator_update:type_name -> vega.events.v1.ValidatorUpdate
	19,  // 101: vega.events.v1.BusEvent.stake_linking:type_name -> vega.events.v1.StakeLinking
	24,  // 102: vega.events.v1.BusEvent.reward_payout:type_name -> vega.events.v1.RewardPayoutEvent
	22,  // 103: vega.events.v1.BusEvent.checkpoint:type_name -> vega.events.v1.CheckpointEvent
	46,  // 104: vega.events.v1.BusEvent.key_rotation:type_name -> vega.events.v1.KeyRotation
	49,  // 105: vega.events.v1.BusEvent.state_var:type_name -> vega.events.v1.StateVar
	118, // 106: vega.events.v1.BusEvent.network_limits:type_name -> vega.NetworkLimits
	14,  // 107: vega.events.v1.BusEvent.transfer:type_name -> vega.events.v1.Transfer
	45,  // 108: vega.events.v1.BusEvent.ranking_event:type_name -> vega.events.v1.ValidatorRankingEvent
	20,  // 109: vega.events.v1.BusEvent.erc20_multisig_signer_event:type_name -> vega.events.v1.ERC20MultiSigSignerEvent
	21,  // 110: vega.events.v1.BusEvent.erc20_multisig_set_threshold_event:type_name -> vega.events.v1.ERC20MultiSigThresholdSetEvent
	11,  // 111: vega.events.v1.BusEvent.erc20_multisig_signer_added:type_name -> vega.events.v1.ERC20MultiSigSignerAdded
	13,  // 112: vega.events.v1.BusEvent.erc20_multisig_signer_removed:type_name -> vega.events.v1.ERC20MultiSigSignerRemoved
	38,  // 113: vega.events.v1.BusEvent.position_state_event:type_name -> vega.events.v1.PositionStateEvent
	47,  // 114: vega.events.v1.BusEvent.ethereum_key_rotation:type_name -> vega.events.v1.EthereumKeyRotation
	48,  // 115: vega.events.v1.BusEvent.protocol_upgrade_event:type_name -> vega.events.v1.ProtocolUpgradeEvent
	50,  // 116: vega.events.v1.BusEvent.begin_block:type_name -> vega.events.v1.BeginBlock
	51,  // 117: vega.events.v1.BusEvent.end_block:type_name -> vega.events.v1.EndBlock
	52,  // 118: vega.events.v1.BusEvent.protocol_upgrade_started:type_name -> vega.events.v1.ProtocolUpgradeStarted
	37,  // 119: vega.events.v1.BusEvent.settle_market:type_name -> vega.events.v1.SettleMarket
	28,  // 120: vega.events.v1.BusEvent.transaction_result:type_name -> vega.events.v1.TransactionResult
	54,  // 121: vega.events.v1.BusEvent.core_snapshot_event:type_name -> vega.events.v1.CoreSnapshotData
	53,  // 122: vega.events.v1.BusEvent.protocol_upgrade_data_node_ready:type_name -> vega.events.v1.ProtocolUpgradeDataNodeReady
	40,  // 123: vega.events.v1.BusEvent.distressed_orders:type_name -> vega.events.v1.DistressedOrders
	55,  // 124: vega.events.v1.BusEvent.expired_orders:type_name -> vega.events.v1.ExpiredOrders
	41,  // 125: vega.events.v1.BusEvent.distressed_positions:type_name -> vega.events.v1.DistressedPositions
	10,  // 126: vega.events.v1.BusEvent.stop_order:type_name -> vega.events.v1.StopOrderEvent
	8,   // 127: vega.events.v1.BusEvent.funding_period:type_name -> vega.events.v1.FundingPeriod
	9,   // 128: vega.events.v1.BusEvent.funding_period_data_point:type_name -> vega.events.v1.FundingPeriodDataPoint
	56,  // 129: vega.events.v1.BusEvent.team_created:type_name -> vega.events.v1.TeamCreated
	57,  // 130: vega.events.v1.BusEvent.team_updated:type_name -> vega.events.v1.TeamUpdated
	58,  // 131: vega.events.v1.BusEvent.referee_switched_team:type_name -> vega.events.v1.RefereeSwitchedTeam
	59,  // 132: vega.events.v1.BusEvent.referee_joined_team:type_name -> vega.events.v1.RefereeJoinedTeam
	62,  // 133: vega.events.v1.BusEvent.referral_program_started:type_name -> vega.events.v1.ReferralProgramStarted
	63,  // 134: vega.events.v1.BusEvent.referral_program_updated:type_name -> vega.events.v1.ReferralProgramUpdated
	64,  // 135: vega.events.v1.BusEvent.referral_program_ended:type_name -> vega.events.v1.ReferralProgramEnded
	60,  // 136: vega.events.v1.BusEvent.referral_set_created:type_name -> vega.events.v1.ReferralSetCreated
	61,  // 137: vega.events.v1.BusEvent.referee_joined_referral_set:type_name -> vega.events.v1.RefereeJoinedReferralSet
	7,   // 138: vega.events.v1.BusEvent.party_activity_streak:type_name -> vega.events.v1.PartyActivityStreak
	27,  // 139: vega.events.v1.BusEvent.market:type_name -> vega.events.v1.MarketEvent
	29,  // 140: vega.events.v1.BusEvent.tx_err_event:type_name -> vega.events.v1.TxErrorEvent
