Feature: Reproduce ETH/USDT-PERP market configuration as updated on November 30th 2023
  ...
  Background:
    ...
    And the log normal risk model named "log-normal-risk-model":
      ...
      | 0.000001      | 0.000009506426342 | 0.016 | 0 | 1.5   |
    ...
    And the markets:
      ...
      | ETH/USDT-PERP | USDT       | TUSDT | log-normal-risk-model | margin-calculator | 3600             | fees | price-monitoring | perp-oracle        | 4              | 1                       | 0.001                  | 0                         | sla        | perp        |
  ...
  Scenario: Check the resulting bounds
    ...
    When the parties submit the following liquidity provision:
      ...
      | lp1 | lp    | ETH/USDT-PERP | 90000000          | 0.1 | submission |
      | lp1 | lp    | ETH/USDT-PERP | 90000000          | 0.1 | submission |
    And the parties place the following pegged iceberg orders:
      | party | market id     | peak size | minimum visible size | side | pegged reference | volume     | offset |
      | lp    | ETH/USDT-PERP | 2         | 1                    | buy  | BID              | 50         | 100    |
      | lp    | ETH/USDT-PERP | 2         | 1                    | sell | ASK              | 50         | 100    |
    # place auxiliary orders so we always have best bid and best offer as to not trigger the liquidity auction
    And the parties place the following orders:
      | party | market id     | side | volume | price     | resulting trades | type       | tif     |
      | aux   | ETH/USDT-PERP | buy  | 1      | 1         | 0                | TYPE_LIMIT | TIF_GTC |
      | aux   | ETH/USDT-PERP | sell | 1      | 200000000 | 0                | TYPE_LIMIT | TIF_GTC |
      | aux2  | ETH/USDT-PERP | buy  | 1      | 29000000  | 0                | TYPE_LIMIT | TIF_GTC |
      | aux   | ETH/USDT-PERP | sell | 1      | 29000000  | 0                | TYPE_LIMIT | TIF_GTC |
    
    When the opening auction period ends for market "ETH/USDT-PERP"
    Then the market data for the market "ETH/USDT-PERP" should be:
      | horizon | ref price | min bound | max bound |
      | 43200   | 29000000  | 21545190  | 38915896  |
      | 21600   | 29000000  | 23511702  | 35715161  |
