Feature: Spot market
  ...
  Scenario: For a price level with multiple iceberg orders, if an aggressive order hits this price level,
            any volume greater than the displayed volume at a level is split proportionally between the
            hidden components of iceberg orders at that price level If there are three iceberg orders with
            remaining volume 200 lots, 100 lots and 100 lots, an order for 600 lots would be split 200 to
            the first order and 100 to the two 100 lot orders, with 200 lots then taking farther price levels.
            (0014-ORDT-113)
    ...
    And the parties place the following orders:
      ...
      | party4 | BTC/ETH   | sell | 600    | 1000  | 3                | TYPE_LIMIT | TIF_GTC | sell1     |

    Then the orders should have the following states:
      | party  | market id | side | price | remaining | volume | reference | status         |
      | party1 | BTC/ETH   | buy  | 1000  | 0         | 200     | iceberg1  | STATUS_FILLED |             
      | party2 | BTC/ETH   | buy  | 1000  | 0         | 100     | iceberg2  | STATUS_FILLED |             
      | party1 | BTC/ETH   | buy  | 1000  | 0         | 100     | iceberg3  | STATUS_FILLED |             
      | party4 | BTC/ETH   | sell | 1000  | 200       | 600     | sell1     | STATUS_ACTIVE | 
    ...
    Then the iceberg orders should have the following states:
      ...
      | party1 | BTC/ETH   | buy  | 0              | 1000  | STATUS_FILLED | 0               |
      | party2 | BTC/ETH   | buy  | 0              | 1000  | STATUS_FILLED | 0               |
      | party1 | BTC/ETH   | buy  | 0              | 1000  | STATUS_FILLED | 0               |

    # The icebergs have all gone but we 200 volume left for the normal order
