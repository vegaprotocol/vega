...
var file_vega_snapshot_v1_snapshot_proto_rawDesc = []byte{
	...
	0x53, 0x74, 0x61, 0x74, 0x73, 0x22, 0x9c, 0x0e, 0x0a, 0x06, 0x4d, 0x61, 0x72, 0x6b, 0x65, 0x74,
...
var file_vega_snapshot_v1_snapshot_proto_depIdxs = []int32{
	...
	191, // 89: vega.snapshot.v1.OracleData.signers:type_name -> vega.data.v1.Signer
	16,  // 90: vega.snapshot.v1.OracleData.data:type_name -> vega.snapshot.v1.OracleDataPair
	192, // 91: vega.snapshot.v1.OracleData.meta_data:type_name -> vega.data.v1.Property
	...
	193, // 94: vega.snapshot.v1.CollateralAccounts.accounts:type_name -> vega.Account
	194, // 95: vega.snapshot.v1.CollateralAssets.assets:type_name -> vega.Asset
	194, // 96: vega.snapshot.v1.ActiveAssets.assets:type_name -> vega.Asset
	194, // 97: vega.snapshot.v1.PendingAssets.assets:type_name -> vega.Asset
	194, // 98: vega.snapshot.v1.PendingAssetUpdates.assets:type_name -> vega.Asset
	195, // 99: vega.snapshot.v1.Withdrawal.withdrawal:type_name -> vega.Withdrawal
	196, // 100: vega.snapshot.v1.Deposit.deposit:type_name -> vega.Deposit
	...
	197, // 103: vega.snapshot.v1.BankingAssetActions.asset_action:type_name -> vega.checkpoint.v1.AssetAction
	198, // 104: vega.snapshot.v1.BankingRecurringTransfers.recurring_transfers:type_name -> vega.checkpoint.v1.RecurringTransfers
	199, // 105: vega.snapshot.v1.BankingScheduledTransfers.transfers_at_time:type_name -> vega.checkpoint.v1.ScheduledTransferAtTime
	200, // 106: vega.snapshot.v1.BankingRecurringGovernanceTransfers.recurring_transfers:type_name -> vega.checkpoint.v1.GovernanceTransfer
	201, // 107: vega.snapshot.v1.BankingScheduledGovernanceTransfers.transfers_at_time:type_name -> vega.checkpoint.v1.ScheduledGovernanceTransferAtTime
	202, // 108: vega.snapshot.v1.BankingBridgeState.bridge_state:type_name -> vega.checkpoint.v1.BridgeState
	203, // 109: vega.snapshot.v1.DelegationActive.delegations:type_name -> vega.Delegation
	203, // 110: vega.snapshot.v1.DelegationPending.delegations:type_name -> vega.Delegation
	203, // 111: vega.snapshot.v1.DelegationPending.undelegation:type_name -> vega.Delegation
	204, // 112: vega.snapshot.v1.ProposalData.proposal:type_name -> vega.Proposal
	205, // 113: vega.snapshot.v1.ProposalData.yes:type_name -> vega.Vote
	205, // 114: vega.snapshot.v1.ProposalData.no:type_name -> vega.Vote
	205, // 115: vega.snapshot.v1.ProposalData.invalid:type_name -> vega.Vote
	...
	204, // 119: vega.snapshot.v1.BatchProposalData.proposals:type_name -> vega.Proposal
	46,  // 120: vega.snapshot.v1.GovernanceBatchActive.batch_proposals:type_name -> vega.snapshot.v1.BatchProposalData
	204, // 121: vega.snapshot.v1.GovernanceNode.proposals:type_name -> vega.Proposal
	43,  // 122: vega.snapshot.v1.GovernanceNode.proposal_data:type_name -> vega.snapshot.v1.ProposalData
	206, // 123: vega.snapshot.v1.StakingAccount.events:type_name -> vega.events.v1.StakeLinking
	49,  // 124: vega.snapshot.v1.StakingAccounts.accounts:type_name -> vega.snapshot.v1.StakingAccount
	207, // 125: vega.snapshot.v1.StakingAccounts.pending_stake_total_supply:type_name -> vega.StakeTotalSupply
	208, // 126: vega.snapshot.v1.MatchingBook.buy:type_name -> vega.Order
	208, // 127: vega.snapshot.v1.MatchingBook.sell:type_name -> vega.Order
	209, // 128: vega.snapshot.v1.NetParams.params:type_name -> vega.NetworkParameter
	210, // 129: vega.snapshot.v1.PriceBound.trigger:type_name -> vega.PriceMonitoringTrigger
	...
	211, // 138: vega.snapshot.v1.AuctionState.mode:type_name -> vega.Market.TradingMode
	211, // 139: vega.snapshot.v1.AuctionState.default_mode:type_name -> vega.Market.TradingMode
	212, // 140: vega.snapshot.v1.AuctionState.trigger:type_name -> vega.AuctionTrigger
	213, // 141: vega.snapshot.v1.AuctionState.end:type_name -> vega.AuctionDuration
	212, // 142: vega.snapshot.v1.AuctionState.extension:type_name -> vega.AuctionTrigger
	63,  // 143: vega.snapshot.v1.EquityShare.lps:type_name -> vega.snapshot.v1.EquityShareLP
	214, // 144: vega.snapshot.v1.SpotMarket.market:type_name -> vega.Market
	...
	208, // 148: vega.snapshot.v1.SpotMarket.expiring_orders:type_name -> vega.Order
	...
	208, // 152: vega.snapshot.v1.SpotMarket.expiring_stop_orders:type_name -> vega.Order
	215, // 153: vega.snapshot.v1.SpotMarket.fees_stats:type_name -> vega.events.v1.FeesStats
	214, // 154: vega.snapshot.v1.Market.market:type_name -> vega.Market
	...
	208, // 158: vega.snapshot.v1.Market.expiring_orders:type_name -> vega.Order
	...
	208, // 162: vega.snapshot.v1.Market.expiring_stop_orders:type_name -> vega.Order
	72,  // 163: vega.snapshot.v1.Market.product:type_name -> vega.snapshot.v1.Product
	215, // 164: vega.snapshot.v1.Market.fees_stats:type_name -> vega.events.v1.FeesStats
	...
	115, // 212: vega.snapshot.v1.ChainIdEthOracles.call_results:type_name -> vega.snapshot.v1.EthContractCallResults
	114, // 213: vega.snapshot.v1.ChainIdEthOracles.misc:type_name -> vega.snapshot.v1.EthOracleVerifierMisc
	117, // 214: vega.snapshot.v1.EthOracleVerifierMisc.buckets:type_name -> vega.snapshot.v1.EthVerifierBucket
	113, // 215: vega.snapshot.v1.EthOracleVerifierMisc.patch_block:type_name -> vega.snapshot.v1.EthOracleVerifierLastBlock
	116, // 216: vega.snapshot.v1.EthContractCallResults.pending_contract_call_result:type_name -> vega.snapshot.v1.EthContractCallResult
	124, // 217: vega.snapshot.v1.Topology.validator_data:type_name -> vega.snapshot.v1.ValidatorState
	118, // 218: vega.snapshot.v1.Topology.pending_pub_key_rotations:type_name -> vega.snapshot.v1.PendingKeyRotation
	127, // 219: vega.snapshot.v1.Topology.validator_performance:type_name -> vega.snapshot.v1.ValidatorPerformance
	119, // 220: vega.snapshot.v1.Topology.pending_ethereum_key_rotations:type_name -> vega.snapshot.v1.PendingEthereumKeyRotation
	121, // 221: vega.snapshot.v1.Topology.signatures:type_name -> vega.snapshot.v1.ToplogySignatures
	119, // 222: vega.snapshot.v1.Topology.unsolved_ethereum_key_rotations:type_name -> vega.snapshot.v1.PendingEthereumKeyRotation
	122, // 223: vega.snapshot.v1.ToplogySignatures.pending_signatures:type_name -> vega.snapshot.v1.PendingERC20MultisigControlSignature
	123, // 224: vega.snapshot.v1.ToplogySignatures.issued_signatures:type_name -> vega.snapshot.v1.IssuedERC20MultisigControlSignature
	218, // 225: vega.snapshot.v1.ValidatorState.validator_update:type_name -> vega.events.v1.ValidatorUpdate
	125, // 226: vega.snapshot.v1.ValidatorState.heartbeat_tracker:type_name -> vega.snapshot.v1.HeartbeatTracker
	219, // 227: vega.snapshot.v1.ValidatorState.ranking_score:type_name -> vega.RankingScore
	126, // 228: vega.snapshot.v1.ValidatorPerformance.validator_perf_stats:type_name -> vega.snapshot.v1.PerformanceStats
	131, // 229: vega.snapshot.v1.LiquidityPartiesLiquidityOrders.party_orders:type_name -> vega.snapshot.v1.PartyOrders
	208, // 230: vega.snapshot.v1.PartyOrders.orders:type_name -> vega.Order
	131, // 231: vega.snapshot.v1.LiquidityPartiesOrders.party_orders:type_name -> vega.snapshot.v1.PartyOrders
	220, // 232: vega.snapshot.v1.LiquidityProvisions.liquidity_provisions:type_name -> vega.LiquidityProvision
	135, // 233: vega.snapshot.v1.LiquidityScores.scores:type_name -> vega.snapshot.v1.LiquidityScore
	221, // 234: vega.snapshot.v1.LiquidityV2Parameters.market_sla_parameters:type_name -> vega.LiquiditySLAParameters
	222, // 235: vega.snapshot.v1.LiquidityV2PaidFeesStats.stats:type_name -> vega.events.v1.PaidLiquidityFeesStats
	220, // 236: vega.snapshot.v1.LiquidityV2Provisions.liquidity_provisions:type_name -> vega.LiquidityProvision
	220, // 237: vega.snapshot.v1.LiquidityV2PendingProvisions.pending_liquidity_provisions:type_name -> vega.LiquidityProvision
	141, // 238: vega.snapshot.v1.LiquidityV2Performances.performance_per_party:type_name -> vega.snapshot.v1.LiquidityV2PerformancePerParty
	135, // 239: vega.snapshot.v1.LiquidityV2Scores.scores:type_name -> vega.snapshot.v1.LiquidityScore
	...
	147, // 242: vega.snapshot.v1.FloatingPointConsensus.next_time_trigger:type_name -> vega.snapshot.v1.NextTimeTrigger
	145, // 243: vega.snapshot.v1.FloatingPointConsensus.state_variables:type_name -> vega.snapshot.v1.StateVarInternalState
	146, // 244: vega.snapshot.v1.StateVarInternalState.validators_results:type_name -> vega.snapshot.v1.FloatingPointValidatorResult
	223, // 245: vega.snapshot.v1.FloatingPointValidatorResult.bundle:type_name -> vega.KeyValueBundle
	224, // 246: vega.snapshot.v1.MarketTracker.market_activity:type_name -> vega.checkpoint.v1.MarketActivityTracker
	225, // 247: vega.snapshot.v1.MarketTracker.taker_notional_volume:type_name -> vega.checkpoint.v1.TakerNotionalVolume
	226, // 248: vega.snapshot.v1.MarketTracker.market_to_party_taker_notional_volume:type_name -> vega.checkpoint.v1.MarketToPartyTakerNotionalVolume
	227, // 249: vega.snapshot.v1.SignerEventsPerAddress.events:type_name -> vega.events.v1.ERC20MultiSigSignerEvent
	149, // 250: vega.snapshot.v1.ERC20MultiSigTopologyVerified.events_per_address:type_name -> vega.snapshot.v1.SignerEventsPerAddress
	228, // 251: vega.snapshot.v1.ERC20MultiSigTopologyVerified.threshold:type_name -> vega.events.v1.ERC20MultiSigThresholdSetEvent
	227, // 252: vega.snapshot.v1.ERC20MultiSigTopologyPending.pending_signers:type_name -> vega.events.v1.ERC20MultiSigSignerEvent
	228, // 253: vega.snapshot.v1.ERC20MultiSigTopologyPending.pending_threshold_set:type_name -> vega.events.v1.ERC20MultiSigThresholdSetEvent
	158, // 254: vega.snapshot.v1.ProofOfWork.tx_at_height:type_name -> vega.snapshot.v1.TransactionsAtHeight
	158, // 255: vega.snapshot.v1.ProofOfWork.tid_at_height:type_name -> vega.snapshot.v1.TransactionsAtHeight
	153, // 256: vega.snapshot.v1.ProofOfWork.banned:type_name -> vega.snapshot.v1.BannedParty
	154, // 257: vega.snapshot.v1.ProofOfWork.pow_params:type_name -> vega.snapshot.v1.ProofOfWorkParams
	155, // 258: vega.snapshot.v1.ProofOfWork.pow_state:type_name -> vega.snapshot.v1.ProofOfWorkState
	160, // 259: vega.snapshot.v1.ProofOfWork.nonce_refs_at_height:type_name -> vega.snapshot.v1.NonceRefsAtHeight
	156, // 260: vega.snapshot.v1.ProofOfWorkState.pow_state:type_name -> vega.snapshot.v1.ProofOfWorkBlockState
	157, // 261: vega.snapshot.v1.ProofOfWorkBlockState.party_state:type_name -> vega.snapshot.v1.ProofOfWorkPartyStateForBlock
	159, // 262: vega.snapshot.v1.NonceRefsAtHeight.refs:type_name -> vega.snapshot.v1.NonceRef
	229, // 263: vega.snapshot.v1.ProtocolUpgradeProposals.active_proposals:type_name -> vega.events.v1.ProtocolUpgradeEvent
	162, // 264: vega.snapshot.v1.ProtocolUpgradeProposals.accepted_proposal:type_name -> vega.snapshot.v1.AcceptedProtocolUpgradeProposal
	164, // 265: vega.snapshot.v1.Teams.teams:type_name -> vega.snapshot.v1.Team
	165, // 266: vega.snapshot.v1.Team.referrer:type_name -> vega.snapshot.v1.Membership
	165, // 267: vega.snapshot.v1.Team.referees:type_name -> vega.snapshot.v1.Membership
	167, // 268: vega.snapshot.v1.TeamSwitches.team_switches:type_name -> vega.snapshot.v1.TeamSwitch
	169, // 269: vega.snapshot.v1.Vesting.parties_reward:type_name -> vega.snapshot.v1.PartyReward
	174, // 270: vega.snapshot.v1.PartyReward.asset_locked:type_name -> vega.snapshot.v1.AssetLocked
	176, // 271: vega.snapshot.v1.PartyReward.in_vesting:type_name -> vega.snapshot.v1.InVesting
	173, // 272: vega.snapshot.v1.ReferralProgramData.factor_by_referee:type_name -> vega.snapshot.v1.FactorByReferee
	230, // 273: vega.snapshot.v1.ReferralProgramData.current_program:type_name -> vega.ReferralProgram
	230, // 274: vega.snapshot.v1.ReferralProgramData.new_program:type_name -> vega.ReferralProgram
	171, // 275: vega.snapshot.v1.ReferralProgramData.sets:type_name -> vega.snapshot.v1.ReferralSet
	165, // 276: vega.snapshot.v1.ReferralSet.referrer:type_name -> vega.snapshot.v1.Membership
	165, // 277: vega.snapshot.v1.ReferralSet.referees:type_name -> vega.snapshot.v1.Membership
	172, // 278: vega.snapshot.v1.ReferralSet.running_volumes:type_name -> vega.snapshot.v1.RunningVolume
	175, // 279: vega.snapshot.v1.AssetLocked.epoch_balances:type_name -> vega.snapshot.v1.EpochBalance
	178, // 280: vega.snapshot.v1.ActivityStreak.parties_activity_streak:type_name -> vega.snapshot.v1.PartyActivityStreak
	181, // 281: vega.snapshot.v1.VolumeDiscountProgram.epoch_party_volumes:type_name -> vega.snapshot.v1.EpochPartyVolumes
	182, // 282: vega.snapshot.v1.VolumeDiscountProgram.average_party_volume:type_name -> vega.snapshot.v1.PartyVolume
	231, // 283: vega.snapshot.v1.VolumeDiscountProgram.current_program:type_name -> vega.VolumeDiscountProgram
	231, // 284: vega.snapshot.v1.VolumeDiscountProgram.new_program:type_name -> vega.VolumeDiscountProgram
	180, // 285: vega.snapshot.v1.VolumeDiscountProgram.factors_by_party:type_name -> vega.snapshot.v1.VolumeDiscountStats
	182, // 286: vega.snapshot.v1.EpochPartyVolumes.party_volume:type_name -> vega.snapshot.v1.PartyVolume
	232, // 287: vega.snapshot.v1.Liquidation.config:type_name -> vega.LiquidationStrategy
	184, // 288: vega.snapshot.v1.BankingTransferFeeDiscounts.party_asset_discount:type_name -> vega.snapshot.v1.PartyAssetAmount
	233, // 289: vega.snapshot.v1.CompositePriceCalculator.price_configuration:type_name -> vega.CompositePriceConfiguration
	234, // 290: vega.snapshot.v1.CompositePriceCalculator.trades:type_name -> vega.Trade
	54,  // 291: vega.snapshot.v1.CompositePriceCalculator.book_price_at_time:type_name -> vega.snapshot.v1.TimePrice
	188, // 292: vega.snapshot.v1.Parties.profiles:type_name -> vega.snapshot.v1.PartyProfile
	235, // 293: vega.snapshot.v1.PartyProfile.metadata:type_name -> vega.Metadata
	236, // 294: vega.snapshot.v1.PoolMapEntry.Pool.parameters:type_name -> vega.events.v1.AMMPool.ConcentratedLiquidityParameters
	189, // 295: vega.snapshot.v1.PoolMapEntry.Pool.lower:type_name -> vega.snapshot.v1.PoolMapEntry.Curve
	189, // 296: vega.snapshot.v1.PoolMapEntry.Pool.upper:type_name -> vega.snapshot.v1.PoolMapEntry.Curve
