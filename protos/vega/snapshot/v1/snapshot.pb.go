...
var file_vega_snapshot_v1_snapshot_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x03, 0x52, 0x02, 0x6f, 0x66, 0x22, 0x93, 0x31, 0x0a, 0x07, 0x50, 0x61, 0x79, 0x6c,
	...
	0x65, 0x74, 0x65, 0x72, 0x73, 0x42, 0x06, 0x0a, 0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0x56, 0x0a,
	...
	0x65, 0x64, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x73, 0x22, 0x73, 0x0a, 0x12, 0x43, 0x6f, 0x6c, 0x6c,
	...
	0x08, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x73, 0x12, 0x32, 0x0a, 0x15, 0x6e, 0x65, 0x78,
	0x74, 0x5f, 0x62, 0x61, 0x6c, 0x61, 0x6e, 0x63, 0x65, 0x5f, 0x73, 0x6e, 0x61, 0x70, 0x73, 0x68,
	0x6f, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x03, 0x52, 0x13, 0x6e, 0x65, 0x78, 0x74, 0x42, 0x61,
	0x6c, 0x61, 0x6e, 0x63, 0x65, 0x53, 0x6e, 0x61, 0x70, 0x73, 0x68, 0x6f, 0x74, 0x22, 0x37, 0x0a,
...
var file_vega_snapshot_v1_snapshot_proto_goTypes = []interface{}{
	...
	(*ReferralProgramData)(nil),                   // 154: vega.snapshot.v1.ReferralProgramData
	(*ReferralSet)(nil),                           // 155: vega.snapshot.v1.ReferralSet
	(*RunningVolume)(nil),                         // 156: vega.snapshot.v1.RunningVolume
	(*FactorByReferee)(nil),                       // 157: vega.snapshot.v1.FactorByReferee
	...
	(*VolumeDiscountStats)(nil),                   // 164: vega.snapshot.v1.VolumeDiscountStats
	...
	(*v12.FeeStats)(nil),                          // 191: vega.events.v1.FeeStats
...
var file_vega_snapshot_v1_snapshot_proto_depIdxs = []int32{
	...
	154, // 70: vega.snapshot.v1.Payload.referral_program:type_name -> vega.snapshot.v1.ReferralProgramData
	161, // 71: vega.snapshot.v1.Payload.activity_streak:type_name -> vega.snapshot.v1.ActivityStreak
	163, // 72: vega.snapshot.v1.Payload.volume_discount_program:type_name -> vega.snapshot.v1.VolumeDiscountProgram
	123, // 73: vega.snapshot.v1.Payload.liquidity_v2_parameters:type_name -> vega.snapshot.v1.LiquidityV2Parameters
	...
	167, // 82: vega.snapshot.v1.OracleData.signers:type_name -> vega.data.v1.Signer
	16,  // 83: vega.snapshot.v1.OracleData.data:type_name -> vega.snapshot.v1.OracleDataPair
	168, // 84: vega.snapshot.v1.OracleData.meta_data:type_name -> vega.data.v1.Property
	18,  // 85: vega.snapshot.v1.Witness.resources:type_name -> vega.snapshot.v1.Resource
	169, // 86: vega.snapshot.v1.CollateralAccounts.accounts:type_name -> vega.Account
	170, // 87: vega.snapshot.v1.CollateralAssets.assets:type_name -> vega.Asset
	170, // 88: vega.snapshot.v1.ActiveAssets.assets:type_name -> vega.Asset
	170, // 89: vega.snapshot.v1.PendingAssets.assets:type_name -> vega.Asset
	170, // 90: vega.snapshot.v1.PendingAssetUpdates.assets:type_name -> vega.Asset
	171, // 91: vega.snapshot.v1.Withdrawal.withdrawal:type_name -> vega.Withdrawal
	172, // 92: vega.snapshot.v1.Deposit.deposit:type_name -> vega.Deposit
	...
	173, // 95: vega.snapshot.v1.BankingAssetActions.asset_action:type_name -> vega.checkpoint.v1.AssetAction
	174, // 96: vega.snapshot.v1.BankingRecurringTransfers.recurring_transfers:type_name -> vega.checkpoint.v1.RecurringTransfers
	175, // 97: vega.snapshot.v1.BankingScheduledTransfers.transfers_at_time:type_name -> vega.checkpoint.v1.ScheduledTransferAtTime
	176, // 98: vega.snapshot.v1.BankingRecurringGovernanceTransfers.recurring_transfers:type_name -> vega.checkpoint.v1.GovernanceTransfer
	177, // 99: vega.snapshot.v1.BankingScheduledGovernanceTransfers.transfers_at_time:type_name -> vega.checkpoint.v1.ScheduledGovernanceTransferAtTime
	178, // 100: vega.snapshot.v1.BankingBridgeState.bridge_state:type_name -> vega.checkpoint.v1.BridgeState
	179, // 101: vega.snapshot.v1.DelegationActive.delegations:type_name -> vega.Delegation
	179, // 102: vega.snapshot.v1.DelegationPending.delegations:type_name -> vega.Delegation
	179, // 103: vega.snapshot.v1.DelegationPending.undelegation:type_name -> vega.Delegation
	180, // 104: vega.snapshot.v1.ProposalData.proposal:type_name -> vega.Proposal
	181, // 105: vega.snapshot.v1.ProposalData.yes:type_name -> vega.Vote
	181, // 106: vega.snapshot.v1.ProposalData.no:type_name -> vega.Vote
	181, // 107: vega.snapshot.v1.ProposalData.invalid:type_name -> vega.Vote
	...
	180, // 110: vega.snapshot.v1.GovernanceNode.proposals:type_name -> vega.Proposal
	182, // 111: vega.snapshot.v1.StakingAccount.events:type_name -> vega.events.v1.StakeLinking
	46,  // 112: vega.snapshot.v1.StakingAccounts.accounts:type_name -> vega.snapshot.v1.StakingAccount
	183, // 113: vega.snapshot.v1.StakingAccounts.pending_stake_total_supply:type_name -> vega.StakeTotalSupply
	184, // 114: vega.snapshot.v1.MatchingBook.buy:type_name -> vega.Order
	184, // 115: vega.snapshot.v1.MatchingBook.sell:type_name -> vega.Order
	185, // 116: vega.snapshot.v1.NetParams.params:type_name -> vega.NetworkParameter
	186, // 117: vega.snapshot.v1.PriceBound.trigger:type_name -> vega.PriceMonitoringTrigger
	...
	187, // 126: vega.snapshot.v1.AuctionState.mode:type_name -> vega.Market.TradingMode
	187, // 127: vega.snapshot.v1.AuctionState.default_mode:type_name -> vega.Market.TradingMode
	188, // 128: vega.snapshot.v1.AuctionState.trigger:type_name -> vega.AuctionTrigger
	189, // 129: vega.snapshot.v1.AuctionState.end:type_name -> vega.AuctionDuration
	188, // 130: vega.snapshot.v1.AuctionState.extension:type_name -> vega.AuctionTrigger
	60,  // 131: vega.snapshot.v1.EquityShare.lps:type_name -> vega.snapshot.v1.EquityShareLP
	190, // 132: vega.snapshot.v1.SpotMarket.market:type_name -> vega.Market
	...
	184, // 136: vega.snapshot.v1.SpotMarket.expiring_orders:type_name -> vega.Order
	...
	184, // 140: vega.snapshot.v1.SpotMarket.expiring_stop_orders:type_name -> vega.Order
	191, // 141: vega.snapshot.v1.SpotMarket.fee_stats:type_name -> vega.events.v1.FeeStats
	190, // 142: vega.snapshot.v1.Market.market:type_name -> vega.Market
	...
	184, // 146: vega.snapshot.v1.Market.expiring_orders:type_name -> vega.Order
	...
	184, // 150: vega.snapshot.v1.Market.expiring_stop_orders:type_name -> vega.Order
	65,  // 151: vega.snapshot.v1.Market.product:type_name -> vega.snapshot.v1.Product
	191, // 152: vega.snapshot.v1.Market.fee_stats:type_name -> vega.events.v1.FeeStats
	...
	158, // 237: vega.snapshot.v1.PartyReward.asset_locked:type_name -> vega.snapshot.v1.AssetLocked
	160, // 238: vega.snapshot.v1.PartyReward.in_vesting:type_name -> vega.snapshot.v1.InVesting
	157, // 239: vega.snapshot.v1.ReferralProgramData.factor_by_referee:type_name -> vega.snapshot.v1.FactorByReferee
	204, // 240: vega.snapshot.v1.ReferralProgramData.current_program:type_name -> vega.ReferralProgram
	204, // 241: vega.snapshot.v1.ReferralProgramData.new_program:type_name -> vega.ReferralProgram
	155, // 242: vega.snapshot.v1.ReferralProgramData.sets:type_name -> vega.snapshot.v1.ReferralSet
	149, // 243: vega.snapshot.v1.ReferralSet.referrer:type_name -> vega.snapshot.v1.Membership
	149, // 244: vega.snapshot.v1.ReferralSet.referees:type_name -> vega.snapshot.v1.Membership
	156, // 245: vega.snapshot.v1.ReferralSet.running_volumes:type_name -> vega.snapshot.v1.RunningVolume
	159, // 246: vega.snapshot.v1.AssetLocked.epoch_balances:type_name -> vega.snapshot.v1.EpochBalance
	162, // 247: vega.snapshot.v1.ActivityStreak.parties_activity_streak:type_name -> vega.snapshot.v1.PartyActivityStreak
	165, // 248: vega.snapshot.v1.VolumeDiscountProgram.epoch_party_volumes:type_name -> vega.snapshot.v1.EpochPartyVolumes
	166, // 249: vega.snapshot.v1.VolumeDiscountProgram.average_party_volume:type_name -> vega.snapshot.v1.PartyVolume
	205, // 250: vega.snapshot.v1.VolumeDiscountProgram.current_program:type_name -> vega.VolumeDiscountProgram
	205, // 251: vega.snapshot.v1.VolumeDiscountProgram.new_program:type_name -> vega.VolumeDiscountProgram
	164, // 252: vega.snapshot.v1.VolumeDiscountProgram.factors_by_party:type_name -> vega.snapshot.v1.VolumeDiscountStats
	166, // 253: vega.snapshot.v1.EpochPartyVolumes.party_volume:type_name -> vega.snapshot.v1.PartyVolume
