...
func (x *InputData) GetDelayedTransactionsWrapper() *DelayedTransactionsWrapper {
	if x, ok := x.GetCommand().(*InputData_DelayedTransactionsWrapper); ok {
		return x.DelayedTransactionsWrapper
	}
	return nil
}
...
type InputData_UpdateVault struct {
	// Command to updaate an existing vault.
...
type InputData_DelayedTransactionsWrapper struct {
	// Internal transactions used to convey delayed transactions to be included in the next block.
	DelayedTransactionsWrapper *DelayedTransactionsWrapper `protobuf:"bytes,4000,opt,name=delayed_transactions_wrapper,json=delayedTransactionsWrapper,proto3,oneof"`
}
...
func (*InputData_DelayedTransactionsWrapper) isInputData_Command() {}
...
func file_vega_commands_v1_transaction_proto_init() {
	...
	file_vega_commands_v1_transaction_proto_msgTypes[0].OneofWrappers = []interface{}{
		...
		(*InputData_DelayedTransactionsWrapper)(nil),
	}
