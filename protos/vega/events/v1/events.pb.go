...
var file_vega_events_v1_events_proto_msgTypes = make([]protoimpl.MessageInfo, 85)
...
var file_vega_events_v1_events_proto_depIdxs = []int32{
	...
	92,  // 16: vega.events.v1.StopOrderEvent.submission:type_name -> vega.commands.v1.OrderSubmission
	93,  // 17: vega.events.v1.StopOrderEvent.stop_order:type_name -> vega.StopOrder
	...
	94,  // 19: vega.events.v1.Transfer.from_account_type:type_name -> vega.AccountType
	94,  // 20: vega.events.v1.Transfer.to_account_type:type_name -> vega.AccountType
	...
	95,  // 26: vega.events.v1.RecurringTransfer.dispatch_strategy:type_name -> vega.DispatchStrategy
	95,  // 27: vega.events.v1.RecurringGovernanceTransfer.dispatch_strategy:type_name -> vega.DispatchStrategy
