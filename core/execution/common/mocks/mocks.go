...
// Source: code.vegaprotocol.io/vega/core/execution/common (interfaces: TimeService,Assets,StateVarEngine,Collateral,OracleEngine,EpochEngine,AuctionState,LiquidityEngine,EquityLikeShares,MarketLiquidityEngine,Teams,AccountBalanceChecker,Banking,AMM,AMMPool)
...
func (m *MockCollateral) ClearSpotMarket(arg0 context.Context, arg1, arg2 string, arg3 []string) ([]*types.LedgerMovement, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ClearSpotMarket", arg0, arg1, arg2, arg3)
	ret0, _ := ret[0].([]*types.LedgerMovement)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockCollateralMockRecorder) ClearSpotMarket(arg0, arg1, arg2, arg3 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ClearSpotMarket", reflect.TypeOf((*MockCollateral)(nil).ClearSpotMarket), arg0, arg1, arg2, arg3)
}
...
func (m *MockAMM) GetAMMPools() map[string]common0.AMMPool {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAMMPools")
	ret0, _ := ret[0].(map[string]common0.AMMPool)
	return ret0
}
