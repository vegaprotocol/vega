...
// ConsolidateFeePayoutOnBuyer changes the given fees transfers such that they are all taken from the given buyer.
func (e *Engine) ConsolidateFeePayoutOnBuyer(fees events.FeesTransfer, buyer string) events.FeesTransfer {
	total := num.UintZero()
