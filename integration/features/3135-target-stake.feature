...
#    And the max_oi for the market "ETH/DEC21" is "60"
    ...
    Then the target stake for the market "ETH/DEC21" is "990"

    # T0 + 8 days + 1 hour
    When time is updated to "2021-03-08T00:01:00Z"
...
#    And the max_oi for the market "ETH/DEC21" is "60"
    ...
    Then the target stake for the market "ETH/DEC21" is "810"

    # T0 + 15 days + 2 hour
    # so now the peak of 60 should have passed from window
    When time is updated to "2021-03-15T00:02:00Z"

#    Then the max_oi for the market "ETH/DEC21" is "40"
