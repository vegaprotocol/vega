...
# setup orderbook
    Then traders place following orders:
      ...
      | sellSideProvider | ETH/DEC19 | sell |    200 | 10000 |                0 | LIMIT | TIF_GTC |
      | buySideProvider  | ETH/DEC19 | buy  |    200 |     1 |                0 | LIMIT | TIF_GTC |
    ...
    Then traders place following orders:
      | trader    | id        | type      | volume | price | resulting trades | type  | tif |
      | traderGuy | ETH/DEC19 | buy       |    100 | 10000 |                1 | LIMIT | TIF_GTC |
