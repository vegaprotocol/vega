...
ALTER TABLE markets ADD COLUMN IF NOT EXISTS liquidation_strategy jsonb;

ALTER TABLE markets_current ADD COLUMN IF NOT EXISTS liquidation_strategy jsonb;
