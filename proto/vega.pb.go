...
type MarketData struct {
	...
	OpenInterest uint64 `protobuf:"varint,13,opt,name=openInterest,proto3" json:"openInterest,omitempty"`
	// Time in seconds until the end of the auction (0 if currently not in auction period).
	AuctionEnd int64 `protobuf:"varint,14,opt,name=auctionEnd,proto3" json:"auctionEnd,omitempty"`
	// Time until next auction (used in FBA's) - currently always 0.
	AuctionStart int64 `protobuf:"varint,15,opt,name=auctionStart,proto3" json:"auctionStart,omitempty"`
	// indicative price (zero if not in auction)
	IndicativePrice uint64 `protobuf:"varint,16,opt,name=indicativePrice,proto3" json:"indicativePrice,omitempty"`
	// indicative volume (zero if not in auction)
	IndicativeVolume uint64 `protobuf:"varint,17,opt,name=indicativeVolume,proto3" json:"indicativeVolume,omitempty"`
	// the current state of the market
	MarketState MarketState `protobuf:"varint,18,opt,name=marketState,proto3,enum=vega.MarketState" json:"marketState,omitempty"`
	// if the market is in auction state, this field indicates what triggered the auction
	Trigger AuctionTrigger `protobuf:"varint,19,opt,name=trigger,proto3,enum=vega.AuctionTrigger" json:"trigger,omitempty"`
	// the targeted stake for the given market
	TargetStake string `protobuf:"bytes,20,opt,name=targetStake,proto3" json:"targetStake,omitempty"`
	// the available stake fo the given market
	SuppliedStake        string   `protobuf:"bytes,21,opt,name=suppliedStake,proto3" json:"suppliedStake,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
var fileDescriptor_bb6b8173ee11af27 = []byte{
	...
	,
}
