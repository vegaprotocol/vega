...
var file_vega_events_v1_events_proto_rawDesc = []byte{
	...
	0x53, 0x65, 0x71, 0x22, 0xe8, 0x04, 0x0a, 0x08, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x66, 0x65, 0x72,
	...
	0x70, 0x12, 0x39, 0x0a, 0x07, 0x6f, 0x6e, 0x65, 0x5f, 0x6f, 0x66, 0x66, 0x18, 0x65, 0x20, 0x01,
	...
	0x65, 0x72, 0x48, 0x00, 0x52, 0x09, 0x72, 0x65, 0x63, 0x75, 0x72, 0x72, 0x69, 0x6e, 0x67, 0x22,
	...
	0x4c, 0x4c, 0x45, 0x44, 0x10, 0x05, 0x42, 0x06, 0x0a, 0x04, 0x6b, 0x69, 0x6e, 0x64, 0x22, 0x2f,
	...
	0x22, 0x9a, 0x0f, 0x0a, 0x11, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e,
	...
	0x74, 0x49, 0x6e, 0x73, 0x74, 0x72, 0x75, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x12, 0x4d, 0x0a,
	...
	0x8c, 0x03, 0x0a, 0x0f, 0x56, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x6f, 0x72, 0x55, 0x70, 0x64,
	...
	0x62, 0x6d, 0x69, 0x74, 0x74, 0x65, 0x72, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x22, 0xb2,
	...
	0x61, 0x73, 0x74, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x48, 0x65, 0x69, 0x67, 0x68, 0x74, 0x22, 0x80,
	...
	0x03, 0x2a, 0x9d, 0x0f, 0x0a, 0x0c, 0x42, 0x75, 0x73, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x54, 0x79,
	...
	0x52, 0x45, 0x53, 0x55, 0x4c, 0x54, 0x10, 0x35, 0x12, 0x19, 0x0a, 0x15, 0x42, 0x55, 0x53, 0x5f,
...
var file_vega_events_v1_events_proto_goTypes = []interface{}{
	...
	(vega.EpochAction)(0),                       // 67: vega.EpochAction
	(*vega.LedgerMovement)(nil),                 // 68: vega.LedgerMovement
	(vega.AuctionTrigger)(0),                    // 69: vega.AuctionTrigger
	(*vega.Order)(nil),                          // 70: vega.Order
	(*vega.Account)(nil),                        // 71: vega.Account
	(*vega.Party)(nil),                          // 72: vega.Party
	(*vega.Trade)(nil),                          // 73: vega.Trade
	(*vega.MarginLevels)(nil),                   // 74: vega.MarginLevels
	(*vega.Proposal)(nil),                       // 75: vega.Proposal
	(*vega.Vote)(nil),                           // 76: vega.Vote
	(*vega.MarketData)(nil),                     // 77: vega.MarketData
	(*v1.NodeSignature)(nil),                    // 78: vega.commands.v1.NodeSignature
	(*vega.Market)(nil),                         // 79: vega.Market
	(*vega.Asset)(nil),                          // 80: vega.Asset
	(*vega.Withdrawal)(nil),                     // 81: vega.Withdrawal
	(*vega.Deposit)(nil),                        // 82: vega.Deposit
	(*vega.RiskFactor)(nil),                     // 83: vega.RiskFactor
	(*vega.NetworkParameter)(nil),               // 84: vega.NetworkParameter
	(*vega.LiquidityProvision)(nil),             // 85: vega.LiquidityProvision
	(*v11.OracleSpec)(nil),                      // 86: oracles.v1.OracleSpec
	(*v11.OracleData)(nil),                      // 87: oracles.v1.OracleData
	(*vega.NetworkLimits)(nil),                  // 88: vega.NetworkLimits
}
var file_vega_events_v1_events_proto_depIdxs = []int32{
	...
	45,  // 28: vega.events.v1.TransactionResult.success:type_name -> vega.events.v1.TransactionResult.SuccessDetails
	46,  // 29: vega.events.v1.TransactionResult.failure:type_name -> vega.events.v1.TransactionResult.FailureDetails
	49,  // 30: vega.events.v1.TxErrorEvent.order_submission:type_name -> vega.commands.v1.OrderSubmission
	50,  // 31: vega.events.v1.TxErrorEvent.order_amendment:type_name -> vega.commands.v1.OrderAmendment
	51,  // 32: vega.events.v1.TxErrorEvent.order_cancellation:type_name -> vega.commands.v1.OrderCancellation
	52,  // 33: vega.events.v1.TxErrorEvent.proposal:type_name -> vega.commands.v1.ProposalSubmission
	53,  // 34: vega.events.v1.TxErrorEvent.vote_submission:type_name -> vega.commands.v1.VoteSubmission
	54,  // 35: vega.events.v1.TxErrorEvent.liquidity_provision_submission:type_name -> vega.commands.v1.LiquidityProvisionSubmission
	55,  // 36: vega.events.v1.TxErrorEvent.withdraw_submission:type_name -> vega.commands.v1.WithdrawSubmission
	56,  // 37: vega.events.v1.TxErrorEvent.delegate_submission:type_name -> vega.commands.v1.DelegateSubmission
	57,  // 38: vega.events.v1.TxErrorEvent.undelegate_submission:type_name -> vega.commands.v1.UndelegateSubmission
	58,  // 39: vega.events.v1.TxErrorEvent.liquidity_provision_cancellation:type_name -> vega.commands.v1.LiquidityProvisionCancellation
	59,  // 40: vega.events.v1.TxErrorEvent.liquidity_provision_amendment:type_name -> vega.commands.v1.LiquidityProvisionAmendment
	60,  // 41: vega.events.v1.TxErrorEvent.transfer:type_name -> vega.commands.v1.Transfer
	61,  // 42: vega.events.v1.TxErrorEvent.cancel_transfer:type_name -> vega.commands.v1.CancelTransfer
	62,  // 43: vega.events.v1.TxErrorEvent.announce_node:type_name -> vega.commands.v1.AnnounceNode
	63,  // 44: vega.events.v1.TxErrorEvent.oracle_data_submission:type_name -> vega.commands.v1.OracleDataSubmission
	64,  // 45: vega.events.v1.TxErrorEvent.protocol_upgrade_proposal:type_name -> vega.commands.v1.ProtocolUpgradeProposal
	65,  // 46: vega.events.v1.TxErrorEvent.issue_signatures:type_name -> vega.commands.v1.IssueSignatures
	66,  // 47: vega.events.v1.TxErrorEvent.batch_market_instructions:type_name -> vega.commands.v1.BatchMarketInstructions
	67,  // 48: vega.events.v1.EpochEvent.action:type_name -> vega.EpochAction
	68,  // 49: vega.events.v1.LedgerMovements.ledger_movements:type_name -> vega.LedgerMovement
	28,  // 50: vega.events.v1.SettlePosition.trade_settlements:type_name -> vega.events.v1.TradeSettlement
	69,  // 51: vega.events.v1.AuctionEvent.trigger:type_name -> vega.AuctionTrigger
	69,  // 52: vega.events.v1.AuctionEvent.extension_trigger:type_name -> vega.AuctionTrigger
	0,   // 53: vega.events.v1.ProtocolUpgradeEvent.status:type_name -> vega.events.v1.ProtocolUpgradeProposalStatus
	1,   // 54: vega.events.v1.BusEvent.type:type_name -> vega.events.v1.BusEventType
	23,  // 55: vega.events.v1.BusEvent.time_update:type_name -> vega.events.v1.TimeUpdate
	25,  // 56: vega.events.v1.BusEvent.ledger_movements:type_name -> vega.events.v1.LedgerMovements
	26,  // 57: vega.events.v1.BusEvent.position_resolution:type_name -> vega.events.v1.PositionResolution
	70,  // 58: vega.events.v1.BusEvent.order:type_name -> vega.Order
	71,  // 59: vega.events.v1.BusEvent.account:type_name -> vega.Account
	72,  // 60: vega.events.v1.BusEvent.party:type_name -> vega.Party
	73,  // 61: vega.events.v1.BusEvent.trade:type_name -> vega.Trade
	74,  // 62: vega.events.v1.BusEvent.margin_levels:type_name -> vega.MarginLevels
	75,  // 63: vega.events.v1.BusEvent.proposal:type_name -> vega.Proposal
	76,  // 64: vega.events.v1.BusEvent.vote:type_name -> vega.Vote
	77,  // 65: vega.events.v1.BusEvent.market_data:type_name -> vega.MarketData
	78,  // 66: vega.events.v1.BusEvent.node_signature:type_name -> vega.commands.v1.NodeSignature
	27,  // 67: vega.events.v1.BusEvent.loss_socialization:type_name -> vega.events.v1.LossSocialization
	29,  // 68: vega.events.v1.BusEvent.settle_position:type_name -> vega.events.v1.SettlePosition
	32,  // 69: vega.events.v1.BusEvent.settle_distressed:type_name -> vega.events.v1.SettleDistressed
	79,  // 70: vega.events.v1.BusEvent.market_created:type_name -> vega.Market
	80,  // 71: vega.events.v1.BusEvent.asset:type_name -> vega.Asset
	33,  // 72: vega.events.v1.BusEvent.market_tick:type_name -> vega.events.v1.MarketTick
	81,  // 73: vega.events.v1.BusEvent.withdrawal:type_name -> vega.Withdrawal
	82,  // 74: vega.events.v1.BusEvent.deposit:type_name -> vega.Deposit
	34,  // 75: vega.events.v1.BusEvent.auction:type_name -> vega.events.v1.AuctionEvent
	83,  // 76: vega.events.v1.BusEvent.risk_factor:type_name -> vega.RiskFactor
	84,  // 77: vega.events.v1.BusEvent.network_parameter:type_name -> vega.NetworkParameter
	85,  // 78: vega.events.v1.BusEvent.liquidity_provision:type_name -> vega.LiquidityProvision
	79,  // 79: vega.events.v1.BusEvent.market_updated:type_name -> vega.Market
	86,  // 80: vega.events.v1.BusEvent.oracle_spec:type_name -> oracles.v1.OracleSpec
	87,  // 81: vega.events.v1.BusEvent.oracle_data:type_name -> oracles.v1.OracleData
	19,  // 82: vega.events.v1.BusEvent.delegation_balance:type_name -> vega.events.v1.DelegationBalanceEvent
	18,  // 83: vega.events.v1.BusEvent.validator_score:type_name -> vega.events.v1.ValidatorScoreEvent
	24,  // 84: vega.events.v1.BusEvent.epoch_event:type_name -> vega.events.v1.EpochEvent
	35,  // 85: vega.events.v1.BusEvent.validator_update:type_name -> vega.events.v1.ValidatorUpdate
	12,  // 86: vega.events.v1.BusEvent.stake_linking:type_name -> vega.events.v1.StakeLinking
	17,  // 87: vega.events.v1.BusEvent.reward_payout:type_name -> vega.events.v1.RewardPayoutEvent
	15,  // 88: vega.events.v1.BusEvent.checkpoint:type_name -> vega.events.v1.CheckpointEvent
	37,  // 89: vega.events.v1.BusEvent.key_rotation:type_name -> vega.events.v1.KeyRotation
	40,  // 90: vega.events.v1.BusEvent.state_var:type_name -> vega.events.v1.StateVar
	88,  // 91: vega.events.v1.BusEvent.network_limits:type_name -> vega.NetworkLimits
	9,   // 92: vega.events.v1.BusEvent.transfer:type_name -> vega.events.v1.Transfer
	36,  // 93: vega.events.v1.BusEvent.ranking_event:type_name -> vega.events.v1.ValidatorRankingEvent
	13,  // 94: vega.events.v1.BusEvent.erc20_multisig_signer_event:type_name -> vega.events.v1.ERC20MultiSigSignerEvent
	14,  // 95: vega.events.v1.BusEvent.erc20_multisig_set_threshold_event:type_name -> vega.events.v1.ERC20MultiSigThresholdSetEvent
	6,   // 96: vega.events.v1.BusEvent.erc20_multisig_signer_added:type_name -> vega.events.v1.ERC20MultiSigSignerAdded
	8,   // 97: vega.events.v1.BusEvent.erc20_multisig_signer_removed:type_name -> vega.events.v1.ERC20MultiSigSignerRemoved
	31,  // 98: vega.events.v1.BusEvent.position_state_event:type_name -> vega.events.v1.PositionStateEvent
	38,  // 99: vega.events.v1.BusEvent.ethereum_key_rotation:type_name -> vega.events.v1.EthereumKeyRotation
	39,  // 100: vega.events.v1.BusEvent.protocol_upgrade_event:type_name -> vega.events.v1.ProtocolUpgradeEvent
	41,  // 101: vega.events.v1.BusEvent.begin_block:type_name -> vega.events.v1.BeginBlock
	42,  // 102: vega.events.v1.BusEvent.end_block:type_name -> vega.events.v1.EndBlock
	43,  // 103: vega.events.v1.BusEvent.protocol_upgrade_started:type_name -> vega.events.v1.ProtocolUpgradeStarted
	30,  // 104: vega.events.v1.BusEvent.settle_market:type_name -> vega.events.v1.SettleMarket
	21,  // 105: vega.events.v1.BusEvent.transaction_result:type_name -> vega.events.v1.TransactionResult
	20,  // 106: vega.events.v1.BusEvent.market:type_name -> vega.events.v1.MarketEvent
	22,  // 107: vega.events.v1.BusEvent.tx_err_event:type_name -> vega.events.v1.TxErrorEvent
