...
func InitializeScenario(s *godog.ScenarioContext) {
	...
	s.Step(`^the parties submit the following delegations:$`, func(table *gherkin.DataTable) error {
		return steps.PartiesDelegateTheFollowingStake(execsetup.executionEngine, table)
	})
	s.Step(`^the parties submit the following undelegations:$`, func(table *gherkin.DataTable) error {
