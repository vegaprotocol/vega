...
// Source: code.vegaprotocol.io/vega/datanode/service (interfaces: OrderStore,ChainStore,MarketStore,MarketDataStore,PositionStore,AccountStore,BalanceStore,RewardStore,AMMStore)
...
func (m *MockAMMStore) ListByStatus(arg0 context.Context, arg1 entities.AMMStatus, arg2 entities.CursorPagination) ([]entities.AMMPool, entities.PageInfo, error) {
	m.ctrl.T.Helper()
...
func (mr *MockAMMStoreMockRecorder) ListByStatus(arg0, arg1, arg2 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListByStatus", reflect.TypeOf((*MockAMMStore)(nil).ListByStatus), arg0, arg1, arg2)
}
