...
var file_vega_data_source_proto_rawDesc = []byte{
	...
	0x69, 0x6c, 0x74, 0x65, 0x72, 0x52, 0x07, 0x66, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x73, 0x22, 0xc9,
	0x01, 0x0a, 0x0b, 0x45, 0x74, 0x68, 0x43, 0x61, 0x6c, 0x6c, 0x53, 0x70, 0x65, 0x63, 0x12, 0x18,
	...
	0x72, 0x52, 0x07, 0x74, 0x72, 0x69, 0x67, 0x67, 0x65, 0x72, 0x22, 0x56, 0x0a, 0x0e, 0x45, 0x74,
...
var file_vega_data_source_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_vega_data_source_proto_goTypes = []interface{}{
	...
	(*v1.Condition)(nil),                    // 11: vega.data.v1.Condition
	(*v1.Signer)(nil),                       // 12: vega.data.v1.Signer
	(*v1.Filter)(nil),                       // 13: vega.data.v1.Filter
...
var file_vega_data_source_proto_depIdxs = []int32{
	...
	11, // 2: vega.DataSourceSpecConfigurationTime.conditions:type_name -> vega.data.v1.Condition
	...
	12, // 6: vega.DataSourceSpecConfiguration.signers:type_name -> vega.data.v1.Signer
	13, // 7: vega.DataSourceSpecConfiguration.filters:type_name -> vega.data.v1.Filter
	14, // 8: vega.EthCallSpec.abi:type_name -> google.protobuf.ListValue
	15, // 9: vega.EthCallSpec.args:type_name -> google.protobuf.Value
	7,  // 10: vega.EthCallSpec.trigger:type_name -> vega.EthCallTrigger
	8,  // 11: vega.EthCallTrigger.time_trigger:type_name -> vega.EthTimeTrigger
	1,  // 12: vega.DataSourceSpec.data:type_name -> vega.DataSourceDefinition
	0,  // 13: vega.DataSourceSpec.status:type_name -> vega.DataSourceSpec.Status
	9,  // 14: vega.ExternalDataSourceSpec.spec:type_name -> vega.DataSourceSpec
