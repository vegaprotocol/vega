...
type DataSourceDefinition_Type int32

const (
	DataSourceDefinition_TYPE_DATA_SOURCE_INVALID DataSourceDefinition_Type = 0
	// Default type
	DataSourceDefinition_TYPE_DATA_SOURCE_EXT_ORACLE DataSourceDefinition_Type = 1
	// Ethereum oracle type
	DataSourceDefinition_TYPE_DATA_SOURCE_EXT_ETHEREUM_ORACLE DataSourceDefinition_Type = 2
	// Internal time trigger type
	DataSourceDefinition_TYPE_DATA_SOURCE_INT_TIME_TRIGGER DataSourceDefinition_Type = 3
)

// Enum value maps for DataSourceDefinition_Type.
var (
	DataSourceDefinition_Type_name = map[int32]string{
		0: "TYPE_DATA_SOURCE_INVALID",
		1: "TYPE_DATA_SOURCE_EXT_ORACLE",
		2: "TYPE_DATA_SOURCE_EXT_ETHEREUM_ORACLE",
		3: "TYPE_DATA_SOURCE_INT_TIME_TRIGGER",
	}
	DataSourceDefinition_Type_value = map[string]int32{
		"TYPE_DATA_SOURCE_INVALID":             0,
		"TYPE_DATA_SOURCE_EXT_ORACLE":          1,
		"TYPE_DATA_SOURCE_EXT_ETHEREUM_ORACLE": 2,
		"TYPE_DATA_SOURCE_INT_TIME_TRIGGER":    3,
	}
)

func (x DataSourceDefinition_Type) Enum() *DataSourceDefinition_Type {
	p := new(DataSourceDefinition_Type)
	*p = x
	return p
}

func (x DataSourceDefinition_Type) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (DataSourceDefinition_Type) Descriptor() protoreflect.EnumDescriptor {
	return file_vega_data_source_proto_enumTypes[0].Descriptor()
}

func (DataSourceDefinition_Type) Type() protoreflect.EnumType {
	return &file_vega_data_source_proto_enumTypes[0]
}

func (x DataSourceDefinition_Type) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use DataSourceDefinition_Type.Descriptor instead.
func (DataSourceDefinition_Type) EnumDescriptor() ([]byte, []int) {
	return file_vega_data_source_proto_rawDescGZIP(), []int{0, 0}
}
...
func (DataSourceSpec_Status) Descriptor() protoreflect.EnumDescriptor {
	return file_vega_data_source_proto_enumTypes[1].Descriptor()
}

func (DataSourceSpec_Status) Type() protoreflect.EnumType {
	return &file_vega_data_source_proto_enumTypes[1]
}
...
func (DataSourceSpec_Status) EnumDescriptor() ([]byte, []int) {
	return file_vega_data_source_proto_rawDescGZIP(), []int{11, 0}
}
...
type EthCallSpec struct {
	...
	Abi *structpb.ListValue `protobuf:"bytes,2,opt,name=abi,proto3" json:"abi,omitempty"`
	...
	Filter     *EthFilter  `protobuf:"bytes,7,opt,name=filter,proto3" json:"filter,omitempty"`
	Normaliser *Normaliser `protobuf:"bytes,8,opt,name=normaliser,proto3" json:"normaliser,omitempty"`
}
...
func (x *EthCallSpec) GetAbi() *structpb.ListValue {
	if x != nil {
		return x.Abi
	}
	return nil
...
func (x *EthCallSpec) GetFilter() *EthFilter {
	if x != nil {
		return x.Filter
	}
	return nil
...
func (x *EthCallSpec) GetNormaliser() *Normaliser {
	if x != nil {
		return x.Normaliser
	}
	return nil
...
func (x *EthFilter) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*EthFilter) ProtoMessage() {}

func (x *EthFilter) ProtoReflect() protoreflect.Message {
	mi := &file_vega_data_source_proto_msgTypes[8]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use EthFilter.ProtoReflect.Descriptor instead.
func (*EthFilter) Descriptor() ([]byte, []int) {
	return file_vega_data_source_proto_rawDescGZIP(), []int{8}
}

func (x *EthFilter) GetFilters() []*v1.Filter {
	if x != nil {
		return x.Filters
	}
	return nil
...
func (x *ExternalDataSourceSpec) Reset() {
	*x = ExternalDataSourceSpec{}
	if protoimpl.UnsafeEnabled {
		mi := &file_vega_data_source_proto_msgTypes[12]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ExternalDataSourceSpec) Descriptor() ([]byte, []int) {
	return file_vega_data_source_proto_rawDescGZIP(), []int{12}
}
...
var file_vega_data_source_proto_rawDesc = []byte{
	...
	0x2f, 0x76, 0x31, 0x2f, 0x73, 0x70, 0x65, 0x63, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xc2,
	0x02, 0x0a, 0x14, 0x44, 0x61, 0x74, 0x61, 0x53, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x44, 0x65, 0x66,
	...
	,
	...
	,
	...
	0x65, 0x66, 0x69, 0x6e, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x12,
	0x33, 0x0a, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0e, 0x32,
	0x1b, 0x2e, 0x76, 0x65, 0x67, 0x61, 0x2e, 0x44, 0x61, 0x74, 0x61, 0x53, 0x6f, 0x75, 0x72, 0x63,
	0x65, 0x53, 0x70, 0x65, 0x63, 0x2e, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x52, 0x06, 0x73, 0x74,
	0x61, 0x74, 0x75, 0x73, 0x22, 0x4b, 0x0a, 0x06, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x16,
	...
	0x5f, 0x41, 0x43, 0x54, 0x49, 0x56, 0x45, 0x10, 0x01, 0x12, 0x16, 0x0a, 0x12, 0x53, 0x54, 0x41,
	0x54, 0x55, 0x53, 0x5f, 0x44, 0x45, 0x41, 0x43, 0x54, 0x49, 0x56, 0x41, 0x54, 0x45, 0x44, 0x10,
	0x02, 0x22, 0x42, 0x0a, 0x16, 0x45, 0x78, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x44, 0x61, 0x74,
	0x61, 0x53, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x53, 0x70, 0x65, 0x63, 0x12, 0x28, 0x0a, 0x04, 0x73,
	0x70, 0x65, 0x63, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x14, 0x2e, 0x76, 0x65, 0x67, 0x61,
	0x2e, 0x44, 0x61, 0x74, 0x61, 0x53, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x53, 0x70, 0x65, 0x63, 0x52,
	0x04, 0x73, 0x70, 0x65, 0x63, 0x42, 0x27, 0x5a, 0x25, 0x63, 0x6f, 0x64, 0x65, 0x2e, 0x76, 0x65,
...
var file_vega_data_source_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_vega_data_source_proto_msgTypes = make([]protoimpl.MessageInfo, 13)
var file_vega_data_source_proto_goTypes = []interface{}{
	(DataSourceDefinition_Type)(0),          // 0: vega.DataSourceDefinition.Type
	(DataSourceSpec_Status)(0),              // 1: vega.DataSourceSpec.Status
	(*DataSourceDefinition)(nil),            // 2: vega.DataSourceDefinition
	(*DataSourceSpecConfigurationTime)(nil), // 3: vega.DataSourceSpecConfigurationTime
	...
	(*EthFilter)(nil),                       // 10: vega.EthFilter
	(*Normaliser)(nil),                      // 11: vega.Normaliser
	(*EthDecimalsNormaliser)(nil),           // 12: vega.EthDecimalsNormaliser
	(*DataSourceSpec)(nil),                  // 13: vega.DataSourceSpec
	(*ExternalDataSourceSpec)(nil),          // 14: vega.ExternalDataSourceSpec
	(*v1.Condition)(nil),                    // 15: vega.data.v1.Condition
	(*v1.Signer)(nil),                       // 16: vega.data.v1.Signer
	(*v1.Filter)(nil),                       // 17: vega.data.v1.Filter
...
var file_vega_data_source_proto_depIdxs = []int32{
	...
	15, // 2: vega.DataSourceSpecConfigurationTime.conditions:type_name -> vega.data.v1.Condition
	3,  // 3: vega.DataSourceDefinitionInternal.time:type_name -> vega.DataSourceSpecConfigurationTime
	6,  // 4: vega.DataSourceDefinitionExternal.oracle:type_name -> vega.DataSourceSpecConfiguration
	7,  // 5: vega.DataSourceDefinitionExternal.eth_oracle:type_name -> vega.EthCallSpec
	16, // 6: vega.DataSourceSpecConfiguration.signers:type_name -> vega.data.v1.Signer
	17, // 7: vega.DataSourceSpecConfiguration.filters:type_name -> vega.data.v1.Filter
	18, // 8: vega.EthCallSpec.abi:type_name -> google.protobuf.ListValue
	19, // 9: vega.EthCallSpec.args:type_name -> google.protobuf.Value
	8,  // 10: vega.EthCallSpec.trigger:type_name -> vega.EthCallTrigger
	10, // 11: vega.EthCallSpec.filter:type_name -> vega.EthFilter
	11, // 12: vega.EthCallSpec.normaliser:type_name -> vega.Normaliser
	9,  // 13: vega.EthCallTrigger.time_trigger:type_name -> vega.EthTimeTrigger
	17, // 14: vega.EthFilter.filters:type_name -> vega.data.v1.Filter
	12, // 15: vega.Normaliser.eth_decimals_normaliser:type_name -> vega.EthDecimalsNormaliser
	2,  // 16: vega.DataSourceSpec.data:type_name -> vega.DataSourceDefinition
	1,  // 17: vega.DataSourceSpec.status:type_name -> vega.DataSourceSpec.Status
	13, // 18: vega.ExternalDataSourceSpec.spec:type_name -> vega.DataSourceSpec
...
func file_vega_data_source_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_vega_data_source_proto_msgTypes[12].Exporter = func(v interface{}, i int) interface{} {
	...
	file_vega_data_source_proto_msgTypes[6].OneofWrappers = []interface{}{
