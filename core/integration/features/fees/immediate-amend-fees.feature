Feature: Fees when amended order trades instantly
  ...
  Scenario: Testing fees in continuous trading with one trade
    ...
    When the parties place the following orders:
      ...
      | trader2 | ETH/DEC21 | sell | 4      | 1002  | 1                | TYPE_LIMIT | TIF_GTC | t2-s4-01  |
...
Scenario: Testing fees in continuous training when an order is ammended to a price where it causes an immediate trade
    Given the parties deposit on asset's general account the following amount:
      | party    | asset | amount    |
      | aux1     | ETH   | 100000000 |
      | aux2     | ETH   | 100000000 |
