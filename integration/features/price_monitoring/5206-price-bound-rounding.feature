Feature: Ensure price bounds are triggered as and when they should be, considering rounding and decimal places
  ...
  Scenario: Replicate issue where price monitoring should be triggered at min bound - 1
    ...
    And the parties submit the following liquidity provision:
      ...
      | lp1 | party1 | ETH/DEC20 | 3905000000000000000 | 0.3 | buy  | BID              | 2          | 1000000 | submission |
      | lp1 | party1 | ETH/DEC20 | 3905000000000000000 | 0.3 | sell | ASK              | 13         | 1000000 | submission |
    ...
    And the market data for the market "ETH/DEC20" should be:
      ...
      | 977142641  | TRADING_MODE_CONTINUOUS | 5       | 975999651 | 978286619 | 1080524332417800000000 | 3905000000000000000 | 2              |
