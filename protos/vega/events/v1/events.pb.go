...
var file_vega_events_v1_events_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x04, 0x52, 0x05, 0x65, 0x70, 0x6f, 0x63, 0x68, 0x22, 0xf4, 0x16, 0x0a, 0x11, 0x54,
	...
	0x65, 0x12, 0x4d, 0x0a, 0x07, 0x73, 0x75, 0x63, 0x63, 0x65, 0x73, 0x73, 0x18, 0xe9, 0x07, 0x20,
	...
	0x6c, 0x65, 0x22, 0x82, 0x35, 0x0a, 0x08, 0x42, 0x75, 0x73, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x12,
	...
	0x45, 0x43, 0x54, 0x45, 0x44, 0x10, 0x03, 0x2a, 0xa4, 0x1a, 0x0a, 0x0c, 0x42, 0x75, 0x73, 0x45,
	...
	0x54, 0x45, 0x44, 0x10, 0x56, 0x12, 0x19, 0x0a, 0x15, 0x42, 0x55, 0x53, 0x5f, 0x45, 0x56, 0x45,
...
var file_vega_events_v1_events_proto_goTypes = []interface{}{
	...
	(vega.EpochAction)(0),                       // 124: vega.EpochAction
	(*vega.LedgerMovement)(nil),                 // 125: vega.LedgerMovement
	(vega.AuctionTrigger)(0),                    // 126: vega.AuctionTrigger
	(*vega.ReferralProgram)(nil),                // 127: vega.ReferralProgram
	(*vega.VolumeDiscountProgram)(nil),          // 128: vega.VolumeDiscountProgram
	(vega.MarginMode)(0),                        // 129: vega.MarginMode
	(*vega.PartyProfile)(nil),                   // 130: vega.PartyProfile
	(*vega.Order)(nil),                          // 131: vega.Order
	(*vega.Account)(nil),                        // 132: vega.Account
	(*vega.Party)(nil),                          // 133: vega.Party
	(*vega.Trade)(nil),                          // 134: vega.Trade
	(*vega.MarginLevels)(nil),                   // 135: vega.MarginLevels
	(*vega.Proposal)(nil),                       // 136: vega.Proposal
	(*vega.Vote)(nil),                           // 137: vega.Vote
	(*vega.MarketData)(nil),                     // 138: vega.MarketData
	(*v1.NodeSignature)(nil),                    // 139: vega.commands.v1.NodeSignature
	(*vega.Market)(nil),                         // 140: vega.Market
	(*vega.Asset)(nil),                          // 141: vega.Asset
	(*vega.Withdrawal)(nil),                     // 142: vega.Withdrawal
	(*vega.Deposit)(nil),                        // 143: vega.Deposit
	(*vega.RiskFactor)(nil),                     // 144: vega.RiskFactor
	(*vega.NetworkParameter)(nil),               // 145: vega.NetworkParameter
	(*vega.LiquidityProvision)(nil),             // 146: vega.LiquidityProvision
	(*vega.OracleSpec)(nil),                     // 147: vega.OracleSpec
	(*vega.OracleData)(nil),                     // 148: vega.OracleData
	(*vega.NetworkLimits)(nil),                  // 149: vega.NetworkLimits
}
var file_vega_events_v1_events_proto_depIdxs = []int32{
	...
	90,  // 60: vega.events.v1.TransactionResult.success:type_name -> vega.events.v1.TransactionResult.SuccessDetails
	91,  // 61: vega.events.v1.TransactionResult.failure:type_name -> vega.events.v1.TransactionResult.FailureDetails
	92,  // 62: vega.events.v1.TxErrorEvent.order_submission:type_name -> vega.commands.v1.OrderSubmission
	96,  // 63: vega.events.v1.TxErrorEvent.order_amendment:type_name -> vega.commands.v1.OrderAmendment
	97,  // 64: vega.events.v1.TxErrorEvent.order_cancellation:type_name -> vega.commands.v1.OrderCancellation
	98,  // 65: vega.events.v1.TxErrorEvent.proposal:type_name -> vega.commands.v1.ProposalSubmission
	99,  // 66: vega.events.v1.TxErrorEvent.vote_submission:type_name -> vega.commands.v1.VoteSubmission
	100, // 67: vega.events.v1.TxErrorEvent.liquidity_provision_submission:type_name -> vega.commands.v1.LiquidityProvisionSubmission
	101, // 68: vega.events.v1.TxErrorEvent.withdraw_submission:type_name -> vega.commands.v1.WithdrawSubmission
	102, // 69: vega.events.v1.TxErrorEvent.delegate_submission:type_name -> vega.commands.v1.DelegateSubmission
	103, // 70: vega.events.v1.TxErrorEvent.undelegate_submission:type_name -> vega.commands.v1.UndelegateSubmission
	104, // 71: vega.events.v1.TxErrorEvent.liquidity_provision_cancellation:type_name -> vega.commands.v1.LiquidityProvisionCancellation
	105, // 72: vega.events.v1.TxErrorEvent.liquidity_provision_amendment:type_name -> vega.commands.v1.LiquidityProvisionAmendment
	106, // 73: vega.events.v1.TxErrorEvent.transfer:type_name -> vega.commands.v1.Transfer
	107, // 74: vega.events.v1.TxErrorEvent.cancel_transfer:type_name -> vega.commands.v1.CancelTransfer
	108, // 75: vega.events.v1.TxErrorEvent.announce_node:type_name -> vega.commands.v1.AnnounceNode
	109, // 76: vega.events.v1.TxErrorEvent.oracle_data_submission:type_name -> vega.commands.v1.OracleDataSubmission
	110, // 77: vega.events.v1.TxErrorEvent.protocol_upgrade_proposal:type_name -> vega.commands.v1.ProtocolUpgradeProposal
	111, // 78: vega.events.v1.TxErrorEvent.issue_signatures:type_name -> vega.commands.v1.IssueSignatures
	112, // 79: vega.events.v1.TxErrorEvent.batch_market_instructions:type_name -> vega.commands.v1.BatchMarketInstructions
	124, // 80: vega.events.v1.EpochEvent.action:type_name -> vega.EpochAction
	125, // 81: vega.events.v1.LedgerMovements.ledger_movements:type_name -> vega.LedgerMovement
	51,  // 82: vega.events.v1.SettlePosition.trade_settlements:type_name -> vega.events.v1.TradeSettlement
	126, // 83: vega.events.v1.AuctionEvent.trigger:type_name -> vega.AuctionTrigger
	126, // 84: vega.events.v1.AuctionEvent.extension_trigger:type_name -> vega.AuctionTrigger
	...
	127, // 87: vega.events.v1.ReferralProgramStarted.program:type_name -> vega.ReferralProgram
	127, // 88: vega.events.v1.ReferralProgramUpdated.program:type_name -> vega.ReferralProgram
	128, // 89: vega.events.v1.VolumeDiscountProgramStarted.program:type_name -> vega.VolumeDiscountProgram
	128, // 90: vega.events.v1.VolumeDiscountProgramUpdated.program:type_name -> vega.VolumeDiscountProgram
	18,  // 91: vega.events.v1.PaidLiquidityFeesStats.fees_paid_per_party:type_name -> vega.events.v1.PartyAmount
	129, // 92: vega.events.v1.PartyMarginModeUpdated.margin_mode:type_name -> vega.MarginMode
	130, // 93: vega.events.v1.PartyProfileUpdated.updated_profile:type_name -> vega.PartyProfile
	1,   // 94: vega.events.v1.BusEvent.type:type_name -> vega.events.v1.BusEventType
	46,  // 95: vega.events.v1.BusEvent.time_update:type_name -> vega.events.v1.TimeUpdate
	48,  // 96: vega.events.v1.BusEvent.ledger_movements:type_name -> vega.events.v1.LedgerMovements
	49,  // 97: vega.events.v1.BusEvent.position_resolution:type_name -> vega.events.v1.PositionResolution
	131, // 98: vega.events.v1.BusEvent.order:type_name -> vega.Order
	132, // 99: vega.events.v1.BusEvent.account:type_name -> vega.Account
	133, // 100: vega.events.v1.BusEvent.party:type_name -> vega.Party
	134, // 101: vega.events.v1.BusEvent.trade:type_name -> vega.Trade
	135, // 102: vega.events.v1.BusEvent.margin_levels:type_name -> vega.MarginLevels
	136, // 103: vega.events.v1.BusEvent.proposal:type_name -> vega.Proposal
	137, // 104: vega.events.v1.BusEvent.vote:type_name -> vega.Vote
	138, // 105: vega.events.v1.BusEvent.market_data:type_name -> vega.MarketData
	139, // 106: vega.events.v1.BusEvent.node_signature:type_name -> vega.commands.v1.NodeSignature
	50,  // 107: vega.events.v1.BusEvent.loss_socialization:type_name -> vega.events.v1.LossSocialization
	52,  // 108: vega.events.v1.BusEvent.settle_position:type_name -> vega.events.v1.SettlePosition
	55,  // 109: vega.events.v1.BusEvent.settle_distressed:type_name -> vega.events.v1.SettleDistressed
	140, // 110: vega.events.v1.BusEvent.market_created:type_name -> vega.Market
	141, // 111: vega.events.v1.BusEvent.asset:type_name -> vega.Asset
	58,  // 112: vega.events.v1.BusEvent.market_tick:type_name -> vega.events.v1.MarketTick
	142, // 113: vega.events.v1.BusEvent.withdrawal:type_name -> vega.Withdrawal
	143, // 114: vega.events.v1.BusEvent.deposit:type_name -> vega.Deposit
	59,  // 115: vega.events.v1.BusEvent.auction:type_name -> vega.events.v1.AuctionEvent
	144, // 116: vega.events.v1.BusEvent.risk_factor:type_name -> vega.RiskFactor
	145, // 117: vega.events.v1.BusEvent.network_parameter:type_name -> vega.NetworkParameter
	146, // 118: vega.events.v1.BusEvent.liquidity_provision:type_name -> vega.LiquidityProvision
	140, // 119: vega.events.v1.BusEvent.market_updated:type_name -> vega.Market
	147, // 120: vega.events.v1.BusEvent.oracle_spec:type_name -> vega.OracleSpec
	148, // 121: vega.events.v1.BusEvent.oracle_data:type_name -> vega.OracleData
	40,  // 122: vega.events.v1.BusEvent.delegation_balance:type_name -> vega.events.v1.DelegationBalanceEvent
	39,  // 123: vega.events.v1.BusEvent.validator_score:type_name -> vega.events.v1.ValidatorScoreEvent
	47,  // 124: vega.events.v1.BusEvent.epoch_event:type_name -> vega.events.v1.EpochEvent
	60,  // 125: vega.events.v1.BusEvent.validator_update:type_name -> vega.events.v1.ValidatorUpdate
	33,  // 126: vega.events.v1.BusEvent.stake_linking:type_name -> vega.events.v1.StakeLinking
	38,  // 127: vega.events.v1.BusEvent.reward_payout:type_name -> vega.events.v1.RewardPayoutEvent
	36,  // 128: vega.events.v1.BusEvent.checkpoint:type_name -> vega.events.v1.CheckpointEvent
	62,  // 129: vega.events.v1.BusEvent.key_rotation:type_name -> vega.events.v1.KeyRotation
	65,  // 130: vega.events.v1.BusEvent.state_var:type_name -> vega.events.v1.StateVar
	149, // 131: vega.events.v1.BusEvent.network_limits:type_name -> vega.NetworkLimits
	28,  // 132: vega.events.v1.BusEvent.transfer:type_name -> vega.events.v1.Transfer
	61,  // 133: vega.events.v1.BusEvent.ranking_event:type_name -> vega.events.v1.ValidatorRankingEvent
	34,  // 134: vega.events.v1.BusEvent.erc20_multisig_signer_event:type_name -> vega.events.v1.ERC20MultiSigSignerEvent
	35,  // 135: vega.events.v1.BusEvent.erc20_multisig_set_threshold_event:type_name -> vega.events.v1.ERC20MultiSigThresholdSetEvent
	25,  // 136: vega.events.v1.BusEvent.erc20_multisig_signer_added:type_name -> vega.events.v1.ERC20MultiSigSignerAdded
	27,  // 137: vega.events.v1.BusEvent.erc20_multisig_signer_removed:type_name -> vega.events.v1.ERC20MultiSigSignerRemoved
	54,  // 138: vega.events.v1.BusEvent.position_state_event:type_name -> vega.events.v1.PositionStateEvent
	63,  // 139: vega.events.v1.BusEvent.ethereum_key_rotation:type_name -> vega.events.v1.EthereumKeyRotation
	64,  // 140: vega.events.v1.BusEvent.protocol_upgrade_event:type_name -> vega.events.v1.ProtocolUpgradeEvent
	66,  // 141: vega.events.v1.BusEvent.begin_block:type_name -> vega.events.v1.BeginBlock
	67,  // 142: vega.events.v1.BusEvent.end_block:type_name -> vega.events.v1.EndBlock
	68,  // 143: vega.events.v1.BusEvent.protocol_upgrade_started:type_name -> vega.events.v1.ProtocolUpgradeStarted
	53,  // 144: vega.events.v1.BusEvent.settle_market:type_name -> vega.events.v1.SettleMarket
	44,  // 145: vega.events.v1.BusEvent.transaction_result:type_name -> vega.events.v1.TransactionResult
	70,  // 146: vega.events.v1.BusEvent.core_snapshot_event:type_name -> vega.events.v1.CoreSnapshotData
	69,  // 147: vega.events.v1.BusEvent.protocol_upgrade_data_node_ready:type_name -> vega.events.v1.ProtocolUpgradeDataNodeReady
	56,  // 148: vega.events.v1.BusEvent.distressed_orders:type_name -> vega.events.v1.DistressedOrders
	71,  // 149: vega.events.v1.BusEvent.expired_orders:type_name -> vega.events.v1.ExpiredOrders
	57,  // 150: vega.events.v1.BusEvent.distressed_positions:type_name -> vega.events.v1.DistressedPositions
	24,  // 151: vega.events.v1.BusEvent.stop_order:type_name -> vega.events.v1.StopOrderEvent
	20,  // 152: vega.events.v1.BusEvent.funding_period:type_name -> vega.events.v1.FundingPeriod
	23,  // 153: vega.events.v1.BusEvent.funding_period_data_point:type_name -> vega.events.v1.FundingPeriodDataPoint
	72,  // 154: vega.events.v1.BusEvent.team_created:type_name -> vega.events.v1.TeamCreated
	73,  // 155: vega.events.v1.BusEvent.team_updated:type_name -> vega.events.v1.TeamUpdated
	74,  // 156: vega.events.v1.BusEvent.referee_switched_team:type_name -> vega.events.v1.RefereeSwitchedTeam
	75,  // 157: vega.events.v1.BusEvent.referee_joined_team:type_name -> vega.events.v1.RefereeJoinedTeam
	80,  // 158: vega.events.v1.BusEvent.referral_program_started:type_name -> vega.events.v1.ReferralProgramStarted
	81,  // 159: vega.events.v1.BusEvent.referral_program_updated:type_name -> vega.events.v1.ReferralProgramUpdated
	82,  // 160: vega.events.v1.BusEvent.referral_program_ended:type_name -> vega.events.v1.ReferralProgramEnded
	76,  // 161: vega.events.v1.BusEvent.referral_set_created:type_name -> vega.events.v1.ReferralSetCreated
	79,  // 162: vega.events.v1.BusEvent.referee_joined_referral_set:type_name -> vega.events.v1.RefereeJoinedReferralSet
	19,  // 163: vega.events.v1.BusEvent.party_activity_streak:type_name -> vega.events.v1.PartyActivityStreak
	83,  // 164: vega.events.v1.BusEvent.volume_discount_program_started:type_name -> vega.events.v1.VolumeDiscountProgramStarted
	84,  // 165: vega.events.v1.BusEvent.volume_discount_program_updated:type_name -> vega.events.v1.VolumeDiscountProgramUpdated
	85,  // 166: vega.events.v1.BusEvent.volume_discount_program_ended:type_name -> vega.events.v1.VolumeDiscountProgramEnded
	77,  // 167: vega.events.v1.BusEvent.referral_set_stats_updated:type_name -> vega.events.v1.ReferralSetStatsUpdated
	13,  // 168: vega.events.v1.BusEvent.vesting_stats_updated:type_name -> vega.events.v1.VestingStatsUpdated
	11,  // 169: vega.events.v1.BusEvent.volume_discount_stats_updated:type_name -> vega.events.v1.VolumeDiscountStatsUpdated
	15,  // 170: vega.events.v1.BusEvent.fees_stats:type_name -> vega.events.v1.FeesStats
	22,  // 171: vega.events.v1.BusEvent.funding_payments:type_name -> vega.events.v1.FundingPayments
	86,  // 172: vega.events.v1.BusEvent.paid_liquidity_fees_stats:type_name -> vega.events.v1.PaidLiquidityFeesStats
	7,   // 173: vega.events.v1.BusEvent.vesting_balances_summary:type_name -> vega.events.v1.VestingBalancesSummary
	42,  // 174: vega.events.v1.BusEvent.transfer_fees:type_name -> vega.events.v1.TransferFees
	43,  // 175: vega.events.v1.BusEvent.transfer_fees_discount:type_name -> vega.events.v1.TransferFeesDiscount
	87,  // 176: vega.events.v1.BusEvent.party_margin_mode_updated:type_name -> vega.events.v1.PartyMarginModeUpdated
	88,  // 177: vega.events.v1.BusEvent.party_profile_updated:type_name -> vega.events.v1.PartyProfileUpdated
	41,  // 178: vega.events.v1.BusEvent.market:type_name -> vega.events.v1.MarketEvent
	45,  // 179: vega.events.v1.BusEvent.tx_err_event:type_name -> vega.events.v1.TxErrorEvent
