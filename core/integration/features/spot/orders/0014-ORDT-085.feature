Feature: Spot market
  ...
  Scenario: Immediate orders, continuous trading A GTT order submitted at a time >= its expiry time is rejected. (0014-ORDT-085)
    ...
    And the parties place the following orders:
      ...
      | party5 | BTC/ETH   | sell | 1      | 1000  | 0                | TYPE_LIMIT | TIF_GTT | sell1     | -10        | invalid expiresAt time |
