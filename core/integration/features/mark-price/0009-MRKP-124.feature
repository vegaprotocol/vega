Feature: Test book mark price
  Background:
    ...
    And the markets:
      ...
      | ETH/FEB23 | ETH        | USD   | lqm-params           | simple-risk-model | default-margin-calculator | 1                | default-none | default-none     | default-eth-for-future | 0.25                   | 0                         | default-futures | weight     | 0.5          | 2           | 50000       | 0,1,0,0        | 6s,4s,24h0m0s,1h25m0s      | future      |
      | ETH/FEB22 | ETH        | USD   | lqm-params           | simple-risk-model | default-margin-calculator | 1                | default-none | default-none     | perp-oracle            | 0.25                   | 0                         | default-futures | weight     | 0.5          | 2           | 50000       | 0,1,0,0        | 6s,4s,24h0m0s,1h25m0s      | perp        |
  ...
  Scenario: 001 check mark price using order price with cash amount 50000 USD
    ...
    And the parties place the following orders:
      ...
      | buySideProvider1  | ETH/FEB22 | buy  | 20     | 14900 | 0                | TYPE_LIMIT | TIF_GTC |
      ...
      | sellSideProvider1 | ETH/FEB22 | sell | 2      | 15950 | 0                | TYPE_LIMIT | TIF_GTC |
      | sellSideProvider1 | ETH/FEB22 | sell | 20     | 20000 | 0                | TYPE_LIMIT | TIF_GTC |

    #AC 0009-MRKP-124, 0009-MRKP-125
    ...
    Then the mark price should be "16878" for the market "ETH/FEB22"

    When the network moves ahead "4" blocks
    Then the mark price should be "16878" for the market "ETH/FEB23"
    Then the mark price should be "16878" for the market "ETH/FEB22"

    #0009-MRKP-126, 0009-MRKP-127
    And the parties place the following orders:
      | party            | market id | side | volume | price | resulting trades | type       | tif     | reference |
      | buySideProvider  | ETH/FEB23 | buy  | 1      | 15950 | 1                | TYPE_LIMIT | TIF_GTC |           |
      | buySideProvider1 | ETH/FEB22 | buy  | 1      | 15950 | 1                | TYPE_LIMIT | TIF_GTC |           |
    ...
    Then the mark price should be "17094" for the market "ETH/FEB22"
