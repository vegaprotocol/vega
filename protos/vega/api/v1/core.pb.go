...
type VoteSpamStatistic struct {
	...
	MinTokensRequired string `protobuf:"bytes,4,opt,name=min_tokens_required,json=minTokensRequired,proto3" json:"min_tokens_required,omitempty"`
}
...
var file_vega_api_v1_core_proto_rawDesc = []byte{
	...
	0x65, 0x71, 0x75, 0x69, 0x72, 0x65, 0x64, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x11, 0x6d,
