Feature: Test liquidity monitoring
  ...
  Scenario: 001: A market which enters a state requiring liquidity auction through increased open interest during a block but then leaves state again prior to block completion never enters liquidity auction. (0035-LIQM-005)
    ...
    And the parties should have the following margin levels:
      ...
      # | party1 | ETH/DEC21 | 110000001100 | 110000001100 | 110000001100 | 220000002200 |
      # | party2 | ETH/DEC21 | 110000001100 | 110000001100 | 110000001100 | 220000002200 |
      | lprov1 | ETH/DEC21 | 0 | 0 | 0 | 0 |
    And the parties should have the following account balances:
      | party  | asset | market id | margin         | general                     | bond      |
      # | party1 | ETH   | ETH/DEC21 | 74999925000000 | 499999999999924999975000000 | 100000000 |
      # | party2 | ETH   | ETH/DEC21 | 74999925000000 | 499999999999924999975000000 | 100000000 |
      | lprov1 | ETH   | ETH/DEC21 | 0              | 999999000                    | 1000      |
