-- +goose Up
alter table market_data add column if not exists mark_price_state JSONB;
alter table current_market_data add column if not exists mark_price_state JSONB;
...
-- +goose Down
alter table current_market_data drop column if exists mark_price_state;
alter table market_data drop column if exists mark_price_state;
