...
var file_vega_snapshot_v1_snapshot_proto_rawDesc = []byte{
	...
	0x72, 0x6b, 0x65, 0x64, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x73, 0x22, 0x8f, 0x02, 0x0a, 0x10, 0x45,
	...
	0x52, 0x0a, 0x73, 0x75, 0x63, 0x63, 0x65, 0x73, 0x73, 0x6f, 0x72, 0x73, 0x22, 0x5e, 0x0a, 0x0a,
	...
	0x75, 0x6e, 0x74, 0x22, 0x94, 0x03, 0x0a, 0x0a, 0x4c, 0x69, 0x6d, 0x69, 0x74, 0x53, 0x74, 0x61,
	...
	0x6e, 0x61, 0x62, 0x6c, 0x65, 0x64, 0x46, 0x72, 0x6f, 0x6d, 0x22, 0x94, 0x04, 0x0a, 0x0e, 0x56,
	...
	0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x22, 0x82, 0x01, 0x0a, 0x16, 0x45, 0x74, 0x68, 0x43,
	...
	0x63, 0x74, 0x43, 0x61, 0x6c, 0x6c, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x22, 0x8a, 0x01, 0x0a,
	...
	0x0c, 0x52, 0x06, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x22, 0x9b, 0x01, 0x0a, 0x12, 0x50, 0x65,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x70, 0x61, 0x72, 0x74, 0x79, 0x49, 0x64, 0x22, 0xb9, 0x01,
	...
	0x6f, 0x6c, 0x64, 0x53, 0x65, 0x74, 0x73, 0x22, 0xa1, 0x03, 0x0a, 0x0b, 0x50, 0x72, 0x6f, 0x6f,
	...
	0x65, 0x52, 0x08, 0x70, 0x6f, 0x77, 0x53, 0x74, 0x61, 0x74, 0x65, 0x22, 0x39, 0x0a, 0x0b, 0x42,
...
var file_vega_snapshot_v1_snapshot_proto_depIdxs = []int32{
	...
	133, // 69: vega.snapshot.v1.OracleData.meta_data:type_name -> vega.data.v1.Property
	16,  // 70: vega.snapshot.v1.Witness.resources:type_name -> vega.snapshot.v1.Resource
	134, // 71: vega.snapshot.v1.CollateralAccounts.accounts:type_name -> vega.Account
	135, // 72: vega.snapshot.v1.CollateralAssets.assets:type_name -> vega.Asset
	135, // 73: vega.snapshot.v1.ActiveAssets.assets:type_name -> vega.Asset
	135, // 74: vega.snapshot.v1.PendingAssets.assets:type_name -> vega.Asset
	135, // 75: vega.snapshot.v1.PendingAssetUpdates.assets:type_name -> vega.Asset
	136, // 76: vega.snapshot.v1.Withdrawal.withdrawal:type_name -> vega.Withdrawal
	137, // 77: vega.snapshot.v1.Deposit.deposit:type_name -> vega.Deposit
	...
	138, // 80: vega.snapshot.v1.BankingAssetActions.asset_action:type_name -> vega.checkpoint.v1.AssetAction
	139, // 81: vega.snapshot.v1.BankingRecurringTransfers.recurring_transfers:type_name -> vega.checkpoint.v1.RecurringTransfers
	140, // 82: vega.snapshot.v1.BankingScheduledTransfers.transfers_at_time:type_name -> vega.checkpoint.v1.ScheduledTransferAtTime
	141, // 83: vega.snapshot.v1.BankingRecurringGovernanceTransfers.recurring_transfers:type_name -> vega.checkpoint.v1.GovernanceTransfer
	142, // 84: vega.snapshot.v1.BankingScheduledGovernanceTransfers.transfers_at_time:type_name -> vega.checkpoint.v1.ScheduledGovernanceTransferAtTime
	143, // 85: vega.snapshot.v1.BankingBridgeState.bridge_state:type_name -> vega.checkpoint.v1.BridgeState
	144, // 86: vega.snapshot.v1.DelegationActive.delegations:type_name -> vega.Delegation
	144, // 87: vega.snapshot.v1.DelegationPending.delegations:type_name -> vega.Delegation
	144, // 88: vega.snapshot.v1.DelegationPending.undelegation:type_name -> vega.Delegation
	145, // 89: vega.snapshot.v1.ProposalData.proposal:type_name -> vega.Proposal
	146, // 90: vega.snapshot.v1.ProposalData.yes:type_name -> vega.Vote
	146, // 91: vega.snapshot.v1.ProposalData.no:type_name -> vega.Vote
	146, // 92: vega.snapshot.v1.ProposalData.invalid:type_name -> vega.Vote
	...
	145, // 95: vega.snapshot.v1.GovernanceNode.proposals:type_name -> vega.Proposal
	147, // 96: vega.snapshot.v1.StakingAccount.events:type_name -> vega.events.v1.StakeLinking
	44,  // 97: vega.snapshot.v1.StakingAccounts.accounts:type_name -> vega.snapshot.v1.StakingAccount
	148, // 98: vega.snapshot.v1.StakingAccounts.pending_stake_total_supply:type_name -> vega.StakeTotalSupply
	149, // 99: vega.snapshot.v1.MatchingBook.buy:type_name -> vega.Order
	149, // 100: vega.snapshot.v1.MatchingBook.sell:type_name -> vega.Order
	150, // 101: vega.snapshot.v1.NetParams.params:type_name -> vega.NetworkParameter
	151, // 102: vega.snapshot.v1.PriceBound.trigger:type_name -> vega.PriceMonitoringTrigger
	...
	152, // 111: vega.snapshot.v1.AuctionState.mode:type_name -> vega.Market.TradingMode
	152, // 112: vega.snapshot.v1.AuctionState.default_mode:type_name -> vega.Market.TradingMode
	153, // 113: vega.snapshot.v1.AuctionState.trigger:type_name -> vega.AuctionTrigger
	154, // 114: vega.snapshot.v1.AuctionState.end:type_name -> vega.AuctionDuration
	153, // 115: vega.snapshot.v1.AuctionState.extension:type_name -> vega.AuctionTrigger
	58,  // 116: vega.snapshot.v1.EquityShare.lps:type_name -> vega.snapshot.v1.EquityShareLP
	155, // 117: vega.snapshot.v1.SpotMarket.market:type_name -> vega.Market
	...
	149, // 121: vega.snapshot.v1.SpotMarket.expiring_orders:type_name -> vega.Order
	...
	155, // 124: vega.snapshot.v1.Market.market:type_name -> vega.Market
	...
	149, // 128: vega.snapshot.v1.Market.expiring_orders:type_name -> vega.Order
	...
	149, // 132: vega.snapshot.v1.Market.expiring_stop_orders:type_name -> vega.Order
	...
	156, // 138: vega.snapshot.v1.StopOrders.stop_orders:type_name -> vega.events.v1.StopOrderEvent
	...
	149, // 141: vega.snapshot.v1.PeggedOrders.parked_orders:type_name -> vega.Order
	...
	157, // 144: vega.snapshot.v1.ExecutionMarkets.settled_markets:type_name -> vega.checkpoint.v1.MarketState
	71,  // 145: vega.snapshot.v1.ExecutionMarkets.successors:type_name -> vega.snapshot.v1.Successors
	72,  // 146: vega.snapshot.v1.MarketPositions.positions:type_name -> vega.snapshot.v1.Position
	75,  // 147: vega.snapshot.v1.SettlementState.last_settled_positions:type_name -> vega.snapshot.v1.LastSettledPosition
	76,  // 148: vega.snapshot.v1.SettlementState.trades:type_name -> vega.snapshot.v1.SettlementTrade
	80,  // 149: vega.snapshot.v1.RewardsPendingPayouts.scheduled_rewards_payout:type_name -> vega.snapshot.v1.ScheduledRewardsPayout
	81,  // 150: vega.snapshot.v1.ScheduledRewardsPayout.rewards_payout:type_name -> vega.snapshot.v1.RewardsPayout
	82,  // 151: vega.snapshot.v1.RewardsPayout.reward_party_amount:type_name -> vega.snapshot.v1.RewardsPartyAmount
	85,  // 152: vega.snapshot.v1.VoteSpamPolicy.party_to_vote:type_name -> vega.snapshot.v1.PartyProposalVoteCount
	124, // 153: vega.snapshot.v1.VoteSpamPolicy.banned_parties:type_name -> vega.snapshot.v1.BannedParty
	86,  // 154: vega.snapshot.v1.VoteSpamPolicy.token_balance:type_name -> vega.snapshot.v1.PartyTokenBalance
	87,  // 155: vega.snapshot.v1.VoteSpamPolicy.recent_blocks_reject_stats:type_name -> vega.snapshot.v1.BlockRejectStats
	88,  // 156: vega.snapshot.v1.SimpleSpamPolicy.party_to_count:type_name -> vega.snapshot.v1.SpamPartyTransactionCount
	124, // 157: vega.snapshot.v1.SimpleSpamPolicy.banned_parties:type_name -> vega.snapshot.v1.BannedParty
	86,  // 158: vega.snapshot.v1.SimpleSpamPolicy.token_balance:type_name -> vega.snapshot.v1.PartyTokenBalance
	90,  // 159: vega.snapshot.v1.Notary.notary_sigs:type_name -> vega.snapshot.v1.NotarySigs
	94,  // 160: vega.snapshot.v1.StakeVerifierDeposited.pending_deposited:type_name -> vega.snapshot.v1.StakeVerifierPending
	94,  // 161: vega.snapshot.v1.StakeVerifierRemoved.pending_removed:type_name -> vega.snapshot.v1.StakeVerifierPending
