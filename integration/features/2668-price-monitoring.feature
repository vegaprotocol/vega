Feature: Price monitoring test for issue 2668
  ...
  Background:
    ...
    And the execution engine have these markets:
      ...
      | ETH/DEC20 | ETH        | ETH   | forward    | 0.000001  | 0.00011407711613050422 | 0              | 0.016           | 0.8   | 1.4            | 1.2            | 1.1           | 0                | 0         | 0                  | 0             | 1                  | 43200          | 0.9999999   | 300             | 0.1              | 0xDEADBEEF,0xCAFEDOOD | prices.ETH.value     | TYPE_INTEGER              | prices.ETH.value    |
  ...
  Scenario: Upper bound breached
    ...
    Then traders place following orders:
      ...
      | trader2 | ETH/DEC20 | buy  | 1      | 6640000 | 0                | TYPE_LIMIT | TIF_FOK | ref-2     |
  ...
  Scenario: Lower bound breached
    ...
    Then traders place following orders:
      ...
      | trader2 | ETH/DEC20 | buy  | 1      | 4840000 | 0                | TYPE_LIMIT | TIF_FOK | ref-2     |
  ...
  Scenario: Upper bound breached (scale prices down by 10000)
    ...
    Then traders place following orders:
      ...
      | trader2 | ETH/DEC20 | buy  | 1      | 664   | 0                | TYPE_LIMIT | TIF_FOK | ref-2     |
