Feature: Target stake
  ...
  Background:
    ...
    And the markets:
      ...
      | ETH/DEC21 | BTC        | BTC   | simple-risk-model-1 | default-margin-calculator | 1                | fees-config-1 | default-none     | default-eth-for-future | 2              | 1e6                    | 1e6                       |
  ...
  Scenario: Max open interest changes over time
    ...
    Given the parties deposit on asset's general account the following amount:
      | party | asset | amount       |
      | tt_0  | BTC   | 100000000000 |
      | tt_1  | BTC   | 100000000000 |
      | tt_2  | BTC   | 100000000000 |
      | tt_3  | BTC   | 100000000000 |
    ...
    And the target stake should be "990000" for the market "ETH/DEC21"
    ...
    And the target stake should be "810000" for the market "ETH/DEC21"
    ...
    And the target stake should be "540000" for the market "ETH/DEC21"
