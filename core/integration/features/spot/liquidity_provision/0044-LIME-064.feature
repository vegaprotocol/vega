Feature: Spot market SLA
  ...
  Scenario: 0044-LIME-064, When the LP increases its commitment and the increment is higher than its general account balance, the increments are rejected, and the old provision persists
    ...
    Then the market data for the market "BTC/ETH" should be:
      ...
      | 15         | TRADING_MODE_CONTINUOUS | AUCTION_TRIGGER_UNSPECIFIED | 3200         | 4000           |
