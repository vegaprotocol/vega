...
var (
	...
	// ErrMissingOracleSpecForSettlementData is returned when the oracle spec for settlement price is absent.
	ErrMissingOracleSpecForSettlementData = errors.New("missing oracle spec for settlement price")
