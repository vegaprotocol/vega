...
func (_m *OrderStore) GetByMarket(market string, filters *filtering.OrderQueryFilters) ([]*msg.Order, error) {
	ret := _m.Called(market, filters)

	var r0 []*msg.Order
	if rf, ok := ret.Get(0).(func(string, *filtering.OrderQueryFilters) []*msg.Order); ok {
...
func (_m *OrderStore) GetByParty(party string, filters *filtering.OrderQueryFilters) ([]*msg.Order, error) {
