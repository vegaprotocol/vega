...
func TestConfigurationHistory(t *testing.T) {
	...
	e.EndOfBlock()
	e.BeginBlock(2, crypto.RandomHash())
	...
	e.EndOfBlock()
	e.BeginBlock(3, crypto.RandomHash())
...
func TestFindParamsForBlockHeight(t *testing.T) {
	...
	e.BeginBlock(9, crypto.RandomHash())
	...
	e.EndOfBlock()
	e.BeginBlock(29, crypto.RandomHash())
