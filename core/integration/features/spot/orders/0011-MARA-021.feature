Feature: Spot market
  ...
  Scenario: In Spot Market, if an order is partially filled then the holding requirements are recalculated reflecting the reduced order size. (0011-MARA-021)
    ...
    And "party5" should have holding account balance of "4" for asset "BTC"
