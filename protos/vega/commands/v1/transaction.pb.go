...
type InputData_SubmitAmm struct {
	...
	SubmitAmm *SubmitAMM `protobuf:"bytes,1025,opt,name=submit_amm,json=submitAmm,proto3,oneof"`
}
...
var file_vega_commands_v1_transaction_proto_rawDesc = []byte{
	...
	0x6f, 0x22, 0x8a, 0x1a, 0x0a, 0x09, 0x49, 0x6e, 0x70, 0x75, 0x74, 0x44, 0x61, 0x74, 0x61, 0x12,
	...
	0x6d, 0x69, 0x74, 0x5f, 0x61, 0x6d, 0x6d, 0x18, 0x81, 0x08, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1b,
	0x2e, 0x76, 0x65, 0x67, 0x61, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x61, 0x6e, 0x64, 0x73, 0x2e, 0x76,
	...
	0x64, 0x5f, 0x61, 0x6d, 0x6d, 0x18, 0x82, 0x08, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x76,
	0x65, 0x67, 0x61, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x61, 0x6e, 0x64, 0x73, 0x2e, 0x76, 0x31, 0x2e,
...
var file_vega_commands_v1_transaction_proto_goTypes = []interface{}{
	...
	(*Signature)(nil),                      // 41: vega.commands.v1.Signature
}
var file_vega_commands_v1_transaction_proto_depIdxs = []int32{
	...
	41, // 37: vega.commands.v1.Transaction.signature:type_name -> vega.commands.v1.Signature
	0,  // 38: vega.commands.v1.Transaction.version:type_name -> vega.commands.v1.TxVersion
	3,  // 39: vega.commands.v1.Transaction.pow:type_name -> vega.commands.v1.ProofOfWork
