Feature: Price monitoring test using forward risk model (bounds for the valid price moves around price of 100000 for the two horizons are: [95878,104251], [90497,110401])
  ...
  Background:
    ...
    And the executon engine have these markets:
      ...
      | ETH/DEC20 | BTC      | ETH       | ETH   |      100000  | forward    |      0.000001 | 0.00011407711613050422 |              0 | 0.016           |   2.0 |            1.4 |            1.2 |           1.1 |              42 |           0 | continuous   |        0 |                 0 |            0 | 60                 |         3600,7200 |   0.95,0.999 |         240,360 |
  ...
  Scenario: Auction triggered by 1st trigger (upper bound breached)
    Given the following traders:
      | name    |      amount  |
      | trader1 | 10000000000  |
      | trader2 | 10000000000  |
  ...
  Scenario: Auction triggered by 1st trigger (lower bound breached), extended by 2nd trigger (upper bound breached)
    Given the following traders:
      | name    |      amount  |
      | trader1 | 10000000000  |
      | trader2 | 10000000000  |
