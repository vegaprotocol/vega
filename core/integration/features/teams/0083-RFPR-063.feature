Feature: Test allow lists, based on team_rewards.feature test in rewards set.
  ...
  @Closed
  Scenario: 0083-RFPR-063 Joining a closed team while not on the allow list should fail
    ...
    When the parties apply the following referral codes:
      ...
      | another2 | referral-code-3 | true    | team3 | some ref  | team "team3" is closed |
  ...
  Scenario: 0083-RFPR-063 Joining a closed team while not on the allow list should fail, team with non-empty join list
    ...
    When the parties apply the following referral codes:
      | party    | code            | is_team | team  | reference | error                                     |
      | another2 | referral-code-1 | true    | team1 | some ref  | party is not allowed to join team "team1" |
    Then the team "team2" has the following members:
      | party     |
      | referrer2 |
      | referee2  |
