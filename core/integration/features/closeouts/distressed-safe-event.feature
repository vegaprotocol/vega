Feature: Ensure distressed status events are correctly emitted, both for safe and distressed parties
  ...
  Background:
    ...
    Given the markets:
      ...
      | ETH/DEC19 | BTC        | BTC   | default-simple-risk-model-2 | default-overkill-margin-calculator | 1                | default-none | default-none     | default-eth-for-future | 1e3                    | 1e3                       | default-futures |
