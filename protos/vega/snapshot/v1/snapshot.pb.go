...
type LiquidityV2Parameters struct {
	...
	BondPenaltiesDisabledRemainingEpochs uint64 `protobuf:"varint,6,opt,name=bond_penalties_disabled_remaining_epochs,json=bondPenaltiesDisabledRemainingEpochs,proto3" json:"bond_penalties_disabled_remaining_epochs,omitempty"`
}
...
func (x *LiquidityV2Parameters) GetBondPenaltiesDisabledRemainingEpochs() uint64 {
	if x != nil {
		return x.BondPenaltiesDisabledRemainingEpochs
	}
	return 0
}
...
var file_vega_snapshot_v1_snapshot_proto_rawDesc = []byte{
	...
	0x09, 0x52, 0x07, 0x70, 0x61, 0x72, 0x74, 0x79, 0x49, 0x64, 0x22, 0xde, 0x02, 0x0a, 0x15, 0x4c,
	...
	0x4d, 0x61, 0x78, 0x12, 0x56, 0x0a, 0x28, 0x62, 0x6f, 0x6e, 0x64, 0x5f, 0x70, 0x65, 0x6e, 0x61,
	0x6c, 0x74, 0x69, 0x65, 0x73, 0x5f, 0x64, 0x69, 0x73, 0x61, 0x62, 0x6c, 0x65, 0x64, 0x5f, 0x72,
	0x65, 0x6d, 0x61, 0x69, 0x6e, 0x69, 0x6e, 0x67, 0x5f, 0x65, 0x70, 0x6f, 0x63, 0x68, 0x73, 0x18,
	0x06, 0x20, 0x01, 0x28, 0x04, 0x52, 0x24, 0x62, 0x6f, 0x6e, 0x64, 0x50, 0x65, 0x6e, 0x61, 0x6c,
	0x74, 0x69, 0x65, 0x73, 0x44, 0x69, 0x73, 0x61, 0x62, 0x6c, 0x65, 0x64, 0x52, 0x65, 0x6d, 0x61,
	0x69, 0x6e, 0x69, 0x6e, 0x67, 0x45, 0x70, 0x6f, 0x63, 0x68, 0x73, 0x22, 0x75, 0x0a, 0x18, 0x4c,
	0x69, 0x71, 0x75, 0x69, 0x64, 0x69, 0x74, 0x79, 0x56, 0x32, 0x50, 0x61, 0x69, 0x64, 0x46, 0x65,
	...
	0x78, 0x74, 0x54, 0x72, 0x69, 0x67, 0x67, 0x65, 0x72, 0x22, 0xc0, 0x01, 0x0a, 0x0d, 0x4d, 0x61,
...
var file_vega_snapshot_v1_snapshot_proto_msgTypes = make([]protoimpl.MessageInfo, 169)
var file_vega_snapshot_v1_snapshot_proto_goTypes = []interface{}{
	...
	(*LiquidityV2PaidFeesStats)(nil),              // 124: vega.snapshot.v1.LiquidityV2PaidFeesStats
	(*LiquidityV2Provisions)(nil),                 // 125: vega.snapshot.v1.LiquidityV2Provisions
	(*LiquidityV2PendingProvisions)(nil),          // 126: vega.snapshot.v1.LiquidityV2PendingProvisions
	(*LiquidityV2Performances)(nil),               // 127: vega.snapshot.v1.LiquidityV2Performances
	(*LiquidityV2PerformancePerParty)(nil),        // 128: vega.snapshot.v1.LiquidityV2PerformancePerParty
	(*LiquidityV2Scores)(nil),                     // 129: vega.snapshot.v1.LiquidityV2Scores
	(*LiquidityV2Supplied)(nil),                   // 130: vega.snapshot.v1.LiquidityV2Supplied
	(*FloatingPointConsensus)(nil),                // 131: vega.snapshot.v1.FloatingPointConsensus
	(*StateVarInternalState)(nil),                 // 132: vega.snapshot.v1.StateVarInternalState
	(*FloatingPointValidatorResult)(nil),          // 133: vega.snapshot.v1.FloatingPointValidatorResult
	(*NextTimeTrigger)(nil),                       // 134: vega.snapshot.v1.NextTimeTrigger
	(*MarketTracker)(nil),                         // 135: vega.snapshot.v1.MarketTracker
	(*SignerEventsPerAddress)(nil),                // 136: vega.snapshot.v1.SignerEventsPerAddress
	(*ERC20MultiSigTopologyVerified)(nil),         // 137: vega.snapshot.v1.ERC20MultiSigTopologyVerified
	(*ERC20MultiSigTopologyPending)(nil),          // 138: vega.snapshot.v1.ERC20MultiSigTopologyPending
	(*ProofOfWork)(nil),                           // 139: vega.snapshot.v1.ProofOfWork
	(*BannedParty)(nil),                           // 140: vega.snapshot.v1.BannedParty
	(*ProofOfWorkParams)(nil),                     // 141: vega.snapshot.v1.ProofOfWorkParams
	(*ProofOfWorkState)(nil),                      // 142: vega.snapshot.v1.ProofOfWorkState
	(*ProofOfWorkBlockState)(nil),                 // 143: vega.snapshot.v1.ProofOfWorkBlockState
	(*ProofOfWorkPartyStateForBlock)(nil),         // 144: vega.snapshot.v1.ProofOfWorkPartyStateForBlock
	(*TransactionsAtHeight)(nil),                  // 145: vega.snapshot.v1.TransactionsAtHeight
	(*NonceRef)(nil),                              // 146: vega.snapshot.v1.NonceRef
	(*NonceRefsAtHeight)(nil),                     // 147: vega.snapshot.v1.NonceRefsAtHeight
	(*ProtocolUpgradeProposals)(nil),              // 148: vega.snapshot.v1.ProtocolUpgradeProposals
	(*AcceptedProtocolUpgradeProposal)(nil),       // 149: vega.snapshot.v1.AcceptedProtocolUpgradeProposal
	(*Teams)(nil),                                 // 150: vega.snapshot.v1.Teams
	(*Team)(nil),                                  // 151: vega.snapshot.v1.Team
	(*Membership)(nil),                            // 152: vega.snapshot.v1.Membership
	(*TeamSwitches)(nil),                          // 153: vega.snapshot.v1.TeamSwitches
	(*TeamSwitch)(nil),                            // 154: vega.snapshot.v1.TeamSwitch
	(*Vesting)(nil),                               // 155: vega.snapshot.v1.Vesting
	(*PartyReward)(nil),                           // 156: vega.snapshot.v1.PartyReward
	(*ReferralProgramData)(nil),                   // 157: vega.snapshot.v1.ReferralProgramData
	(*ReferralSet)(nil),                           // 158: vega.snapshot.v1.ReferralSet
	(*RunningVolume)(nil),                         // 159: vega.snapshot.v1.RunningVolume
	(*FactorByReferee)(nil),                       // 160: vega.snapshot.v1.FactorByReferee
	(*AssetLocked)(nil),                           // 161: vega.snapshot.v1.AssetLocked
	(*EpochBalance)(nil),                          // 162: vega.snapshot.v1.EpochBalance
	(*InVesting)(nil),                             // 163: vega.snapshot.v1.InVesting
	(*ActivityStreak)(nil),                        // 164: vega.snapshot.v1.ActivityStreak
	(*PartyActivityStreak)(nil),                   // 165: vega.snapshot.v1.PartyActivityStreak
	(*VolumeDiscountProgram)(nil),                 // 166: vega.snapshot.v1.VolumeDiscountProgram
	(*VolumeDiscountStats)(nil),                   // 167: vega.snapshot.v1.VolumeDiscountStats
	(*EpochPartyVolumes)(nil),                     // 168: vega.snapshot.v1.EpochPartyVolumes
	(*PartyVolume)(nil),                           // 169: vega.snapshot.v1.PartyVolume
	(*v1.Signer)(nil),                             // 170: vega.data.v1.Signer
	(*v1.Property)(nil),                           // 171: vega.data.v1.Property
	(*vega.Account)(nil),                          // 172: vega.Account
	(*vega.Asset)(nil),                            // 173: vega.Asset
	(*vega.Withdrawal)(nil),                       // 174: vega.Withdrawal
	(*vega.Deposit)(nil),                          // 175: vega.Deposit
	(*v11.AssetAction)(nil),                       // 176: vega.checkpoint.v1.AssetAction
	(*v11.RecurringTransfers)(nil),                // 177: vega.checkpoint.v1.RecurringTransfers
	(*v11.ScheduledTransferAtTime)(nil),           // 178: vega.checkpoint.v1.ScheduledTransferAtTime
	(*v11.GovernanceTransfer)(nil),                // 179: vega.checkpoint.v1.GovernanceTransfer
	(*v11.ScheduledGovernanceTransferAtTime)(nil), // 180: vega.checkpoint.v1.ScheduledGovernanceTransferAtTime
	(*v11.BridgeState)(nil),                       // 181: vega.checkpoint.v1.BridgeState
	(*vega.Delegation)(nil),                       // 182: vega.Delegation
	(*vega.Proposal)(nil),                         // 183: vega.Proposal
	(*vega.Vote)(nil),                             // 184: vega.Vote
	(*v12.StakeLinking)(nil),                      // 185: vega.events.v1.StakeLinking
	(*vega.StakeTotalSupply)(nil),                 // 186: vega.StakeTotalSupply
	(*vega.Order)(nil),                            // 187: vega.Order
	(*vega.NetworkParameter)(nil),                 // 188: vega.NetworkParameter
	(*vega.PriceMonitoringTrigger)(nil),           // 189: vega.PriceMonitoringTrigger
	(vega.Market_TradingMode)(0),                  // 190: vega.Market.TradingMode
	(vega.AuctionTrigger)(0),                      // 191: vega.AuctionTrigger
	(*vega.AuctionDuration)(nil),                  // 192: vega.AuctionDuration
	(*vega.Market)(nil),                           // 193: vega.Market
	(*v12.FeesStats)(nil),                         // 194: vega.events.v1.FeesStats
	(*v12.StopOrderEvent)(nil),                    // 195: vega.events.v1.StopOrderEvent
	(*v11.MarketState)(nil),                       // 196: vega.checkpoint.v1.MarketState
	(*v12.ValidatorUpdate)(nil),                   // 197: vega.events.v1.ValidatorUpdate
	(*vega.RankingScore)(nil),                     // 198: vega.RankingScore
	(*vega.LiquidityProvision)(nil),               // 199: vega.LiquidityProvision
	(*vega.LiquiditySLAParameters)(nil),           // 200: vega.LiquiditySLAParameters
	(*v12.PaidLiquidityFeesStats)(nil),            // 201: vega.events.v1.PaidLiquidityFeesStats
	(*vega.KeyValueBundle)(nil),                   // 202: vega.KeyValueBundle
	(*v11.MarketActivityTracker)(nil),             // 203: vega.checkpoint.v1.MarketActivityTracker
	(*v11.TakerNotionalVolume)(nil),               // 204: vega.checkpoint.v1.TakerNotionalVolume
	(*v12.ERC20MultiSigSignerEvent)(nil),          // 205: vega.events.v1.ERC20MultiSigSignerEvent
	(*v12.ERC20MultiSigThresholdSetEvent)(nil),    // 206: vega.events.v1.ERC20MultiSigThresholdSetEvent
	(*v12.ProtocolUpgradeEvent)(nil),              // 207: vega.events.v1.ProtocolUpgradeEvent
	(*vega.ReferralProgram)(nil),                  // 208: vega.ReferralProgram
	(*vega.VolumeDiscountProgram)(nil),            // 209: vega.VolumeDiscountProgram
}
var file_vega_snapshot_v1_snapshot_proto_depIdxs = []int32{
	...
	131, // 44: vega.snapshot.v1.Payload.floating_point_consensus:type_name -> vega.snapshot.v1.FloatingPointConsensus
	135, // 45: vega.snapshot.v1.Payload.market_tracker:type_name -> vega.snapshot.v1.MarketTracker
	...
	137, // 48: vega.snapshot.v1.Payload.erc20_multisig_topology_verified:type_name -> vega.snapshot.v1.ERC20MultiSigTopologyVerified
	138, // 49: vega.snapshot.v1.Payload.erc20_multisig_topology_pending:type_name -> vega.snapshot.v1.ERC20MultiSigTopologyPending
	139, // 50: vega.snapshot.v1.Payload.proof_of_work:type_name -> vega.snapshot.v1.ProofOfWork
	24,  // 51: vega.snapshot.v1.Payload.pending_asset_updates:type_name -> vega.snapshot.v1.PendingAssetUpdates
	148, // 52: vega.snapshot.v1.Payload.protocol_upgrade_proposals:type_name -> vega.snapshot.v1.ProtocolUpgradeProposals
	...
	125, // 61: vega.snapshot.v1.Payload.liquidity_v2_provisions:type_name -> vega.snapshot.v1.LiquidityV2Provisions
	126, // 62: vega.snapshot.v1.Payload.liquidity_v2_pending_provisions:type_name -> vega.snapshot.v1.LiquidityV2PendingProvisions
	127, // 63: vega.snapshot.v1.Payload.liquidity_v2_performances:type_name -> vega.snapshot.v1.LiquidityV2Performances
	130, // 64: vega.snapshot.v1.Payload.liquidity_v2_supplied:type_name -> vega.snapshot.v1.LiquidityV2Supplied
	129, // 65: vega.snapshot.v1.Payload.liquidity_v2_scores:type_name -> vega.snapshot.v1.LiquidityV2Scores
	7,   // 66: vega.snapshot.v1.Payload.holding_account_tracker:type_name -> vega.snapshot.v1.HoldingAccountTracker
	150, // 67: vega.snapshot.v1.Payload.teams:type_name -> vega.snapshot.v1.Teams
	153, // 68: vega.snapshot.v1.Payload.team_switches:type_name -> vega.snapshot.v1.TeamSwitches
	155, // 69: vega.snapshot.v1.Payload.vesting:type_name -> vega.snapshot.v1.Vesting
	157, // 70: vega.snapshot.v1.Payload.referral_program:type_name -> vega.snapshot.v1.ReferralProgramData
	164, // 71: vega.snapshot.v1.Payload.activity_streak:type_name -> vega.snapshot.v1.ActivityStreak
	166, // 72: vega.snapshot.v1.Payload.volume_discount_program:type_name -> vega.snapshot.v1.VolumeDiscountProgram
	123, // 73: vega.snapshot.v1.Payload.liquidity_v2_parameters:type_name -> vega.snapshot.v1.LiquidityV2Parameters
	124, // 74: vega.snapshot.v1.Payload.liquidity_v2_paid_fees_stats:type_name -> vega.snapshot.v1.LiquidityV2PaidFeesStats
	...
	170, // 83: vega.snapshot.v1.OracleData.signers:type_name -> vega.data.v1.Signer
	16,  // 84: vega.snapshot.v1.OracleData.data:type_name -> vega.snapshot.v1.OracleDataPair
	171, // 85: vega.snapshot.v1.OracleData.meta_data:type_name -> vega.data.v1.Property
	18,  // 86: vega.snapshot.v1.Witness.resources:type_name -> vega.snapshot.v1.Resource
	172, // 87: vega.snapshot.v1.CollateralAccounts.accounts:type_name -> vega.Account
	173, // 88: vega.snapshot.v1.CollateralAssets.assets:type_name -> vega.Asset
	173, // 89: vega.snapshot.v1.ActiveAssets.assets:type_name -> vega.Asset
	173, // 90: vega.snapshot.v1.PendingAssets.assets:type_name -> vega.Asset
	173, // 91: vega.snapshot.v1.PendingAssetUpdates.assets:type_name -> vega.Asset
	174, // 92: vega.snapshot.v1.Withdrawal.withdrawal:type_name -> vega.Withdrawal
	175, // 93: vega.snapshot.v1.Deposit.deposit:type_name -> vega.Deposit
	...
	176, // 96: vega.snapshot.v1.BankingAssetActions.asset_action:type_name -> vega.checkpoint.v1.AssetAction
	177, // 97: vega.snapshot.v1.BankingRecurringTransfers.recurring_transfers:type_name -> vega.checkpoint.v1.RecurringTransfers
	178, // 98: vega.snapshot.v1.BankingScheduledTransfers.transfers_at_time:type_name -> vega.checkpoint.v1.ScheduledTransferAtTime
	179, // 99: vega.snapshot.v1.BankingRecurringGovernanceTransfers.recurring_transfers:type_name -> vega.checkpoint.v1.GovernanceTransfer
	180, // 100: vega.snapshot.v1.BankingScheduledGovernanceTransfers.transfers_at_time:type_name -> vega.checkpoint.v1.ScheduledGovernanceTransferAtTime
	181, // 101: vega.snapshot.v1.BankingBridgeState.bridge_state:type_name -> vega.checkpoint.v1.BridgeState
	182, // 102: vega.snapshot.v1.DelegationActive.delegations:type_name -> vega.Delegation
	182, // 103: vega.snapshot.v1.DelegationPending.delegations:type_name -> vega.Delegation
	182, // 104: vega.snapshot.v1.DelegationPending.undelegation:type_name -> vega.Delegation
	183, // 105: vega.snapshot.v1.ProposalData.proposal:type_name -> vega.Proposal
	184, // 106: vega.snapshot.v1.ProposalData.yes:type_name -> vega.Vote
	184, // 107: vega.snapshot.v1.ProposalData.no:type_name -> vega.Vote
	184, // 108: vega.snapshot.v1.ProposalData.invalid:type_name -> vega.Vote
	...
	183, // 111: vega.snapshot.v1.GovernanceNode.proposals:type_name -> vega.Proposal
	185, // 112: vega.snapshot.v1.StakingAccount.events:type_name -> vega.events.v1.StakeLinking
	46,  // 113: vega.snapshot.v1.StakingAccounts.accounts:type_name -> vega.snapshot.v1.StakingAccount
	186, // 114: vega.snapshot.v1.StakingAccounts.pending_stake_total_supply:type_name -> vega.StakeTotalSupply
	187, // 115: vega.snapshot.v1.MatchingBook.buy:type_name -> vega.Order
	187, // 116: vega.snapshot.v1.MatchingBook.sell:type_name -> vega.Order
	188, // 117: vega.snapshot.v1.NetParams.params:type_name -> vega.NetworkParameter
	189, // 118: vega.snapshot.v1.PriceBound.trigger:type_name -> vega.PriceMonitoringTrigger
	...
	190, // 127: vega.snapshot.v1.AuctionState.mode:type_name -> vega.Market.TradingMode
	190, // 128: vega.snapshot.v1.AuctionState.default_mode:type_name -> vega.Market.TradingMode
	191, // 129: vega.snapshot.v1.AuctionState.trigger:type_name -> vega.AuctionTrigger
	192, // 130: vega.snapshot.v1.AuctionState.end:type_name -> vega.AuctionDuration
	191, // 131: vega.snapshot.v1.AuctionState.extension:type_name -> vega.AuctionTrigger
	60,  // 132: vega.snapshot.v1.EquityShare.lps:type_name -> vega.snapshot.v1.EquityShareLP
	193, // 133: vega.snapshot.v1.SpotMarket.market:type_name -> vega.Market
	...
	187, // 137: vega.snapshot.v1.SpotMarket.expiring_orders:type_name -> vega.Order
	...
	187, // 141: vega.snapshot.v1.SpotMarket.expiring_stop_orders:type_name -> vega.Order
	194, // 142: vega.snapshot.v1.SpotMarket.fees_stats:type_name -> vega.events.v1.FeesStats
	193, // 143: vega.snapshot.v1.Market.market:type_name -> vega.Market
	...
	187, // 147: vega.snapshot.v1.Market.expiring_orders:type_name -> vega.Order
	...
	187, // 151: vega.snapshot.v1.Market.expiring_stop_orders:type_name -> vega.Order
	65,  // 152: vega.snapshot.v1.Market.product:type_name -> vega.snapshot.v1.Product
	194, // 153: vega.snapshot.v1.Market.fees_stats:type_name -> vega.events.v1.FeesStats
	67,  // 154: vega.snapshot.v1.Product.perps:type_name -> vega.snapshot.v1.Perps
	...
	68,  // 157: vega.snapshot.v1.PricedStopOrders.falls_bellow:type_name -> vega.snapshot.v1.OrdersAtPrice
	68,  // 158: vega.snapshot.v1.PricedStopOrders.rises_above:type_name -> vega.snapshot.v1.OrdersAtPrice
	72,  // 159: vega.snapshot.v1.TrailingStopOrders.falls_bellow:type_name -> vega.snapshot.v1.OffsetsAtPrice
	72,  // 160: vega.snapshot.v1.TrailingStopOrders.rises_above:type_name -> vega.snapshot.v1.OffsetsAtPrice
	71,  // 161: vega.snapshot.v1.OffsetsAtPrice.offsets:type_name -> vega.snapshot.v1.OrdersAtOffset
	195, // 162: vega.snapshot.v1.StopOrders.stop_orders:type_name -> vega.events.v1.StopOrderEvent
	69,  // 163: vega.snapshot.v1.StopOrders.priced_stop_orders:type_name -> vega.snapshot.v1.PricedStopOrders
	70,  // 164: vega.snapshot.v1.StopOrders.trailing_stop_orders:type_name -> vega.snapshot.v1.TrailingStopOrders
	187, // 165: vega.snapshot.v1.PeggedOrders.parked_orders:type_name -> vega.Order
	64,  // 166: vega.snapshot.v1.ExecutionMarkets.markets:type_name -> vega.snapshot.v1.Market
	63,  // 167: vega.snapshot.v1.ExecutionMarkets.spot_markets:type_name -> vega.snapshot.v1.SpotMarket
	196, // 168: vega.snapshot.v1.ExecutionMarkets.settled_markets:type_name -> vega.checkpoint.v1.MarketState
	77,  // 169: vega.snapshot.v1.ExecutionMarkets.successors:type_name -> vega.snapshot.v1.Successors
	75,  // 170: vega.snapshot.v1.ExecutionMarkets.sla_network_params:type_name -> vega.snapshot.v1.SLANetworkParams
	78,  // 171: vega.snapshot.v1.MarketPositions.positions:type_name -> vega.snapshot.v1.Position
	80,  // 172: vega.snapshot.v1.MarketPositions.parties_records:type_name -> vega.snapshot.v1.PartyPositionStats
	82,  // 173: vega.snapshot.v1.SettlementState.last_settled_positions:type_name -> vega.snapshot.v1.LastSettledPosition
	83,  // 174: vega.snapshot.v1.SettlementState.trades:type_name -> vega.snapshot.v1.SettlementTrade
	87,  // 175: vega.snapshot.v1.RewardsPendingPayouts.scheduled_rewards_payout:type_name -> vega.snapshot.v1.ScheduledRewardsPayout
	88,  // 176: vega.snapshot.v1.ScheduledRewardsPayout.rewards_payout:type_name -> vega.snapshot.v1.RewardsPayout
	89,  // 177: vega.snapshot.v1.RewardsPayout.reward_party_amount:type_name -> vega.snapshot.v1.RewardsPartyAmount
	92,  // 178: vega.snapshot.v1.VoteSpamPolicy.party_to_vote:type_name -> vega.snapshot.v1.PartyProposalVoteCount
	140, // 179: vega.snapshot.v1.VoteSpamPolicy.banned_parties:type_name -> vega.snapshot.v1.BannedParty
	93,  // 180: vega.snapshot.v1.VoteSpamPolicy.token_balance:type_name -> vega.snapshot.v1.PartyTokenBalance
	94,  // 181: vega.snapshot.v1.VoteSpamPolicy.recent_blocks_reject_stats:type_name -> vega.snapshot.v1.BlockRejectStats
	95,  // 182: vega.snapshot.v1.SimpleSpamPolicy.party_to_count:type_name -> vega.snapshot.v1.SpamPartyTransactionCount
	140, // 183: vega.snapshot.v1.SimpleSpamPolicy.banned_parties:type_name -> vega.snapshot.v1.BannedParty
	93,  // 184: vega.snapshot.v1.SimpleSpamPolicy.token_balance:type_name -> vega.snapshot.v1.PartyTokenBalance
	97,  // 185: vega.snapshot.v1.Notary.notary_sigs:type_name -> vega.snapshot.v1.NotarySigs
	101, // 186: vega.snapshot.v1.StakeVerifierDeposited.pending_deposited:type_name -> vega.snapshot.v1.StakeVerifierPending
	101, // 187: vega.snapshot.v1.StakeVerifierRemoved.pending_removed:type_name -> vega.snapshot.v1.StakeVerifierPending
	104, // 188: vega.snapshot.v1.EthContractCallResults.pending_contract_call_result:type_name -> vega.snapshot.v1.EthContractCallResult
	111, // 189: vega.snapshot.v1.Topology.validator_data:type_name -> vega.snapshot.v1.ValidatorState
	105, // 190: vega.snapshot.v1.Topology.pending_pub_key_rotations:type_name -> vega.snapshot.v1.PendingKeyRotation
	114, // 191: vega.snapshot.v1.Topology.validator_performance:type_name -> vega.snapshot.v1.ValidatorPerformance
	106, // 192: vega.snapshot.v1.Topology.pending_ethereum_key_rotations:type_name -> vega.snapshot.v1.PendingEthereumKeyRotation
	108, // 193: vega.snapshot.v1.Topology.signatures:type_name -> vega.snapshot.v1.ToplogySignatures
	106, // 194: vega.snapshot.v1.Topology.unsolved_ethereum_key_rotations:type_name -> vega.snapshot.v1.PendingEthereumKeyRotation
	109, // 195: vega.snapshot.v1.ToplogySignatures.pending_signatures:type_name -> vega.snapshot.v1.PendingERC20MultisigControlSignature
	110, // 196: vega.snapshot.v1.ToplogySignatures.issued_signatures:type_name -> vega.snapshot.v1.IssuedERC20MultisigControlSignature
	197, // 197: vega.snapshot.v1.ValidatorState.validator_update:type_name -> vega.events.v1.ValidatorUpdate
	112, // 198: vega.snapshot.v1.ValidatorState.heartbeat_tracker:type_name -> vega.snapshot.v1.HeartbeatTracker
	198, // 199: vega.snapshot.v1.ValidatorState.ranking_score:type_name -> vega.RankingScore
	113, // 200: vega.snapshot.v1.ValidatorPerformance.validator_perf_stats:type_name -> vega.snapshot.v1.PerformanceStats
	118, // 201: vega.snapshot.v1.LiquidityPartiesLiquidityOrders.party_orders:type_name -> vega.snapshot.v1.PartyOrders
	187, // 202: vega.snapshot.v1.PartyOrders.orders:type_name -> vega.Order
	118, // 203: vega.snapshot.v1.LiquidityPartiesOrders.party_orders:type_name -> vega.snapshot.v1.PartyOrders
	199, // 204: vega.snapshot.v1.LiquidityProvisions.liquidity_provisions:type_name -> vega.LiquidityProvision
	122, // 205: vega.snapshot.v1.LiquidityScores.scores:type_name -> vega.snapshot.v1.LiquidityScore
	200, // 206: vega.snapshot.v1.LiquidityV2Parameters.market_sla_parameters:type_name -> vega.LiquiditySLAParameters
	201, // 207: vega.snapshot.v1.LiquidityV2PaidFeesStats.stats:type_name -> vega.events.v1.PaidLiquidityFeesStats
	199, // 208: vega.snapshot.v1.LiquidityV2Provisions.liquidity_provisions:type_name -> vega.LiquidityProvision
	199, // 209: vega.snapshot.v1.LiquidityV2PendingProvisions.pending_liquidity_provisions:type_name -> vega.LiquidityProvision
	128, // 210: vega.snapshot.v1.LiquidityV2Performances.performance_per_party:type_name -> vega.snapshot.v1.LiquidityV2PerformancePerParty
	...
	134, // 214: vega.snapshot.v1.FloatingPointConsensus.next_time_trigger:type_name -> vega.snapshot.v1.NextTimeTrigger
	132, // 215: vega.snapshot.v1.FloatingPointConsensus.state_variables:type_name -> vega.snapshot.v1.StateVarInternalState
	133, // 216: vega.snapshot.v1.StateVarInternalState.validators_results:type_name -> vega.snapshot.v1.FloatingPointValidatorResult
	202, // 217: vega.snapshot.v1.FloatingPointValidatorResult.bundle:type_name -> vega.KeyValueBundle
	203, // 218: vega.snapshot.v1.MarketTracker.market_activity:type_name -> vega.checkpoint.v1.MarketActivityTracker
	204, // 219: vega.snapshot.v1.MarketTracker.taker_notional_volume:type_name -> vega.checkpoint.v1.TakerNotionalVolume
	205, // 220: vega.snapshot.v1.SignerEventsPerAddress.events:type_name -> vega.events.v1.ERC20MultiSigSignerEvent
	136, // 221: vega.snapshot.v1.ERC20MultiSigTopologyVerified.events_per_address:type_name -> vega.snapshot.v1.SignerEventsPerAddress
	206, // 222: vega.snapshot.v1.ERC20MultiSigTopologyVerified.threshold:type_name -> vega.events.v1.ERC20MultiSigThresholdSetEvent
	205, // 223: vega.snapshot.v1.ERC20MultiSigTopologyPending.pending_signers:type_name -> vega.events.v1.ERC20MultiSigSignerEvent
	206, // 224: vega.snapshot.v1.ERC20MultiSigTopologyPending.pending_threshold_set:type_name -> vega.events.v1.ERC20MultiSigThresholdSetEvent
	145, // 225: vega.snapshot.v1.ProofOfWork.tx_at_height:type_name -> vega.snapshot.v1.TransactionsAtHeight
	145, // 226: vega.snapshot.v1.ProofOfWork.tid_at_height:type_name -> vega.snapshot.v1.TransactionsAtHeight
	140, // 227: vega.snapshot.v1.ProofOfWork.banned:type_name -> vega.snapshot.v1.BannedParty
	141, // 228: vega.snapshot.v1.ProofOfWork.pow_params:type_name -> vega.snapshot.v1.ProofOfWorkParams
	142, // 229: vega.snapshot.v1.ProofOfWork.pow_state:type_name -> vega.snapshot.v1.ProofOfWorkState
	147, // 230: vega.snapshot.v1.ProofOfWork.nonce_refs_at_height:type_name -> vega.snapshot.v1.NonceRefsAtHeight
	143, // 231: vega.snapshot.v1.ProofOfWorkState.pow_state:type_name -> vega.snapshot.v1.ProofOfWorkBlockState
	144, // 232: vega.snapshot.v1.ProofOfWorkBlockState.party_state:type_name -> vega.snapshot.v1.ProofOfWorkPartyStateForBlock
	146, // 233: vega.snapshot.v1.NonceRefsAtHeight.refs:type_name -> vega.snapshot.v1.NonceRef
	207, // 234: vega.snapshot.v1.ProtocolUpgradeProposals.active_proposals:type_name -> vega.events.v1.ProtocolUpgradeEvent
	149, // 235: vega.snapshot.v1.ProtocolUpgradeProposals.accepted_proposal:type_name -> vega.snapshot.v1.AcceptedProtocolUpgradeProposal
	151, // 236: vega.snapshot.v1.Teams.teams:type_name -> vega.snapshot.v1.Team
	152, // 237: vega.snapshot.v1.Team.referrer:type_name -> vega.snapshot.v1.Membership
	152, // 238: vega.snapshot.v1.Team.referees:type_name -> vega.snapshot.v1.Membership
	154, // 239: vega.snapshot.v1.TeamSwitches.team_switches:type_name -> vega.snapshot.v1.TeamSwitch
	156, // 240: vega.snapshot.v1.Vesting.parties_reward:type_name -> vega.snapshot.v1.PartyReward
	161, // 241: vega.snapshot.v1.PartyReward.asset_locked:type_name -> vega.snapshot.v1.AssetLocked
	163, // 242: vega.snapshot.v1.PartyReward.in_vesting:type_name -> vega.snapshot.v1.InVesting
	160, // 243: vega.snapshot.v1.ReferralProgramData.factor_by_referee:type_name -> vega.snapshot.v1.FactorByReferee
	208, // 244: vega.snapshot.v1.ReferralProgramData.current_program:type_name -> vega.ReferralProgram
	208, // 245: vega.snapshot.v1.ReferralProgramData.new_program:type_name -> vega.ReferralProgram
	158, // 246: vega.snapshot.v1.ReferralProgramData.sets:type_name -> vega.snapshot.v1.ReferralSet
	152, // 247: vega.snapshot.v1.ReferralSet.referrer:type_name -> vega.snapshot.v1.Membership
	152, // 248: vega.snapshot.v1.ReferralSet.referees:type_name -> vega.snapshot.v1.Membership
	159, // 249: vega.snapshot.v1.ReferralSet.running_volumes:type_name -> vega.snapshot.v1.RunningVolume
	162, // 250: vega.snapshot.v1.AssetLocked.epoch_balances:type_name -> vega.snapshot.v1.EpochBalance
	165, // 251: vega.snapshot.v1.ActivityStreak.parties_activity_streak:type_name -> vega.snapshot.v1.PartyActivityStreak
	168, // 252: vega.snapshot.v1.VolumeDiscountProgram.epoch_party_volumes:type_name -> vega.snapshot.v1.EpochPartyVolumes
	169, // 253: vega.snapshot.v1.VolumeDiscountProgram.average_party_volume:type_name -> vega.snapshot.v1.PartyVolume
	209, // 254: vega.snapshot.v1.VolumeDiscountProgram.current_program:type_name -> vega.VolumeDiscountProgram
	209, // 255: vega.snapshot.v1.VolumeDiscountProgram.new_program:type_name -> vega.VolumeDiscountProgram
	167, // 256: vega.snapshot.v1.VolumeDiscountProgram.factors_by_party:type_name -> vega.snapshot.v1.VolumeDiscountStats
	169, // 257: vega.snapshot.v1.EpochPartyVolumes.party_volume:type_name -> vega.snapshot.v1.PartyVolume
