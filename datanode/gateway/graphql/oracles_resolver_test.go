...
func Test_oracleSpecResolver_DataSourceSpec(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			wantJsn: `{"spec":{"id":"","createdAt":"0","updatedAt":"0","data":{"sourceType":{"SourceType":{"Oracle":{"signers":[{"Signer":{"PubKey":{"key":"key"}}},{"Signer":{"EthAddress":{"address":"address"}}}]}}}},"status":"0"}}`,
			...
			wantJsn: `{"spec":{"id":"","createdAt":"0","updatedAt":"0","data":{"sourceType":{"SourceType":{"Time":{"conditions":[{"operator":12,"value":"blah"}]}}}},"status":"0"}}`,
			wantErr: assert.NoError,
		},
	}
