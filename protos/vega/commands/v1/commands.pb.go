...
var file_vega_commands_v1_commands_proto_goTypes = []interface{}{
	...
	(vega.Side)(0),                         // 32: vega.Side
	(vega.Order_TimeInForce)(0),            // 33: vega.Order.TimeInForce
	(vega.Order_Type)(0),                   // 34: vega.Order.Type
	(*vega.PeggedOrder)(nil),               // 35: vega.PeggedOrder
	(vega.PeggedReference)(0),              // 36: vega.PeggedReference
	(*vega.WithdrawExt)(nil),               // 37: vega.WithdrawExt
	(*vega.ProposalTerms)(nil),             // 38: vega.ProposalTerms
	(*vega.ProposalRationale)(nil),         // 39: vega.ProposalRationale
	(*vega.BatchProposalTerms)(nil),        // 40: vega.BatchProposalTerms
	(vega.Vote_Value)(0),                   // 41: vega.Vote.Value
	(vega.AccountType)(0),                  // 42: vega.AccountType
	(*vega.DispatchStrategy)(nil),          // 43: vega.DispatchStrategy
	(NodeSignatureKind)(0),                 // 44: vega.commands.v1.NodeSignatureKind
}
