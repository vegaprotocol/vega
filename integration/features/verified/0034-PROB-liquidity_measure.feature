Feature: Tests confirming probability of trading acceptance criteria (0038-OLIQ-001, 0038-OLIQ-002)
  ...
  Scenario: Order from liquidity provision and from normal order submission are correctly cumulated in order book's total size(0034-PROB-001);Probability of trading decreases away from the mid-price (0034-PROB-005). Tested with varying decimal places.
    ...
    And the parties submit the following liquidity provision:
      | id  | party      | market id | commitment amount | fee | side | pegged reference | proportion | offset | reference | lp type    |
      | lp1 | party-lp-1 | ETH/DEC19 | 100000000000      | 0.1 | buy  | BID              | 1          | 100000 | lp-1-ref  | submission |
      | lp1 | party-lp-1 | ETH/DEC19 | 100000000000      | 0.1 | buy  | BID              | 1          | 90000  | lp-1-ref  | amendment  |
      | lp1 | party-lp-1 | ETH/DEC19 | 100000000000      | 0.1 | buy  | BID              | 1          | 80000  | lp-1-ref  | amendment  |
      | lp1 | party-lp-1 | ETH/DEC19 | 100000000000      | 0.1 | buy  | BID              | 1          | 70000  | lp-1-ref  | amendment  |
      | lp1 | party-lp-1 | ETH/DEC19 | 100000000000      | 0.1 | buy  | BID              | 1          | 60000  | lp-1-ref  | amendment  |
      | lp1 | party-lp-1 | ETH/DEC19 | 100000000000      | 0.1 | buy  | BID              | 1          | 50000  | lp-1-ref  | amendment  |
      | lp1 | party-lp-1 | ETH/DEC19 | 100000000000      | 0.1 | buy  | BID              | 1          | 40000  | lp-1-ref  | amendment  |
      | lp1 | party-lp-1 | ETH/DEC19 | 100000000000      | 0.1 | buy  | BID              | 1          | 30000  | lp-1-ref  | amendment  |
      | lp1 | party-lp-1 | ETH/DEC19 | 100000000000      | 0.1 | buy  | BID              | 1          | 20000  | lp-1-ref  | amendment  |
      | lp1 | party-lp-1 | ETH/DEC19 | 100000000000      | 0.1 | sell | ASK              | 1          | 20000  | lp-1-ref  | amendment  |
      | lp1 | party-lp-1 | ETH/DEC19 | 100000000000      | 0.1 | sell | ASK              | 1          | 30000  | lp-1-ref  | amendment  |
      | lp1 | party-lp-1 | ETH/DEC19 | 100000000000      | 0.1 | sell | ASK              | 1          | 40000  | lp-1-ref  | amendment  |
      | lp1 | party-lp-1 | ETH/DEC19 | 100000000000      | 0.1 | sell | ASK              | 1          | 50000  | lp-1-ref  | amendment  |
      | lp1 | party-lp-1 | ETH/DEC19 | 100000000000      | 0.1 | sell | ASK              | 1          | 60000  | lp-1-ref  | amendment  |
      | lp1 | party-lp-1 | ETH/DEC19 | 100000000000      | 0.1 | sell | ASK              | 1          | 70000  | lp-1-ref  | amendment  |
      | lp1 | party-lp-1 | ETH/DEC19 | 100000000000      | 0.1 | sell | ASK              | 1          | 80000  | lp-1-ref  | amendment  |
      | lp1 | party-lp-1 | ETH/DEC19 | 100000000000      | 0.1 | sell | ASK              | 1          | 90000  | lp-1-ref  | amendment  |
      | lp1 | party-lp-1 | ETH/DEC19 | 100000000000      | 0.1 | sell | ASK              | 1          | 100000 | lp-1-ref  | amendment  |

    Then the liquidity provisions should have the following states:
      | id  | party      | market    | commitment amount | status        |
      | lp1 | party-lp-1 | ETH/DEC19 | 100000000000      | STATUS_ACTIVE |
    ...
    Then the order book should have the following volumes for market "ETH/DEC19":
      ...
      | buy  | 1199960000 | 4700        |
      | buy  | 1199950000 | 9300        |
      | buy  | 1199940000 | 92597222500 |
      | buy  | 1199930000 | 92597994200 |
      | buy  | 1199920000 | 92598765900 |
      | buy  | 1199910000 | 92599537600 |
      | buy  | 1199900000 | 92600309300 |
      | sell | 1200010000 | 1           |
      | sell | 1200030000 | 3100        |
      | sell | 1200040000 | 4700        |
      | sell | 1200050000 | 9300        |
      | sell | 1200060000 | 92587963200 |
      | sell | 1200070000 | 92587191700 |
      | sell | 1200080000 | 92586420200 |
      | sell | 1200090000 | 92585648700 |
      | sell | 1200100000 | 92584877200 |
