...
func (ProposalError) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_governance_970f1eedf0ac08d6, []int{0}
}
...
func (Proposal_State) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_governance_970f1eedf0ac08d6, []int{10, 0}
}
...
func (Vote_Value) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_governance_970f1eedf0ac08d6, []int{11, 0}
}
...
func (dst *FutureProduct) XXX_Merge(src proto.Message) {
	xxx_messageInfo_FutureProduct.Merge(dst, src)
}
...
func (*InstrumentConfiguration) Descriptor() ([]byte, []int) {
	return fileDescriptor_governance_970f1eedf0ac08d6, []int{1}
}
...
func (dst *InstrumentConfiguration) XXX_Merge(src proto.Message) {
	xxx_messageInfo_InstrumentConfiguration.Merge(dst, src)
}
...
func (*InstrumentConfiguration) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _InstrumentConfiguration_OneofMarshaler, _InstrumentConfiguration_OneofUnmarshaler, _InstrumentConfiguration_OneofSizer, []interface{}{
		(*InstrumentConfiguration_Future)(nil),
	}
}

func _InstrumentConfiguration_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	m := msg.(*InstrumentConfiguration)
	// product
	...
	case nil:
	default:
		return fmt.Errorf("InstrumentConfiguration.Product has unexpected type %T", x)
	}
	return nil
}

func _InstrumentConfiguration_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	m := msg.(*InstrumentConfiguration)
	switch tag {
	case 100: // product.future
		...
		msg := new(FutureProduct)
		err := b.DecodeMessage(msg)
		m.Product = &InstrumentConfiguration_Future{msg}
		return true, err
	default:
		return false, nil
	}
...
func _InstrumentConfiguration_OneofSizer(msg proto.Message) (n int) {
	m := msg.(*InstrumentConfiguration)
	// product
	switch x := m.Product.(type) {
	case *InstrumentConfiguration_Future:
...
func (*NewMarketConfiguration) Descriptor() ([]byte, []int) {
	return fileDescriptor_governance_970f1eedf0ac08d6, []int{2}
}
...
func (dst *NewMarketConfiguration) XXX_Merge(src proto.Message) {
	xxx_messageInfo_NewMarketConfiguration.Merge(dst, src)
}
...
// XXX_OneofFuncs is for the internal use of the proto package.
func (*NewMarketConfiguration) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _NewMarketConfiguration_OneofMarshaler, _NewMarketConfiguration_OneofUnmarshaler, _NewMarketConfiguration_OneofSizer, []interface{}{
...
func _NewMarketConfiguration_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	m := msg.(*NewMarketConfiguration)
	// risk_parameters
	switch x := m.RiskParameters.(type) {
	...
	case *NewMarketConfiguration_LogNormal:
		...
		if err := b.EncodeMessage(x.LogNormal); err != nil {
			return err
		}
	case nil:
	default:
		return fmt.Errorf("NewMarketConfiguration.RiskParameters has unexpected type %T", x)
	}
	// trading_mode
	switch x := m.TradingMode.(type) {
	...
	case nil:
	default:
		return fmt.Errorf("NewMarketConfiguration.TradingMode has unexpected type %T", x)
	}
	return nil
}

func _NewMarketConfiguration_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	m := msg.(*NewMarketConfiguration)
	switch tag {
	case 100: // risk_parameters.simple
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(SimpleModelParams)
		err := b.DecodeMessage(msg)
		m.RiskParameters = &NewMarketConfiguration_Simple{msg}
		return true, err
	case 101: // risk_parameters.log_normal
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(LogNormalRiskModel)
		err := b.DecodeMessage(msg)
		m.RiskParameters = &NewMarketConfiguration_LogNormal{msg}
		return true, err
	case 200: // trading_mode.continuous
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(ContinuousTrading)
		err := b.DecodeMessage(msg)
		m.TradingMode = &NewMarketConfiguration_Continuous{msg}
		return true, err
	case 201: // trading_mode.discrete
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(DiscreteTrading)
		err := b.DecodeMessage(msg)
		m.TradingMode = &NewMarketConfiguration_Discrete{msg}
		return true, err
	default:
		return false, nil
	}
...
func _NewMarketConfiguration_OneofSizer(msg proto.Message) (n int) {
	m := msg.(*NewMarketConfiguration)
	// risk_parameters
	switch x := m.RiskParameters.(type) {
	case *NewMarketConfiguration_Simple:
...
func (*NewMarketCommitment) Descriptor() ([]byte, []int) {
	return fileDescriptor_governance_970f1eedf0ac08d6, []int{3}
}
...
func (dst *NewMarketCommitment) XXX_Merge(src proto.Message) {
	xxx_messageInfo_NewMarketCommitment.Merge(dst, src)
}
...
func (*NewMarket) Descriptor() ([]byte, []int) {
	return fileDescriptor_governance_970f1eedf0ac08d6, []int{4}
}
...
func (dst *NewMarket) XXX_Merge(src proto.Message) {
	xxx_messageInfo_NewMarket.Merge(dst, src)
}
...
func (*UpdateMarket) Descriptor() ([]byte, []int) {
	return fileDescriptor_governance_970f1eedf0ac08d6, []int{5}
}
...
func (dst *UpdateMarket) XXX_Merge(src proto.Message) {
	xxx_messageInfo_UpdateMarket.Merge(dst, src)
}
...
func (*UpdateNetworkParameter) Descriptor() ([]byte, []int) {
	return fileDescriptor_governance_970f1eedf0ac08d6, []int{6}
}
...
func (dst *UpdateNetworkParameter) XXX_Merge(src proto.Message) {
	xxx_messageInfo_UpdateNetworkParameter.Merge(dst, src)
}
...
func (*NewAsset) Descriptor() ([]byte, []int) {
	return fileDescriptor_governance_970f1eedf0ac08d6, []int{7}
}
...
func (dst *NewAsset) XXX_Merge(src proto.Message) {
	xxx_messageInfo_NewAsset.Merge(dst, src)
}
...
func (*ProposalTerms) Descriptor() ([]byte, []int) {
	return fileDescriptor_governance_970f1eedf0ac08d6, []int{8}
}
...
func (dst *ProposalTerms) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ProposalTerms.Merge(dst, src)
}
...
// XXX_OneofFuncs is for the internal use of the proto package.
func (*ProposalTerms) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _ProposalTerms_OneofMarshaler, _ProposalTerms_OneofUnmarshaler, _ProposalTerms_OneofSizer, []interface{}{
...
func _ProposalTerms_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	m := msg.(*ProposalTerms)
	// change
	switch x := m.Change.(type) {
	case *ProposalTerms_UpdateMarket:
		b.EncodeVarint(101<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.UpdateMarket); err != nil {
			return err
		}
	case *ProposalTerms_NewMarket:
		b.EncodeVarint(102<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.NewMarket); err != nil {
			return err
		}
	case *ProposalTerms_UpdateNetworkParameter:
		b.EncodeVarint(103<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.UpdateNetworkParameter); err != nil {
			return err
		}
	case *ProposalTerms_NewAsset:
		b.EncodeVarint(104<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.NewAsset); err != nil {
			return err
		}
	case nil:
	default:
		return fmt.Errorf("ProposalTerms.Change has unexpected type %T", x)
	}
	return nil
}

func _ProposalTerms_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	m := msg.(*ProposalTerms)
	switch tag {
	case 101: // change.update_market
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(UpdateMarket)
		err := b.DecodeMessage(msg)
		m.Change = &ProposalTerms_UpdateMarket{msg}
		return true, err
	case 102: // change.new_market
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(NewMarket)
		err := b.DecodeMessage(msg)
		m.Change = &ProposalTerms_NewMarket{msg}
		return true, err
	case 103: // change.update_network_parameter
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(UpdateNetworkParameter)
		err := b.DecodeMessage(msg)
		m.Change = &ProposalTerms_UpdateNetworkParameter{msg}
		return true, err
	case 104: // change.new_asset
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(NewAsset)
		err := b.DecodeMessage(msg)
		m.Change = &ProposalTerms_NewAsset{msg}
		return true, err
	default:
		return false, nil
	}
...
func _ProposalTerms_OneofSizer(msg proto.Message) (n int) {
	m := msg.(*ProposalTerms)
	// change
	switch x := m.Change.(type) {
	case *ProposalTerms_UpdateMarket:
		s := proto.Size(x.UpdateMarket)
		n += 2 // tag and wire
		n += proto.SizeVarint(uint64(s))
		n += s
	case *ProposalTerms_NewMarket:
		s := proto.Size(x.NewMarket)
		n += 2 // tag and wire
		n += proto.SizeVarint(uint64(s))
		n += s
	case *ProposalTerms_UpdateNetworkParameter:
		s := proto.Size(x.UpdateNetworkParameter)
		n += 2 // tag and wire
		n += proto.SizeVarint(uint64(s))
		n += s
	case *ProposalTerms_NewAsset:
		s := proto.Size(x.NewAsset)
		n += 2 // tag and wire
		n += proto.SizeVarint(uint64(s))
		n += s
	case nil:
...
func (*GovernanceData) Descriptor() ([]byte, []int) {
	return fileDescriptor_governance_970f1eedf0ac08d6, []int{9}
}
...
func (dst *GovernanceData) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GovernanceData.Merge(dst, src)
}
...
func (*Proposal) Descriptor() ([]byte, []int) {
	return fileDescriptor_governance_970f1eedf0ac08d6, []int{10}
}
...
func (*Vote) Descriptor() ([]byte, []int) {
	return fileDescriptor_governance_970f1eedf0ac08d6, []int{11}
}
...
func init() { proto.RegisterFile("governance.proto", fileDescriptor_governance_970f1eedf0ac08d6) }

var fileDescriptor_governance_970f1eedf0ac08d6 = []byte{
	...
	,
}
