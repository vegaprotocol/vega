...
func defaultNetParams() map[string]value {
	m := map[string]value{
		...
		SpamProtectionMinimiumWithdrawalQuantumMultiple: NewDecimal(DecimalGT(num.MustDecimalFromString("0")), DecimalLT(num.MustDecimalFromString("10e6"))).Mutable(true).MustUpdate("10"),
