...
var (
	OrderError_name = map[int32]string{
		...
		54: "ORDER_ERROR_PRICE_MUST_BE_LESS_THAN_OR_EQUAL_TO_MAX_PRICE",
	}
...
const (
	...
	AccountType_ACCOUNT_TYPE_REWARD_REALISED_RETURN AccountType = 30
	// Per asset account for paid buy-back fees
	AccountType_ACCOUNT_TYPE_BUY_BACK_FEES AccountType = 31
...
const (
	...
	TransferType_TRANSFER_TYPE_AMM_LOW TransferType = 49
	// Transfer from an AMM's general account to their owner's general account.
	TransferType_TRANSFER_TYPE_AMM_HIGH TransferType = 50
	// Transfer releasing an AMM's general account upon closure.
	TransferType_TRANSFER_TYPE_AMM_RELEASE TransferType = 51
	// Treasury fee paid from party's general account.
	TransferType_TRANSFER_TYPE_TREASURY_FEE_PAY TransferType = 52
	// Buy-back fee paid into network buy-back account.
	TransferType_TRANSFER_TYPE_BUY_BACK_FEE_PAY TransferType = 53
...
const (
	...
	DispatchMetric_DISPATCH_METRIC_REALISED_RETURN DispatchMetric = 9
	// Dispatch metric that uses the time weighted average notional
	DispatchMetric_DISPATCH_METRIC_AVERAGE_NOTIONAL DispatchMetric = 10
	// Dispatch metric that uses the eligibility criteria of entities
	DispatchMetric_DISPATCH_METRIC_ELIGIBLE_ENTITIES DispatchMetric = 11
)
...
var (
	DispatchMetric_name = map[int32]string{
		...
		10: "DISPATCH_METRIC_AVERAGE_NOTIONAL",
		11: "DISPATCH_METRIC_ELIGIBLE_ENTITIES",
	}
...
const (
	...
	DistributionStrategy_DISTRIBUTION_STRATEGY_RANK_LOTTERY DistributionStrategy = 3
)
...
const (
	...
	StopOrder_REJECTION_REASON_STOP_ORDER_SIZE_OVERRIDE_UNSUPPORTED_FOR_SPOT StopOrder_RejectionReason = 10
)
...
type Fee struct {
	...
	TreasuryFee string `protobuf:"bytes,10,opt,name=treasury_fee,json=treasuryFee,proto3" json:"treasury_fee,omitempty"`
	// Fee amount used to purchase governance tokens via regular auctions (network wide).
	BuyBackFee string `protobuf:"bytes,11,opt,name=buy_back_fee,json=buyBackFee,proto3" json:"buy_back_fee,omitempty"`
	// Fee paid by the taker to the maker if the maker is eligible.
	HighVolumeMakerFee string `protobuf:"bytes,12,opt,name=high_volume_maker_fee,json=highVolumeMakerFee,proto3" json:"high_volume_maker_fee,omitempty"`
}
...
func (x *Fee) GetTreasuryFee() string {
	if x != nil {
...
func (x *Fee) GetBuyBackFee() string {
	if x != nil {
		return x.BuyBackFee
	}
	return ""
...
func (x *Fee) GetHighVolumeMakerFee() string {
	if x != nil {
		return x.HighVolumeMakerFee
	}
	return ""
}
...
type PriceLevel struct {
	...
	AmmVolume uint64 `protobuf:"varint,4,opt,name=amm_volume,json=ammVolume,proto3" json:"amm_volume,omitempty"`
	// Estimated AMM volume at the price level.
	AmmVolumeEstimated uint64 `protobuf:"varint,5,opt,name=amm_volume_estimated,json=ammVolumeEstimated,proto3" json:"amm_volume_estimated,omitempty"`
}
...
func (x *PriceLevel) GetAmmVolumeEstimated() uint64 {
	if x != nil {
		return x.AmmVolumeEstimated
	}
	return 0
}
...
type DispatchStrategy struct {
	...
	TransferInterval *int32 `protobuf:"varint,15,opt,name=transfer_interval,json=transferInterval,proto3,oneof" json:"transfer_interval,omitempty"`
	// If set, the target notional factor used to scale the amount to be taken from the source account
	TargetNotionalVolume *string `protobuf:"bytes,16,opt,name=target_notional_volume,json=targetNotionalVolume,proto3,oneof" json:"target_notional_volume,omitempty"`
	// A list of party keys to constrain the potential receivers of a reward transfer.
	EligibleKeys []string `protobuf:"bytes,17,rep,name=eligible_keys,json=eligibleKeys,proto3" json:"eligible_keys,omitempty"`
}
...
func (x *DispatchStrategy) GetTransferInterval() int32 {
	if x != nil && x.TransferInterval != nil {
		return *x.TransferInterval
	}
	return 0
}

func (x *DispatchStrategy) GetTargetNotionalVolume() string {
	if x != nil && x.TargetNotionalVolume != nil {
		return *x.TargetNotionalVolume
	}
	return ""
}

func (x *DispatchStrategy) GetEligibleKeys() []string {
	if x != nil {
		return x.EligibleKeys
	}
	return nil
}
...
func (x *PriceMonitoringBounds) GetActive() bool {
	if x != nil {
		return x.Active
	}
	return false
...
type EthereumConfig struct {
	...
	BlockTime string `protobuf:"bytes,8,opt,name=block_time,json=blockTime,proto3" json:"block_time,omitempty"`
}
...
func (x *EthereumConfig) GetBlockTime() string {
	if x != nil {
		return x.BlockTime
	}
	return ""
...
func (x *EVMBridgeConfig) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*EVMBridgeConfig) ProtoMessage() {}

func (x *EVMBridgeConfig) ProtoReflect() protoreflect.Message {
	mi := &file_vega_vega_proto_msgTypes[52]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use EVMBridgeConfig.ProtoReflect.Descriptor instead.
func (*EVMBridgeConfig) Descriptor() ([]byte, []int) {
	return file_vega_vega_proto_rawDescGZIP(), []int{52}
}

func (x *EVMBridgeConfig) GetNetworkId() string {
	if x != nil {
		return x.NetworkId
	}
	return ""
...
func (x *EVMBridgeConfig) GetChainId() string {
	if x != nil {
		return x.ChainId
	}
	return ""
...
func (x *EVMBridgeConfig) GetCollateralBridgeContract() *EthereumContractConfig {
	if x != nil {
		return x.CollateralBridgeContract
	}
	return nil
...
func (x *EVMBridgeConfig) GetConfirmations() uint32 {
	if x != nil {
		return x.Confirmations
	}
	return 0
...
func (x *EVMBridgeConfig) GetMultisigControlContract() *EthereumContractConfig {
	if x != nil {
		return x.MultisigControlContract
	}
	return nil
...
func (x *EVMBridgeConfig) GetBlockTime() string {
	if x != nil {
		return x.BlockTime
	}
	return ""
...
func (x *EVMBridgeConfig) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
type EVMBridgeConfigs struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// The EVM configurations
	Configs []*EVMBridgeConfig `protobuf:"bytes,1,rep,name=configs,proto3" json:"configs,omitempty"`
}

func (x *EVMBridgeConfigs) Reset() {
	*x = EVMBridgeConfigs{}
	if protoimpl.UnsafeEnabled {
...
func (x *EVMBridgeConfigs) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*EVMBridgeConfigs) ProtoMessage() {}

func (x *EVMBridgeConfigs) ProtoReflect() protoreflect.Message {
	mi := &file_vega_vega_proto_msgTypes[53]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use EVMBridgeConfigs.ProtoReflect.Descriptor instead.
func (*EVMBridgeConfigs) Descriptor() ([]byte, []int) {
	return file_vega_vega_proto_rawDescGZIP(), []int{53}
}

func (x *EVMBridgeConfigs) GetConfigs() []*EVMBridgeConfig {
	if x != nil {
		return x.Configs
	}
	return nil
...
func (x *VolumeBenefitTier) GetVolumeDiscountFactors() *DiscountFactors {
	if x != nil {
		return x.VolumeDiscountFactors
	}
	return nil
}

func (x *VolumeBenefitTier) GetTierNumber() uint64 {
	if x != nil && x.TierNumber != nil {
		return *x.TierNumber
	}
	return 0
}
...
func (x *BenefitTier) GetReferralRewardFactors() *RewardFactors {
	if x != nil {
		return x.ReferralRewardFactors
	}
	return nil
}

func (x *BenefitTier) GetReferralDiscountFactors() *DiscountFactors {
	if x != nil {
		return x.ReferralDiscountFactors
	}
	return nil
}

func (x *BenefitTier) GetTierNumber() uint64 {
	if x != nil && x.TierNumber != nil {
		return *x.TierNumber
	}
	return 0
...
type RewardFactors struct {
	...
	InfrastructureRewardFactor string `protobuf:"bytes,1,opt,name=infrastructure_reward_factor,json=infrastructureRewardFactor,proto3" json:"infrastructure_reward_factor,omitempty"`
	// Proportion of the referee's liquidity fees to be rewarded to the referrer.
	LiquidityRewardFactor string `protobuf:"bytes,2,opt,name=liquidity_reward_factor,json=liquidityRewardFactor,proto3" json:"liquidity_reward_factor,omitempty"`
	// Proportion of the maker fees to be rewarded.
	MakerRewardFactor string `protobuf:"bytes,3,opt,name=maker_reward_factor,json=makerRewardFactor,proto3" json:"maker_reward_factor,omitempty"`
}

func (x *RewardFactors) Reset() {
	*x = RewardFactors{}
	if protoimpl.UnsafeEnabled {
...
func (x *RewardFactors) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RewardFactors) ProtoMessage() {}

func (x *RewardFactors) ProtoReflect() protoreflect.Message {
	mi := &file_vega_vega_proto_msgTypes[77]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RewardFactors.ProtoReflect.Descriptor instead.
func (*RewardFactors) Descriptor() ([]byte, []int) {
	return file_vega_vega_proto_rawDescGZIP(), []int{77}
}

func (x *RewardFactors) GetInfrastructureRewardFactor() string {
	if x != nil {
		return x.InfrastructureRewardFactor
	}
	return ""
}

func (x *RewardFactors) GetLiquidityRewardFactor() string {
	if x != nil {
		return x.LiquidityRewardFactor
	}
	return ""
}

func (x *RewardFactors) GetMakerRewardFactor() string {
	if x != nil {
		return x.MakerRewardFactor
	}
	return ""
}
...
type DiscountFactors struct {
	...
	InfrastructureDiscountFactor string `protobuf:"bytes,1,opt,name=infrastructure_discount_factor,json=infrastructureDiscountFactor,proto3" json:"infrastructure_discount_factor,omitempty"`
	// Proportion of the referee's liquidity fee to be discounted.
	LiquidityDiscountFactor string `protobuf:"bytes,2,opt,name=liquidity_discount_factor,json=liquidityDiscountFactor,proto3" json:"liquidity_discount_factor,omitempty"`
	// Proportion of the referee's maker fee to be discounted.
	MakerDiscountFactor string `protobuf:"bytes,3,opt,name=maker_discount_factor,json=makerDiscountFactor,proto3" json:"maker_discount_factor,omitempty"`
}

func (x *DiscountFactors) Reset() {
	*x = DiscountFactors{}
	if protoimpl.UnsafeEnabled {
...
func (x *DiscountFactors) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DiscountFactors) ProtoMessage() {}

func (x *DiscountFactors) ProtoReflect() protoreflect.Message {
	mi := &file_vega_vega_proto_msgTypes[78]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DiscountFactors.ProtoReflect.Descriptor instead.
func (*DiscountFactors) Descriptor() ([]byte, []int) {
	return file_vega_vega_proto_rawDescGZIP(), []int{78}
}

func (x *DiscountFactors) GetInfrastructureDiscountFactor() string {
	if x != nil {
		return x.InfrastructureDiscountFactor
	}
	return ""
}

func (x *DiscountFactors) GetLiquidityDiscountFactor() string {
	if x != nil {
		return x.LiquidityDiscountFactor
	}
	return ""
}

func (x *DiscountFactors) GetMakerDiscountFactor() string {
	if x != nil {
		return x.MakerDiscountFactor
	}
	return ""
}
...
func (*VolumeDiscountProgram) Descriptor() ([]byte, []int) {
	return file_vega_vega_proto_rawDescGZIP(), []int{82}
}
...
func (x *ActivityStreakBenefitTiers) Reset() {
	*x = ActivityStreakBenefitTiers{}
	if protoimpl.UnsafeEnabled {
		mi := &file_vega_vega_proto_msgTypes[83]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ActivityStreakBenefitTiers) Descriptor() ([]byte, []int) {
	return file_vega_vega_proto_rawDescGZIP(), []int{83}
}
...
func (x *ActivityStreakBenefitTier) Reset() {
	*x = ActivityStreakBenefitTier{}
	if protoimpl.UnsafeEnabled {
		mi := &file_vega_vega_proto_msgTypes[84]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ActivityStreakBenefitTier) Descriptor() ([]byte, []int) {
	return file_vega_vega_proto_rawDescGZIP(), []int{84}
}
...
func (x *LongBlockAuction) Reset() {
	*x = LongBlockAuction{}
	if protoimpl.UnsafeEnabled {
		mi := &file_vega_vega_proto_msgTypes[85]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *LongBlockAuction) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*LongBlockAuction) ProtoMessage() {}

func (x *LongBlockAuction) ProtoReflect() protoreflect.Message {
	mi := &file_vega_vega_proto_msgTypes[85]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use LongBlockAuction.ProtoReflect.Descriptor instead.
func (*LongBlockAuction) Descriptor() ([]byte, []int) {
	return file_vega_vega_proto_rawDescGZIP(), []int{85}
}

func (x *LongBlockAuction) GetThreshold() string {
	if x != nil {
		return x.Threshold
	}
	return ""
...
func (x *LongBlockAuction) GetDuration() string {
	if x != nil {
		return x.Duration
	}
	return ""
...
type LongBlockAuctionDurationTable struct {
	...
	ThresholdAndDuration []*LongBlockAuction `protobuf:"bytes,1,rep,name=threshold_and_duration,json=thresholdAndDuration,proto3" json:"threshold_and_duration,omitempty"`
}

func (x *LongBlockAuctionDurationTable) Reset() {
	*x = LongBlockAuctionDurationTable{}
	if protoimpl.UnsafeEnabled {
		mi := &file_vega_vega_proto_msgTypes[86]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *LongBlockAuctionDurationTable) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*LongBlockAuctionDurationTable) ProtoMessage() {}

func (x *LongBlockAuctionDurationTable) ProtoReflect() protoreflect.Message {
	mi := &file_vega_vega_proto_msgTypes[86]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use LongBlockAuctionDurationTable.ProtoReflect.Descriptor instead.
func (*LongBlockAuctionDurationTable) Descriptor() ([]byte, []int) {
	return file_vega_vega_proto_rawDescGZIP(), []int{86}
}

func (x *LongBlockAuctionDurationTable) GetThresholdAndDuration() []*LongBlockAuction {
	if x != nil {
		return x.ThresholdAndDuration
	}
	return nil
}
...
func (x *VolumeRebateBenefitTier) Reset() {
	*x = VolumeRebateBenefitTier{}
	if protoimpl.UnsafeEnabled {
		mi := &file_vega_vega_proto_msgTypes[87]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *VolumeRebateBenefitTier) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*VolumeRebateBenefitTier) ProtoMessage() {}

func (x *VolumeRebateBenefitTier) ProtoReflect() protoreflect.Message {
	mi := &file_vega_vega_proto_msgTypes[87]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use VolumeRebateBenefitTier.ProtoReflect.Descriptor instead.
func (*VolumeRebateBenefitTier) Descriptor() ([]byte, []int) {
	return file_vega_vega_proto_rawDescGZIP(), []int{87}
}

func (x *VolumeRebateBenefitTier) GetMinimumPartyMakerVolumeFraction() string {
	if x != nil {
		return x.MinimumPartyMakerVolumeFraction
	}
	return ""
}

func (x *VolumeRebateBenefitTier) GetAdditionalMakerRebate() string {
	if x != nil {
		return x.AdditionalMakerRebate
	}
	return ""
}

func (x *VolumeRebateBenefitTier) GetTierNumber() uint64 {
	if x != nil && x.TierNumber != nil {
		return *x.TierNumber
	}
	return 0
...
type VolumeRebateProgram struct {
	...
	BenefitTiers []*VolumeRebateBenefitTier `protobuf:"bytes,3,rep,name=benefit_tiers,json=benefitTiers,proto3" json:"benefit_tiers,omitempty"`
	// Timestamp in Unix seconds, after which when the current epoch
	// ends, the program will end and benefits will be disabled.
	EndOfProgramTimestamp int64 `protobuf:"varint,4,opt,name=end_of_program_timestamp,json=endOfProgramTimestamp,proto3" json:"end_of_program_timestamp,omitempty"`
	// Number of epochs over which a referral set's running volume is evaluated.
...
func (x *VolumeRebateProgram) Reset() {
	*x = VolumeRebateProgram{}
	if protoimpl.UnsafeEnabled {
		mi := &file_vega_vega_proto_msgTypes[88]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *VolumeRebateProgram) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (*VolumeRebateProgram) Descriptor() ([]byte, []int) {
	return file_vega_vega_proto_rawDescGZIP(), []int{88}
}
...
func (x *VolumeRebateProgram) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *VolumeRebateProgram) GetBenefitTiers() []*VolumeRebateBenefitTier {
	if x != nil {
		return x.BenefitTiers
	}
	return nil
...
func (x *VolumeRebateProgram) GetEndOfProgramTimestamp() int64 {
	if x != nil {
		return x.EndOfProgramTimestamp
	}
	return 0
...
func (x *VolumeRebateProgram) GetWindowLength() uint64 {
	if x != nil {
		return x.WindowLength
	}
	return 0
...
func (x *StopOrder_SizeOverrideValue) Reset() {
	*x = StopOrder_SizeOverrideValue{}
	if protoimpl.UnsafeEnabled {
		mi := &file_vega_vega_proto_msgTypes[89]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
var file_vega_vega_proto_rawDesc = []byte{
	...
	0x72, 0x6b, 0x65, 0x74, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x8e, 0x01, 0x0a, 0x0c,
	0x50, 0x61, 0x72, 0x74, 0x79, 0x50, 0x72, 0x6f, 0x66, 0x69, 0x6c, 0x65, 0x12, 0x19, 0x0a, 0x08,
	0x70, 0x61, 0x72, 0x74, 0x79, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07,
	0x70, 0x61, 0x72, 0x74, 0x79, 0x49, 0x64, 0x12, 0x14, 0x0a, 0x05, 0x61, 0x6c, 0x69, 0x61, 0x73,
	0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x61, 0x6c, 0x69, 0x61, 0x73, 0x12, 0x2a, 0x0a,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x6e, 0x5f, 0x72, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x42, 0x16, 0x0a, 0x14, 0x5f, 0x73, 0x69, 0x7a,
	0x65, 0x5f, 0x6f, 0x76, 0x65, 0x72, 0x72, 0x69, 0x64, 0x65, 0x5f, 0x76, 0x61, 0x6c, 0x75, 0x65,
	0x22, 0x59, 0x0a, 0x05, 0x50, 0x61, 0x72, 0x74, 0x79, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18,
	...
	0x61, 0x52, 0x08, 0x6d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x22, 0x4e, 0x0a, 0x0a, 0x52,
	0x69, 0x73, 0x6b, 0x46, 0x61, 0x63, 0x74, 0x6f, 0x72, 0x12, 0x16, 0x0a, 0x06, 0x6d, 0x61, 0x72,
	0x6b, 0x65, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x6d, 0x61, 0x72, 0x6b, 0x65,
	0x74, 0x12, 0x14, 0x0a, 0x05, 0x73, 0x68, 0x6f, 0x72, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x05, 0x73, 0x68, 0x6f, 0x72, 0x74, 0x12, 0x12, 0x0a, 0x04, 0x6c, 0x6f, 0x6e, 0x67, 0x18,
	0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x6c, 0x6f, 0x6e, 0x67, 0x22, 0x5a, 0x0a, 0x0b, 0x50,
	...
	0x06, 0x6f, 0x66, 0x66, 0x73, 0x65, 0x74, 0x22, 0x8c, 0x01, 0x0a, 0x0c, 0x49, 0x63, 0x65, 0x62,
	0x65, 0x72, 0x67, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x12, 0x1b, 0x0a, 0x09, 0x70, 0x65, 0x61, 0x6b,
	...
	0x62, 0x6c, 0x65, 0x53, 0x69, 0x7a, 0x65, 0x12, 0x2d, 0x0a, 0x12, 0x72, 0x65, 0x73, 0x65, 0x72,
	0x76, 0x65, 0x64, 0x5f, 0x72, 0x65, 0x6d, 0x61, 0x69, 0x6e, 0x69, 0x6e, 0x67, 0x18, 0x03, 0x20,
	0x01, 0x28, 0x04, 0x52, 0x11, 0x72, 0x65, 0x73, 0x65, 0x72, 0x76, 0x65, 0x64, 0x52, 0x65, 0x6d,
	0x61, 0x69, 0x6e, 0x69, 0x6e, 0x67, 0x22, 0x80, 0x0a, 0x0a, 0x05, 0x4f, 0x72, 0x64, 0x65, 0x72,
	...
	0x07, 0x70, 0x61, 0x72, 0x74, 0x79, 0x49, 0x64, 0x12, 0x1e, 0x0a, 0x04, 0x73, 0x69, 0x64, 0x65,
	0x18, 0x04, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x0a, 0x2e, 0x76, 0x65, 0x67, 0x61, 0x2e, 0x53, 0x69,
	...
	0x7a, 0x65, 0x12, 0x1c, 0x0a, 0x09, 0x72, 0x65, 0x6d, 0x61, 0x69, 0x6e, 0x69, 0x6e, 0x67, 0x18,
	0x07, 0x20, 0x01, 0x28, 0x04, 0x52, 0x09, 0x72, 0x65, 0x6d, 0x61, 0x69, 0x6e, 0x69, 0x6e, 0x67,
	0x12, 0x3b, 0x0a, 0x0d, 0x74, 0x69, 0x6d, 0x65, 0x5f, 0x69, 0x6e, 0x5f, 0x66, 0x6f, 0x72, 0x63,
	0x65, 0x18, 0x08, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x17, 0x2e, 0x76, 0x65, 0x67, 0x61, 0x2e, 0x4f,
	...
	0x04, 0x74, 0x79, 0x70, 0x65, 0x18, 0x09, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x10, 0x2e, 0x76, 0x65,
	...
	0x41, 0x74, 0x12, 0x2a, 0x0a, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x0b, 0x20, 0x01,
	...
	0x52, 0x09, 0x72, 0x65, 0x66, 0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x12, 0x2d, 0x0a, 0x06, 0x72,
	0x65, 0x61, 0x73, 0x6f, 0x6e, 0x18, 0x0e, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x10, 0x2e, 0x76, 0x65,
	0x67, 0x61, 0x2e, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x48, 0x00, 0x52,
	0x06, 0x72, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x88, 0x01, 0x01, 0x12, 0x1d, 0x0a, 0x0a, 0x75, 0x70,
	...
	,
	...
	0x54, 0x10, 0x02, 0x12, 0x15, 0x0a, 0x11, 0x54, 0x49, 0x4d, 0x45, 0x5f, 0x49, 0x4e, 0x5f, 0x46,
	0x4f, 0x52, 0x43, 0x45, 0x5f, 0x49, 0x4f, 0x43, 0x10, 0x03, 0x12, 0x15, 0x0a, 0x11, 0x54, 0x49,
	...
	,
	...
	0x5f, 0x45, 0x58, 0x50, 0x49, 0x52, 0x45, 0x44, 0x10, 0x02, 0x12, 0x14, 0x0a, 0x10, 0x53, 0x54,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x20, 0x01, 0x28, 0x04, 0x52, 0x08, 0x6e, 0x6f, 0x74, 0x69, 0x6f, 0x6e, 0x61, 0x6c, 0x22, 0xb5,
	0x01, 0x0a, 0x0a, 0x50, 0x72, 0x69, 0x63, 0x65, 0x4c, 0x65, 0x76, 0x65, 0x6c, 0x12, 0x14, 0x0a,
	...
	,
	...
	0x83, 0x03, 0x0a, 0x07, 0x44, 0x65, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x12, 0x0e, 0x0a, 0x02, 0x69,
	...
	0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x22, 0x7c, 0x0a, 0x06, 0x53, 0x74, 0x61, 0x74, 0x75,
	...
	0x49, 0x5a, 0x45, 0x44, 0x10, 0x03, 0x12, 0x1d, 0x0a, 0x19, 0x53, 0x54, 0x41, 0x54, 0x55, 0x53,
	0x5f, 0x44, 0x55, 0x50, 0x4c, 0x49, 0x43, 0x41, 0x54, 0x45, 0x5f, 0x52, 0x45, 0x4a, 0x45, 0x43,
	0x54, 0x45, 0x44, 0x10, 0x04, 0x22, 0xa8, 0x03, 0x0a, 0x0a, 0x57, 0x69, 0x74, 0x68, 0x64, 0x72,
	0x61, 0x77, 0x61, 0x6c, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09,
	...
	0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x61, 0x73, 0x73, 0x65, 0x74, 0x12, 0x2f, 0x0a,
	0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x17, 0x2e,
	0x76, 0x65, 0x67, 0x61, 0x2e, 0x57, 0x69, 0x74, 0x68, 0x64, 0x72, 0x61, 0x77, 0x61, 0x6c, 0x2e,
	0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x10,
	0x0a, 0x03, 0x72, 0x65, 0x66, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x72, 0x65, 0x66,
	...
	0x49, 0x4e, 0x41, 0x4c, 0x49, 0x5a, 0x45, 0x44, 0x10, 0x03, 0x4a, 0x04, 0x08, 0x07, 0x10, 0x08,
	...
	0x64, 0x72, 0x65, 0x73, 0x73, 0x22, 0xa3, 0x01, 0x0a, 0x07, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e,
	...
	0x74, 0x54, 0x79, 0x70, 0x65, 0x52, 0x04, 0x74, 0x79, 0x70, 0x65, 0x22, 0x3f, 0x0a, 0x0f, 0x46,
	0x69, 0x6e, 0x61, 0x6e, 0x63, 0x69, 0x61, 0x6c, 0x41, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x16,
	...
	0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x61, 0x73, 0x73, 0x65, 0x74, 0x22, 0xb3, 0x01, 0x0a,
	0x08, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x66, 0x65, 0x72, 0x12, 0x14, 0x0a, 0x05, 0x6f, 0x77, 0x6e,
	...
	0x15, 0x2e, 0x76, 0x65, 0x67, 0x61, 0x2e, 0x46, 0x69, 0x6e, 0x61, 0x6e, 0x63, 0x69, 0x61, 0x6c,
	0x41, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x52, 0x06, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x26,
	...
	0x52, 0x04, 0x74, 0x79, 0x70, 0x65, 0x12, 0x1d, 0x0a, 0x0a, 0x6d, 0x69, 0x6e, 0x5f, 0x61, 0x6d,
	...
	,
	...
	0x03, 0x52, 0x09, 0x74, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x12, 0x30, 0x0a, 0x14,
	0x66, 0x72, 0x6f, 0x6d, 0x5f, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x5f, 0x62, 0x61, 0x6c,
	0x61, 0x6e, 0x63, 0x65, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x12, 0x66, 0x72, 0x6f, 0x6d,
	...
	0x61, 0x6e, 0x63, 0x65, 0x18, 0x07, 0x20, 0x01, 0x28, 0x09, 0x52, 0x10, 0x74, 0x6f, 0x41, 0x63,
	0x63, 0x6f, 0x75, 0x6e, 0x74, 0x42, 0x61, 0x6c, 0x61, 0x6e, 0x63, 0x65, 0x12, 0x24, 0x0a, 0x0b,
	0x74, 0x72, 0x61, 0x6e, 0x73, 0x66, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x18, 0x08, 0x20, 0x01, 0x28,
	0x09, 0x48, 0x00, 0x52, 0x0a, 0x74, 0x72, 0x61, 0x6e, 0x73, 0x66, 0x65, 0x72, 0x49, 0x64, 0x88,
	0x01, 0x01, 0x42, 0x0e, 0x0a, 0x0c, 0x5f, 0x74, 0x72, 0x61, 0x6e, 0x73, 0x66, 0x65, 0x72, 0x5f,
	0x69, 0x64, 0x22, 0x5f, 0x0a, 0x13, 0x50, 0x6f, 0x73, 0x74, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x66,
	...
	0x08, 0x62, 0x61, 0x6c, 0x61, 0x6e, 0x63, 0x65, 0x73, 0x22, 0xa8, 0x03, 0x0a, 0x0c, 0x4d, 0x61,
	...
	0x74, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x12, 0x21, 0x0a, 0x0c, 0x6f, 0x72, 0x64,
	0x65, 0x72, 0x5f, 0x6d, 0x61, 0x72, 0x67, 0x69, 0x6e, 0x18, 0x09, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x0b, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x4d, 0x61, 0x72, 0x67, 0x69, 0x6e, 0x12, 0x31, 0x0a, 0x0b,
	0x6d, 0x61, 0x72, 0x67, 0x69, 0x6e, 0x5f, 0x6d, 0x6f, 0x64, 0x65, 0x18, 0x0a, 0x20, 0x01, 0x28,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x6c, 0x5f, 0x76, 0x6f, 0x6c, 0x75, 0x6d, 0x65, 0x5f, 0x62, 0x75, 0x79, 0x73, 0x18, 0x08, 0x20,
	...
	0x18, 0x09, 0x20, 0x01, 0x28, 0x09, 0x52, 0x13, 0x6e, 0x6f, 0x74, 0x69, 0x6f, 0x6e, 0x61, 0x6c,
	0x56, 0x6f, 0x6c, 0x75, 0x6d, 0x65, 0x53, 0x65, 0x6c, 0x6c, 0x73, 0x22, 0xe0, 0x01, 0x0a, 0x15,
	...
	0x65, 0x50, 0x72, 0x69, 0x63, 0x65, 0x12, 0x16, 0x0a, 0x06, 0x61, 0x63, 0x74, 0x69, 0x76, 0x65,
	0x18, 0x05, 0x20, 0x01, 0x28, 0x08, 0x52, 0x06, 0x61, 0x63, 0x74, 0x69, 0x76, 0x65, 0x22, 0x51,
	...
	0x6e, 0x6e, 0x65, 0x72, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x69, 0x6e, 0x6e, 0x65,
	0x72, 0x22, 0x3a, 0x0a, 0x10, 0x4e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b, 0x50, 0x61, 0x72, 0x61,
	0x6d, 0x65, 0x74, 0x65, 0x72, 0x12, 0x10, 0x0a, 0x03, 0x6b, 0x65, 0x79, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x03, 0x6b, 0x65, 0x79, 0x12, 0x14, 0x0a, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65,
	0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x22, 0x9a, 0x04,
	...
	0x61, 0x72, 0x6b, 0x65, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x08, 0x52, 0x10, 0x63, 0x61, 0x6e,
	...
	0x65, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0f, 0x63, 0x61, 0x6e, 0x50, 0x72, 0x6f,
	0x70, 0x6f, 0x73, 0x65, 0x41, 0x73, 0x73, 0x65, 0x74, 0x12, 0x34, 0x0a, 0x16, 0x70, 0x72, 0x6f,
	0x70, 0x6f, 0x73, 0x65, 0x5f, 0x6d, 0x61, 0x72, 0x6b, 0x65, 0x74, 0x5f, 0x65, 0x6e, 0x61, 0x62,
	0x6c, 0x65, 0x64, 0x18, 0x04, 0x20, 0x01, 0x28, 0x08, 0x52, 0x14, 0x70, 0x72, 0x6f, 0x70, 0x6f,
	...
	0x6c, 0x65, 0x64, 0x12, 0x25, 0x0a, 0x0e, 0x67, 0x65, 0x6e, 0x65, 0x73, 0x69, 0x73, 0x5f, 0x6c,
	0x6f, 0x61, 0x64, 0x65, 0x64, 0x18, 0x07, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0d, 0x67, 0x65, 0x6e,
	0x65, 0x73, 0x69, 0x73, 0x4c, 0x6f, 0x61, 0x64, 0x65, 0x64, 0x12, 0x3d, 0x0a, 0x1b, 0x70, 0x72,
	...
	,
	...
	0x02, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0a, 0x70, 0x72, 0x6f, 0x70, 0x6f, 0x72, 0x74, 0x69, 0x6f,
	0x6e, 0x12, 0x16, 0x0a, 0x06, 0x6f, 0x66, 0x66, 0x73, 0x65, 0x74, 0x18, 0x03, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x06, 0x6f, 0x66, 0x66, 0x73, 0x65, 0x74, 0x22, 0x73, 0x0a, 0x17, 0x4c, 0x69, 0x71,
	...
	0x3d, 0x0a, 0x0f, 0x6c, 0x69, 0x71, 0x75, 0x69, 0x64, 0x69, 0x74, 0x79, 0x5f, 0x6f, 0x72, 0x64,
	0x65, 0x72, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x14, 0x2e, 0x76, 0x65, 0x67, 0x61, 0x2e,
	0x4c, 0x69, 0x71, 0x75, 0x69, 0x64, 0x69, 0x74, 0x79, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x52, 0x0e,
	0x6c, 0x69, 0x71, 0x75, 0x69, 0x64, 0x69, 0x74, 0x79, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x22, 0xd2,
	0x04, 0x0a, 0x12, 0x4c, 0x69, 0x71, 0x75, 0x69, 0x64, 0x69, 0x74, 0x79, 0x50, 0x72, 0x6f, 0x76,
	...
	,
	...
	0x44, 0x10, 0x03, 0x12, 0x13, 0x0a, 0x0f, 0x53, 0x54, 0x41, 0x54, 0x55, 0x53, 0x5f, 0x52, 0x45,
	0x4a, 0x45, 0x43, 0x54, 0x45, 0x44, 0x10, 0x04, 0x12, 0x15, 0x0a, 0x11, 0x53, 0x54, 0x41, 0x54,
	0x55, 0x53, 0x5f, 0x55, 0x4e, 0x44, 0x45, 0x50, 0x4c, 0x4f, 0x59, 0x45, 0x44, 0x10, 0x05, 0x12,
	0x12, 0x0a, 0x0e, 0x53, 0x54, 0x41, 0x54, 0x55, 0x53, 0x5f, 0x50, 0x45, 0x4e, 0x44, 0x49, 0x4e,
	0x47, 0x10, 0x06, 0x22, 0xad, 0x01, 0x0a, 0x10, 0x45, 0x74, 0x68, 0x65, 0x72, 0x65, 0x75, 0x6d,
	0x4c, 0x32, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x1d, 0x0a, 0x0a, 0x6e, 0x65, 0x74, 0x77,
	...
	,
	...
	0x6e, 0x74, 0x72, 0x6f, 0x6c, 0x43, 0x6f, 0x6e, 0x74, 0x72, 0x61, 0x63, 0x74, 0x12, 0x1d, 0x0a,
	0x0a, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x5f, 0x74, 0x69, 0x6d, 0x65, 0x18, 0x08, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x09, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x54, 0x69, 0x6d, 0x65, 0x22, 0xda, 0x02, 0x0a,
	0x0f, 0x45, 0x56, 0x4d, 0x42, 0x72, 0x69, 0x64, 0x67, 0x65, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67,
	...
	,
	...
	,
	...
	0x05, 0x52, 0x07, 0x6f, 0x66, 0x66, 0x6c, 0x69, 0x6e, 0x65, 0x12, 0x16, 0x0a, 0x06, 0x6f, 0x6e,
	0x6c, 0x69, 0x6e, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x05, 0x52, 0x06, 0x6f, 0x6e, 0x6c, 0x69,
	0x6e, 0x65, 0x22, 0x9b, 0x02, 0x0a, 0x0c, 0x52, 0x61, 0x6e, 0x6b, 0x69, 0x6e, 0x67, 0x53, 0x63,
	0x6f, 0x72, 0x65, 0x12, 0x1f, 0x0a, 0x0b, 0x73, 0x74, 0x61, 0x6b, 0x65, 0x5f, 0x73, 0x63, 0x6f,
	0x72, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x73, 0x74, 0x61, 0x6b, 0x65, 0x53,
	...
	0x65, 0x12, 0x42, 0x0a, 0x0f, 0x70, 0x72, 0x65, 0x76, 0x69, 0x6f, 0x75, 0x73, 0x5f, 0x73, 0x74,
	0x61, 0x74, 0x75, 0x73, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x19, 0x2e, 0x76, 0x65, 0x67,
	0x61, 0x2e, 0x56, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x6f, 0x72, 0x4e, 0x6f, 0x64, 0x65, 0x53,
	...
	,
	...
	0x66, 0x6f, 0x72, 0x6d, 0x61, 0x6e, 0x63, 0x65, 0x53, 0x63, 0x6f, 0x72, 0x65, 0x12, 0x25, 0x0a,
	0x0e, 0x6d, 0x75, 0x6c, 0x74, 0x69, 0x73, 0x69, 0x67, 0x5f, 0x73, 0x63, 0x6f, 0x72, 0x65, 0x18,
	0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0d, 0x6d, 0x75, 0x6c, 0x74, 0x69, 0x73, 0x69, 0x67, 0x53,
	0x63, 0x6f, 0x72, 0x65, 0x12, 0x27, 0x0a, 0x0f, 0x76, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x6f,
	0x72, 0x5f, 0x73, 0x63, 0x6f, 0x72, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0e, 0x76,
	...
	,
	...
	,
	...
	0x0a, 0x0b, 0x64, 0x65, 0x6c, 0x65, 0x67, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x18, 0x0e, 0x20,
	...
	0x6e, 0x73, 0x12, 0x34, 0x0a, 0x0c, 0x72, 0x65, 0x77, 0x61, 0x72, 0x64, 0x5f, 0x73, 0x63, 0x6f,
	0x72, 0x65, 0x18, 0x0f, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x11, 0x2e, 0x76, 0x65, 0x67, 0x61, 0x2e,
	0x52, 0x65, 0x77, 0x61, 0x72, 0x64, 0x53, 0x63, 0x6f, 0x72, 0x65, 0x52, 0x0b, 0x72, 0x65, 0x77,
	0x61, 0x72, 0x64, 0x53, 0x63, 0x6f, 0x72, 0x65, 0x12, 0x37, 0x0a, 0x0d, 0x72, 0x61, 0x6e, 0x6b,
	0x69, 0x6e, 0x67, 0x5f, 0x73, 0x63, 0x6f, 0x72, 0x65, 0x18, 0x10, 0x20, 0x01, 0x28, 0x0b, 0x32,
	...
	,
	...
	0x63, 0x68, 0x53, 0x65, 0x71, 0x22, 0xa4, 0x03, 0x0a, 0x06, 0x52, 0x65, 0x77, 0x61, 0x72, 0x64,
	...
	,
	...
	0x74, 0x69, 0x6c, 0x5f, 0x65, 0x70, 0x6f, 0x63, 0x68, 0x18, 0x09, 0x20, 0x01, 0x28, 0x04, 0x52,
	...
	0x65, 0x49, 0x64, 0x88, 0x01, 0x01, 0x12, 0x1c, 0x0a, 0x07, 0x74, 0x65, 0x61, 0x6d, 0x5f, 0x69,
	0x64, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x09, 0x48, 0x01, 0x52, 0x06, 0x74, 0x65, 0x61, 0x6d, 0x49,
	0x64, 0x88, 0x01, 0x01, 0x42, 0x0a, 0x0a, 0x08, 0x5f, 0x67, 0x61, 0x6d, 0x65, 0x5f, 0x69, 0x64,
	0x42, 0x0a, 0x0a, 0x08, 0x5f, 0x74, 0x65, 0x61, 0x6d, 0x5f, 0x69, 0x64, 0x22, 0x5d, 0x0a, 0x0d,
	0x52, 0x65, 0x77, 0x61, 0x72, 0x64, 0x53, 0x75, 0x6d, 0x6d, 0x61, 0x72, 0x79, 0x12, 0x19, 0x0a,
	...
	0x01, 0x28, 0x09, 0x52, 0x06, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x22, 0x9b, 0x01, 0x0a, 0x12,
	...
	0x04, 0x52, 0x05, 0x65, 0x70, 0x6f, 0x63, 0x68, 0x12, 0x19, 0x0a, 0x08, 0x61, 0x73, 0x73, 0x65,
	...
	,
	...
	,
	...
	,
	...
	0x09, 0x52, 0x02, 0x69, 0x64, 0x12, 0x3c, 0x0a, 0x0d, 0x62, 0x65, 0x6e, 0x65, 0x66, 0x69, 0x74,
	0x5f, 0x74, 0x69, 0x65, 0x72, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x17, 0x2e, 0x76,
	...
	0x04, 0x20, 0x01, 0x28, 0x03, 0x52, 0x15, 0x65, 0x6e, 0x64, 0x4f, 0x66, 0x50, 0x72, 0x6f, 0x67,
	...
	,
	...
	0x42, 0x0a, 0x0d, 0x62, 0x65, 0x6e, 0x65, 0x66, 0x69, 0x74, 0x5f, 0x74, 0x69, 0x65, 0x72, 0x73,
	0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1d, 0x2e, 0x76, 0x65, 0x67, 0x61, 0x2e, 0x56, 0x6f,
	0x6c, 0x75, 0x6d, 0x65, 0x52, 0x65, 0x62, 0x61, 0x74, 0x65, 0x42, 0x65, 0x6e, 0x65, 0x66, 0x69,
	0x74, 0x54, 0x69, 0x65, 0x72, 0x52, 0x0c, 0x62, 0x65, 0x6e, 0x65, 0x66, 0x69, 0x74, 0x54, 0x69,
	0x65, 0x72, 0x73, 0x12, 0x37, 0x0a, 0x18, 0x65, 0x6e, 0x64, 0x5f, 0x6f, 0x66, 0x5f, 0x70, 0x72,
	0x6f, 0x67, 0x72, 0x61, 0x6d, 0x5f, 0x74, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x18,
	0x04, 0x20, 0x01, 0x28, 0x03, 0x52, 0x15, 0x65, 0x6e, 0x64, 0x4f, 0x66, 0x50, 0x72, 0x6f, 0x67,
	...
	0x77, 0x69, 0x6e, 0x64, 0x6f, 0x77, 0x5f, 0x6c, 0x65, 0x6e, 0x67, 0x74, 0x68, 0x18, 0x05, 0x20,
	0x01, 0x28, 0x04, 0x52, 0x0c, 0x77, 0x69, 0x6e, 0x64, 0x6f, 0x77, 0x4c, 0x65, 0x6e, 0x67, 0x74,
	0x68, 0x2a, 0x39, 0x0a, 0x04, 0x53, 0x69, 0x64, 0x65, 0x12, 0x14, 0x0a, 0x10, 0x53, 0x49, 0x44,
	0x45, 0x5f, 0x55, 0x4e, 0x53, 0x50, 0x45, 0x43, 0x49, 0x46, 0x49, 0x45, 0x44, 0x10, 0x00, 0x12,
	0x0c, 0x0a, 0x08, 0x53, 0x49, 0x44, 0x45, 0x5f, 0x42, 0x55, 0x59, 0x10, 0x01, 0x12, 0x0d, 0x0a,
	0x09, 0x53, 0x49, 0x44, 0x45, 0x5f, 0x53, 0x45, 0x4c, 0x4c, 0x10, 0x02, 0x2a, 0x99, 0x02, 0x0a,
	...
	0x44, 0x10, 0x00, 0x12, 0x1b, 0x0a, 0x0e, 0x49, 0x4e, 0x54, 0x45, 0x52, 0x56, 0x41, 0x4c, 0x5f,
	0x42, 0x4c, 0x4f, 0x43, 0x4b, 0x10, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x01,
	...
	,
	...
	0x4f, 0x52, 0x44, 0x45, 0x52, 0x53, 0x5f, 0x43, 0x4c, 0x4f, 0x53, 0x45, 0x44, 0x10, 0x01, 0x12,
	0x1e, 0x0a, 0x1a, 0x50, 0x4f, 0x53, 0x49, 0x54, 0x49, 0x4f, 0x4e, 0x5f, 0x53, 0x54, 0x41, 0x54,
	0x55, 0x53, 0x5f, 0x43, 0x4c, 0x4f, 0x53, 0x45, 0x44, 0x5f, 0x4f, 0x55, 0x54, 0x10, 0x02, 0x12,
	0x1e, 0x0a, 0x1a, 0x50, 0x4f, 0x53, 0x49, 0x54, 0x49, 0x4f, 0x4e, 0x5f, 0x53, 0x54, 0x41, 0x54,
	0x55, 0x53, 0x5f, 0x44, 0x49, 0x53, 0x54, 0x52, 0x45, 0x53, 0x53, 0x45, 0x44, 0x10, 0x04, 0x2a,
	0xd0, 0x02, 0x0a, 0x0e, 0x41, 0x75, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x54, 0x72, 0x69, 0x67, 0x67,
	...
	,
	...
	,
	...
	0x4b, 0x5f, 0x50, 0x52, 0x49, 0x43, 0x45, 0x10, 0x25, 0x12, 0x37, 0x0a, 0x33, 0x4f, 0x52, 0x44,
	...
	0x10, 0x28, 0x12, 0x34, 0x0a, 0x30, 0x4f, 0x52, 0x44, 0x45, 0x52, 0x5f, 0x45, 0x52, 0x52, 0x4f,
	0x52, 0x5f, 0x53, 0x45, 0x4c, 0x4c, 0x5f, 0x43, 0x41, 0x4e, 0x4e, 0x4f, 0x54, 0x5f, 0x52, 0x45,
	0x46, 0x45, 0x52, 0x45, 0x4e, 0x43, 0x45, 0x5f, 0x42, 0x45, 0x53, 0x54, 0x5f, 0x42, 0x49, 0x44,
	0x5f, 0x50, 0x52, 0x49, 0x43, 0x45, 0x10, 0x29, 0x12, 0x30, 0x0a, 0x2c, 0x4f, 0x52, 0x44, 0x45,
	...
	,
	...
	,
	...
	0x4e, 0x4e, 0x45, 0x43, 0x54, 0x45, 0x44, 0x10, 0x03, 0x2a, 0x8c, 0x09, 0x0a, 0x0b, 0x41, 0x63,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
...
var file_vega_vega_proto_msgTypes = make([]protoimpl.MessageInfo, 90)
var file_vega_vega_proto_goTypes = []interface{}{
	...
	(*EVMBridgeConfig)(nil),               // 81: vega.EVMBridgeConfig
	(*EVMBridgeConfigs)(nil),              // 82: vega.EVMBridgeConfigs
	(*EthereumContractConfig)(nil),        // 83: vega.EthereumContractConfig
	(*EpochTimestamps)(nil),               // 84: vega.EpochTimestamps
	(*Epoch)(nil),                         // 85: vega.Epoch
	(*EpochParticipation)(nil),            // 86: vega.EpochParticipation
	(*EpochData)(nil),                     // 87: vega.EpochData
	(*RankingScore)(nil),                  // 88: vega.RankingScore
	(*RewardScore)(nil),                   // 89: vega.RewardScore
	(*Node)(nil),                          // 90: vega.Node
	(*NodeSet)(nil),                       // 91: vega.NodeSet
	(*NodeData)(nil),                      // 92: vega.NodeData
	(*Delegation)(nil),                    // 93: vega.Delegation
	(*Reward)(nil),                        // 94: vega.Reward
	(*RewardSummary)(nil),                 // 95: vega.RewardSummary
	(*EpochRewardSummary)(nil),            // 96: vega.EpochRewardSummary
	(*StateValueProposal)(nil),            // 97: vega.StateValueProposal
	(*KeyValueBundle)(nil),                // 98: vega.KeyValueBundle
	(*StateVarValue)(nil),                 // 99: vega.StateVarValue
	(*ScalarValue)(nil),                   // 100: vega.ScalarValue
	(*VectorValue)(nil),                   // 101: vega.VectorValue
	(*MatrixValue)(nil),                   // 102: vega.MatrixValue
	(*ReferralProgram)(nil),               // 103: vega.ReferralProgram
	(*VolumeBenefitTier)(nil),             // 104: vega.VolumeBenefitTier
	(*BenefitTier)(nil),                   // 105: vega.BenefitTier
	(*RewardFactors)(nil),                 // 106: vega.RewardFactors
	(*DiscountFactors)(nil),               // 107: vega.DiscountFactors
	(*VestingBenefitTiers)(nil),           // 108: vega.VestingBenefitTiers
	(*VestingBenefitTier)(nil),            // 109: vega.VestingBenefitTier
	(*StakingTier)(nil),                   // 110: vega.StakingTier
	(*VolumeDiscountProgram)(nil),         // 111: vega.VolumeDiscountProgram
	(*ActivityStreakBenefitTiers)(nil),    // 112: vega.ActivityStreakBenefitTiers
	(*ActivityStreakBenefitTier)(nil),     // 113: vega.ActivityStreakBenefitTier
	(*LongBlockAuction)(nil),              // 114: vega.LongBlockAuction
	(*LongBlockAuctionDurationTable)(nil), // 115: vega.LongBlockAuctionDurationTable
	(*VolumeRebateBenefitTier)(nil),       // 116: vega.VolumeRebateBenefitTier
	(*VolumeRebateProgram)(nil),           // 117: vega.VolumeRebateProgram
	(*StopOrder_SizeOverrideValue)(nil),   // 118: vega.StopOrder.SizeOverrideValue
	(CompositePriceType)(0),               // 119: vega.CompositePriceType
	(Market_TradingMode)(0),               // 120: vega.Market.TradingMode
	(Market_State)(0),                     // 121: vega.Market.State
	(*PriceMonitoringTrigger)(nil),        // 122: vega.PriceMonitoringTrigger
}
var file_vega_vega_proto_depIdxs = []int32{
	...
	118, // 6: vega.StopOrder.size_override_value:type_name -> vega.StopOrder.SizeOverrideValue
	...
	119, // 54: vega.PerpetualData.internal_composite_price_type:type_name -> vega.CompositePriceType
	...
	120, // 57: vega.MarketData.market_trading_mode:type_name -> vega.Market.TradingMode
	...
	121, // 62: vega.MarketData.market_state:type_name -> vega.Market.State
	...
	119, // 65: vega.MarketData.mark_price_type:type_name -> vega.CompositePriceType
	...
	122, // 68: vega.PriceMonitoringBounds.trigger:type_name -> vega.PriceMonitoringTrigger
	...
	83,  // 75: vega.EthereumConfig.collateral_bridge_contract:type_name -> vega.EthereumContractConfig
	83,  // 76: vega.EthereumConfig.staking_bridge_contract:type_name -> vega.EthereumContractConfig
	83,  // 77: vega.EthereumConfig.token_vesting_contract:type_name -> vega.EthereumContractConfig
	83,  // 78: vega.EthereumConfig.multisig_control_contract:type_name -> vega.EthereumContractConfig
	83,  // 79: vega.EVMBridgeConfig.collateral_bridge_contract:type_name -> vega.EthereumContractConfig
	83,  // 80: vega.EVMBridgeConfig.multisig_control_contract:type_name -> vega.EthereumContractConfig
	81,  // 81: vega.EVMBridgeConfigs.configs:type_name -> vega.EVMBridgeConfig
	84,  // 82: vega.Epoch.timestamps:type_name -> vega.EpochTimestamps
	90,  // 83: vega.Epoch.validators:type_name -> vega.Node
	93,  // 84: vega.Epoch.delegations:type_name -> vega.Delegation
	85,  // 85: vega.EpochParticipation.epoch:type_name -> vega.Epoch
	15,  // 86: vega.RankingScore.previous_status:type_name -> vega.ValidatorNodeStatus
	15,  // 87: vega.RankingScore.status:type_name -> vega.ValidatorNodeStatus
	15,  // 88: vega.RewardScore.validator_status:type_name -> vega.ValidatorNodeStatus
	87,  // 89: vega.Node.epoch_data:type_name -> vega.EpochData
	13,  // 90: vega.Node.status:type_name -> vega.NodeStatus
	93,  // 91: vega.Node.delegations:type_name -> vega.Delegation
	89,  // 92: vega.Node.reward_score:type_name -> vega.RewardScore
	88,  // 93: vega.Node.ranking_score:type_name -> vega.RankingScore
	91,  // 94: vega.NodeData.tendermint_nodes:type_name -> vega.NodeSet
	91,  // 95: vega.NodeData.ersatz_nodes:type_name -> vega.NodeSet
	91,  // 96: vega.NodeData.pending_nodes:type_name -> vega.NodeSet
	98,  // 97: vega.StateValueProposal.kvb:type_name -> vega.KeyValueBundle
	99,  // 98: vega.KeyValueBundle.value:type_name -> vega.StateVarValue
	100, // 99: vega.StateVarValue.scalar_val:type_name -> vega.ScalarValue
	101, // 100: vega.StateVarValue.vector_val:type_name -> vega.VectorValue
	102, // 101: vega.StateVarValue.matrix_val:type_name -> vega.MatrixValue
	101, // 102: vega.MatrixValue.value:type_name -> vega.VectorValue
	105, // 103: vega.ReferralProgram.benefit_tiers:type_name -> vega.BenefitTier
	110, // 104: vega.ReferralProgram.staking_tiers:type_name -> vega.StakingTier
	107, // 105: vega.VolumeBenefitTier.volume_discount_factors:type_name -> vega.DiscountFactors
	106, // 106: vega.BenefitTier.referral_reward_factors:type_name -> vega.RewardFactors
	107, // 107: vega.BenefitTier.referral_discount_factors:type_name -> vega.DiscountFactors
	109, // 108: vega.VestingBenefitTiers.tiers:type_name -> vega.VestingBenefitTier
	104, // 109: vega.VolumeDiscountProgram.benefit_tiers:type_name -> vega.VolumeBenefitTier
	113, // 110: vega.ActivityStreakBenefitTiers.tiers:type_name -> vega.ActivityStreakBenefitTier
	114, // 111: vega.LongBlockAuctionDurationTable.threshold_and_duration:type_name -> vega.LongBlockAuction
	116, // 112: vega.VolumeRebateProgram.benefit_tiers:type_name -> vega.VolumeRebateBenefitTier
...
func file_vega_vega_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_vega_vega_proto_msgTypes[83].Exporter = func(v interface{}, i int) interface{} {
		...
		file_vega_vega_proto_msgTypes[84].Exporter = func(v interface{}, i int) interface{} {
		...
		file_vega_vega_proto_msgTypes[85].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*LongBlockAuction); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_vega_vega_proto_msgTypes[86].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*LongBlockAuctionDurationTable); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_vega_vega_proto_msgTypes[87].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*VolumeRebateBenefitTier); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_vega_vega_proto_msgTypes[88].Exporter = func(v interface{}, i int) interface{} {
		...
		file_vega_vega_proto_msgTypes[89].Exporter = func(v interface{}, i int) interface{} {
	...
	file_vega_vega_proto_msgTypes[65].OneofWrappers = []interface{}{}
	file_vega_vega_proto_msgTypes[70].OneofWrappers = []interface{}{
		(*StateVarValue_ScalarVal)(nil),
		(*StateVarValue_VectorVal)(nil),
		(*StateVarValue_MatrixVal)(nil),
	}
	file_vega_vega_proto_msgTypes[75].OneofWrappers = []interface{}{}
	file_vega_vega_proto_msgTypes[76].OneofWrappers = []interface{}{}
	file_vega_vega_proto_msgTypes[87].OneofWrappers = []interface{}{}
	type x struct{}
