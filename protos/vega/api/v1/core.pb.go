...
type SpamStatistic struct {
	...
	CountForEpoch string `protobuf:"bytes,1,opt,name=count_for_epoch,json=countForEpoch,proto3" json:"count_for_epoch,omitempty"`
	// The current transaction count received from the party during the current block for this policy
	CountForBlock string `protobuf:"bytes,2,opt,name=count_for_block,json=countForBlock,proto3" json:"count_for_block,omitempty"`
	// The maximum number of transactions allowed for this policy in an epoch
	MaxForEpoch string `protobuf:"bytes,3,opt,name=max_for_epoch,json=maxForEpoch,proto3" json:"max_for_epoch,omitempty"`
	// If blocked the timestamp when the party will be unblocked
	Until *string `protobuf:"bytes,4,opt,name=until,proto3,oneof" json:"until,omitempty"`
}
...
func (x *SpamStatistic) GetCountForEpoch() string {
	if x != nil {
...
func (x *SpamStatistic) GetCountForBlock() string {
	if x != nil {
		return x.CountForBlock
	}
	return ""
}

func (x *SpamStatistic) GetMaxForEpoch() string {
	if x != nil {
...
func (x *SpamStatistic) GetUntil() string {
...
type VoteSpamStatistic struct {
	...
	// The current vote count received from the party during this epoch
	CountForEpoch string `protobuf:"bytes,1,opt,name=count_for_epoch,json=countForEpoch,proto3" json:"count_for_epoch,omitempty"`
	// The number of votes from the party that have been rejected during this epoch
	RejectedCount string `protobuf:"bytes,2,opt,name=rejected_count,json=rejectedCount,proto3" json:"rejected_count,omitempty"`
	// The percentage of total votes that have been rejected
	RejectedPercentage string `protobuf:"bytes,3,opt,name=rejected_percentage,json=rejectedPercentage,proto3" json:"rejected_percentage,omitempty"`
	// The maximum rejection limit that is allowed for this policy in an epoch
	BlockLimit string `protobuf:"bytes,4,opt,name=block_limit,json=blockLimit,proto3" json:"block_limit,omitempty"`
	// If blocked the timestamp when the party will be unblocked
...
func (x *VoteSpamStatistic) GetCountForEpoch() string {
	if x != nil {
		return x.CountForEpoch
	}
	return ""
...
func (x *VoteSpamStatistic) GetRejectedCount() string {
	if x != nil {
...
func (x *VoteSpamStatistic) GetRejectedPercentage() string {
	if x != nil {
		return x.RejectedPercentage
	}
	return ""
}

func (x *VoteSpamStatistic) GetBlockLimit() string {
	if x != nil {
		return x.BlockLimit
	}
	return ""
...
func (x *VoteSpamStatistic) GetUntil() string {
	if x != nil && x.Until != nil {
		return *x.Until
	}
	return ""
...
type SpamStatistics struct {
	...
	Votes             *VoteSpamStatistic `protobuf:"bytes,5,opt,name=votes,proto3" json:"votes,omitempty"`
}
...
func (x *SpamStatistics) GetVotes() *VoteSpamStatistic {
	if x != nil {
		return x.Votes
	}
	return nil
...
var file_vega_api_v1_core_proto_rawDesc = []byte{
	...
	0x28, 0x09, 0x52, 0x07, 0x70, 0x61, 0x72, 0x74, 0x79, 0x49, 0x64, 0x22, 0xa8, 0x01, 0x0a, 0x0d,
	...
	,
	...
	0x11, 0x6e, 0x6f, 0x64, 0x65, 0x41, 0x6e, 0x6e, 0x6f, 0x75, 0x6e, 0x63, 0x65, 0x6d, 0x65, 0x6e,
	0x74, 0x73, 0x12, 0x34, 0x0a, 0x05, 0x76, 0x6f, 0x74, 0x65, 0x73, 0x18, 0x05, 0x20, 0x01, 0x28,
	0x0b, 0x32, 0x1e, 0x2e, 0x76, 0x65, 0x67, 0x61, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x76, 0x31, 0x2e,
	0x56, 0x6f, 0x74, 0x65, 0x53, 0x70, 0x61, 0x6d, 0x53, 0x74, 0x61, 0x74, 0x69, 0x73, 0x74, 0x69,
	0x63, 0x52, 0x05, 0x76, 0x6f, 0x74, 0x65, 0x73, 0x22, 0x58, 0x0a, 0x19, 0x47, 0x65, 0x74, 0x53,
...
var file_vega_api_v1_core_proto_msgTypes = make([]protoimpl.MessageInfo, 24)
var file_vega_api_v1_core_proto_goTypes = []interface{}{
	...
	(*VoteSpamStatistic)(nil),             // 23: vega.api.v1.VoteSpamStatistic
	(*SpamStatistics)(nil),                // 24: vega.api.v1.SpamStatistics
	(*GetSpamStatisticsResponse)(nil),     // 25: vega.api.v1.GetSpamStatisticsResponse
	(*v1.Transaction)(nil),                // 26: vega.commands.v1.Transaction
	(v11.BusEventType)(0),                 // 27: vega.events.v1.BusEventType
	(*v11.BusEvent)(nil),                  // 28: vega.events.v1.BusEvent
	(vega.ChainStatus)(0),                 // 29: vega.ChainStatus
}
var file_vega_api_v1_core_proto_depIdxs = []int32{
	26, // 0: vega.api.v1.SubmitTransactionRequest.tx:type_name -> vega.commands.v1.Transaction
	0,  // 1: vega.api.v1.SubmitTransactionRequest.type:type_name -> vega.api.v1.SubmitTransactionRequest.Type
	26, // 2: vega.api.v1.CheckTransactionRequest.tx:type_name -> vega.commands.v1.Transaction
	1,  // 3: vega.api.v1.SubmitRawTransactionRequest.type:type_name -> vega.api.v1.SubmitRawTransactionRequest.Type
	27, // 4: vega.api.v1.ObserveEventBusRequest.type:type_name -> vega.events.v1.BusEventType
	28, // 5: vega.api.v1.ObserveEventBusResponse.events:type_name -> vega.events.v1.BusEvent
	18, // 6: vega.api.v1.StatisticsResponse.statistics:type_name -> vega.api.v1.Statistics
	29, // 7: vega.api.v1.Statistics.status:type_name -> vega.ChainStatus
	22, // 8: vega.api.v1.SpamStatistics.proposals:type_name -> vega.api.v1.SpamStatistic
	22, // 9: vega.api.v1.SpamStatistics.delegations:type_name -> vega.api.v1.SpamStatistic
	22, // 10: vega.api.v1.SpamStatistics.transfers:type_name -> vega.api.v1.SpamStatistic
	22, // 11: vega.api.v1.SpamStatistics.node_announcements:type_name -> vega.api.v1.SpamStatistic
	23, // 12: vega.api.v1.SpamStatistics.votes:type_name -> vega.api.v1.VoteSpamStatistic
	24, // 13: vega.api.v1.GetSpamStatisticsResponse.statistics:type_name -> vega.api.v1.SpamStatistics
	4,  // 14: vega.api.v1.CoreService.SubmitTransaction:input_type -> vega.api.v1.SubmitTransactionRequest
	2,  // 15: vega.api.v1.CoreService.PropagateChainEvent:input_type -> vega.api.v1.PropagateChainEventRequest
	16, // 16: vega.api.v1.CoreService.Statistics:input_type -> vega.api.v1.StatisticsRequest
	19, // 17: vega.api.v1.CoreService.LastBlockHeight:input_type -> vega.api.v1.LastBlockHeightRequest
	12, // 18: vega.api.v1.CoreService.GetVegaTime:input_type -> vega.api.v1.GetVegaTimeRequest
	14, // 19: vega.api.v1.CoreService.ObserveEventBus:input_type -> vega.api.v1.ObserveEventBusRequest
	8,  // 20: vega.api.v1.CoreService.SubmitRawTransaction:input_type -> vega.api.v1.SubmitRawTransactionRequest
	6,  // 21: vega.api.v1.CoreService.CheckTransaction:input_type -> vega.api.v1.CheckTransactionRequest
	10, // 22: vega.api.v1.CoreService.CheckRawTransaction:input_type -> vega.api.v1.CheckRawTransactionRequest
	21, // 23: vega.api.v1.CoreService.GetSpamStatistics:input_type -> vega.api.v1.GetSpamStatisticsRequest
	5,  // 24: vega.api.v1.CoreService.SubmitTransaction:output_type -> vega.api.v1.SubmitTransactionResponse
	3,  // 25: vega.api.v1.CoreService.PropagateChainEvent:output_type -> vega.api.v1.PropagateChainEventResponse
	17, // 26: vega.api.v1.CoreService.Statistics:output_type -> vega.api.v1.StatisticsResponse
	20, // 27: vega.api.v1.CoreService.LastBlockHeight:output_type -> vega.api.v1.LastBlockHeightResponse
	13, // 28: vega.api.v1.CoreService.GetVegaTime:output_type -> vega.api.v1.GetVegaTimeResponse
	15, // 29: vega.api.v1.CoreService.ObserveEventBus:output_type -> vega.api.v1.ObserveEventBusResponse
	9,  // 30: vega.api.v1.CoreService.SubmitRawTransaction:output_type -> vega.api.v1.SubmitRawTransactionResponse
	7,  // 31: vega.api.v1.CoreService.CheckTransaction:output_type -> vega.api.v1.CheckTransactionResponse
	11, // 32: vega.api.v1.CoreService.CheckRawTransaction:output_type -> vega.api.v1.CheckRawTransactionResponse
	25, // 33: vega.api.v1.CoreService.GetSpamStatistics:output_type -> vega.api.v1.GetSpamStatisticsResponse
