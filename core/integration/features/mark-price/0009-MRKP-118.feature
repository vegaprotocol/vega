Feature: Test setting of mark price
  Background:
    ...
    And the markets:
      ...
      | ETH/FEB23 | ETH        | USD   | lqm-params           | simple-risk-model | default-margin-calculator | 1                | default-none | default-none     | default-eth-for-future | 0.25                   | 0                         | default-futures | weight     | 0.5          | 1           | 0           | 1,0,0,0        | 5s,5s,24h0m0s,1h25m0s      | future      |
      | ETH/FEB22 | ETH        | USD   | lqm-params           | simple-risk-model | default-margin-calculator | 1                | default-none | default-none     | perp-oracle            | 0.25                   | 0                         | default-futures | weight     | 0.5          | 1           | 0           | 1,0,0,0        | 5s,5s,24h0m0s,1h25m0s      | perp        |
  ...
  Scenario: 001 check mark price using weight average
    ...
    # AC 0009-MRKP-118, 0009-MRKP-119
    ...
    #decay weight is 0.5, power is 1, so mark price is: (15920*2*0.5+15940*1*0.625+15960*3*0.75+15990*5*0.875)/(2*0.5+1*0.625+3*0.75+5*0.875)=15969
    When the network moves ahead "1" blocks
    Then the mark price should be "15969" for the market "ETH/FEB23"
    Then the mark price should be "15969" for the market "ETH/FEB22"
