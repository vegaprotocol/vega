Feature: Cancelling all orders emits a single event per party.
  ...
  Scenario: Parties cancel all their orders.
    Given the parties place the following orders:
      | party  | market id | side | volume | price | resulting trades | type       | tif     | reference |
      | party2 | ETH/DEC21 | buy  | 100    | 90    | 0                | TYPE_LIMIT | TIF_GTC | p2b1      |
      ...
      | party2 | ETH/DEC21 | sell | 1000   | 200   | 0                | TYPE_LIMIT | TIF_GTC | p2s1      |
    ...
    Then the orders should have the following states:
      ...
      | party2 | ETH/DEC21 | buy  | 100    | 100       | 90    | STATUS_ACTIVE |
      | party3 | ETH/DEC21 | buy  | 100    | 100       | 100   | STATUS_ACTIVE |
      | party4 | ETH/DEC21 | sell | 1000   | 1000      | 190   | STATUS_ACTIVE |
      | party2 | ETH/DEC21 | sell | 1000   | 1000      | 200   | STATUS_ACTIVE |

    When the parties cancel all their orders for the markets:
      | party  | market id |
      | party2 | ETH/DEC21 |
    Then the following orders are cancelled on market "ETH/DEC21":
      | reference | party  |
      | p2b1      | party2 |
      | p2s1      | party2 |
    And the orders should have the following states:
      | party  | market id | side | volume | remaining | price | status           |
      | party2 | ETH/DEC21 | buy  | 100    | 100       | 90    | STATUS_CANCELLED |
      | party3 | ETH/DEC21 | buy  | 100    | 100       | 100   | STATUS_ACTIVE    |
      | party4 | ETH/DEC21 | sell | 1000   | 1000      | 190   | STATUS_ACTIVE    |
      | party2 | ETH/DEC21 | sell | 1000   | 1000      | 200   | STATUS_CANCELLED |
