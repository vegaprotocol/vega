...
// ValidateWithdrawal will request the ethereum chain in orde to check that
// a given withdrawal have been applied
func (b *ERC20) ValidateWithdrawal() error {
	return nil
}

// SignWithdrawal will create the message and signature to instruct
// a withdrawal on the bridge
func (b *ERC20) SignWithdrawal() ([]byte, error) {
	return nil, nil
}

// ValidateDeposit will validate on chain a deposit to a party account
