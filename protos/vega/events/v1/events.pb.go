...
var file_vega_events_v1_events_proto_rawDesc = []byte{
	...
	0x22, 0x6e, 0x0a, 0x1b, 0x52, 0x65, 0x63, 0x75, 0x72, 0x72, 0x69, 0x6e, 0x67, 0x47, 0x6f, 0x76,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x70, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x22, 0xaf, 0x12,
	...
	0x70, 0x67, 0x72, 0x61, 0x64, 0x65, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x22, 0xfa, 0x21, 0x0a, 0x08,
	...
	0x70, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x12, 0x36, 0x0a, 0x06, 0x6d, 0x61, 0x72, 0x6b, 0x65, 0x74,
	...
	0x07, 0x0a, 0x05, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x22, 0x49, 0x0a, 0x0d, 0x45, 0x78, 0x70, 0x69,
	...
	0x49, 0x64, 0x73, 0x2a, 0xdd, 0x01, 0x0a, 0x1d, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c,
	...
	0x44, 0x10, 0x03, 0x2a, 0xba, 0x11, 0x0a, 0x0c, 0x42, 0x75, 0x73, 0x45, 0x76, 0x65, 0x6e, 0x74,
	...
	0x4f, 0x52, 0x44, 0x45, 0x52, 0x10, 0x3c, 0x12, 0x19, 0x0a, 0x15, 0x42, 0x55, 0x53, 0x5f, 0x45,
...
var file_vega_events_v1_events_proto_depIdxs = []int32{
	...
	3,   // 11: vega.events.v1.StakeLinking.type:type_name -> vega.events.v1.StakeLinking.Type
	4,   // 12: vega.events.v1.StakeLinking.status:type_name -> vega.events.v1.StakeLinking.Status
	5,   // 13: vega.events.v1.ERC20MultiSigSignerEvent.type:type_name -> vega.events.v1.ERC20MultiSigSignerEvent.Type
	55,  // 14: vega.events.v1.TransactionResult.order_submission:type_name -> vega.commands.v1.OrderSubmission
	59,  // 15: vega.events.v1.TransactionResult.order_amendment:type_name -> vega.commands.v1.OrderAmendment
	60,  // 16: vega.events.v1.TransactionResult.order_cancellation:type_name -> vega.commands.v1.OrderCancellation
	61,  // 17: vega.events.v1.TransactionResult.proposal:type_name -> vega.commands.v1.ProposalSubmission
	62,  // 18: vega.events.v1.TransactionResult.vote_submission:type_name -> vega.commands.v1.VoteSubmission
	63,  // 19: vega.events.v1.TransactionResult.liquidity_provision_submission:type_name -> vega.commands.v1.LiquidityProvisionSubmission
	64,  // 20: vega.events.v1.TransactionResult.withdraw_submission:type_name -> vega.commands.v1.WithdrawSubmission
	65,  // 21: vega.events.v1.TransactionResult.delegate_submission:type_name -> vega.commands.v1.DelegateSubmission
	66,  // 22: vega.events.v1.TransactionResult.undelegate_submission:type_name -> vega.commands.v1.UndelegateSubmission
	67,  // 23: vega.events.v1.TransactionResult.liquidity_provision_cancellation:type_name -> vega.commands.v1.LiquidityProvisionCancellation
	68,  // 24: vega.events.v1.TransactionResult.liquidity_provision_amendment:type_name -> vega.commands.v1.LiquidityProvisionAmendment
	69,  // 25: vega.events.v1.TransactionResult.transfer:type_name -> vega.commands.v1.Transfer
	70,  // 26: vega.events.v1.TransactionResult.cancel_transfer:type_name -> vega.commands.v1.CancelTransfer
	71,  // 27: vega.events.v1.TransactionResult.announce_node:type_name -> vega.commands.v1.AnnounceNode
	72,  // 28: vega.events.v1.TransactionResult.oracle_data_submission:type_name -> vega.commands.v1.OracleDataSubmission
	73,  // 29: vega.events.v1.TransactionResult.protocol_upgrade_proposal:type_name -> vega.commands.v1.ProtocolUpgradeProposal
	74,  // 30: vega.events.v1.TransactionResult.issue_signatures:type_name -> vega.commands.v1.IssueSignatures
	75,  // 31: vega.events.v1.TransactionResult.batch_market_instructions:type_name -> vega.commands.v1.BatchMarketInstructions
	76,  // 32: vega.events.v1.TransactionResult.key_rotate_submission:type_name -> vega.commands.v1.KeyRotateSubmission
	77,  // 33: vega.events.v1.TransactionResult.ethereum_key_rotate_submission:type_name -> vega.commands.v1.EthereumKeyRotateSubmission
	78,  // 34: vega.events.v1.TransactionResult.stop_order_submission:type_name -> vega.commands.v1.StopOrdersSubmission
	79,  // 35: vega.events.v1.TransactionResult.stop_order_cancellation:type_name -> vega.commands.v1.StopOrdersCancellation
	53,  // 36: vega.events.v1.TransactionResult.success:type_name -> vega.events.v1.TransactionResult.SuccessDetails
	54,  // 37: vega.events.v1.TransactionResult.failure:type_name -> vega.events.v1.TransactionResult.FailureDetails
	55,  // 38: vega.events.v1.TxErrorEvent.order_submission:type_name -> vega.commands.v1.OrderSubmission
	59,  // 39: vega.events.v1.TxErrorEvent.order_amendment:type_name -> vega.commands.v1.OrderAmendment
	60,  // 40: vega.events.v1.TxErrorEvent.order_cancellation:type_name -> vega.commands.v1.OrderCancellation
	61,  // 41: vega.events.v1.TxErrorEvent.proposal:type_name -> vega.commands.v1.ProposalSubmission
	62,  // 42: vega.events.v1.TxErrorEvent.vote_submission:type_name -> vega.commands.v1.VoteSubmission
	63,  // 43: vega.events.v1.TxErrorEvent.liquidity_provision_submission:type_name -> vega.commands.v1.LiquidityProvisionSubmission
	64,  // 44: vega.events.v1.TxErrorEvent.withdraw_submission:type_name -> vega.commands.v1.WithdrawSubmission
	65,  // 45: vega.events.v1.TxErrorEvent.delegate_submission:type_name -> vega.commands.v1.DelegateSubmission
	66,  // 46: vega.events.v1.TxErrorEvent.undelegate_submission:type_name -> vega.commands.v1.UndelegateSubmission
	67,  // 47: vega.events.v1.TxErrorEvent.liquidity_provision_cancellation:type_name -> vega.commands.v1.LiquidityProvisionCancellation
	68,  // 48: vega.events.v1.TxErrorEvent.liquidity_provision_amendment:type_name -> vega.commands.v1.LiquidityProvisionAmendment
	69,  // 49: vega.events.v1.TxErrorEvent.transfer:type_name -> vega.commands.v1.Transfer
	70,  // 50: vega.events.v1.TxErrorEvent.cancel_transfer:type_name -> vega.commands.v1.CancelTransfer
	71,  // 51: vega.events.v1.TxErrorEvent.announce_node:type_name -> vega.commands.v1.AnnounceNode
	72,  // 52: vega.events.v1.TxErrorEvent.oracle_data_submission:type_name -> vega.commands.v1.OracleDataSubmission
	73,  // 53: vega.events.v1.TxErrorEvent.protocol_upgrade_proposal:type_name -> vega.commands.v1.ProtocolUpgradeProposal
	74,  // 54: vega.events.v1.TxErrorEvent.issue_signatures:type_name -> vega.commands.v1.IssueSignatures
	75,  // 55: vega.events.v1.TxErrorEvent.batch_market_instructions:type_name -> vega.commands.v1.BatchMarketInstructions
	80,  // 56: vega.events.v1.EpochEvent.action:type_name -> vega.EpochAction
	81,  // 57: vega.events.v1.LedgerMovements.ledger_movements:type_name -> vega.LedgerMovement
	31,  // 58: vega.events.v1.SettlePosition.trade_settlements:type_name -> vega.events.v1.TradeSettlement
	82,  // 59: vega.events.v1.AuctionEvent.trigger:type_name -> vega.AuctionTrigger
	82,  // 60: vega.events.v1.AuctionEvent.extension_trigger:type_name -> vega.AuctionTrigger
	...
	26,  // 63: vega.events.v1.BusEvent.time_update:type_name -> vega.events.v1.TimeUpdate
	28,  // 64: vega.events.v1.BusEvent.ledger_movements:type_name -> vega.events.v1.LedgerMovements
	29,  // 65: vega.events.v1.BusEvent.position_resolution:type_name -> vega.events.v1.PositionResolution
	83,  // 66: vega.events.v1.BusEvent.order:type_name -> vega.Order
	84,  // 67: vega.events.v1.BusEvent.account:type_name -> vega.Account
	85,  // 68: vega.events.v1.BusEvent.party:type_name -> vega.Party
	86,  // 69: vega.events.v1.BusEvent.trade:type_name -> vega.Trade
	87,  // 70: vega.events.v1.BusEvent.margin_levels:type_name -> vega.MarginLevels
	88,  // 71: vega.events.v1.BusEvent.proposal:type_name -> vega.Proposal
	89,  // 72: vega.events.v1.BusEvent.vote:type_name -> vega.Vote
	90,  // 73: vega.events.v1.BusEvent.market_data:type_name -> vega.MarketData
	91,  // 74: vega.events.v1.BusEvent.node_signature:type_name -> vega.commands.v1.NodeSignature
	30,  // 75: vega.events.v1.BusEvent.loss_socialization:type_name -> vega.events.v1.LossSocialization
	32,  // 76: vega.events.v1.BusEvent.settle_position:type_name -> vega.events.v1.SettlePosition
	35,  // 77: vega.events.v1.BusEvent.settle_distressed:type_name -> vega.events.v1.SettleDistressed
	92,  // 78: vega.events.v1.BusEvent.market_created:type_name -> vega.Market
	93,  // 79: vega.events.v1.BusEvent.asset:type_name -> vega.Asset
	38,  // 80: vega.events.v1.BusEvent.market_tick:type_name -> vega.events.v1.MarketTick
	94,  // 81: vega.events.v1.BusEvent.withdrawal:type_name -> vega.Withdrawal
	95,  // 82: vega.events.v1.BusEvent.deposit:type_name -> vega.Deposit
	39,  // 83: vega.events.v1.BusEvent.auction:type_name -> vega.events.v1.AuctionEvent
	96,  // 84: vega.events.v1.BusEvent.risk_factor:type_name -> vega.RiskFactor
	97,  // 85: vega.events.v1.BusEvent.network_parameter:type_name -> vega.NetworkParameter
	98,  // 86: vega.events.v1.BusEvent.liquidity_provision:type_name -> vega.LiquidityProvision
	92,  // 87: vega.events.v1.BusEvent.market_updated:type_name -> vega.Market
	99,  // 88: vega.events.v1.BusEvent.oracle_spec:type_name -> vega.OracleSpec
	100, // 89: vega.events.v1.BusEvent.oracle_data:type_name -> vega.OracleData
	22,  // 90: vega.events.v1.BusEvent.delegation_balance:type_name -> vega.events.v1.DelegationBalanceEvent
	21,  // 91: vega.events.v1.BusEvent.validator_score:type_name -> vega.events.v1.ValidatorScoreEvent
	27,  // 92: vega.events.v1.BusEvent.epoch_event:type_name -> vega.events.v1.EpochEvent
	40,  // 93: vega.events.v1.BusEvent.validator_update:type_name -> vega.events.v1.ValidatorUpdate
	15,  // 94: vega.events.v1.BusEvent.stake_linking:type_name -> vega.events.v1.StakeLinking
	20,  // 95: vega.events.v1.BusEvent.reward_payout:type_name -> vega.events.v1.RewardPayoutEvent
	18,  // 96: vega.events.v1.BusEvent.checkpoint:type_name -> vega.events.v1.CheckpointEvent
	42,  // 97: vega.events.v1.BusEvent.key_rotation:type_name -> vega.events.v1.KeyRotation
	45,  // 98: vega.events.v1.BusEvent.state_var:type_name -> vega.events.v1.StateVar
	101, // 99: vega.events.v1.BusEvent.network_limits:type_name -> vega.NetworkLimits
	10,  // 100: vega.events.v1.BusEvent.transfer:type_name -> vega.events.v1.Transfer
	41,  // 101: vega.events.v1.BusEvent.ranking_event:type_name -> vega.events.v1.ValidatorRankingEvent
	16,  // 102: vega.events.v1.BusEvent.erc20_multisig_signer_event:type_name -> vega.events.v1.ERC20MultiSigSignerEvent
	17,  // 103: vega.events.v1.BusEvent.erc20_multisig_set_threshold_event:type_name -> vega.events.v1.ERC20MultiSigThresholdSetEvent
	7,   // 104: vega.events.v1.BusEvent.erc20_multisig_signer_added:type_name -> vega.events.v1.ERC20MultiSigSignerAdded
	9,   // 105: vega.events.v1.BusEvent.erc20_multisig_signer_removed:type_name -> vega.events.v1.ERC20MultiSigSignerRemoved
	34,  // 106: vega.events.v1.BusEvent.position_state_event:type_name -> vega.events.v1.PositionStateEvent
	43,  // 107: vega.events.v1.BusEvent.ethereum_key_rotation:type_name -> vega.events.v1.EthereumKeyRotation
	44,  // 108: vega.events.v1.BusEvent.protocol_upgrade_event:type_name -> vega.events.v1.ProtocolUpgradeEvent
	46,  // 109: vega.events.v1.BusEvent.begin_block:type_name -> vega.events.v1.BeginBlock
	47,  // 110: vega.events.v1.BusEvent.end_block:type_name -> vega.events.v1.EndBlock
	48,  // 111: vega.events.v1.BusEvent.protocol_upgrade_started:type_name -> vega.events.v1.ProtocolUpgradeStarted
	33,  // 112: vega.events.v1.BusEvent.settle_market:type_name -> vega.events.v1.SettleMarket
	24,  // 113: vega.events.v1.BusEvent.transaction_result:type_name -> vega.events.v1.TransactionResult
	50,  // 114: vega.events.v1.BusEvent.core_snapshot_event:type_name -> vega.events.v1.CoreSnapshotData
	49,  // 115: vega.events.v1.BusEvent.protocol_upgrade_data_node_ready:type_name -> vega.events.v1.ProtocolUpgradeDataNodeReady
	36,  // 116: vega.events.v1.BusEvent.distressed_orders:type_name -> vega.events.v1.DistressedOrders
	52,  // 117: vega.events.v1.BusEvent.expired_orders:type_name -> vega.events.v1.ExpiredOrders
	37,  // 118: vega.events.v1.BusEvent.distressed_positions:type_name -> vega.events.v1.DistressedPositions
	6,   // 119: vega.events.v1.BusEvent.stop_order:type_name -> vega.events.v1.StopOrderEvent
	23,  // 120: vega.events.v1.BusEvent.market:type_name -> vega.events.v1.MarketEvent
	25,  // 121: vega.events.v1.BusEvent.tx_err_event:type_name -> vega.events.v1.TxErrorEvent
