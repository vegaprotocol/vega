Feature: Team Rewards
    ...
    @TeamStep
    Scenario: Given a recurring transfer scoping a single market and specifying a non-zero target_notional_volume. If that market's volume is greater than the target, no more than the full reward amount is distributed. (0056-REWA-207).
