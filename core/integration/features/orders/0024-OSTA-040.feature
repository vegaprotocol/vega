Feature: 0037-OPEG-020, 0037-OPEG-021
  ...
  Scenario: Given a mid-price which is not an integer multiple of the market tick size, a buy order pegged to the mid price should have it's price rounded up to the nearest market tick size
    ...
    And the parties place the following orders:
      ...
      | party3 | ETH/DEC21 | buy  | 100    | 1000  | 0                | TYPE_LIMIT | TIF_GTC | p3b1      |
      | party3 | ETH/DEC21 | buy  | 10     | 1100  | 0                | TYPE_LIMIT | TIF_GTC | p3b2      |
      | party4 | ETH/DEC21 | sell | 10     | 1100  | 0                | TYPE_LIMIT | TIF_GTC | p4s2      |
      | party4 | ETH/DEC21 | sell | 1000   | 1900  | 0                | TYPE_LIMIT | TIF_GTC | p4s1      |

    Then the network moves ahead "2" blocks
    And the trading mode should be "TRADING_MODE_CONTINUOUS" for the market "ETH/DEC21"
    Then the market data for the market "ETH/DEC21" should be:
      | mark price | trading mode            | horizon | min bound | max bound | target stake | supplied stake | open interest |
      | 1100       | TRADING_MODE_CONTINUOUS | 3600    | 1050      | 1159      | 1100         | 10000          | 10            |
    ...
    When the parties place the following orders:
      ...
      | party3 | ETH/DEC21 | buy  | 1      | 1160  | 0                | TYPE_LIMIT | TIF_GTC |
      | party4 | ETH/DEC21 | sell | 1      | 1160  | 0                | TYPE_LIMIT | TIF_GTC |
    ...
    When the parties place the following orders:
      ...
      | party3 | ETH/DEC21 | buy  | 1      | 1160  | 0                | TYPE_LIMIT | TIF_IOC | ioc order received during auction trading |
      | party3 | ETH/DEC21 | buy  | 1      | 1160  | 0                | TYPE_LIMIT | TIF_FOK | fok order received during auction trading |
      | party3 | ETH/DEC21 | buy  | 1      | 1160  | 0                | TYPE_LIMIT | TIF_GFN | gfn order received during auction trading |
