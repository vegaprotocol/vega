Feature: Test setting of mark price
  Background:
    ...
    And the markets:
      ...
      | ETH/FEB22 | ETH        | USD   | lqm-params           | simple-risk-model | default-margin-calculator | 1                | default-none | default-none     | default-eth-for-future | 0.25                   | 0                         | default-futures | weight     | 1            | 1           | 0           | 1,0,0,0        | 3h0m0s,2s,24h0m0s,1h25m0s  |
  ...
  Scenario: 001 check mark price using weight average
    ...
    And the parties place the following orders:
      ...
      | sellSideProvider1 | ETH/FEB22 | sell | 2      | 16000  | 0                | TYPE_LIMIT | TIF_GTC | sell-7    |
      | sellSideProvider1 | ETH/FEB22 | sell | 4      | 16020  | 0                | TYPE_LIMIT | TIF_GTC | sell-8    |
    ...
    Then the mark price should be "15978" for the market "ETH/FEB22"
