...
var file_data_node_api_v2_trading_data_proto_rawDesc = []byte{
	...
	0x74, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x2a, 0xb0, 0x01, 0x0a, 0x0c, 0x41, 0x63,
	...
	0x54, 0x4f, 0x5f, 0x4f, 0x52, 0x5f, 0x46, 0x52, 0x4f, 0x4d, 0x10, 0x03, 0x32, 0xd3, 0x3c, 0x0a,
...
var file_data_node_api_v2_trading_data_proto_goTypes = []interface{}{
	...
	(vega.Side)(0),                                       // 266: vega.Side
	(vega.Order_Type)(0),                                 // 267: vega.Order.Type
	(*vega.NetworkParameter)(nil),                        // 268: vega.NetworkParameter
	(*v1.StakeLinking)(nil),                              // 269: vega.events.v1.StakeLinking
	(*vega.RiskFactor)(nil),                              // 270: vega.RiskFactor
	(v1.BusEventType)(0),                                 // 271: vega.events.v1.BusEventType
	(*v1.BusEvent)(nil),                                  // 272: vega.events.v1.BusEvent
	(*vega.LedgerMovement)(nil),                          // 273: vega.LedgerMovement
	(*v1.KeyRotation)(nil),                               // 274: vega.events.v1.KeyRotation
	(*v1.EthereumKeyRotation)(nil),                       // 275: vega.events.v1.EthereumKeyRotation
}
var file_data_node_api_v2_trading_data_proto_depIdxs = []int32{
	...
	265, // 190: datanode.api.v2.EstimateFeeResponse.fee:type_name -> vega.Fee
	266, // 191: datanode.api.v2.EstimateMarginRequest.side:type_name -> vega.Side
	267, // 192: datanode.api.v2.EstimateMarginRequest.type:type_name -> vega.Order.Type
	...
	268, // 196: datanode.api.v2.GetNetworkParameterResponse.network_parameter:type_name -> vega.NetworkParameter
	268, // 197: datanode.api.v2.NetworkParameterEdge.node:type_name -> vega.NetworkParameter
	...
	269, // 207: datanode.api.v2.StakeLinkingEdge.node:type_name -> vega.events.v1.StakeLinking
	...
	270, // 210: datanode.api.v2.GetRiskFactorsResponse.risk_factor:type_name -> vega.RiskFactor
	271, // 211: datanode.api.v2.ObserveEventBusRequest.type:type_name -> vega.events.v1.BusEventType
	272, // 212: datanode.api.v2.ObserveEventBusResponse.events:type_name -> vega.events.v1.BusEvent
	273, // 213: datanode.api.v2.ObserveLedgerMovementsResponse.ledger_movement:type_name -> vega.LedgerMovement
	...
	274, // 216: datanode.api.v2.KeyRotationEdge.node:type_name -> vega.events.v1.KeyRotation
	...
	275, // 223: datanode.api.v2.EthereumKeyRotationEdge.ethereum_key_rotation:type_name -> vega.events.v1.EthereumKeyRotation
