...
//go:generate go run github.com/golang/mock/mockgen -destination mocks/risk_factor_mock.go -package mocks code.vegaprotocol.io/vega/datanode/sqlsubscribers RiskFactorStore
