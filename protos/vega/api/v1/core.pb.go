...
type Statistics struct {
	...
	// Epoch start time
	EpochStartTime int64 `protobuf:"varint,37,opt,name=epoch_start_time,json=epochStartTime,proto3" json:"epoch_start_time,omitempty"`
	// Epoch expirty time
	EpochExpiryTime int64 `protobuf:"varint,38,opt,name=epoch_expiry_time,json=epochExpiryTime,proto3" json:"epoch_expiry_time,omitempty"`
}
...
func (x *Statistics) GetEpochStartTime() int64 {
	if x != nil {
...
func (x *Statistics) GetEpochExpiryTime() int64 {
	if x != nil {
...
var file_vega_api_v1_core_proto_rawDesc = []byte{
	...
	0x18, 0x25, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0e, 0x65, 0x70, 0x6f, 0x63, 0x68, 0x53, 0x74, 0x61,
	...
	0x03, 0x52, 0x0f, 0x65, 0x70, 0x6f, 0x63, 0x68, 0x45, 0x78, 0x70, 0x69, 0x72, 0x79, 0x54, 0x69,
	...
	0x2e, 0x35, 0x39, 0x2e, 0x30, 0x2b, 0x64, 0x65, 0x76, 0x1a, 0x13, 0x6c, 0x62, 0x2e, 0x74, 0x65,
