Feature: Price monitoring test using forward risk model (bounds for the price moves around price of 100 for the two horizons are roughly: (-0.6,0.6), (-1.1,1.1))
