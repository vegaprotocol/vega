...
func (m *Market) SubmitLiquidityProvision(ctx context.Context, sub *commandspb.LiquidityProvisionSubmission, party, id string) (err error) {
	...
	newOrders, cancels, err := m.liquidity.CreateInitialOrders(ctx, midPriceBid, midPriceAsk, party, existingOrders, m.repriceFuncW)
	if err != nil {
...
func (m *Market) liquidityUpdate(ctx context.Context, orders []*types.Order) error {
	...
	timer.EngineTimeCounterAdd()
	return m.updateAndCreateOrders(ctx, newOrders, cancels)
}
