...
type ScheduledTransferInstruction struct {
	...
	TransferInstruction       *vega.TransferInstruction `protobuf:"bytes,1,opt,name=transfer_instruction,json=transferInstruction,proto3" json:"transfer_instruction,omitempty"`
	...
	OneoffTransferInstruction *v1.TransferInstruction   `protobuf:"bytes,4,opt,name=oneoff_transfer_instruction,json=oneoffTransferInstruction,proto3" json:"oneoff_transfer_instruction,omitempty"`
}

func (x *ScheduledTransferInstruction) Reset() {
	*x = ScheduledTransferInstruction{}
	if protoimpl.UnsafeEnabled {
...
func (x *ScheduledTransferInstruction) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ScheduledTransferInstruction) ProtoMessage() {}

func (x *ScheduledTransferInstruction) ProtoReflect() protoreflect.Message {
	mi := &file_vega_checkpoint_v1_checkpoint_proto_msgTypes[17]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ScheduledTransferInstruction.ProtoReflect.Descriptor instead.
func (*ScheduledTransferInstruction) Descriptor() ([]byte, []int) {
	return file_vega_checkpoint_v1_checkpoint_proto_rawDescGZIP(), []int{17}
}

func (x *ScheduledTransferInstruction) GetTransferInstruction() *vega.TransferInstruction {
	if x != nil {
...
func (x *ScheduledTransferInstruction) GetAccountType() vega.AccountType {
	if x != nil {
...
func (x *ScheduledTransferInstruction) GetReference() string {
	if x != nil {
		return x.Reference
	}
	return ""
...
func (x *ScheduledTransferInstruction) GetOneoffTransferInstruction() *v1.TransferInstruction {
	if x != nil {
		return x.OneoffTransferInstruction
	}
	return nil
}

type ScheduledTransferInstructionAtTime struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	DeliverOn            int64                           `protobuf:"varint,1,opt,name=deliver_on,json=deliverOn,proto3" json:"deliver_on,omitempty"`
	TransferInstructions []*ScheduledTransferInstruction `protobuf:"bytes,2,rep,name=transfer_instructions,json=transferInstructions,proto3" json:"transfer_instructions,omitempty"`
}

func (x *ScheduledTransferInstructionAtTime) Reset() {
	*x = ScheduledTransferInstructionAtTime{}
	if protoimpl.UnsafeEnabled {
...
func (x *ScheduledTransferInstructionAtTime) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ScheduledTransferInstructionAtTime) ProtoMessage() {}

func (x *ScheduledTransferInstructionAtTime) ProtoReflect() protoreflect.Message {
	mi := &file_vega_checkpoint_v1_checkpoint_proto_msgTypes[18]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ScheduledTransferInstructionAtTime.ProtoReflect.Descriptor instead.
func (*ScheduledTransferInstructionAtTime) Descriptor() ([]byte, []int) {
	return file_vega_checkpoint_v1_checkpoint_proto_rawDescGZIP(), []int{18}
}

func (x *ScheduledTransferInstructionAtTime) GetDeliverOn() int64 {
	if x != nil {
		return x.DeliverOn
	}
	return 0
...
func (x *ScheduledTransferInstructionAtTime) GetTransferInstructions() []*ScheduledTransferInstruction {
	if x != nil {
...
type RecurringTransferInstructions struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	RecurringTransferInstructions []*v1.TransferInstruction `protobuf:"bytes,1,rep,name=recurring_transfer_instructions,json=recurringTransferInstructions,proto3" json:"recurring_transfer_instructions,omitempty"`
}

func (x *RecurringTransferInstructions) Reset() {
	*x = RecurringTransferInstructions{}
	if protoimpl.UnsafeEnabled {
...
func (x *RecurringTransferInstructions) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RecurringTransferInstructions) ProtoMessage() {}

func (x *RecurringTransferInstructions) ProtoReflect() protoreflect.Message {
	mi := &file_vega_checkpoint_v1_checkpoint_proto_msgTypes[19]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RecurringTransferInstructions.ProtoReflect.Descriptor instead.
func (*RecurringTransferInstructions) Descriptor() ([]byte, []int) {
	return file_vega_checkpoint_v1_checkpoint_proto_rawDescGZIP(), []int{19}
}

func (x *RecurringTransferInstructions) GetRecurringTransferInstructions() []*v1.TransferInstruction {
	if x != nil {
		return x.RecurringTransferInstructions
	}
	return nil
}
...
type Banking struct {
	...
	TransferInstructionsAtTime    []*ScheduledTransferInstructionAtTime `protobuf:"bytes,1,rep,name=transfer_instructions_at_time,json=transferInstructionsAtTime,proto3" json:"transfer_instructions_at_time,omitempty"`
	RecurringTransferInstructions *RecurringTransferInstructions        `protobuf:"bytes,2,opt,name=recurring_transfer_instructions,json=recurringTransferInstructions,proto3" json:"recurring_transfer_instructions,omitempty"`
...
func (x *Banking) GetTransferInstructionsAtTime() []*ScheduledTransferInstructionAtTime {
	if x != nil {
...
func (x *Banking) GetRecurringTransferInstructions() *RecurringTransferInstructions {
	if x != nil {
		return x.RecurringTransferInstructions
	}
	return nil
...
var file_vega_checkpoint_v1_checkpoint_proto_rawDesc = []byte{
	...
	,
	...
	0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x61, 0x73, 0x73, 0x65, 0x74, 0x12, 0x18, 0x0a, 0x07,
	0x62, 0x61, 0x6c, 0x61, 0x6e, 0x63, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x62,
	0x61, 0x6c, 0x61, 0x6e, 0x63, 0x65, 0x22, 0x4a, 0x0a, 0x0a, 0x43, 0x6f, 0x6c, 0x6c, 0x61, 0x74,
	0x65, 0x72, 0x61, 0x6c, 0x12, 0x3c, 0x0a, 0x08, 0x62, 0x61, 0x6c, 0x61, 0x6e, 0x63, 0x65, 0x73,
	0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x20, 0x2e, 0x76, 0x65, 0x67, 0x61, 0x2e, 0x63, 0x68,
	...
	0x65, 0x73, 0x22, 0x3b, 0x0a, 0x09, 0x4e, 0x65, 0x74, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x12,
	...
	0x39, 0x0a, 0x09, 0x50, 0x72, 0x6f, 0x70, 0x6f, 0x73, 0x61, 0x6c, 0x73, 0x12, 0x2c, 0x0a, 0x09,
	...
	,
	...
	,
	...
	0x6d, 0x65, 0x12, 0x4e, 0x0a, 0x0e, 0x72, 0x65, 0x77, 0x61, 0x72, 0x64, 0x73, 0x5f, 0x70, 0x61,
	0x79, 0x6f, 0x75, 0x74, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x27, 0x2e, 0x76, 0x65, 0x67,
	0x61, 0x2e, 0x63, 0x68, 0x65, 0x63, 0x6b, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x2e, 0x76, 0x31, 0x2e,
	...
	0x75, 0x74, 0x22, 0xf0, 0x01, 0x0a, 0x13, 0x50, 0x65, 0x6e, 0x64, 0x69, 0x6e, 0x67, 0x52, 0x65,
	0x77, 0x61, 0x72, 0x64, 0x50, 0x61, 0x79, 0x6f, 0x75, 0x74, 0x12, 0x21, 0x0a, 0x0c, 0x66, 0x72,
	...
	0x73, 0x65, 0x74, 0x12, 0x42, 0x0a, 0x0c, 0x70, 0x61, 0x72, 0x74, 0x79, 0x5f, 0x61, 0x6d, 0x6f,
	0x75, 0x6e, 0x74, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1f, 0x2e, 0x76, 0x65, 0x67, 0x61,
	0x2e, 0x63, 0x68, 0x65, 0x63, 0x6b, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x2e, 0x76, 0x31, 0x2e, 0x50,
	0x61, 0x72, 0x74, 0x79, 0x41, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x52, 0x0b, 0x70, 0x61, 0x72, 0x74,
	...
	0x73, 0x74, 0x61, 0x6d, 0x70, 0x22, 0x3b, 0x0a, 0x0b, 0x50, 0x61, 0x72, 0x74, 0x79, 0x41, 0x6d,
	...
	0x6e, 0x74, 0x22, 0xb9, 0x01, 0x0a, 0x12, 0x50, 0x65, 0x6e, 0x64, 0x69, 0x6e, 0x67, 0x4b, 0x65,
	0x79, 0x52, 0x6f, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x3f, 0x0a, 0x1c, 0x72, 0x65, 0x6c,
	0x61, 0x74, 0x69, 0x76, 0x65, 0x5f, 0x74, 0x61, 0x72, 0x67, 0x65, 0x74, 0x5f, 0x62, 0x6c, 0x6f,
	0x63, 0x6b, 0x5f, 0x68, 0x65, 0x69, 0x67, 0x68, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x04, 0x52,
	0x19, 0x72, 0x65, 0x6c, 0x61, 0x74, 0x69, 0x76, 0x65, 0x54, 0x61, 0x72, 0x67, 0x65, 0x74, 0x42,
	...
	0x6e, 0x65, 0x77, 0x50, 0x75, 0x62, 0x4b, 0x65, 0x79, 0x49, 0x6e, 0x64, 0x65, 0x78, 0x22, 0x97,
	0x01, 0x0a, 0x1a, 0x50, 0x65, 0x6e, 0x64, 0x69, 0x6e, 0x67, 0x45, 0x74, 0x68, 0x65, 0x72, 0x65,
	0x75, 0x6d, 0x4b, 0x65, 0x79, 0x52, 0x6f, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x3f, 0x0a,
	0x1c, 0x72, 0x65, 0x6c, 0x61, 0x74, 0x69, 0x76, 0x65, 0x5f, 0x74, 0x61, 0x72, 0x67, 0x65, 0x74,
	0x5f, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x5f, 0x68, 0x65, 0x69, 0x67, 0x68, 0x74, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x04, 0x52, 0x19, 0x72, 0x65, 0x6c, 0x61, 0x74, 0x69, 0x76, 0x65, 0x54, 0x61, 0x72,
	0x67, 0x65, 0x74, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x48, 0x65, 0x69, 0x67, 0x68, 0x74, 0x12, 0x17,
	...
	,
	...
	0x52, 0x0b, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x54, 0x79, 0x70, 0x65, 0x12, 0x1c, 0x0a,
	0x09, 0x72, 0x65, 0x66, 0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x09, 0x72, 0x65, 0x66, 0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x12, 0x63, 0x0a, 0x1b, 0x6f,
	0x6e, 0x65, 0x6f, 0x66, 0x66, 0x5f, 0x74, 0x72, 0x61, 0x6e, 0x73, 0x66, 0x65, 0x72, 0x5f, 0x69,
	...
	,
	...
	,
	...
	0x66, 0x65, 0x72, 0x49, 0x6e, 0x73, 0x74, 0x72, 0x75, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x52,
	0x1d, 0x72, 0x65, 0x63, 0x75, 0x72, 0x72, 0x69, 0x6e, 0x67, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x66,
	0x65, 0x72, 0x49, 0x6e, 0x73, 0x74, 0x72, 0x75, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x12, 0x42,
	0x0a, 0x0c, 0x62, 0x72, 0x69, 0x64, 0x67, 0x65, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x65, 0x18, 0x03,
	...
	0x74, 0x65, 0x22, 0x65, 0x0a, 0x0b, 0x42, 0x72, 0x69, 0x64, 0x67, 0x65, 0x53, 0x74, 0x61, 0x74,
	0x65, 0x12, 0x16, 0x0a, 0x06, 0x61, 0x63, 0x74, 0x69, 0x76, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x08, 0x52, 0x06, 0x61, 0x63, 0x74, 0x69, 0x76, 0x65, 0x12, 0x21, 0x0a, 0x0c, 0x62, 0x6c, 0x6f,
	...
	,
	...
	0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x22, 0x88, 0x02, 0x0a, 0x0e, 0x56, 0x61, 0x6c, 0x69, 0x64,
	...
	0x02, 0x20, 0x01, 0x28, 0x05, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x30, 0x0a,
	0x14, 0x65, 0x74, 0x68, 0x5f, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x73, 0x5f, 0x66, 0x6f, 0x72, 0x77,
	0x61, 0x72, 0x64, 0x65, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x04, 0x52, 0x12, 0x65, 0x74, 0x68,
	...
	0x69, 0x6e, 0x67, 0x5f, 0x73, 0x63, 0x6f, 0x72, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32,
	...
	0x65, 0x22, 0x6b, 0x0a, 0x07, 0x53, 0x74, 0x61, 0x6b, 0x69, 0x6e, 0x67, 0x12, 0x38, 0x0a, 0x08,
	...
	0x65, 0x65, 0x6e, 0x22, 0x63, 0x0a, 0x0d, 0x4d, 0x61, 0x72, 0x6b, 0x65, 0x74, 0x54, 0x72, 0x61,
	...
	0x41, 0x63, 0x74, 0x69, 0x76, 0x69, 0x74, 0x79, 0x22, 0x99, 0x03, 0x0a, 0x15, 0x4d, 0x61, 0x72,
	...
	,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x66, 0x65, 0x65, 0x42, 0x35, 0x5a, 0x33, 0x63, 0x6f, 0x64,
...
var file_vega_checkpoint_v1_checkpoint_proto_msgTypes = make([]protoimpl.MessageInfo, 29)
var file_vega_checkpoint_v1_checkpoint_proto_goTypes = []interface{}{
	...
	(*ScheduledTransferInstruction)(nil),       // 17: vega.checkpoint.v1.ScheduledTransferInstruction
	(*ScheduledTransferInstructionAtTime)(nil), // 18: vega.checkpoint.v1.ScheduledTransferInstructionAtTime
	(*RecurringTransferInstructions)(nil),      // 19: vega.checkpoint.v1.RecurringTransferInstructions
	(*Banking)(nil),                            // 20: vega.checkpoint.v1.Banking
	(*BridgeState)(nil),                        // 21: vega.checkpoint.v1.BridgeState
	(*Validators)(nil),                         // 22: vega.checkpoint.v1.Validators
	(*ValidatorState)(nil),                     // 23: vega.checkpoint.v1.ValidatorState
	(*Staking)(nil),                            // 24: vega.checkpoint.v1.Staking
	(*MultisigControl)(nil),                    // 25: vega.checkpoint.v1.MultisigControl
	(*MarketTracker)(nil),                      // 26: vega.checkpoint.v1.MarketTracker
	(*MarketActivityTracker)(nil),              // 27: vega.checkpoint.v1.MarketActivityTracker
	(*PartyFees)(nil),                          // 28: vega.checkpoint.v1.PartyFees
	(*vega.AssetDetails)(nil),                  // 29: vega.AssetDetails
	(*vega.NetworkParameter)(nil),              // 30: vega.NetworkParameter
	(*vega.Proposal)(nil),                      // 31: vega.Proposal
	(*vega.TransferInstruction)(nil),           // 32: vega.TransferInstruction
	(vega.AccountType)(0),                      // 33: vega.AccountType
	(*v1.TransferInstruction)(nil),             // 34: vega.events.v1.TransferInstruction
	(*v1.ValidatorUpdate)(nil),                 // 35: vega.events.v1.ValidatorUpdate
	(*vega.RankingScore)(nil),                  // 36: vega.RankingScore
	(*v1.StakeLinking)(nil),                    // 37: vega.events.v1.StakeLinking
	(*v1.ERC20MultiSigSignerEvent)(nil),        // 38: vega.events.v1.ERC20MultiSigSignerEvent
	(*v1.ERC20MultiSigThresholdSetEvent)(nil),  // 39: vega.events.v1.ERC20MultiSigThresholdSetEvent
}
var file_vega_checkpoint_v1_checkpoint_proto_depIdxs = []int32{
	29, // 0: vega.checkpoint.v1.AssetEntry.asset_details:type_name -> vega.AssetDetails
	...
	30, // 4: vega.checkpoint.v1.NetParams.params:type_name -> vega.NetworkParameter
	31, // 5: vega.checkpoint.v1.Proposals.proposals:type_name -> vega.Proposal
	...
	32, // 11: vega.checkpoint.v1.ScheduledTransferInstruction.transfer_instruction:type_name -> vega.TransferInstruction
	33, // 12: vega.checkpoint.v1.ScheduledTransferInstruction.account_type:type_name -> vega.AccountType
	34, // 13: vega.checkpoint.v1.ScheduledTransferInstruction.oneoff_transfer_instruction:type_name -> vega.events.v1.TransferInstruction
	17, // 14: vega.checkpoint.v1.ScheduledTransferInstructionAtTime.transfer_instructions:type_name -> vega.checkpoint.v1.ScheduledTransferInstruction
	34, // 15: vega.checkpoint.v1.RecurringTransferInstructions.recurring_transfer_instructions:type_name -> vega.events.v1.TransferInstruction
	18, // 16: vega.checkpoint.v1.Banking.transfer_instructions_at_time:type_name -> vega.checkpoint.v1.ScheduledTransferInstructionAtTime
	19, // 17: vega.checkpoint.v1.Banking.recurring_transfer_instructions:type_name -> vega.checkpoint.v1.RecurringTransferInstructions
	21, // 18: vega.checkpoint.v1.Banking.bridge_state:type_name -> vega.checkpoint.v1.BridgeState
	23, // 19: vega.checkpoint.v1.Validators.validator_state:type_name -> vega.checkpoint.v1.ValidatorState
	15, // 20: vega.checkpoint.v1.Validators.pending_key_rotations:type_name -> vega.checkpoint.v1.PendingKeyRotation
	16, // 21: vega.checkpoint.v1.Validators.pending_ethereum_key_rotations:type_name -> vega.checkpoint.v1.PendingEthereumKeyRotation
	35, // 22: vega.checkpoint.v1.ValidatorState.validator_update:type_name -> vega.events.v1.ValidatorUpdate
	36, // 23: vega.checkpoint.v1.ValidatorState.ranking_score:type_name -> vega.RankingScore
	37, // 24: vega.checkpoint.v1.Staking.accepted:type_name -> vega.events.v1.StakeLinking
	38, // 25: vega.checkpoint.v1.MultisigControl.signers:type_name -> vega.events.v1.ERC20MultiSigSignerEvent
	39, // 26: vega.checkpoint.v1.MultisigControl.threshold_set:type_name -> vega.events.v1.ERC20MultiSigThresholdSetEvent
	27, // 27: vega.checkpoint.v1.MarketTracker.market_activity:type_name -> vega.checkpoint.v1.MarketActivityTracker
	28, // 28: vega.checkpoint.v1.MarketActivityTracker.maker_fees_received:type_name -> vega.checkpoint.v1.PartyFees
	28, // 29: vega.checkpoint.v1.MarketActivityTracker.maker_fees_paid:type_name -> vega.checkpoint.v1.PartyFees
	28, // 30: vega.checkpoint.v1.MarketActivityTracker.lp_fees:type_name -> vega.checkpoint.v1.PartyFees
...
func file_vega_checkpoint_v1_checkpoint_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_vega_checkpoint_v1_checkpoint_proto_msgTypes[17].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ScheduledTransferInstruction); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_vega_checkpoint_v1_checkpoint_proto_msgTypes[18].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ScheduledTransferInstructionAtTime); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_vega_checkpoint_v1_checkpoint_proto_msgTypes[19].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*RecurringTransferInstructions); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
