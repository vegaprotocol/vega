...
type VoteSpamStatistic struct {
	...
	MaxForEpoch uint64 `protobuf:"varint,3,opt,name=max_for_epoch,json=maxForEpoch,proto3" json:"max_for_epoch,omitempty"`
}
...
func (x *VoteSpamStatistic) GetMaxForEpoch() uint64 {
	if x != nil {
		return x.MaxForEpoch
	}
	return 0
...
type PoWBlockState struct {
	...
	// The effective minimum difficulty required for the block if
	// increasing difficulty is required
	EffectiveMinimumDifficulty *uint64 `protobuf:"varint,4,opt,name=effective_minimum_difficulty,json=effectiveMinimumDifficulty,proto3,oneof" json:"effective_minimum_difficulty,omitempty"`
	...
	ExpectedDifficulty *uint64 `protobuf:"varint,5,opt,name=expected_difficulty,json=expectedDifficulty,proto3,oneof" json:"expected_difficulty,omitempty"`
	// The hashing function used to calculate the block hash
	HashFunction string `protobuf:"bytes,6,opt,name=hash_function,json=hashFunction,proto3" json:"hash_function,omitempty"`
}
...
func (x *PoWBlockState) GetEffectiveMinimumDifficulty() uint64 {
	if x != nil && x.EffectiveMinimumDifficulty != nil {
		return *x.EffectiveMinimumDifficulty
	}
	return 0
}
...
type GetSpamStatisticsResponse struct {
	...
	Statistics *SpamStatistics `protobuf:"bytes,1,opt,name=statistics,proto3" json:"statistics,omitempty"`
}
...
var file_vega_api_v1_core_proto_rawDesc = []byte{
	...
	0x61, 0x74, 0x69, 0x73, 0x74, 0x69, 0x63, 0x73, 0x22, 0xfb, 0x0b, 0x0a, 0x0a, 0x53, 0x74, 0x61,
	...
	0x72, 0x79, 0x54, 0x69, 0x6d, 0x65, 0x22, 0x18, 0x0a, 0x16, 0x4c, 0x61, 0x73, 0x74, 0x42, 0x6c,
	0x6f, 0x63, 0x6b, 0x48, 0x65, 0x69, 0x67, 0x68, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	0x22, 0x91, 0x03, 0x0a, 0x17, 0x4c, 0x61, 0x73, 0x74, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x48, 0x65,
	...
	0x28, 0x09, 0x52, 0x04, 0x68, 0x61, 0x73, 0x68, 0x12, 0x33, 0x0a, 0x16, 0x73, 0x70, 0x61, 0x6d,
	...
	0x77, 0x48, 0x61, 0x73, 0x68, 0x46, 0x75, 0x6e, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x2e, 0x0a,
	0x13, 0x73, 0x70, 0x61, 0x6d, 0x5f, 0x70, 0x6f, 0x77, 0x5f, 0x64, 0x69, 0x66, 0x66, 0x69, 0x63,
	0x75, 0x6c, 0x74, 0x79, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x11, 0x73, 0x70, 0x61, 0x6d,
	0x50, 0x6f, 0x77, 0x44, 0x69, 0x66, 0x66, 0x69, 0x63, 0x75, 0x6c, 0x74, 0x79, 0x12, 0x41, 0x0a,
	...
	0x05, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x19, 0x73, 0x70, 0x61, 0x6d, 0x50, 0x6f, 0x77, 0x4e, 0x75,
	...
	0x6f, 0x63, 0x6b, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x19, 0x73, 0x70, 0x61, 0x6d, 0x50,
	...
	0x69, 0x63, 0x75, 0x6c, 0x74, 0x79, 0x18, 0x07, 0x20, 0x01, 0x28, 0x08, 0x52, 0x1b, 0x73, 0x70,
	0x61, 0x6d, 0x50, 0x6f, 0x77, 0x49, 0x6e, 0x63, 0x72, 0x65, 0x61, 0x73, 0x69, 0x6e, 0x67, 0x44,
	0x69, 0x66, 0x66, 0x69, 0x63, 0x75, 0x6c, 0x74, 0x79, 0x12, 0x19, 0x0a, 0x08, 0x63, 0x68, 0x61,
	0x69, 0x6e, 0x5f, 0x69, 0x64, 0x18, 0x08, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x63, 0x68, 0x61,
	0x69, 0x6e, 0x49, 0x64, 0x22, 0x35, 0x0a, 0x18, 0x47, 0x65, 0x74, 0x53, 0x70, 0x61, 0x6d, 0x53,
	...
	,
	...
	,
	...
	,
	...
	0x6e, 0x74, 0x69, 0x6c, 0x22, 0xf1, 0x02, 0x0a, 0x0e, 0x53, 0x70, 0x61, 0x6d, 0x53, 0x74, 0x61,
	...
	0x74, 0x69, 0x63, 0x52, 0x03, 0x70, 0x6f, 0x77, 0x22, 0x58, 0x0a, 0x19, 0x47, 0x65, 0x74, 0x53,
	0x70, 0x61, 0x6d, 0x53, 0x74, 0x61, 0x74, 0x69, 0x73, 0x74, 0x69, 0x63, 0x73, 0x52, 0x65, 0x73,
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x3b, 0x0a, 0x0a, 0x73, 0x74, 0x61, 0x74, 0x69, 0x73, 0x74,
	0x69, 0x63, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1b, 0x2e, 0x76, 0x65, 0x67, 0x61,
...
var file_vega_api_v1_core_proto_depIdxs = []int32{
	...
	27, // 16: vega.api.v1.GetSpamStatisticsResponse.statistics:type_name -> vega.api.v1.SpamStatistics
	4,  // 17: vega.api.v1.CoreService.SubmitTransaction:input_type -> vega.api.v1.SubmitTransactionRequest
	2,  // 18: vega.api.v1.CoreService.PropagateChainEvent:input_type -> vega.api.v1.PropagateChainEventRequest
	16, // 19: vega.api.v1.CoreService.Statistics:input_type -> vega.api.v1.StatisticsRequest
	19, // 20: vega.api.v1.CoreService.LastBlockHeight:input_type -> vega.api.v1.LastBlockHeightRequest
	12, // 21: vega.api.v1.CoreService.GetVegaTime:input_type -> vega.api.v1.GetVegaTimeRequest
	14, // 22: vega.api.v1.CoreService.ObserveEventBus:input_type -> vega.api.v1.ObserveEventBusRequest
	8,  // 23: vega.api.v1.CoreService.SubmitRawTransaction:input_type -> vega.api.v1.SubmitRawTransactionRequest
	6,  // 24: vega.api.v1.CoreService.CheckTransaction:input_type -> vega.api.v1.CheckTransactionRequest
	10, // 25: vega.api.v1.CoreService.CheckRawTransaction:input_type -> vega.api.v1.CheckRawTransactionRequest
	21, // 26: vega.api.v1.CoreService.GetSpamStatistics:input_type -> vega.api.v1.GetSpamStatisticsRequest
	5,  // 27: vega.api.v1.CoreService.SubmitTransaction:output_type -> vega.api.v1.SubmitTransactionResponse
	3,  // 28: vega.api.v1.CoreService.PropagateChainEvent:output_type -> vega.api.v1.PropagateChainEventResponse
	17, // 29: vega.api.v1.CoreService.Statistics:output_type -> vega.api.v1.StatisticsResponse
	20, // 30: vega.api.v1.CoreService.LastBlockHeight:output_type -> vega.api.v1.LastBlockHeightResponse
	13, // 31: vega.api.v1.CoreService.GetVegaTime:output_type -> vega.api.v1.GetVegaTimeResponse
	15, // 32: vega.api.v1.CoreService.ObserveEventBus:output_type -> vega.api.v1.ObserveEventBusResponse
	9,  // 33: vega.api.v1.CoreService.SubmitRawTransaction:output_type -> vega.api.v1.SubmitRawTransactionResponse
	7,  // 34: vega.api.v1.CoreService.CheckTransaction:output_type -> vega.api.v1.CheckTransactionResponse
	11, // 35: vega.api.v1.CoreService.CheckRawTransaction:output_type -> vega.api.v1.CheckRawTransactionResponse
	28, // 36: vega.api.v1.CoreService.GetSpamStatistics:output_type -> vega.api.v1.GetSpamStatisticsResponse
