...
var file_vega_snapshot_v1_snapshot_proto_rawDesc = []byte{
	...
	0x66, 0x22, 0xa1, 0x28, 0x0a, 0x07, 0x50, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x12, 0x45, 0x0a,
	...
	0x66, 0x69, 0x65, 0x72, 0x4c, 0x61, 0x73, 0x74, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x42, 0x06, 0x0a,
	...
	0x6c, 0x74, 0x22, 0x8a, 0x01, 0x0a, 0x15, 0x45, 0x74, 0x68, 0x43, 0x6f, 0x6e, 0x74, 0x72, 0x61,
	...
	0x79, 0x49, 0x64, 0x22, 0xb9, 0x01, 0x0a, 0x16, 0x46, 0x6c, 0x6f, 0x61, 0x74, 0x69, 0x6e, 0x67,
	...
	0x22, 0x63, 0x0a, 0x0d, 0x4d, 0x61, 0x72, 0x6b, 0x65, 0x74, 0x54, 0x72, 0x61, 0x63, 0x6b, 0x65,
	0x72, 0x12, 0x52, 0x0a, 0x0f, 0x6d, 0x61, 0x72, 0x6b, 0x65, 0x74, 0x5f, 0x61, 0x63, 0x74, 0x69,
	0x76, 0x69, 0x74, 0x79, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x29, 0x2e, 0x76, 0x65, 0x67,
	0x61, 0x2e, 0x63, 0x68, 0x65, 0x63, 0x6b, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x2e, 0x76, 0x31, 0x2e,
	0x4d, 0x61, 0x72, 0x6b, 0x65, 0x74, 0x41, 0x63, 0x74, 0x69, 0x76, 0x69, 0x74, 0x79, 0x54, 0x72,
	0x61, 0x63, 0x6b, 0x65, 0x72, 0x52, 0x0e, 0x6d, 0x61, 0x72, 0x6b, 0x65, 0x74, 0x41, 0x63, 0x74,
	0x69, 0x76, 0x69, 0x74, 0x79, 0x22, 0x74, 0x0a, 0x16, 0x53, 0x69, 0x67, 0x6e, 0x65, 0x72, 0x45,
	...
	0x54, 0x68, 0x72, 0x65, 0x73, 0x68, 0x6f, 0x6c, 0x64, 0x53, 0x65, 0x74, 0x73, 0x22, 0xa1, 0x03,
	...
	0x65, 0x22, 0x39, 0x0a, 0x0b, 0x42, 0x61, 0x6e, 0x6e, 0x65, 0x64, 0x50, 0x61, 0x72, 0x74, 0x79,
	...
	0x73, 0x65, 0x54, 0x61, 0x67, 0x2a, 0x60, 0x0a, 0x06, 0x46, 0x6f, 0x72, 0x6d, 0x61, 0x74, 0x12,
...
var file_vega_snapshot_v1_snapshot_proto_goTypes = []interface{}{
	...
	(*EthOracleVerifierLastBlock)(nil),            // 94: vega.snapshot.v1.EthOracleVerifierLastBlock
	...
	(*v1.Property)(nil),                           // 133: vega.data.v1.Property
	(*vega.Account)(nil),                          // 134: vega.Account
	(*vega.Asset)(nil),                            // 135: vega.Asset
	(*vega.Withdrawal)(nil),                       // 136: vega.Withdrawal
	(*vega.Deposit)(nil),                          // 137: vega.Deposit
	(*v11.AssetAction)(nil),                       // 138: vega.checkpoint.v1.AssetAction
	(*v11.RecurringTransfers)(nil),                // 139: vega.checkpoint.v1.RecurringTransfers
	(*v11.ScheduledTransferAtTime)(nil),           // 140: vega.checkpoint.v1.ScheduledTransferAtTime
	(*v11.GovernanceTransfer)(nil),                // 141: vega.checkpoint.v1.GovernanceTransfer
	(*v11.ScheduledGovernanceTransferAtTime)(nil), // 142: vega.checkpoint.v1.ScheduledGovernanceTransferAtTime
	(*v11.BridgeState)(nil),                       // 143: vega.checkpoint.v1.BridgeState
	(*vega.Delegation)(nil),                       // 144: vega.Delegation
	(*vega.Proposal)(nil),                         // 145: vega.Proposal
	(*vega.Vote)(nil),                             // 146: vega.Vote
	(*v12.StakeLinking)(nil),                      // 147: vega.events.v1.StakeLinking
	(*vega.StakeTotalSupply)(nil),                 // 148: vega.StakeTotalSupply
	(*vega.Order)(nil),                            // 149: vega.Order
	(*vega.NetworkParameter)(nil),                 // 150: vega.NetworkParameter
	(*vega.PriceMonitoringTrigger)(nil),           // 151: vega.PriceMonitoringTrigger
	(vega.Market_TradingMode)(0),                  // 152: vega.Market.TradingMode
	(vega.AuctionTrigger)(0),                      // 153: vega.AuctionTrigger
	(*vega.AuctionDuration)(nil),                  // 154: vega.AuctionDuration
	(*vega.Market)(nil),                           // 155: vega.Market
	(*v12.StopOrderEvent)(nil),                    // 156: vega.events.v1.StopOrderEvent
	(*v11.MarketState)(nil),                       // 157: vega.checkpoint.v1.MarketState
	(*v12.ValidatorUpdate)(nil),                   // 158: vega.events.v1.ValidatorUpdate
	(*vega.RankingScore)(nil),                     // 159: vega.RankingScore
	(*vega.LiquidityProvision)(nil),               // 160: vega.LiquidityProvision
	(*vega.KeyValueBundle)(nil),                   // 161: vega.KeyValueBundle
	(*v11.MarketActivityTracker)(nil),             // 162: vega.checkpoint.v1.MarketActivityTracker
	(*v12.ERC20MultiSigSignerEvent)(nil),          // 163: vega.events.v1.ERC20MultiSigSignerEvent
	(*v12.ERC20MultiSigThresholdSetEvent)(nil),    // 164: vega.events.v1.ERC20MultiSigThresholdSetEvent
	(*v12.ProtocolUpgradeEvent)(nil),              // 165: vega.events.v1.ProtocolUpgradeEvent
}
var file_vega_snapshot_v1_snapshot_proto_depIdxs = []int32{
	...
	94,  // 60: vega.snapshot.v1.Payload.eth_oracle_verifier_last_block:type_name -> vega.snapshot.v1.EthOracleVerifierLastBlock
	7,   // 61: vega.snapshot.v1.LiquidityTarget.previous_open_interests:type_name -> vega.snapshot.v1.TimestampedOpenInterest
	7,   // 62: vega.snapshot.v1.LiquidityTarget.max_open_interests:type_name -> vega.snapshot.v1.TimestampedOpenInterest
	6,   // 63: vega.snapshot.v1.SpotLiquidityTarget.previous_total_stake:type_name -> vega.snapshot.v1.TimestampedTotalStake
	6,   // 64: vega.snapshot.v1.SpotLiquidityTarget.max_total_stake:type_name -> vega.snapshot.v1.TimestampedTotalStake
	10,  // 65: vega.snapshot.v1.LiquiditySupplied.bid_cache:type_name -> vega.snapshot.v1.LiquidityOffsetProbabilityPair
	10,  // 66: vega.snapshot.v1.LiquiditySupplied.ask_cache:type_name -> vega.snapshot.v1.LiquidityOffsetProbabilityPair
	13,  // 67: vega.snapshot.v1.OracleDataBatch.oracle_data:type_name -> vega.snapshot.v1.OracleData
	132, // 68: vega.snapshot.v1.OracleData.signers:type_name -> vega.data.v1.Signer
	14,  // 69: vega.snapshot.v1.OracleData.data:type_name -> vega.snapshot.v1.OracleDataPair
	133, // 70: vega.snapshot.v1.OracleData.meta_data:type_name -> vega.data.v1.Property
	16,  // 71: vega.snapshot.v1.Witness.resources:type_name -> vega.snapshot.v1.Resource
	134, // 72: vega.snapshot.v1.CollateralAccounts.accounts:type_name -> vega.Account
	135, // 73: vega.snapshot.v1.CollateralAssets.assets:type_name -> vega.Asset
	135, // 74: vega.snapshot.v1.ActiveAssets.assets:type_name -> vega.Asset
	135, // 75: vega.snapshot.v1.PendingAssets.assets:type_name -> vega.Asset
	135, // 76: vega.snapshot.v1.PendingAssetUpdates.assets:type_name -> vega.Asset
	136, // 77: vega.snapshot.v1.Withdrawal.withdrawal:type_name -> vega.Withdrawal
	137, // 78: vega.snapshot.v1.Deposit.deposit:type_name -> vega.Deposit
	23,  // 79: vega.snapshot.v1.BankingWithdrawals.withdrawals:type_name -> vega.snapshot.v1.Withdrawal
	24,  // 80: vega.snapshot.v1.BankingDeposits.deposit:type_name -> vega.snapshot.v1.Deposit
	138, // 81: vega.snapshot.v1.BankingAssetActions.asset_action:type_name -> vega.checkpoint.v1.AssetAction
	139, // 82: vega.snapshot.v1.BankingRecurringTransfers.recurring_transfers:type_name -> vega.checkpoint.v1.RecurringTransfers
	140, // 83: vega.snapshot.v1.BankingScheduledTransfers.transfers_at_time:type_name -> vega.checkpoint.v1.ScheduledTransferAtTime
	141, // 84: vega.snapshot.v1.BankingRecurringGovernanceTransfers.recurring_transfers:type_name -> vega.checkpoint.v1.GovernanceTransfer
	142, // 85: vega.snapshot.v1.BankingScheduledGovernanceTransfers.transfers_at_time:type_name -> vega.checkpoint.v1.ScheduledGovernanceTransferAtTime
	143, // 86: vega.snapshot.v1.BankingBridgeState.bridge_state:type_name -> vega.checkpoint.v1.BridgeState
	144, // 87: vega.snapshot.v1.DelegationActive.delegations:type_name -> vega.Delegation
	144, // 88: vega.snapshot.v1.DelegationPending.delegations:type_name -> vega.Delegation
	144, // 89: vega.snapshot.v1.DelegationPending.undelegation:type_name -> vega.Delegation
	145, // 90: vega.snapshot.v1.ProposalData.proposal:type_name -> vega.Proposal
	146, // 91: vega.snapshot.v1.ProposalData.yes:type_name -> vega.Vote
	146, // 92: vega.snapshot.v1.ProposalData.no:type_name -> vega.Vote
	146, // 93: vega.snapshot.v1.ProposalData.invalid:type_name -> vega.Vote
	40,  // 94: vega.snapshot.v1.GovernanceEnacted.proposals:type_name -> vega.snapshot.v1.ProposalData
	40,  // 95: vega.snapshot.v1.GovernanceActive.proposals:type_name -> vega.snapshot.v1.ProposalData
	145, // 96: vega.snapshot.v1.GovernanceNode.proposals:type_name -> vega.Proposal
	147, // 97: vega.snapshot.v1.StakingAccount.events:type_name -> vega.events.v1.StakeLinking
	44,  // 98: vega.snapshot.v1.StakingAccounts.accounts:type_name -> vega.snapshot.v1.StakingAccount
	148, // 99: vega.snapshot.v1.StakingAccounts.pending_stake_total_supply:type_name -> vega.StakeTotalSupply
	149, // 100: vega.snapshot.v1.MatchingBook.buy:type_name -> vega.Order
	149, // 101: vega.snapshot.v1.MatchingBook.sell:type_name -> vega.Order
	150, // 102: vega.snapshot.v1.NetParams.params:type_name -> vega.NetworkParameter
	151, // 103: vega.snapshot.v1.PriceBound.trigger:type_name -> vega.PriceMonitoringTrigger
	52,  // 104: vega.snapshot.v1.PriceRangeCache.bound:type_name -> vega.snapshot.v1.PriceBound
	51,  // 105: vega.snapshot.v1.PriceRangeCache.range:type_name -> vega.snapshot.v1.PriceRange
	48,  // 106: vega.snapshot.v1.PriceMonitor.fp_horizons:type_name -> vega.snapshot.v1.DecimalMap
	52,  // 107: vega.snapshot.v1.PriceMonitor.bounds:type_name -> vega.snapshot.v1.PriceBound
	53,  // 108: vega.snapshot.v1.PriceMonitor.price_range_cache:type_name -> vega.snapshot.v1.PriceRangeCache
	48,  // 109: vega.snapshot.v1.PriceMonitor.ref_price_cache:type_name -> vega.snapshot.v1.DecimalMap
	54,  // 110: vega.snapshot.v1.PriceMonitor.prices_now:type_name -> vega.snapshot.v1.CurrentPrice
	55,  // 111: vega.snapshot.v1.PriceMonitor.prices_past:type_name -> vega.snapshot.v1.PastPrice
	152, // 112: vega.snapshot.v1.AuctionState.mode:type_name -> vega.Market.TradingMode
	152, // 113: vega.snapshot.v1.AuctionState.default_mode:type_name -> vega.Market.TradingMode
	153, // 114: vega.snapshot.v1.AuctionState.trigger:type_name -> vega.AuctionTrigger
	154, // 115: vega.snapshot.v1.AuctionState.end:type_name -> vega.AuctionDuration
	153, // 116: vega.snapshot.v1.AuctionState.extension:type_name -> vega.AuctionTrigger
	58,  // 117: vega.snapshot.v1.EquityShare.lps:type_name -> vega.snapshot.v1.EquityShareLP
	155, // 118: vega.snapshot.v1.SpotMarket.market:type_name -> vega.Market
	56,  // 119: vega.snapshot.v1.SpotMarket.price_monitor:type_name -> vega.snapshot.v1.PriceMonitor
	57,  // 120: vega.snapshot.v1.SpotMarket.auction_state:type_name -> vega.snapshot.v1.AuctionState
	69,  // 121: vega.snapshot.v1.SpotMarket.pegged_orders:type_name -> vega.snapshot.v1.PeggedOrders
	149, // 122: vega.snapshot.v1.SpotMarket.expiring_orders:type_name -> vega.Order
	59,  // 123: vega.snapshot.v1.SpotMarket.equity_share:type_name -> vega.snapshot.v1.EquityShare
	60,  // 124: vega.snapshot.v1.SpotMarket.fee_splitter:type_name -> vega.snapshot.v1.FeeSplitter
	155, // 125: vega.snapshot.v1.Market.market:type_name -> vega.Market
	56,  // 126: vega.snapshot.v1.Market.price_monitor:type_name -> vega.snapshot.v1.PriceMonitor
	57,  // 127: vega.snapshot.v1.Market.auction_state:type_name -> vega.snapshot.v1.AuctionState
	69,  // 128: vega.snapshot.v1.Market.pegged_orders:type_name -> vega.snapshot.v1.PeggedOrders
	149, // 129: vega.snapshot.v1.Market.expiring_orders:type_name -> vega.Order
	59,  // 130: vega.snapshot.v1.Market.equity_share:type_name -> vega.snapshot.v1.EquityShare
	60,  // 131: vega.snapshot.v1.Market.fee_splitter:type_name -> vega.snapshot.v1.FeeSplitter
	68,  // 132: vega.snapshot.v1.Market.stop_orders:type_name -> vega.snapshot.v1.StopOrders
	149, // 133: vega.snapshot.v1.Market.expiring_stop_orders:type_name -> vega.Order
	63,  // 134: vega.snapshot.v1.PricedStopOrders.falls_bellow:type_name -> vega.snapshot.v1.OrdersAtPrice
	63,  // 135: vega.snapshot.v1.PricedStopOrders.rises_above:type_name -> vega.snapshot.v1.OrdersAtPrice
	67,  // 136: vega.snapshot.v1.TrailingStopOrders.falls_bellow:type_name -> vega.snapshot.v1.OffsetsAtPrice
	67,  // 137: vega.snapshot.v1.TrailingStopOrders.rises_above:type_name -> vega.snapshot.v1.OffsetsAtPrice
	66,  // 138: vega.snapshot.v1.OffsetsAtPrice.offsets:type_name -> vega.snapshot.v1.OrdersAtOffset
	156, // 139: vega.snapshot.v1.StopOrders.stop_orders:type_name -> vega.events.v1.StopOrderEvent
	64,  // 140: vega.snapshot.v1.StopOrders.priced_stop_orders:type_name -> vega.snapshot.v1.PricedStopOrders
	65,  // 141: vega.snapshot.v1.StopOrders.trailing_stop_orders:type_name -> vega.snapshot.v1.TrailingStopOrders
	149, // 142: vega.snapshot.v1.PeggedOrders.parked_orders:type_name -> vega.Order
	62,  // 143: vega.snapshot.v1.ExecutionMarkets.markets:type_name -> vega.snapshot.v1.Market
	61,  // 144: vega.snapshot.v1.ExecutionMarkets.spot_markets:type_name -> vega.snapshot.v1.SpotMarket
	157, // 145: vega.snapshot.v1.ExecutionMarkets.settled_markets:type_name -> vega.checkpoint.v1.MarketState
	71,  // 146: vega.snapshot.v1.MarketPositions.positions:type_name -> vega.snapshot.v1.Position
	74,  // 147: vega.snapshot.v1.SettlementState.last_settled_positions:type_name -> vega.snapshot.v1.LastSettledPosition
	75,  // 148: vega.snapshot.v1.SettlementState.trades:type_name -> vega.snapshot.v1.SettlementTrade
	79,  // 149: vega.snapshot.v1.RewardsPendingPayouts.scheduled_rewards_payout:type_name -> vega.snapshot.v1.ScheduledRewardsPayout
	80,  // 150: vega.snapshot.v1.ScheduledRewardsPayout.rewards_payout:type_name -> vega.snapshot.v1.RewardsPayout
	81,  // 151: vega.snapshot.v1.RewardsPayout.reward_party_amount:type_name -> vega.snapshot.v1.RewardsPartyAmount
	84,  // 152: vega.snapshot.v1.VoteSpamPolicy.party_to_vote:type_name -> vega.snapshot.v1.PartyProposalVoteCount
	124, // 153: vega.snapshot.v1.VoteSpamPolicy.banned_parties:type_name -> vega.snapshot.v1.BannedParty
	85,  // 154: vega.snapshot.v1.VoteSpamPolicy.token_balance:type_name -> vega.snapshot.v1.PartyTokenBalance
	86,  // 155: vega.snapshot.v1.VoteSpamPolicy.recent_blocks_reject_stats:type_name -> vega.snapshot.v1.BlockRejectStats
	87,  // 156: vega.snapshot.v1.SimpleSpamPolicy.party_to_count:type_name -> vega.snapshot.v1.SpamPartyTransactionCount
	124, // 157: vega.snapshot.v1.SimpleSpamPolicy.banned_parties:type_name -> vega.snapshot.v1.BannedParty
	85,  // 158: vega.snapshot.v1.SimpleSpamPolicy.token_balance:type_name -> vega.snapshot.v1.PartyTokenBalance
	89,  // 159: vega.snapshot.v1.Notary.notary_sigs:type_name -> vega.snapshot.v1.NotarySigs
	93,  // 160: vega.snapshot.v1.StakeVerifierDeposited.pending_deposited:type_name -> vega.snapshot.v1.StakeVerifierPending
	93,  // 161: vega.snapshot.v1.StakeVerifierRemoved.pending_removed:type_name -> vega.snapshot.v1.StakeVerifierPending
	96,  // 162: vega.snapshot.v1.EthContractCallResults.pending_contract_call_result:type_name -> vega.snapshot.v1.EthContractCallResult
	103, // 163: vega.snapshot.v1.Topology.validator_data:type_name -> vega.snapshot.v1.ValidatorState
	97,  // 164: vega.snapshot.v1.Topology.pending_pub_key_rotations:type_name -> vega.snapshot.v1.PendingKeyRotation
	106, // 165: vega.snapshot.v1.Topology.validator_performance:type_name -> vega.snapshot.v1.ValidatorPerformance
	98,  // 166: vega.snapshot.v1.Topology.pending_ethereum_key_rotations:type_name -> vega.snapshot.v1.PendingEthereumKeyRotation
	100, // 167: vega.snapshot.v1.Topology.signatures:type_name -> vega.snapshot.v1.ToplogySignatures
	98,  // 168: vega.snapshot.v1.Topology.unsolved_ethereum_key_rotations:type_name -> vega.snapshot.v1.PendingEthereumKeyRotation
	101, // 169: vega.snapshot.v1.ToplogySignatures.pending_signatures:type_name -> vega.snapshot.v1.PendingERC20MultisigControlSignature
	102, // 170: vega.snapshot.v1.ToplogySignatures.issued_signatures:type_name -> vega.snapshot.v1.IssuedERC20MultisigControlSignature
	158, // 171: vega.snapshot.v1.ValidatorState.validator_update:type_name -> vega.events.v1.ValidatorUpdate
	104, // 172: vega.snapshot.v1.ValidatorState.heartbeat_tracker:type_name -> vega.snapshot.v1.HeartbeatTracker
	159, // 173: vega.snapshot.v1.ValidatorState.ranking_score:type_name -> vega.RankingScore
	105, // 174: vega.snapshot.v1.ValidatorPerformance.validator_perf_stats:type_name -> vega.snapshot.v1.PerformanceStats
	110, // 175: vega.snapshot.v1.LiquidityPartiesLiquidityOrders.party_orders:type_name -> vega.snapshot.v1.PartyOrders
	149, // 176: vega.snapshot.v1.PartyOrders.orders:type_name -> vega.Order
	110, // 177: vega.snapshot.v1.LiquidityPartiesOrders.party_orders:type_name -> vega.snapshot.v1.PartyOrders
	160, // 178: vega.snapshot.v1.LiquidityProvisions.liquidity_provisions:type_name -> vega.LiquidityProvision
	114, // 179: vega.snapshot.v1.LiquidityScores.scores:type_name -> vega.snapshot.v1.LiquidityScore
	118, // 180: vega.snapshot.v1.FloatingPointConsensus.next_time_trigger:type_name -> vega.snapshot.v1.NextTimeTrigger
	116, // 181: vega.snapshot.v1.FloatingPointConsensus.state_variables:type_name -> vega.snapshot.v1.StateVarInternalState
	117, // 182: vega.snapshot.v1.StateVarInternalState.validators_results:type_name -> vega.snapshot.v1.FloatingPointValidatorResult
	161, // 183: vega.snapshot.v1.FloatingPointValidatorResult.bundle:type_name -> vega.KeyValueBundle
	162, // 184: vega.snapshot.v1.MarketTracker.market_activity:type_name -> vega.checkpoint.v1.MarketActivityTracker
	163, // 185: vega.snapshot.v1.SignerEventsPerAddress.events:type_name -> vega.events.v1.ERC20MultiSigSignerEvent
	120, // 186: vega.snapshot.v1.ERC20MultiSigTopologyVerified.events_per_address:type_name -> vega.snapshot.v1.SignerEventsPerAddress
	164, // 187: vega.snapshot.v1.ERC20MultiSigTopologyVerified.threshold:type_name -> vega.events.v1.ERC20MultiSigThresholdSetEvent
	163, // 188: vega.snapshot.v1.ERC20MultiSigTopologyPending.pending_signers:type_name -> vega.events.v1.ERC20MultiSigSignerEvent
	164, // 189: vega.snapshot.v1.ERC20MultiSigTopologyPending.pending_threshold_set:type_name -> vega.events.v1.ERC20MultiSigThresholdSetEvent
	129, // 190: vega.snapshot.v1.ProofOfWork.tx_at_height:type_name -> vega.snapshot.v1.TransactionsAtHeight
	129, // 191: vega.snapshot.v1.ProofOfWork.tid_at_height:type_name -> vega.snapshot.v1.TransactionsAtHeight
	124, // 192: vega.snapshot.v1.ProofOfWork.banned:type_name -> vega.snapshot.v1.BannedParty
	125, // 193: vega.snapshot.v1.ProofOfWork.pow_params:type_name -> vega.snapshot.v1.ProofOfWorkParams
	126, // 194: vega.snapshot.v1.ProofOfWork.pow_state:type_name -> vega.snapshot.v1.ProofOfWorkState
	127, // 195: vega.snapshot.v1.ProofOfWorkState.pow_state:type_name -> vega.snapshot.v1.ProofOfWorkBlockState
	128, // 196: vega.snapshot.v1.ProofOfWorkBlockState.party_state:type_name -> vega.snapshot.v1.ProofOfWorkPartyStateForBlock
	165, // 197: vega.snapshot.v1.ProtocolUpgradeProposals.active_proposals:type_name -> vega.events.v1.ProtocolUpgradeEvent
	131, // 198: vega.snapshot.v1.ProtocolUpgradeProposals.accepted_proposal:type_name -> vega.snapshot.v1.AcceptedProtocolUpgradeProposal
