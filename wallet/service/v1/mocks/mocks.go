...
// Source: code.vegaprotocol.io/vega/wallet/service/v1 (interfaces: WalletHandler,Auth,NodeForward,RSAStore,ProofOfWork)
...
func (m *MockProofOfWork) Generate(arg0 string, arg1 *types.LastBlock) (*v10.ProofOfWork, error) {
	m.ctrl.T.Helper()
