...
type Payload_EthOracleVerifierLastBlock struct {
	EthOracleVerifierLastBlock *EthOracleVerifierLastBlock `protobuf:"bytes,61,opt,name=eth_oracle_verifier_last_block,json=ethOracleVerifierLastBlock,proto3,oneof"`
}
...
var file_vega_snapshot_v1_snapshot_proto_rawDesc = []byte{
	...
	0x66, 0x22, 0x83, 0x26, 0x0a, 0x07, 0x50, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x12, 0x45, 0x0a,
	...
	0x43, 0x61, 0x6c, 0x6c, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x73, 0x12, 0x72, 0x0a, 0x1e, 0x65,
	0x74, 0x68, 0x5f, 0x6f, 0x72, 0x61, 0x63, 0x6c, 0x65, 0x5f, 0x76, 0x65, 0x72, 0x69, 0x66, 0x69,
	0x65, 0x72, 0x5f, 0x6c, 0x61, 0x73, 0x74, 0x5f, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x18, 0x3d, 0x20,
	...
	0x6b, 0x48, 0x00, 0x52, 0x1a, 0x65, 0x74, 0x68, 0x4f, 0x72, 0x61, 0x63, 0x6c, 0x65, 0x56, 0x65,
	0x72, 0x69, 0x66, 0x69, 0x65, 0x72, 0x4c, 0x61, 0x73, 0x74, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x42,
	0x06, 0x0a, 0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0x4c, 0x0a, 0x15, 0x54, 0x69, 0x6d, 0x65, 0x73,
	...
	0x67, 0x65, 0x53, 0x74, 0x61, 0x74, 0x65, 0x22, 0x25, 0x0a, 0x0a, 0x43, 0x68, 0x65, 0x63, 0x6b,
	...
	0x6b, 0x65, 0x54, 0x6f, 0x74, 0x61, 0x6c, 0x53, 0x75, 0x70, 0x70, 0x6c, 0x79, 0x22, 0xcc, 0x01,
	...
	0x01, 0x28, 0x04, 0x52, 0x07, 0x62, 0x61, 0x74, 0x63, 0x68, 0x49, 0x64, 0x22, 0x3b, 0x0a, 0x09,
	...
	0x28, 0x04, 0x52, 0x06, 0x77, 0x69, 0x6e, 0x64, 0x6f, 0x77, 0x22, 0xfc, 0x06, 0x0a, 0x0a, 0x53,
	...
	0x08, 0x52, 0x06, 0x63, 0x6c, 0x6f, 0x73, 0x65, 0x64, 0x22, 0xd8, 0x08, 0x0a, 0x06, 0x4d, 0x61,
	...
	0x65, 0x64, 0x65, 0x64, 0x22, 0x40, 0x0a, 0x0c, 0x50, 0x65, 0x67, 0x67, 0x65, 0x64, 0x4f, 0x72,
	...
	0x4f, 0x72, 0x64, 0x65, 0x72, 0x73, 0x22, 0x87, 0x01, 0x0a, 0x10, 0x45, 0x78, 0x65, 0x63, 0x75,
...
var file_vega_snapshot_v1_snapshot_proto_goTypes = []interface{}{
	...
	(*EthOracleVerifierLastBlock)(nil),           // 86: vega.snapshot.v1.EthOracleVerifierLastBlock
	(*EthContractCallResults)(nil),               // 87: vega.snapshot.v1.EthContractCallResults
	(*EthContractCallResult)(nil),                // 88: vega.snapshot.v1.EthContractCallResult
	(*PendingKeyRotation)(nil),                   // 89: vega.snapshot.v1.PendingKeyRotation
	(*PendingEthereumKeyRotation)(nil),           // 90: vega.snapshot.v1.PendingEthereumKeyRotation
	(*Topology)(nil),                             // 91: vega.snapshot.v1.Topology
	(*ToplogySignatures)(nil),                    // 92: vega.snapshot.v1.ToplogySignatures
	(*PendingERC20MultisigControlSignature)(nil), // 93: vega.snapshot.v1.PendingERC20MultisigControlSignature
	(*IssuedERC20MultisigControlSignature)(nil),  // 94: vega.snapshot.v1.IssuedERC20MultisigControlSignature
	(*ValidatorState)(nil),                       // 95: vega.snapshot.v1.ValidatorState
	(*HeartbeatTracker)(nil),                     // 96: vega.snapshot.v1.HeartbeatTracker
	(*PerformanceStats)(nil),                     // 97: vega.snapshot.v1.PerformanceStats
	(*ValidatorPerformance)(nil),                 // 98: vega.snapshot.v1.ValidatorPerformance
	(*LiquidityParameters)(nil),                  // 99: vega.snapshot.v1.LiquidityParameters
	(*LiquidityPendingProvisions)(nil),           // 100: vega.snapshot.v1.LiquidityPendingProvisions
	(*LiquidityPartiesLiquidityOrders)(nil),      // 101: vega.snapshot.v1.LiquidityPartiesLiquidityOrders
	(*PartyOrders)(nil),                          // 102: vega.snapshot.v1.PartyOrders
	(*LiquidityPartiesOrders)(nil),               // 103: vega.snapshot.v1.LiquidityPartiesOrders
	(*LiquidityProvisions)(nil),                  // 104: vega.snapshot.v1.LiquidityProvisions
	...
	(*v1.Property)(nil),                          // 125: vega.data.v1.Property
	...
	(*v11.AssetAction)(nil),                      // 130: vega.checkpoint.v1.AssetAction
	(*v11.RecurringTransfers)(nil),               // 131: vega.checkpoint.v1.RecurringTransfers
	(*v11.ScheduledTransferAtTime)(nil),          // 132: vega.checkpoint.v1.ScheduledTransferAtTime
	(*v11.BridgeState)(nil),                      // 133: vega.checkpoint.v1.BridgeState
	(*vega.Delegation)(nil),                      // 134: vega.Delegation
	(*vega.Proposal)(nil),                        // 135: vega.Proposal
	(*vega.Vote)(nil),                            // 136: vega.Vote
	(*v12.StakeLinking)(nil),                     // 137: vega.events.v1.StakeLinking
	(*vega.StakeTotalSupply)(nil),                // 138: vega.StakeTotalSupply
	(*vega.Order)(nil),                           // 139: vega.Order
	(*vega.NetworkParameter)(nil),                // 140: vega.NetworkParameter
	(*vega.PriceMonitoringTrigger)(nil),          // 141: vega.PriceMonitoringTrigger
	(vega.Market_TradingMode)(0),                 // 142: vega.Market.TradingMode
	(vega.AuctionTrigger)(0),                     // 143: vega.AuctionTrigger
	(*vega.AuctionDuration)(nil),                 // 144: vega.AuctionDuration
	(*vega.Market)(nil),                          // 145: vega.Market
	(*v12.ValidatorUpdate)(nil),                  // 146: vega.events.v1.ValidatorUpdate
	(*vega.RankingScore)(nil),                    // 147: vega.RankingScore
	(*vega.LiquidityProvision)(nil),              // 148: vega.LiquidityProvision
...
var file_vega_snapshot_v1_snapshot_proto_depIdxs = []int32{
	...
	91,  // 35: vega.snapshot.v1.Payload.topology:type_name -> vega.snapshot.v1.Topology
	12,  // 36: vega.snapshot.v1.Payload.oracle_data:type_name -> vega.snapshot.v1.OracleDataBatch
	99,  // 37: vega.snapshot.v1.Payload.liquidity_parameters:type_name -> vega.snapshot.v1.LiquidityParameters
	100, // 38: vega.snapshot.v1.Payload.liquidity_pending_provisions:type_name -> vega.snapshot.v1.LiquidityPendingProvisions
	101, // 39: vega.snapshot.v1.Payload.liquidity_parties_liquidity_orders:type_name -> vega.snapshot.v1.LiquidityPartiesLiquidityOrders
	103, // 40: vega.snapshot.v1.Payload.liquidity_parties_orders:type_name -> vega.snapshot.v1.LiquidityPartiesOrders
	104, // 41: vega.snapshot.v1.Payload.liquidity_provisions:type_name -> vega.snapshot.v1.LiquidityProvisions
	...
	87,  // 57: vega.snapshot.v1.Payload.eth_contract_call_results:type_name -> vega.snapshot.v1.EthContractCallResults
	86,  // 58: vega.snapshot.v1.Payload.eth_oracle_verifier_last_block:type_name -> vega.snapshot.v1.EthOracleVerifierLastBlock
	...
	124, // 66: vega.snapshot.v1.OracleData.signers:type_name -> vega.data.v1.Signer
	14,  // 67: vega.snapshot.v1.OracleData.data:type_name -> vega.snapshot.v1.OracleDataPair
	125, // 68: vega.snapshot.v1.OracleData.meta_data:type_name -> vega.data.v1.Property
	16,  // 69: vega.snapshot.v1.Witness.resources:type_name -> vega.snapshot.v1.Resource
	126, // 70: vega.snapshot.v1.CollateralAccounts.accounts:type_name -> vega.Account
	127, // 71: vega.snapshot.v1.CollateralAssets.assets:type_name -> vega.Asset
	127, // 72: vega.snapshot.v1.ActiveAssets.assets:type_name -> vega.Asset
	127, // 73: vega.snapshot.v1.PendingAssets.assets:type_name -> vega.Asset
	127, // 74: vega.snapshot.v1.PendingAssetUpdates.assets:type_name -> vega.Asset
	128, // 75: vega.snapshot.v1.Withdrawal.withdrawal:type_name -> vega.Withdrawal
	129, // 76: vega.snapshot.v1.Deposit.deposit:type_name -> vega.Deposit
	...
	130, // 79: vega.snapshot.v1.BankingAssetActions.asset_action:type_name -> vega.checkpoint.v1.AssetAction
	131, // 80: vega.snapshot.v1.BankingRecurringTransfers.recurring_transfers:type_name -> vega.checkpoint.v1.RecurringTransfers
	132, // 81: vega.snapshot.v1.BankingScheduledTransfers.transfers_at_time:type_name -> vega.checkpoint.v1.ScheduledTransferAtTime
	133, // 82: vega.snapshot.v1.BankingBridgeState.bridge_state:type_name -> vega.checkpoint.v1.BridgeState
	134, // 83: vega.snapshot.v1.DelegationActive.delegations:type_name -> vega.Delegation
	134, // 84: vega.snapshot.v1.DelegationPending.delegations:type_name -> vega.Delegation
	134, // 85: vega.snapshot.v1.DelegationPending.undelegation:type_name -> vega.Delegation
	135, // 86: vega.snapshot.v1.ProposalData.proposal:type_name -> vega.Proposal
	136, // 87: vega.snapshot.v1.ProposalData.yes:type_name -> vega.Vote
	136, // 88: vega.snapshot.v1.ProposalData.no:type_name -> vega.Vote
	136, // 89: vega.snapshot.v1.ProposalData.invalid:type_name -> vega.Vote
	38,  // 90: vega.snapshot.v1.GovernanceEnacted.proposals:type_name -> vega.snapshot.v1.ProposalData
	38,  // 91: vega.snapshot.v1.GovernanceActive.proposals:type_name -> vega.snapshot.v1.ProposalData
	135, // 92: vega.snapshot.v1.GovernanceNode.proposals:type_name -> vega.Proposal
	137, // 93: vega.snapshot.v1.StakingAccount.events:type_name -> vega.events.v1.StakeLinking
	42,  // 94: vega.snapshot.v1.StakingAccounts.accounts:type_name -> vega.snapshot.v1.StakingAccount
	138, // 95: vega.snapshot.v1.StakingAccounts.pending_stake_total_supply:type_name -> vega.StakeTotalSupply
	139, // 96: vega.snapshot.v1.MatchingBook.buy:type_name -> vega.Order
	139, // 97: vega.snapshot.v1.MatchingBook.sell:type_name -> vega.Order
	140, // 98: vega.snapshot.v1.NetParams.params:type_name -> vega.NetworkParameter
	141, // 99: vega.snapshot.v1.PriceBound.trigger:type_name -> vega.PriceMonitoringTrigger
	50,  // 100: vega.snapshot.v1.PriceRangeCache.bound:type_name -> vega.snapshot.v1.PriceBound
	49,  // 101: vega.snapshot.v1.PriceRangeCache.range:type_name -> vega.snapshot.v1.PriceRange
	46,  // 102: vega.snapshot.v1.PriceMonitor.fp_horizons:type_name -> vega.snapshot.v1.DecimalMap
	50,  // 103: vega.snapshot.v1.PriceMonitor.bounds:type_name -> vega.snapshot.v1.PriceBound
	51,  // 104: vega.snapshot.v1.PriceMonitor.price_range_cache:type_name -> vega.snapshot.v1.PriceRangeCache
	46,  // 105: vega.snapshot.v1.PriceMonitor.ref_price_cache:type_name -> vega.snapshot.v1.DecimalMap
	52,  // 106: vega.snapshot.v1.PriceMonitor.prices_now:type_name -> vega.snapshot.v1.CurrentPrice
	53,  // 107: vega.snapshot.v1.PriceMonitor.prices_past:type_name -> vega.snapshot.v1.PastPrice
	142, // 108: vega.snapshot.v1.AuctionState.mode:type_name -> vega.Market.TradingMode
	142, // 109: vega.snapshot.v1.AuctionState.default_mode:type_name -> vega.Market.TradingMode
	143, // 110: vega.snapshot.v1.AuctionState.trigger:type_name -> vega.AuctionTrigger
	144, // 111: vega.snapshot.v1.AuctionState.end:type_name -> vega.AuctionDuration
	143, // 112: vega.snapshot.v1.AuctionState.extension:type_name -> vega.AuctionTrigger
	56,  // 113: vega.snapshot.v1.EquityShare.lps:type_name -> vega.snapshot.v1.EquityShareLP
	145, // 114: vega.snapshot.v1.SpotMarket.market:type_name -> vega.Market
	54,  // 115: vega.snapshot.v1.SpotMarket.price_monitor:type_name -> vega.snapshot.v1.PriceMonitor
	55,  // 116: vega.snapshot.v1.SpotMarket.auction_state:type_name -> vega.snapshot.v1.AuctionState
	61,  // 117: vega.snapshot.v1.SpotMarket.pegged_orders:type_name -> vega.snapshot.v1.PeggedOrders
	139, // 118: vega.snapshot.v1.SpotMarket.expiring_orders:type_name -> vega.Order
	57,  // 119: vega.snapshot.v1.SpotMarket.equity_share:type_name -> vega.snapshot.v1.EquityShare
	58,  // 120: vega.snapshot.v1.SpotMarket.fee_splitter:type_name -> vega.snapshot.v1.FeeSplitter
	145, // 121: vega.snapshot.v1.Market.market:type_name -> vega.Market
	54,  // 122: vega.snapshot.v1.Market.price_monitor:type_name -> vega.snapshot.v1.PriceMonitor
	55,  // 123: vega.snapshot.v1.Market.auction_state:type_name -> vega.snapshot.v1.AuctionState
	61,  // 124: vega.snapshot.v1.Market.pegged_orders:type_name -> vega.snapshot.v1.PeggedOrders
	139, // 125: vega.snapshot.v1.Market.expiring_orders:type_name -> vega.Order
	57,  // 126: vega.snapshot.v1.Market.equity_share:type_name -> vega.snapshot.v1.EquityShare
	58,  // 127: vega.snapshot.v1.Market.fee_splitter:type_name -> vega.snapshot.v1.FeeSplitter
	139, // 128: vega.snapshot.v1.PeggedOrders.parked_orders:type_name -> vega.Order
	60,  // 129: vega.snapshot.v1.ExecutionMarkets.markets:type_name -> vega.snapshot.v1.Market
	59,  // 130: vega.snapshot.v1.ExecutionMarkets.spot_markets:type_name -> vega.snapshot.v1.SpotMarket
	63,  // 131: vega.snapshot.v1.MarketPositions.positions:type_name -> vega.snapshot.v1.Position
	66,  // 132: vega.snapshot.v1.SettlementState.last_settled_positions:type_name -> vega.snapshot.v1.LastSettledPosition
	67,  // 133: vega.snapshot.v1.SettlementState.trades:type_name -> vega.snapshot.v1.SettlementTrade
	71,  // 134: vega.snapshot.v1.RewardsPendingPayouts.scheduled_rewards_payout:type_name -> vega.snapshot.v1.ScheduledRewardsPayout
	72,  // 135: vega.snapshot.v1.ScheduledRewardsPayout.rewards_payout:type_name -> vega.snapshot.v1.RewardsPayout
	73,  // 136: vega.snapshot.v1.RewardsPayout.reward_party_amount:type_name -> vega.snapshot.v1.RewardsPartyAmount
	76,  // 137: vega.snapshot.v1.VoteSpamPolicy.party_to_vote:type_name -> vega.snapshot.v1.PartyProposalVoteCount
	116, // 138: vega.snapshot.v1.VoteSpamPolicy.banned_parties:type_name -> vega.snapshot.v1.BannedParty
	77,  // 139: vega.snapshot.v1.VoteSpamPolicy.token_balance:type_name -> vega.snapshot.v1.PartyTokenBalance
	78,  // 140: vega.snapshot.v1.VoteSpamPolicy.recent_blocks_reject_stats:type_name -> vega.snapshot.v1.BlockRejectStats
	79,  // 141: vega.snapshot.v1.SimpleSpamPolicy.party_to_count:type_name -> vega.snapshot.v1.SpamPartyTransactionCount
	116, // 142: vega.snapshot.v1.SimpleSpamPolicy.banned_parties:type_name -> vega.snapshot.v1.BannedParty
	77,  // 143: vega.snapshot.v1.SimpleSpamPolicy.token_balance:type_name -> vega.snapshot.v1.PartyTokenBalance
	81,  // 144: vega.snapshot.v1.Notary.notary_sigs:type_name -> vega.snapshot.v1.NotarySigs
	85,  // 145: vega.snapshot.v1.StakeVerifierDeposited.pending_deposited:type_name -> vega.snapshot.v1.StakeVerifierPending
	85,  // 146: vega.snapshot.v1.StakeVerifierRemoved.pending_removed:type_name -> vega.snapshot.v1.StakeVerifierPending
	88,  // 147: vega.snapshot.v1.EthContractCallResults.pending_contract_call_result:type_name -> vega.snapshot.v1.EthContractCallResult
	95,  // 148: vega.snapshot.v1.Topology.validator_data:type_name -> vega.snapshot.v1.ValidatorState
	89,  // 149: vega.snapshot.v1.Topology.pending_pub_key_rotations:type_name -> vega.snapshot.v1.PendingKeyRotation
	98,  // 150: vega.snapshot.v1.Topology.validator_performance:type_name -> vega.snapshot.v1.ValidatorPerformance
	90,  // 151: vega.snapshot.v1.Topology.pending_ethereum_key_rotations:type_name -> vega.snapshot.v1.PendingEthereumKeyRotation
	92,  // 152: vega.snapshot.v1.Topology.signatures:type_name -> vega.snapshot.v1.ToplogySignatures
	90,  // 153: vega.snapshot.v1.Topology.unsolved_ethereum_key_rotations:type_name -> vega.snapshot.v1.PendingEthereumKeyRotation
	93,  // 154: vega.snapshot.v1.ToplogySignatures.pending_signatures:type_name -> vega.snapshot.v1.PendingERC20MultisigControlSignature
	94,  // 155: vega.snapshot.v1.ToplogySignatures.issued_signatures:type_name -> vega.snapshot.v1.IssuedERC20MultisigControlSignature
	146, // 156: vega.snapshot.v1.ValidatorState.validator_update:type_name -> vega.events.v1.ValidatorUpdate
	96,  // 157: vega.snapshot.v1.ValidatorState.heartbeat_tracker:type_name -> vega.snapshot.v1.HeartbeatTracker
	147, // 158: vega.snapshot.v1.ValidatorState.ranking_score:type_name -> vega.RankingScore
	97,  // 159: vega.snapshot.v1.ValidatorPerformance.validator_perf_stats:type_name -> vega.snapshot.v1.PerformanceStats
	102, // 160: vega.snapshot.v1.LiquidityPartiesLiquidityOrders.party_orders:type_name -> vega.snapshot.v1.PartyOrders
	139, // 161: vega.snapshot.v1.PartyOrders.orders:type_name -> vega.Order
	102, // 162: vega.snapshot.v1.LiquidityPartiesOrders.party_orders:type_name -> vega.snapshot.v1.PartyOrders
	148, // 163: vega.snapshot.v1.LiquidityProvisions.liquidity_provisions:type_name -> vega.LiquidityProvision
	106, // 164: vega.snapshot.v1.LiquidityScores.scores:type_name -> vega.snapshot.v1.LiquidityScore
	110, // 165: vega.snapshot.v1.FloatingPointConsensus.next_time_trigger:type_name -> vega.snapshot.v1.NextTimeTrigger
	108, // 166: vega.snapshot.v1.FloatingPointConsensus.state_variables:type_name -> vega.snapshot.v1.StateVarInternalState
	109, // 167: vega.snapshot.v1.StateVarInternalState.validators_results:type_name -> vega.snapshot.v1.FloatingPointValidatorResult
	149, // 168: vega.snapshot.v1.FloatingPointValidatorResult.bundle:type_name -> vega.KeyValueBundle
	150, // 169: vega.snapshot.v1.MarketTracker.market_activity:type_name -> vega.checkpoint.v1.MarketActivityTracker
	151, // 170: vega.snapshot.v1.SignerEventsPerAddress.events:type_name -> vega.events.v1.ERC20MultiSigSignerEvent
	112, // 171: vega.snapshot.v1.ERC20MultiSigTopologyVerified.events_per_address:type_name -> vega.snapshot.v1.SignerEventsPerAddress
	152, // 172: vega.snapshot.v1.ERC20MultiSigTopologyVerified.threshold:type_name -> vega.events.v1.ERC20MultiSigThresholdSetEvent
	151, // 173: vega.snapshot.v1.ERC20MultiSigTopologyPending.pending_signers:type_name -> vega.events.v1.ERC20MultiSigSignerEvent
	152, // 174: vega.snapshot.v1.ERC20MultiSigTopologyPending.pending_threshold_set:type_name -> vega.events.v1.ERC20MultiSigThresholdSetEvent
	121, // 175: vega.snapshot.v1.ProofOfWork.tx_at_height:type_name -> vega.snapshot.v1.TransactionsAtHeight
	121, // 176: vega.snapshot.v1.ProofOfWork.tid_at_height:type_name -> vega.snapshot.v1.TransactionsAtHeight
	116, // 177: vega.snapshot.v1.ProofOfWork.banned:type_name -> vega.snapshot.v1.BannedParty
	117, // 178: vega.snapshot.v1.ProofOfWork.pow_params:type_name -> vega.snapshot.v1.ProofOfWorkParams
	118, // 179: vega.snapshot.v1.ProofOfWork.pow_state:type_name -> vega.snapshot.v1.ProofOfWorkState
	119, // 180: vega.snapshot.v1.ProofOfWorkState.pow_state:type_name -> vega.snapshot.v1.ProofOfWorkBlockState
	120, // 181: vega.snapshot.v1.ProofOfWorkBlockState.party_state:type_name -> vega.snapshot.v1.ProofOfWorkPartyStateForBlock
	153, // 182: vega.snapshot.v1.ProtocolUpgradeProposals.active_proposals:type_name -> vega.events.v1.ProtocolUpgradeEvent
	123, // 183: vega.snapshot.v1.ProtocolUpgradeProposals.accepted_proposal:type_name -> vega.snapshot.v1.AcceptedProtocolUpgradeProposal
