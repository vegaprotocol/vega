...
#Check what happens with time and distribution period (both in genesis and mid-market)
  ...
  Scenario: 004 2 LPs joining at start, unequal commitments. Checking calculation of equity-like-shares and liquidity-fee-distribution in a growing market. (0042-LIQF-008 0042-LIQF-011)
      ...
      # liquidity_fee = ceil(volume * price * liquidity_fee_factor) =  ceil(1001 * 1 * 0.02) = ceil(2.002) = 3
      ...
      # liquidity_fee = ceil(volume * price * liquidity_fee_factor) =  ceil(1001 * 2 * 0.02) = ceil(4.004) = 5
      ...
      # liquidity_fee = ceil(volume * price * liquidity_fee_factor) =  ceil(1001 * 3 * 0.02) = ceil(6.006) = 7
      ...
      # liquidity_fee = ceil(volume * price * liquidity_fee_factor) =  ceil(1001 * 4 * 0.02) = ceil(8.008) = 9
      ...
      # liquidity_fee = ceil(volume * price * liquidity_fee_factor) =  ceil(1001 * 11 * 0.02) = ceil(10.01) = 11
