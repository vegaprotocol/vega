...
type BuiltinAssetWithdrawal struct {
	...
	PartyId string `protobuf:"bytes,2,opt,name=party_id,json=partyId,proto3" json:"party_id,omitempty"`
	// The amount to be withdrawn. This field is an unsigned integer passed as a string
	// and needs to be scaled using the asset's decimal places.
	Amount string `protobuf:"bytes,3,opt,name=amount,proto3" json:"amount,omitempty"`
}
...
type StakeDeposited struct {
	...
	// Amount deposited as an unsigned base 10 integer. This field is passed as a string
	// and needs to be scaled using the asset's decimal places.
	Amount string `protobuf:"bytes,3,opt,name=amount,proto3" json:"amount,omitempty"`
	// Time at which the block was produced.
	// Will be used to inform the core at what time
...
type StakeRemoved struct {
	...
	VegaPublicKey string `protobuf:"bytes,2,opt,name=vega_public_key,json=vegaPublicKey,proto3" json:"vega_public_key,omitempty"`
	// Amount removed as a base 10 unsigned integer.This field is passed as a string
	// and needs to be scaled using the asset decimal places for the staking token.
	Amount string `protobuf:"bytes,3,opt,name=amount,proto3" json:"amount,omitempty"`
...
type StakeTotalSupply struct {
	...
	// Total supply observed for the token as an unsigned based 10 integer. This field is passed as a string
	// and needs to be scaled using the asset decimal places for the staking token.
