Feature: Spot market matching engine
  ...
  Scenario: 001 0068-MATC-080-092, test the matching engine when in auction, moving into auction, and exiting autcion
    ...
    And the parties place the following orders:
      ...
      | party4 | BTC/ETH   | sell | 1      | 19    | 0                | TYPE_LIMIT | TIF_GTC | p4-sell      |            |       |

    # 0068-MATC-089:Amend the price
    When the parties amend the following orders:
      | party  | reference | price | size delta | tif     |
      | party4 | p4-sell   | 20    | 0          | TIF_GTC |
    ...
    And the parties place the following orders:
      ...
      | party1 | BTC/ETH   | buy  | 1      | 8     | 0                | TYPE_LIMIT | TIF_GTT | party1-GTT | 1          |       |

    #trigger auction
    And the parties place the following orders:
      | party  | market id | side | volume | price | resulting trades | type       | tif     | reference |
      | party3 | BTC/ETH   | buy  | 1      | 13    | 0                | TYPE_LIMIT | TIF_GTC | buy-13    |
      | party4 | BTC/ETH   | sell | 1      | 13    | 0                | TYPE_LIMIT | TIF_GTC | sell-13   |
    ...
    And the parties place the following orders:
      ...
      | party1 | BTC/ETH   | buy  | 1      | 14    | 0                | TYPE_LIMIT | TIF_GFA | party1-GFA   |      |
      | party1 | BTC/ETH   | buy  | 1      | 15    | 0                | TYPE_LIMIT | TIF_GTC | buy-15-self  |      |
      | party1 | BTC/ETH   | sell | 1      | 15    | 0                | TYPE_LIMIT | TIF_GTC | sell-15-self |      |
      | party1 | BTC/ETH   | buy  | 1      | 15    | 0                | TYPE_LIMIT | TIF_GTC | post-only-b  | post |
      | party2 | BTC/ETH   | sell | 1      | 15    | 0                | TYPE_LIMIT | TIF_GTC | post-only-s  | post |
      | party1 | BTC/ETH   | buy  | 1      | 15    | 0                | TYPE_LIMIT | TIF_GTC | buy-15       |      |
      | party2 | BTC/ETH   | sell | 1      | 15    | 0                | TYPE_LIMIT | TIF_GTC | sell-15      |      |
    ...
    # 0068-MATC-090:Amend the size
    When the parties amend the following orders:
      | party  | reference | price | size delta | tif     |
      | party4 | p4-sell   | 20    | 3          | TIF_GTC |
    ...
    Then the orders should have the following status:
      ...
      | party1 | post-only-b | STATUS_ACTIVE |
      | party2 | post-only-s | STATUS_ACTIVE |
    ...
    #0068-MATC-087: Self trading is allowed during uncrossing.
    Then the market data for the market "BTC/ETH" should be:
      | mark price | trading mode            | auction trigger             |
    ...
    #0068-MATC-086: The book is uncrossed when exits an auction
    Then the following trades should be executed:
      | buyer  | price | size | seller |
      | party1 | 15    | 1    | party1 |
      | party1 | 15    | 1    | party2 |

    #0068-MATC-088: GFA orders are canceled when exiting auction
    Then the orders should have the following status:
      | party  | reference    | status           |
      | party1 | party1-GFA   | STATUS_CANCELLED |
      | party1 | buy-15-self  | STATUS_FILLED    |
      | party1 | sell-15-self | STATUS_FILLED    |
      | party1 | buy-15       | STATUS_FILLED    |
      | party2 | sell-15      | STATUS_FILLED    |
      | party1 | party1-GTT   | STATUS_EXPIRED   |

    # 0068-MATC-091:An update to an order that is not [ACTIVE or PARKED](./0024-OSTA-order_status.md) (Stopped, Cancelled, Expired, Filled) will be rejected
    When the parties amend the following orders:
      | party  | reference   | price | size delta | tif     | error                        |
      | party1 | party1-GFA  | 14    | 1          | TIF_GFA | OrderError: Invalid Order ID |
