...
// Source: code.vegaprotocol.io/vega/statevar (interfaces: Topology)
...
func (m *MockTopology) IsValidatorNodeID(arg0 string) bool {
	m.ctrl.T.Helper()
...
func (mr *MockTopologyMockRecorder) IsValidatorNodeID(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "IsValidatorNodeID", reflect.TypeOf((*MockTopology)(nil).IsValidatorNodeID), arg0)
}
