Feature: Test funding margin for Perps market
  ...
  Background:
    ...
    And the perpetual oracles from "0xCAFECAFE1":
      ...
      | perp-oracle | USD   | perp.ETH.value      | TYPE_INTEGER    | perp.funding.cue  | TYPE_TIMESTAMP | 0.5                   | 0.05          | 0.1               | 0.15              | ETH        | 18                  |
    And the liquidity sla params named "SLA":
      | price range | commitment min time fraction | performance hysteresis epochs | sla competition factor |
      | 1.0         | 0.5                          | 1                             | 1.0                    |

    And the markets:
      | id        | quote name | asset | risk model                  | margin calculator         | auction duration | fees         | price monitoring | data source config     | linear slippage factor | quadratic slippage factor | position decimal places | sla params      |
      | ETH/DEC19 | ETH        | USD   | default-simple-risk-model-3 | default-margin-calculator | 1                | default-none | default-none     | default-eth-for-future | 1e6                    | 1e6                       | -3                      | default-futures |
...
# #funding payment = f_twap - s_twap + clamp_upper_bound*s_twap =2000-3000+(0.15*3000)=-550
# And the following transfers should happen:
#   | from   | to     | from account            | to account              | market id | amount  | asset |
#   | aux    | market | ACCOUNT_TYPE_MARGIN     | ACCOUNT_TYPE_SETTLEMENT | ETH/DEC19 | 1100000 | USD   |
#   | party1 | market | ACCOUNT_TYPE_MARGIN     | ACCOUNT_TYPE_SETTLEMENT | ETH/DEC19 | 1100000 | USD   |
#   | market | aux2   | ACCOUNT_TYPE_SETTLEMENT | ACCOUNT_TYPE_MARGIN     | ETH/DEC19 | 1100000 | USD   |
#   | market | party2 | ACCOUNT_TYPE_SETTLEMENT | ACCOUNT_TYPE_MARGIN     | ETH/DEC19 | 550000  | USD   |
#   | market | party3 | ACCOUNT_TYPE_SETTLEMENT | ACCOUNT_TYPE_MARGIN     | ETH/DEC19 | 550000  | USD   |

# Then the parties should have the following account balances:
#   | party  | asset | market id | margin  | general |
#   | party1 | USD   | ETH/DEC19 | 7682400 | 217600  |
#   | party3 | USD   | ETH/DEC19 | 2605200 | 7942800 |
#   | party2 | USD   | ETH/DEC19 | 2605200 | 8943800 |
...
# Then the parties should have the following account balances:
#   | party  | asset | market id | margin  | general |
#   | party1 | USD   | ETH/DEC19 | 7680400 | 217600  |
#   | party3 | USD   | ETH/DEC19 | 2606200 | 7942800 |
#   | party2 | USD   | ETH/DEC19 | 2606200 | 8943800 |
