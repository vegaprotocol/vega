...
// Source: code.vegaprotocol.io/vega/internal/api (interfaces: BlockchainClient)
...
func (m *MockBlockchainClient) CancelOrder(arg0 context.Context, arg1 *proto.Order) (bool, error) {
	m.ctrl.T.Helper()
