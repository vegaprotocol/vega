...
func (Order_TimeInForce) EnumDescriptor() ([]byte, []int) {
	return file_vega_vega_proto_rawDescGZIP(), []int{4, 0}
}
...
func (Order_Type) EnumDescriptor() ([]byte, []int) {
	return file_vega_vega_proto_rawDescGZIP(), []int{4, 1}
}
...
func (Order_Status) EnumDescriptor() ([]byte, []int) {
	return file_vega_vega_proto_rawDescGZIP(), []int{4, 2}
}
...
func (LiquidityProvision_Status) EnumDescriptor() ([]byte, []int) {
	return file_vega_vega_proto_rawDescGZIP(), []int{39, 0}
}
...
const (
	...
	// Liquidity provision was stopped by the network
	SpotLiquidityProvision_STATUS_STOPPED SpotLiquidityProvision_Status = 2
	// Liquidity provision was cancelled by the liquidity provider
	SpotLiquidityProvision_STATUS_CANCELLED SpotLiquidityProvision_Status = 3
	// Liquidity provision was invalid and got rejected
	SpotLiquidityProvision_STATUS_REJECTED SpotLiquidityProvision_Status = 4
	// Liquidity provision is valid and accepted by network, but orders aren't deployed
	SpotLiquidityProvision_STATUS_UNDEPLOYED SpotLiquidityProvision_Status = 5
	// Liquidity provision is valid and accepted by network
	// but has never been deployed. If when it's possible to deploy the orders for the first time
	// margin check fails, then they will be cancelled without any penalties.
	SpotLiquidityProvision_STATUS_PENDING SpotLiquidityProvision_Status = 6
)

// Enum value maps for SpotLiquidityProvision_Status.
var (
	SpotLiquidityProvision_Status_name = map[int32]string{
		0: "STATUS_UNSPECIFIED",
		1: "STATUS_ACTIVE",
		2: "STATUS_STOPPED",
		3: "STATUS_CANCELLED",
	...
	SpotLiquidityProvision_Status_value = map[string]int32{
		"STATUS_UNSPECIFIED": 0,
		"STATUS_ACTIVE":      1,
		"STATUS_STOPPED":     2,
		"STATUS_CANCELLED":   3,
...
func (x SpotLiquidityProvision_Status) Enum() *SpotLiquidityProvision_Status {
	p := new(SpotLiquidityProvision_Status)
	*p = x
	return p
}

func (x SpotLiquidityProvision_Status) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (SpotLiquidityProvision_Status) Descriptor() protoreflect.EnumDescriptor {
	return file_vega_vega_proto_enumTypes[20].Descriptor()
}

func (SpotLiquidityProvision_Status) Type() protoreflect.EnumType {
	return &file_vega_vega_proto_enumTypes[20]
}

func (x SpotLiquidityProvision_Status) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use SpotLiquidityProvision_Status.Descriptor instead.
func (SpotLiquidityProvision_Status) EnumDescriptor() ([]byte, []int) {
...
type SpotLiquidityProvision struct {
	...
	// This field is an unsigned integer scaled to the asset's decimal places.
	SellCommitmentAmount string `protobuf:"bytes,7,opt,name=sell_commitment_amount,json=sellCommitmentAmount,proto3" json:"sell_commitment_amount,omitempty"`
	// Nominated liquidity fee factor, which is an input to the calculation of taker fees on the market, as per setting fees and rewarding liquidity providers.
	...
	// Status of this liquidity provision order.
	Status SpotLiquidityProvision_Status `protobuf:"varint,10,opt,name=status,proto3,enum=vega.SpotLiquidityProvision_Status" json:"status,omitempty"`
}

func (x *SpotLiquidityProvision) Reset() {
	*x = SpotLiquidityProvision{}
	if protoimpl.UnsafeEnabled {
...
func (x *SpotLiquidityProvision) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SpotLiquidityProvision) ProtoMessage() {}

func (x *SpotLiquidityProvision) ProtoReflect() protoreflect.Message {
	mi := &file_vega_vega_proto_msgTypes[40]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SpotLiquidityProvision.ProtoReflect.Descriptor instead.
func (*SpotLiquidityProvision) Descriptor() ([]byte, []int) {
	return file_vega_vega_proto_rawDescGZIP(), []int{40}
}

func (x *SpotLiquidityProvision) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *SpotLiquidityProvision) GetPartyId() string {
	if x != nil {
		return x.PartyId
	}
	return ""
...
func (x *SpotLiquidityProvision) GetCreatedAt() int64 {
	if x != nil {
		return x.CreatedAt
	}
	return 0
...
func (x *SpotLiquidityProvision) GetUpdatedAt() int64 {
	if x != nil {
		return x.UpdatedAt
	}
	return 0
...
func (x *SpotLiquidityProvision) GetMarketId() string {
	if x != nil {
		return x.MarketId
	}
	return ""
...
func (x *SpotLiquidityProvision) GetBuyCommitmentAmount() string {
	if x != nil {
...
func (x *SpotLiquidityProvision) GetSellCommitmentAmount() string {
	if x != nil {
...
func (x *SpotLiquidityProvision) GetFee() string {
	if x != nil {
		return x.Fee
	}
	return ""
...
func (x *SpotLiquidityProvision) GetVersion() uint64 {
	if x != nil {
		return x.Version
	}
	return 0
...
func (x *SpotLiquidityProvision) GetStatus() SpotLiquidityProvision_Status {
	if x != nil {
		return x.Status
	}
	return SpotLiquidityProvision_STATUS_UNSPECIFIED
}
...
var file_vega_vega_proto_rawDesc = []byte{
	...
	0x49, 0x4e, 0x47, 0x10, 0x06, 0x22, 0x91, 0x04, 0x0a, 0x16, 0x53, 0x70, 0x6f, 0x74, 0x4c, 0x69,
	...
	0x72, 0x6b, 0x65, 0x74, 0x49, 0x64, 0x12, 0x32, 0x0a, 0x15, 0x62, 0x75, 0x79, 0x5f, 0x63, 0x6f,
	0x6d, 0x6d, 0x69, 0x74, 0x6d, 0x65, 0x6e, 0x74, 0x5f, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x18,
	0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x13, 0x62, 0x75, 0x79, 0x43, 0x6f, 0x6d, 0x6d, 0x69, 0x74,
	0x6d, 0x65, 0x6e, 0x74, 0x41, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x34, 0x0a, 0x16, 0x73, 0x65,
	0x6c, 0x6c, 0x5f, 0x63, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x6d, 0x65, 0x6e, 0x74, 0x5f, 0x61, 0x6d,
	0x6f, 0x75, 0x6e, 0x74, 0x18, 0x07, 0x20, 0x01, 0x28, 0x09, 0x52, 0x14, 0x73, 0x65, 0x6c, 0x6c,
	...
	0x65, 0x65, 0x12, 0x18, 0x0a, 0x07, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x18, 0x09, 0x20,
	0x01, 0x28, 0x04, 0x52, 0x07, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x3b, 0x0a, 0x06,
	0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x23, 0x2e, 0x76,
	0x65, 0x67, 0x61, 0x2e, 0x53, 0x70, 0x6f, 0x74, 0x4c, 0x69, 0x71, 0x75, 0x69, 0x64, 0x69, 0x74,
	0x79, 0x50, 0x72, 0x6f, 0x76, 0x69, 0x73, 0x69, 0x6f, 0x6e, 0x2e, 0x53, 0x74, 0x61, 0x74, 0x75,
	0x73, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x22, 0x9d, 0x01, 0x0a, 0x06, 0x53, 0x74,
	...
	0x53, 0x65, 0x71, 0x22, 0xfb, 0x01, 0x0a, 0x06, 0x52, 0x65, 0x77, 0x61, 0x72, 0x64, 0x12, 0x19,
	0x0a, 0x08, 0x61, 0x73, 0x73, 0x65, 0x74, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09,
	...
	0x65, 0x22, 0x5d, 0x0a, 0x0d, 0x52, 0x65, 0x77, 0x61, 0x72, 0x64, 0x53, 0x75, 0x6d, 0x6d, 0x61,
	...
	0x74, 0x6f, 0x72, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x2a,
	...
	0x54, 0x52, 0x45, 0x53, 0x53, 0x45, 0x44, 0x10, 0x04, 0x2a, 0x81, 0x02, 0x0a, 0x0e, 0x41, 0x75,
	...
	0x47, 0x45, 0x54, 0x5f, 0x4e, 0x4f, 0x54, 0x5f, 0x4d, 0x45, 0x54, 0x10, 0x05, 0x12, 0x2e, 0x0a,
	...
	0x59, 0x5f, 0x4c, 0x50, 0x5f, 0x4f, 0x52, 0x44, 0x45, 0x52, 0x53, 0x10, 0x06, 0x2a, 0x8b, 0x01,
	...
	0x5f, 0x42, 0x45, 0x53, 0x54, 0x5f, 0x41, 0x53, 0x4b, 0x10, 0x03, 0x2a, 0xc9, 0x10, 0x0a, 0x0a,
	...
	0x5f, 0x50, 0x4f, 0x53, 0x49, 0x54, 0x49, 0x4f, 0x4e, 0x10, 0x32, 0x22, 0x04, 0x08, 0x26, 0x10,
	...
	0x5f, 0x43, 0x4f, 0x4e, 0x4e, 0x45, 0x43, 0x54, 0x45, 0x44, 0x10, 0x03, 0x2a, 0xde, 0x04, 0x0a,
	...
	0x4c, 0x44, 0x49, 0x4e, 0x47, 0x10, 0x12, 0x22, 0x04, 0x08, 0x08, 0x10, 0x08, 0x2a, 0xd4, 0x07,
	...
	0x41, 0x43, 0x54, 0x49, 0x4f, 0x4e, 0x10, 0x1d, 0x22, 0x04, 0x08, 0x03, 0x10, 0x03, 0x22, 0x04,
...
var file_vega_vega_proto_enumTypes = make([]protoimpl.EnumInfo, 21)
...
var file_vega_vega_proto_goTypes = []interface{}{
	...
	(SpotLiquidityProvision_Status)(0),    // 20: vega.SpotLiquidityProvision.Status
	(*Party)(nil),                         // 21: vega.Party
	(*RiskFactor)(nil),                    // 22: vega.RiskFactor
	(*PeggedOrder)(nil),                   // 23: vega.PeggedOrder
	(*IcebergOrder)(nil),                  // 24: vega.IcebergOrder
	(*Order)(nil),                         // 25: vega.Order
	(*OrderCancellationConfirmation)(nil), // 26: vega.OrderCancellationConfirmation
	(*OrderConfirmation)(nil),             // 27: vega.OrderConfirmation
	(*AuctionIndicativeState)(nil),        // 28: vega.AuctionIndicativeState
	(*Trade)(nil),                         // 29: vega.Trade
	(*Fee)(nil),                           // 30: vega.Fee
	(*TradeSet)(nil),                      // 31: vega.TradeSet
	(*Candle)(nil),                        // 32: vega.Candle
	(*PriceLevel)(nil),                    // 33: vega.PriceLevel
	(*MarketDepth)(nil),                   // 34: vega.MarketDepth
	(*MarketDepthUpdate)(nil),             // 35: vega.MarketDepthUpdate
	(*Position)(nil),                      // 36: vega.Position
	(*PositionTrade)(nil),                 // 37: vega.PositionTrade
	(*Deposit)(nil),                       // 38: vega.Deposit
	(*Withdrawal)(nil),                    // 39: vega.Withdrawal
	(*WithdrawExt)(nil),                   // 40: vega.WithdrawExt
	(*Erc20WithdrawExt)(nil),              // 41: vega.Erc20WithdrawExt
	(*Account)(nil),                       // 42: vega.Account
	(*FinancialAmount)(nil),               // 43: vega.FinancialAmount
	(*Transfer)(nil),                      // 44: vega.Transfer
	(*DispatchStrategy)(nil),              // 45: vega.DispatchStrategy
	(*TransferRequest)(nil),               // 46: vega.TransferRequest
	(*AccountDetails)(nil),                // 47: vega.AccountDetails
	(*LedgerEntry)(nil),                   // 48: vega.LedgerEntry
	(*PostTransferBalance)(nil),           // 49: vega.PostTransferBalance
	(*LedgerMovement)(nil),                // 50: vega.LedgerMovement
	(*MarginLevels)(nil),                  // 51: vega.MarginLevels
	(*MarketData)(nil),                    // 52: vega.MarketData
	(*LiquidityProviderFeeShare)(nil),     // 53: vega.LiquidityProviderFeeShare
	(*PriceMonitoringBounds)(nil),         // 54: vega.PriceMonitoringBounds
	(*ErrorDetail)(nil),                   // 55: vega.ErrorDetail
	(*NetworkParameter)(nil),              // 56: vega.NetworkParameter
	(*NetworkLimits)(nil),                 // 57: vega.NetworkLimits
	(*LiquidityOrder)(nil),                // 58: vega.LiquidityOrder
	(*LiquidityOrderReference)(nil),       // 59: vega.LiquidityOrderReference
	(*LiquidityProvision)(nil),            // 60: vega.LiquidityProvision
	(*SpotLiquidityProvision)(nil),        // 61: vega.SpotLiquidityProvision
	(*EthereumConfig)(nil),                // 62: vega.EthereumConfig
	(*EthereumContractConfig)(nil),        // 63: vega.EthereumContractConfig
	(*EpochTimestamps)(nil),               // 64: vega.EpochTimestamps
	(*Epoch)(nil),                         // 65: vega.Epoch
	(*EpochParticipation)(nil),            // 66: vega.EpochParticipation
	(*EpochData)(nil),                     // 67: vega.EpochData
	(*RankingScore)(nil),                  // 68: vega.RankingScore
	(*RewardScore)(nil),                   // 69: vega.RewardScore
	(*Node)(nil),                          // 70: vega.Node
	(*NodeSet)(nil),                       // 71: vega.NodeSet
	(*NodeData)(nil),                      // 72: vega.NodeData
	(*Delegation)(nil),                    // 73: vega.Delegation
	(*Reward)(nil),                        // 74: vega.Reward
	(*RewardSummary)(nil),                 // 75: vega.RewardSummary
	(*EpochRewardSummary)(nil),            // 76: vega.EpochRewardSummary
	(*StateValueProposal)(nil),            // 77: vega.StateValueProposal
	(*KeyValueBundle)(nil),                // 78: vega.KeyValueBundle
	(*StateVarValue)(nil),                 // 79: vega.StateVarValue
	(*ScalarValue)(nil),                   // 80: vega.ScalarValue
	(*VectorValue)(nil),                   // 81: vega.VectorValue
	(*MatrixValue)(nil),                   // 82: vega.MatrixValue
	(Market_TradingMode)(0),               // 83: vega.Market.TradingMode
	(Market_State)(0),                     // 84: vega.Market.State
	(*PriceMonitoringTrigger)(nil),        // 85: vega.PriceMonitoringTrigger
}
var file_vega_vega_proto_depIdxs = []int32{
	...
	23, // 6: vega.Order.pegged_order:type_name -> vega.PeggedOrder
	24, // 7: vega.Order.iceberg_order:type_name -> vega.IcebergOrder
	25, // 8: vega.OrderCancellationConfirmation.order:type_name -> vega.Order
	25, // 9: vega.OrderConfirmation.order:type_name -> vega.Order
	29, // 10: vega.OrderConfirmation.trades:type_name -> vega.Trade
	25, // 11: vega.OrderConfirmation.passive_orders_affected:type_name -> vega.Order
	0,  // 12: vega.Trade.aggressor:type_name -> vega.Side
	16, // 13: vega.Trade.type:type_name -> vega.Trade.Type
	30, // 14: vega.Trade.buyer_fee:type_name -> vega.Fee
	30, // 15: vega.Trade.seller_fee:type_name -> vega.Fee
	29, // 16: vega.TradeSet.trades:type_name -> vega.Trade
	1,  // 17: vega.Candle.interval:type_name -> vega.Interval
	33, // 18: vega.MarketDepth.buy:type_name -> vega.PriceLevel
	33, // 19: vega.MarketDepth.sell:type_name -> vega.PriceLevel
	33, // 20: vega.MarketDepthUpdate.buy:type_name -> vega.PriceLevel
	33, // 21: vega.MarketDepthUpdate.sell:type_name -> vega.PriceLevel
	2,  // 22: vega.Position.position_status:type_name -> vega.PositionStatus
	17, // 23: vega.Deposit.status:type_name -> vega.Deposit.Status
	18, // 24: vega.Withdrawal.status:type_name -> vega.Withdrawal.Status
	40, // 25: vega.Withdrawal.ext:type_name -> vega.WithdrawExt
	41, // 26: vega.WithdrawExt.erc20:type_name -> vega.Erc20WithdrawExt
	7,  // 27: vega.Account.type:type_name -> vega.AccountType
	43, // 28: vega.Transfer.amount:type_name -> vega.FinancialAmount
	8,  // 29: vega.Transfer.type:type_name -> vega.TransferType
	9,  // 30: vega.DispatchStrategy.metric:type_name -> vega.DispatchMetric
	42, // 31: vega.TransferRequest.from_account:type_name -> vega.Account
	42, // 32: vega.TransferRequest.to_account:type_name -> vega.Account
	8,  // 33: vega.TransferRequest.type:type_name -> vega.TransferType
	7,  // 34: vega.AccountDetails.type:type_name -> vega.AccountType
	47, // 35: vega.LedgerEntry.from_account:type_name -> vega.AccountDetails
	47, // 36: vega.LedgerEntry.to_account:type_name -> vega.AccountDetails
	8,  // 37: vega.LedgerEntry.type:type_name -> vega.TransferType
	47, // 38: vega.PostTransferBalance.account:type_name -> vega.AccountDetails
	48, // 39: vega.LedgerMovement.entries:type_name -> vega.LedgerEntry
	49, // 40: vega.LedgerMovement.balances:type_name -> vega.PostTransferBalance
	83, // 41: vega.MarketData.market_trading_mode:type_name -> vega.Market.TradingMode
	3,  // 42: vega.MarketData.trigger:type_name -> vega.AuctionTrigger
	3,  // 43: vega.MarketData.extension_trigger:type_name -> vega.AuctionTrigger
	54, // 44: vega.MarketData.price_monitoring_bounds:type_name -> vega.PriceMonitoringBounds
	53, // 45: vega.MarketData.liquidity_provider_fee_share:type_name -> vega.LiquidityProviderFeeShare
	84, // 46: vega.MarketData.market_state:type_name -> vega.Market.State
	85, // 47: vega.PriceMonitoringBounds.trigger:type_name -> vega.PriceMonitoringTrigger
	4,  // 48: vega.LiquidityOrder.reference:type_name -> vega.PeggedReference
	58, // 49: vega.LiquidityOrderReference.liquidity_order:type_name -> vega.LiquidityOrder
	59, // 50: vega.LiquidityProvision.sells:type_name -> vega.LiquidityOrderReference
	59, // 51: vega.LiquidityProvision.buys:type_name -> vega.LiquidityOrderReference
	19, // 52: vega.LiquidityProvision.status:type_name -> vega.LiquidityProvision.Status
	20, // 53: vega.SpotLiquidityProvision.status:type_name -> vega.SpotLiquidityProvision.Status
	63, // 54: vega.EthereumConfig.collateral_bridge_contract:type_name -> vega.EthereumContractConfig
	63, // 55: vega.EthereumConfig.staking_bridge_contract:type_name -> vega.EthereumContractConfig
	63, // 56: vega.EthereumConfig.token_vesting_contract:type_name -> vega.EthereumContractConfig
	63, // 57: vega.EthereumConfig.multisig_control_contract:type_name -> vega.EthereumContractConfig
	64, // 58: vega.Epoch.timestamps:type_name -> vega.EpochTimestamps
	70, // 59: vega.Epoch.validators:type_name -> vega.Node
	73, // 60: vega.Epoch.delegations:type_name -> vega.Delegation
	65, // 61: vega.EpochParticipation.epoch:type_name -> vega.Epoch
	12, // 62: vega.RankingScore.previous_status:type_name -> vega.ValidatorNodeStatus
	12, // 63: vega.RankingScore.status:type_name -> vega.ValidatorNodeStatus
	12, // 64: vega.RewardScore.validator_status:type_name -> vega.ValidatorNodeStatus
	67, // 65: vega.Node.epoch_data:type_name -> vega.EpochData
	10, // 66: vega.Node.status:type_name -> vega.NodeStatus
	73, // 67: vega.Node.delegations:type_name -> vega.Delegation
	69, // 68: vega.Node.reward_score:type_name -> vega.RewardScore
	68, // 69: vega.Node.ranking_score:type_name -> vega.RankingScore
	71, // 70: vega.NodeData.tendermint_nodes:type_name -> vega.NodeSet
	71, // 71: vega.NodeData.ersatz_nodes:type_name -> vega.NodeSet
	71, // 72: vega.NodeData.pending_nodes:type_name -> vega.NodeSet
	78, // 73: vega.StateValueProposal.kvb:type_name -> vega.KeyValueBundle
	79, // 74: vega.KeyValueBundle.value:type_name -> vega.StateVarValue
	80, // 75: vega.StateVarValue.scalar_val:type_name -> vega.ScalarValue
	81, // 76: vega.StateVarValue.vector_val:type_name -> vega.VectorValue
	82, // 77: vega.StateVarValue.matrix_val:type_name -> vega.MatrixValue
	81, // 78: vega.MatrixValue.value:type_name -> vega.VectorValue
...
func file_vega_vega_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_vega_vega_proto_msgTypes[40].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SpotLiquidityProvision); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_vega_vega_proto_msgTypes[4].OneofWrappers = []interface{}{}
	file_vega_vega_proto_msgTypes[19].OneofWrappers = []interface{}{
		(*WithdrawExt_Erc20)(nil),
	}
	file_vega_vega_proto_msgTypes[26].OneofWrappers = []interface{}{}
