Feature: Amend orders
  ...
  Background:
    ...
    And the markets:
      ...
      | ETH/DEC19 | BTC        | BTC   | default-simple-risk-model-2 | default-overkill-margin-calculator | 1                | default-none | default-none     | default-eth-for-future | 2              | 1e6                    | 1e6                       | default-futures |
  ...
  Scenario: Reduce size success and not loosing position in order book
    ...
    Given the parties deposit on asset's general account the following amount:
      | party  | asset | amount      |
      | myboi  | BTC   | 1000000000  |
      | myboi2 | BTC   | 1000000000  |
      | myboi3 | BTC   | 1000000000  |
      | aux    | BTC   | 10000000000 |
      | aux2   | BTC   | 10000000000 |
