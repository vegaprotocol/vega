...
var file_data_node_api_v2_trading_data_proto_rawDesc = []byte{
	...
	0x75, 0x72, 0x73, 0x6f, 0x72, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x63, 0x75, 0x72,
	0x73, 0x6f, 0x72, 0x22, 0x0d, 0x0a, 0x0b, 0x50, 0x69, 0x6e, 0x67, 0x52, 0x65, 0x71, 0x75, 0x65,
	...
	0x10, 0x03, 0x32, 0x8b, 0x42, 0x0a, 0x12, 0x54, 0x72, 0x61, 0x64, 0x69, 0x6e, 0x67, 0x44, 0x61,
	...
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x30, 0x01, 0x12, 0x5e, 0x0a, 0x0d, 0x4c, 0x69, 0x73,
	...
	0x6f, 0x74, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x43, 0x0a, 0x04, 0x50,
	...
	0x32, 0x0b, 0x76, 0x30, 0x2e, 0x36, 0x35, 0x2e, 0x30, 0x2b, 0x64, 0x65, 0x76, 0x1a, 0x21, 0x6c,
...
var file_data_node_api_v2_trading_data_proto_msgTypes = make([]protoimpl.MessageInfo, 255)
var file_data_node_api_v2_trading_data_proto_goTypes = []interface{}{
	...
	(*PingRequest)(nil),                                   // 257: datanode.api.v2.PingRequest
	(*PingResponse)(nil),                                  // 258: datanode.api.v2.PingResponse
	(vega.AccountType)(0),                                 // 259: vega.AccountType
	(*vega.Order)(nil),                                    // 260: vega.Order
	(vega.Order_Status)(0),                                // 261: vega.Order.Status
	(vega.Order_Type)(0),                                  // 262: vega.Order.Type
	(vega.Order_TimeInForce)(0),                           // 263: vega.Order.TimeInForce
	...
	(*vega.EpochRewardSummary)(nil),                       // 284: vega.EpochRewardSummary
	(*vega.Deposit)(nil),                                  // 285: vega.Deposit
	(*vega.Withdrawal)(nil),                               // 286: vega.Withdrawal
	(*vega.Asset)(nil),                                    // 287: vega.Asset
	(*vega.LiquidityProvision)(nil),                       // 288: vega.LiquidityProvision
	(*vega.GovernanceData)(nil),                           // 289: vega.GovernanceData
	(vega.Proposal_State)(0),                              // 290: vega.Proposal.State
	(*vega.Delegation)(nil),                               // 291: vega.Delegation
	(*vega.NodeData)(nil),                                 // 292: vega.NodeData
	(*vega.Node)(nil),                                     // 293: vega.Node
	(*v11.NodeSignature)(nil),                             // 294: vega.commands.v1.NodeSignature
	(*vega.Epoch)(nil),                                    // 295: vega.Epoch
	(*vega.Fee)(nil),                                      // 296: vega.Fee
	(vega.Side)(0),                                        // 297: vega.Side
	...
	(*v1.CoreSnapshotData)(nil),                           // 308: vega.events.v1.CoreSnapshotData
}
var file_data_node_api_v2_trading_data_proto_depIdxs = []int32{
	259, // 0: datanode.api.v2.AccountBalance.type:type_name -> vega.AccountType
	...
	259, // 7: datanode.api.v2.ObserveAccountsRequest.type:type_name -> vega.AccountType
	...
	260, // 12: datanode.api.v2.GetOrderResponse.order:type_name -> vega.Order
	261, // 13: datanode.api.v2.OrderFilter.statuses:type_name -> vega.Order.Status
	262, // 14: datanode.api.v2.OrderFilter.types:type_name -> vega.Order.Type
	263, // 15: datanode.api.v2.OrderFilter.time_in_forces:type_name -> vega.Order.TimeInForce
	...
	260, // 24: datanode.api.v2.OrderSnapshotPage.orders:type_name -> vega.Order
	260, // 25: datanode.api.v2.OrderUpdates.orders:type_name -> vega.Order
	...
	264, // 28: datanode.api.v2.PositionEdge.node:type_name -> vega.Position
	...
	264, // 33: datanode.api.v2.PositionSnapshotPage.positions:type_name -> vega.Position
	264, // 34: datanode.api.v2.PositionUpdates.positions:type_name -> vega.Position
	...
	265, // 37: datanode.api.v2.LedgerEntryFilter.transfer_types:type_name -> vega.TransferType
	265, // 38: datanode.api.v2.AggregatedLedgerEntry.transfer_type:type_name -> vega.TransferType
	259, // 39: datanode.api.v2.AggregatedLedgerEntry.sender_account_type:type_name -> vega.AccountType
	259, // 40: datanode.api.v2.AggregatedLedgerEntry.receiver_account_type:type_name -> vega.AccountType
	...
	259, // 60: datanode.api.v2.AccountFilter.account_types:type_name -> vega.AccountType
	259, // 61: datanode.api.v2.AggregatedBalance.account_type:type_name -> vega.AccountType
	266, // 62: datanode.api.v2.ObserveMarketsDepthResponse.market_depth:type_name -> vega.MarketDepth
	267, // 63: datanode.api.v2.ObserveMarketsDepthUpdatesResponse.update:type_name -> vega.MarketDepthUpdate
	268, // 64: datanode.api.v2.ObserveMarketsDataResponse.market_data:type_name -> vega.MarketData
	269, // 65: datanode.api.v2.GetLatestMarketDepthResponse.buy:type_name -> vega.PriceLevel
	269, // 66: datanode.api.v2.GetLatestMarketDepthResponse.sell:type_name -> vega.PriceLevel
	270, // 67: datanode.api.v2.GetLatestMarketDepthResponse.last_trade:type_name -> vega.Trade
	268, // 68: datanode.api.v2.ListLatestMarketDataResponse.markets_data:type_name -> vega.MarketData
	268, // 69: datanode.api.v2.GetLatestMarketDataResponse.market_data:type_name -> vega.MarketData
	...
	268, // 73: datanode.api.v2.MarketDataEdge.node:type_name -> vega.MarketData
	...
	268, // 76: datanode.api.v2.MarketsDataSubscribeResponse.market_data:type_name -> vega.MarketData
	...
	271, // 80: datanode.api.v2.TransferEdge.node:type_name -> vega.events.v1.Transfer
	...
	272, // 83: datanode.api.v2.GetNetworkLimitsResponse.limits:type_name -> vega.NetworkLimits
	...
	273, // 86: datanode.api.v2.ListCandleDataRequest.interval:type_name -> vega.Interval
	...
	274, // 94: datanode.api.v2.VoteEdge.node:type_name -> vega.Vote
	...
	274, // 97: datanode.api.v2.ObserveVotesResponse.vote:type_name -> vega.Vote
	...
	275, // 100: datanode.api.v2.ERC20MultiSigSignerAddedEdge.node:type_name -> vega.events.v1.ERC20MultiSigSignerAdded
	...
	276, // 106: datanode.api.v2.ERC20MultiSigSignerRemovedEdge.node:type_name -> vega.events.v1.ERC20MultiSigSignerRemoved
	...
	270, // 110: datanode.api.v2.GetLastTradeResponse.trade:type_name -> vega.Trade
	...
	270, // 116: datanode.api.v2.TradeEdge.node:type_name -> vega.Trade
	270, // 117: datanode.api.v2.ObserveTradesResponse.trades:type_name -> vega.Trade
	277, // 118: datanode.api.v2.GetOracleSpecResponse.oracle_spec:type_name -> vega.OracleSpec
	...
	277, // 123: datanode.api.v2.OracleSpecEdge.node:type_name -> vega.OracleSpec
	...
	278, // 126: datanode.api.v2.OracleDataEdge.node:type_name -> vega.OracleData
	...
	279, // 129: datanode.api.v2.GetMarketResponse.market:type_name -> vega.Market
	...
	279, // 132: datanode.api.v2.MarketEdge.node:type_name -> vega.Market
	...
	280, // 135: datanode.api.v2.GetPartyResponse.party:type_name -> vega.Party
	...
	280, // 138: datanode.api.v2.PartyEdge.node:type_name -> vega.Party
	...
	260, // 141: datanode.api.v2.OrderEdge.node:type_name -> vega.Order
	...
	281, // 144: datanode.api.v2.ObserveMarginLevelsResponse.margin_levels:type_name -> vega.MarginLevels
	...
	281, // 147: datanode.api.v2.MarginEdge.node:type_name -> vega.MarginLevels
	...
	282, // 152: datanode.api.v2.RewardEdge.node:type_name -> vega.Reward
	...
	283, // 156: datanode.api.v2.ListRewardSummariesResponse.summaries:type_name -> vega.RewardSummary
	...
	284, // 161: datanode.api.v2.EpochRewardSummaryEdge.node:type_name -> vega.EpochRewardSummary
	282, // 162: datanode.api.v2.ObserveRewardsResponse.reward:type_name -> vega.Reward
	285, // 163: datanode.api.v2.GetDepositResponse.deposit:type_name -> vega.Deposit
	...
	285, // 167: datanode.api.v2.DepositEdge.node:type_name -> vega.Deposit
	...
	286, // 170: datanode.api.v2.GetWithdrawalResponse.withdrawal:type_name -> vega.Withdrawal
	...
	286, // 174: datanode.api.v2.WithdrawalEdge.node:type_name -> vega.Withdrawal
	...
	287, // 177: datanode.api.v2.GetAssetResponse.asset:type_name -> vega.Asset
	...
	287, // 180: datanode.api.v2.AssetEdge.node:type_name -> vega.Asset
	...
	288, // 185: datanode.api.v2.LiquidityProvisionsEdge.node:type_name -> vega.LiquidityProvision
	...
	288, // 188: datanode.api.v2.ObserveLiquidityProvisionsResponse.liquidity_provisions:type_name -> vega.LiquidityProvision
	289, // 189: datanode.api.v2.GetGovernanceDataResponse.data:type_name -> vega.GovernanceData
	290, // 190: datanode.api.v2.ListGovernanceDataRequest.proposal_state:type_name -> vega.Proposal.State
	...
	289, // 194: datanode.api.v2.GovernanceDataEdge.node:type_name -> vega.GovernanceData
	...
	289, // 197: datanode.api.v2.ObserveGovernanceResponse.data:type_name -> vega.GovernanceData
	...
	291, // 200: datanode.api.v2.DelegationEdge.node:type_name -> vega.Delegation
	...
	291, // 203: datanode.api.v2.ObserveDelegationsResponse.delegation:type_name -> vega.Delegation
	292, // 204: datanode.api.v2.GetNetworkDataResponse.node_data:type_name -> vega.NodeData
	293, // 205: datanode.api.v2.GetNodeResponse.node:type_name -> vega.Node
	...
	293, // 208: datanode.api.v2.NodeEdge.node:type_name -> vega.Node
	...
	294, // 213: datanode.api.v2.NodeSignatureEdge.node:type_name -> vega.commands.v1.NodeSignature
	...
	295, // 216: datanode.api.v2.GetEpochResponse.epoch:type_name -> vega.Epoch
	296, // 217: datanode.api.v2.EstimateFeeResponse.fee:type_name -> vega.Fee
	297, // 218: datanode.api.v2.EstimateMarginRequest.side:type_name -> vega.Side
	262, // 219: datanode.api.v2.EstimateMarginRequest.type:type_name -> vega.Order.Type
	281, // 220: datanode.api.v2.EstimateMarginResponse.margin_levels:type_name -> vega.MarginLevels
	...
	298, // 223: datanode.api.v2.GetNetworkParameterResponse.network_parameter:type_name -> vega.NetworkParameter
	298, // 224: datanode.api.v2.NetworkParameterEdge.node:type_name -> vega.NetworkParameter
	...
	299, // 234: datanode.api.v2.StakeLinkingEdge.node:type_name -> vega.events.v1.StakeLinking
	...
	300, // 237: datanode.api.v2.GetRiskFactorsResponse.risk_factor:type_name -> vega.RiskFactor
	301, // 238: datanode.api.v2.ObserveEventBusRequest.type:type_name -> vega.events.v1.BusEventType
	302, // 239: datanode.api.v2.ObserveEventBusResponse.events:type_name -> vega.events.v1.BusEvent
	303, // 240: datanode.api.v2.ObserveLedgerMovementsResponse.ledger_movement:type_name -> vega.LedgerMovement
	...
	304, // 243: datanode.api.v2.KeyRotationEdge.node:type_name -> vega.events.v1.KeyRotation
	...
	305, // 250: datanode.api.v2.EthereumKeyRotationEdge.node:type_name -> vega.events.v1.EthereumKeyRotation
	306, // 251: datanode.api.v2.ListProtocolUpgradeProposalsRequest.status:type_name -> vega.events.v1.ProtocolUpgradeProposalStatus
	...
	307, // 256: datanode.api.v2.ProtocolUpgradeProposalEdge.node:type_name -> vega.events.v1.ProtocolUpgradeEvent
	...
	308, // 261: datanode.api.v2.CoreSnapshotEdge.node:type_name -> vega.events.v1.CoreSnapshotData
	8,   // 262: datanode.api.v2.TradingDataService.ListAccounts:input_type -> datanode.api.v2.ListAccountsRequest
	12,  // 263: datanode.api.v2.TradingDataService.ObserveAccounts:input_type -> datanode.api.v2.ObserveAccountsRequest
	16,  // 264: datanode.api.v2.TradingDataService.Info:input_type -> datanode.api.v2.InfoRequest
	18,  // 265: datanode.api.v2.TradingDataService.GetOrder:input_type -> datanode.api.v2.GetOrderRequest
	21,  // 266: datanode.api.v2.TradingDataService.ListOrders:input_type -> datanode.api.v2.ListOrdersRequest
	23,  // 267: datanode.api.v2.TradingDataService.ListOrderVersions:input_type -> datanode.api.v2.ListOrderVersionsRequest
	25,  // 268: datanode.api.v2.TradingDataService.ObserveOrders:input_type -> datanode.api.v2.ObserveOrdersRequest
	29,  // 269: datanode.api.v2.TradingDataService.ListPositions:input_type -> datanode.api.v2.ListPositionsRequest
	33,  // 270: datanode.api.v2.TradingDataService.ObservePositions:input_type -> datanode.api.v2.ObservePositionsRequest
	39,  // 271: datanode.api.v2.TradingDataService.ListLedgerEntries:input_type -> datanode.api.v2.ListLedgerEntriesRequest
	43,  // 272: datanode.api.v2.TradingDataService.ListBalanceChanges:input_type -> datanode.api.v2.ListBalanceChangesRequest
	61,  // 273: datanode.api.v2.TradingDataService.GetLatestMarketData:input_type -> datanode.api.v2.GetLatestMarketDataRequest
	59,  // 274: datanode.api.v2.TradingDataService.ListLatestMarketData:input_type -> datanode.api.v2.ListLatestMarketDataRequest
	57,  // 275: datanode.api.v2.TradingDataService.GetLatestMarketDepth:input_type -> datanode.api.v2.GetLatestMarketDepthRequest
	51,  // 276: datanode.api.v2.TradingDataService.ObserveMarketsDepth:input_type -> datanode.api.v2.ObserveMarketsDepthRequest
	53,  // 277: datanode.api.v2.TradingDataService.ObserveMarketsDepthUpdates:input_type -> datanode.api.v2.ObserveMarketsDepthUpdatesRequest
	55,  // 278: datanode.api.v2.TradingDataService.ObserveMarketsData:input_type -> datanode.api.v2.ObserveMarketsDataRequest
	63,  // 279: datanode.api.v2.TradingDataService.GetMarketDataHistoryByID:input_type -> datanode.api.v2.GetMarketDataHistoryByIDRequest
	69,  // 280: datanode.api.v2.TradingDataService.ListTransfers:input_type -> datanode.api.v2.ListTransfersRequest
	73,  // 281: datanode.api.v2.TradingDataService.GetNetworkLimits:input_type -> datanode.api.v2.GetNetworkLimitsRequest
	81,  // 282: datanode.api.v2.TradingDataService.ListCandleData:input_type -> datanode.api.v2.ListCandleDataRequest
	79,  // 283: datanode.api.v2.TradingDataService.ObserveCandleData:input_type -> datanode.api.v2.ObserveCandleDataRequest
	75,  // 284: datanode.api.v2.TradingDataService.ListCandleIntervals:input_type -> datanode.api.v2.ListCandleIntervalsRequest
	85,  // 285: datanode.api.v2.TradingDataService.ListVotes:input_type -> datanode.api.v2.ListVotesRequest
	89,  // 286: datanode.api.v2.TradingDataService.ObserveVotes:input_type -> datanode.api.v2.ObserveVotesRequest
	91,  // 287: datanode.api.v2.TradingDataService.ListERC20MultiSigSignerAddedBundles:input_type -> datanode.api.v2.ListERC20MultiSigSignerAddedBundlesRequest
	97,  // 288: datanode.api.v2.TradingDataService.ListERC20MultiSigSignerRemovedBundles:input_type -> datanode.api.v2.ListERC20MultiSigSignerRemovedBundlesRequest
	103, // 289: datanode.api.v2.TradingDataService.GetERC20ListAssetBundle:input_type -> datanode.api.v2.GetERC20ListAssetBundleRequest
	105, // 290: datanode.api.v2.TradingDataService.GetERC20SetAssetLimitsBundle:input_type -> datanode.api.v2.GetERC20SetAssetLimitsBundleRequest
	107, // 291: datanode.api.v2.TradingDataService.GetERC20WithdrawalApproval:input_type -> datanode.api.v2.GetERC20WithdrawalApprovalRequest
	109, // 292: datanode.api.v2.TradingDataService.GetLastTrade:input_type -> datanode.api.v2.GetLastTradeRequest
	111, // 293: datanode.api.v2.TradingDataService.ListTrades:input_type -> datanode.api.v2.ListTradesRequest
	115, // 294: datanode.api.v2.TradingDataService.ObserveTrades:input_type -> datanode.api.v2.ObserveTradesRequest
	117, // 295: datanode.api.v2.TradingDataService.GetOracleSpec:input_type -> datanode.api.v2.GetOracleSpecRequest
	119, // 296: datanode.api.v2.TradingDataService.ListOracleSpecs:input_type -> datanode.api.v2.ListOracleSpecsRequest
	121, // 297: datanode.api.v2.TradingDataService.ListOracleData:input_type -> datanode.api.v2.ListOracleDataRequest
	127, // 298: datanode.api.v2.TradingDataService.GetMarket:input_type -> datanode.api.v2.GetMarketRequest
	129, // 299: datanode.api.v2.TradingDataService.ListMarkets:input_type -> datanode.api.v2.ListMarketsRequest
	133, // 300: datanode.api.v2.TradingDataService.GetParty:input_type -> datanode.api.v2.GetPartyRequest
	135, // 301: datanode.api.v2.TradingDataService.ListParties:input_type -> datanode.api.v2.ListPartiesRequest
	140, // 302: datanode.api.v2.TradingDataService.ListMarginLevels:input_type -> datanode.api.v2.ListMarginLevelsRequest
	142, // 303: datanode.api.v2.TradingDataService.ObserveMarginLevels:input_type -> datanode.api.v2.ObserveMarginLevelsRequest
	147, // 304: datanode.api.v2.TradingDataService.ListRewards:input_type -> datanode.api.v2.ListRewardsRequest
	151, // 305: datanode.api.v2.TradingDataService.ListRewardSummaries:input_type -> datanode.api.v2.ListRewardSummariesRequest
	153, // 306: datanode.api.v2.TradingDataService.ListEpochRewardSummaries:input_type -> datanode.api.v2.ListEpochRewardSummariesRequest
	157, // 307: datanode.api.v2.TradingDataService.ObserveRewards:input_type -> datanode.api.v2.ObserveRewardsRequest
	159, // 308: datanode.api.v2.TradingDataService.GetDeposit:input_type -> datanode.api.v2.GetDepositRequest
	161, // 309: datanode.api.v2.TradingDataService.ListDeposits:input_type -> datanode.api.v2.ListDepositsRequest
	165, // 310: datanode.api.v2.TradingDataService.GetWithdrawal:input_type -> datanode.api.v2.GetWithdrawalRequest
	167, // 311: datanode.api.v2.TradingDataService.ListWithdrawals:input_type -> datanode.api.v2.ListWithdrawalsRequest
	171, // 312: datanode.api.v2.TradingDataService.GetAsset:input_type -> datanode.api.v2.GetAssetRequest
	173, // 313: datanode.api.v2.TradingDataService.ListAssets:input_type -> datanode.api.v2.ListAssetsRequest
	177, // 314: datanode.api.v2.TradingDataService.ListLiquidityProvisions:input_type -> datanode.api.v2.ListLiquidityProvisionsRequest
	181, // 315: datanode.api.v2.TradingDataService.ObserveLiquidityProvisions:input_type -> datanode.api.v2.ObserveLiquidityProvisionsRequest
	183, // 316: datanode.api.v2.TradingDataService.GetGovernanceData:input_type -> datanode.api.v2.GetGovernanceDataRequest
	185, // 317: datanode.api.v2.TradingDataService.ListGovernanceData:input_type -> datanode.api.v2.ListGovernanceDataRequest
	189, // 318: datanode.api.v2.TradingDataService.ObserveGovernance:input_type -> datanode.api.v2.ObserveGovernanceRequest
	191, // 319: datanode.api.v2.TradingDataService.ListDelegations:input_type -> datanode.api.v2.ListDelegationsRequest
	195, // 320: datanode.api.v2.TradingDataService.ObserveDelegations:input_type -> datanode.api.v2.ObserveDelegationsRequest
	197, // 321: datanode.api.v2.TradingDataService.GetNetworkData:input_type -> datanode.api.v2.GetNetworkDataRequest
	199, // 322: datanode.api.v2.TradingDataService.GetNode:input_type -> datanode.api.v2.GetNodeRequest
	201, // 323: datanode.api.v2.TradingDataService.ListNodes:input_type -> datanode.api.v2.ListNodesRequest
	205, // 324: datanode.api.v2.TradingDataService.ListNodeSignatures:input_type -> datanode.api.v2.ListNodeSignaturesRequest
	209, // 325: datanode.api.v2.TradingDataService.GetEpoch:input_type -> datanode.api.v2.GetEpochRequest
	211, // 326: datanode.api.v2.TradingDataService.EstimateFee:input_type -> datanode.api.v2.EstimateFeeRequest
	213, // 327: datanode.api.v2.TradingDataService.EstimateMargin:input_type -> datanode.api.v2.EstimateMarginRequest
	215, // 328: datanode.api.v2.TradingDataService.ListNetworkParameters:input_type -> datanode.api.v2.ListNetworkParametersRequest
	217, // 329: datanode.api.v2.TradingDataService.GetNetworkParameter:input_type -> datanode.api.v2.GetNetworkParameterRequest
	222, // 330: datanode.api.v2.TradingDataService.ListCheckpoints:input_type -> datanode.api.v2.ListCheckpointsRequest
	226, // 331: datanode.api.v2.TradingDataService.GetStake:input_type -> datanode.api.v2.GetStakeRequest
	230, // 332: datanode.api.v2.TradingDataService.GetRiskFactors:input_type -> datanode.api.v2.GetRiskFactorsRequest
	232, // 333: datanode.api.v2.TradingDataService.ObserveEventBus:input_type -> datanode.api.v2.ObserveEventBusRequest
	234, // 334: datanode.api.v2.TradingDataService.ObserveLedgerMovements:input_type -> datanode.api.v2.ObserveLedgerMovementsRequest
	236, // 335: datanode.api.v2.TradingDataService.ListKeyRotations:input_type -> datanode.api.v2.ListKeyRotationsRequest
	240, // 336: datanode.api.v2.TradingDataService.ListEthereumKeyRotations:input_type -> datanode.api.v2.ListEthereumKeyRotationsRequest
	244, // 337: datanode.api.v2.TradingDataService.GetVegaTime:input_type -> datanode.api.v2.GetVegaTimeRequest
	247, // 338: datanode.api.v2.TradingDataService.GetProtocolUpgradeStatus:input_type -> datanode.api.v2.GetProtocolUpgradeStatusRequest
	249, // 339: datanode.api.v2.TradingDataService.ListProtocolUpgradeProposals:input_type -> datanode.api.v2.ListProtocolUpgradeProposalsRequest
	253, // 340: datanode.api.v2.TradingDataService.ListCoreSnapshots:input_type -> datanode.api.v2.ListCoreSnapshotsRequest
	257, // 341: datanode.api.v2.TradingDataService.Ping:input_type -> datanode.api.v2.PingRequest
	9,   // 342: datanode.api.v2.TradingDataService.ListAccounts:output_type -> datanode.api.v2.ListAccountsResponse
	13,  // 343: datanode.api.v2.TradingDataService.ObserveAccounts:output_type -> datanode.api.v2.ObserveAccountsResponse
	17,  // 344: datanode.api.v2.TradingDataService.Info:output_type -> datanode.api.v2.InfoResponse
	19,  // 345: datanode.api.v2.TradingDataService.GetOrder:output_type -> datanode.api.v2.GetOrderResponse
	22,  // 346: datanode.api.v2.TradingDataService.ListOrders:output_type -> datanode.api.v2.ListOrdersResponse
	24,  // 347: datanode.api.v2.TradingDataService.ListOrderVersions:output_type -> datanode.api.v2.ListOrderVersionsResponse
	26,  // 348: datanode.api.v2.TradingDataService.ObserveOrders:output_type -> datanode.api.v2.ObserveOrdersResponse
	30,  // 349: datanode.api.v2.TradingDataService.ListPositions:output_type -> datanode.api.v2.ListPositionsResponse
	34,  // 350: datanode.api.v2.TradingDataService.ObservePositions:output_type -> datanode.api.v2.ObservePositionsResponse
	40,  // 351: datanode.api.v2.TradingDataService.ListLedgerEntries:output_type -> datanode.api.v2.ListLedgerEntriesResponse
	44,  // 352: datanode.api.v2.TradingDataService.ListBalanceChanges:output_type -> datanode.api.v2.ListBalanceChangesResponse
	62,  // 353: datanode.api.v2.TradingDataService.GetLatestMarketData:output_type -> datanode.api.v2.GetLatestMarketDataResponse
	60,  // 354: datanode.api.v2.TradingDataService.ListLatestMarketData:output_type -> datanode.api.v2.ListLatestMarketDataResponse
	58,  // 355: datanode.api.v2.TradingDataService.GetLatestMarketDepth:output_type -> datanode.api.v2.GetLatestMarketDepthResponse
	52,  // 356: datanode.api.v2.TradingDataService.ObserveMarketsDepth:output_type -> datanode.api.v2.ObserveMarketsDepthResponse
	54,  // 357: datanode.api.v2.TradingDataService.ObserveMarketsDepthUpdates:output_type -> datanode.api.v2.ObserveMarketsDepthUpdatesResponse
	56,  // 358: datanode.api.v2.TradingDataService.ObserveMarketsData:output_type -> datanode.api.v2.ObserveMarketsDataResponse
	64,  // 359: datanode.api.v2.TradingDataService.GetMarketDataHistoryByID:output_type -> datanode.api.v2.GetMarketDataHistoryByIDResponse
	70,  // 360: datanode.api.v2.TradingDataService.ListTransfers:output_type -> datanode.api.v2.ListTransfersResponse
	74,  // 361: datanode.api.v2.TradingDataService.GetNetworkLimits:output_type -> datanode.api.v2.GetNetworkLimitsResponse
	82,  // 362: datanode.api.v2.TradingDataService.ListCandleData:output_type -> datanode.api.v2.ListCandleDataResponse
	80,  // 363: datanode.api.v2.TradingDataService.ObserveCandleData:output_type -> datanode.api.v2.ObserveCandleDataResponse
	77,  // 364: datanode.api.v2.TradingDataService.ListCandleIntervals:output_type -> datanode.api.v2.ListCandleIntervalsResponse
	86,  // 365: datanode.api.v2.TradingDataService.ListVotes:output_type -> datanode.api.v2.ListVotesResponse
	90,  // 366: datanode.api.v2.TradingDataService.ObserveVotes:output_type -> datanode.api.v2.ObserveVotesResponse
	92,  // 367: datanode.api.v2.TradingDataService.ListERC20MultiSigSignerAddedBundles:output_type -> datanode.api.v2.ListERC20MultiSigSignerAddedBundlesResponse
	98,  // 368: datanode.api.v2.TradingDataService.ListERC20MultiSigSignerRemovedBundles:output_type -> datanode.api.v2.ListERC20MultiSigSignerRemovedBundlesResponse
	104, // 369: datanode.api.v2.TradingDataService.GetERC20ListAssetBundle:output_type -> datanode.api.v2.GetERC20ListAssetBundleResponse
	106, // 370: datanode.api.v2.TradingDataService.GetERC20SetAssetLimitsBundle:output_type -> datanode.api.v2.GetERC20SetAssetLimitsBundleResponse
	108, // 371: datanode.api.v2.TradingDataService.GetERC20WithdrawalApproval:output_type -> datanode.api.v2.GetERC20WithdrawalApprovalResponse
	110, // 372: datanode.api.v2.TradingDataService.GetLastTrade:output_type -> datanode.api.v2.GetLastTradeResponse
	112, // 373: datanode.api.v2.TradingDataService.ListTrades:output_type -> datanode.api.v2.ListTradesResponse
	116, // 374: datanode.api.v2.TradingDataService.ObserveTrades:output_type -> datanode.api.v2.ObserveTradesResponse
	118, // 375: datanode.api.v2.TradingDataService.GetOracleSpec:output_type -> datanode.api.v2.GetOracleSpecResponse
	120, // 376: datanode.api.v2.TradingDataService.ListOracleSpecs:output_type -> datanode.api.v2.ListOracleSpecsResponse
	122, // 377: datanode.api.v2.TradingDataService.ListOracleData:output_type -> datanode.api.v2.ListOracleDataResponse
	128, // 378: datanode.api.v2.TradingDataService.GetMarket:output_type -> datanode.api.v2.GetMarketResponse
	130, // 379: datanode.api.v2.TradingDataService.ListMarkets:output_type -> datanode.api.v2.ListMarketsResponse
	134, // 380: datanode.api.v2.TradingDataService.GetParty:output_type -> datanode.api.v2.GetPartyResponse
	136, // 381: datanode.api.v2.TradingDataService.ListParties:output_type -> datanode.api.v2.ListPartiesResponse
	141, // 382: datanode.api.v2.TradingDataService.ListMarginLevels:output_type -> datanode.api.v2.ListMarginLevelsResponse
	143, // 383: datanode.api.v2.TradingDataService.ObserveMarginLevels:output_type -> datanode.api.v2.ObserveMarginLevelsResponse
	148, // 384: datanode.api.v2.TradingDataService.ListRewards:output_type -> datanode.api.v2.ListRewardsResponse
	152, // 385: datanode.api.v2.TradingDataService.ListRewardSummaries:output_type -> datanode.api.v2.ListRewardSummariesResponse
	154, // 386: datanode.api.v2.TradingDataService.ListEpochRewardSummaries:output_type -> datanode.api.v2.ListEpochRewardSummariesResponse
	158, // 387: datanode.api.v2.TradingDataService.ObserveRewards:output_type -> datanode.api.v2.ObserveRewardsResponse
	160, // 388: datanode.api.v2.TradingDataService.GetDeposit:output_type -> datanode.api.v2.GetDepositResponse
	162, // 389: datanode.api.v2.TradingDataService.ListDeposits:output_type -> datanode.api.v2.ListDepositsResponse
	166, // 390: datanode.api.v2.TradingDataService.GetWithdrawal:output_type -> datanode.api.v2.GetWithdrawalResponse
	168, // 391: datanode.api.v2.TradingDataService.ListWithdrawals:output_type -> datanode.api.v2.ListWithdrawalsResponse
	172, // 392: datanode.api.v2.TradingDataService.GetAsset:output_type -> datanode.api.v2.GetAssetResponse
	174, // 393: datanode.api.v2.TradingDataService.ListAssets:output_type -> datanode.api.v2.ListAssetsResponse
	178, // 394: datanode.api.v2.TradingDataService.ListLiquidityProvisions:output_type -> datanode.api.v2.ListLiquidityProvisionsResponse
	182, // 395: datanode.api.v2.TradingDataService.ObserveLiquidityProvisions:output_type -> datanode.api.v2.ObserveLiquidityProvisionsResponse
	184, // 396: datanode.api.v2.TradingDataService.GetGovernanceData:output_type -> datanode.api.v2.GetGovernanceDataResponse
	186, // 397: datanode.api.v2.TradingDataService.ListGovernanceData:output_type -> datanode.api.v2.ListGovernanceDataResponse
	190, // 398: datanode.api.v2.TradingDataService.ObserveGovernance:output_type -> datanode.api.v2.ObserveGovernanceResponse
	192, // 399: datanode.api.v2.TradingDataService.ListDelegations:output_type -> datanode.api.v2.ListDelegationsResponse
	196, // 400: datanode.api.v2.TradingDataService.ObserveDelegations:output_type -> datanode.api.v2.ObserveDelegationsResponse
	198, // 401: datanode.api.v2.TradingDataService.GetNetworkData:output_type -> datanode.api.v2.GetNetworkDataResponse
	200, // 402: datanode.api.v2.TradingDataService.GetNode:output_type -> datanode.api.v2.GetNodeResponse
	202, // 403: datanode.api.v2.TradingDataService.ListNodes:output_type -> datanode.api.v2.ListNodesResponse
	206, // 404: datanode.api.v2.TradingDataService.ListNodeSignatures:output_type -> datanode.api.v2.ListNodeSignaturesResponse
	210, // 405: datanode.api.v2.TradingDataService.GetEpoch:output_type -> datanode.api.v2.GetEpochResponse
	212, // 406: datanode.api.v2.TradingDataService.EstimateFee:output_type -> datanode.api.v2.EstimateFeeResponse
	214, // 407: datanode.api.v2.TradingDataService.EstimateMargin:output_type -> datanode.api.v2.EstimateMarginResponse
	216, // 408: datanode.api.v2.TradingDataService.ListNetworkParameters:output_type -> datanode.api.v2.ListNetworkParametersResponse
	218, // 409: datanode.api.v2.TradingDataService.GetNetworkParameter:output_type -> datanode.api.v2.GetNetworkParameterResponse
	223, // 410: datanode.api.v2.TradingDataService.ListCheckpoints:output_type -> datanode.api.v2.ListCheckpointsResponse
	227, // 411: datanode.api.v2.TradingDataService.GetStake:output_type -> datanode.api.v2.GetStakeResponse
	231, // 412: datanode.api.v2.TradingDataService.GetRiskFactors:output_type -> datanode.api.v2.GetRiskFactorsResponse
	233, // 413: datanode.api.v2.TradingDataService.ObserveEventBus:output_type -> datanode.api.v2.ObserveEventBusResponse
	235, // 414: datanode.api.v2.TradingDataService.ObserveLedgerMovements:output_type -> datanode.api.v2.ObserveLedgerMovementsResponse
	237, // 415: datanode.api.v2.TradingDataService.ListKeyRotations:output_type -> datanode.api.v2.ListKeyRotationsResponse
	241, // 416: datanode.api.v2.TradingDataService.ListEthereumKeyRotations:output_type -> datanode.api.v2.ListEthereumKeyRotationsResponse
	245, // 417: datanode.api.v2.TradingDataService.GetVegaTime:output_type -> datanode.api.v2.GetVegaTimeResponse
	248, // 418: datanode.api.v2.TradingDataService.GetProtocolUpgradeStatus:output_type -> datanode.api.v2.GetProtocolUpgradeStatusResponse
	250, // 419: datanode.api.v2.TradingDataService.ListProtocolUpgradeProposals:output_type -> datanode.api.v2.ListProtocolUpgradeProposalsResponse
	254, // 420: datanode.api.v2.TradingDataService.ListCoreSnapshots:output_type -> datanode.api.v2.ListCoreSnapshotsResponse
	258, // 421: datanode.api.v2.TradingDataService.Ping:output_type -> datanode.api.v2.PingResponse
	342, // [342:422] is the sub-list for method output_type
	262, // [262:342] is the sub-list for method input_type
