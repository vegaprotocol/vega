Feature: Test setting of mark price
  Background:
    ...
    And the markets:
      ...
      | ETH/FEB22 | ETH        | USD   | lqm-params           | simple-risk-model | default-margin-calculator | 1                | default-none | default-none     | default-eth-for-future | 0.25                   | 0                         | default-futures | median     | 0.5          | 2           | 0           | 0,1,0,0        | 6s,4s,24h0m0s,1h25m0s      |
  ...
  Scenario: 001 check mark price using order price with cash amount 100 USD
    ...
    # median price = 15675
    # => mark price by median = 15675
    When the network moves ahead "1" blocks
    Then the mark price should be "15675" for the market "ETH/FEB23"
    Then the mark price should be "15675" for the market "ETH/FEB22"
    ...
    Then the mark price should be "15676" for the market "ETH/FEB22"
