Feature: Test setting of mark price
  Background:
    ...
    And the markets:
      ...
      | ETH/FEB23 | ETH        | USD   | lqm-params           | simple-risk-model | default-margin-calculator | 1                | default-none | default-none     | default-eth-for-future | 0.25                   | 0                         | default-futures | median     | 0.5          | 2           | 500000      | 0,1,0,0        | 6s,4s,24h0m0s,1h25m0s      |
  ...
  Scenario: 001 check mark price using order price with cash amount 100 USD
    ...
    And the parties place the following orders:
      ...
      | buySideProvider  | ETH/FEB23 | buy  | 2      | 14900  | 0                | TYPE_LIMIT | TIF_GTC |
      ...
      | sellSideProvider | ETH/FEB23 | sell | 2      | 15902  | 0                | TYPE_LIMIT | TIF_GTC |
      | sellSideProvider | ETH/FEB23 | sell | 2      | 100000 | 0                | TYPE_LIMIT | TIF_GTC |
