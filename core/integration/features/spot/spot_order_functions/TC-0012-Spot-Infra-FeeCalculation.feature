Feature: Simple Spot Order Market fee and infrastructure fee calculation
  ...
  Background:
    ...
    And the spot markets:
      | id      | name    | base asset | quote asset | risk model           | auction duration | fees          | price monitoring | position decimal places |
      | BTC/ETH | BTC/ETH | BTC        | ETH         | my-simple-risk-model | 1                | fees-config-1 | price-monitoring | 2                       |
