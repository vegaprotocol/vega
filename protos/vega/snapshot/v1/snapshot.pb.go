...
type LiquidityParameters struct {
	...
	// ID of the market these liquidity parameters apply to. Required for key generation
...
type LiquidityPendingProvisions struct {
	...
	// ID of the market these liquidity provisions apply to. Required for key generation
...
type LiquidityPartiesLiquidityOrders struct {
	...
	// ID of the market these liquidity orders apply to. Required for key generation
	MarketId string `protobuf:"bytes,2,opt,name=market_id,json=marketId,proto3" json:"market_id,omitempty"`
}
...
type LiquidityPartiesOrders struct {
	...
	PartyOrders []*PartyOrders `protobuf:"bytes,1,rep,name=party_orders,json=partyOrders,proto3" json:"party_orders,omitempty"`
	// ID of the market these orders apply to. Required for key generation
	MarketId string `protobuf:"bytes,2,opt,name=market_id,json=marketId,proto3" json:"market_id,omitempty"`
}
...
type LiquidityProvisions struct {
	...
	// ID of the market these provisions apply to. Required for key generation
	MarketId string `protobuf:"bytes,2,opt,name=market_id,json=marketId,proto3" json:"market_id,omitempty"`
}
...
var file_vega_snapshot_v1_snapshot_proto_rawDesc = []byte{
	...
	0x74, 0x61, 0x6c, 0x53, 0x75, 0x70, 0x70, 0x6c, 0x79, 0x22, 0xcc, 0x01, 0x0a, 0x0c, 0x4d, 0x61,
	...
	0x07, 0x62, 0x61, 0x74, 0x63, 0x68, 0x49, 0x64, 0x22, 0x3b, 0x0a, 0x09, 0x4e, 0x65, 0x74, 0x50,
	...
	0x77, 0x69, 0x6e, 0x64, 0x6f, 0x77, 0x22, 0xba, 0x08, 0x0a, 0x06, 0x4d, 0x61, 0x72, 0x6b, 0x65,
	...
	0x73, 0x65, 0x64, 0x22, 0x40, 0x0a, 0x0c, 0x50, 0x65, 0x67, 0x67, 0x65, 0x64, 0x4f, 0x72, 0x64,
	...
	0x72, 0x64, 0x65, 0x72, 0x73, 0x22, 0x46, 0x0a, 0x10, 0x45, 0x78, 0x65, 0x63, 0x75, 0x74, 0x69,
	...
	0x61, 0x2e, 0x73, 0x6e, 0x61, 0x70, 0x73, 0x68, 0x6f, 0x74, 0x2e, 0x76, 0x31, 0x2e, 0x4d, 0x61,
	0x72, 0x6b, 0x65, 0x74, 0x52, 0x07, 0x6d, 0x61, 0x72, 0x6b, 0x65, 0x74, 0x73, 0x22, 0xe7, 0x01,
	...
	0x74, 0x72, 0x65, 0x73, 0x73, 0x65, 0x64, 0x22, 0x68, 0x0a, 0x0f, 0x4d, 0x61, 0x72, 0x6b, 0x65,
	...
	0x73, 0x22, 0xee, 0x01, 0x0a, 0x0f, 0x53, 0x65, 0x74, 0x74, 0x6c, 0x65, 0x6d, 0x65, 0x6e, 0x74,
	...
	0x74, 0x79, 0x49, 0x64, 0x22, 0xb9, 0x01, 0x0a, 0x16, 0x46, 0x6c, 0x6f, 0x61, 0x74, 0x69, 0x6e,
	...
	0x64, 0x54, 0x68, 0x72, 0x65, 0x73, 0x68, 0x6f, 0x6c, 0x64, 0x53, 0x65, 0x74, 0x73, 0x22, 0xa1,
	...
	0x74, 0x65, 0x22, 0x39, 0x0a, 0x0b, 0x42, 0x61, 0x6e, 0x6e, 0x65, 0x64, 0x50, 0x61, 0x72, 0x74,
	...
	0x61, 0x73, 0x65, 0x54, 0x61, 0x67, 0x2a, 0x60, 0x0a, 0x06, 0x46, 0x6f, 0x72, 0x6d, 0x61, 0x74,
...
var file_vega_snapshot_v1_snapshot_proto_goTypes = []interface{}{
	...
	(*vega.StakeTotalSupply)(nil),                // 130: vega.StakeTotalSupply
	(*vega.Order)(nil),                           // 131: vega.Order
	(*vega.NetworkParameter)(nil),                // 132: vega.NetworkParameter
	(*vega.PriceMonitoringTrigger)(nil),          // 133: vega.PriceMonitoringTrigger
	(vega.Market_TradingMode)(0),                 // 134: vega.Market.TradingMode
	(vega.AuctionTrigger)(0),                     // 135: vega.AuctionTrigger
	(*vega.AuctionDuration)(nil),                 // 136: vega.AuctionDuration
	(*vega.Market)(nil),                          // 137: vega.Market
	(*v12.ValidatorUpdate)(nil),                  // 138: vega.events.v1.ValidatorUpdate
	(*vega.RankingScore)(nil),                    // 139: vega.RankingScore
	(*vega.LiquidityProvision)(nil),              // 140: vega.LiquidityProvision
	(*vega.KeyValueBundle)(nil),                  // 141: vega.KeyValueBundle
	(*v11.MarketActivityTracker)(nil),            // 142: vega.checkpoint.v1.MarketActivityTracker
	(*v12.ERC20MultiSigSignerEvent)(nil),         // 143: vega.events.v1.ERC20MultiSigSignerEvent
	(*v12.ERC20MultiSigThresholdSetEvent)(nil),   // 144: vega.events.v1.ERC20MultiSigThresholdSetEvent
	(*v12.ProtocolUpgradeEvent)(nil),             // 145: vega.events.v1.ProtocolUpgradeEvent
}
var file_vega_snapshot_v1_snapshot_proto_depIdxs = []int32{
	...
	130, // 89: vega.snapshot.v1.StakingAccounts.pending_stake_total_supply:type_name -> vega.StakeTotalSupply
	131, // 90: vega.snapshot.v1.MatchingBook.buy:type_name -> vega.Order
	131, // 91: vega.snapshot.v1.MatchingBook.sell:type_name -> vega.Order
	132, // 92: vega.snapshot.v1.NetParams.params:type_name -> vega.NetworkParameter
	133, // 93: vega.snapshot.v1.PriceBound.trigger:type_name -> vega.PriceMonitoringTrigger
	48,  // 94: vega.snapshot.v1.PriceRangeCache.bound:type_name -> vega.snapshot.v1.PriceBound
	47,  // 95: vega.snapshot.v1.PriceRangeCache.range:type_name -> vega.snapshot.v1.PriceRange
	44,  // 96: vega.snapshot.v1.PriceMonitor.fp_horizons:type_name -> vega.snapshot.v1.DecimalMap
	48,  // 97: vega.snapshot.v1.PriceMonitor.bounds:type_name -> vega.snapshot.v1.PriceBound
	49,  // 98: vega.snapshot.v1.PriceMonitor.price_range_cache:type_name -> vega.snapshot.v1.PriceRangeCache
	44,  // 99: vega.snapshot.v1.PriceMonitor.ref_price_cache:type_name -> vega.snapshot.v1.DecimalMap
	50,  // 100: vega.snapshot.v1.PriceMonitor.prices_now:type_name -> vega.snapshot.v1.CurrentPrice
	51,  // 101: vega.snapshot.v1.PriceMonitor.prices_past:type_name -> vega.snapshot.v1.PastPrice
	134, // 102: vega.snapshot.v1.AuctionState.mode:type_name -> vega.Market.TradingMode
	134, // 103: vega.snapshot.v1.AuctionState.default_mode:type_name -> vega.Market.TradingMode
	135, // 104: vega.snapshot.v1.AuctionState.trigger:type_name -> vega.AuctionTrigger
	136, // 105: vega.snapshot.v1.AuctionState.end:type_name -> vega.AuctionDuration
	135, // 106: vega.snapshot.v1.AuctionState.extension:type_name -> vega.AuctionTrigger
	54,  // 107: vega.snapshot.v1.EquityShare.lps:type_name -> vega.snapshot.v1.EquityShareLP
	137, // 108: vega.snapshot.v1.Market.market:type_name -> vega.Market
	52,  // 109: vega.snapshot.v1.Market.price_monitor:type_name -> vega.snapshot.v1.PriceMonitor
	53,  // 110: vega.snapshot.v1.Market.auction_state:type_name -> vega.snapshot.v1.AuctionState
	58,  // 111: vega.snapshot.v1.Market.pegged_orders:type_name -> vega.snapshot.v1.PeggedOrders
	131, // 112: vega.snapshot.v1.Market.expiring_orders:type_name -> vega.Order
	55,  // 113: vega.snapshot.v1.Market.equity_share:type_name -> vega.snapshot.v1.EquityShare
	56,  // 114: vega.snapshot.v1.Market.fee_splitter:type_name -> vega.snapshot.v1.FeeSplitter
	131, // 115: vega.snapshot.v1.PeggedOrders.parked_orders:type_name -> vega.Order
	57,  // 116: vega.snapshot.v1.ExecutionMarkets.markets:type_name -> vega.snapshot.v1.Market
	60,  // 117: vega.snapshot.v1.MarketPositions.positions:type_name -> vega.snapshot.v1.Position
	63,  // 118: vega.snapshot.v1.SettlementState.last_settled_positions:type_name -> vega.snapshot.v1.LastSettledPosition
	64,  // 119: vega.snapshot.v1.SettlementState.trades:type_name -> vega.snapshot.v1.SettlementTrade
	68,  // 120: vega.snapshot.v1.RewardsPendingPayouts.scheduled_rewards_payout:type_name -> vega.snapshot.v1.ScheduledRewardsPayout
	69,  // 121: vega.snapshot.v1.ScheduledRewardsPayout.rewards_payout:type_name -> vega.snapshot.v1.RewardsPayout
	70,  // 122: vega.snapshot.v1.RewardsPayout.reward_party_amount:type_name -> vega.snapshot.v1.RewardsPartyAmount
	73,  // 123: vega.snapshot.v1.VoteSpamPolicy.party_to_vote:type_name -> vega.snapshot.v1.PartyProposalVoteCount
	109, // 124: vega.snapshot.v1.VoteSpamPolicy.banned_parties:type_name -> vega.snapshot.v1.BannedParty
	74,  // 125: vega.snapshot.v1.VoteSpamPolicy.token_balance:type_name -> vega.snapshot.v1.PartyTokenBalance
	75,  // 126: vega.snapshot.v1.VoteSpamPolicy.recent_blocks_reject_stats:type_name -> vega.snapshot.v1.BlockRejectStats
	76,  // 127: vega.snapshot.v1.SimpleSpamPolicy.party_to_count:type_name -> vega.snapshot.v1.SpamPartyTransactionCount
	109, // 128: vega.snapshot.v1.SimpleSpamPolicy.banned_parties:type_name -> vega.snapshot.v1.BannedParty
	74,  // 129: vega.snapshot.v1.SimpleSpamPolicy.token_balance:type_name -> vega.snapshot.v1.PartyTokenBalance
	78,  // 130: vega.snapshot.v1.Notary.notary_sigs:type_name -> vega.snapshot.v1.NotarySigs
	...
	88,  // 133: vega.snapshot.v1.Topology.validator_data:type_name -> vega.snapshot.v1.ValidatorState
	83,  // 134: vega.snapshot.v1.Topology.pending_pub_key_rotations:type_name -> vega.snapshot.v1.PendingKeyRotation
	91,  // 135: vega.snapshot.v1.Topology.validator_performance:type_name -> vega.snapshot.v1.ValidatorPerformance
	84,  // 136: vega.snapshot.v1.Topology.pending_ethereum_key_rotations:type_name -> vega.snapshot.v1.PendingEthereumKeyRotation
	86,  // 137: vega.snapshot.v1.Topology.signatures:type_name -> vega.snapshot.v1.ToplogySignatures
	84,  // 138: vega.snapshot.v1.Topology.unsolved_ethereum_key_rotations:type_name -> vega.snapshot.v1.PendingEthereumKeyRotation
	87,  // 139: vega.snapshot.v1.ToplogySignatures.pending_signatures:type_name -> vega.snapshot.v1.PendingERC20MultisigControlSignature
	138, // 140: vega.snapshot.v1.ValidatorState.validator_update:type_name -> vega.events.v1.ValidatorUpdate
	89,  // 141: vega.snapshot.v1.ValidatorState.heartbeat_tracker:type_name -> vega.snapshot.v1.HeartbeatTracker
	139, // 142: vega.snapshot.v1.ValidatorState.ranking_score:type_name -> vega.RankingScore
	90,  // 143: vega.snapshot.v1.ValidatorPerformance.validator_perf_stats:type_name -> vega.snapshot.v1.PerformanceStats
	95,  // 144: vega.snapshot.v1.LiquidityPartiesLiquidityOrders.party_orders:type_name -> vega.snapshot.v1.PartyOrders
	131, // 145: vega.snapshot.v1.PartyOrders.orders:type_name -> vega.Order
	95,  // 146: vega.snapshot.v1.LiquidityPartiesOrders.party_orders:type_name -> vega.snapshot.v1.PartyOrders
	140, // 147: vega.snapshot.v1.LiquidityProvisions.liquidity_provisions:type_name -> vega.LiquidityProvision
	99,  // 148: vega.snapshot.v1.LiquidityScores.scores:type_name -> vega.snapshot.v1.LiquidityScore
	103, // 149: vega.snapshot.v1.FloatingPointConsensus.next_time_trigger:type_name -> vega.snapshot.v1.NextTimeTrigger
	101, // 150: vega.snapshot.v1.FloatingPointConsensus.state_variables:type_name -> vega.snapshot.v1.StateVarInternalState
	102, // 151: vega.snapshot.v1.StateVarInternalState.validators_results:type_name -> vega.snapshot.v1.FloatingPointValidatorResult
	141, // 152: vega.snapshot.v1.FloatingPointValidatorResult.bundle:type_name -> vega.KeyValueBundle
	142, // 153: vega.snapshot.v1.MarketTracker.market_activity:type_name -> vega.checkpoint.v1.MarketActivityTracker
	143, // 154: vega.snapshot.v1.SignerEventsPerAddress.events:type_name -> vega.events.v1.ERC20MultiSigSignerEvent
	105, // 155: vega.snapshot.v1.ERC20MultiSigTopologyVerified.events_per_address:type_name -> vega.snapshot.v1.SignerEventsPerAddress
	144, // 156: vega.snapshot.v1.ERC20MultiSigTopologyVerified.threshold:type_name -> vega.events.v1.ERC20MultiSigThresholdSetEvent
	143, // 157: vega.snapshot.v1.ERC20MultiSigTopologyPending.pending_signers:type_name -> vega.events.v1.ERC20MultiSigSignerEvent
	144, // 158: vega.snapshot.v1.ERC20MultiSigTopologyPending.pending_threshold_set:type_name -> vega.events.v1.ERC20MultiSigThresholdSetEvent
	114, // 159: vega.snapshot.v1.ProofOfWork.tx_at_height:type_name -> vega.snapshot.v1.TransactionsAtHeight
	114, // 160: vega.snapshot.v1.ProofOfWork.tid_at_height:type_name -> vega.snapshot.v1.TransactionsAtHeight
	109, // 161: vega.snapshot.v1.ProofOfWork.banned:type_name -> vega.snapshot.v1.BannedParty
	110, // 162: vega.snapshot.v1.ProofOfWork.pow_params:type_name -> vega.snapshot.v1.ProofOfWorkParams
	111, // 163: vega.snapshot.v1.ProofOfWork.pow_state:type_name -> vega.snapshot.v1.ProofOfWorkState
	112, // 164: vega.snapshot.v1.ProofOfWorkState.pow_state:type_name -> vega.snapshot.v1.ProofOfWorkBlockState
	113, // 165: vega.snapshot.v1.ProofOfWorkBlockState.party_state:type_name -> vega.snapshot.v1.ProofOfWorkPartyStateForBlock
	145, // 166: vega.snapshot.v1.ProtocolUpgradeProposals.active_proposals:type_name -> vega.events.v1.ProtocolUpgradeEvent
	116, // 167: vega.snapshot.v1.ProtocolUpgradeProposals.accepted_proposal:type_name -> vega.snapshot.v1.AcceptedProtocolUpgradeProposal
