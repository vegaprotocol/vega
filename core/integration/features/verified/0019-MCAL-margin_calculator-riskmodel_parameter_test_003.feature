Feature: test risk model parameter change in margin calculation
  ...
  Background:
    ...
    Given the markets:
      ...
      | ETH/MAR22 | ETH        | USD   | log-normal-risk-model-3 | default-margin-calculator | 1                | fees-config-1 | price-monitoring-1 | default-eth-for-future |
   ...
   Scenario:  lognormal risk model 003
   ...
   And the parties submit the following liquidity provision:
    ...
    And the parties should have the following account balances:
      ...
      | party0 | USD   | ETH/MAR22 | 26917  | 423083   | 50000 |
      | party1 | USD   | ETH/MAR22 | 3831   | 99996169 | 0     |
      | party2 | USD   | ETH/MAR22 | 4454   | 99995546 | 0     |
    ...
    Then the parties should have the following margin levels:
      ...
      | party0 | ETH/MAR22 | 22431       | 24674  | 26917  | 31403  |
      | party1 | ETH/MAR22 | 3193        | 3512   | 3831   | 4470   |
      | party2 | ETH/MAR22 | 3712        | 4083   | 4454   | 5196   |
