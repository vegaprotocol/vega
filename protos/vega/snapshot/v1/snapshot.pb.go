...
var file_vega_snapshot_v1_snapshot_proto_goTypes = []interface{}{
	...
	(*v11.GovernanceTransfer)(nil),                // 131: vega.checkpoint.v1.GovernanceTransfer
	(*v11.ScheduledGovernanceTransferAtTime)(nil), // 132: vega.checkpoint.v1.ScheduledGovernanceTransferAtTime
...
var file_vega_snapshot_v1_snapshot_proto_depIdxs = []int32{
	...
	123, // 66: vega.snapshot.v1.OracleData.signers:type_name -> vega.data.v1.Signer
	...
	124, // 69: vega.snapshot.v1.CollateralAccounts.accounts:type_name -> vega.Account
	125, // 70: vega.snapshot.v1.CollateralAssets.assets:type_name -> vega.Asset
	125, // 71: vega.snapshot.v1.ActiveAssets.assets:type_name -> vega.Asset
	125, // 72: vega.snapshot.v1.PendingAssets.assets:type_name -> vega.Asset
	125, // 73: vega.snapshot.v1.PendingAssetUpdates.assets:type_name -> vega.Asset
	126, // 74: vega.snapshot.v1.Withdrawal.withdrawal:type_name -> vega.Withdrawal
	127, // 75: vega.snapshot.v1.Deposit.deposit:type_name -> vega.Deposit
	...
	128, // 78: vega.snapshot.v1.BankingAssetActions.asset_action:type_name -> vega.checkpoint.v1.AssetAction
	129, // 79: vega.snapshot.v1.BankingRecurringTransfers.recurring_transfers:type_name -> vega.checkpoint.v1.RecurringTransfers
	130, // 80: vega.snapshot.v1.BankingScheduledTransfers.transfers_at_time:type_name -> vega.checkpoint.v1.ScheduledTransferAtTime
	131, // 81: vega.snapshot.v1.BankingRecurringGovernanceTransfers.recurring_transfers:type_name -> vega.checkpoint.v1.GovernanceTransfer
	132, // 82: vega.snapshot.v1.BankingScheduledGovernanceTransfers.transfers_at_time:type_name -> vega.checkpoint.v1.ScheduledGovernanceTransferAtTime
	133, // 83: vega.snapshot.v1.BankingBridgeState.bridge_state:type_name -> vega.checkpoint.v1.BridgeState
	134, // 84: vega.snapshot.v1.DelegationActive.delegations:type_name -> vega.Delegation
	134, // 85: vega.snapshot.v1.DelegationPending.delegations:type_name -> vega.Delegation
	134, // 86: vega.snapshot.v1.DelegationPending.undelegation:type_name -> vega.Delegation
	135, // 87: vega.snapshot.v1.ProposalData.proposal:type_name -> vega.Proposal
	136, // 88: vega.snapshot.v1.ProposalData.yes:type_name -> vega.Vote
	136, // 89: vega.snapshot.v1.ProposalData.no:type_name -> vega.Vote
	136, // 90: vega.snapshot.v1.ProposalData.invalid:type_name -> vega.Vote
	...
	135, // 93: vega.snapshot.v1.GovernanceNode.proposals:type_name -> vega.Proposal
	137, // 94: vega.snapshot.v1.StakingAccount.events:type_name -> vega.events.v1.StakeLinking
	44,  // 95: vega.snapshot.v1.StakingAccounts.accounts:type_name -> vega.snapshot.v1.StakingAccount
	138, // 96: vega.snapshot.v1.StakingAccounts.pending_stake_total_supply:type_name -> vega.StakeTotalSupply
	139, // 97: vega.snapshot.v1.MatchingBook.buy:type_name -> vega.Order
	139, // 98: vega.snapshot.v1.MatchingBook.sell:type_name -> vega.Order
	140, // 99: vega.snapshot.v1.NetParams.params:type_name -> vega.NetworkParameter
	141, // 100: vega.snapshot.v1.PriceBound.trigger:type_name -> vega.PriceMonitoringTrigger
	...
	142, // 109: vega.snapshot.v1.AuctionState.mode:type_name -> vega.Market.TradingMode
	142, // 110: vega.snapshot.v1.AuctionState.default_mode:type_name -> vega.Market.TradingMode
	143, // 111: vega.snapshot.v1.AuctionState.trigger:type_name -> vega.AuctionTrigger
	144, // 112: vega.snapshot.v1.AuctionState.end:type_name -> vega.AuctionDuration
	143, // 113: vega.snapshot.v1.AuctionState.extension:type_name -> vega.AuctionTrigger
	58,  // 114: vega.snapshot.v1.EquityShare.lps:type_name -> vega.snapshot.v1.EquityShareLP
	145, // 115: vega.snapshot.v1.SpotMarket.market:type_name -> vega.Market
	...
	63,  // 118: vega.snapshot.v1.SpotMarket.pegged_orders:type_name -> vega.snapshot.v1.PeggedOrders
	139, // 119: vega.snapshot.v1.SpotMarket.expiring_orders:type_name -> vega.Order
	...
	145, // 122: vega.snapshot.v1.Market.market:type_name -> vega.Market
	...
	63,  // 125: vega.snapshot.v1.Market.pegged_orders:type_name -> vega.snapshot.v1.PeggedOrders
	139, // 126: vega.snapshot.v1.Market.expiring_orders:type_name -> vega.Order
	...
	139, // 129: vega.snapshot.v1.PeggedOrders.parked_orders:type_name -> vega.Order
	62,  // 130: vega.snapshot.v1.ExecutionMarkets.markets:type_name -> vega.snapshot.v1.Market
	61,  // 131: vega.snapshot.v1.ExecutionMarkets.spot_markets:type_name -> vega.snapshot.v1.SpotMarket
	65,  // 132: vega.snapshot.v1.MarketPositions.positions:type_name -> vega.snapshot.v1.Position
	68,  // 133: vega.snapshot.v1.SettlementState.last_settled_positions:type_name -> vega.snapshot.v1.LastSettledPosition
	69,  // 134: vega.snapshot.v1.SettlementState.trades:type_name -> vega.snapshot.v1.SettlementTrade
	73,  // 135: vega.snapshot.v1.RewardsPendingPayouts.scheduled_rewards_payout:type_name -> vega.snapshot.v1.ScheduledRewardsPayout
	74,  // 136: vega.snapshot.v1.ScheduledRewardsPayout.rewards_payout:type_name -> vega.snapshot.v1.RewardsPayout
	75,  // 137: vega.snapshot.v1.RewardsPayout.reward_party_amount:type_name -> vega.snapshot.v1.RewardsPartyAmount
	78,  // 138: vega.snapshot.v1.VoteSpamPolicy.party_to_vote:type_name -> vega.snapshot.v1.PartyProposalVoteCount
	115, // 139: vega.snapshot.v1.VoteSpamPolicy.banned_parties:type_name -> vega.snapshot.v1.BannedParty
	79,  // 140: vega.snapshot.v1.VoteSpamPolicy.token_balance:type_name -> vega.snapshot.v1.PartyTokenBalance
	80,  // 141: vega.snapshot.v1.VoteSpamPolicy.recent_blocks_reject_stats:type_name -> vega.snapshot.v1.BlockRejectStats
	81,  // 142: vega.snapshot.v1.SimpleSpamPolicy.party_to_count:type_name -> vega.snapshot.v1.SpamPartyTransactionCount
	115, // 143: vega.snapshot.v1.SimpleSpamPolicy.banned_parties:type_name -> vega.snapshot.v1.BannedParty
	79,  // 144: vega.snapshot.v1.SimpleSpamPolicy.token_balance:type_name -> vega.snapshot.v1.PartyTokenBalance
	83,  // 145: vega.snapshot.v1.Notary.notary_sigs:type_name -> vega.snapshot.v1.NotarySigs
	87,  // 146: vega.snapshot.v1.StakeVerifierDeposited.pending_deposited:type_name -> vega.snapshot.v1.StakeVerifierPending
	87,  // 147: vega.snapshot.v1.StakeVerifierRemoved.pending_removed:type_name -> vega.snapshot.v1.StakeVerifierPending
	94,  // 148: vega.snapshot.v1.Topology.validator_data:type_name -> vega.snapshot.v1.ValidatorState
	88,  // 149: vega.snapshot.v1.Topology.pending_pub_key_rotations:type_name -> vega.snapshot.v1.PendingKeyRotation
	97,  // 150: vega.snapshot.v1.Topology.validator_performance:type_name -> vega.snapshot.v1.ValidatorPerformance
	89,  // 151: vega.snapshot.v1.Topology.pending_ethereum_key_rotations:type_name -> vega.snapshot.v1.PendingEthereumKeyRotation
	91,  // 152: vega.snapshot.v1.Topology.signatures:type_name -> vega.snapshot.v1.ToplogySignatures
	89,  // 153: vega.snapshot.v1.Topology.unsolved_ethereum_key_rotations:type_name -> vega.snapshot.v1.PendingEthereumKeyRotation
	92,  // 154: vega.snapshot.v1.ToplogySignatures.pending_signatures:type_name -> vega.snapshot.v1.PendingERC20MultisigControlSignature
	93,  // 155: vega.snapshot.v1.ToplogySignatures.issued_signatures:type_name -> vega.snapshot.v1.IssuedERC20MultisigControlSignature
	146, // 156: vega.snapshot.v1.ValidatorState.validator_update:type_name -> vega.events.v1.ValidatorUpdate
	95,  // 157: vega.snapshot.v1.ValidatorState.heartbeat_tracker:type_name -> vega.snapshot.v1.HeartbeatTracker
	147, // 158: vega.snapshot.v1.ValidatorState.ranking_score:type_name -> vega.RankingScore
	96,  // 159: vega.snapshot.v1.ValidatorPerformance.validator_perf_stats:type_name -> vega.snapshot.v1.PerformanceStats
	101, // 160: vega.snapshot.v1.LiquidityPartiesLiquidityOrders.party_orders:type_name -> vega.snapshot.v1.PartyOrders
	139, // 161: vega.snapshot.v1.PartyOrders.orders:type_name -> vega.Order
	101, // 162: vega.snapshot.v1.LiquidityPartiesOrders.party_orders:type_name -> vega.snapshot.v1.PartyOrders
	148, // 163: vega.snapshot.v1.LiquidityProvisions.liquidity_provisions:type_name -> vega.LiquidityProvision
	105, // 164: vega.snapshot.v1.LiquidityScores.scores:type_name -> vega.snapshot.v1.LiquidityScore
	109, // 165: vega.snapshot.v1.FloatingPointConsensus.next_time_trigger:type_name -> vega.snapshot.v1.NextTimeTrigger
	107, // 166: vega.snapshot.v1.FloatingPointConsensus.state_variables:type_name -> vega.snapshot.v1.StateVarInternalState
	108, // 167: vega.snapshot.v1.StateVarInternalState.validators_results:type_name -> vega.snapshot.v1.FloatingPointValidatorResult
	...
	111, // 171: vega.snapshot.v1.ERC20MultiSigTopologyVerified.events_per_address:type_name -> vega.snapshot.v1.SignerEventsPerAddress
	...
	120, // 175: vega.snapshot.v1.ProofOfWork.tx_at_height:type_name -> vega.snapshot.v1.TransactionsAtHeight
	120, // 176: vega.snapshot.v1.ProofOfWork.tid_at_height:type_name -> vega.snapshot.v1.TransactionsAtHeight
	115, // 177: vega.snapshot.v1.ProofOfWork.banned:type_name -> vega.snapshot.v1.BannedParty
	116, // 178: vega.snapshot.v1.ProofOfWork.pow_params:type_name -> vega.snapshot.v1.ProofOfWorkParams
	117, // 179: vega.snapshot.v1.ProofOfWork.pow_state:type_name -> vega.snapshot.v1.ProofOfWorkState
	118, // 180: vega.snapshot.v1.ProofOfWorkState.pow_state:type_name -> vega.snapshot.v1.ProofOfWorkBlockState
	119, // 181: vega.snapshot.v1.ProofOfWorkBlockState.party_state:type_name -> vega.snapshot.v1.ProofOfWorkPartyStateForBlock
	153, // 182: vega.snapshot.v1.ProtocolUpgradeProposals.active_proposals:type_name -> vega.events.v1.ProtocolUpgradeEvent
	122, // 183: vega.snapshot.v1.ProtocolUpgradeProposals.accepted_proposal:type_name -> vega.snapshot.v1.AcceptedProtocolUpgradeProposal
