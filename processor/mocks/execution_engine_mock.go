...
func (m *MockExecutionEngine) AmendOrder(arg0 context.Context, arg1 string, arg2 *proto.OrderAmendment) (*proto.OrderConfirmation, error) {
	m.ctrl.T.Helper()
...
func (m *MockExecutionEngine) CancelOrder(arg0 context.Context, arg1 string, arg2 *proto.OrderCancellation) ([]*proto.OrderCancellationConfirmation, error) {
	m.ctrl.T.Helper()
...
func (m *MockExecutionEngine) SubmitOrder(arg0 context.Context, arg1 string, arg2 *proto.OrderSubmission) (*proto.OrderConfirmation, error) {
	m.ctrl.T.Helper()
