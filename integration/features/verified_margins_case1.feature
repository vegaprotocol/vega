Feature: CASE-1: Trader submits long order that will trade - new formula & high exit price
  ...
  Background:
    ...
    And traders place following orders with references:
      ...
      | sellSideMM | ETH/DEC19 | sell | 100    | 25000000 | 0      | LIMIT | GTC | _sell1    |
      | sellSideMM | ETH/DEC19 | sell | 11     | 14000000 | 0      | LIMIT | GTC | _sell2    |
      | sellSideMM | ETH/DEC19 | sell | 2      | 11200000 | 0      | LIMIT | GTC | _sell3    |
      | buySideMM  | ETH/DEC19 | buy  | 1      | 10000000 | 0      | LIMIT | GTC | buy1      |
      | buySideMM  | ETH/DEC19 | buy  | 3      | 9600000  | 0      | LIMIT | GTC | buy2      |
      | buySideMM  | ETH/DEC19 | buy  | 15     | 9000000  | 0      | LIMIT | GTC | buy3      |
      | buySideMM  | ETH/DEC19 | buy  | 50     | 8700000  | 0      | LIMIT | GTC | _buy4     |
  ...
  Scenario:
    ...
    Then traders place following orders:
      | trader    | market id | type | volume | price    | trades | type  | tif |
      | buySideMM | ETH/DEC19 | buy  | 1      | 19000000 | 0      | LIMIT | GTC |
      | buySideMM | ETH/DEC19 | buy  | 3      | 18000000 | 0      | LIMIT | GTC |
      | buySideMM | ETH/DEC19 | buy  | 15     | 17000000 | 0      | LIMIT | GTC |
    ...
    Then traders place following orders:
      | trader     | market id | type | volume | price    | trades | type  | tif |
      | sellSideMM | ETH/DEC19 | sell | 1      | 20000000 | 0      | LIMIT | GTC |
      | buySideMM  | ETH/DEC19 | buy  | 1      | 20000000 | 1      | LIMIT | GTC |
    ...
    Then traders place following orders:
      | trader  | market id | type | volume | price    | trades | type  | tif |
      | trader1 | ETH/DEC19 | sell | 13     | 16500000 | 3      | LIMIT | GTC |
    And the margins levels for the traders are:
      | trader  | market id | maintenance | search | initial | release |
