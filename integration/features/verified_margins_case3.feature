Feature: CASE-3: Trader submits long order that will trade - new formula & zero side of order book
  ...
  Background:
    ...
    And traders place following orders:
      | trader     | market id | type | volume | price    | trades | type  | tif |
      | sellSideMM | ETH/DEC19 | sell | 100    | 25000000 | 0      | LIMIT | TIF_GTC |
      | sellSideMM | ETH/DEC19 | sell | 11     | 14000000 | 0      | LIMIT | TIF_GTC |
      | sellSideMM | ETH/DEC19 | sell | 2      | 11200000 | 0      | LIMIT | TIF_GTC |
  ...
  Scenario:
    ...
    Then traders place following orders:
      | trader     | market id | type | volume | price    | trades | type  | tif |
      | sellSideMM | ETH/DEC19 | sell | 1      | 16000000 | 0      | LIMIT | TIF_GTC |
      | buySideMM  | ETH/DEC19 | buy  | 1      | 16000000 | 1      | LIMIT | TIF_GTC |
    ...
    Then traders place following orders:
      | trader  | market id | type | volume | price   | trades | type  | tif |
      | trader1 | ETH/DEC19 | sell | 13     | 8000000 | 0      | LIMIT | TIF_GTC |
    And I expect the trader to have a margin:
      | trader  | asset | market id | margin   | general   |
      | trader1 | ETH   | ETH/DEC19 | 85160000 | 946440000 |
    And the margins levels for the traders are:
