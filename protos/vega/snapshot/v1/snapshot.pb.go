...
var file_vega_snapshot_v1_snapshot_proto_goTypes = []interface{}{
	...
	(*v12.ERC20MultiSigSignerEvent)(nil),          // 219: vega.events.v1.ERC20MultiSigSignerEvent
	(*v12.ERC20MultiSigThresholdSetEvent)(nil),    // 220: vega.events.v1.ERC20MultiSigThresholdSetEvent
	(*v12.ProtocolUpgradeEvent)(nil),              // 221: vega.events.v1.ProtocolUpgradeEvent
	(*vega.ReferralProgram)(nil),                  // 222: vega.ReferralProgram
	(*vega.VolumeDiscountProgram)(nil),            // 223: vega.VolumeDiscountProgram
	(*vega.LiquidationStrategy)(nil),              // 224: vega.LiquidationStrategy
	(*vega.CompositePriceConfiguration)(nil),      // 225: vega.CompositePriceConfiguration
	(*vega.Trade)(nil),                            // 226: vega.Trade
	(*vega.Metadata)(nil),                         // 227: vega.Metadata
}
var file_vega_snapshot_v1_snapshot_proto_depIdxs = []int32{
	...
	219, // 239: vega.snapshot.v1.SignerEventsPerAddress.events:type_name -> vega.events.v1.ERC20MultiSigSignerEvent
	144, // 240: vega.snapshot.v1.ERC20MultiSigTopologyVerified.events_per_address:type_name -> vega.snapshot.v1.SignerEventsPerAddress
	220, // 241: vega.snapshot.v1.ERC20MultiSigTopologyVerified.threshold:type_name -> vega.events.v1.ERC20MultiSigThresholdSetEvent
	219, // 242: vega.snapshot.v1.ERC20MultiSigTopologyPending.pending_signers:type_name -> vega.events.v1.ERC20MultiSigSignerEvent
	220, // 243: vega.snapshot.v1.ERC20MultiSigTopologyPending.pending_threshold_set:type_name -> vega.events.v1.ERC20MultiSigThresholdSetEvent
	153, // 244: vega.snapshot.v1.ProofOfWork.tx_at_height:type_name -> vega.snapshot.v1.TransactionsAtHeight
	153, // 245: vega.snapshot.v1.ProofOfWork.tid_at_height:type_name -> vega.snapshot.v1.TransactionsAtHeight
	148, // 246: vega.snapshot.v1.ProofOfWork.banned:type_name -> vega.snapshot.v1.BannedParty
	149, // 247: vega.snapshot.v1.ProofOfWork.pow_params:type_name -> vega.snapshot.v1.ProofOfWorkParams
	150, // 248: vega.snapshot.v1.ProofOfWork.pow_state:type_name -> vega.snapshot.v1.ProofOfWorkState
	155, // 249: vega.snapshot.v1.ProofOfWork.nonce_refs_at_height:type_name -> vega.snapshot.v1.NonceRefsAtHeight
	151, // 250: vega.snapshot.v1.ProofOfWorkState.pow_state:type_name -> vega.snapshot.v1.ProofOfWorkBlockState
	152, // 251: vega.snapshot.v1.ProofOfWorkBlockState.party_state:type_name -> vega.snapshot.v1.ProofOfWorkPartyStateForBlock
	154, // 252: vega.snapshot.v1.NonceRefsAtHeight.refs:type_name -> vega.snapshot.v1.NonceRef
	221, // 253: vega.snapshot.v1.ProtocolUpgradeProposals.active_proposals:type_name -> vega.events.v1.ProtocolUpgradeEvent
	157, // 254: vega.snapshot.v1.ProtocolUpgradeProposals.accepted_proposal:type_name -> vega.snapshot.v1.AcceptedProtocolUpgradeProposal
	159, // 255: vega.snapshot.v1.Teams.teams:type_name -> vega.snapshot.v1.Team
	160, // 256: vega.snapshot.v1.Team.referrer:type_name -> vega.snapshot.v1.Membership
	160, // 257: vega.snapshot.v1.Team.referees:type_name -> vega.snapshot.v1.Membership
	162, // 258: vega.snapshot.v1.TeamSwitches.team_switches:type_name -> vega.snapshot.v1.TeamSwitch
	164, // 259: vega.snapshot.v1.Vesting.parties_reward:type_name -> vega.snapshot.v1.PartyReward
	169, // 260: vega.snapshot.v1.PartyReward.asset_locked:type_name -> vega.snapshot.v1.AssetLocked
	171, // 261: vega.snapshot.v1.PartyReward.in_vesting:type_name -> vega.snapshot.v1.InVesting
	168, // 262: vega.snapshot.v1.ReferralProgramData.factor_by_referee:type_name -> vega.snapshot.v1.FactorByReferee
	222, // 263: vega.snapshot.v1.ReferralProgramData.current_program:type_name -> vega.ReferralProgram
	222, // 264: vega.snapshot.v1.ReferralProgramData.new_program:type_name -> vega.ReferralProgram
	166, // 265: vega.snapshot.v1.ReferralProgramData.sets:type_name -> vega.snapshot.v1.ReferralSet
	160, // 266: vega.snapshot.v1.ReferralSet.referrer:type_name -> vega.snapshot.v1.Membership
	160, // 267: vega.snapshot.v1.ReferralSet.referees:type_name -> vega.snapshot.v1.Membership
	167, // 268: vega.snapshot.v1.ReferralSet.running_volumes:type_name -> vega.snapshot.v1.RunningVolume
	170, // 269: vega.snapshot.v1.AssetLocked.epoch_balances:type_name -> vega.snapshot.v1.EpochBalance
	173, // 270: vega.snapshot.v1.ActivityStreak.parties_activity_streak:type_name -> vega.snapshot.v1.PartyActivityStreak
	176, // 271: vega.snapshot.v1.VolumeDiscountProgram.epoch_party_volumes:type_name -> vega.snapshot.v1.EpochPartyVolumes
	177, // 272: vega.snapshot.v1.VolumeDiscountProgram.average_party_volume:type_name -> vega.snapshot.v1.PartyVolume
	223, // 273: vega.snapshot.v1.VolumeDiscountProgram.current_program:type_name -> vega.VolumeDiscountProgram
	223, // 274: vega.snapshot.v1.VolumeDiscountProgram.new_program:type_name -> vega.VolumeDiscountProgram
	175, // 275: vega.snapshot.v1.VolumeDiscountProgram.factors_by_party:type_name -> vega.snapshot.v1.VolumeDiscountStats
	177, // 276: vega.snapshot.v1.EpochPartyVolumes.party_volume:type_name -> vega.snapshot.v1.PartyVolume
	224, // 277: vega.snapshot.v1.Liquidation.config:type_name -> vega.LiquidationStrategy
	179, // 278: vega.snapshot.v1.BankingTransferFeeDiscounts.party_asset_discount:type_name -> vega.snapshot.v1.PartyAssetAmount
	225, // 279: vega.snapshot.v1.CompositePriceCalculator.price_configuration:type_name -> vega.CompositePriceConfiguration
	226, // 280: vega.snapshot.v1.CompositePriceCalculator.trades:type_name -> vega.Trade
	54,  // 281: vega.snapshot.v1.CompositePriceCalculator.book_price_at_time:type_name -> vega.snapshot.v1.TimePrice
	183, // 282: vega.snapshot.v1.Parties.profiles:type_name -> vega.snapshot.v1.PartyProfile
	227, // 283: vega.snapshot.v1.PartyProfile.metadata:type_name -> vega.Metadata
