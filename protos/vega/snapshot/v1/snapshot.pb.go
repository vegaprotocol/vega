...
var file_vega_snapshot_v1_snapshot_proto_rawDesc = []byte{
	...
	0x72, 0x61, 0x63, 0x6c, 0x65, 0x44, 0x61, 0x74, 0x61, 0x22, 0xa7, 0x01, 0x0a, 0x0a, 0x4f, 0x72,
	0x61, 0x63, 0x6c, 0x65, 0x44, 0x61, 0x74, 0x61, 0x12, 0x2e, 0x0a, 0x07, 0x73, 0x69, 0x67, 0x6e,
	0x65, 0x72, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x14, 0x2e, 0x76, 0x65, 0x67, 0x61,
	0x2e, 0x64, 0x61, 0x74, 0x61, 0x2e, 0x76, 0x31, 0x2e, 0x53, 0x69, 0x67, 0x6e, 0x65, 0x72, 0x52,
	0x07, 0x73, 0x69, 0x67, 0x6e, 0x65, 0x72, 0x73, 0x12, 0x34, 0x0a, 0x04, 0x64, 0x61, 0x74, 0x61,
	...
	0x44, 0x61, 0x74, 0x61, 0x50, 0x61, 0x69, 0x72, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x12, 0x33,
	...
	0x2e, 0x50, 0x72, 0x6f, 0x70, 0x65, 0x72, 0x74, 0x79, 0x52, 0x08, 0x6d, 0x65, 0x74, 0x61, 0x44,
	...
	0x77, 0x69, 0x6e, 0x64, 0x6f, 0x77, 0x22, 0xfc, 0x06, 0x0a, 0x0a, 0x53, 0x70, 0x6f, 0x74, 0x4d,
	...
	0x6c, 0x6f, 0x73, 0x65, 0x64, 0x22, 0xd8, 0x08, 0x0a, 0x06, 0x4d, 0x61, 0x72, 0x6b, 0x65, 0x74,
	...
	0x72, 0x73, 0x22, 0x87, 0x01, 0x0a, 0x10, 0x45, 0x78, 0x65, 0x63, 0x75, 0x74, 0x69, 0x6f, 0x6e,
	...
	0x0b, 0x73, 0x70, 0x6f, 0x74, 0x4d, 0x61, 0x72, 0x6b, 0x65, 0x74, 0x73, 0x22, 0xe7, 0x01, 0x0a,
...
var file_vega_snapshot_v1_snapshot_proto_goTypes = []interface{}{
	...
	(*v1.Property)(nil),                          // 124: vega.data.v1.Property
	...
	(*vega.KeyValueBundle)(nil),                  // 148: vega.KeyValueBundle
	(*v11.MarketActivityTracker)(nil),            // 149: vega.checkpoint.v1.MarketActivityTracker
	(*v12.ERC20MultiSigSignerEvent)(nil),         // 150: vega.events.v1.ERC20MultiSigSignerEvent
	(*v12.ERC20MultiSigThresholdSetEvent)(nil),   // 151: vega.events.v1.ERC20MultiSigThresholdSetEvent
	(*v12.ProtocolUpgradeEvent)(nil),             // 152: vega.events.v1.ProtocolUpgradeEvent
}
var file_vega_snapshot_v1_snapshot_proto_depIdxs = []int32{
	...
	124, // 67: vega.snapshot.v1.OracleData.meta_data:type_name -> vega.data.v1.Property
	16,  // 68: vega.snapshot.v1.Witness.resources:type_name -> vega.snapshot.v1.Resource
	125, // 69: vega.snapshot.v1.CollateralAccounts.accounts:type_name -> vega.Account
	126, // 70: vega.snapshot.v1.CollateralAssets.assets:type_name -> vega.Asset
	126, // 71: vega.snapshot.v1.ActiveAssets.assets:type_name -> vega.Asset
	126, // 72: vega.snapshot.v1.PendingAssets.assets:type_name -> vega.Asset
	126, // 73: vega.snapshot.v1.PendingAssetUpdates.assets:type_name -> vega.Asset
	127, // 74: vega.snapshot.v1.Withdrawal.withdrawal:type_name -> vega.Withdrawal
	128, // 75: vega.snapshot.v1.Deposit.deposit:type_name -> vega.Deposit
	...
	129, // 78: vega.snapshot.v1.BankingAssetActions.asset_action:type_name -> vega.checkpoint.v1.AssetAction
	130, // 79: vega.snapshot.v1.BankingRecurringTransfers.recurring_transfers:type_name -> vega.checkpoint.v1.RecurringTransfers
	131, // 80: vega.snapshot.v1.BankingScheduledTransfers.transfers_at_time:type_name -> vega.checkpoint.v1.ScheduledTransferAtTime
	132, // 81: vega.snapshot.v1.BankingBridgeState.bridge_state:type_name -> vega.checkpoint.v1.BridgeState
	133, // 82: vega.snapshot.v1.DelegationActive.delegations:type_name -> vega.Delegation
	133, // 83: vega.snapshot.v1.DelegationPending.delegations:type_name -> vega.Delegation
	133, // 84: vega.snapshot.v1.DelegationPending.undelegation:type_name -> vega.Delegation
	134, // 85: vega.snapshot.v1.ProposalData.proposal:type_name -> vega.Proposal
	135, // 86: vega.snapshot.v1.ProposalData.yes:type_name -> vega.Vote
	135, // 87: vega.snapshot.v1.ProposalData.no:type_name -> vega.Vote
	135, // 88: vega.snapshot.v1.ProposalData.invalid:type_name -> vega.Vote
	38,  // 89: vega.snapshot.v1.GovernanceEnacted.proposals:type_name -> vega.snapshot.v1.ProposalData
	38,  // 90: vega.snapshot.v1.GovernanceActive.proposals:type_name -> vega.snapshot.v1.ProposalData
	134, // 91: vega.snapshot.v1.GovernanceNode.proposals:type_name -> vega.Proposal
	136, // 92: vega.snapshot.v1.StakingAccount.events:type_name -> vega.events.v1.StakeLinking
	42,  // 93: vega.snapshot.v1.StakingAccounts.accounts:type_name -> vega.snapshot.v1.StakingAccount
	137, // 94: vega.snapshot.v1.StakingAccounts.pending_stake_total_supply:type_name -> vega.StakeTotalSupply
	138, // 95: vega.snapshot.v1.MatchingBook.buy:type_name -> vega.Order
	138, // 96: vega.snapshot.v1.MatchingBook.sell:type_name -> vega.Order
	139, // 97: vega.snapshot.v1.NetParams.params:type_name -> vega.NetworkParameter
	140, // 98: vega.snapshot.v1.PriceBound.trigger:type_name -> vega.PriceMonitoringTrigger
	50,  // 99: vega.snapshot.v1.PriceRangeCache.bound:type_name -> vega.snapshot.v1.PriceBound
	49,  // 100: vega.snapshot.v1.PriceRangeCache.range:type_name -> vega.snapshot.v1.PriceRange
	46,  // 101: vega.snapshot.v1.PriceMonitor.fp_horizons:type_name -> vega.snapshot.v1.DecimalMap
	50,  // 102: vega.snapshot.v1.PriceMonitor.bounds:type_name -> vega.snapshot.v1.PriceBound
	51,  // 103: vega.snapshot.v1.PriceMonitor.price_range_cache:type_name -> vega.snapshot.v1.PriceRangeCache
	46,  // 104: vega.snapshot.v1.PriceMonitor.ref_price_cache:type_name -> vega.snapshot.v1.DecimalMap
	52,  // 105: vega.snapshot.v1.PriceMonitor.prices_now:type_name -> vega.snapshot.v1.CurrentPrice
	53,  // 106: vega.snapshot.v1.PriceMonitor.prices_past:type_name -> vega.snapshot.v1.PastPrice
	141, // 107: vega.snapshot.v1.AuctionState.mode:type_name -> vega.Market.TradingMode
	141, // 108: vega.snapshot.v1.AuctionState.default_mode:type_name -> vega.Market.TradingMode
	142, // 109: vega.snapshot.v1.AuctionState.trigger:type_name -> vega.AuctionTrigger
	143, // 110: vega.snapshot.v1.AuctionState.end:type_name -> vega.AuctionDuration
	142, // 111: vega.snapshot.v1.AuctionState.extension:type_name -> vega.AuctionTrigger
	56,  // 112: vega.snapshot.v1.EquityShare.lps:type_name -> vega.snapshot.v1.EquityShareLP
	...
	61,  // 116: vega.snapshot.v1.SpotMarket.pegged_orders:type_name -> vega.snapshot.v1.PeggedOrders
	138, // 117: vega.snapshot.v1.SpotMarket.expiring_orders:type_name -> vega.Order
	57,  // 118: vega.snapshot.v1.SpotMarket.equity_share:type_name -> vega.snapshot.v1.EquityShare
	58,  // 119: vega.snapshot.v1.SpotMarket.fee_splitter:type_name -> vega.snapshot.v1.FeeSplitter
	...
	61,  // 123: vega.snapshot.v1.Market.pegged_orders:type_name -> vega.snapshot.v1.PeggedOrders
	...
	58,  // 126: vega.snapshot.v1.Market.fee_splitter:type_name -> vega.snapshot.v1.FeeSplitter
	138, // 127: vega.snapshot.v1.PeggedOrders.parked_orders:type_name -> vega.Order
	60,  // 128: vega.snapshot.v1.ExecutionMarkets.markets:type_name -> vega.snapshot.v1.Market
	59,  // 129: vega.snapshot.v1.ExecutionMarkets.spot_markets:type_name -> vega.snapshot.v1.SpotMarket
	63,  // 130: vega.snapshot.v1.MarketPositions.positions:type_name -> vega.snapshot.v1.Position
	66,  // 131: vega.snapshot.v1.SettlementState.last_settled_positions:type_name -> vega.snapshot.v1.LastSettledPosition
	67,  // 132: vega.snapshot.v1.SettlementState.trades:type_name -> vega.snapshot.v1.SettlementTrade
	71,  // 133: vega.snapshot.v1.RewardsPendingPayouts.scheduled_rewards_payout:type_name -> vega.snapshot.v1.ScheduledRewardsPayout
	72,  // 134: vega.snapshot.v1.ScheduledRewardsPayout.rewards_payout:type_name -> vega.snapshot.v1.RewardsPayout
	73,  // 135: vega.snapshot.v1.RewardsPayout.reward_party_amount:type_name -> vega.snapshot.v1.RewardsPartyAmount
	76,  // 136: vega.snapshot.v1.VoteSpamPolicy.party_to_vote:type_name -> vega.snapshot.v1.PartyProposalVoteCount
	115, // 137: vega.snapshot.v1.VoteSpamPolicy.banned_parties:type_name -> vega.snapshot.v1.BannedParty
	77,  // 138: vega.snapshot.v1.VoteSpamPolicy.token_balance:type_name -> vega.snapshot.v1.PartyTokenBalance
	78,  // 139: vega.snapshot.v1.VoteSpamPolicy.recent_blocks_reject_stats:type_name -> vega.snapshot.v1.BlockRejectStats
	79,  // 140: vega.snapshot.v1.SimpleSpamPolicy.party_to_count:type_name -> vega.snapshot.v1.SpamPartyTransactionCount
	115, // 141: vega.snapshot.v1.SimpleSpamPolicy.banned_parties:type_name -> vega.snapshot.v1.BannedParty
	77,  // 142: vega.snapshot.v1.SimpleSpamPolicy.token_balance:type_name -> vega.snapshot.v1.PartyTokenBalance
	81,  // 143: vega.snapshot.v1.Notary.notary_sigs:type_name -> vega.snapshot.v1.NotarySigs
	85,  // 144: vega.snapshot.v1.StakeVerifierDeposited.pending_deposited:type_name -> vega.snapshot.v1.StakeVerifierPending
	85,  // 145: vega.snapshot.v1.StakeVerifierRemoved.pending_removed:type_name -> vega.snapshot.v1.StakeVerifierPending
	87,  // 146: vega.snapshot.v1.EthContractCallResults.pending_contract_call_result:type_name -> vega.snapshot.v1.EthContractCallResult
	94,  // 147: vega.snapshot.v1.Topology.validator_data:type_name -> vega.snapshot.v1.ValidatorState
	88,  // 148: vega.snapshot.v1.Topology.pending_pub_key_rotations:type_name -> vega.snapshot.v1.PendingKeyRotation
	97,  // 149: vega.snapshot.v1.Topology.validator_performance:type_name -> vega.snapshot.v1.ValidatorPerformance
	89,  // 150: vega.snapshot.v1.Topology.pending_ethereum_key_rotations:type_name -> vega.snapshot.v1.PendingEthereumKeyRotation
	91,  // 151: vega.snapshot.v1.Topology.signatures:type_name -> vega.snapshot.v1.ToplogySignatures
	89,  // 152: vega.snapshot.v1.Topology.unsolved_ethereum_key_rotations:type_name -> vega.snapshot.v1.PendingEthereumKeyRotation
	92,  // 153: vega.snapshot.v1.ToplogySignatures.pending_signatures:type_name -> vega.snapshot.v1.PendingERC20MultisigControlSignature
	93,  // 154: vega.snapshot.v1.ToplogySignatures.issued_signatures:type_name -> vega.snapshot.v1.IssuedERC20MultisigControlSignature
	145, // 155: vega.snapshot.v1.ValidatorState.validator_update:type_name -> vega.events.v1.ValidatorUpdate
	95,  // 156: vega.snapshot.v1.ValidatorState.heartbeat_tracker:type_name -> vega.snapshot.v1.HeartbeatTracker
	146, // 157: vega.snapshot.v1.ValidatorState.ranking_score:type_name -> vega.RankingScore
	96,  // 158: vega.snapshot.v1.ValidatorPerformance.validator_perf_stats:type_name -> vega.snapshot.v1.PerformanceStats
	101, // 159: vega.snapshot.v1.LiquidityPartiesLiquidityOrders.party_orders:type_name -> vega.snapshot.v1.PartyOrders
	138, // 160: vega.snapshot.v1.PartyOrders.orders:type_name -> vega.Order
	101, // 161: vega.snapshot.v1.LiquidityPartiesOrders.party_orders:type_name -> vega.snapshot.v1.PartyOrders
	147, // 162: vega.snapshot.v1.LiquidityProvisions.liquidity_provisions:type_name -> vega.LiquidityProvision
	105, // 163: vega.snapshot.v1.LiquidityScores.scores:type_name -> vega.snapshot.v1.LiquidityScore
	109, // 164: vega.snapshot.v1.FloatingPointConsensus.next_time_trigger:type_name -> vega.snapshot.v1.NextTimeTrigger
	107, // 165: vega.snapshot.v1.FloatingPointConsensus.state_variables:type_name -> vega.snapshot.v1.StateVarInternalState
	108, // 166: vega.snapshot.v1.StateVarInternalState.validators_results:type_name -> vega.snapshot.v1.FloatingPointValidatorResult
	148, // 167: vega.snapshot.v1.FloatingPointValidatorResult.bundle:type_name -> vega.KeyValueBundle
	149, // 168: vega.snapshot.v1.MarketTracker.market_activity:type_name -> vega.checkpoint.v1.MarketActivityTracker
	150, // 169: vega.snapshot.v1.SignerEventsPerAddress.events:type_name -> vega.events.v1.ERC20MultiSigSignerEvent
	111, // 170: vega.snapshot.v1.ERC20MultiSigTopologyVerified.events_per_address:type_name -> vega.snapshot.v1.SignerEventsPerAddress
	151, // 171: vega.snapshot.v1.ERC20MultiSigTopologyVerified.threshold:type_name -> vega.events.v1.ERC20MultiSigThresholdSetEvent
	150, // 172: vega.snapshot.v1.ERC20MultiSigTopologyPending.pending_signers:type_name -> vega.events.v1.ERC20MultiSigSignerEvent
	151, // 173: vega.snapshot.v1.ERC20MultiSigTopologyPending.pending_threshold_set:type_name -> vega.events.v1.ERC20MultiSigThresholdSetEvent
	120, // 174: vega.snapshot.v1.ProofOfWork.tx_at_height:type_name -> vega.snapshot.v1.TransactionsAtHeight
	120, // 175: vega.snapshot.v1.ProofOfWork.tid_at_height:type_name -> vega.snapshot.v1.TransactionsAtHeight
	115, // 176: vega.snapshot.v1.ProofOfWork.banned:type_name -> vega.snapshot.v1.BannedParty
	116, // 177: vega.snapshot.v1.ProofOfWork.pow_params:type_name -> vega.snapshot.v1.ProofOfWorkParams
	117, // 178: vega.snapshot.v1.ProofOfWork.pow_state:type_name -> vega.snapshot.v1.ProofOfWorkState
	118, // 179: vega.snapshot.v1.ProofOfWorkState.pow_state:type_name -> vega.snapshot.v1.ProofOfWorkBlockState
	119, // 180: vega.snapshot.v1.ProofOfWorkBlockState.party_state:type_name -> vega.snapshot.v1.ProofOfWorkPartyStateForBlock
	152, // 181: vega.snapshot.v1.ProtocolUpgradeProposals.active_proposals:type_name -> vega.events.v1.ProtocolUpgradeEvent
	122, // 182: vega.snapshot.v1.ProtocolUpgradeProposals.accepted_proposal:type_name -> vega.snapshot.v1.AcceptedProtocolUpgradeProposal
