...
type Order_MarketType int32

const (
	// Default value, always invalid
	Order_MARKET_TYPE_UNSPECIFIED Order_MarketType = 0
	// Normal trading market
	Order_MARKET_TYPE_CONTINUOUS Order_MarketType = 1
	// Auction
	Order_MARKET_TYPE_AUCTION Order_MarketType = 2
	// used for orders where the initiating party is the network (used for distressed traders)
	Order_MARKET_TYPE_AUCTION_AND_CONTINUOUS Order_MarketType = 3
)

var Order_MarketType_name = map[int32]string{
	0: "MARKET_TYPE_UNSPECIFIED",
	1: "MARKET_TYPE_CONTINUOUS",
	2: "MARKET_TYPE_AUCTION",
	3: "MARKET_TYPE_AUCTION_AND_CONTINUOUS",
}

var Order_MarketType_value = map[string]int32{
	"MARKET_TYPE_UNSPECIFIED":            0,
	"MARKET_TYPE_CONTINUOUS":             1,
	"MARKET_TYPE_AUCTION":                2,
	"MARKET_TYPE_AUCTION_AND_CONTINUOUS": 3,
}

func (x Order_MarketType) String() string {
	return proto.EnumName(Order_MarketType_name, int32(x))
}

func (Order_MarketType) EnumDescriptor() ([]byte, []int) {
...
type Order struct {
	...
	// Used to indicate which market state this order is valid for
	MarketType           Order_MarketType `protobuf:"varint,18,opt,name=marketType,proto3,enum=vega.Order_MarketType" json:"marketType,omitempty"`
	XXX_NoUnkeyedLiteral struct{}         `json:"-"`
	XXX_unrecognized     []byte           `json:"-"`
	XXX_sizecache        int32            `json:"-"`
}
...
func (m *Order) GetMarketType() Order_MarketType {
	if m != nil {
		return m.MarketType
	}
	return Order_MARKET_TYPE_UNSPECIFIED
}
...
type OrderSubmission struct {
	...
	MarketType           Order_MarketType  `protobuf:"varint,11,opt,name=marketType,proto3,enum=vega.Order_MarketType" json:"marketType,omitempty"`
	XXX_NoUnkeyedLiteral struct{}          `json:"-"`
	XXX_unrecognized     []byte            `json:"-"`
	XXX_sizecache        int32             `json:"-"`
}
...
func (m *OrderSubmission) GetMarketType() Order_MarketType {
	if m != nil {
		return m.MarketType
	}
	return Order_MARKET_TYPE_UNSPECIFIED
...
func init() {
	...
	proto.RegisterEnum("vega.Order_MarketType", Order_MarketType_name, Order_MarketType_value)
...
var fileDescriptor_bb6b8173ee11af27 = []byte{
	...
	,
}
