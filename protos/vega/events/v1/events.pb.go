...
var file_vega_events_v1_events_proto_rawDesc = []byte{
	...
	0x61, 0x73, 0x74, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x48, 0x65, 0x69, 0x67, 0x68, 0x74, 0x22, 0xf4,
	0x1d, 0x0a, 0x08, 0x42, 0x75, 0x73, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x12, 0x0e, 0x0a, 0x02, 0x69,
	...
	0x75, 0x6c, 0x74, 0x12, 0x36, 0x0a, 0x06, 0x6d, 0x61, 0x72, 0x6b, 0x65, 0x74, 0x18, 0xe9, 0x07,
	...
	0x54, 0x45, 0x44, 0x10, 0x03, 0x2a, 0x9d, 0x0f, 0x0a, 0x0c, 0x42, 0x75, 0x73, 0x45, 0x76, 0x65,
	...
	0x49, 0x4f, 0x4e, 0x5f, 0x52, 0x45, 0x53, 0x55, 0x4c, 0x54, 0x10, 0x35, 0x12, 0x19, 0x0a, 0x15,
...
var file_vega_events_v1_events_proto_msgTypes = make([]protoimpl.MessageInfo, 41)
var file_vega_events_v1_events_proto_goTypes = []interface{}{
	...
	(*BusEvent)(nil),                            // 44: vega.events.v1.BusEvent
	(*TransactionResult_SuccessDetails)(nil),    // 45: vega.events.v1.TransactionResult.SuccessDetails
	(*TransactionResult_FailureDetails)(nil),    // 46: vega.events.v1.TransactionResult.FailureDetails
	(vega.AccountType)(0),                       // 47: vega.AccountType
	(*vega.DispatchStrategy)(nil),               // 48: vega.DispatchStrategy
	(*v1.OrderSubmission)(nil),                  // 49: vega.commands.v1.OrderSubmission
	(*v1.OrderAmendment)(nil),                   // 50: vega.commands.v1.OrderAmendment
	(*v1.OrderCancellation)(nil),                // 51: vega.commands.v1.OrderCancellation
	(*v1.ProposalSubmission)(nil),               // 52: vega.commands.v1.ProposalSubmission
	(*v1.VoteSubmission)(nil),                   // 53: vega.commands.v1.VoteSubmission
	(*v1.LiquidityProvisionSubmission)(nil),     // 54: vega.commands.v1.LiquidityProvisionSubmission
	(*v1.WithdrawSubmission)(nil),               // 55: vega.commands.v1.WithdrawSubmission
	(*v1.DelegateSubmission)(nil),               // 56: vega.commands.v1.DelegateSubmission
	(*v1.UndelegateSubmission)(nil),             // 57: vega.commands.v1.UndelegateSubmission
	(*v1.LiquidityProvisionCancellation)(nil),   // 58: vega.commands.v1.LiquidityProvisionCancellation
	(*v1.LiquidityProvisionAmendment)(nil),      // 59: vega.commands.v1.LiquidityProvisionAmendment
	(*v1.Transfer)(nil),                         // 60: vega.commands.v1.Transfer
	(*v1.CancelTransfer)(nil),                   // 61: vega.commands.v1.CancelTransfer
	(*v1.AnnounceNode)(nil),                     // 62: vega.commands.v1.AnnounceNode
	(*v1.OracleDataSubmission)(nil),             // 63: vega.commands.v1.OracleDataSubmission
	(*v1.ProtocolUpgradeProposal)(nil),          // 64: vega.commands.v1.ProtocolUpgradeProposal
	(*v1.IssueSignatures)(nil),                  // 65: vega.commands.v1.IssueSignatures
	(*v1.BatchMarketInstructions)(nil),          // 66: vega.commands.v1.BatchMarketInstructions
	(*v1.KeyRotateSubmission)(nil),              // 67: vega.commands.v1.KeyRotateSubmission
	(*v1.EthereumKeyRotateSubmission)(nil),      // 68: vega.commands.v1.EthereumKeyRotateSubmission
	(vega.EpochAction)(0),                       // 69: vega.EpochAction
	(*vega.LedgerMovement)(nil),                 // 70: vega.LedgerMovement
	(vega.AuctionTrigger)(0),                    // 71: vega.AuctionTrigger
	(*vega.Order)(nil),                          // 72: vega.Order
	(*vega.Account)(nil),                        // 73: vega.Account
	(*vega.Party)(nil),                          // 74: vega.Party
	(*vega.Trade)(nil),                          // 75: vega.Trade
	(*vega.MarginLevels)(nil),                   // 76: vega.MarginLevels
	(*vega.Proposal)(nil),                       // 77: vega.Proposal
	(*vega.Vote)(nil),                           // 78: vega.Vote
	(*vega.MarketData)(nil),                     // 79: vega.MarketData
	(*v1.NodeSignature)(nil),                    // 80: vega.commands.v1.NodeSignature
	(*vega.Market)(nil),                         // 81: vega.Market
	(*vega.Asset)(nil),                          // 82: vega.Asset
	(*vega.Withdrawal)(nil),                     // 83: vega.Withdrawal
	(*vega.Deposit)(nil),                        // 84: vega.Deposit
	(*vega.RiskFactor)(nil),                     // 85: vega.RiskFactor
	(*vega.NetworkParameter)(nil),               // 86: vega.NetworkParameter
	(*vega.LiquidityProvision)(nil),             // 87: vega.LiquidityProvision
	(*vega.OracleSpec)(nil),                     // 88: vega.OracleSpec
	(*vega.OracleData)(nil),                     // 89: vega.OracleData
	(*vega.NetworkLimits)(nil),                  // 90: vega.NetworkLimits
}
var file_vega_events_v1_events_proto_depIdxs = []int32{
	...
	47,  // 1: vega.events.v1.Transfer.from_account_type:type_name -> vega.AccountType
	47,  // 2: vega.events.v1.Transfer.to_account_type:type_name -> vega.AccountType
	...
	48,  // 6: vega.events.v1.RecurringTransfer.dispatch_strategy:type_name -> vega.DispatchStrategy
	...
	49,  // 10: vega.events.v1.TransactionResult.order_submission:type_name -> vega.commands.v1.OrderSubmission
	50,  // 11: vega.events.v1.TransactionResult.order_amendment:type_name -> vega.commands.v1.OrderAmendment
	51,  // 12: vega.events.v1.TransactionResult.order_cancellation:type_name -> vega.commands.v1.OrderCancellation
	52,  // 13: vega.events.v1.TransactionResult.proposal:type_name -> vega.commands.v1.ProposalSubmission
	53,  // 14: vega.events.v1.TransactionResult.vote_submission:type_name -> vega.commands.v1.VoteSubmission
	54,  // 15: vega.events.v1.TransactionResult.liquidity_provision_submission:type_name -> vega.commands.v1.LiquidityProvisionSubmission
	55,  // 16: vega.events.v1.TransactionResult.withdraw_submission:type_name -> vega.commands.v1.WithdrawSubmission
	56,  // 17: vega.events.v1.TransactionResult.delegate_submission:type_name -> vega.commands.v1.DelegateSubmission
	57,  // 18: vega.events.v1.TransactionResult.undelegate_submission:type_name -> vega.commands.v1.UndelegateSubmission
	58,  // 19: vega.events.v1.TransactionResult.liquidity_provision_cancellation:type_name -> vega.commands.v1.LiquidityProvisionCancellation
	59,  // 20: vega.events.v1.TransactionResult.liquidity_provision_amendment:type_name -> vega.commands.v1.LiquidityProvisionAmendment
	60,  // 21: vega.events.v1.TransactionResult.transfer:type_name -> vega.commands.v1.Transfer
	61,  // 22: vega.events.v1.TransactionResult.cancel_transfer:type_name -> vega.commands.v1.CancelTransfer
	62,  // 23: vega.events.v1.TransactionResult.announce_node:type_name -> vega.commands.v1.AnnounceNode
	63,  // 24: vega.events.v1.TransactionResult.oracle_data_submission:type_name -> vega.commands.v1.OracleDataSubmission
	64,  // 25: vega.events.v1.TransactionResult.protocol_upgrade_proposal:type_name -> vega.commands.v1.ProtocolUpgradeProposal
	65,  // 26: vega.events.v1.TransactionResult.issue_signatures:type_name -> vega.commands.v1.IssueSignatures
	66,  // 27: vega.events.v1.TransactionResult.batch_market_instructions:type_name -> vega.commands.v1.BatchMarketInstructions
	67,  // 28: vega.events.v1.TransactionResult.key_rotate_submission:type_name -> vega.commands.v1.KeyRotateSubmission
	68,  // 29: vega.events.v1.TransactionResult.ethereum_key_rotate_submission:type_name -> vega.commands.v1.EthereumKeyRotateSubmission
	45,  // 30: vega.events.v1.TransactionResult.success:type_name -> vega.events.v1.TransactionResult.SuccessDetails
	46,  // 31: vega.events.v1.TransactionResult.failure:type_name -> vega.events.v1.TransactionResult.FailureDetails
	49,  // 32: vega.events.v1.TxErrorEvent.order_submission:type_name -> vega.commands.v1.OrderSubmission
	50,  // 33: vega.events.v1.TxErrorEvent.order_amendment:type_name -> vega.commands.v1.OrderAmendment
	51,  // 34: vega.events.v1.TxErrorEvent.order_cancellation:type_name -> vega.commands.v1.OrderCancellation
	52,  // 35: vega.events.v1.TxErrorEvent.proposal:type_name -> vega.commands.v1.ProposalSubmission
	53,  // 36: vega.events.v1.TxErrorEvent.vote_submission:type_name -> vega.commands.v1.VoteSubmission
	54,  // 37: vega.events.v1.TxErrorEvent.liquidity_provision_submission:type_name -> vega.commands.v1.LiquidityProvisionSubmission
	55,  // 38: vega.events.v1.TxErrorEvent.withdraw_submission:type_name -> vega.commands.v1.WithdrawSubmission
	56,  // 39: vega.events.v1.TxErrorEvent.delegate_submission:type_name -> vega.commands.v1.DelegateSubmission
	57,  // 40: vega.events.v1.TxErrorEvent.undelegate_submission:type_name -> vega.commands.v1.UndelegateSubmission
	58,  // 41: vega.events.v1.TxErrorEvent.liquidity_provision_cancellation:type_name -> vega.commands.v1.LiquidityProvisionCancellation
	59,  // 42: vega.events.v1.TxErrorEvent.liquidity_provision_amendment:type_name -> vega.commands.v1.LiquidityProvisionAmendment
	60,  // 43: vega.events.v1.TxErrorEvent.transfer:type_name -> vega.commands.v1.Transfer
	61,  // 44: vega.events.v1.TxErrorEvent.cancel_transfer:type_name -> vega.commands.v1.CancelTransfer
	62,  // 45: vega.events.v1.TxErrorEvent.announce_node:type_name -> vega.commands.v1.AnnounceNode
	63,  // 46: vega.events.v1.TxErrorEvent.oracle_data_submission:type_name -> vega.commands.v1.OracleDataSubmission
	64,  // 47: vega.events.v1.TxErrorEvent.protocol_upgrade_proposal:type_name -> vega.commands.v1.ProtocolUpgradeProposal
	65,  // 48: vega.events.v1.TxErrorEvent.issue_signatures:type_name -> vega.commands.v1.IssueSignatures
	66,  // 49: vega.events.v1.TxErrorEvent.batch_market_instructions:type_name -> vega.commands.v1.BatchMarketInstructions
	69,  // 50: vega.events.v1.EpochEvent.action:type_name -> vega.EpochAction
	70,  // 51: vega.events.v1.LedgerMovements.ledger_movements:type_name -> vega.LedgerMovement
	28,  // 52: vega.events.v1.SettlePosition.trade_settlements:type_name -> vega.events.v1.TradeSettlement
	71,  // 53: vega.events.v1.AuctionEvent.trigger:type_name -> vega.AuctionTrigger
	71,  // 54: vega.events.v1.AuctionEvent.extension_trigger:type_name -> vega.AuctionTrigger
	...
	72,  // 60: vega.events.v1.BusEvent.order:type_name -> vega.Order
	73,  // 61: vega.events.v1.BusEvent.account:type_name -> vega.Account
	74,  // 62: vega.events.v1.BusEvent.party:type_name -> vega.Party
	75,  // 63: vega.events.v1.BusEvent.trade:type_name -> vega.Trade
	76,  // 64: vega.events.v1.BusEvent.margin_levels:type_name -> vega.MarginLevels
	77,  // 65: vega.events.v1.BusEvent.proposal:type_name -> vega.Proposal
	78,  // 66: vega.events.v1.BusEvent.vote:type_name -> vega.Vote
	79,  // 67: vega.events.v1.BusEvent.market_data:type_name -> vega.MarketData
	80,  // 68: vega.events.v1.BusEvent.node_signature:type_name -> vega.commands.v1.NodeSignature
	...
	81,  // 72: vega.events.v1.BusEvent.market_created:type_name -> vega.Market
	82,  // 73: vega.events.v1.BusEvent.asset:type_name -> vega.Asset
	33,  // 74: vega.events.v1.BusEvent.market_tick:type_name -> vega.events.v1.MarketTick
	83,  // 75: vega.events.v1.BusEvent.withdrawal:type_name -> vega.Withdrawal
	84,  // 76: vega.events.v1.BusEvent.deposit:type_name -> vega.Deposit
	34,  // 77: vega.events.v1.BusEvent.auction:type_name -> vega.events.v1.AuctionEvent
	85,  // 78: vega.events.v1.BusEvent.risk_factor:type_name -> vega.RiskFactor
	86,  // 79: vega.events.v1.BusEvent.network_parameter:type_name -> vega.NetworkParameter
	87,  // 80: vega.events.v1.BusEvent.liquidity_provision:type_name -> vega.LiquidityProvision
	81,  // 81: vega.events.v1.BusEvent.market_updated:type_name -> vega.Market
	88,  // 82: vega.events.v1.BusEvent.oracle_spec:type_name -> vega.OracleSpec
	89,  // 83: vega.events.v1.BusEvent.oracle_data:type_name -> vega.OracleData
	...
	90,  // 93: vega.events.v1.BusEvent.network_limits:type_name -> vega.NetworkLimits
	...
	20,  // 108: vega.events.v1.BusEvent.market:type_name -> vega.events.v1.MarketEvent
	22,  // 109: vega.events.v1.BusEvent.tx_err_event:type_name -> vega.events.v1.TxErrorEvent
