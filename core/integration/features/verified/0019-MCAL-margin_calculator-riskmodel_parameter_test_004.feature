Feature: test risk model parameter change in margin calculation
  ...
  Background:
    ...
    Given the markets:
      ...
      | ETH/MAR22 | ETH        | USD   | log-normal-risk-model-4 | default-margin-calculator | 1                | fees-config-1 | price-monitoring-1 | default-eth-for-future |
   ...
   Scenario:  lognormal risk model 004
   ...
   And the parties submit the following liquidity provision:
    ...
    And the parties should have the following account balances:
      ...
      | party0 | USD   | ETH/MAR22 | 15870  | 434130   | 50000 |
      | party1 | USD   | ETH/MAR22 | 3101   | 99996899 | 0     |
      | party2 | USD   | ETH/MAR22 | 2953   | 99997047 | 0     |
    ...
    Then the parties should have the following margin levels:
      ...
      | party0 | ETH/MAR22 | 13225       | 14547  | 15870  | 18515  |
      | party1 | ETH/MAR22 | 2299        | 2528   | 2758   | 3218   |
      | party2 | ETH/MAR22 | 2461        | 2707   | 2953   | 3445   |
