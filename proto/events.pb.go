...
type TxErrorEvent_Order struct {
	Order *Order `protobuf:"bytes,101,opt,name=order,proto3,oneof"`
}
...
func (*TxErrorEvent_Order) isTxErrorEvent_Transaction() {}
...
func (m *TxErrorEvent) GetOrder() *Order {
	if x, ok := m.GetTransaction().(*TxErrorEvent_Order); ok {
		return x.Order
	}
	return nil
}
...
var fileDescriptor_499cf8c2dd86f7dd = []byte{
	...
	,
}
