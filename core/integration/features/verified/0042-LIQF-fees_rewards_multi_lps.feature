Feature: Test liquidity provider reward distribution when there are multiple liquidity providers;
  ...
  Background:
    ...
    And the markets:
      ...
      | ETH/MAR22 | USD        | USD   | log-normal-risk-model | margin-calculator-1 | 2                | fees-config-1 | price-monitoring | default-eth-for-future | 1e6                    | 1e6                       | default-futures |
  ...
  Scenario: 001: All liquidity providers in the market receive a greater than zero amount of liquidity fee
    ...
    And the parties place the following pegged iceberg orders:
      ...
      | lp2   | ETH/MAR22 | 2         | 1                    | buy  | BID              | 1          | 20     |
      | lp2   | ETH/MAR22 | 2         | 1                    | sell | ASK              | 1          | 20     |
      | lp3   | ETH/MAR22 | 2         | 1                    | buy  | BID              | 1          | 20     |
      | lp3   | ETH/MAR22 | 2         | 1                    | sell | ASK              | 1          | 20     |
