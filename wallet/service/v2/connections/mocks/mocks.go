...
// Source: code.vegaprotocol.io/vega/wallet/service/v2/connections (interfaces: WalletStore,TimeService,TokenStore,SessionStore)
...
func (m *MockSessionStore) ListSessions(arg0 context.Context) ([]connections.Session, error) {
	...
	ret0, _ := ret[0].([]connections.Session)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockSessionStoreMockRecorder) ListSessions(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListSessions", reflect.TypeOf((*MockSessionStore)(nil).ListSessions), arg0)
}

// TrackSession mocks base method.
func (m *MockSessionStore) TrackSession(arg0 connections.Session) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "TrackSession", arg0)
	ret0, _ := ret[0].(error)
	return ret0
}
...
func (mr *MockSessionStoreMockRecorder) TrackSession(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "TrackSession", reflect.TypeOf((*MockSessionStore)(nil).TrackSession), arg0)
}
