...
func TestMarshalWallet(t *testing.T) {
	...
	expected := `{"Owner":"jeremy","Keypairs":[{"Pub":"AQIDBA==","Priv":"BAMCAQ==","Algorithm":"ed25519","Tainted":false,"Meta":null}]}`
...
func TestUnMarshalWallet(t *testing.T) {
	w := Wallet{}
	marshalled := `{"Owner":"jeremy","Keypairs":[{"Pub":"AQIDBA==","Priv":"BAMCAQ==","Algorithm":"ed25519","Tainted":false,"Meta":null}]}`
...
func TestUnMarshalWalletErrorInvalidAlgorithm(t *testing.T) {
	w := Wallet{}
	marshalled := `{"Owner":"jeremy","Keypairs":[{"Pub":"AQIDBA==","Priv":"BAMCAQ==","Algorithm":"notanalgorithm","Tainted":false,"Meta":null}]}`
	err := json.Unmarshal([]byte(marshalled), &w)
