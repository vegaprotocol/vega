Feature: Test funding margin for Perps market
  ...
  @Perpetual
  Scenario: (0019-MCAL-027, 0019-MCAL-030 - cross margin, 0019-MCAL-058, 0019-MCAL-054 - isolated margin) check funding margin for Perps market when clumps are -0.05 and 0.05
    ...
    And the perpetual oracles from "0xCAFECAFE1":
      ...
      | perp-oracle | USD   | perp.ETH.value      | TYPE_INTEGER    | perp.funding.cue  | TYPE_TIMESTAMP | 0.5                   | 0.05          | -0.05             | 0.05              | ETH        | 18                  |
    And the markets:
    ...
    When the parties place the following orders:
      ...
      | party1 | ETH/DEC19 | sell | 1      | 1500    | 0                | TYPE_LIMIT | TIF_GTC |
      | party2 | ETH/DEC19 | buy  | 1      | 1500    | 0                | TYPE_LIMIT | TIF_GTC |
    ...
    When the parties place the following orders:
      | party  | market id | side | volume | price   | resulting trades | type       | tif     |
      | party4 | ETH/DEC19 | buy  | 1      | 1500    | 0                | TYPE_LIMIT | TIF_GTC |
      | party3 | ETH/DEC19 | sell | 1      | 1500    | 1                | TYPE_LIMIT | TIF_GTC |
    ...
    Then the mark price should be "1500" for the market "ETH/DEC19"
    And the parties should have the following margin levels:
      | party  | market id | maintenance | margin mode     |
      | party1 | ETH/DEC19 | 525000      | cross margin    |
      | party2 | ETH/DEC19 | 525000      | cross margin    |
      | party3 | ETH/DEC19 | 525000      | isolated margin |
      | party4 | ETH/DEC19 | 525000      | isolated margin |
    ...
    And the parties place the following orders:
      | party  | market id | side | volume | price | resulting trades | type       | tif     |
      | aux    | ETH/DEC19 | buy  | 1      | 1501  | 0                | TYPE_LIMIT | TIF_GTC |
      | aux2   | ETH/DEC19 | sell | 1      | 1501  | 1                | TYPE_LIMIT | TIF_GTC |
    And the network moves ahead "5" blocks
    # Now trade at desired price and forward time again to trigger another MTM
    And the parties place the following orders:
      | party  | market id | side | volume | price | resulting trades | type       | tif     |
      | aux    | ETH/DEC19 | buy  | 1      | 1500  | 0                | TYPE_LIMIT | TIF_GTC |
      | aux2   | ETH/DEC19 | sell | 1      | 1500  | 1                | TYPE_LIMIT | TIF_GTC |
    And the network moves ahead "5" blocks
    Then the parties should have the following margin levels:
      | party  | market id | maintenance | margin mode     |
      | party1 | ETH/DEC19 | 535000      | cross margin    |
      | party2 | ETH/DEC19 | 525000      | cross margin    |
      | party3 | ETH/DEC19 | 535000      | isolated margin |
      | party4 | ETH/DEC19 | 525000      | isolated margin |
    ...
    Then the following funding period events should be emitted:
      ...
      | 1704067201000000000 | 1704130273000000000  | 1500000       | 1600000       | -20000          | -0.0125      |
    And the following transfers should happen:
      | from   | to     | from account            | to account              | market id | amount | asset | type                                  |
      | market | party2 | ACCOUNT_TYPE_SETTLEMENT | ACCOUNT_TYPE_MARGIN     | ETH/DEC19 | 20000  | USD   | TRANSFER_TYPE_PERPETUALS_FUNDING_WIN  |
      | party1 | market | ACCOUNT_TYPE_MARGIN     | ACCOUNT_TYPE_SETTLEMENT | ETH/DEC19 | 20000  | USD   | TRANSFER_TYPE_PERPETUALS_FUNDING_LOSS |
      | market | party4 | ACCOUNT_TYPE_SETTLEMENT | ACCOUNT_TYPE_MARGIN     | ETH/DEC19 | 20000  | USD   | TRANSFER_TYPE_PERPETUALS_FUNDING_WIN  |
      | party3 | market | ACCOUNT_TYPE_MARGIN     | ACCOUNT_TYPE_SETTLEMENT | ETH/DEC19 | 20000  | USD   | TRANSFER_TYPE_PERPETUALS_FUNDING_LOSS |