...
const (
	...
	StopOrderRejectionOCONotAllowedSameExpiryTime    StopOrderRejectionReason = vega.StopOrder_REJECTION_REASON_STOP_ORDER_CANNOT_HAVE_MATCHING_OCO_EXPIRY_TIMES
)
