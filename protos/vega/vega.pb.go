...
const (
	...
	// Spot moving funds to holding account
	TransferType_TRANSFER_TYPE_HOLDING_LOCK TransferType = 27
	// Spot release funds from holding account
...
// Spot Liquidity provider commitment
type SpotLiquidityProvision struct {
	...
	// Set of liquidity sell orders to meet the liquidity provision obligation.
	Sells []*LiquidityOrderReference `protobuf:"bytes,9,rep,name=sells,proto3" json:"sells,omitempty"`
	// Set of liquidity buy orders to meet the liquidity provision obligation.
	Buys []*LiquidityOrderReference `protobuf:"bytes,10,rep,name=buys,proto3" json:"buys,omitempty"`
	// Version of this liquidity provision order.
	Version uint64 `protobuf:"varint,11,opt,name=version,proto3" json:"version,omitempty"`
	// Status of this liquidity provision order.
	Status SpotLiquidityProvision_Status `protobuf:"varint,12,opt,name=status,proto3,enum=vega.SpotLiquidityProvision_Status" json:"status,omitempty"`
	// Reference shared between this liquidity provision and all its orders.
	Reference string `protobuf:"bytes,13,opt,name=reference,proto3" json:"reference,omitempty"`
}
...
func (x *SpotLiquidityProvision) GetSells() []*LiquidityOrderReference {
	if x != nil {
		return x.Sells
	}
	return nil
...
func (x *SpotLiquidityProvision) GetBuys() []*LiquidityOrderReference {
	if x != nil {
		return x.Buys
	}
	return nil
...
func (x *SpotLiquidityProvision) GetReference() string {
	if x != nil {
		return x.Reference
	}
	return ""
...
var file_vega_vega_proto_rawDesc = []byte{
	...
	0x54, 0x55, 0x53, 0x5f, 0x50, 0x45, 0x4e, 0x44, 0x49, 0x4e, 0x47, 0x10, 0x06, 0x22, 0x97, 0x05,
	...
	0x08, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x66, 0x65, 0x65, 0x12, 0x33, 0x0a, 0x05, 0x73, 0x65,
	0x6c, 0x6c, 0x73, 0x18, 0x09, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1d, 0x2e, 0x76, 0x65, 0x67, 0x61,
	...
	0x31, 0x0a, 0x04, 0x62, 0x75, 0x79, 0x73, 0x18, 0x0a, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1d, 0x2e,
	...
	0x79, 0x73, 0x12, 0x18, 0x0a, 0x07, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x18, 0x0b, 0x20,
	0x01, 0x28, 0x04, 0x52, 0x07, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x3b, 0x0a, 0x06,
	0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x23, 0x2e, 0x76,
	...
	0x49, 0x4e, 0x47, 0x10, 0x12, 0x22, 0x04, 0x08, 0x08, 0x10, 0x08, 0x2a, 0xa4, 0x07, 0x0a, 0x0c,
	...
	0x45, 0x41, 0x53, 0x45, 0x10, 0x1c, 0x22, 0x04, 0x08, 0x03, 0x10, 0x03, 0x22, 0x04, 0x08, 0x11,
...
var file_vega_vega_proto_depIdxs = []int32{
	...
	58, // 52: vega.SpotLiquidityProvision.sells:type_name -> vega.LiquidityOrderReference
	58, // 53: vega.SpotLiquidityProvision.buys:type_name -> vega.LiquidityOrderReference
	20, // 54: vega.SpotLiquidityProvision.status:type_name -> vega.SpotLiquidityProvision.Status
	62, // 55: vega.EthereumConfig.collateral_bridge_contract:type_name -> vega.EthereumContractConfig
	62, // 56: vega.EthereumConfig.staking_bridge_contract:type_name -> vega.EthereumContractConfig
	62, // 57: vega.EthereumConfig.token_vesting_contract:type_name -> vega.EthereumContractConfig
	62, // 58: vega.EthereumConfig.multisig_control_contract:type_name -> vega.EthereumContractConfig
	63, // 59: vega.Epoch.timestamps:type_name -> vega.EpochTimestamps
	69, // 60: vega.Epoch.validators:type_name -> vega.Node
	72, // 61: vega.Epoch.delegations:type_name -> vega.Delegation
	64, // 62: vega.EpochParticipation.epoch:type_name -> vega.Epoch
	12, // 63: vega.RankingScore.previous_status:type_name -> vega.ValidatorNodeStatus
	12, // 64: vega.RankingScore.status:type_name -> vega.ValidatorNodeStatus
	12, // 65: vega.RewardScore.validator_status:type_name -> vega.ValidatorNodeStatus
	66, // 66: vega.Node.epoch_data:type_name -> vega.EpochData
	10, // 67: vega.Node.status:type_name -> vega.NodeStatus
	72, // 68: vega.Node.delegations:type_name -> vega.Delegation
	68, // 69: vega.Node.reward_score:type_name -> vega.RewardScore
	67, // 70: vega.Node.ranking_score:type_name -> vega.RankingScore
	70, // 71: vega.NodeData.tendermint_nodes:type_name -> vega.NodeSet
	70, // 72: vega.NodeData.ersatz_nodes:type_name -> vega.NodeSet
	70, // 73: vega.NodeData.pending_nodes:type_name -> vega.NodeSet
	77, // 74: vega.StateValueProposal.kvb:type_name -> vega.KeyValueBundle
	78, // 75: vega.KeyValueBundle.value:type_name -> vega.StateVarValue
	79, // 76: vega.StateVarValue.scalar_val:type_name -> vega.ScalarValue
	80, // 77: vega.StateVarValue.vector_val:type_name -> vega.VectorValue
	81, // 78: vega.StateVarValue.matrix_val:type_name -> vega.MatrixValue
	80, // 79: vega.MatrixValue.value:type_name -> vega.VectorValue
