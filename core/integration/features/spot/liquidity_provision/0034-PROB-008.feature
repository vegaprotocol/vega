Feature: Probability of trading decreases away from the mid-price in Spot market
  ...
  Scenario: 001
    ...
    And the party "lp1" lp liquidity fee account balance should be "0" for the market "BTC/ETH"
    And the party "lp2" lp liquidity fee account balance should be "0" for the market "BTC/ETH"
    And the party "lp3" lp liquidity fee account balance should be "0" for the market "BTC/ETH"
