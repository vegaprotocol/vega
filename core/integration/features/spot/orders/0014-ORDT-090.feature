Feature: Spot market
  ...
  Scenario: An iceberg reduce only order is rejected (0014-ORDT-090)
    ...
    When the parties place the following iceberg orders:
      ...
      | party1 | BTC/ETH   | buy  | 10     | 1000  | 0                | TYPE_LIMIT | TIF_GTC | 5         | 2                    | reduce | OrderError: iceberg orders cannot be reduce only |
