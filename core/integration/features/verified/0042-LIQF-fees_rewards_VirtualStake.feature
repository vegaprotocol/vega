Feature: Test liquidity provider reward distribution; Should also cover liquidity-fee-setting and equity-like-share calc and total stake.
  ...
  Background:
    ...
    And the markets:
      ...
      | ETH/MAR22 | USD        | USD   | simple-risk-model-1 | default-margin-calculator | 2                | fees-config-1 | price-monitoring | default-eth-for-future | 0.2                    | 0                         | default-futures |
  ...
  Scenario: 001 1 LP joining at start, checking liquidity rewards over 3 periods, 1 period with no trades (0042-LIQF-001)
    ...
    When the parties place the following orders:
      ...
      | lp1   | ETH/MAR22 | buy  | 1      | 900   | 0                | TYPE_LIMIT | TIF_GTC |
      | lp1   | ETH/MAR22 | buy  | 10     | 1000  | 0                | TYPE_LIMIT | TIF_GTC |
      | lp1   | ETH/MAR22 | sell | 1      | 1100  | 0                | TYPE_LIMIT | TIF_GTC |
      | lp1   | ETH/MAR22 | sell | 10     | 1000  | 0                | TYPE_LIMIT | TIF_GTC |
  ...
  Scenario: 004 2 LPs joining at start, 1 LP forcibly closed out (0042-LIQF-008)
    ...
    And the parties submit the following liquidity provision:
      ...
      | lp1 | lp1   | ETH/MAR22 | 1000              | 0.001 | amendment  |
    And the parties place the following pegged iceberg orders:
      | party | market id | peak size | minimum visible size | side | pegged reference | volume     | offset |
    ...
    And the parties submit the following liquidity provision:
      ...
      | lp2 | lp2   | ETH/MAR22 | 9000              | 0.002 | amendment  |
    And the parties place the following pegged iceberg orders:
      | party | market id | peak size | minimum visible size | side | pegged reference | volume     | offset |
