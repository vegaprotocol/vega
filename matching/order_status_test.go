...
func (m marketPositionFake) Price() *num.Uint  { return num.NewUint(0) }
func (m marketPositionFake) VWBuy() *num.Uint  { return num.NewUint(0) }
func (m marketPositionFake) VWSell() *num.Uint { return num.NewUint(0) }
