...
func (x *TakerNotionalVolume) GetVolume() string {
	if x != nil {
		return x.Volume
	}
	return ""
...
type TWNotionalPosition struct {
	...
	TwNotionalPosition string `protobuf:"bytes,5,opt,name=tw_notional_position,json=twNotionalPosition,proto3" json:"tw_notional_position,omitempty"`
}
...
func (x *TWNotionalPosition) GetPosition() string {
	if x != nil {
		return x.Position
	}
	return ""
...
func (x *TWNotionalPosition) GetPrice() string {
	if x != nil {
		return x.Price
	}
	return ""
...
func (x *TWNotionalPosition) GetTwNotionalPosition() string {
	if x != nil {
...
func (x *TWPositionData) GetPosition() string {
	if x != nil {
		return x.Position
	}
	return ""
...
type DataWithHistory struct {
	...
	RunningTotal        string   `protobuf:"bytes,2,opt,name=running_total,json=runningTotal,proto3" json:"running_total,omitempty"`
	PreviousEpochs      []string `protobuf:"bytes,3,rep,name=previous_epochs,json=previousEpochs,proto3" json:"previous_epochs,omitempty"`
	PreviousEpochsIndex uint64   `protobuf:"varint,4,opt,name=previous_epochs_index,json=previousEpochsIndex,proto3" json:"previous_epochs_index,omitempty"`
}
...
func (x *DataWithHistory) GetRunningTotal() string {
	if x != nil {
...
func (x *DataWithHistory) GetPreviousEpochs() []string {
	if x != nil {
...
var file_vega_checkpoint_v1_checkpoint_proto_rawDesc = []byte{
	...
	0x6c, 0x5f, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09,
	...
	0x6e, 0x6e, 0x69, 0x6e, 0x67, 0x5f, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x18, 0x02, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x0c, 0x72, 0x75, 0x6e, 0x6e, 0x69, 0x6e, 0x67, 0x54, 0x6f, 0x74, 0x61, 0x6c, 0x12,
	0x27, 0x0a, 0x0f, 0x70, 0x72, 0x65, 0x76, 0x69, 0x6f, 0x75, 0x73, 0x5f, 0x65, 0x70, 0x6f, 0x63,
	0x68, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28, 0x09, 0x52, 0x0e, 0x70, 0x72, 0x65, 0x76, 0x69, 0x6f,
	...
	0x78, 0x18, 0x04, 0x20, 0x01, 0x28, 0x04, 0x52, 0x13, 0x70, 0x72, 0x65, 0x76, 0x69, 0x6f, 0x75,
