...
func (m *MockOracleSpecStore) Upsert(arg0 *entities.OracleSpec) error {
	m.ctrl.T.Helper()
...
func (mr *MockOracleSpecStoreMockRecorder) Upsert(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Upsert", reflect.TypeOf((*MockOracleSpecStore)(nil).Upsert), arg0)
}
