Feature: test risk model parameter change in margin calculation
  Background:
    ...
    And the markets:
      ...
      | ETH/MAR21 | ETH        | USD   | lqm-params           | log-normal-risk-model-1 | default-margin-calculator | 1                | fees-config-1 | price-monitoring-1 | default-eth-for-future | 1e6                    | 1e6                       | default-futures |
      | ETH/MAR22 | ETH        | USD   | lqm-params           | log-normal-risk-model-2 | default-margin-calculator | 1                | fees-config-1 | price-monitoring-1 | default-eth-for-future | 1e6                    | 1e6                       | default-futures |
      | ETH/MAR23 | ETH        | USD   | lqm-params           | log-normal-risk-model-3 | default-margin-calculator | 1                | fees-config-1 | price-monitoring-1 | default-eth-for-future | 1e6                    | 1e6                       | default-futures |
      | ETH/MAR24 | ETH        | USD   | lqm-params           | log-normal-risk-model-4 | default-margin-calculator | 1                | fees-config-1 | price-monitoring-1 | default-eth-for-future | 1e6                    | 1e6                       | default-futures |
  ...
  Scenario: lognormal risk model in 4 markets with different risk parameters , 0010-MARG-012, 0010-MARG-013, 0010-MARG-014
    ...
    When the parties place the following orders:
      ...
      | party0 | ETH/MAR21 | buy  | 57     | 880   | 0                | TYPE_LIMIT | TIF_GTC | peg-1     |
      | party0 | ETH/MAR21 | sell | 45     | 1120  | 0                | TYPE_LIMIT | TIF_GTC | peg-2     |
      | party0 | ETH/MAR22 | buy  | 57     | 880   | 0                | TYPE_LIMIT | TIF_GTC | peg-1     |
      | party0 | ETH/MAR22 | sell | 45     | 1120  | 0                | TYPE_LIMIT | TIF_GTC | peg-2     |
      | party0 | ETH/MAR23 | buy  | 57     | 880   | 0                | TYPE_LIMIT | TIF_GTC | peg-1     |
      | party0 | ETH/MAR23 | sell | 45     | 1120  | 0                | TYPE_LIMIT | TIF_GTC | peg-2     |
      | party0 | ETH/MAR24 | buy  | 57     | 880   | 0                | TYPE_LIMIT | TIF_GTC | peg-1     |
      | party0 | ETH/MAR24 | sell | 45     | 1120  | 0                | TYPE_LIMIT | TIF_GTC | peg-2     |
