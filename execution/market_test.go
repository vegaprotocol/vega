...
func TestLimitOrderChangesAffectLiquidityOrders(t *testing.T) {
	...
	lp1.Sells[0].Offset = num.Sum(lp1.Sells[0].Offset, num.NewUint(1))
	err = tm.market.SubmitLiquidityProvision(ctx, lp1, mainParty, "id-lp1")
	require.NoError(t, err)
...
func getPeggedOrder(reference types.PeggedReference, offset uint64) *types.PeggedOrder {
...
func TestOrderBook_Crash2651(t *testing.T) {
	...
	o7.PeggedOrder = getPeggedOrder(types.PeggedReferenceBestAsk, 1000)
	...
	o10.PeggedOrder = getPeggedOrder(types.PeggedReferenceBestBid, 1000)
	...
	o11.PeggedOrder = getPeggedOrder(types.PeggedReferenceMid, 2000)
...
func TestOrderBook_Crash2599(t *testing.T) {
	...
	o5.PeggedOrder = getPeggedOrder(types.PeggedReferenceMid, 500)
	o5conf, err := tm.market.SubmitOrder(ctx, o5)
	require.NotNil(t, o5conf)
	require.NoError(t, err)
	now = now.Add(time.Second * 1)
	...
	o6.PeggedOrder = getPeggedOrder(types.PeggedReferenceBestBid, 2000)
	o6conf, err := tm.market.SubmitOrder(ctx, o6)
	require.NotNil(t, o6conf)
	require.NoError(t, err)
	now = now.Add(time.Second * 1)
	...
	o7.PeggedOrder = getPeggedOrder(types.PeggedReferenceBestAsk, 3000)
...
func TestOrderBook_Crash2718(t *testing.T) {
	...
	o2.PeggedOrder = getPeggedOrder(types.PeggedReferenceBestBid, 10)
	o2conf, err := tm.market.SubmitOrder(ctx, o2)
	require.NotNil(t, o2conf)
	require.NoError(t, err)
	now = now.Add(time.Second * 1)
...
func TestOrderBook_AmendPriceInParkedOrder(t *testing.T) {
	...
	o1.PeggedOrder = getPeggedOrder(types.PeggedReferenceBestBid, 10)
	o1conf, err := tm.market.SubmitOrder(ctx, o1)
	require.Equal(t, types.MarketStateSuspended, tm.market.State()) // enter auction
	require.NotNil(t, o1conf)
	require.NoError(t, err)
...
func TestOrderBook_ExpiredOrderTriggersReprice(t *testing.T) {
	...
	o2.PeggedOrder = getPeggedOrder(types.PeggedReferenceBestBid, 2)
	o2conf, err := tm.market.SubmitOrder(ctx, o2)
	require.NotNil(t, o2conf)
	require.NoError(t, err)
...
func TestOrderBook_CrashWithDistressedPartyPeggedOrderNotRemovedFromPeggedList2734(t *testing.T) {
	...
	o4.PeggedOrder = getPeggedOrder(types.PeggedReferenceBestAsk, 1)
	o4conf, err := tm.market.SubmitOrder(ctx, o4)
	require.NotNil(t, o4conf)
	require.NoError(t, err)
...
func TestOrderBook_Crash2733(t *testing.T) {
	...
	for i := 1; i <= 10; i += 1 {
		...
		o1.PeggedOrder = getPeggedOrder(types.PeggedReferenceBestBid, uint64(i*15))
		o1conf, err := tm.market.SubmitOrder(ctx, o1)
		require.NotNil(t, o1conf)
		require.NoError(t, err)
		...
		o2.PeggedOrder = getPeggedOrder(types.PeggedReferenceBestAsk, uint64(i*10))
		o2conf, err := tm.market.SubmitOrder(ctx, o2)
		require.NotNil(t, o2conf)
		require.NoError(t, err)
		...
		o3.PeggedOrder = getPeggedOrder(types.PeggedReferenceMid, uint64(i*5))
		o3conf, err := tm.market.SubmitOrder(ctx, o3)
		require.NotNil(t, o3conf)
		require.NoError(t, err)
	}
...
func TestOrderBook_Bug2747(t *testing.T) {
	...
	o1.PeggedOrder = getPeggedOrder(types.PeggedReferenceMid, 15)
	o1conf, err := tm.market.SubmitOrder(ctx, o1)
	require.Equal(t, types.MarketStateSuspended, tm.market.State()) // enter auction
	require.NotNil(t, o1conf)
	require.NoError(t, err)
...
func TestOrderBook_PeggedOrderReprice2748(t *testing.T) {
	...
	o3.PeggedOrder = getPeggedOrder(types.PeggedReferenceMid, 15)
	o3conf, err := tm.market.SubmitOrder(ctx, o3)
	require.NotNil(t, o3conf)
	require.NoError(t, err)
...
func TestOrderBook_CancelAll2771(t *testing.T) {
	...
	o1.PeggedOrder = getPeggedOrder(types.PeggedReferenceBestAsk, 10)
	o1conf, err := tm.market.SubmitOrder(ctx, o1)
	require.NotNil(t, o1conf)
	require.NoError(t, err)
	require.Equal(t, types.MarketStateSuspended, tm.market.State()) // enter auction
	...
	o2.PeggedOrder = getPeggedOrder(types.PeggedReferenceBestAsk, 10)
	o2conf, err := tm.market.SubmitOrder(ctx, o2)
	require.NotNil(t, o2conf)
	require.NoError(t, err)
...
func TestOrderBook_RejectAmendPriceOnPeggedOrder2658(t *testing.T) {
	...
	o1.PeggedOrder = getPeggedOrder(types.PeggedReferenceMid, 10)
	o1conf, err := tm.market.SubmitOrder(ctx, o1)
	assert.NotNil(t, o1conf)
	assert.NoError(t, err)
	require.Equal(t, types.MarketStateSuspended, tm.market.State()) // enter auction
...
func TestOrderBook_AmendExpPersistParkPeggedOrder(t *testing.T) {
	...
	o2.PeggedOrder = getPeggedOrder(types.PeggedReferenceBestAsk, 100)
	o2conf, err := tm.market.SubmitOrder(ctx, o2)
	assert.NotNil(t, o2conf)
	assert.NoError(t, err)
...
func TestOrderBook_ParkPeggedOrderWhenMovingToAuction(t *testing.T) {
	...
	o3.PeggedOrder = getPeggedOrder(types.PeggedReferenceBestAsk, 100)
	o3conf, err := tm.market.SubmitOrder(ctx, o3)
	require.NotNil(t, o3conf)
	require.NoError(t, err)
...
func TestMarket_LeaveAuctionRepricePeggedOrdersShouldFailIfNoMargin(t *testing.T) {
	...
	buys := []*types.LiquidityOrder{
		getLiquidityOrder(types.PeggedReferenceBestBid, 10, 50),
		getLiquidityOrder(types.PeggedReferenceBestBid, 20, 50),
	}
	sells := []*types.LiquidityOrder{
		getLiquidityOrder(types.PeggedReferenceBestAsk, 10, 50),
		getLiquidityOrder(types.PeggedReferenceBestAsk, 20, 50),
	}
...
func TestOrderBook_ParkLiquidityProvisionOrders(t *testing.T) {
	...
	lp := &types.LiquidityProvisionSubmission{
		...
		Fee:              num.DecimalFromFloat(0.01),
		Sells: []*types.LiquidityOrder{
			getLiquidityOrder(types.PeggedReferenceBestAsk, 2000, 10),
			getLiquidityOrder(types.PeggedReferenceBestAsk, 1000, 13),
		},
		Buys: []*types.LiquidityOrder{
			getLiquidityOrder(types.PeggedReferenceBestBid, 1000, 10),
			getLiquidityOrder(types.PeggedReferenceMid, 1500, 13),
		},
	}
...
func TestOrderBook_ClosingOutLPProviderShouldRemoveCommitment(t *testing.T) {
	...
	lp := &types.LiquidityProvisionSubmission{
		...
		Fee:              num.DecimalFromFloat(0.01),
		Sells: []*types.LiquidityOrder{
			getLiquidityOrder(types.PeggedReferenceBestAsk, 2, 25),
			getLiquidityOrder(types.PeggedReferenceBestAsk, 3, 25),
		},
		Buys: []*types.LiquidityOrder{
			getLiquidityOrder(types.PeggedReferenceBestBid, 2, 25),
			getLiquidityOrder(types.PeggedReferenceMid, 3, 25),
		},
	}
...
func TestLPOrdersRollback(t *testing.T) {
	...
	orders := []*types.Order{
		...
		tpl.New(types.Order{
			...
			PeggedOrder: getPeggedOrder(partyA.pegRef, partyA.pegOffset),
		}),
		tpl.New(types.Order{
			Party:       partyB.id,
			Side:        partyB.side,
			...
			PeggedOrder: getPeggedOrder(partyB.pegRef, partyB.pegOffset),
		}),
	}
	...
	lp := &types.LiquidityProvisionSubmission{
		...
		Fee:              num.DecimalFromFloat(0.01),
		Buys: []*types.LiquidityOrder{
			getLiquidityOrder(types.PeggedReferenceMid, 800, 22),
			getLiquidityOrder(types.PeggedReferenceMid, 900, 64),
		},
		Sells: []*types.LiquidityOrder{
			getLiquidityOrder(types.PeggedReferenceMid, 1200, 45),
			getLiquidityOrder(types.PeggedReferenceMid, 1300, 66),
		},
	}
...
func TestLiquidityMonitoring_GoIntoAndOutOfAuction(t *testing.T) {
	...
	lp2sub := &types.LiquidityProvisionSubmission{
		...
		Buys: []*types.LiquidityOrder{
			getLiquidityOrder(types.PeggedReferenceBestBid, 1, 1),
		},
		Sells: []*types.LiquidityOrder{
