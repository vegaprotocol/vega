Feature: amend the order and it isn't matched and it's all good and it just moves some funds around and it sits in the book and wait
  ...
  Scenario: 001 party holds orders only, and party1 holds both orders and positions
    ...
    And the parties should have the following margin levels:
      ...
      | party  | ETH/FEB23 | 4770        | 0      | 5724    | 0       | isolated margin | 0.2           | 15900 |
      | party1 | ETH/FEB23 | 0           | 0      | 0       | 0       | isolated margin | 0.2           | 15900 |

    Then the parties should have the following account balances:
      | party  | asset | market id | margin | general | order margin |
      | party  | USD   | ETH/FEB23 | 9540   | 22610   | 15900        |
      | party1 | USD   | ETH/FEB23 | 0      | 32150   | 15900        |
    ...
    And the parties should have the following margin levels:
      | party  | market id | maintenance | search | initial | release | margin mode     | margin factor | order |
      | party  | ETH/FEB23 | 4770        | 0      | 5724    | 0       | isolated margin | 0.2           | 15500 |
      | party1 | ETH/FEB23 | 0           | 0      | 0       | 0       | isolated margin | 0.2           | 15500 |
    ...
    And the parties should have the following margin levels:
      | party  | market id | maintenance | search | initial | release | margin mode     | margin factor | order |
      | party  | ETH/FEB23 | 4770        | 0      | 5724    | 0       | isolated margin | 0.2           | 9300  |
      | party1 | ETH/FEB23 | 0           | 0      | 0       | 0       | isolated margin | 0.2           | 9300  |
