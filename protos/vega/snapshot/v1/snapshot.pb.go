...
func (x *Payload) GetLiquidityV2FeeStats() *LiquidityV2FeeStats {
	if x, ok := x.GetData().(*Payload_LiquidityV2FeeStats); ok {
		return x.LiquidityV2FeeStats
	}
	return nil
}
...
type Payload_LiquidityV2FeeStats struct {
	LiquidityV2FeeStats *LiquidityV2FeeStats `protobuf:"bytes,79,opt,name=liquidity_v2_fee_stats,json=liquidityV2FeeStats,proto3,oneof"`
}
...
func (*Payload_LiquidityV2FeeStats) isPayload_Data() {}
...
type LiquidityV2FeeStats struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	// Market ID these liquidity parameters apply to. Required for key generation
	MarketId string                 `protobuf:"bytes,1,opt,name=market_id,json=marketId,proto3" json:"market_id,omitempty"`
	Stats    *v12.LiquidityFeeStats `protobuf:"bytes,2,opt,name=stats,proto3" json:"stats,omitempty"`
}

func (x *LiquidityV2FeeStats) Reset() {
	*x = LiquidityV2FeeStats{}
	if protoimpl.UnsafeEnabled {
...
func (x *LiquidityV2FeeStats) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*LiquidityV2FeeStats) ProtoMessage() {}

func (x *LiquidityV2FeeStats) ProtoReflect() protoreflect.Message {
	mi := &file_vega_snapshot_v1_snapshot_proto_msgTypes[123]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use LiquidityV2FeeStats.ProtoReflect.Descriptor instead.
func (*LiquidityV2FeeStats) Descriptor() ([]byte, []int) {
	return file_vega_snapshot_v1_snapshot_proto_rawDescGZIP(), []int{123}
}

func (x *LiquidityV2FeeStats) GetMarketId() string {
	if x != nil {
		return x.MarketId
	}
	return ""
...
func (x *LiquidityV2FeeStats) GetStats() *v12.LiquidityFeeStats {
	if x != nil {
		return x.Stats
	}
	return nil
...
var file_vega_snapshot_v1_snapshot_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x03, 0x52, 0x02, 0x6f, 0x66, 0x22, 0xf1, 0x31, 0x0a, 0x07, 0x50, 0x61, 0x79, 0x6c,
	...
	0x65, 0x74, 0x65, 0x72, 0x73, 0x12, 0x5c, 0x0a, 0x16, 0x6c, 0x69, 0x71, 0x75, 0x69, 0x64, 0x69,
	0x74, 0x79, 0x5f, 0x76, 0x32, 0x5f, 0x66, 0x65, 0x65, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x73, 0x18,
	0x4f, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x25, 0x2e, 0x76, 0x65, 0x67, 0x61, 0x2e, 0x73, 0x6e, 0x61,
	0x70, 0x73, 0x68, 0x6f, 0x74, 0x2e, 0x76, 0x31, 0x2e, 0x4c, 0x69, 0x71, 0x75, 0x69, 0x64, 0x69,
	0x74, 0x79, 0x56, 0x32, 0x46, 0x65, 0x65, 0x53, 0x74, 0x61, 0x74, 0x73, 0x48, 0x00, 0x52, 0x13,
	0x6c, 0x69, 0x71, 0x75, 0x69, 0x64, 0x69, 0x74, 0x79, 0x56, 0x32, 0x46, 0x65, 0x65, 0x53, 0x74,
	...
	0x4d, 0x61, 0x78, 0x22, 0x6b, 0x0a, 0x13, 0x4c, 0x69, 0x71, 0x75, 0x69, 0x64, 0x69, 0x74, 0x79,
	0x56, 0x32, 0x46, 0x65, 0x65, 0x53, 0x74, 0x61, 0x74, 0x73, 0x12, 0x1b, 0x0a, 0x09, 0x6d, 0x61,
	0x72, 0x6b, 0x65, 0x74, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x6d,
	0x61, 0x72, 0x6b, 0x65, 0x74, 0x49, 0x64, 0x12, 0x37, 0x0a, 0x05, 0x73, 0x74, 0x61, 0x74, 0x73,
	0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x21, 0x2e, 0x76, 0x65, 0x67, 0x61, 0x2e, 0x65, 0x76,
	0x65, 0x6e, 0x74, 0x73, 0x2e, 0x76, 0x31, 0x2e, 0x4c, 0x69, 0x71, 0x75, 0x69, 0x64, 0x69, 0x74,
	0x79, 0x46, 0x65, 0x65, 0x53, 0x74, 0x61, 0x74, 0x73, 0x52, 0x05, 0x73, 0x74, 0x61, 0x74, 0x73,
	...
	0x54, 0x72, 0x69, 0x67, 0x67, 0x65, 0x72, 0x22, 0xc0, 0x01, 0x0a, 0x0d, 0x4d, 0x61, 0x72, 0x6b,
	...
	0x6f, 0x6e, 0x61, 0x6c, 0x56, 0x6f, 0x6c, 0x75, 0x6d, 0x65, 0x22, 0x74, 0x0a, 0x16, 0x53, 0x69,
	...
	0x74, 0x73, 0x22, 0xcf, 0x03, 0x0a, 0x0b, 0x50, 0x72, 0x6f, 0x6f, 0x66, 0x4f, 0x66, 0x57, 0x6f,
	...
	0x6c, 0x6f, 0x63, 0x6b, 0x22, 0x39, 0x0a, 0x0b, 0x42, 0x61, 0x6e, 0x6e, 0x65, 0x64, 0x50, 0x61,
...
var file_vega_snapshot_v1_snapshot_proto_goTypes = []interface{}{
	...
	(*LiquidityV2FeeStats)(nil),                   // 124: vega.snapshot.v1.LiquidityV2FeeStats
	...
	(*v12.LiquidityFeeStats)(nil),                 // 199: vega.events.v1.LiquidityFeeStats
...
var file_vega_snapshot_v1_snapshot_proto_depIdxs = []int32{
	...
	124, // 74: vega.snapshot.v1.Payload.liquidity_v2_fee_stats:type_name -> vega.snapshot.v1.LiquidityV2FeeStats
	...
	199, // 207: vega.snapshot.v1.LiquidityV2FeeStats.stats:type_name -> vega.events.v1.LiquidityFeeStats
...
func file_vega_snapshot_v1_snapshot_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_vega_snapshot_v1_snapshot_proto_msgTypes[123].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*LiquidityV2FeeStats); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_vega_snapshot_v1_snapshot_proto_msgTypes[4].OneofWrappers = []interface{}{
		...
		(*Payload_LiquidityV2FeeStats)(nil),
	}
