...
var file_vega_governance_proto_depIdxs = []int32{
	...
	48, // 21: vega.NewMarketConfiguration.liquidity_sla_parameters:type_name -> vega.LiquiditySLAParameters
	...
	44, // 27: vega.UpdateMarketConfiguration.price_monitoring_parameters:type_name -> vega.PriceMonitoringParameters
	49, // 28: vega.UpdateMarketConfiguration.liquidity_monitoring_parameters:type_name -> vega.LiquidityMonitoringParameters
	46, // 29: vega.UpdateMarketConfiguration.simple:type_name -> vega.SimpleModelParams
	47, // 30: vega.UpdateMarketConfiguration.log_normal:type_name -> vega.LogNormalRiskModel
	48, // 31: vega.UpdateMarketConfiguration.liquidity_sla_parameters:type_name -> vega.LiquiditySLAParameters
	44, // 32: vega.UpdateSpotMarketConfiguration.price_monitoring_parameters:type_name -> vega.PriceMonitoringParameters
	45, // 33: vega.UpdateSpotMarketConfiguration.target_stake_parameters:type_name -> vega.TargetStakeParameters
	46, // 34: vega.UpdateSpotMarketConfiguration.simple:type_name -> vega.SimpleModelParams
	47, // 35: vega.UpdateSpotMarketConfiguration.log_normal:type_name -> vega.LogNormalRiskModel
	48, // 36: vega.UpdateSpotMarketConfiguration.sla_params:type_name -> vega.LiquiditySLAParameters
	...
	41, // 39: vega.UpdateFutureProduct.data_source_spec_for_settlement_data:type_name -> vega.DataSourceDefinition
	41, // 40: vega.UpdateFutureProduct.data_source_spec_for_trading_termination:type_name -> vega.DataSourceDefinition
	42, // 41: vega.UpdateFutureProduct.data_source_spec_binding:type_name -> vega.DataSourceSpecToFutureBinding
	41, // 42: vega.UpdatePerpetualProduct.data_source_spec_for_settlement_schedule:type_name -> vega.DataSourceDefinition
	41, // 43: vega.UpdatePerpetualProduct.data_source_spec_for_settlement_data:type_name -> vega.DataSourceDefinition
	43, // 44: vega.UpdatePerpetualProduct.data_source_spec_binding:type_name -> vega.DataSourceSpecToPerpetualBinding
	50, // 45: vega.UpdateNetworkParameter.changes:type_name -> vega.NetworkParameter
	51, // 46: vega.NewAsset.changes:type_name -> vega.AssetDetails
	52, // 47: vega.UpdateAsset.changes:type_name -> vega.AssetDetailsUpdate
	...
	35, // 56: vega.ProposalTerms.new_transfer:type_name -> vega.NewTransfer
	33, // 57: vega.ProposalTerms.cancel_transfer:type_name -> vega.CancelTransfer
	31, // 58: vega.ProposalTerms.update_market_state:type_name -> vega.UpdateMarketState
	30, // 59: vega.ProposalTerms.update_referral_program:type_name -> vega.UpdateReferralProgram
	28, // 60: vega.GovernanceData.proposal:type_name -> vega.Proposal
	29, // 61: vega.GovernanceData.yes:type_name -> vega.Vote
	29, // 62: vega.GovernanceData.no:type_name -> vega.Vote
	39, // 63: vega.GovernanceData.yes_party:type_name -> vega.GovernanceData.YesPartyEntry
	40, // 64: vega.GovernanceData.no_party:type_name -> vega.GovernanceData.NoPartyEntry
	3,  // 65: vega.Proposal.state:type_name -> vega.Proposal.State
	25, // 66: vega.Proposal.terms:type_name -> vega.ProposalTerms
	0,  // 67: vega.Proposal.reason:type_name -> vega.ProposalError
	26, // 68: vega.Proposal.rationale:type_name -> vega.ProposalRationale
	4,  // 69: vega.Vote.value:type_name -> vega.Vote.Value
	53, // 70: vega.UpdateReferralProgram.changes:type_name -> vega.ReferralProgram
	32, // 71: vega.UpdateMarketState.changes:type_name -> vega.UpdateMarketStateConfiguration
	1,  // 72: vega.UpdateMarketStateConfiguration.update_type:type_name -> vega.MarketStateUpdateType
	34, // 73: vega.CancelTransfer.changes:type_name -> vega.CancelTransferConfiguration
	36, // 74: vega.NewTransfer.changes:type_name -> vega.NewTransferConfiguration
	54, // 75: vega.NewTransferConfiguration.source_type:type_name -> vega.AccountType
	2,  // 76: vega.NewTransferConfiguration.transfer_type:type_name -> vega.GovernanceTransferType
	54, // 77: vega.NewTransferConfiguration.destination_type:type_name -> vega.AccountType
	37, // 78: vega.NewTransferConfiguration.one_off:type_name -> vega.OneOffTransfer
	38, // 79: vega.NewTransferConfiguration.recurring:type_name -> vega.RecurringTransfer
	55, // 80: vega.RecurringTransfer.dispatch_strategy:type_name -> vega.DispatchStrategy
	29, // 81: vega.GovernanceData.YesPartyEntry.value:type_name -> vega.Vote
	29, // 82: vega.GovernanceData.NoPartyEntry.value:type_name -> vega.Vote
