...
ALTER TABLE markets ADD COLUMN IF NOT EXISTS mark_price_configuration jsonb;

ALTER TABLE markets_current ADD COLUMN IF NOT EXISTS mark_price_configuration jsonb;
