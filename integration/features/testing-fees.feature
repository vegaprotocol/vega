...
Scenario: WIP - Testing fees in continuous trading with two trades and one liquidity providers with 10 s liquidity fee distribution timestep
...
Scenario: WIP - Testing fees in continuous trading with two trades and insufficient balance in their general (but margin covers it) account, then the trade fees gets executed in this order - Maker, IP, LP
  ...
  #  TODO: Remove liquidity orders, add limit orders for same price and volume so that checks on lines 257-1 pass and update margin/general account figures.
   ...
   # Then debug transfers
    ...
    Then the traders should have the following account balances:
      | trader      | asset | market id | margin | general  |
      | trader3a    | ETH   | ETH/DEC21 | 480    | 0 |
      | trader3b    | ETH   | ETH/DEC21 | 240    | 0 |
  ...
  # And the accumulated infrastructure fees should be "0" for the market "ETH/DEC21"
    ...
    Then the traders should have the following account balances:
      ...
      # | trader3b    | ETH   | ETH/DEC21 | 339    | 9667    | 
      # | trader4     | ETH   | ETH/DEC21 | 679    | 9296    |
      | trader3a    | ETH   | ETH/DEC21 | 480    | 11    | 
      | trader3b    | ETH   | ETH/DEC21 | 240    | 6    | 
      # | trader4     | ETH   | ETH/DEC21 | 679    | 0    |
...
Scenario: WIP - Testing fees in continuous trading with two trades and insufficient balance in their general and margin account, then the trade doesn't execute.
  ...
  # And the accumulated infrastructure fees should be "0" for the market "ETH/DEC21"
    ...
    Then the traders should have the following account balances:
      ...
      # | trader3a    | ETH   | ETH/DEC21 | 690    | 9321    | 
      # | trader3b    | ETH   | ETH/DEC21 | 339    | 9667    | 
      # | trader4     | ETH   | ETH/DEC21 | 679    | 9296    |ß
      | trader3a    | ETH   | ETH/DEC21 | 480    | 11    | 
      | trader3b    | ETH   | ETH/DEC21 | 240    | 6    | 
      # | trader4     | ETH   | ETH/DEC21 | 679    | 0    |
      # | trader4     | ETH   | ETH/DEC21 | 649    | 0    |
...
# TO DO -
# Testing fees in continuous trading with two trades and one liquidity providers with 0s liquidity fee distribution timestep - Expand the above scenario - PC - Amended the steps, verify if that's correct.
