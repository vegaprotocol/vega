...
var file_vega_snapshot_v1_snapshot_proto_rawDesc = []byte{
	...
	0x52, 0x09, 0x66, 0x65, 0x65, 0x73, 0x53, 0x74, 0x61, 0x74, 0x73, 0x22, 0x9a, 0x0b, 0x0a, 0x06,
	...
	0x69, 0x6e, 0x46, 0x61, 0x63, 0x74, 0x6f, 0x72, 0x22, 0x4e, 0x0a, 0x11, 0x50, 0x61, 0x72, 0x74,
...
var file_vega_snapshot_v1_snapshot_proto_msgTypes = make([]protoimpl.MessageInfo, 175)
var file_vega_snapshot_v1_snapshot_proto_goTypes = []interface{}{
	...
	(*PartyAssetAmount)(nil),                      // 174: vega.snapshot.v1.PartyAssetAmount
	(*BankingTransferFeeDiscounts)(nil),           // 175: vega.snapshot.v1.BankingTransferFeeDiscounts
	(*v1.Signer)(nil),                             // 176: vega.data.v1.Signer
	(*v1.Property)(nil),                           // 177: vega.data.v1.Property
	(*vega.Account)(nil),                          // 178: vega.Account
	(*vega.Asset)(nil),                            // 179: vega.Asset
	(*vega.Withdrawal)(nil),                       // 180: vega.Withdrawal
	(*vega.Deposit)(nil),                          // 181: vega.Deposit
	(*v11.AssetAction)(nil),                       // 182: vega.checkpoint.v1.AssetAction
	(*v11.RecurringTransfers)(nil),                // 183: vega.checkpoint.v1.RecurringTransfers
	(*v11.ScheduledTransferAtTime)(nil),           // 184: vega.checkpoint.v1.ScheduledTransferAtTime
	(*v11.GovernanceTransfer)(nil),                // 185: vega.checkpoint.v1.GovernanceTransfer
	(*v11.ScheduledGovernanceTransferAtTime)(nil), // 186: vega.checkpoint.v1.ScheduledGovernanceTransferAtTime
	(*v11.BridgeState)(nil),                       // 187: vega.checkpoint.v1.BridgeState
	(*vega.Delegation)(nil),                       // 188: vega.Delegation
	(*vega.Proposal)(nil),                         // 189: vega.Proposal
	(*vega.Vote)(nil),                             // 190: vega.Vote
	(*v12.StakeLinking)(nil),                      // 191: vega.events.v1.StakeLinking
	(*vega.StakeTotalSupply)(nil),                 // 192: vega.StakeTotalSupply
	(*vega.Order)(nil),                            // 193: vega.Order
	(*vega.NetworkParameter)(nil),                 // 194: vega.NetworkParameter
	(*vega.PriceMonitoringTrigger)(nil),           // 195: vega.PriceMonitoringTrigger
	(vega.Market_TradingMode)(0),                  // 196: vega.Market.TradingMode
	(vega.AuctionTrigger)(0),                      // 197: vega.AuctionTrigger
	(*vega.AuctionDuration)(nil),                  // 198: vega.AuctionDuration
	(*vega.Market)(nil),                           // 199: vega.Market
	(*v12.FeesStats)(nil),                         // 200: vega.events.v1.FeesStats
	(*v12.StopOrderEvent)(nil),                    // 201: vega.events.v1.StopOrderEvent
	(*v11.MarketState)(nil),                       // 202: vega.checkpoint.v1.MarketState
	(*v12.ValidatorUpdate)(nil),                   // 203: vega.events.v1.ValidatorUpdate
	(*vega.RankingScore)(nil),                     // 204: vega.RankingScore
	(*vega.LiquidityProvision)(nil),               // 205: vega.LiquidityProvision
	(*vega.LiquiditySLAParameters)(nil),           // 206: vega.LiquiditySLAParameters
	(*v12.PaidLiquidityFeesStats)(nil),            // 207: vega.events.v1.PaidLiquidityFeesStats
	(*vega.KeyValueBundle)(nil),                   // 208: vega.KeyValueBundle
	(*v11.MarketActivityTracker)(nil),             // 209: vega.checkpoint.v1.MarketActivityTracker
	(*v11.TakerNotionalVolume)(nil),               // 210: vega.checkpoint.v1.TakerNotionalVolume
	(*v12.ERC20MultiSigSignerEvent)(nil),          // 211: vega.events.v1.ERC20MultiSigSignerEvent
	(*v12.ERC20MultiSigThresholdSetEvent)(nil),    // 212: vega.events.v1.ERC20MultiSigThresholdSetEvent
	(*v12.ProtocolUpgradeEvent)(nil),              // 213: vega.events.v1.ProtocolUpgradeEvent
	(*vega.ReferralProgram)(nil),                  // 214: vega.ReferralProgram
	(*vega.VolumeDiscountProgram)(nil),            // 215: vega.VolumeDiscountProgram
	(*vega.LiquidationStrategy)(nil),              // 216: vega.LiquidationStrategy
}
var file_vega_snapshot_v1_snapshot_proto_depIdxs = []int32{
	...
	175, // 76: vega.snapshot.v1.Payload.banking_transfer_fee_discounts:type_name -> vega.snapshot.v1.BankingTransferFeeDiscounts
	...
	176, // 85: vega.snapshot.v1.OracleData.signers:type_name -> vega.data.v1.Signer
	16,  // 86: vega.snapshot.v1.OracleData.data:type_name -> vega.snapshot.v1.OracleDataPair
	177, // 87: vega.snapshot.v1.OracleData.meta_data:type_name -> vega.data.v1.Property
	18,  // 88: vega.snapshot.v1.Witness.resources:type_name -> vega.snapshot.v1.Resource
	178, // 89: vega.snapshot.v1.CollateralAccounts.accounts:type_name -> vega.Account
	179, // 90: vega.snapshot.v1.CollateralAssets.assets:type_name -> vega.Asset
	179, // 91: vega.snapshot.v1.ActiveAssets.assets:type_name -> vega.Asset
	179, // 92: vega.snapshot.v1.PendingAssets.assets:type_name -> vega.Asset
	179, // 93: vega.snapshot.v1.PendingAssetUpdates.assets:type_name -> vega.Asset
	180, // 94: vega.snapshot.v1.Withdrawal.withdrawal:type_name -> vega.Withdrawal
	181, // 95: vega.snapshot.v1.Deposit.deposit:type_name -> vega.Deposit
	...
	182, // 98: vega.snapshot.v1.BankingAssetActions.asset_action:type_name -> vega.checkpoint.v1.AssetAction
	183, // 99: vega.snapshot.v1.BankingRecurringTransfers.recurring_transfers:type_name -> vega.checkpoint.v1.RecurringTransfers
	184, // 100: vega.snapshot.v1.BankingScheduledTransfers.transfers_at_time:type_name -> vega.checkpoint.v1.ScheduledTransferAtTime
	185, // 101: vega.snapshot.v1.BankingRecurringGovernanceTransfers.recurring_transfers:type_name -> vega.checkpoint.v1.GovernanceTransfer
	186, // 102: vega.snapshot.v1.BankingScheduledGovernanceTransfers.transfers_at_time:type_name -> vega.checkpoint.v1.ScheduledGovernanceTransferAtTime
	187, // 103: vega.snapshot.v1.BankingBridgeState.bridge_state:type_name -> vega.checkpoint.v1.BridgeState
	188, // 104: vega.snapshot.v1.DelegationActive.delegations:type_name -> vega.Delegation
	188, // 105: vega.snapshot.v1.DelegationPending.delegations:type_name -> vega.Delegation
	188, // 106: vega.snapshot.v1.DelegationPending.undelegation:type_name -> vega.Delegation
	189, // 107: vega.snapshot.v1.ProposalData.proposal:type_name -> vega.Proposal
	190, // 108: vega.snapshot.v1.ProposalData.yes:type_name -> vega.Vote
	190, // 109: vega.snapshot.v1.ProposalData.no:type_name -> vega.Vote
	190, // 110: vega.snapshot.v1.ProposalData.invalid:type_name -> vega.Vote
	...
	189, // 113: vega.snapshot.v1.GovernanceNode.proposals:type_name -> vega.Proposal
	42,  // 114: vega.snapshot.v1.GovernanceNode.proposal_data:type_name -> vega.snapshot.v1.ProposalData
	191, // 115: vega.snapshot.v1.StakingAccount.events:type_name -> vega.events.v1.StakeLinking
	46,  // 116: vega.snapshot.v1.StakingAccounts.accounts:type_name -> vega.snapshot.v1.StakingAccount
	192, // 117: vega.snapshot.v1.StakingAccounts.pending_stake_total_supply:type_name -> vega.StakeTotalSupply
	193, // 118: vega.snapshot.v1.MatchingBook.buy:type_name -> vega.Order
	193, // 119: vega.snapshot.v1.MatchingBook.sell:type_name -> vega.Order
	194, // 120: vega.snapshot.v1.NetParams.params:type_name -> vega.NetworkParameter
	195, // 121: vega.snapshot.v1.PriceBound.trigger:type_name -> vega.PriceMonitoringTrigger
	...
	196, // 130: vega.snapshot.v1.AuctionState.mode:type_name -> vega.Market.TradingMode
	196, // 131: vega.snapshot.v1.AuctionState.default_mode:type_name -> vega.Market.TradingMode
	197, // 132: vega.snapshot.v1.AuctionState.trigger:type_name -> vega.AuctionTrigger
	198, // 133: vega.snapshot.v1.AuctionState.end:type_name -> vega.AuctionDuration
	197, // 134: vega.snapshot.v1.AuctionState.extension:type_name -> vega.AuctionTrigger
	60,  // 135: vega.snapshot.v1.EquityShare.lps:type_name -> vega.snapshot.v1.EquityShareLP
	199, // 136: vega.snapshot.v1.SpotMarket.market:type_name -> vega.Market
	...
	77,  // 139: vega.snapshot.v1.SpotMarket.pegged_orders:type_name -> vega.snapshot.v1.PeggedOrders
	193, // 140: vega.snapshot.v1.SpotMarket.expiring_orders:type_name -> vega.Order
	...
	76,  // 143: vega.snapshot.v1.SpotMarket.stop_orders:type_name -> vega.snapshot.v1.StopOrders
	193, // 144: vega.snapshot.v1.SpotMarket.expiring_stop_orders:type_name -> vega.Order
	200, // 145: vega.snapshot.v1.SpotMarket.fees_stats:type_name -> vega.events.v1.FeesStats
	199, // 146: vega.snapshot.v1.Market.market:type_name -> vega.Market
	...
	77,  // 149: vega.snapshot.v1.Market.pegged_orders:type_name -> vega.snapshot.v1.PeggedOrders
	193, // 150: vega.snapshot.v1.Market.expiring_orders:type_name -> vega.Order
	...
	76,  // 153: vega.snapshot.v1.Market.stop_orders:type_name -> vega.snapshot.v1.StopOrders
	193, // 154: vega.snapshot.v1.Market.expiring_stop_orders:type_name -> vega.Order
	66,  // 155: vega.snapshot.v1.Market.product:type_name -> vega.snapshot.v1.Product
	200, // 156: vega.snapshot.v1.Market.fees_stats:type_name -> vega.events.v1.FeesStats
	65,  // 157: vega.snapshot.v1.Market.party_margin_factor:type_name -> vega.snapshot.v1.PartyMarginFactor
	70,  // 158: vega.snapshot.v1.Product.perps:type_name -> vega.snapshot.v1.Perps
	67,  // 159: vega.snapshot.v1.Perps.external_data_point:type_name -> vega.snapshot.v1.DataPoint
	67,  // 160: vega.snapshot.v1.Perps.internal_data_point:type_name -> vega.snapshot.v1.DataPoint
	69,  // 161: vega.snapshot.v1.Perps.external_twap_data:type_name -> vega.snapshot.v1.TWAPData
	69,  // 162: vega.snapshot.v1.Perps.internal_twap_data:type_name -> vega.snapshot.v1.TWAPData
	68,  // 163: vega.snapshot.v1.Perps.auction_intervals:type_name -> vega.snapshot.v1.AuctionIntervals
	71,  // 164: vega.snapshot.v1.PricedStopOrders.falls_bellow:type_name -> vega.snapshot.v1.OrdersAtPrice
	71,  // 165: vega.snapshot.v1.PricedStopOrders.rises_above:type_name -> vega.snapshot.v1.OrdersAtPrice
	75,  // 166: vega.snapshot.v1.TrailingStopOrders.falls_bellow:type_name -> vega.snapshot.v1.OffsetsAtPrice
	75,  // 167: vega.snapshot.v1.TrailingStopOrders.rises_above:type_name -> vega.snapshot.v1.OffsetsAtPrice
	74,  // 168: vega.snapshot.v1.OffsetsAtPrice.offsets:type_name -> vega.snapshot.v1.OrdersAtOffset
	201, // 169: vega.snapshot.v1.StopOrders.stop_orders:type_name -> vega.events.v1.StopOrderEvent
	72,  // 170: vega.snapshot.v1.StopOrders.priced_stop_orders:type_name -> vega.snapshot.v1.PricedStopOrders
	73,  // 171: vega.snapshot.v1.StopOrders.trailing_stop_orders:type_name -> vega.snapshot.v1.TrailingStopOrders
	193, // 172: vega.snapshot.v1.PeggedOrders.parked_orders:type_name -> vega.Order
	64,  // 173: vega.snapshot.v1.ExecutionMarkets.markets:type_name -> vega.snapshot.v1.Market
	63,  // 174: vega.snapshot.v1.ExecutionMarkets.spot_markets:type_name -> vega.snapshot.v1.SpotMarket
	202, // 175: vega.snapshot.v1.ExecutionMarkets.settled_markets:type_name -> vega.checkpoint.v1.MarketState
	80,  // 176: vega.snapshot.v1.ExecutionMarkets.successors:type_name -> vega.snapshot.v1.Successors
	78,  // 177: vega.snapshot.v1.ExecutionMarkets.sla_network_params:type_name -> vega.snapshot.v1.SLANetworkParams
	81,  // 178: vega.snapshot.v1.MarketPositions.positions:type_name -> vega.snapshot.v1.Position
	83,  // 179: vega.snapshot.v1.MarketPositions.parties_records:type_name -> vega.snapshot.v1.PartyPositionStats
	85,  // 180: vega.snapshot.v1.SettlementState.last_settled_positions:type_name -> vega.snapshot.v1.LastSettledPosition
	86,  // 181: vega.snapshot.v1.SettlementState.trades:type_name -> vega.snapshot.v1.SettlementTrade
	90,  // 182: vega.snapshot.v1.RewardsPendingPayouts.scheduled_rewards_payout:type_name -> vega.snapshot.v1.ScheduledRewardsPayout
	91,  // 183: vega.snapshot.v1.ScheduledRewardsPayout.rewards_payout:type_name -> vega.snapshot.v1.RewardsPayout
	92,  // 184: vega.snapshot.v1.RewardsPayout.reward_party_amount:type_name -> vega.snapshot.v1.RewardsPartyAmount
	95,  // 185: vega.snapshot.v1.VoteSpamPolicy.party_to_vote:type_name -> vega.snapshot.v1.PartyProposalVoteCount
	143, // 186: vega.snapshot.v1.VoteSpamPolicy.banned_parties:type_name -> vega.snapshot.v1.BannedParty
	96,  // 187: vega.snapshot.v1.VoteSpamPolicy.token_balance:type_name -> vega.snapshot.v1.PartyTokenBalance
	97,  // 188: vega.snapshot.v1.VoteSpamPolicy.recent_blocks_reject_stats:type_name -> vega.snapshot.v1.BlockRejectStats
	98,  // 189: vega.snapshot.v1.SimpleSpamPolicy.party_to_count:type_name -> vega.snapshot.v1.SpamPartyTransactionCount
	143, // 190: vega.snapshot.v1.SimpleSpamPolicy.banned_parties:type_name -> vega.snapshot.v1.BannedParty
	96,  // 191: vega.snapshot.v1.SimpleSpamPolicy.token_balance:type_name -> vega.snapshot.v1.PartyTokenBalance
	100, // 192: vega.snapshot.v1.Notary.notary_sigs:type_name -> vega.snapshot.v1.NotarySigs
	104, // 193: vega.snapshot.v1.StakeVerifierDeposited.pending_deposited:type_name -> vega.snapshot.v1.StakeVerifierPending
	104, // 194: vega.snapshot.v1.StakeVerifierRemoved.pending_removed:type_name -> vega.snapshot.v1.StakeVerifierPending
	107, // 195: vega.snapshot.v1.EthContractCallResults.pending_contract_call_result:type_name -> vega.snapshot.v1.EthContractCallResult
	114, // 196: vega.snapshot.v1.Topology.validator_data:type_name -> vega.snapshot.v1.ValidatorState
	108, // 197: vega.snapshot.v1.Topology.pending_pub_key_rotations:type_name -> vega.snapshot.v1.PendingKeyRotation
	117, // 198: vega.snapshot.v1.Topology.validator_performance:type_name -> vega.snapshot.v1.ValidatorPerformance
	109, // 199: vega.snapshot.v1.Topology.pending_ethereum_key_rotations:type_name -> vega.snapshot.v1.PendingEthereumKeyRotation
	111, // 200: vega.snapshot.v1.Topology.signatures:type_name -> vega.snapshot.v1.ToplogySignatures
	109, // 201: vega.snapshot.v1.Topology.unsolved_ethereum_key_rotations:type_name -> vega.snapshot.v1.PendingEthereumKeyRotation
	112, // 202: vega.snapshot.v1.ToplogySignatures.pending_signatures:type_name -> vega.snapshot.v1.PendingERC20MultisigControlSignature
	113, // 203: vega.snapshot.v1.ToplogySignatures.issued_signatures:type_name -> vega.snapshot.v1.IssuedERC20MultisigControlSignature
	203, // 204: vega.snapshot.v1.ValidatorState.validator_update:type_name -> vega.events.v1.ValidatorUpdate
	115, // 205: vega.snapshot.v1.ValidatorState.heartbeat_tracker:type_name -> vega.snapshot.v1.HeartbeatTracker
	204, // 206: vega.snapshot.v1.ValidatorState.ranking_score:type_name -> vega.RankingScore
	116, // 207: vega.snapshot.v1.ValidatorPerformance.validator_perf_stats:type_name -> vega.snapshot.v1.PerformanceStats
	121, // 208: vega.snapshot.v1.LiquidityPartiesLiquidityOrders.party_orders:type_name -> vega.snapshot.v1.PartyOrders
	193, // 209: vega.snapshot.v1.PartyOrders.orders:type_name -> vega.Order
	121, // 210: vega.snapshot.v1.LiquidityPartiesOrders.party_orders:type_name -> vega.snapshot.v1.PartyOrders
	205, // 211: vega.snapshot.v1.LiquidityProvisions.liquidity_provisions:type_name -> vega.LiquidityProvision
	125, // 212: vega.snapshot.v1.LiquidityScores.scores:type_name -> vega.snapshot.v1.LiquidityScore
	206, // 213: vega.snapshot.v1.LiquidityV2Parameters.market_sla_parameters:type_name -> vega.LiquiditySLAParameters
	207, // 214: vega.snapshot.v1.LiquidityV2PaidFeesStats.stats:type_name -> vega.events.v1.PaidLiquidityFeesStats
	205, // 215: vega.snapshot.v1.LiquidityV2Provisions.liquidity_provisions:type_name -> vega.LiquidityProvision
	205, // 216: vega.snapshot.v1.LiquidityV2PendingProvisions.pending_liquidity_provisions:type_name -> vega.LiquidityProvision
	131, // 217: vega.snapshot.v1.LiquidityV2Performances.performance_per_party:type_name -> vega.snapshot.v1.LiquidityV2PerformancePerParty
	125, // 218: vega.snapshot.v1.LiquidityV2Scores.scores:type_name -> vega.snapshot.v1.LiquidityScore
	12,  // 219: vega.snapshot.v1.LiquidityV2Supplied.bid_cache:type_name -> vega.snapshot.v1.LiquidityOffsetProbabilityPair
	12,  // 220: vega.snapshot.v1.LiquidityV2Supplied.ask_cache:type_name -> vega.snapshot.v1.LiquidityOffsetProbabilityPair
	137, // 221: vega.snapshot.v1.FloatingPointConsensus.next_time_trigger:type_name -> vega.snapshot.v1.NextTimeTrigger
	135, // 222: vega.snapshot.v1.FloatingPointConsensus.state_variables:type_name -> vega.snapshot.v1.StateVarInternalState
	136, // 223: vega.snapshot.v1.StateVarInternalState.validators_results:type_name -> vega.snapshot.v1.FloatingPointValidatorResult
	208, // 224: vega.snapshot.v1.FloatingPointValidatorResult.bundle:type_name -> vega.KeyValueBundle
	209, // 225: vega.snapshot.v1.MarketTracker.market_activity:type_name -> vega.checkpoint.v1.MarketActivityTracker
	210, // 226: vega.snapshot.v1.MarketTracker.taker_notional_volume:type_name -> vega.checkpoint.v1.TakerNotionalVolume
	211, // 227: vega.snapshot.v1.SignerEventsPerAddress.events:type_name -> vega.events.v1.ERC20MultiSigSignerEvent
	139, // 228: vega.snapshot.v1.ERC20MultiSigTopologyVerified.events_per_address:type_name -> vega.snapshot.v1.SignerEventsPerAddress
	212, // 229: vega.snapshot.v1.ERC20MultiSigTopologyVerified.threshold:type_name -> vega.events.v1.ERC20MultiSigThresholdSetEvent
	211, // 230: vega.snapshot.v1.ERC20MultiSigTopologyPending.pending_signers:type_name -> vega.events.v1.ERC20MultiSigSignerEvent
	212, // 231: vega.snapshot.v1.ERC20MultiSigTopologyPending.pending_threshold_set:type_name -> vega.events.v1.ERC20MultiSigThresholdSetEvent
	148, // 232: vega.snapshot.v1.ProofOfWork.tx_at_height:type_name -> vega.snapshot.v1.TransactionsAtHeight
	148, // 233: vega.snapshot.v1.ProofOfWork.tid_at_height:type_name -> vega.snapshot.v1.TransactionsAtHeight
	143, // 234: vega.snapshot.v1.ProofOfWork.banned:type_name -> vega.snapshot.v1.BannedParty
	144, // 235: vega.snapshot.v1.ProofOfWork.pow_params:type_name -> vega.snapshot.v1.ProofOfWorkParams
	145, // 236: vega.snapshot.v1.ProofOfWork.pow_state:type_name -> vega.snapshot.v1.ProofOfWorkState
	150, // 237: vega.snapshot.v1.ProofOfWork.nonce_refs_at_height:type_name -> vega.snapshot.v1.NonceRefsAtHeight
	146, // 238: vega.snapshot.v1.ProofOfWorkState.pow_state:type_name -> vega.snapshot.v1.ProofOfWorkBlockState
	147, // 239: vega.snapshot.v1.ProofOfWorkBlockState.party_state:type_name -> vega.snapshot.v1.ProofOfWorkPartyStateForBlock
	149, // 240: vega.snapshot.v1.NonceRefsAtHeight.refs:type_name -> vega.snapshot.v1.NonceRef
	213, // 241: vega.snapshot.v1.ProtocolUpgradeProposals.active_proposals:type_name -> vega.events.v1.ProtocolUpgradeEvent
	152, // 242: vega.snapshot.v1.ProtocolUpgradeProposals.accepted_proposal:type_name -> vega.snapshot.v1.AcceptedProtocolUpgradeProposal
	154, // 243: vega.snapshot.v1.Teams.teams:type_name -> vega.snapshot.v1.Team
	155, // 244: vega.snapshot.v1.Team.referrer:type_name -> vega.snapshot.v1.Membership
	155, // 245: vega.snapshot.v1.Team.referees:type_name -> vega.snapshot.v1.Membership
	157, // 246: vega.snapshot.v1.TeamSwitches.team_switches:type_name -> vega.snapshot.v1.TeamSwitch
	159, // 247: vega.snapshot.v1.Vesting.parties_reward:type_name -> vega.snapshot.v1.PartyReward
	164, // 248: vega.snapshot.v1.PartyReward.asset_locked:type_name -> vega.snapshot.v1.AssetLocked
	166, // 249: vega.snapshot.v1.PartyReward.in_vesting:type_name -> vega.snapshot.v1.InVesting
	163, // 250: vega.snapshot.v1.ReferralProgramData.factor_by_referee:type_name -> vega.snapshot.v1.FactorByReferee
	214, // 251: vega.snapshot.v1.ReferralProgramData.current_program:type_name -> vega.ReferralProgram
	214, // 252: vega.snapshot.v1.ReferralProgramData.new_program:type_name -> vega.ReferralProgram
	161, // 253: vega.snapshot.v1.ReferralProgramData.sets:type_name -> vega.snapshot.v1.ReferralSet
	155, // 254: vega.snapshot.v1.ReferralSet.referrer:type_name -> vega.snapshot.v1.Membership
	155, // 255: vega.snapshot.v1.ReferralSet.referees:type_name -> vega.snapshot.v1.Membership
	162, // 256: vega.snapshot.v1.ReferralSet.running_volumes:type_name -> vega.snapshot.v1.RunningVolume
	165, // 257: vega.snapshot.v1.AssetLocked.epoch_balances:type_name -> vega.snapshot.v1.EpochBalance
	168, // 258: vega.snapshot.v1.ActivityStreak.parties_activity_streak:type_name -> vega.snapshot.v1.PartyActivityStreak
	171, // 259: vega.snapshot.v1.VolumeDiscountProgram.epoch_party_volumes:type_name -> vega.snapshot.v1.EpochPartyVolumes
	172, // 260: vega.snapshot.v1.VolumeDiscountProgram.average_party_volume:type_name -> vega.snapshot.v1.PartyVolume
	215, // 261: vega.snapshot.v1.VolumeDiscountProgram.current_program:type_name -> vega.VolumeDiscountProgram
	215, // 262: vega.snapshot.v1.VolumeDiscountProgram.new_program:type_name -> vega.VolumeDiscountProgram
	170, // 263: vega.snapshot.v1.VolumeDiscountProgram.factors_by_party:type_name -> vega.snapshot.v1.VolumeDiscountStats
	172, // 264: vega.snapshot.v1.EpochPartyVolumes.party_volume:type_name -> vega.snapshot.v1.PartyVolume
	216, // 265: vega.snapshot.v1.Liquidation.config:type_name -> vega.LiquidationStrategy
	174, // 266: vega.snapshot.v1.BankingTransferFeeDiscounts.party_asset_discount:type_name -> vega.snapshot.v1.PartyAssetAmount
