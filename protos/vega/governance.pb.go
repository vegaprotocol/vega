...
type UpdateVolumeDiscountProgram struct {
	...
	Changes *VolumeDiscountProgram `protobuf:"bytes,1,opt,name=changes,proto3" json:"changes,omitempty"`
}
...
func (x *UpdateVolumeDiscountProgram) GetChanges() *VolumeDiscountProgram {
	if x != nil {
		return x.Changes
	}
	return nil
...
var file_vega_governance_proto_rawDesc = []byte{
	...
	0x10, 0x02, 0x22, 0x54, 0x0a, 0x1b, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x56, 0x6f, 0x6c, 0x75,
