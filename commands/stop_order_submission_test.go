		...
		},
		{
			submission: commandspb.StopOrdersSubmission{
				RisesAbove: &commandspb.StopOrderSetup{
					...
					SizeOverrideValue:   &vega.StopOrder_SizeOverrideValue{Percentage: ptr.From("0.5")},
				},
			},
			errStr: "",
		},
		{
			submission: commandspb.StopOrdersSubmission{
				RisesAbove: &commandspb.StopOrderSetup{
					...
					SizeOverrideSetting: ptr.From(vega.StopOrder_SIZE_OVERRIDE_SETTING_POSITION),
					SizeOverrideValue:   &vega.StopOrder_SizeOverrideValue{Percentage: ptr.From("BrokenString")},
				},
			},
		...
		},
		{
			submission: commandspb.StopOrdersSubmission{
				RisesAbove: &commandspb.StopOrderSetup{
					...
					SizeOverrideSetting: ptr.From(vega.StopOrder_SIZE_OVERRIDE_SETTING_POSITION),
					SizeOverrideValue:   &vega.StopOrder_SizeOverrideValue{Percentage: ptr.From("0.0")},
				},
			},
		...
		},
		{
			submission: commandspb.StopOrdersSubmission{
				RisesAbove: &commandspb.StopOrderSetup{
					...
					SizeOverrideSetting: ptr.From(vega.StopOrder_SIZE_OVERRIDE_SETTING_POSITION),
					SizeOverrideValue:   &vega.StopOrder_SizeOverrideValue{Percentage: ptr.From("1.1")},
				},
			},
			errStr: "stop_orders_submission.rises_above.size_override_value (must be between 0 (excluded) and 1 (included))",
		},
