...
var file_vega_wallet_v1_wallet_proto_rawDesc = []byte{
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xdd, 0x18, 0x0a, 0x18, 0x53, 0x75, 0x62, 0x6d, 0x69,
	...
	0x61, 0x72, 0x74, 0x79, 0x50, 0x72, 0x6f, 0x66, 0x69, 0x6c, 0x65, 0x12, 0x3a, 0x0a, 0x09, 0x6e,
	...
	0x08, 0xd1, 0x0f, 0x10, 0xd2, 0x0f, 0x42, 0x31, 0x5a, 0x2f, 0x63, 0x6f, 0x64, 0x65, 0x2e, 0x76,
...
var file_vega_wallet_v1_wallet_proto_goTypes = []interface{}{
	...
	(*v1.NodeVote)(nil),                       // 25: vega.commands.v1.NodeVote
	(*v1.NodeSignature)(nil),                  // 26: vega.commands.v1.NodeSignature
	(*v1.ChainEvent)(nil),                     // 27: vega.commands.v1.ChainEvent
	(*v1.KeyRotateSubmission)(nil),            // 28: vega.commands.v1.KeyRotateSubmission
	(*v1.StateVariableProposal)(nil),          // 29: vega.commands.v1.StateVariableProposal
	(*v1.ValidatorHeartbeat)(nil),             // 30: vega.commands.v1.ValidatorHeartbeat
	(*v1.EthereumKeyRotateSubmission)(nil),    // 31: vega.commands.v1.EthereumKeyRotateSubmission
	(*v1.ProtocolUpgradeProposal)(nil),        // 32: vega.commands.v1.ProtocolUpgradeProposal
	(*v1.IssueSignatures)(nil),                // 33: vega.commands.v1.IssueSignatures
	(*v1.OracleDataSubmission)(nil),           // 34: vega.commands.v1.OracleDataSubmission
}
var file_vega_wallet_v1_wallet_proto_depIdxs = []int32{
	...
	25, // 24: vega.wallet.v1.SubmitTransactionRequest.node_vote:type_name -> vega.commands.v1.NodeVote
	26, // 25: vega.wallet.v1.SubmitTransactionRequest.node_signature:type_name -> vega.commands.v1.NodeSignature
	27, // 26: vega.wallet.v1.SubmitTransactionRequest.chain_event:type_name -> vega.commands.v1.ChainEvent
	28, // 27: vega.wallet.v1.SubmitTransactionRequest.key_rotate_submission:type_name -> vega.commands.v1.KeyRotateSubmission
	29, // 28: vega.wallet.v1.SubmitTransactionRequest.state_variable_proposal:type_name -> vega.commands.v1.StateVariableProposal
	30, // 29: vega.wallet.v1.SubmitTransactionRequest.validator_heartbeat:type_name -> vega.commands.v1.ValidatorHeartbeat
	31, // 30: vega.wallet.v1.SubmitTransactionRequest.ethereum_key_rotate_submission:type_name -> vega.commands.v1.EthereumKeyRotateSubmission
	32, // 31: vega.wallet.v1.SubmitTransactionRequest.protocol_upgrade_proposal:type_name -> vega.commands.v1.ProtocolUpgradeProposal
	33, // 32: vega.wallet.v1.SubmitTransactionRequest.issue_signatures:type_name -> vega.commands.v1.IssueSignatures
	34, // 33: vega.wallet.v1.SubmitTransactionRequest.oracle_data_submission:type_name -> vega.commands.v1.OracleDataSubmission
