...
func TestOrderBook_Crash2651(t *testing.T) {
	...
	o1 := getOrder(t, book, market, "Order01", types.Side_SIDE_BUY, 9000, "613f", 5)
	o1.TimeInForce = types.Order_TIF_GFA
	o1conf, err := book.SubmitOrder(o1)
	require.NotNil(t, o1conf)
	require.NoError(t, err)

	o2 := getOrder(t, book, market, "Order02", types.Side_SIDE_SELL, 9000, "f9e7", 5)
	o2.TimeInForce = types.Order_TIF_GFA
	o2conf, err := book.SubmitOrder(o2)
	require.NotNil(t, o2conf)
	require.NoError(t, err)

	o3 := getOrder(t, book, market, "Order03", types.Side_SIDE_BUY, 8000, "613f", 4)
	o3.TimeInForce = types.Order_TIF_GFA
	o3conf, err := book.SubmitOrder(o3)
	require.NotNil(t, o3conf)
	require.NoError(t, err)

	o4 := getOrder(t, book, market, "Order04", types.Side_SIDE_SELL, 8000, "f9e7", 4)
	o4.TimeInForce = types.Order_TIF_GFA
	o4conf, err := book.SubmitOrder(o4)
	require.NotNil(t, o4conf)
	require.NoError(t, err)

	o5 := getOrder(t, book, market, "Order05", types.Side_SIDE_BUY, 3000, "613f", 4)
	o5.TimeInForce = types.Order_TIF_GFA
	o5conf, err := book.SubmitOrder(o5)
	require.NotNil(t, o5conf)
	require.NoError(t, err)

	o6 := getOrder(t, book, market, "Order06", types.Side_SIDE_SELL, 3000, "f9e7", 3)
	o6.TimeInForce = types.Order_TIF_GFA
	o6conf, err := book.SubmitOrder(o6)
	require.NotNil(t, o6conf)
	require.NoError(t, err)

	o7 := getOrder(t, book, market, "Order07", types.Side_SIDE_SELL, 0, "f9e7", 20)
	o7.TimeInForce = types.Order_TIF_GFA
	o7.PeggedOrder = &types.PeggedOrder{Reference: types.PeggedReference_PEGGED_REFERENCE_BEST_ASK, Offset: 1000}
	o7conf, err := book.SubmitOrder(o7)
	require.NotNil(t, o7conf)
	require.NoError(t, err)

	o8 := getOrder(t, book, market, "Order08", types.Side_SIDE_SELL, 10001, "613f", 5)
	o8.TimeInForce = types.Order_TIF_GFA
	o8conf, err := book.SubmitOrder(o8)
	require.NotNil(t, o8conf)
	require.NoError(t, err)

	o9 := getOrder(t, book, market, "Order09", types.Side_SIDE_BUY, 15001, "613f", 5)
	o9.TimeInForce = types.Order_TIF_GFA
	o9conf, err := book.SubmitOrder(o9)
	require.NotNil(t, o9conf)
	require.NoError(t, err)

	o10 := getOrder(t, book, market, "Order10", types.Side_SIDE_BUY, 0, "f9e7", 12)
	o10.TimeInForce = types.Order_TIF_GTC
	o10.PeggedOrder = &types.PeggedOrder{Reference: types.PeggedReference_PEGGED_REFERENCE_BEST_BID, Offset: -1000}
	o10conf, err := book.SubmitOrder(o10)
	require.NotNil(t, o10conf)
	require.NoError(t, err)

	o11 := getOrder(t, book, market, "Order11", types.Side_SIDE_BUY, 0, "613f", 21)
	o11.TimeInForce = types.Order_TIF_GTC
	o11.PeggedOrder = &types.PeggedOrder{Reference: types.PeggedReference_PEGGED_REFERENCE_MID, Offset: -2000}
	o11conf, err := book.SubmitOrder(o11)
	...
	uncrossedOrders, cancels, err := book.LeaveAuction(time.Now())
	assert.Nil(t, err)
	assert.GreaterOrEqual(t, len(uncrossedOrders), 0)
	assert.GreaterOrEqual(t, len(cancels), 0)

	o12 := getOrder(t, book, market, "Order12", types.Side_SIDE_SELL, 9023, "613f", 22)
	o12.TimeInForce = types.Order_TIF_GTC
	o12conf, err := book.SubmitOrder(o12)
	require.NotNil(t, o12conf)
	require.NoError(t, err)

	o13 := getOrder(t, book, market, "Order13", types.Side_SIDE_BUY, 11119, "98e1", 23)
	o13.TimeInForce = types.Order_TIF_GTC
	o13conf, err := book.SubmitOrder(o13)
	require.NotNil(t, o13conf)
	require.NoError(t, err)

	o14 := getOrder(t, book, market, "Order14", types.Side_SIDE_BUY, 11513, "qqqq", 34)
	o14.TimeInForce = types.Order_TIF_GTC
	o14conf, err := book.SubmitOrder(o14)
