...
var file_vega_snapshot_v1_snapshot_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x03, 0x52, 0x02, 0x6f, 0x66, 0x22, 0xd4, 0x34, 0x0a, 0x07, 0x50, 0x61, 0x79, 0x6c,
	...
	0x61, 0x72, 0x74, 0x69, 0x65, 0x73, 0x42, 0x06, 0x0a, 0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0x56,
	...
	0x6f, 0x70, 0x6f, 0x73, 0x61, 0x6c, 0x73, 0x22, 0x83, 0x01, 0x0a, 0x0e, 0x47, 0x6f, 0x76, 0x65,
	...
	0x0c, 0x70, 0x72, 0x6f, 0x70, 0x6f, 0x73, 0x61, 0x6c, 0x44, 0x61, 0x74, 0x61, 0x22, 0x76, 0x0a,
	...
	0x22, 0xb4, 0x08, 0x0a, 0x0a, 0x53, 0x70, 0x6f, 0x74, 0x4d, 0x61, 0x72, 0x6b, 0x65, 0x74, 0x12,
	...
	0x65, 0x73, 0x53, 0x74, 0x61, 0x74, 0x73, 0x22, 0xaf, 0x0d, 0x0a, 0x06, 0x4d, 0x61, 0x72, 0x6b,
	...
	0x61, 0x74, 0x6f, 0x72, 0x12, 0x65, 0x0a, 0x16, 0x69, 0x6e, 0x64, 0x65, 0x78, 0x5f, 0x70, 0x72,
	0x69, 0x63, 0x65, 0x5f, 0x63, 0x61, 0x6c, 0x63, 0x75, 0x6c, 0x61, 0x74, 0x6f, 0x72, 0x18, 0x1e,
	...
	0x48, 0x00, 0x52, 0x14, 0x69, 0x6e, 0x64, 0x65, 0x78, 0x50, 0x72, 0x69, 0x63, 0x65, 0x43, 0x61,
	0x6c, 0x63, 0x75, 0x6c, 0x61, 0x74, 0x6f, 0x72, 0x88, 0x01, 0x01, 0x12, 0x31, 0x0a, 0x15, 0x6e,
	0x65, 0x78, 0x74, 0x5f, 0x69, 0x6e, 0x64, 0x65, 0x78, 0x5f, 0x70, 0x72, 0x69, 0x63, 0x65, 0x5f,
	0x63, 0x61, 0x6c, 0x63, 0x18, 0x1f, 0x20, 0x01, 0x28, 0x03, 0x52, 0x12, 0x6e, 0x65, 0x78, 0x74,
	0x49, 0x6e, 0x64, 0x65, 0x78, 0x50, 0x72, 0x69, 0x63, 0x65, 0x43, 0x61, 0x6c, 0x63, 0x42, 0x19,
	0x0a, 0x17, 0x5f, 0x69, 0x6e, 0x64, 0x65, 0x78, 0x5f, 0x70, 0x72, 0x69, 0x63, 0x65, 0x5f, 0x63,
	...
	0x67, 0x69, 0x6e, 0x46, 0x61, 0x63, 0x74, 0x6f, 0x72, 0x22, 0x42, 0x0a, 0x07, 0x50, 0x72, 0x6f,
	...
	0x68, 0x6f, 0x6c, 0x64, 0x53, 0x65, 0x74, 0x73, 0x22, 0xa5, 0x04, 0x0a, 0x0b, 0x50, 0x72, 0x6f,
	...
	0x64, 0x61, 0x74, 0x61, 0x2a, 0x60, 0x0a, 0x06, 0x46, 0x6f, 0x72, 0x6d, 0x61, 0x74, 0x12, 0x16,
...
var file_vega_snapshot_v1_snapshot_proto_msgTypes = make([]protoimpl.MessageInfo, 180)
var file_vega_snapshot_v1_snapshot_proto_goTypes = []interface{}{
	...
	(*BatchProposalData)(nil),                     // 45: vega.snapshot.v1.BatchProposalData
	(*GovernanceBatchActive)(nil),                 // 46: vega.snapshot.v1.GovernanceBatchActive
	(*GovernanceNode)(nil),                        // 47: vega.snapshot.v1.GovernanceNode
	(*StakingAccount)(nil),                        // 48: vega.snapshot.v1.StakingAccount
	(*StakingAccounts)(nil),                       // 49: vega.snapshot.v1.StakingAccounts
	(*MatchingBook)(nil),                          // 50: vega.snapshot.v1.MatchingBook
	(*NetParams)(nil),                             // 51: vega.snapshot.v1.NetParams
	(*DecimalMap)(nil),                            // 52: vega.snapshot.v1.DecimalMap
	(*TimePrice)(nil),                             // 53: vega.snapshot.v1.TimePrice
	(*PriceVolume)(nil),                           // 54: vega.snapshot.v1.PriceVolume
	(*PriceRange)(nil),                            // 55: vega.snapshot.v1.PriceRange
	(*PriceBound)(nil),                            // 56: vega.snapshot.v1.PriceBound
	(*PriceRangeCache)(nil),                       // 57: vega.snapshot.v1.PriceRangeCache
	(*CurrentPrice)(nil),                          // 58: vega.snapshot.v1.CurrentPrice
	...
	(*CompositePriceCalculator)(nil),              // 178: vega.snapshot.v1.CompositePriceCalculator
	(*Parties)(nil),                               // 179: vega.snapshot.v1.Parties
	(*PartyProfile)(nil),                          // 180: vega.snapshot.v1.PartyProfile
	(*v1.Signer)(nil),                             // 181: vega.data.v1.Signer
	(*v1.Property)(nil),                           // 182: vega.data.v1.Property
	(*vega.Account)(nil),                          // 183: vega.Account
	(*vega.Asset)(nil),                            // 184: vega.Asset
	(*vega.Withdrawal)(nil),                       // 185: vega.Withdrawal
	(*vega.Deposit)(nil),                          // 186: vega.Deposit
	(*v11.AssetAction)(nil),                       // 187: vega.checkpoint.v1.AssetAction
	(*v11.RecurringTransfers)(nil),                // 188: vega.checkpoint.v1.RecurringTransfers
	(*v11.ScheduledTransferAtTime)(nil),           // 189: vega.checkpoint.v1.ScheduledTransferAtTime
	(*v11.GovernanceTransfer)(nil),                // 190: vega.checkpoint.v1.GovernanceTransfer
	(*v11.ScheduledGovernanceTransferAtTime)(nil), // 191: vega.checkpoint.v1.ScheduledGovernanceTransferAtTime
	(*v11.BridgeState)(nil),                       // 192: vega.checkpoint.v1.BridgeState
	(*vega.Delegation)(nil),                       // 193: vega.Delegation
	(*vega.Proposal)(nil),                         // 194: vega.Proposal
	(*vega.Vote)(nil),                             // 195: vega.Vote
	(*v12.StakeLinking)(nil),                      // 196: vega.events.v1.StakeLinking
	(*vega.StakeTotalSupply)(nil),                 // 197: vega.StakeTotalSupply
	(*vega.Order)(nil),                            // 198: vega.Order
	(*vega.NetworkParameter)(nil),                 // 199: vega.NetworkParameter
	(*vega.PriceMonitoringTrigger)(nil),           // 200: vega.PriceMonitoringTrigger
	(vega.Market_TradingMode)(0),                  // 201: vega.Market.TradingMode
	(vega.AuctionTrigger)(0),                      // 202: vega.AuctionTrigger
	(*vega.AuctionDuration)(nil),                  // 203: vega.AuctionDuration
	(*vega.Market)(nil),                           // 204: vega.Market
	(*v12.FeesStats)(nil),                         // 205: vega.events.v1.FeesStats
	(*v12.StopOrderEvent)(nil),                    // 206: vega.events.v1.StopOrderEvent
	(*v11.MarketState)(nil),                       // 207: vega.checkpoint.v1.MarketState
	(*v12.ValidatorUpdate)(nil),                   // 208: vega.events.v1.ValidatorUpdate
	(*vega.RankingScore)(nil),                     // 209: vega.RankingScore
	(*vega.LiquidityProvision)(nil),               // 210: vega.LiquidityProvision
	(*vega.LiquiditySLAParameters)(nil),           // 211: vega.LiquiditySLAParameters
	(*v12.PaidLiquidityFeesStats)(nil),            // 212: vega.events.v1.PaidLiquidityFeesStats
	(*vega.KeyValueBundle)(nil),                   // 213: vega.KeyValueBundle
	(*v11.MarketActivityTracker)(nil),             // 214: vega.checkpoint.v1.MarketActivityTracker
	(*v11.TakerNotionalVolume)(nil),               // 215: vega.checkpoint.v1.TakerNotionalVolume
	(*v12.ERC20MultiSigSignerEvent)(nil),          // 216: vega.events.v1.ERC20MultiSigSignerEvent
	(*v12.ERC20MultiSigThresholdSetEvent)(nil),    // 217: vega.events.v1.ERC20MultiSigThresholdSetEvent
	(*v12.ProtocolUpgradeEvent)(nil),              // 218: vega.events.v1.ProtocolUpgradeEvent
	(*vega.ReferralProgram)(nil),                  // 219: vega.ReferralProgram
	(*vega.VolumeDiscountProgram)(nil),            // 220: vega.VolumeDiscountProgram
	(*vega.LiquidationStrategy)(nil),              // 221: vega.LiquidationStrategy
	(*vega.CompositePriceConfiguration)(nil),      // 222: vega.CompositePriceConfiguration
	(*vega.Trade)(nil),                            // 223: vega.Trade
	(*vega.Metadata)(nil),                         // 224: vega.Metadata
}
var file_vega_snapshot_v1_snapshot_proto_depIdxs = []int32{
	...
	179, // 78: vega.snapshot.v1.Payload.parties:type_name -> vega.snapshot.v1.Parties
	6,   // 79: vega.snapshot.v1.HoldingAccountTracker.order_holding:type_name -> vega.snapshot.v1.OrderHoldingQuantities
	9,   // 80: vega.snapshot.v1.LiquidityTarget.previous_open_interests:type_name -> vega.snapshot.v1.TimestampedOpenInterest
	9,   // 81: vega.snapshot.v1.LiquidityTarget.max_open_interests:type_name -> vega.snapshot.v1.TimestampedOpenInterest
	8,   // 82: vega.snapshot.v1.SpotLiquidityTarget.previous_total_stake:type_name -> vega.snapshot.v1.TimestampedTotalStake
	8,   // 83: vega.snapshot.v1.SpotLiquidityTarget.max_total_stake:type_name -> vega.snapshot.v1.TimestampedTotalStake
	12,  // 84: vega.snapshot.v1.LiquiditySupplied.bid_cache:type_name -> vega.snapshot.v1.LiquidityOffsetProbabilityPair
	12,  // 85: vega.snapshot.v1.LiquiditySupplied.ask_cache:type_name -> vega.snapshot.v1.LiquidityOffsetProbabilityPair
	15,  // 86: vega.snapshot.v1.OracleDataBatch.oracle_data:type_name -> vega.snapshot.v1.OracleData
	181, // 87: vega.snapshot.v1.OracleData.signers:type_name -> vega.data.v1.Signer
	16,  // 88: vega.snapshot.v1.OracleData.data:type_name -> vega.snapshot.v1.OracleDataPair
	182, // 89: vega.snapshot.v1.OracleData.meta_data:type_name -> vega.data.v1.Property
	18,  // 90: vega.snapshot.v1.Witness.resources:type_name -> vega.snapshot.v1.Resource
	183, // 91: vega.snapshot.v1.CollateralAccounts.accounts:type_name -> vega.Account
	184, // 92: vega.snapshot.v1.CollateralAssets.assets:type_name -> vega.Asset
	184, // 93: vega.snapshot.v1.ActiveAssets.assets:type_name -> vega.Asset
	184, // 94: vega.snapshot.v1.PendingAssets.assets:type_name -> vega.Asset
	184, // 95: vega.snapshot.v1.PendingAssetUpdates.assets:type_name -> vega.Asset
	185, // 96: vega.snapshot.v1.Withdrawal.withdrawal:type_name -> vega.Withdrawal
	186, // 97: vega.snapshot.v1.Deposit.deposit:type_name -> vega.Deposit
	25,  // 98: vega.snapshot.v1.BankingWithdrawals.withdrawals:type_name -> vega.snapshot.v1.Withdrawal
	26,  // 99: vega.snapshot.v1.BankingDeposits.deposit:type_name -> vega.snapshot.v1.Deposit
	187, // 100: vega.snapshot.v1.BankingAssetActions.asset_action:type_name -> vega.checkpoint.v1.AssetAction
	188, // 101: vega.snapshot.v1.BankingRecurringTransfers.recurring_transfers:type_name -> vega.checkpoint.v1.RecurringTransfers
	189, // 102: vega.snapshot.v1.BankingScheduledTransfers.transfers_at_time:type_name -> vega.checkpoint.v1.ScheduledTransferAtTime
	190, // 103: vega.snapshot.v1.BankingRecurringGovernanceTransfers.recurring_transfers:type_name -> vega.checkpoint.v1.GovernanceTransfer
	191, // 104: vega.snapshot.v1.BankingScheduledGovernanceTransfers.transfers_at_time:type_name -> vega.checkpoint.v1.ScheduledGovernanceTransferAtTime
	192, // 105: vega.snapshot.v1.BankingBridgeState.bridge_state:type_name -> vega.checkpoint.v1.BridgeState
	193, // 106: vega.snapshot.v1.DelegationActive.delegations:type_name -> vega.Delegation
	193, // 107: vega.snapshot.v1.DelegationPending.delegations:type_name -> vega.Delegation
	193, // 108: vega.snapshot.v1.DelegationPending.undelegation:type_name -> vega.Delegation
	194, // 109: vega.snapshot.v1.ProposalData.proposal:type_name -> vega.Proposal
	195, // 110: vega.snapshot.v1.ProposalData.yes:type_name -> vega.Vote
	195, // 111: vega.snapshot.v1.ProposalData.no:type_name -> vega.Vote
	195, // 112: vega.snapshot.v1.ProposalData.invalid:type_name -> vega.Vote
	42,  // 113: vega.snapshot.v1.GovernanceEnacted.proposals:type_name -> vega.snapshot.v1.ProposalData
	42,  // 114: vega.snapshot.v1.GovernanceActive.proposals:type_name -> vega.snapshot.v1.ProposalData
	42,  // 115: vega.snapshot.v1.BatchProposalData.batch_proposal:type_name -> vega.snapshot.v1.ProposalData
	194, // 116: vega.snapshot.v1.BatchProposalData.proposals:type_name -> vega.Proposal
	45,  // 117: vega.snapshot.v1.GovernanceBatchActive.batch_proposals:type_name -> vega.snapshot.v1.BatchProposalData
	194, // 118: vega.snapshot.v1.GovernanceNode.proposals:type_name -> vega.Proposal
	42,  // 119: vega.snapshot.v1.GovernanceNode.proposal_data:type_name -> vega.snapshot.v1.ProposalData
	196, // 120: vega.snapshot.v1.StakingAccount.events:type_name -> vega.events.v1.StakeLinking
	48,  // 121: vega.snapshot.v1.StakingAccounts.accounts:type_name -> vega.snapshot.v1.StakingAccount
	197, // 122: vega.snapshot.v1.StakingAccounts.pending_stake_total_supply:type_name -> vega.StakeTotalSupply
	198, // 123: vega.snapshot.v1.MatchingBook.buy:type_name -> vega.Order
	198, // 124: vega.snapshot.v1.MatchingBook.sell:type_name -> vega.Order
	199, // 125: vega.snapshot.v1.NetParams.params:type_name -> vega.NetworkParameter
	200, // 126: vega.snapshot.v1.PriceBound.trigger:type_name -> vega.PriceMonitoringTrigger
	56,  // 127: vega.snapshot.v1.PriceRangeCache.bound:type_name -> vega.snapshot.v1.PriceBound
	55,  // 128: vega.snapshot.v1.PriceRangeCache.range:type_name -> vega.snapshot.v1.PriceRange
	52,  // 129: vega.snapshot.v1.PriceMonitor.fp_horizons:type_name -> vega.snapshot.v1.DecimalMap
	56,  // 130: vega.snapshot.v1.PriceMonitor.bounds:type_name -> vega.snapshot.v1.PriceBound
	57,  // 131: vega.snapshot.v1.PriceMonitor.price_range_cache:type_name -> vega.snapshot.v1.PriceRangeCache
	52,  // 132: vega.snapshot.v1.PriceMonitor.ref_price_cache:type_name -> vega.snapshot.v1.DecimalMap
	58,  // 133: vega.snapshot.v1.PriceMonitor.prices_now:type_name -> vega.snapshot.v1.CurrentPrice
	59,  // 134: vega.snapshot.v1.PriceMonitor.prices_past:type_name -> vega.snapshot.v1.PastPrice
	201, // 135: vega.snapshot.v1.AuctionState.mode:type_name -> vega.Market.TradingMode
	201, // 136: vega.snapshot.v1.AuctionState.default_mode:type_name -> vega.Market.TradingMode
	202, // 137: vega.snapshot.v1.AuctionState.trigger:type_name -> vega.AuctionTrigger
	203, // 138: vega.snapshot.v1.AuctionState.end:type_name -> vega.AuctionDuration
	202, // 139: vega.snapshot.v1.AuctionState.extension:type_name -> vega.AuctionTrigger
	62,  // 140: vega.snapshot.v1.EquityShare.lps:type_name -> vega.snapshot.v1.EquityShareLP
	204, // 141: vega.snapshot.v1.SpotMarket.market:type_name -> vega.Market
	60,  // 142: vega.snapshot.v1.SpotMarket.price_monitor:type_name -> vega.snapshot.v1.PriceMonitor
	61,  // 143: vega.snapshot.v1.SpotMarket.auction_state:type_name -> vega.snapshot.v1.AuctionState
	79,  // 144: vega.snapshot.v1.SpotMarket.pegged_orders:type_name -> vega.snapshot.v1.PeggedOrders
	198, // 145: vega.snapshot.v1.SpotMarket.expiring_orders:type_name -> vega.Order
	63,  // 146: vega.snapshot.v1.SpotMarket.equity_share:type_name -> vega.snapshot.v1.EquityShare
	64,  // 147: vega.snapshot.v1.SpotMarket.fee_splitter:type_name -> vega.snapshot.v1.FeeSplitter
	78,  // 148: vega.snapshot.v1.SpotMarket.stop_orders:type_name -> vega.snapshot.v1.StopOrders
	198, // 149: vega.snapshot.v1.SpotMarket.expiring_stop_orders:type_name -> vega.Order
	205, // 150: vega.snapshot.v1.SpotMarket.fees_stats:type_name -> vega.events.v1.FeesStats
	204, // 151: vega.snapshot.v1.Market.market:type_name -> vega.Market
	60,  // 152: vega.snapshot.v1.Market.price_monitor:type_name -> vega.snapshot.v1.PriceMonitor
	61,  // 153: vega.snapshot.v1.Market.auction_state:type_name -> vega.snapshot.v1.AuctionState
	79,  // 154: vega.snapshot.v1.Market.pegged_orders:type_name -> vega.snapshot.v1.PeggedOrders
	198, // 155: vega.snapshot.v1.Market.expiring_orders:type_name -> vega.Order
	63,  // 156: vega.snapshot.v1.Market.equity_share:type_name -> vega.snapshot.v1.EquityShare
	64,  // 157: vega.snapshot.v1.Market.fee_splitter:type_name -> vega.snapshot.v1.FeeSplitter
	78,  // 158: vega.snapshot.v1.Market.stop_orders:type_name -> vega.snapshot.v1.StopOrders
	198, // 159: vega.snapshot.v1.Market.expiring_stop_orders:type_name -> vega.Order
	68,  // 160: vega.snapshot.v1.Market.product:type_name -> vega.snapshot.v1.Product
	205, // 161: vega.snapshot.v1.Market.fees_stats:type_name -> vega.events.v1.FeesStats
	67,  // 162: vega.snapshot.v1.Market.party_margin_factor:type_name -> vega.snapshot.v1.PartyMarginFactor
	178, // 163: vega.snapshot.v1.Market.mark_price_calculator:type_name -> vega.snapshot.v1.CompositePriceCalculator
	178, // 164: vega.snapshot.v1.Market.index_price_calculator:type_name -> vega.snapshot.v1.CompositePriceCalculator
	72,  // 165: vega.snapshot.v1.Product.perps:type_name -> vega.snapshot.v1.Perps
	69,  // 166: vega.snapshot.v1.Perps.external_data_point:type_name -> vega.snapshot.v1.DataPoint
	69,  // 167: vega.snapshot.v1.Perps.internal_data_point:type_name -> vega.snapshot.v1.DataPoint
	71,  // 168: vega.snapshot.v1.Perps.external_twap_data:type_name -> vega.snapshot.v1.TWAPData
	71,  // 169: vega.snapshot.v1.Perps.internal_twap_data:type_name -> vega.snapshot.v1.TWAPData
	70,  // 170: vega.snapshot.v1.Perps.auction_intervals:type_name -> vega.snapshot.v1.AuctionIntervals
	73,  // 171: vega.snapshot.v1.PricedStopOrders.falls_bellow:type_name -> vega.snapshot.v1.OrdersAtPrice
	73,  // 172: vega.snapshot.v1.PricedStopOrders.rises_above:type_name -> vega.snapshot.v1.OrdersAtPrice
	77,  // 173: vega.snapshot.v1.TrailingStopOrders.falls_bellow:type_name -> vega.snapshot.v1.OffsetsAtPrice
	77,  // 174: vega.snapshot.v1.TrailingStopOrders.rises_above:type_name -> vega.snapshot.v1.OffsetsAtPrice
	76,  // 175: vega.snapshot.v1.OffsetsAtPrice.offsets:type_name -> vega.snapshot.v1.OrdersAtOffset
	206, // 176: vega.snapshot.v1.StopOrders.stop_orders:type_name -> vega.events.v1.StopOrderEvent
	74,  // 177: vega.snapshot.v1.StopOrders.priced_stop_orders:type_name -> vega.snapshot.v1.PricedStopOrders
	75,  // 178: vega.snapshot.v1.StopOrders.trailing_stop_orders:type_name -> vega.snapshot.v1.TrailingStopOrders
	198, // 179: vega.snapshot.v1.PeggedOrders.parked_orders:type_name -> vega.Order
	66,  // 180: vega.snapshot.v1.ExecutionMarkets.markets:type_name -> vega.snapshot.v1.Market
	65,  // 181: vega.snapshot.v1.ExecutionMarkets.spot_markets:type_name -> vega.snapshot.v1.SpotMarket
	207, // 182: vega.snapshot.v1.ExecutionMarkets.settled_markets:type_name -> vega.checkpoint.v1.MarketState
	82,  // 183: vega.snapshot.v1.ExecutionMarkets.successors:type_name -> vega.snapshot.v1.Successors
	80,  // 184: vega.snapshot.v1.ExecutionMarkets.sla_network_params:type_name -> vega.snapshot.v1.SLANetworkParams
	83,  // 185: vega.snapshot.v1.MarketPositions.positions:type_name -> vega.snapshot.v1.Position
	85,  // 186: vega.snapshot.v1.MarketPositions.parties_records:type_name -> vega.snapshot.v1.PartyPositionStats
	87,  // 187: vega.snapshot.v1.SettlementState.last_settled_positions:type_name -> vega.snapshot.v1.LastSettledPosition
	88,  // 188: vega.snapshot.v1.SettlementState.trades:type_name -> vega.snapshot.v1.SettlementTrade
	92,  // 189: vega.snapshot.v1.RewardsPendingPayouts.scheduled_rewards_payout:type_name -> vega.snapshot.v1.ScheduledRewardsPayout
	93,  // 190: vega.snapshot.v1.ScheduledRewardsPayout.rewards_payout:type_name -> vega.snapshot.v1.RewardsPayout
	94,  // 191: vega.snapshot.v1.RewardsPayout.reward_party_amount:type_name -> vega.snapshot.v1.RewardsPartyAmount
	97,  // 192: vega.snapshot.v1.VoteSpamPolicy.party_to_vote:type_name -> vega.snapshot.v1.PartyProposalVoteCount
	145, // 193: vega.snapshot.v1.VoteSpamPolicy.banned_parties:type_name -> vega.snapshot.v1.BannedParty
	98,  // 194: vega.snapshot.v1.VoteSpamPolicy.token_balance:type_name -> vega.snapshot.v1.PartyTokenBalance
	99,  // 195: vega.snapshot.v1.VoteSpamPolicy.recent_blocks_reject_stats:type_name -> vega.snapshot.v1.BlockRejectStats
	100, // 196: vega.snapshot.v1.SimpleSpamPolicy.party_to_count:type_name -> vega.snapshot.v1.SpamPartyTransactionCount
	145, // 197: vega.snapshot.v1.SimpleSpamPolicy.banned_parties:type_name -> vega.snapshot.v1.BannedParty
	98,  // 198: vega.snapshot.v1.SimpleSpamPolicy.token_balance:type_name -> vega.snapshot.v1.PartyTokenBalance
	102, // 199: vega.snapshot.v1.Notary.notary_sigs:type_name -> vega.snapshot.v1.NotarySigs
	106, // 200: vega.snapshot.v1.StakeVerifierDeposited.pending_deposited:type_name -> vega.snapshot.v1.StakeVerifierPending
	106, // 201: vega.snapshot.v1.StakeVerifierRemoved.pending_removed:type_name -> vega.snapshot.v1.StakeVerifierPending
	109, // 202: vega.snapshot.v1.EthContractCallResults.pending_contract_call_result:type_name -> vega.snapshot.v1.EthContractCallResult
	116, // 203: vega.snapshot.v1.Topology.validator_data:type_name -> vega.snapshot.v1.ValidatorState
	110, // 204: vega.snapshot.v1.Topology.pending_pub_key_rotations:type_name -> vega.snapshot.v1.PendingKeyRotation
	119, // 205: vega.snapshot.v1.Topology.validator_performance:type_name -> vega.snapshot.v1.ValidatorPerformance
	111, // 206: vega.snapshot.v1.Topology.pending_ethereum_key_rotations:type_name -> vega.snapshot.v1.PendingEthereumKeyRotation
	113, // 207: vega.snapshot.v1.Topology.signatures:type_name -> vega.snapshot.v1.ToplogySignatures
	111, // 208: vega.snapshot.v1.Topology.unsolved_ethereum_key_rotations:type_name -> vega.snapshot.v1.PendingEthereumKeyRotation
	114, // 209: vega.snapshot.v1.ToplogySignatures.pending_signatures:type_name -> vega.snapshot.v1.PendingERC20MultisigControlSignature
	115, // 210: vega.snapshot.v1.ToplogySignatures.issued_signatures:type_name -> vega.snapshot.v1.IssuedERC20MultisigControlSignature
	208, // 211: vega.snapshot.v1.ValidatorState.validator_update:type_name -> vega.events.v1.ValidatorUpdate
	117, // 212: vega.snapshot.v1.ValidatorState.heartbeat_tracker:type_name -> vega.snapshot.v1.HeartbeatTracker
	209, // 213: vega.snapshot.v1.ValidatorState.ranking_score:type_name -> vega.RankingScore
	118, // 214: vega.snapshot.v1.ValidatorPerformance.validator_perf_stats:type_name -> vega.snapshot.v1.PerformanceStats
	123, // 215: vega.snapshot.v1.LiquidityPartiesLiquidityOrders.party_orders:type_name -> vega.snapshot.v1.PartyOrders
	198, // 216: vega.snapshot.v1.PartyOrders.orders:type_name -> vega.Order
	123, // 217: vega.snapshot.v1.LiquidityPartiesOrders.party_orders:type_name -> vega.snapshot.v1.PartyOrders
	210, // 218: vega.snapshot.v1.LiquidityProvisions.liquidity_provisions:type_name -> vega.LiquidityProvision
	127, // 219: vega.snapshot.v1.LiquidityScores.scores:type_name -> vega.snapshot.v1.LiquidityScore
	211, // 220: vega.snapshot.v1.LiquidityV2Parameters.market_sla_parameters:type_name -> vega.LiquiditySLAParameters
	212, // 221: vega.snapshot.v1.LiquidityV2PaidFeesStats.stats:type_name -> vega.events.v1.PaidLiquidityFeesStats
	210, // 222: vega.snapshot.v1.LiquidityV2Provisions.liquidity_provisions:type_name -> vega.LiquidityProvision
	210, // 223: vega.snapshot.v1.LiquidityV2PendingProvisions.pending_liquidity_provisions:type_name -> vega.LiquidityProvision
	133, // 224: vega.snapshot.v1.LiquidityV2Performances.performance_per_party:type_name -> vega.snapshot.v1.LiquidityV2PerformancePerParty
	127, // 225: vega.snapshot.v1.LiquidityV2Scores.scores:type_name -> vega.snapshot.v1.LiquidityScore
	12,  // 226: vega.snapshot.v1.LiquidityV2Supplied.bid_cache:type_name -> vega.snapshot.v1.LiquidityOffsetProbabilityPair
	12,  // 227: vega.snapshot.v1.LiquidityV2Supplied.ask_cache:type_name -> vega.snapshot.v1.LiquidityOffsetProbabilityPair
	139, // 228: vega.snapshot.v1.FloatingPointConsensus.next_time_trigger:type_name -> vega.snapshot.v1.NextTimeTrigger
	137, // 229: vega.snapshot.v1.FloatingPointConsensus.state_variables:type_name -> vega.snapshot.v1.StateVarInternalState
	138, // 230: vega.snapshot.v1.StateVarInternalState.validators_results:type_name -> vega.snapshot.v1.FloatingPointValidatorResult
	213, // 231: vega.snapshot.v1.FloatingPointValidatorResult.bundle:type_name -> vega.KeyValueBundle
	214, // 232: vega.snapshot.v1.MarketTracker.market_activity:type_name -> vega.checkpoint.v1.MarketActivityTracker
	215, // 233: vega.snapshot.v1.MarketTracker.taker_notional_volume:type_name -> vega.checkpoint.v1.TakerNotionalVolume
	216, // 234: vega.snapshot.v1.SignerEventsPerAddress.events:type_name -> vega.events.v1.ERC20MultiSigSignerEvent
	141, // 235: vega.snapshot.v1.ERC20MultiSigTopologyVerified.events_per_address:type_name -> vega.snapshot.v1.SignerEventsPerAddress
	217, // 236: vega.snapshot.v1.ERC20MultiSigTopologyVerified.threshold:type_name -> vega.events.v1.ERC20MultiSigThresholdSetEvent
	216, // 237: vega.snapshot.v1.ERC20MultiSigTopologyPending.pending_signers:type_name -> vega.events.v1.ERC20MultiSigSignerEvent
	217, // 238: vega.snapshot.v1.ERC20MultiSigTopologyPending.pending_threshold_set:type_name -> vega.events.v1.ERC20MultiSigThresholdSetEvent
	150, // 239: vega.snapshot.v1.ProofOfWork.tx_at_height:type_name -> vega.snapshot.v1.TransactionsAtHeight
	150, // 240: vega.snapshot.v1.ProofOfWork.tid_at_height:type_name -> vega.snapshot.v1.TransactionsAtHeight
	145, // 241: vega.snapshot.v1.ProofOfWork.banned:type_name -> vega.snapshot.v1.BannedParty
	146, // 242: vega.snapshot.v1.ProofOfWork.pow_params:type_name -> vega.snapshot.v1.ProofOfWorkParams
	147, // 243: vega.snapshot.v1.ProofOfWork.pow_state:type_name -> vega.snapshot.v1.ProofOfWorkState
	152, // 244: vega.snapshot.v1.ProofOfWork.nonce_refs_at_height:type_name -> vega.snapshot.v1.NonceRefsAtHeight
	148, // 245: vega.snapshot.v1.ProofOfWorkState.pow_state:type_name -> vega.snapshot.v1.ProofOfWorkBlockState
	149, // 246: vega.snapshot.v1.ProofOfWorkBlockState.party_state:type_name -> vega.snapshot.v1.ProofOfWorkPartyStateForBlock
	151, // 247: vega.snapshot.v1.NonceRefsAtHeight.refs:type_name -> vega.snapshot.v1.NonceRef
	218, // 248: vega.snapshot.v1.ProtocolUpgradeProposals.active_proposals:type_name -> vega.events.v1.ProtocolUpgradeEvent
	154, // 249: vega.snapshot.v1.ProtocolUpgradeProposals.accepted_proposal:type_name -> vega.snapshot.v1.AcceptedProtocolUpgradeProposal
	156, // 250: vega.snapshot.v1.Teams.teams:type_name -> vega.snapshot.v1.Team
	157, // 251: vega.snapshot.v1.Team.referrer:type_name -> vega.snapshot.v1.Membership
	157, // 252: vega.snapshot.v1.Team.referees:type_name -> vega.snapshot.v1.Membership
	159, // 253: vega.snapshot.v1.TeamSwitches.team_switches:type_name -> vega.snapshot.v1.TeamSwitch
	161, // 254: vega.snapshot.v1.Vesting.parties_reward:type_name -> vega.snapshot.v1.PartyReward
	166, // 255: vega.snapshot.v1.PartyReward.asset_locked:type_name -> vega.snapshot.v1.AssetLocked
	168, // 256: vega.snapshot.v1.PartyReward.in_vesting:type_name -> vega.snapshot.v1.InVesting
	165, // 257: vega.snapshot.v1.ReferralProgramData.factor_by_referee:type_name -> vega.snapshot.v1.FactorByReferee
	219, // 258: vega.snapshot.v1.ReferralProgramData.current_program:type_name -> vega.ReferralProgram
	219, // 259: vega.snapshot.v1.ReferralProgramData.new_program:type_name -> vega.ReferralProgram
	163, // 260: vega.snapshot.v1.ReferralProgramData.sets:type_name -> vega.snapshot.v1.ReferralSet
	157, // 261: vega.snapshot.v1.ReferralSet.referrer:type_name -> vega.snapshot.v1.Membership
	157, // 262: vega.snapshot.v1.ReferralSet.referees:type_name -> vega.snapshot.v1.Membership
	164, // 263: vega.snapshot.v1.ReferralSet.running_volumes:type_name -> vega.snapshot.v1.RunningVolume
	167, // 264: vega.snapshot.v1.AssetLocked.epoch_balances:type_name -> vega.snapshot.v1.EpochBalance
	170, // 265: vega.snapshot.v1.ActivityStreak.parties_activity_streak:type_name -> vega.snapshot.v1.PartyActivityStreak
	173, // 266: vega.snapshot.v1.VolumeDiscountProgram.epoch_party_volumes:type_name -> vega.snapshot.v1.EpochPartyVolumes
	174, // 267: vega.snapshot.v1.VolumeDiscountProgram.average_party_volume:type_name -> vega.snapshot.v1.PartyVolume
	220, // 268: vega.snapshot.v1.VolumeDiscountProgram.current_program:type_name -> vega.VolumeDiscountProgram
	220, // 269: vega.snapshot.v1.VolumeDiscountProgram.new_program:type_name -> vega.VolumeDiscountProgram
	172, // 270: vega.snapshot.v1.VolumeDiscountProgram.factors_by_party:type_name -> vega.snapshot.v1.VolumeDiscountStats
	174, // 271: vega.snapshot.v1.EpochPartyVolumes.party_volume:type_name -> vega.snapshot.v1.PartyVolume
	221, // 272: vega.snapshot.v1.Liquidation.config:type_name -> vega.LiquidationStrategy
	176, // 273: vega.snapshot.v1.BankingTransferFeeDiscounts.party_asset_discount:type_name -> vega.snapshot.v1.PartyAssetAmount
	222, // 274: vega.snapshot.v1.CompositePriceCalculator.price_configuration:type_name -> vega.CompositePriceConfiguration
	223, // 275: vega.snapshot.v1.CompositePriceCalculator.trades:type_name -> vega.Trade
	53,  // 276: vega.snapshot.v1.CompositePriceCalculator.book_price_at_time:type_name -> vega.snapshot.v1.TimePrice
	180, // 277: vega.snapshot.v1.Parties.profiles:type_name -> vega.snapshot.v1.PartyProfile
	224, // 278: vega.snapshot.v1.PartyProfile.metadata:type_name -> vega.Metadata
