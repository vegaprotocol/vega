Feature: test risk model parameter change in margin calculation
  Background:
    ...
    And the parties deposit on asset's general account the following amount:
      | party  | asset | amount    |
      | party0 | USD   | 5000000000000000    |
      | party1 | USD   | 10000000000000000 |
      | party2 | USD   | 10000000000000000 |
      | party3 | USD   | 10000000000000000 |

   Scenario: lognormal risk model with different risk parameters 
   ...
   And the parties submit the following liquidity provision:
      ...
      # | lp1 | party0 | ETH/MAR23 | 50000             | 0.001 | sell | ASK              | 500        | 20     | submission |
      # | lp1 | party0 | ETH/MAR23 | 50000             | 0.001 | buy  | BID              | 500        | 20     | submission  |
      # | lp1 | party0 | ETH/MAR24 | 50000             | 0.001 | sell | ASK              | 500        | 20     | submission |
      # | lp1 | party0 | ETH/MAR24 | 50000             | 0.001 | buy  | BID              | 500        | 20     | submission  |
    ...
    #   | mark price | trading mode            | horizon | min bound | max bound | target stake | supplied stake | open interest |
    #   | 1000       | TRADING_MODE_CONTINUOUS | 1000    | 986       | 1014      | 2464         | 50000          | 10            |
    # target_stake = mark_price x max_oi x target_stake_scaling_factor x rf_short = 1000 x 10 x 1 x 0.24649034405344100 = 2464
    ...
    And the parties should have the following account balances:
      ...
      | party0 | USD   | ETH/MAR21 | 19524  | 430476   | 50000 |
      | party1 | USD   | ETH/MAR21 | 3117   | 99981450 | 0     |
      | party2 | USD   | ETH/MAR21 | 3429   | 99976835 | 0     |
    ...
    # risk model 002: check the requried balances
    And the parties should have the following account balances:
      | party  | asset | market id | margin | general  | bond  |
  ...
  # risk model 003: check the requried balances
    And the parties should have the following account balances:
      | party  | asset | market id | margin | general   | bond  |
      | party0 | USD   | ETH/MAR23 | 26917  | 423083   | 50000 |
      | party1 | USD   | ETH/MAR23 | 3831   | 99996169 | 0     |
      | party2 | USD   | ETH/MAR23 | 4454   | 99995546 | 0     |

    #check the margin levels
    #party1 margin level is: margin_position+margin_order = vol * (MarkPrice-ExitPrice)+ vol * rf * MarkPrice + order * rf * MarkPrice = 10 * (1000-900)+10*0.199294303*1000 + 1*0.199294303*1000=3972
    Then the parties should have the following margin levels:
      | party  | market id | maintenance | search | initial | release |
    ...
    # risk model 004: check the requried balances
    And the parties should have the following account balances:
      | party  | asset | market id | margin | general   | bond  |
      | party0 | USD   | ETH/MAR24 | 15870  | 434130   | 50000 |
      | party1 | USD   | ETH/MAR24 | 3101   | 99996899 | 0     |
      | party2 | USD   | ETH/MAR24 | 2953   | 99997047 | 0     |
