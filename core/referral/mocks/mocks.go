...
// Source: code.vegaprotocol.io/vega/core/referral (interfaces: EpochEngine,Broker,TimeService,MarketActivityTracker,StakingBalances)
...
func (mr *MockStakingBalancesMockRecorder) GetAvailableBalance(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAvailableBalance", reflect.TypeOf((*MockStakingBalances)(nil).GetAvailableBalance), arg0)
}
