Feature: CASE-5: Trader submits short order that will trade - new formula & low exit price
  ...
  Background:
    ...
    And the execution engine have these markets:
      ...
      | ETH/DEC19 | BTC       | ETH        | ETH   | 9400000    | simple     | 0.1       | 0.2       | 0              | 0               | 0     | 5              | 4              | 3.2           | 940000           | 0                | continous    | 0         | 0                  | 0             | 0                  |                |             |                 | 0.1              | 0xDEADBEEF,0xCAFEDOOD | prices.ETH.value     | TYPE_INTEGER              | prices.ETH.value    |
