...
type TxErrorEvent_OrderSubmission struct {
	OrderSubmission *proto1.OrderSubmission `protobuf:"bytes,101,opt,name=order_submission,json=orderSubmission,proto3,oneof"`
}

type TxErrorEvent_OrderAmendment struct {
	OrderAmendment *proto1.OrderAmendment `protobuf:"bytes,102,opt,name=order_amendment,json=orderAmendment,proto3,oneof"`
}

type TxErrorEvent_OrderCancellation struct {
	OrderCancellation *proto1.OrderCancellation `protobuf:"bytes,103,opt,name=order_cancellation,json=orderCancellation,proto3,oneof"`
}
...
func (m *TxErrorEvent) GetOrderSubmission() *proto1.OrderSubmission {
...
func (m *TxErrorEvent) GetOrderAmendment() *proto1.OrderAmendment {
...
func (m *TxErrorEvent) GetOrderCancellation() *proto1.OrderCancellation {
...
var fileDescriptor_289f490918bfe3bf = []byte{
	...
	,
}
