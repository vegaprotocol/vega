...
var file_vega_snapshot_v1_snapshot_proto_rawDesc = []byte{
	...
	0x08, 0x52, 0x0a, 0x64, 0x69, 0x73, 0x74, 0x72, 0x65, 0x73, 0x73, 0x65, 0x64, 0x22, 0x68, 0x0a,
	...
	0x73, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x22, 0xee, 0x01, 0x0a, 0x0f, 0x53, 0x65, 0x74, 0x74,
	...
	0x6e, 0x65, 0x77, 0x53, 0x69, 0x7a, 0x65, 0x22, 0x67, 0x0a, 0x08, 0x41, 0x70, 0x70, 0x53, 0x74,
	...
	0x28, 0x09, 0x52, 0x06, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x22, 0x94, 0x04, 0x0a, 0x0a, 0x4c,
	...
	0x0a, 0x02, 0x69, 0x64, 0x18, 0x08, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x22, 0x5e,
	...
	0x75, 0x6c, 0x74, 0x22, 0xaf, 0x01, 0x0a, 0x15, 0x45, 0x74, 0x68, 0x43, 0x6f, 0x6e, 0x74, 0x72,
	...
	0x65, 0x72, 0x72, 0x6f, 0x72, 0x22, 0x9b, 0x01, 0x0a, 0x12, 0x50, 0x65, 0x6e, 0x64, 0x69, 0x6e,
	...
	0x52, 0x07, 0x70, 0x61, 0x72, 0x74, 0x79, 0x49, 0x64, 0x22, 0x81, 0x01, 0x0a, 0x15, 0x4c, 0x69,
	...
	0x22, 0xc6, 0x02, 0x0a, 0x1e, 0x4c, 0x69, 0x71, 0x75, 0x69, 0x64, 0x69, 0x74, 0x79, 0x56, 0x32,
	...
	0x73, 0x50, 0x65, 0x72, 0x45, 0x70, 0x6f, 0x63, 0x68, 0x22, 0xdf, 0x01, 0x0a, 0x11, 0x4c, 0x69,
	...
	0x69, 0x65, 0x72, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x1c, 0x72, 0x65, 0x77, 0x61, 0x72,
	...
	0x6c, 0x69, 0x65, 0x72, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x17, 0x72, 0x65, 0x77, 0x61,
	0x72, 0x64, 0x56, 0x65, 0x73, 0x74, 0x69, 0x6e, 0x67, 0x4d, 0x75, 0x6c, 0x74, 0x69, 0x70, 0x6c,
	0x69, 0x65, 0x72, 0x2a, 0x60, 0x0a, 0x06, 0x46, 0x6f, 0x72, 0x6d, 0x61, 0x74, 0x12, 0x16, 0x0a,
...
var file_vega_snapshot_v1_snapshot_proto_msgTypes = make([]protoimpl.MessageInfo, 160)
var file_vega_snapshot_v1_snapshot_proto_goTypes = []interface{}{
	...
	(*ActivityStreak)(nil),                        // 159: vega.snapshot.v1.ActivityStreak
	(*PartyActivityStreak)(nil),                   // 160: vega.snapshot.v1.PartyActivityStreak
	(*v1.Signer)(nil),                             // 161: vega.data.v1.Signer
	(*v1.Property)(nil),                           // 162: vega.data.v1.Property
	(*vega.Account)(nil),                          // 163: vega.Account
	(*vega.Asset)(nil),                            // 164: vega.Asset
	(*vega.Withdrawal)(nil),                       // 165: vega.Withdrawal
	(*vega.Deposit)(nil),                          // 166: vega.Deposit
	(*v11.AssetAction)(nil),                       // 167: vega.checkpoint.v1.AssetAction
	(*v11.RecurringTransfers)(nil),                // 168: vega.checkpoint.v1.RecurringTransfers
	(*v11.ScheduledTransferAtTime)(nil),           // 169: vega.checkpoint.v1.ScheduledTransferAtTime
	(*v11.GovernanceTransfer)(nil),                // 170: vega.checkpoint.v1.GovernanceTransfer
	(*v11.ScheduledGovernanceTransferAtTime)(nil), // 171: vega.checkpoint.v1.ScheduledGovernanceTransferAtTime
	(*v11.BridgeState)(nil),                       // 172: vega.checkpoint.v1.BridgeState
	(*vega.Delegation)(nil),                       // 173: vega.Delegation
	(*vega.Proposal)(nil),                         // 174: vega.Proposal
	(*vega.Vote)(nil),                             // 175: vega.Vote
	(*v12.StakeLinking)(nil),                      // 176: vega.events.v1.StakeLinking
	(*vega.StakeTotalSupply)(nil),                 // 177: vega.StakeTotalSupply
	(*vega.Order)(nil),                            // 178: vega.Order
	(*vega.NetworkParameter)(nil),                 // 179: vega.NetworkParameter
	(*vega.PriceMonitoringTrigger)(nil),           // 180: vega.PriceMonitoringTrigger
	(vega.Market_TradingMode)(0),                  // 181: vega.Market.TradingMode
	(vega.AuctionTrigger)(0),                      // 182: vega.AuctionTrigger
	(*vega.AuctionDuration)(nil),                  // 183: vega.AuctionDuration
	(*vega.Market)(nil),                           // 184: vega.Market
	(*v12.StopOrderEvent)(nil),                    // 185: vega.events.v1.StopOrderEvent
	(*v11.MarketState)(nil),                       // 186: vega.checkpoint.v1.MarketState
	(*v12.ValidatorUpdate)(nil),                   // 187: vega.events.v1.ValidatorUpdate
	(*vega.RankingScore)(nil),                     // 188: vega.RankingScore
	(*vega.LiquidityProvision)(nil),               // 189: vega.LiquidityProvision
	(*vega.KeyValueBundle)(nil),                   // 190: vega.KeyValueBundle
	(*v11.MarketActivityTracker)(nil),             // 191: vega.checkpoint.v1.MarketActivityTracker
	(*v11.TakerNotionalVolume)(nil),               // 192: vega.checkpoint.v1.TakerNotionalVolume
	(*v12.ERC20MultiSigSignerEvent)(nil),          // 193: vega.events.v1.ERC20MultiSigSignerEvent
	(*v12.ERC20MultiSigThresholdSetEvent)(nil),    // 194: vega.events.v1.ERC20MultiSigThresholdSetEvent
	(*v12.ProtocolUpgradeEvent)(nil),              // 195: vega.events.v1.ProtocolUpgradeEvent
	(*vega.ReferralProgram)(nil),                  // 196: vega.ReferralProgram
}
var file_vega_snapshot_v1_snapshot_proto_depIdxs = []int32{
	...
	159, // 73: vega.snapshot.v1.Payload.activity_streak:type_name -> vega.snapshot.v1.ActivityStreak
	...
	161, // 82: vega.snapshot.v1.OracleData.signers:type_name -> vega.data.v1.Signer
	16,  // 83: vega.snapshot.v1.OracleData.data:type_name -> vega.snapshot.v1.OracleDataPair
	162, // 84: vega.snapshot.v1.OracleData.meta_data:type_name -> vega.data.v1.Property
	18,  // 85: vega.snapshot.v1.Witness.resources:type_name -> vega.snapshot.v1.Resource
	163, // 86: vega.snapshot.v1.CollateralAccounts.accounts:type_name -> vega.Account
	164, // 87: vega.snapshot.v1.CollateralAssets.assets:type_name -> vega.Asset
	164, // 88: vega.snapshot.v1.ActiveAssets.assets:type_name -> vega.Asset
	164, // 89: vega.snapshot.v1.PendingAssets.assets:type_name -> vega.Asset
	164, // 90: vega.snapshot.v1.PendingAssetUpdates.assets:type_name -> vega.Asset
	165, // 91: vega.snapshot.v1.Withdrawal.withdrawal:type_name -> vega.Withdrawal
	166, // 92: vega.snapshot.v1.Deposit.deposit:type_name -> vega.Deposit
	...
	167, // 95: vega.snapshot.v1.BankingAssetActions.asset_action:type_name -> vega.checkpoint.v1.AssetAction
	168, // 96: vega.snapshot.v1.BankingRecurringTransfers.recurring_transfers:type_name -> vega.checkpoint.v1.RecurringTransfers
	169, // 97: vega.snapshot.v1.BankingScheduledTransfers.transfers_at_time:type_name -> vega.checkpoint.v1.ScheduledTransferAtTime
	170, // 98: vega.snapshot.v1.BankingRecurringGovernanceTransfers.recurring_transfers:type_name -> vega.checkpoint.v1.GovernanceTransfer
	171, // 99: vega.snapshot.v1.BankingScheduledGovernanceTransfers.transfers_at_time:type_name -> vega.checkpoint.v1.ScheduledGovernanceTransferAtTime
	172, // 100: vega.snapshot.v1.BankingBridgeState.bridge_state:type_name -> vega.checkpoint.v1.BridgeState
	173, // 101: vega.snapshot.v1.DelegationActive.delegations:type_name -> vega.Delegation
	173, // 102: vega.snapshot.v1.DelegationPending.delegations:type_name -> vega.Delegation
	173, // 103: vega.snapshot.v1.DelegationPending.undelegation:type_name -> vega.Delegation
	174, // 104: vega.snapshot.v1.ProposalData.proposal:type_name -> vega.Proposal
	175, // 105: vega.snapshot.v1.ProposalData.yes:type_name -> vega.Vote
	175, // 106: vega.snapshot.v1.ProposalData.no:type_name -> vega.Vote
	175, // 107: vega.snapshot.v1.ProposalData.invalid:type_name -> vega.Vote
	...
	174, // 110: vega.snapshot.v1.GovernanceNode.proposals:type_name -> vega.Proposal
	176, // 111: vega.snapshot.v1.StakingAccount.events:type_name -> vega.events.v1.StakeLinking
	46,  // 112: vega.snapshot.v1.StakingAccounts.accounts:type_name -> vega.snapshot.v1.StakingAccount
	177, // 113: vega.snapshot.v1.StakingAccounts.pending_stake_total_supply:type_name -> vega.StakeTotalSupply
	178, // 114: vega.snapshot.v1.MatchingBook.buy:type_name -> vega.Order
	178, // 115: vega.snapshot.v1.MatchingBook.sell:type_name -> vega.Order
	179, // 116: vega.snapshot.v1.NetParams.params:type_name -> vega.NetworkParameter
	180, // 117: vega.snapshot.v1.PriceBound.trigger:type_name -> vega.PriceMonitoringTrigger
	...
	181, // 126: vega.snapshot.v1.AuctionState.mode:type_name -> vega.Market.TradingMode
	181, // 127: vega.snapshot.v1.AuctionState.default_mode:type_name -> vega.Market.TradingMode
	182, // 128: vega.snapshot.v1.AuctionState.trigger:type_name -> vega.AuctionTrigger
	183, // 129: vega.snapshot.v1.AuctionState.end:type_name -> vega.AuctionDuration
	182, // 130: vega.snapshot.v1.AuctionState.extension:type_name -> vega.AuctionTrigger
	60,  // 131: vega.snapshot.v1.EquityShare.lps:type_name -> vega.snapshot.v1.EquityShareLP
	184, // 132: vega.snapshot.v1.SpotMarket.market:type_name -> vega.Market
	...
	178, // 136: vega.snapshot.v1.SpotMarket.expiring_orders:type_name -> vega.Order
	...
	178, // 140: vega.snapshot.v1.SpotMarket.expiring_stop_orders:type_name -> vega.Order
	184, // 141: vega.snapshot.v1.Market.market:type_name -> vega.Market
	...
	178, // 145: vega.snapshot.v1.Market.expiring_orders:type_name -> vega.Order
	...
	178, // 149: vega.snapshot.v1.Market.expiring_stop_orders:type_name -> vega.Order
	...
	185, // 159: vega.snapshot.v1.StopOrders.stop_orders:type_name -> vega.events.v1.StopOrderEvent
	...
	178, // 162: vega.snapshot.v1.PeggedOrders.parked_orders:type_name -> vega.Order
	...
	186, // 165: vega.snapshot.v1.ExecutionMarkets.settled_markets:type_name -> vega.checkpoint.v1.MarketState
	...
	80,  // 168: vega.snapshot.v1.SettlementState.last_settled_positions:type_name -> vega.snapshot.v1.LastSettledPosition
	81,  // 169: vega.snapshot.v1.SettlementState.trades:type_name -> vega.snapshot.v1.SettlementTrade
	85,  // 170: vega.snapshot.v1.RewardsPendingPayouts.scheduled_rewards_payout:type_name -> vega.snapshot.v1.ScheduledRewardsPayout
	86,  // 171: vega.snapshot.v1.ScheduledRewardsPayout.rewards_payout:type_name -> vega.snapshot.v1.RewardsPayout
	87,  // 172: vega.snapshot.v1.RewardsPayout.reward_party_amount:type_name -> vega.snapshot.v1.RewardsPartyAmount
	90,  // 173: vega.snapshot.v1.VoteSpamPolicy.party_to_vote:type_name -> vega.snapshot.v1.PartyProposalVoteCount
	136, // 174: vega.snapshot.v1.VoteSpamPolicy.banned_parties:type_name -> vega.snapshot.v1.BannedParty
	91,  // 175: vega.snapshot.v1.VoteSpamPolicy.token_balance:type_name -> vega.snapshot.v1.PartyTokenBalance
	92,  // 176: vega.snapshot.v1.VoteSpamPolicy.recent_blocks_reject_stats:type_name -> vega.snapshot.v1.BlockRejectStats
	93,  // 177: vega.snapshot.v1.SimpleSpamPolicy.party_to_count:type_name -> vega.snapshot.v1.SpamPartyTransactionCount
	136, // 178: vega.snapshot.v1.SimpleSpamPolicy.banned_parties:type_name -> vega.snapshot.v1.BannedParty
	91,  // 179: vega.snapshot.v1.SimpleSpamPolicy.token_balance:type_name -> vega.snapshot.v1.PartyTokenBalance
	95,  // 180: vega.snapshot.v1.Notary.notary_sigs:type_name -> vega.snapshot.v1.NotarySigs
	99,  // 181: vega.snapshot.v1.StakeVerifierDeposited.pending_deposited:type_name -> vega.snapshot.v1.StakeVerifierPending
	99,  // 182: vega.snapshot.v1.StakeVerifierRemoved.pending_removed:type_name -> vega.snapshot.v1.StakeVerifierPending
	102, // 183: vega.snapshot.v1.EthContractCallResults.pending_contract_call_result:type_name -> vega.snapshot.v1.EthContractCallResult
	109, // 184: vega.snapshot.v1.Topology.validator_data:type_name -> vega.snapshot.v1.ValidatorState
	103, // 185: vega.snapshot.v1.Topology.pending_pub_key_rotations:type_name -> vega.snapshot.v1.PendingKeyRotation
	112, // 186: vega.snapshot.v1.Topology.validator_performance:type_name -> vega.snapshot.v1.ValidatorPerformance
	104, // 187: vega.snapshot.v1.Topology.pending_ethereum_key_rotations:type_name -> vega.snapshot.v1.PendingEthereumKeyRotation
	106, // 188: vega.snapshot.v1.Topology.signatures:type_name -> vega.snapshot.v1.ToplogySignatures
	104, // 189: vega.snapshot.v1.Topology.unsolved_ethereum_key_rotations:type_name -> vega.snapshot.v1.PendingEthereumKeyRotation
	107, // 190: vega.snapshot.v1.ToplogySignatures.pending_signatures:type_name -> vega.snapshot.v1.PendingERC20MultisigControlSignature
	108, // 191: vega.snapshot.v1.ToplogySignatures.issued_signatures:type_name -> vega.snapshot.v1.IssuedERC20MultisigControlSignature
	187, // 192: vega.snapshot.v1.ValidatorState.validator_update:type_name -> vega.events.v1.ValidatorUpdate
	110, // 193: vega.snapshot.v1.ValidatorState.heartbeat_tracker:type_name -> vega.snapshot.v1.HeartbeatTracker
	188, // 194: vega.snapshot.v1.ValidatorState.ranking_score:type_name -> vega.RankingScore
	111, // 195: vega.snapshot.v1.ValidatorPerformance.validator_perf_stats:type_name -> vega.snapshot.v1.PerformanceStats
	116, // 196: vega.snapshot.v1.LiquidityPartiesLiquidityOrders.party_orders:type_name -> vega.snapshot.v1.PartyOrders
	178, // 197: vega.snapshot.v1.PartyOrders.orders:type_name -> vega.Order
	116, // 198: vega.snapshot.v1.LiquidityPartiesOrders.party_orders:type_name -> vega.snapshot.v1.PartyOrders
	189, // 199: vega.snapshot.v1.LiquidityProvisions.liquidity_provisions:type_name -> vega.LiquidityProvision
	120, // 200: vega.snapshot.v1.LiquidityScores.scores:type_name -> vega.snapshot.v1.LiquidityScore
	189, // 201: vega.snapshot.v1.LiquidityV2Provisions.liquidity_provisions:type_name -> vega.LiquidityProvision
	189, // 202: vega.snapshot.v1.LiquidityV2PendingProvisions.pending_liquidity_provisions:type_name -> vega.LiquidityProvision
	124, // 203: vega.snapshot.v1.LiquidityV2Performances.performance_per_party:type_name -> vega.snapshot.v1.LiquidityV2PerformancePerParty
	120, // 204: vega.snapshot.v1.LiquidityV2Scores.scores:type_name -> vega.snapshot.v1.LiquidityScore
	12,  // 205: vega.snapshot.v1.LiquidityV2Supplied.bid_cache:type_name -> vega.snapshot.v1.LiquidityOffsetProbabilityPair
	12,  // 206: vega.snapshot.v1.LiquidityV2Supplied.ask_cache:type_name -> vega.snapshot.v1.LiquidityOffsetProbabilityPair
	130, // 207: vega.snapshot.v1.FloatingPointConsensus.next_time_trigger:type_name -> vega.snapshot.v1.NextTimeTrigger
	128, // 208: vega.snapshot.v1.FloatingPointConsensus.state_variables:type_name -> vega.snapshot.v1.StateVarInternalState
	129, // 209: vega.snapshot.v1.StateVarInternalState.validators_results:type_name -> vega.snapshot.v1.FloatingPointValidatorResult
	190, // 210: vega.snapshot.v1.FloatingPointValidatorResult.bundle:type_name -> vega.KeyValueBundle
	191, // 211: vega.snapshot.v1.MarketTracker.market_activity:type_name -> vega.checkpoint.v1.MarketActivityTracker
	192, // 212: vega.snapshot.v1.MarketTracker.taker_notional_volume:type_name -> vega.checkpoint.v1.TakerNotionalVolume
	193, // 213: vega.snapshot.v1.SignerEventsPerAddress.events:type_name -> vega.events.v1.ERC20MultiSigSignerEvent
	132, // 214: vega.snapshot.v1.ERC20MultiSigTopologyVerified.events_per_address:type_name -> vega.snapshot.v1.SignerEventsPerAddress
	194, // 215: vega.snapshot.v1.ERC20MultiSigTopologyVerified.threshold:type_name -> vega.events.v1.ERC20MultiSigThresholdSetEvent
	193, // 216: vega.snapshot.v1.ERC20MultiSigTopologyPending.pending_signers:type_name -> vega.events.v1.ERC20MultiSigSignerEvent
	194, // 217: vega.snapshot.v1.ERC20MultiSigTopologyPending.pending_threshold_set:type_name -> vega.events.v1.ERC20MultiSigThresholdSetEvent
	141, // 218: vega.snapshot.v1.ProofOfWork.tx_at_height:type_name -> vega.snapshot.v1.TransactionsAtHeight
	141, // 219: vega.snapshot.v1.ProofOfWork.tid_at_height:type_name -> vega.snapshot.v1.TransactionsAtHeight
	136, // 220: vega.snapshot.v1.ProofOfWork.banned:type_name -> vega.snapshot.v1.BannedParty
	137, // 221: vega.snapshot.v1.ProofOfWork.pow_params:type_name -> vega.snapshot.v1.ProofOfWorkParams
	138, // 222: vega.snapshot.v1.ProofOfWork.pow_state:type_name -> vega.snapshot.v1.ProofOfWorkState
	139, // 223: vega.snapshot.v1.ProofOfWorkState.pow_state:type_name -> vega.snapshot.v1.ProofOfWorkBlockState
	140, // 224: vega.snapshot.v1.ProofOfWorkBlockState.party_state:type_name -> vega.snapshot.v1.ProofOfWorkPartyStateForBlock
	195, // 225: vega.snapshot.v1.ProtocolUpgradeProposals.active_proposals:type_name -> vega.events.v1.ProtocolUpgradeEvent
	143, // 226: vega.snapshot.v1.ProtocolUpgradeProposals.accepted_proposal:type_name -> vega.snapshot.v1.AcceptedProtocolUpgradeProposal
	145, // 227: vega.snapshot.v1.Teams.teams:type_name -> vega.snapshot.v1.Team
	146, // 228: vega.snapshot.v1.Team.referrer:type_name -> vega.snapshot.v1.Membership
	146, // 229: vega.snapshot.v1.Team.referees:type_name -> vega.snapshot.v1.Membership
	148, // 230: vega.snapshot.v1.TeamSwitches.team_switches:type_name -> vega.snapshot.v1.TeamSwitch
	150, // 231: vega.snapshot.v1.Vesting.parties_reward:type_name -> vega.snapshot.v1.PartyReward
	156, // 232: vega.snapshot.v1.PartyReward.asset_locked:type_name -> vega.snapshot.v1.AssetLocked
	158, // 233: vega.snapshot.v1.PartyReward.in_vesting:type_name -> vega.snapshot.v1.InVesting
	196, // 234: vega.snapshot.v1.CurrentReferralProgram.referral_program:type_name -> vega.ReferralProgram
	196, // 235: vega.snapshot.v1.NewReferralProgram.referral_program:type_name -> vega.ReferralProgram
	154, // 236: vega.snapshot.v1.ReferralSets.sets:type_name -> vega.snapshot.v1.ReferralSet
	146, // 237: vega.snapshot.v1.ReferralSet.referrer:type_name -> vega.snapshot.v1.Membership
	146, // 238: vega.snapshot.v1.ReferralSet.referees:type_name -> vega.snapshot.v1.Membership
	155, // 239: vega.snapshot.v1.ReferralSet.running_volumes:type_name -> vega.snapshot.v1.RunningVolume
	157, // 240: vega.snapshot.v1.AssetLocked.epoch_balances:type_name -> vega.snapshot.v1.EpochBalance
	160, // 241: vega.snapshot.v1.ActivityStreak.parties_activity_streak:type_name -> vega.snapshot.v1.PartyActivityStreak
