...
var file_vega_snapshot_v1_snapshot_proto_rawDesc = []byte{
	...
	0x74, 0x45, 0x70, 0x6f, 0x63, 0x68, 0x53, 0x65, 0x71, 0x22, 0x56, 0x0a, 0x0a, 0x4e, 0x6f, 0x74,
	...
	0x18, 0x08, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x22, 0x9b, 0x01, 0x0a, 0x12, 0x50,
	...
	0x6f, 0x6e, 0x73, 0x22, 0xa7, 0x01, 0x0a, 0x11, 0x54, 0x6f, 0x70, 0x6c, 0x6f, 0x67, 0x79, 0x53,
	...
	0x12, 0x2b, 0x0a, 0x11, 0x69, 0x73, 0x73, 0x75, 0x65, 0x64, 0x5f, 0x73, 0x69, 0x67, 0x6e, 0x61,
	0x74, 0x75, 0x72, 0x65, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x09, 0x52, 0x10, 0x69, 0x73, 0x73,
	...
	0x64, 0x65, 0x64, 0x22, 0xf2, 0x03, 0x0a, 0x0e, 0x56, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x6f,
...
var file_vega_snapshot_v1_snapshot_proto_msgTypes = make([]protoimpl.MessageInfo, 115)
var file_vega_snapshot_v1_snapshot_proto_goTypes = []interface{}{
	...
	(*BannedParty)(nil),                          // 108: vega.snapshot.v1.BannedParty
	(*ProofOfWorkParams)(nil),                    // 109: vega.snapshot.v1.ProofOfWorkParams
	(*ProofOfWorkState)(nil),                     // 110: vega.snapshot.v1.ProofOfWorkState
	(*ProofOfWorkBlockState)(nil),                // 111: vega.snapshot.v1.ProofOfWorkBlockState
	(*ProofOfWorkPartyStateForBlock)(nil),        // 112: vega.snapshot.v1.ProofOfWorkPartyStateForBlock
	(*TransactionsAtHeight)(nil),                 // 113: vega.snapshot.v1.TransactionsAtHeight
	(*ProtocolUpgradeProposals)(nil),             // 114: vega.snapshot.v1.ProtocolUpgradeProposals
	(*AcceptedProtocolUpgradeProposal)(nil),      // 115: vega.snapshot.v1.AcceptedProtocolUpgradeProposal
	(*v1.Signer)(nil),                            // 116: vega.data.v1.Signer
	...
	(*vega.BuiltinAssetDeposit)(nil),             // 121: vega.BuiltinAssetDeposit
	(*vega.ERC20Deposit)(nil),                    // 122: vega.ERC20Deposit
	(*vega.ERC20AssetList)(nil),                  // 123: vega.ERC20AssetList
	(*vega.ERC20AssetLimitsUpdated)(nil),         // 124: vega.ERC20AssetLimitsUpdated
	(*v11.RecurringTransfers)(nil),               // 125: vega.checkpoint.v1.RecurringTransfers
	(*v11.ScheduledTransferAtTime)(nil),          // 126: vega.checkpoint.v1.ScheduledTransferAtTime
	(*v11.BridgeState)(nil),                      // 127: vega.checkpoint.v1.BridgeState
	(*vega.Delegation)(nil),                      // 128: vega.Delegation
	(*vega.Proposal)(nil),                        // 129: vega.Proposal
	(*vega.Vote)(nil),                            // 130: vega.Vote
	(*v12.StakeLinking)(nil),                     // 131: vega.events.v1.StakeLinking
	(*vega.Order)(nil),                           // 132: vega.Order
	(*vega.NetworkParameter)(nil),                // 133: vega.NetworkParameter
	(*vega.PriceMonitoringTrigger)(nil),          // 134: vega.PriceMonitoringTrigger
	(vega.Market_TradingMode)(0),                 // 135: vega.Market.TradingMode
	(vega.AuctionTrigger)(0),                     // 136: vega.AuctionTrigger
	(*vega.AuctionDuration)(nil),                 // 137: vega.AuctionDuration
	(*vega.Market)(nil),                          // 138: vega.Market
	(*v12.ValidatorUpdate)(nil),                  // 139: vega.events.v1.ValidatorUpdate
	(*vega.RankingScore)(nil),                    // 140: vega.RankingScore
	(*vega.LiquidityProvision)(nil),              // 141: vega.LiquidityProvision
	(*vega.KeyValueBundle)(nil),                  // 142: vega.KeyValueBundle
	(*v11.MarketActivityTracker)(nil),            // 143: vega.checkpoint.v1.MarketActivityTracker
	(*v12.ERC20MultiSigSignerEvent)(nil),         // 144: vega.events.v1.ERC20MultiSigSignerEvent
	(*v12.ERC20MultiSigThresholdSetEvent)(nil),   // 145: vega.events.v1.ERC20MultiSigThresholdSetEvent
	(*v12.ProtocolUpgradeEvent)(nil),             // 146: vega.events.v1.ProtocolUpgradeEvent
}
var file_vega_snapshot_v1_snapshot_proto_depIdxs = []int32{
	...
	114, // 52: vega.snapshot.v1.Payload.protocol_upgrade_proposals:type_name -> vega.snapshot.v1.ProtocolUpgradeProposals
	...
	116, // 60: vega.snapshot.v1.OracleData.signers:type_name -> vega.data.v1.Signer
	...
	117, // 63: vega.snapshot.v1.CollateralAccounts.accounts:type_name -> vega.Account
	118, // 64: vega.snapshot.v1.CollateralAssets.assets:type_name -> vega.Asset
	118, // 65: vega.snapshot.v1.ActiveAssets.assets:type_name -> vega.Asset
	118, // 66: vega.snapshot.v1.PendingAssets.assets:type_name -> vega.Asset
	118, // 67: vega.snapshot.v1.PendingAssetUpdates.assets:type_name -> vega.Asset
	119, // 68: vega.snapshot.v1.Withdrawal.withdrawal:type_name -> vega.Withdrawal
	120, // 69: vega.snapshot.v1.Deposit.deposit:type_name -> vega.Deposit
	121, // 70: vega.snapshot.v1.AssetAction.builtin_deposit:type_name -> vega.BuiltinAssetDeposit
	122, // 71: vega.snapshot.v1.AssetAction.erc20_deposit:type_name -> vega.ERC20Deposit
	123, // 72: vega.snapshot.v1.AssetAction.asset_list:type_name -> vega.ERC20AssetList
	124, // 73: vega.snapshot.v1.AssetAction.erc20_asset_limits_updated:type_name -> vega.ERC20AssetLimitsUpdated
	...
	125, // 77: vega.snapshot.v1.BankingRecurringTransfers.recurring_transfers:type_name -> vega.checkpoint.v1.RecurringTransfers
	126, // 78: vega.snapshot.v1.BankingScheduledTransfers.transfers_at_time:type_name -> vega.checkpoint.v1.ScheduledTransferAtTime
	127, // 79: vega.snapshot.v1.BankingBridgeState.bridge_state:type_name -> vega.checkpoint.v1.BridgeState
	128, // 80: vega.snapshot.v1.DelegationActive.delegations:type_name -> vega.Delegation
	128, // 81: vega.snapshot.v1.DelegationPending.delegations:type_name -> vega.Delegation
	128, // 82: vega.snapshot.v1.DelegationPending.undelegation:type_name -> vega.Delegation
	129, // 83: vega.snapshot.v1.ProposalData.proposal:type_name -> vega.Proposal
	130, // 84: vega.snapshot.v1.ProposalData.yes:type_name -> vega.Vote
	130, // 85: vega.snapshot.v1.ProposalData.no:type_name -> vega.Vote
	130, // 86: vega.snapshot.v1.ProposalData.invalid:type_name -> vega.Vote
	...
	129, // 89: vega.snapshot.v1.GovernanceNode.proposals:type_name -> vega.Proposal
	131, // 90: vega.snapshot.v1.StakingAccount.events:type_name -> vega.events.v1.StakeLinking
	41,  // 91: vega.snapshot.v1.StakingAccounts.accounts:type_name -> vega.snapshot.v1.StakingAccount
	132, // 92: vega.snapshot.v1.MatchingBook.buy:type_name -> vega.Order
	132, // 93: vega.snapshot.v1.MatchingBook.sell:type_name -> vega.Order
	133, // 94: vega.snapshot.v1.NetParams.params:type_name -> vega.NetworkParameter
	134, // 95: vega.snapshot.v1.PriceBound.trigger:type_name -> vega.PriceMonitoringTrigger
	...
	135, // 104: vega.snapshot.v1.AuctionState.mode:type_name -> vega.Market.TradingMode
	135, // 105: vega.snapshot.v1.AuctionState.default_mode:type_name -> vega.Market.TradingMode
	136, // 106: vega.snapshot.v1.AuctionState.trigger:type_name -> vega.AuctionTrigger
	137, // 107: vega.snapshot.v1.AuctionState.end:type_name -> vega.AuctionDuration
	136, // 108: vega.snapshot.v1.AuctionState.extension:type_name -> vega.AuctionTrigger
	55,  // 109: vega.snapshot.v1.EquityShare.lps:type_name -> vega.snapshot.v1.EquityShareLP
	138, // 110: vega.snapshot.v1.Market.market:type_name -> vega.Market
	...
	132, // 114: vega.snapshot.v1.Market.expiring_orders:type_name -> vega.Order
	...
	132, // 117: vega.snapshot.v1.PeggedOrders.parked_orders:type_name -> vega.Order
	...
	108, // 126: vega.snapshot.v1.VoteSpamPolicy.banned_parties:type_name -> vega.snapshot.v1.BannedParty
	...
	108, // 130: vega.snapshot.v1.SimpleSpamPolicy.banned_parties:type_name -> vega.snapshot.v1.BannedParty
	...
	139, // 142: vega.snapshot.v1.ValidatorState.validator_update:type_name -> vega.events.v1.ValidatorUpdate
	90,  // 143: vega.snapshot.v1.ValidatorState.heartbeat_tracker:type_name -> vega.snapshot.v1.HeartbeatTracker
	140, // 144: vega.snapshot.v1.ValidatorState.ranking_score:type_name -> vega.RankingScore
	...
	132, // 147: vega.snapshot.v1.PartyOrders.orders:type_name -> vega.Order
	96,  // 148: vega.snapshot.v1.LiquidityPartiesOrders.party_orders:type_name -> vega.snapshot.v1.PartyOrders
	141, // 149: vega.snapshot.v1.LiquidityProvisions.liquidity_provisions:type_name -> vega.LiquidityProvision
	...
	142, // 153: vega.snapshot.v1.FloatingPointValidatorResult.bundle:type_name -> vega.KeyValueBundle
	143, // 154: vega.snapshot.v1.MarketTracker.market_activity:type_name -> vega.checkpoint.v1.MarketActivityTracker
	144, // 155: vega.snapshot.v1.SignerEventsPerAddress.events:type_name -> vega.events.v1.ERC20MultiSigSignerEvent
	...
	145, // 157: vega.snapshot.v1.ERC20MultiSigTopologyVerified.threshold:type_name -> vega.events.v1.ERC20MultiSigThresholdSetEvent
	144, // 158: vega.snapshot.v1.ERC20MultiSigTopologyPending.pending_signers:type_name -> vega.events.v1.ERC20MultiSigSignerEvent
	145, // 159: vega.snapshot.v1.ERC20MultiSigTopologyPending.pending_threshold_set:type_name -> vega.events.v1.ERC20MultiSigThresholdSetEvent
	113, // 160: vega.snapshot.v1.ProofOfWork.tx_at_height:type_name -> vega.snapshot.v1.TransactionsAtHeight
	113, // 161: vega.snapshot.v1.ProofOfWork.tid_at_height:type_name -> vega.snapshot.v1.TransactionsAtHeight
	108, // 162: vega.snapshot.v1.ProofOfWork.banned:type_name -> vega.snapshot.v1.BannedParty
	109, // 163: vega.snapshot.v1.ProofOfWork.pow_params:type_name -> vega.snapshot.v1.ProofOfWorkParams
	110, // 164: vega.snapshot.v1.ProofOfWork.pow_state:type_name -> vega.snapshot.v1.ProofOfWorkState
	111, // 165: vega.snapshot.v1.ProofOfWorkState.pow_state:type_name -> vega.snapshot.v1.ProofOfWorkBlockState
	112, // 166: vega.snapshot.v1.ProofOfWorkBlockState.party_state:type_name -> vega.snapshot.v1.ProofOfWorkPartyStateForBlock
	146, // 167: vega.snapshot.v1.ProtocolUpgradeProposals.active_proposals:type_name -> vega.events.v1.ProtocolUpgradeEvent
	115, // 168: vega.snapshot.v1.ProtocolUpgradeProposals.accepted_proposal:type_name -> vega.snapshot.v1.AcceptedProtocolUpgradeProposal
