...
func (x *OracleData) Reset() {
	*x = OracleData{}
	if protoimpl.UnsafeEnabled {
		mi := &file_vega_data_v1_data_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*OracleData) Descriptor() ([]byte, []int) {
	return file_vega_data_v1_data_proto_rawDescGZIP(), []int{6}
}

func (x *OracleData) GetExternalData() *ExternalData {
	if x != nil {
...
var file_vega_data_v1_data_proto_rawDesc = []byte{
	...
	0x2e, 0x76, 0x31, 0x2e, 0x44, 0x61, 0x74, 0x61, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0x4d,
	0x0a, 0x0a, 0x4f, 0x72, 0x61, 0x63, 0x6c, 0x65, 0x44, 0x61, 0x74, 0x61, 0x12, 0x3f, 0x0a, 0x0d,
	0x65, 0x78, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x5f, 0x64, 0x61, 0x74, 0x61, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x76, 0x65, 0x67, 0x61, 0x2e, 0x64, 0x61, 0x74, 0x61, 0x2e,
	0x76, 0x31, 0x2e, 0x45, 0x78, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x44, 0x61, 0x74, 0x61, 0x52,
	0x0c, 0x65, 0x78, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x44, 0x61, 0x74, 0x61, 0x42, 0x2f, 0x5a,
...
var file_vega_data_v1_data_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_vega_data_v1_data_proto_goTypes = []interface{}{
	...
	(*OracleData)(nil),   // 6: vega.data.v1.OracleData
}
var file_vega_data_v1_data_proto_depIdxs = []int32{
	...
	5, // 5: vega.data.v1.OracleData.external_data:type_name -> vega.data.v1.ExternalData
...
func file_vega_data_v1_data_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_vega_data_v1_data_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
