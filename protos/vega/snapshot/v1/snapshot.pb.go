...
var file_vega_snapshot_v1_snapshot_proto_rawDesc = []byte{
	...
	0x64, 0x65, 0x72, 0x73, 0x22, 0xd1, 0x01, 0x0a, 0x10, 0x45, 0x78, 0x65, 0x63, 0x75, 0x74, 0x69,
	...
	0x64, 0x4d, 0x61, 0x72, 0x6b, 0x65, 0x74, 0x73, 0x22, 0xe7, 0x01, 0x0a, 0x08, 0x50, 0x6f, 0x73,
	...
	0x02, 0x69, 0x64, 0x22, 0x82, 0x01, 0x0a, 0x16, 0x45, 0x74, 0x68, 0x43, 0x6f, 0x6e, 0x74, 0x72,
	...
	0x6c, 0x6c, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x22, 0x8a, 0x01, 0x0a, 0x15, 0x45, 0x74, 0x68,
	...
	0x65, 0x73, 0x75, 0x6c, 0x74, 0x22, 0x9b, 0x01, 0x0a, 0x12, 0x50, 0x65, 0x6e, 0x64, 0x69, 0x6e,
	...
	0x52, 0x07, 0x70, 0x61, 0x72, 0x74, 0x79, 0x49, 0x64, 0x22, 0xb9, 0x01, 0x0a, 0x16, 0x46, 0x6c,
	...
	0x72, 0x69, 0x67, 0x67, 0x65, 0x72, 0x22, 0x63, 0x0a, 0x0d, 0x4d, 0x61, 0x72, 0x6b, 0x65, 0x74,
	...
	0x6b, 0x65, 0x74, 0x41, 0x63, 0x74, 0x69, 0x76, 0x69, 0x74, 0x79, 0x22, 0x74, 0x0a, 0x16, 0x53,
	...
	0x65, 0x74, 0x73, 0x22, 0xa1, 0x03, 0x0a, 0x0b, 0x50, 0x72, 0x6f, 0x6f, 0x66, 0x4f, 0x66, 0x57,
	...
	0x6f, 0x77, 0x53, 0x74, 0x61, 0x74, 0x65, 0x22, 0x39, 0x0a, 0x0b, 0x42, 0x61, 0x6e, 0x6e, 0x65,
...
var file_vega_snapshot_v1_snapshot_proto_depIdxs = []int32{
	...
	132, // 70: vega.snapshot.v1.CollateralAccounts.accounts:type_name -> vega.Account
	133, // 71: vega.snapshot.v1.CollateralAssets.assets:type_name -> vega.Asset
	133, // 72: vega.snapshot.v1.ActiveAssets.assets:type_name -> vega.Asset
	133, // 73: vega.snapshot.v1.PendingAssets.assets:type_name -> vega.Asset
	133, // 74: vega.snapshot.v1.PendingAssetUpdates.assets:type_name -> vega.Asset
	134, // 75: vega.snapshot.v1.Withdrawal.withdrawal:type_name -> vega.Withdrawal
	135, // 76: vega.snapshot.v1.Deposit.deposit:type_name -> vega.Deposit
	...
	136, // 79: vega.snapshot.v1.BankingAssetActions.asset_action:type_name -> vega.checkpoint.v1.AssetAction
	137, // 80: vega.snapshot.v1.BankingRecurringTransfers.recurring_transfers:type_name -> vega.checkpoint.v1.RecurringTransfers
	138, // 81: vega.snapshot.v1.BankingScheduledTransfers.transfers_at_time:type_name -> vega.checkpoint.v1.ScheduledTransferAtTime
	139, // 82: vega.snapshot.v1.BankingRecurringGovernanceTransfers.recurring_transfers:type_name -> vega.checkpoint.v1.GovernanceTransfer
	140, // 83: vega.snapshot.v1.BankingScheduledGovernanceTransfers.transfers_at_time:type_name -> vega.checkpoint.v1.ScheduledGovernanceTransferAtTime
	141, // 84: vega.snapshot.v1.BankingBridgeState.bridge_state:type_name -> vega.checkpoint.v1.BridgeState
	142, // 85: vega.snapshot.v1.DelegationActive.delegations:type_name -> vega.Delegation
	142, // 86: vega.snapshot.v1.DelegationPending.delegations:type_name -> vega.Delegation
	142, // 87: vega.snapshot.v1.DelegationPending.undelegation:type_name -> vega.Delegation
	143, // 88: vega.snapshot.v1.ProposalData.proposal:type_name -> vega.Proposal
	144, // 89: vega.snapshot.v1.ProposalData.yes:type_name -> vega.Vote
	144, // 90: vega.snapshot.v1.ProposalData.no:type_name -> vega.Vote
	144, // 91: vega.snapshot.v1.ProposalData.invalid:type_name -> vega.Vote
	...
	143, // 94: vega.snapshot.v1.GovernanceNode.proposals:type_name -> vega.Proposal
	145, // 95: vega.snapshot.v1.StakingAccount.events:type_name -> vega.events.v1.StakeLinking
	44,  // 96: vega.snapshot.v1.StakingAccounts.accounts:type_name -> vega.snapshot.v1.StakingAccount
	146, // 97: vega.snapshot.v1.StakingAccounts.pending_stake_total_supply:type_name -> vega.StakeTotalSupply
	147, // 98: vega.snapshot.v1.MatchingBook.buy:type_name -> vega.Order
	147, // 99: vega.snapshot.v1.MatchingBook.sell:type_name -> vega.Order
	148, // 100: vega.snapshot.v1.NetParams.params:type_name -> vega.NetworkParameter
	149, // 101: vega.snapshot.v1.PriceBound.trigger:type_name -> vega.PriceMonitoringTrigger
	...
	150, // 110: vega.snapshot.v1.AuctionState.mode:type_name -> vega.Market.TradingMode
	150, // 111: vega.snapshot.v1.AuctionState.default_mode:type_name -> vega.Market.TradingMode
	151, // 112: vega.snapshot.v1.AuctionState.trigger:type_name -> vega.AuctionTrigger
	152, // 113: vega.snapshot.v1.AuctionState.end:type_name -> vega.AuctionDuration
	151, // 114: vega.snapshot.v1.AuctionState.extension:type_name -> vega.AuctionTrigger
	58,  // 115: vega.snapshot.v1.EquityShare.lps:type_name -> vega.snapshot.v1.EquityShareLP
	153, // 116: vega.snapshot.v1.SpotMarket.market:type_name -> vega.Market
	...
	147, // 120: vega.snapshot.v1.SpotMarket.expiring_orders:type_name -> vega.Order
	...
	153, // 123: vega.snapshot.v1.Market.market:type_name -> vega.Market
	...
	147, // 127: vega.snapshot.v1.Market.expiring_orders:type_name -> vega.Order
	...
	147, // 131: vega.snapshot.v1.Market.expiring_stop_orders:type_name -> vega.Order
	...
	154, // 137: vega.snapshot.v1.StopOrders.stop_orders:type_name -> vega.events.v1.StopOrderEvent
	...
	147, // 140: vega.snapshot.v1.PeggedOrders.parked_orders:type_name -> vega.Order
	...
	155, // 143: vega.snapshot.v1.ExecutionMarkets.settled_markets:type_name -> vega.checkpoint.v1.MarketState
	71,  // 144: vega.snapshot.v1.MarketPositions.positions:type_name -> vega.snapshot.v1.Position
	74,  // 145: vega.snapshot.v1.SettlementState.last_settled_positions:type_name -> vega.snapshot.v1.LastSettledPosition
	75,  // 146: vega.snapshot.v1.SettlementState.trades:type_name -> vega.snapshot.v1.SettlementTrade
	79,  // 147: vega.snapshot.v1.RewardsPendingPayouts.scheduled_rewards_payout:type_name -> vega.snapshot.v1.ScheduledRewardsPayout
	80,  // 148: vega.snapshot.v1.ScheduledRewardsPayout.rewards_payout:type_name -> vega.snapshot.v1.RewardsPayout
	81,  // 149: vega.snapshot.v1.RewardsPayout.reward_party_amount:type_name -> vega.snapshot.v1.RewardsPartyAmount
	84,  // 150: vega.snapshot.v1.VoteSpamPolicy.party_to_vote:type_name -> vega.snapshot.v1.PartyProposalVoteCount
	123, // 151: vega.snapshot.v1.VoteSpamPolicy.banned_parties:type_name -> vega.snapshot.v1.BannedParty
	85,  // 152: vega.snapshot.v1.VoteSpamPolicy.token_balance:type_name -> vega.snapshot.v1.PartyTokenBalance
	86,  // 153: vega.snapshot.v1.VoteSpamPolicy.recent_blocks_reject_stats:type_name -> vega.snapshot.v1.BlockRejectStats
	87,  // 154: vega.snapshot.v1.SimpleSpamPolicy.party_to_count:type_name -> vega.snapshot.v1.SpamPartyTransactionCount
	123, // 155: vega.snapshot.v1.SimpleSpamPolicy.banned_parties:type_name -> vega.snapshot.v1.BannedParty
	85,  // 156: vega.snapshot.v1.SimpleSpamPolicy.token_balance:type_name -> vega.snapshot.v1.PartyTokenBalance
	89,  // 157: vega.snapshot.v1.Notary.notary_sigs:type_name -> vega.snapshot.v1.NotarySigs
	93,  // 158: vega.snapshot.v1.StakeVerifierDeposited.pending_deposited:type_name -> vega.snapshot.v1.StakeVerifierPending
	93,  // 159: vega.snapshot.v1.StakeVerifierRemoved.pending_removed:type_name -> vega.snapshot.v1.StakeVerifierPending
	95,  // 160: vega.snapshot.v1.EthContractCallResults.pending_contract_call_result:type_name -> vega.snapshot.v1.EthContractCallResult
