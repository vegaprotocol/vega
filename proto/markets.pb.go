...
type Market_Mode int32

const (
	// Default value, this is invalid
	Market_MODE_UNSPECIFIED Market_Mode = 0
	// Normal trading
	Market_MODE_CONTINUOUS Market_Mode = 1
	// Auction trading (FBA)
	Market_MODE_BATCH_AUCTION Market_Mode = 2
	// Opening auction
	Market_MODE_OPENING_AUCTION Market_Mode = 3
	// Auction triggered by monitoring
	Market_MODE_MONITORING_AUCTION Market_Mode = 4
)

var Market_Mode_name = map[int32]string{
	0: "MODE_UNSPECIFIED",
	1: "MODE_CONTINUOUS",
	2: "MODE_BATCH_AUCTION",
	3: "MODE_OPENING_AUCTION",
	4: "MODE_MONITORING_AUCTION",
}

var Market_Mode_value = map[string]int32{
	"MODE_UNSPECIFIED":        0,
	"MODE_CONTINUOUS":         1,
	"MODE_BATCH_AUCTION":      2,
	"MODE_OPENING_AUCTION":    3,
	"MODE_MONITORING_AUCTION": 4,
}

func (x Market_Mode) String() string {
	return proto.EnumName(Market_Mode_name, int32(x))
}

func (Market_Mode) EnumDescriptor() ([]byte, []int) {
...
func init() {
	proto.RegisterEnum("vega.Market_Mode", Market_Mode_name, Market_Mode_value)
...
var fileDescriptor_a051e0d8e40205f1 = []byte{
	...
	,
}
