...
func (e *Engine) recurringTransfer(
	...
	if err := e.ensureMinimalTransferAmount(a, transfer.Amount, transfer.FromAccountType, transfer.From, transfer.FromSubAccount); err != nil {
		transfer.Status = types.TransferStatusRejected
		return err
	}
...
func (e *Engine) distributeRecurringTransfers(ctx context.Context, newEpoch uint64) {
	...
	for _, v := range e.recurringTransfers {
		...
		if err = e.ensureMinimalTransferAmount(a, amount, v.FromAccountType, v.From, v.FromSubAccount); err != nil {
