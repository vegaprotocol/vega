...
var file_vega_vega_proto_rawDesc = []byte{
	...
	0x54, 0x55, 0x53, 0x5f, 0x50, 0x45, 0x4e, 0x44, 0x49, 0x4e, 0x47, 0x10, 0x06, 0x22, 0x91, 0x04,
	0x0a, 0x16, 0x53, 0x70, 0x6f, 0x74, 0x4c, 0x69, 0x71, 0x75, 0x69, 0x64, 0x69, 0x74, 0x79, 0x50,
	...
	,
	...
	0x73, 0x22, 0x9d, 0x01, 0x0a, 0x06, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x16, 0x0a, 0x12,
...
var file_vega_vega_proto_goTypes = []interface{}{
	...
	(*SpotLiquidityProvision)(nil),        // 60: vega.SpotLiquidityProvision
	(*EthereumConfig)(nil),                // 61: vega.EthereumConfig
	(*EthereumContractConfig)(nil),        // 62: vega.EthereumContractConfig
	(*EpochTimestamps)(nil),               // 63: vega.EpochTimestamps
	(*Epoch)(nil),                         // 64: vega.Epoch
	(*EpochParticipation)(nil),            // 65: vega.EpochParticipation
	(*EpochData)(nil),                     // 66: vega.EpochData
	(*RankingScore)(nil),                  // 67: vega.RankingScore
	(*RewardScore)(nil),                   // 68: vega.RewardScore
	(*Node)(nil),                          // 69: vega.Node
	(*NodeSet)(nil),                       // 70: vega.NodeSet
	(*NodeData)(nil),                      // 71: vega.NodeData
	(*Delegation)(nil),                    // 72: vega.Delegation
	(*Reward)(nil),                        // 73: vega.Reward
	(*RewardSummary)(nil),                 // 74: vega.RewardSummary
	(*EpochRewardSummary)(nil),            // 75: vega.EpochRewardSummary
	(*StateValueProposal)(nil),            // 76: vega.StateValueProposal
	(*KeyValueBundle)(nil),                // 77: vega.KeyValueBundle
	(*StateVarValue)(nil),                 // 78: vega.StateVarValue
	(*ScalarValue)(nil),                   // 79: vega.ScalarValue
	(*VectorValue)(nil),                   // 80: vega.VectorValue
	(*MatrixValue)(nil),                   // 81: vega.MatrixValue
	(Market_TradingMode)(0),               // 82: vega.Market.TradingMode
	(Market_State)(0),                     // 83: vega.Market.State
	(*PriceMonitoringTrigger)(nil),        // 84: vega.PriceMonitoringTrigger
}
var file_vega_vega_proto_depIdxs = []int32{
	...
	24, // 7: vega.OrderCancellationConfirmation.order:type_name -> vega.Order
	24, // 8: vega.OrderConfirmation.order:type_name -> vega.Order
	28, // 9: vega.OrderConfirmation.trades:type_name -> vega.Trade
	24, // 10: vega.OrderConfirmation.passive_orders_affected:type_name -> vega.Order
	0,  // 11: vega.Trade.aggressor:type_name -> vega.Side
	16, // 12: vega.Trade.type:type_name -> vega.Trade.Type
	29, // 13: vega.Trade.buyer_fee:type_name -> vega.Fee
	29, // 14: vega.Trade.seller_fee:type_name -> vega.Fee
	28, // 15: vega.TradeSet.trades:type_name -> vega.Trade
	1,  // 16: vega.Candle.interval:type_name -> vega.Interval
	32, // 17: vega.MarketDepth.buy:type_name -> vega.PriceLevel
	32, // 18: vega.MarketDepth.sell:type_name -> vega.PriceLevel
	32, // 19: vega.MarketDepthUpdate.buy:type_name -> vega.PriceLevel
	32, // 20: vega.MarketDepthUpdate.sell:type_name -> vega.PriceLevel
	...
	39, // 24: vega.Withdrawal.ext:type_name -> vega.WithdrawExt
	40, // 25: vega.WithdrawExt.erc20:type_name -> vega.Erc20WithdrawExt
	7,  // 26: vega.Account.type:type_name -> vega.AccountType
	42, // 27: vega.Transfer.amount:type_name -> vega.FinancialAmount
	8,  // 28: vega.Transfer.type:type_name -> vega.TransferType
	9,  // 29: vega.DispatchStrategy.metric:type_name -> vega.DispatchMetric
	41, // 30: vega.TransferRequest.from_account:type_name -> vega.Account
	41, // 31: vega.TransferRequest.to_account:type_name -> vega.Account
	8,  // 32: vega.TransferRequest.type:type_name -> vega.TransferType
	7,  // 33: vega.AccountDetails.type:type_name -> vega.AccountType
	46, // 34: vega.LedgerEntry.from_account:type_name -> vega.AccountDetails
	46, // 35: vega.LedgerEntry.to_account:type_name -> vega.AccountDetails
	8,  // 36: vega.LedgerEntry.type:type_name -> vega.TransferType
	46, // 37: vega.PostTransferBalance.account:type_name -> vega.AccountDetails
	47, // 38: vega.LedgerMovement.entries:type_name -> vega.LedgerEntry
	48, // 39: vega.LedgerMovement.balances:type_name -> vega.PostTransferBalance
	82, // 40: vega.MarketData.market_trading_mode:type_name -> vega.Market.TradingMode
	...
	53, // 43: vega.MarketData.price_monitoring_bounds:type_name -> vega.PriceMonitoringBounds
	52, // 44: vega.MarketData.liquidity_provider_fee_share:type_name -> vega.LiquidityProviderFeeShare
	83, // 45: vega.MarketData.market_state:type_name -> vega.Market.State
	84, // 46: vega.PriceMonitoringBounds.trigger:type_name -> vega.PriceMonitoringTrigger
	4,  // 47: vega.LiquidityOrder.reference:type_name -> vega.PeggedReference
	57, // 48: vega.LiquidityOrderReference.liquidity_order:type_name -> vega.LiquidityOrder
	58, // 49: vega.LiquidityProvision.sells:type_name -> vega.LiquidityOrderReference
	58, // 50: vega.LiquidityProvision.buys:type_name -> vega.LiquidityOrderReference
	19, // 51: vega.LiquidityProvision.status:type_name -> vega.LiquidityProvision.Status
	20, // 52: vega.SpotLiquidityProvision.status:type_name -> vega.SpotLiquidityProvision.Status
	62, // 53: vega.EthereumConfig.collateral_bridge_contract:type_name -> vega.EthereumContractConfig
	62, // 54: vega.EthereumConfig.staking_bridge_contract:type_name -> vega.EthereumContractConfig
	62, // 55: vega.EthereumConfig.token_vesting_contract:type_name -> vega.EthereumContractConfig
	62, // 56: vega.EthereumConfig.multisig_control_contract:type_name -> vega.EthereumContractConfig
	63, // 57: vega.Epoch.timestamps:type_name -> vega.EpochTimestamps
	69, // 58: vega.Epoch.validators:type_name -> vega.Node
	72, // 59: vega.Epoch.delegations:type_name -> vega.Delegation
	64, // 60: vega.EpochParticipation.epoch:type_name -> vega.Epoch
	...
	66, // 64: vega.Node.epoch_data:type_name -> vega.EpochData
	10, // 65: vega.Node.status:type_name -> vega.NodeStatus
	72, // 66: vega.Node.delegations:type_name -> vega.Delegation
	68, // 67: vega.Node.reward_score:type_name -> vega.RewardScore
	67, // 68: vega.Node.ranking_score:type_name -> vega.RankingScore
	70, // 69: vega.NodeData.tendermint_nodes:type_name -> vega.NodeSet
	70, // 70: vega.NodeData.ersatz_nodes:type_name -> vega.NodeSet
	70, // 71: vega.NodeData.pending_nodes:type_name -> vega.NodeSet
	77, // 72: vega.StateValueProposal.kvb:type_name -> vega.KeyValueBundle
	78, // 73: vega.KeyValueBundle.value:type_name -> vega.StateVarValue
	79, // 74: vega.StateVarValue.scalar_val:type_name -> vega.ScalarValue
	80, // 75: vega.StateVarValue.vector_val:type_name -> vega.VectorValue
	81, // 76: vega.StateVarValue.matrix_val:type_name -> vega.MatrixValue
	80, // 77: vega.MatrixValue.value:type_name -> vega.VectorValue
