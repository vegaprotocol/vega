...
var file_vega_events_v1_events_proto_rawDesc = []byte{
	...
	0x22, 0x88, 0x15, 0x0a, 0x11, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e,
	...
	0x65, 0x4d, 0x61, 0x72, 0x67, 0x69, 0x6e, 0x4d, 0x6f, 0x64, 0x65, 0x12, 0x4d, 0x0a, 0x07, 0x73,
	...
	0x64, 0x73, 0x22, 0x88, 0x02, 0x0a, 0x0b, 0x54, 0x65, 0x61, 0x6d, 0x43, 0x72, 0x65, 0x61, 0x74,
	...
	0x68, 0x42, 0x0b, 0x0a, 0x09, 0x5f, 0x74, 0x65, 0x61, 0x6d, 0x5f, 0x75, 0x72, 0x6c, 0x42, 0x0d,
	0x0a, 0x0b, 0x5f, 0x61, 0x76, 0x61, 0x74, 0x61, 0x72, 0x5f, 0x75, 0x72, 0x6c, 0x22, 0xb2, 0x01,
	...
	0x63, 0x6c, 0x6f, 0x73, 0x65, 0x64, 0x42, 0x0b, 0x0a, 0x09, 0x5f, 0x74, 0x65, 0x61, 0x6d, 0x5f,
	...
	0x65, 0x72, 0x50, 0x61, 0x72, 0x74, 0x79, 0x22, 0xe1, 0x32, 0x0a, 0x08, 0x42, 0x75, 0x73, 0x45,
	...
	0x6e, 0x73, 0x66, 0x65, 0x72, 0x46, 0x65, 0x65, 0x73, 0x12, 0x36, 0x0a, 0x06, 0x6d, 0x61, 0x72,
	...
	0x5f, 0x52, 0x45, 0x4a, 0x45, 0x43, 0x54, 0x45, 0x44, 0x10, 0x03, 0x2a, 0x99, 0x19, 0x0a, 0x0c,
	...
	0x45, 0x52, 0x5f, 0x46, 0x45, 0x45, 0x53, 0x5f, 0x50, 0x41, 0x49, 0x44, 0x10, 0x53, 0x12, 0x19,
...
var file_vega_events_v1_events_proto_goTypes = []interface{}{
	...
	(vega.EpochAction)(0),                       // 118: vega.EpochAction
	(*vega.LedgerMovement)(nil),                 // 119: vega.LedgerMovement
	(vega.AuctionTrigger)(0),                    // 120: vega.AuctionTrigger
	(*vega.ReferralProgram)(nil),                // 121: vega.ReferralProgram
	(*vega.VolumeDiscountProgram)(nil),          // 122: vega.VolumeDiscountProgram
	(*vega.Order)(nil),                          // 123: vega.Order
	(*vega.Account)(nil),                        // 124: vega.Account
	(*vega.Party)(nil),                          // 125: vega.Party
	(*vega.Trade)(nil),                          // 126: vega.Trade
	(*vega.MarginLevels)(nil),                   // 127: vega.MarginLevels
	(*vega.Proposal)(nil),                       // 128: vega.Proposal
	(*vega.Vote)(nil),                           // 129: vega.Vote
	(*vega.MarketData)(nil),                     // 130: vega.MarketData
	(*v1.NodeSignature)(nil),                    // 131: vega.commands.v1.NodeSignature
	(*vega.Market)(nil),                         // 132: vega.Market
	(*vega.Asset)(nil),                          // 133: vega.Asset
	(*vega.Withdrawal)(nil),                     // 134: vega.Withdrawal
	(*vega.Deposit)(nil),                        // 135: vega.Deposit
	(*vega.RiskFactor)(nil),                     // 136: vega.RiskFactor
	(*vega.NetworkParameter)(nil),               // 137: vega.NetworkParameter
	(*vega.LiquidityProvision)(nil),             // 138: vega.LiquidityProvision
	(*vega.OracleSpec)(nil),                     // 139: vega.OracleSpec
	(*vega.OracleData)(nil),                     // 140: vega.OracleData
	(*vega.NetworkLimits)(nil),                  // 141: vega.NetworkLimits
}
var file_vega_events_v1_events_proto_depIdxs = []int32{
	...
	87,  // 56: vega.events.v1.TransactionResult.success:type_name -> vega.events.v1.TransactionResult.SuccessDetails
	88,  // 57: vega.events.v1.TransactionResult.failure:type_name -> vega.events.v1.TransactionResult.FailureDetails
	89,  // 58: vega.events.v1.TxErrorEvent.order_submission:type_name -> vega.commands.v1.OrderSubmission
	93,  // 59: vega.events.v1.TxErrorEvent.order_amendment:type_name -> vega.commands.v1.OrderAmendment
	94,  // 60: vega.events.v1.TxErrorEvent.order_cancellation:type_name -> vega.commands.v1.OrderCancellation
	95,  // 61: vega.events.v1.TxErrorEvent.proposal:type_name -> vega.commands.v1.ProposalSubmission
	96,  // 62: vega.events.v1.TxErrorEvent.vote_submission:type_name -> vega.commands.v1.VoteSubmission
	97,  // 63: vega.events.v1.TxErrorEvent.liquidity_provision_submission:type_name -> vega.commands.v1.LiquidityProvisionSubmission
	98,  // 64: vega.events.v1.TxErrorEvent.withdraw_submission:type_name -> vega.commands.v1.WithdrawSubmission
	99,  // 65: vega.events.v1.TxErrorEvent.delegate_submission:type_name -> vega.commands.v1.DelegateSubmission
	100, // 66: vega.events.v1.TxErrorEvent.undelegate_submission:type_name -> vega.commands.v1.UndelegateSubmission
	101, // 67: vega.events.v1.TxErrorEvent.liquidity_provision_cancellation:type_name -> vega.commands.v1.LiquidityProvisionCancellation
	102, // 68: vega.events.v1.TxErrorEvent.liquidity_provision_amendment:type_name -> vega.commands.v1.LiquidityProvisionAmendment
	103, // 69: vega.events.v1.TxErrorEvent.transfer:type_name -> vega.commands.v1.Transfer
	104, // 70: vega.events.v1.TxErrorEvent.cancel_transfer:type_name -> vega.commands.v1.CancelTransfer
	105, // 71: vega.events.v1.TxErrorEvent.announce_node:type_name -> vega.commands.v1.AnnounceNode
	106, // 72: vega.events.v1.TxErrorEvent.oracle_data_submission:type_name -> vega.commands.v1.OracleDataSubmission
	107, // 73: vega.events.v1.TxErrorEvent.protocol_upgrade_proposal:type_name -> vega.commands.v1.ProtocolUpgradeProposal
	108, // 74: vega.events.v1.TxErrorEvent.issue_signatures:type_name -> vega.commands.v1.IssueSignatures
	109, // 75: vega.events.v1.TxErrorEvent.batch_market_instructions:type_name -> vega.commands.v1.BatchMarketInstructions
	118, // 76: vega.events.v1.EpochEvent.action:type_name -> vega.EpochAction
	119, // 77: vega.events.v1.LedgerMovements.ledger_movements:type_name -> vega.LedgerMovement
	50,  // 78: vega.events.v1.SettlePosition.trade_settlements:type_name -> vega.events.v1.TradeSettlement
	120, // 79: vega.events.v1.AuctionEvent.trigger:type_name -> vega.AuctionTrigger
	120, // 80: vega.events.v1.AuctionEvent.extension_trigger:type_name -> vega.AuctionTrigger
	0,   // 81: vega.events.v1.ProtocolUpgradeEvent.status:type_name -> vega.events.v1.ProtocolUpgradeProposalStatus
	77,  // 82: vega.events.v1.ReferralSetStatsUpdated.referees_stats:type_name -> vega.events.v1.RefereeStats
	121, // 83: vega.events.v1.ReferralProgramStarted.program:type_name -> vega.ReferralProgram
	121, // 84: vega.events.v1.ReferralProgramUpdated.program:type_name -> vega.ReferralProgram
	122, // 85: vega.events.v1.VolumeDiscountProgramStarted.program:type_name -> vega.VolumeDiscountProgram
	122, // 86: vega.events.v1.VolumeDiscountProgramUpdated.program:type_name -> vega.VolumeDiscountProgram
	18,  // 87: vega.events.v1.PaidLiquidityFeesStats.fees_paid_per_party:type_name -> vega.events.v1.PartyAmount
	1,   // 88: vega.events.v1.BusEvent.type:type_name -> vega.events.v1.BusEventType
	45,  // 89: vega.events.v1.BusEvent.time_update:type_name -> vega.events.v1.TimeUpdate
	47,  // 90: vega.events.v1.BusEvent.ledger_movements:type_name -> vega.events.v1.LedgerMovements
	48,  // 91: vega.events.v1.BusEvent.position_resolution:type_name -> vega.events.v1.PositionResolution
	123, // 92: vega.events.v1.BusEvent.order:type_name -> vega.Order
	124, // 93: vega.events.v1.BusEvent.account:type_name -> vega.Account
	125, // 94: vega.events.v1.BusEvent.party:type_name -> vega.Party
	126, // 95: vega.events.v1.BusEvent.trade:type_name -> vega.Trade
	127, // 96: vega.events.v1.BusEvent.margin_levels:type_name -> vega.MarginLevels
	128, // 97: vega.events.v1.BusEvent.proposal:type_name -> vega.Proposal
	129, // 98: vega.events.v1.BusEvent.vote:type_name -> vega.Vote
	130, // 99: vega.events.v1.BusEvent.market_data:type_name -> vega.MarketData
	131, // 100: vega.events.v1.BusEvent.node_signature:type_name -> vega.commands.v1.NodeSignature
	49,  // 101: vega.events.v1.BusEvent.loss_socialization:type_name -> vega.events.v1.LossSocialization
	51,  // 102: vega.events.v1.BusEvent.settle_position:type_name -> vega.events.v1.SettlePosition
	54,  // 103: vega.events.v1.BusEvent.settle_distressed:type_name -> vega.events.v1.SettleDistressed
	132, // 104: vega.events.v1.BusEvent.market_created:type_name -> vega.Market
	133, // 105: vega.events.v1.BusEvent.asset:type_name -> vega.Asset
	57,  // 106: vega.events.v1.BusEvent.market_tick:type_name -> vega.events.v1.MarketTick
	134, // 107: vega.events.v1.BusEvent.withdrawal:type_name -> vega.Withdrawal
	135, // 108: vega.events.v1.BusEvent.deposit:type_name -> vega.Deposit
	58,  // 109: vega.events.v1.BusEvent.auction:type_name -> vega.events.v1.AuctionEvent
	136, // 110: vega.events.v1.BusEvent.risk_factor:type_name -> vega.RiskFactor
	137, // 111: vega.events.v1.BusEvent.network_parameter:type_name -> vega.NetworkParameter
	138, // 112: vega.events.v1.BusEvent.liquidity_provision:type_name -> vega.LiquidityProvision
	132, // 113: vega.events.v1.BusEvent.market_updated:type_name -> vega.Market
	139, // 114: vega.events.v1.BusEvent.oracle_spec:type_name -> vega.OracleSpec
	140, // 115: vega.events.v1.BusEvent.oracle_data:type_name -> vega.OracleData
	40,  // 116: vega.events.v1.BusEvent.delegation_balance:type_name -> vega.events.v1.DelegationBalanceEvent
	39,  // 117: vega.events.v1.BusEvent.validator_score:type_name -> vega.events.v1.ValidatorScoreEvent
	46,  // 118: vega.events.v1.BusEvent.epoch_event:type_name -> vega.events.v1.EpochEvent
	59,  // 119: vega.events.v1.BusEvent.validator_update:type_name -> vega.events.v1.ValidatorUpdate
	33,  // 120: vega.events.v1.BusEvent.stake_linking:type_name -> vega.events.v1.StakeLinking
	38,  // 121: vega.events.v1.BusEvent.reward_payout:type_name -> vega.events.v1.RewardPayoutEvent
	36,  // 122: vega.events.v1.BusEvent.checkpoint:type_name -> vega.events.v1.CheckpointEvent
	61,  // 123: vega.events.v1.BusEvent.key_rotation:type_name -> vega.events.v1.KeyRotation
	64,  // 124: vega.events.v1.BusEvent.state_var:type_name -> vega.events.v1.StateVar
	141, // 125: vega.events.v1.BusEvent.network_limits:type_name -> vega.NetworkLimits
	28,  // 126: vega.events.v1.BusEvent.transfer:type_name -> vega.events.v1.Transfer
	60,  // 127: vega.events.v1.BusEvent.ranking_event:type_name -> vega.events.v1.ValidatorRankingEvent
	34,  // 128: vega.events.v1.BusEvent.erc20_multisig_signer_event:type_name -> vega.events.v1.ERC20MultiSigSignerEvent
	35,  // 129: vega.events.v1.BusEvent.erc20_multisig_set_threshold_event:type_name -> vega.events.v1.ERC20MultiSigThresholdSetEvent
	25,  // 130: vega.events.v1.BusEvent.erc20_multisig_signer_added:type_name -> vega.events.v1.ERC20MultiSigSignerAdded
	27,  // 131: vega.events.v1.BusEvent.erc20_multisig_signer_removed:type_name -> vega.events.v1.ERC20MultiSigSignerRemoved
	53,  // 132: vega.events.v1.BusEvent.position_state_event:type_name -> vega.events.v1.PositionStateEvent
	62,  // 133: vega.events.v1.BusEvent.ethereum_key_rotation:type_name -> vega.events.v1.EthereumKeyRotation
	63,  // 134: vega.events.v1.BusEvent.protocol_upgrade_event:type_name -> vega.events.v1.ProtocolUpgradeEvent
	65,  // 135: vega.events.v1.BusEvent.begin_block:type_name -> vega.events.v1.BeginBlock
	66,  // 136: vega.events.v1.BusEvent.end_block:type_name -> vega.events.v1.EndBlock
	67,  // 137: vega.events.v1.BusEvent.protocol_upgrade_started:type_name -> vega.events.v1.ProtocolUpgradeStarted
	52,  // 138: vega.events.v1.BusEvent.settle_market:type_name -> vega.events.v1.SettleMarket
	43,  // 139: vega.events.v1.BusEvent.transaction_result:type_name -> vega.events.v1.TransactionResult
	69,  // 140: vega.events.v1.BusEvent.core_snapshot_event:type_name -> vega.events.v1.CoreSnapshotData
	68,  // 141: vega.events.v1.BusEvent.protocol_upgrade_data_node_ready:type_name -> vega.events.v1.ProtocolUpgradeDataNodeReady
	55,  // 142: vega.events.v1.BusEvent.distressed_orders:type_name -> vega.events.v1.DistressedOrders
	70,  // 143: vega.events.v1.BusEvent.expired_orders:type_name -> vega.events.v1.ExpiredOrders
	56,  // 144: vega.events.v1.BusEvent.distressed_positions:type_name -> vega.events.v1.DistressedPositions
	24,  // 145: vega.events.v1.BusEvent.stop_order:type_name -> vega.events.v1.StopOrderEvent
	20,  // 146: vega.events.v1.BusEvent.funding_period:type_name -> vega.events.v1.FundingPeriod
	23,  // 147: vega.events.v1.BusEvent.funding_period_data_point:type_name -> vega.events.v1.FundingPeriodDataPoint
	71,  // 148: vega.events.v1.BusEvent.team_created:type_name -> vega.events.v1.TeamCreated
	72,  // 149: vega.events.v1.BusEvent.team_updated:type_name -> vega.events.v1.TeamUpdated
	73,  // 150: vega.events.v1.BusEvent.referee_switched_team:type_name -> vega.events.v1.RefereeSwitchedTeam
	74,  // 151: vega.events.v1.BusEvent.referee_joined_team:type_name -> vega.events.v1.RefereeJoinedTeam
	79,  // 152: vega.events.v1.BusEvent.referral_program_started:type_name -> vega.events.v1.ReferralProgramStarted
	80,  // 153: vega.events.v1.BusEvent.referral_program_updated:type_name -> vega.events.v1.ReferralProgramUpdated
	81,  // 154: vega.events.v1.BusEvent.referral_program_ended:type_name -> vega.events.v1.ReferralProgramEnded
	75,  // 155: vega.events.v1.BusEvent.referral_set_created:type_name -> vega.events.v1.ReferralSetCreated
	78,  // 156: vega.events.v1.BusEvent.referee_joined_referral_set:type_name -> vega.events.v1.RefereeJoinedReferralSet
	19,  // 157: vega.events.v1.BusEvent.party_activity_streak:type_name -> vega.events.v1.PartyActivityStreak
	82,  // 158: vega.events.v1.BusEvent.volume_discount_program_started:type_name -> vega.events.v1.VolumeDiscountProgramStarted
	83,  // 159: vega.events.v1.BusEvent.volume_discount_program_updated:type_name -> vega.events.v1.VolumeDiscountProgramUpdated
	84,  // 160: vega.events.v1.BusEvent.volume_discount_program_ended:type_name -> vega.events.v1.VolumeDiscountProgramEnded
	76,  // 161: vega.events.v1.BusEvent.referral_set_stats_updated:type_name -> vega.events.v1.ReferralSetStatsUpdated
	13,  // 162: vega.events.v1.BusEvent.vesting_stats_updated:type_name -> vega.events.v1.VestingStatsUpdated
	11,  // 163: vega.events.v1.BusEvent.volume_discount_stats_updated:type_name -> vega.events.v1.VolumeDiscountStatsUpdated
	15,  // 164: vega.events.v1.BusEvent.fees_stats:type_name -> vega.events.v1.FeesStats
	22,  // 165: vega.events.v1.BusEvent.funding_payments:type_name -> vega.events.v1.FundingPayments
	85,  // 166: vega.events.v1.BusEvent.paid_liquidity_fees_stats:type_name -> vega.events.v1.PaidLiquidityFeesStats
	7,   // 167: vega.events.v1.BusEvent.vesting_balances_summary:type_name -> vega.events.v1.VestingBalancesSummary
	42,  // 168: vega.events.v1.BusEvent.transfer_fees:type_name -> vega.events.v1.TransferFees
	41,  // 169: vega.events.v1.BusEvent.market:type_name -> vega.events.v1.MarketEvent
	44,  // 170: vega.events.v1.BusEvent.tx_err_event:type_name -> vega.events.v1.TxErrorEvent
