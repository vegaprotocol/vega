...
func (this *FutureProduct) Validate() error {
	...
	if this.SettlementAsset == "" {
		return github_com_mwitkow_go_proto_validators.FieldError("SettlementAsset", fmt.Errorf(`value '%v' must not be an empty string`, this.SettlementAsset))
	}
	if this.QuoteName == "" {
