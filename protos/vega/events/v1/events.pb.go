...
const (
	...
	// Event indicating the liquidity fee stats per market at end of epoch
	BusEventType_BUS_EVENT_TYPE_LIQUIDITY_FEE_STATS_UPDATED BusEventType = 81
...
var (
	BusEventType_name = map[int32]string{
		...
		81:  "BUS_EVENT_TYPE_LIQUIDITY_FEE_STATS_UPDATED",
	...
	BusEventType_value = map[string]int32{
		...
		"BUS_EVENT_TYPE_LIQUIDITY_FEE_STATS_UPDATED":      81,
...
func (x *LiquidityFeeStats) Reset() {
	*x = LiquidityFeeStats{}
	if protoimpl.UnsafeEnabled {
...
func (x *LiquidityFeeStats) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*LiquidityFeeStats) ProtoMessage() {}

func (x *LiquidityFeeStats) ProtoReflect() protoreflect.Message {
	mi := &file_vega_events_v1_events_proto_msgTypes[73]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use LiquidityFeeStats.ProtoReflect.Descriptor instead.
func (*LiquidityFeeStats) Descriptor() ([]byte, []int) {
	return file_vega_events_v1_events_proto_rawDescGZIP(), []int{73}
}

func (x *LiquidityFeeStats) GetMarket() string {
	if x != nil {
		return x.Market
	}
	return ""
...
func (x *LiquidityFeeStats) GetAsset() string {
	if x != nil {
		return x.Asset
	}
	return ""
...
func (x *LiquidityFeeStats) GetEpochSeq() uint64 {
	if x != nil {
		return x.EpochSeq
	}
	return 0
...
func (x *LiquidityFeeStats) GetTotalFeesPaid() string {
	if x != nil {
...
func (x *LiquidityFeeStats) GetFeesPaidPerParty() []*PartyAmount {
	if x != nil {
...
func (x *BusEvent) GetLiquidityFeeStats() *LiquidityFeeStats {
	if x, ok := x.GetEvent().(*BusEvent_LiquidityFeeStats); ok {
		return x.LiquidityFeeStats
	}
	return nil
}
...
type BusEvent_LiquidityFeeStats struct {
	// Event notifying of an update the liqudity fees stats for a market.
	LiquidityFeeStats *LiquidityFeeStats `protobuf:"bytes,179,opt,name=liquidity_fee_stats,json=liquidityFeeStats,proto3,oneof"`
}
...
func (*BusEvent_LiquidityFeeStats) isBusEvent_Event() {}
...
var file_vega_events_v1_events_proto_rawDesc = []byte{
	...
	0x07, 0x61, 0x74, 0x45, 0x70, 0x6f, 0x63, 0x68, 0x22, 0xd2, 0x01, 0x0a, 0x11, 0x4c, 0x69, 0x71,
	0x75, 0x69, 0x64, 0x69, 0x74, 0x79, 0x46, 0x65, 0x65, 0x53, 0x74, 0x61, 0x74, 0x73, 0x12, 0x16,
	...
	0x73, 0x50, 0x61, 0x69, 0x64, 0x50, 0x65, 0x72, 0x50, 0x61, 0x72, 0x74, 0x79, 0x22, 0xa6, 0x31,
	...
	0x75, 0x6e, 0x64, 0x69, 0x6e, 0x67, 0x50, 0x61, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x73, 0x12, 0x54,
	0x0a, 0x13, 0x6c, 0x69, 0x71, 0x75, 0x69, 0x64, 0x69, 0x74, 0x79, 0x5f, 0x66, 0x65, 0x65, 0x5f,
	0x73, 0x74, 0x61, 0x74, 0x73, 0x18, 0xb3, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x21, 0x2e, 0x76,
	0x65, 0x67, 0x61, 0x2e, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x73, 0x2e, 0x76, 0x31, 0x2e, 0x4c, 0x69,
	0x71, 0x75, 0x69, 0x64, 0x69, 0x74, 0x79, 0x46, 0x65, 0x65, 0x53, 0x74, 0x61, 0x74, 0x73, 0x48,
	0x00, 0x52, 0x11, 0x6c, 0x69, 0x71, 0x75, 0x69, 0x64, 0x69, 0x74, 0x79, 0x46, 0x65, 0x65, 0x53,
	0x74, 0x61, 0x74, 0x73, 0x12, 0x36, 0x0a, 0x06, 0x6d, 0x61, 0x72, 0x6b, 0x65, 0x74, 0x18, 0xe9,
	...
	0x43, 0x54, 0x45, 0x44, 0x10, 0x03, 0x2a, 0xc8, 0x18, 0x0a, 0x0c, 0x42, 0x75, 0x73, 0x45, 0x76,
	...
	0x59, 0x4d, 0x45, 0x4e, 0x54, 0x53, 0x10, 0x50, 0x12, 0x2e, 0x0a, 0x2a, 0x42, 0x55, 0x53, 0x5f,
	0x45, 0x56, 0x45, 0x4e, 0x54, 0x5f, 0x54, 0x59, 0x50, 0x45, 0x5f, 0x4c, 0x49, 0x51, 0x55, 0x49,
	0x44, 0x49, 0x54, 0x59, 0x5f, 0x46, 0x45, 0x45, 0x5f, 0x53, 0x54, 0x41, 0x54, 0x53, 0x5f, 0x55,
	0x50, 0x44, 0x41, 0x54, 0x45, 0x44, 0x10, 0x51, 0x12, 0x19, 0x0a, 0x15, 0x42, 0x55, 0x53, 0x5f,
...
var file_vega_events_v1_events_proto_goTypes = []interface{}{
	...
	(*LiquidityFeeStats)(nil),                   // 80: vega.events.v1.LiquidityFeeStats
...
var file_vega_events_v1_events_proto_depIdxs = []int32{
	...
	14,  // 83: vega.events.v1.LiquidityFeeStats.fees_paid_per_party:type_name -> vega.events.v1.PartyAmount
	...
	80,  // 162: vega.events.v1.BusEvent.liquidity_fee_stats:type_name -> vega.events.v1.LiquidityFeeStats
...
func file_vega_events_v1_events_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_vega_events_v1_events_proto_msgTypes[73].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*LiquidityFeeStats); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_vega_events_v1_events_proto_msgTypes[74].OneofWrappers = []interface{}{
		...
		(*BusEvent_LiquidityFeeStats)(nil),
		(*BusEvent_Market)(nil),
