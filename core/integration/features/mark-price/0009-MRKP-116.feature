Feature: Test setting of mark price
  Background:
    ...
    And the markets:
      ...
      | ETH/FEB23 | ETH        | USD   | lqm-params           | simple-risk-model | default-margin-calculator | 1                | default-none | default-none     | default-eth-for-future | 0.25                   | 0                         | default-futures | weight     | 1            | 0           | 0           | 1,0,0,0        | 5s,5s,24h0m0s,1h25m0s      | future      |
      | ETH/FEB22 | ETH        | USD   | lqm-params           | simple-risk-model | default-margin-calculator | 1                | default-none | default-none     | perp-oracle            | 0.25                   | 0                         | default-futures | weight     | 1            | 0           | 0           | 1,0,0,0        | 5s,5s,24h0m0s,1h25m0s      | perp        |
  ...
  Scenario: 001 check mark price using weight average
    ...
    # AC 0009-MRKP-116, 0009-MRKP-117
