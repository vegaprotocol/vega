Feature: Replicate LP getting distressed during continuous trading, and after leaving an auction
  ...
  Background:
    ...
    And the markets:
      ...
      | ETH/DEC21 | ETH        | ETH   | lqm-params           | simple-risk-model-1 | default-margin-calculator | 1                | fees-config-1 | price-monitoring-1 | default-eth-for-future | 0.1                    | 0                         | SLA        | 2                       |
  ...
  Scenario: 001, LP gets distressed during continuous trading (0042-LIQF-014)
    ...
    And the insurance pool balance should be "1422" for the market "ETH/DEC21"
