Feature: Test settlement at expiry
  ...
  Background:
    ...
    And the settlement price decimal scaling factor exponent for the oracle named "ethDec20Oracle" is "0"
    And the settlement price decimal scaling factor exponent for the oracle named "ethDec21Oracle" is "0"
