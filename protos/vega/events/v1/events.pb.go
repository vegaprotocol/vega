...
var file_vega_events_v1_events_proto_depIdxs = []int32{
	...
	88,  // 58: vega.events.v1.TransactionResult.success:type_name -> vega.events.v1.TransactionResult.SuccessDetails
	89,  // 59: vega.events.v1.TransactionResult.failure:type_name -> vega.events.v1.TransactionResult.FailureDetails
	90,  // 60: vega.events.v1.TxErrorEvent.order_submission:type_name -> vega.commands.v1.OrderSubmission
	94,  // 61: vega.events.v1.TxErrorEvent.order_amendment:type_name -> vega.commands.v1.OrderAmendment
	95,  // 62: vega.events.v1.TxErrorEvent.order_cancellation:type_name -> vega.commands.v1.OrderCancellation
	96,  // 63: vega.events.v1.TxErrorEvent.proposal:type_name -> vega.commands.v1.ProposalSubmission
	97,  // 64: vega.events.v1.TxErrorEvent.vote_submission:type_name -> vega.commands.v1.VoteSubmission
	98,  // 65: vega.events.v1.TxErrorEvent.liquidity_provision_submission:type_name -> vega.commands.v1.LiquidityProvisionSubmission
	99,  // 66: vega.events.v1.TxErrorEvent.withdraw_submission:type_name -> vega.commands.v1.WithdrawSubmission
	100, // 67: vega.events.v1.TxErrorEvent.delegate_submission:type_name -> vega.commands.v1.DelegateSubmission
	101, // 68: vega.events.v1.TxErrorEvent.undelegate_submission:type_name -> vega.commands.v1.UndelegateSubmission
	102, // 69: vega.events.v1.TxErrorEvent.liquidity_provision_cancellation:type_name -> vega.commands.v1.LiquidityProvisionCancellation
	103, // 70: vega.events.v1.TxErrorEvent.liquidity_provision_amendment:type_name -> vega.commands.v1.LiquidityProvisionAmendment
	104, // 71: vega.events.v1.TxErrorEvent.transfer:type_name -> vega.commands.v1.Transfer
	105, // 72: vega.events.v1.TxErrorEvent.cancel_transfer:type_name -> vega.commands.v1.CancelTransfer
	106, // 73: vega.events.v1.TxErrorEvent.announce_node:type_name -> vega.commands.v1.AnnounceNode
	107, // 74: vega.events.v1.TxErrorEvent.oracle_data_submission:type_name -> vega.commands.v1.OracleDataSubmission
	108, // 75: vega.events.v1.TxErrorEvent.protocol_upgrade_proposal:type_name -> vega.commands.v1.ProtocolUpgradeProposal
	109, // 76: vega.events.v1.TxErrorEvent.issue_signatures:type_name -> vega.commands.v1.IssueSignatures
	110, // 77: vega.events.v1.TxErrorEvent.batch_market_instructions:type_name -> vega.commands.v1.BatchMarketInstructions
	120, // 78: vega.events.v1.EpochEvent.action:type_name -> vega.EpochAction
	121, // 79: vega.events.v1.LedgerMovements.ledger_movements:type_name -> vega.LedgerMovement
	51,  // 80: vega.events.v1.SettlePosition.trade_settlements:type_name -> vega.events.v1.TradeSettlement
	122, // 81: vega.events.v1.AuctionEvent.trigger:type_name -> vega.AuctionTrigger
	122, // 82: vega.events.v1.AuctionEvent.extension_trigger:type_name -> vega.AuctionTrigger
	0,   // 83: vega.events.v1.ProtocolUpgradeEvent.status:type_name -> vega.events.v1.ProtocolUpgradeProposalStatus
	78,  // 84: vega.events.v1.ReferralSetStatsUpdated.referees_stats:type_name -> vega.events.v1.RefereeStats
	123, // 85: vega.events.v1.ReferralProgramStarted.program:type_name -> vega.ReferralProgram
	123, // 86: vega.events.v1.ReferralProgramUpdated.program:type_name -> vega.ReferralProgram
	124, // 87: vega.events.v1.VolumeDiscountProgramStarted.program:type_name -> vega.VolumeDiscountProgram
	124, // 88: vega.events.v1.VolumeDiscountProgramUpdated.program:type_name -> vega.VolumeDiscountProgram
	18,  // 89: vega.events.v1.PaidLiquidityFeesStats.fees_paid_per_party:type_name -> vega.events.v1.PartyAmount
	1,   // 90: vega.events.v1.BusEvent.type:type_name -> vega.events.v1.BusEventType
	46,  // 91: vega.events.v1.BusEvent.time_update:type_name -> vega.events.v1.TimeUpdate
	48,  // 92: vega.events.v1.BusEvent.ledger_movements:type_name -> vega.events.v1.LedgerMovements
	49,  // 93: vega.events.v1.BusEvent.position_resolution:type_name -> vega.events.v1.PositionResolution
	125, // 94: vega.events.v1.BusEvent.order:type_name -> vega.Order
	126, // 95: vega.events.v1.BusEvent.account:type_name -> vega.Account
	127, // 96: vega.events.v1.BusEvent.party:type_name -> vega.Party
	128, // 97: vega.events.v1.BusEvent.trade:type_name -> vega.Trade
	129, // 98: vega.events.v1.BusEvent.margin_levels:type_name -> vega.MarginLevels
	130, // 99: vega.events.v1.BusEvent.proposal:type_name -> vega.Proposal
	131, // 100: vega.events.v1.BusEvent.vote:type_name -> vega.Vote
	132, // 101: vega.events.v1.BusEvent.market_data:type_name -> vega.MarketData
	133, // 102: vega.events.v1.BusEvent.node_signature:type_name -> vega.commands.v1.NodeSignature
	50,  // 103: vega.events.v1.BusEvent.loss_socialization:type_name -> vega.events.v1.LossSocialization
	52,  // 104: vega.events.v1.BusEvent.settle_position:type_name -> vega.events.v1.SettlePosition
	55,  // 105: vega.events.v1.BusEvent.settle_distressed:type_name -> vega.events.v1.SettleDistressed
	134, // 106: vega.events.v1.BusEvent.market_created:type_name -> vega.Market
	135, // 107: vega.events.v1.BusEvent.asset:type_name -> vega.Asset
	58,  // 108: vega.events.v1.BusEvent.market_tick:type_name -> vega.events.v1.MarketTick
	136, // 109: vega.events.v1.BusEvent.withdrawal:type_name -> vega.Withdrawal
	137, // 110: vega.events.v1.BusEvent.deposit:type_name -> vega.Deposit
	59,  // 111: vega.events.v1.BusEvent.auction:type_name -> vega.events.v1.AuctionEvent
	138, // 112: vega.events.v1.BusEvent.risk_factor:type_name -> vega.RiskFactor
	139, // 113: vega.events.v1.BusEvent.network_parameter:type_name -> vega.NetworkParameter
	140, // 114: vega.events.v1.BusEvent.liquidity_provision:type_name -> vega.LiquidityProvision
	134, // 115: vega.events.v1.BusEvent.market_updated:type_name -> vega.Market
	141, // 116: vega.events.v1.BusEvent.oracle_spec:type_name -> vega.OracleSpec
	142, // 117: vega.events.v1.BusEvent.oracle_data:type_name -> vega.OracleData
	40,  // 118: vega.events.v1.BusEvent.delegation_balance:type_name -> vega.events.v1.DelegationBalanceEvent
	39,  // 119: vega.events.v1.BusEvent.validator_score:type_name -> vega.events.v1.ValidatorScoreEvent
	47,  // 120: vega.events.v1.BusEvent.epoch_event:type_name -> vega.events.v1.EpochEvent
	60,  // 121: vega.events.v1.BusEvent.validator_update:type_name -> vega.events.v1.ValidatorUpdate
	33,  // 122: vega.events.v1.BusEvent.stake_linking:type_name -> vega.events.v1.StakeLinking
	38,  // 123: vega.events.v1.BusEvent.reward_payout:type_name -> vega.events.v1.RewardPayoutEvent
	36,  // 124: vega.events.v1.BusEvent.checkpoint:type_name -> vega.events.v1.CheckpointEvent
	62,  // 125: vega.events.v1.BusEvent.key_rotation:type_name -> vega.events.v1.KeyRotation
	65,  // 126: vega.events.v1.BusEvent.state_var:type_name -> vega.events.v1.StateVar
	143, // 127: vega.events.v1.BusEvent.network_limits:type_name -> vega.NetworkLimits
	28,  // 128: vega.events.v1.BusEvent.transfer:type_name -> vega.events.v1.Transfer
	61,  // 129: vega.events.v1.BusEvent.ranking_event:type_name -> vega.events.v1.ValidatorRankingEvent
	34,  // 130: vega.events.v1.BusEvent.erc20_multisig_signer_event:type_name -> vega.events.v1.ERC20MultiSigSignerEvent
	35,  // 131: vega.events.v1.BusEvent.erc20_multisig_set_threshold_event:type_name -> vega.events.v1.ERC20MultiSigThresholdSetEvent
	25,  // 132: vega.events.v1.BusEvent.erc20_multisig_signer_added:type_name -> vega.events.v1.ERC20MultiSigSignerAdded
	27,  // 133: vega.events.v1.BusEvent.erc20_multisig_signer_removed:type_name -> vega.events.v1.ERC20MultiSigSignerRemoved
	54,  // 134: vega.events.v1.BusEvent.position_state_event:type_name -> vega.events.v1.PositionStateEvent
	63,  // 135: vega.events.v1.BusEvent.ethereum_key_rotation:type_name -> vega.events.v1.EthereumKeyRotation
	64,  // 136: vega.events.v1.BusEvent.protocol_upgrade_event:type_name -> vega.events.v1.ProtocolUpgradeEvent
	66,  // 137: vega.events.v1.BusEvent.begin_block:type_name -> vega.events.v1.BeginBlock
	67,  // 138: vega.events.v1.BusEvent.end_block:type_name -> vega.events.v1.EndBlock
	68,  // 139: vega.events.v1.BusEvent.protocol_upgrade_started:type_name -> vega.events.v1.ProtocolUpgradeStarted
	53,  // 140: vega.events.v1.BusEvent.settle_market:type_name -> vega.events.v1.SettleMarket
	44,  // 141: vega.events.v1.BusEvent.transaction_result:type_name -> vega.events.v1.TransactionResult
	70,  // 142: vega.events.v1.BusEvent.core_snapshot_event:type_name -> vega.events.v1.CoreSnapshotData
	69,  // 143: vega.events.v1.BusEvent.protocol_upgrade_data_node_ready:type_name -> vega.events.v1.ProtocolUpgradeDataNodeReady
	56,  // 144: vega.events.v1.BusEvent.distressed_orders:type_name -> vega.events.v1.DistressedOrders
	71,  // 145: vega.events.v1.BusEvent.expired_orders:type_name -> vega.events.v1.ExpiredOrders
	57,  // 146: vega.events.v1.BusEvent.distressed_positions:type_name -> vega.events.v1.DistressedPositions
	24,  // 147: vega.events.v1.BusEvent.stop_order:type_name -> vega.events.v1.StopOrderEvent
	20,  // 148: vega.events.v1.BusEvent.funding_period:type_name -> vega.events.v1.FundingPeriod
	23,  // 149: vega.events.v1.BusEvent.funding_period_data_point:type_name -> vega.events.v1.FundingPeriodDataPoint
	72,  // 150: vega.events.v1.BusEvent.team_created:type_name -> vega.events.v1.TeamCreated
	73,  // 151: vega.events.v1.BusEvent.team_updated:type_name -> vega.events.v1.TeamUpdated
	74,  // 152: vega.events.v1.BusEvent.referee_switched_team:type_name -> vega.events.v1.RefereeSwitchedTeam
	75,  // 153: vega.events.v1.BusEvent.referee_joined_team:type_name -> vega.events.v1.RefereeJoinedTeam
	80,  // 154: vega.events.v1.BusEvent.referral_program_started:type_name -> vega.events.v1.ReferralProgramStarted
	81,  // 155: vega.events.v1.BusEvent.referral_program_updated:type_name -> vega.events.v1.ReferralProgramUpdated
	82,  // 156: vega.events.v1.BusEvent.referral_program_ended:type_name -> vega.events.v1.ReferralProgramEnded
	76,  // 157: vega.events.v1.BusEvent.referral_set_created:type_name -> vega.events.v1.ReferralSetCreated
	79,  // 158: vega.events.v1.BusEvent.referee_joined_referral_set:type_name -> vega.events.v1.RefereeJoinedReferralSet
	19,  // 159: vega.events.v1.BusEvent.party_activity_streak:type_name -> vega.events.v1.PartyActivityStreak
	83,  // 160: vega.events.v1.BusEvent.volume_discount_program_started:type_name -> vega.events.v1.VolumeDiscountProgramStarted
	84,  // 161: vega.events.v1.BusEvent.volume_discount_program_updated:type_name -> vega.events.v1.VolumeDiscountProgramUpdated
	85,  // 162: vega.events.v1.BusEvent.volume_discount_program_ended:type_name -> vega.events.v1.VolumeDiscountProgramEnded
	77,  // 163: vega.events.v1.BusEvent.referral_set_stats_updated:type_name -> vega.events.v1.ReferralSetStatsUpdated
	13,  // 164: vega.events.v1.BusEvent.vesting_stats_updated:type_name -> vega.events.v1.VestingStatsUpdated
	11,  // 165: vega.events.v1.BusEvent.volume_discount_stats_updated:type_name -> vega.events.v1.VolumeDiscountStatsUpdated
	15,  // 166: vega.events.v1.BusEvent.fees_stats:type_name -> vega.events.v1.FeesStats
	22,  // 167: vega.events.v1.BusEvent.funding_payments:type_name -> vega.events.v1.FundingPayments
	86,  // 168: vega.events.v1.BusEvent.paid_liquidity_fees_stats:type_name -> vega.events.v1.PaidLiquidityFeesStats
	7,   // 169: vega.events.v1.BusEvent.vesting_balances_summary:type_name -> vega.events.v1.VestingBalancesSummary
	42,  // 170: vega.events.v1.BusEvent.transfer_fees:type_name -> vega.events.v1.TransferFees
	43,  // 171: vega.events.v1.BusEvent.transfer_fees_discount:type_name -> vega.events.v1.TransferFeesDiscount
	41,  // 172: vega.events.v1.BusEvent.market:type_name -> vega.events.v1.MarketEvent
	45,  // 173: vega.events.v1.BusEvent.tx_err_event:type_name -> vega.events.v1.TxErrorEvent
