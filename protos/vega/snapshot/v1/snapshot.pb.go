...
type AmmState struct {
	...
	Auction     bool              `protobuf:"varint,4,opt,name=auction,proto3" json:"auction,omitempty"`
}
...
func (x *AmmState) GetAuction() bool {
	if x != nil {
		return x.Auction
	}
	return false
...
type PoolMapEntry_Pool struct {
	...
	Auction                   bool                                     `protobuf:"varint,14,opt,name=auction,proto3" json:"auction,omitempty"`
}
...
func (x *PoolMapEntry_Pool) GetAuction() bool {
	if x != nil {
		return x.Auction
	}
	return false
