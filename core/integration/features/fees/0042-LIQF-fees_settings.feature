Feature: Test liquidity fee settings
  ...
  Scenario: 001 Liquidity fee setting to constant and can update it
    # setup accounts
    ...
    And the parties submit the following liquidity provision:
      ...
      | lp1 | lp1   | ETH/MAR22 | 12000             | 0.005    | submission |
    ...
    And the market data for the market "ETH/MAR22" should be:
      ...
      | 1000 | TRADING_MODE_CONTINUOUS | 3600 | 500 | 1500 | 1000 | 12000 | 10 |
