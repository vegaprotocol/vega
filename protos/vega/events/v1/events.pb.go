...
var file_vega_events_v1_events_proto_rawDesc = []byte{
	...
	0x74, 0x22, 0xab, 0x1d, 0x0a, 0x08, 0x42, 0x75, 0x73, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x12, 0x0e,
	...
	0x0c, 0x73, 0x65, 0x74, 0x74, 0x6c, 0x65, 0x4d, 0x61, 0x72, 0x6b, 0x65, 0x74, 0x12, 0x36, 0x0a,
	...
	0xf6, 0x0e, 0x0a, 0x0c, 0x42, 0x75, 0x73, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x54, 0x79, 0x70, 0x65,
...
var file_vega_events_v1_events_proto_msgTypes = make([]protoimpl.MessageInfo, 38)
var file_vega_events_v1_events_proto_goTypes = []interface{}{
	...
	(*LedgerMovements)(nil),                     // 24: vega.events.v1.LedgerMovements
	...
	(*SettleMarket)(nil),                        // 29: vega.events.v1.SettleMarket
	(*PositionStateEvent)(nil),                  // 30: vega.events.v1.PositionStateEvent
	(*SettleDistressed)(nil),                    // 31: vega.events.v1.SettleDistressed
	(*MarketTick)(nil),                          // 32: vega.events.v1.MarketTick
	(*AuctionEvent)(nil),                        // 33: vega.events.v1.AuctionEvent
	(*ValidatorUpdate)(nil),                     // 34: vega.events.v1.ValidatorUpdate
	(*ValidatorRankingEvent)(nil),               // 35: vega.events.v1.ValidatorRankingEvent
	(*KeyRotation)(nil),                         // 36: vega.events.v1.KeyRotation
	(*EthereumKeyRotation)(nil),                 // 37: vega.events.v1.EthereumKeyRotation
	(*ProtocolUpgradeEvent)(nil),                // 38: vega.events.v1.ProtocolUpgradeEvent
	(*StateVar)(nil),                            // 39: vega.events.v1.StateVar
	(*BeginBlock)(nil),                          // 40: vega.events.v1.BeginBlock
	(*EndBlock)(nil),                            // 41: vega.events.v1.EndBlock
	(*ProtocolUpgradeStarted)(nil),              // 42: vega.events.v1.ProtocolUpgradeStarted
	(*BusEvent)(nil),                            // 43: vega.events.v1.BusEvent
	(vega.AccountType)(0),                       // 44: vega.AccountType
	(*vega.DispatchStrategy)(nil),               // 45: vega.DispatchStrategy
	(*v1.OrderSubmission)(nil),                  // 46: vega.commands.v1.OrderSubmission
	(*v1.OrderAmendment)(nil),                   // 47: vega.commands.v1.OrderAmendment
	(*v1.OrderCancellation)(nil),                // 48: vega.commands.v1.OrderCancellation
	(*v1.ProposalSubmission)(nil),               // 49: vega.commands.v1.ProposalSubmission
	(*v1.VoteSubmission)(nil),                   // 50: vega.commands.v1.VoteSubmission
	(*v1.LiquidityProvisionSubmission)(nil),     // 51: vega.commands.v1.LiquidityProvisionSubmission
	(*v1.WithdrawSubmission)(nil),               // 52: vega.commands.v1.WithdrawSubmission
	(*v1.DelegateSubmission)(nil),               // 53: vega.commands.v1.DelegateSubmission
	(*v1.UndelegateSubmission)(nil),             // 54: vega.commands.v1.UndelegateSubmission
	(*v1.LiquidityProvisionCancellation)(nil),   // 55: vega.commands.v1.LiquidityProvisionCancellation
	(*v1.LiquidityProvisionAmendment)(nil),      // 56: vega.commands.v1.LiquidityProvisionAmendment
	(*v1.Transfer)(nil),                         // 57: vega.commands.v1.Transfer
	(*v1.CancelTransfer)(nil),                   // 58: vega.commands.v1.CancelTransfer
	(*v1.AnnounceNode)(nil),                     // 59: vega.commands.v1.AnnounceNode
	(*v1.OracleDataSubmission)(nil),             // 60: vega.commands.v1.OracleDataSubmission
	(*v1.ProtocolUpgradeProposal)(nil),          // 61: vega.commands.v1.ProtocolUpgradeProposal
	(*v1.IssueSignatures)(nil),                  // 62: vega.commands.v1.IssueSignatures
	(*v1.BatchMarketInstructions)(nil),          // 63: vega.commands.v1.BatchMarketInstructions
	(vega.EpochAction)(0),                       // 64: vega.EpochAction
	(*vega.LedgerMovement)(nil),                 // 65: vega.LedgerMovement
	(vega.AuctionTrigger)(0),                    // 66: vega.AuctionTrigger
	(*vega.Order)(nil),                          // 67: vega.Order
	(*vega.Account)(nil),                        // 68: vega.Account
	(*vega.Party)(nil),                          // 69: vega.Party
	(*vega.Trade)(nil),                          // 70: vega.Trade
	(*vega.MarginLevels)(nil),                   // 71: vega.MarginLevels
	(*vega.Proposal)(nil),                       // 72: vega.Proposal
	(*vega.Vote)(nil),                           // 73: vega.Vote
	(*vega.MarketData)(nil),                     // 74: vega.MarketData
	(*v1.NodeSignature)(nil),                    // 75: vega.commands.v1.NodeSignature
	(*vega.Market)(nil),                         // 76: vega.Market
	(*vega.Asset)(nil),                          // 77: vega.Asset
	(*vega.Withdrawal)(nil),                     // 78: vega.Withdrawal
	(*vega.Deposit)(nil),                        // 79: vega.Deposit
	(*vega.RiskFactor)(nil),                     // 80: vega.RiskFactor
	(*vega.NetworkParameter)(nil),               // 81: vega.NetworkParameter
	(*vega.LiquidityProvision)(nil),             // 82: vega.LiquidityProvision
	(*v11.OracleSpec)(nil),                      // 83: oracles.v1.OracleSpec
	(*v11.OracleData)(nil),                      // 84: oracles.v1.OracleData
	(*vega.NetworkLimits)(nil),                  // 85: vega.NetworkLimits
}
var file_vega_events_v1_events_proto_depIdxs = []int32{
	...
	44, // 1: vega.events.v1.Transfer.from_account_type:type_name -> vega.AccountType
	44, // 2: vega.events.v1.Transfer.to_account_type:type_name -> vega.AccountType
	...
	45, // 6: vega.events.v1.RecurringTransfer.dispatch_strategy:type_name -> vega.DispatchStrategy
	...
	46, // 10: vega.events.v1.TxErrorEvent.order_submission:type_name -> vega.commands.v1.OrderSubmission
	47, // 11: vega.events.v1.TxErrorEvent.order_amendment:type_name -> vega.commands.v1.OrderAmendment
	48, // 12: vega.events.v1.TxErrorEvent.order_cancellation:type_name -> vega.commands.v1.OrderCancellation
	49, // 13: vega.events.v1.TxErrorEvent.proposal:type_name -> vega.commands.v1.ProposalSubmission
	50, // 14: vega.events.v1.TxErrorEvent.vote_submission:type_name -> vega.commands.v1.VoteSubmission
	51, // 15: vega.events.v1.TxErrorEvent.liquidity_provision_submission:type_name -> vega.commands.v1.LiquidityProvisionSubmission
	52, // 16: vega.events.v1.TxErrorEvent.withdraw_submission:type_name -> vega.commands.v1.WithdrawSubmission
	53, // 17: vega.events.v1.TxErrorEvent.delegate_submission:type_name -> vega.commands.v1.DelegateSubmission
	54, // 18: vega.events.v1.TxErrorEvent.undelegate_submission:type_name -> vega.commands.v1.UndelegateSubmission
	55, // 19: vega.events.v1.TxErrorEvent.liquidity_provision_cancellation:type_name -> vega.commands.v1.LiquidityProvisionCancellation
	56, // 20: vega.events.v1.TxErrorEvent.liquidity_provision_amendment:type_name -> vega.commands.v1.LiquidityProvisionAmendment
	57, // 21: vega.events.v1.TxErrorEvent.transfer:type_name -> vega.commands.v1.Transfer
	58, // 22: vega.events.v1.TxErrorEvent.cancel_transfer:type_name -> vega.commands.v1.CancelTransfer
	59, // 23: vega.events.v1.TxErrorEvent.announce_node:type_name -> vega.commands.v1.AnnounceNode
	60, // 24: vega.events.v1.TxErrorEvent.oracle_data_submission:type_name -> vega.commands.v1.OracleDataSubmission
	61, // 25: vega.events.v1.TxErrorEvent.protocol_upgrade_proposal:type_name -> vega.commands.v1.ProtocolUpgradeProposal
	62, // 26: vega.events.v1.TxErrorEvent.issue_signatures:type_name -> vega.commands.v1.IssueSignatures
	63, // 27: vega.events.v1.TxErrorEvent.batch_market_instructions:type_name -> vega.commands.v1.BatchMarketInstructions
	64, // 28: vega.events.v1.EpochEvent.action:type_name -> vega.EpochAction
	65, // 29: vega.events.v1.LedgerMovements.ledger_movements:type_name -> vega.LedgerMovement
	27, // 30: vega.events.v1.SettlePosition.trade_settlements:type_name -> vega.events.v1.TradeSettlement
	66, // 31: vega.events.v1.AuctionEvent.trigger:type_name -> vega.AuctionTrigger
	66, // 32: vega.events.v1.AuctionEvent.extension_trigger:type_name -> vega.AuctionTrigger
	...
	24, // 36: vega.events.v1.BusEvent.ledger_movements:type_name -> vega.events.v1.LedgerMovements
	25, // 37: vega.events.v1.BusEvent.position_resolution:type_name -> vega.events.v1.PositionResolution
	67, // 38: vega.events.v1.BusEvent.order:type_name -> vega.Order
	68, // 39: vega.events.v1.BusEvent.account:type_name -> vega.Account
	69, // 40: vega.events.v1.BusEvent.party:type_name -> vega.Party
	70, // 41: vega.events.v1.BusEvent.trade:type_name -> vega.Trade
	71, // 42: vega.events.v1.BusEvent.margin_levels:type_name -> vega.MarginLevels
	72, // 43: vega.events.v1.BusEvent.proposal:type_name -> vega.Proposal
	73, // 44: vega.events.v1.BusEvent.vote:type_name -> vega.Vote
	74, // 45: vega.events.v1.BusEvent.market_data:type_name -> vega.MarketData
	75, // 46: vega.events.v1.BusEvent.node_signature:type_name -> vega.commands.v1.NodeSignature
	...
	31, // 49: vega.events.v1.BusEvent.settle_distressed:type_name -> vega.events.v1.SettleDistressed
	76, // 50: vega.events.v1.BusEvent.market_created:type_name -> vega.Market
	77, // 51: vega.events.v1.BusEvent.asset:type_name -> vega.Asset
	32, // 52: vega.events.v1.BusEvent.market_tick:type_name -> vega.events.v1.MarketTick
	78, // 53: vega.events.v1.BusEvent.withdrawal:type_name -> vega.Withdrawal
	79, // 54: vega.events.v1.BusEvent.deposit:type_name -> vega.Deposit
	33, // 55: vega.events.v1.BusEvent.auction:type_name -> vega.events.v1.AuctionEvent
	80, // 56: vega.events.v1.BusEvent.risk_factor:type_name -> vega.RiskFactor
	81, // 57: vega.events.v1.BusEvent.network_parameter:type_name -> vega.NetworkParameter
	82, // 58: vega.events.v1.BusEvent.liquidity_provision:type_name -> vega.LiquidityProvision
	76, // 59: vega.events.v1.BusEvent.market_updated:type_name -> vega.Market
	83, // 60: vega.events.v1.BusEvent.oracle_spec:type_name -> oracles.v1.OracleSpec
	84, // 61: vega.events.v1.BusEvent.oracle_data:type_name -> oracles.v1.OracleData
	...
	34, // 65: vega.events.v1.BusEvent.validator_update:type_name -> vega.events.v1.ValidatorUpdate
	...
	36, // 69: vega.events.v1.BusEvent.key_rotation:type_name -> vega.events.v1.KeyRotation
	39, // 70: vega.events.v1.BusEvent.state_var:type_name -> vega.events.v1.StateVar
	85, // 71: vega.events.v1.BusEvent.network_limits:type_name -> vega.NetworkLimits
	9,  // 72: vega.events.v1.BusEvent.transfer:type_name -> vega.events.v1.Transfer
	35, // 73: vega.events.v1.BusEvent.ranking_event:type_name -> vega.events.v1.ValidatorRankingEvent
	...
	30, // 78: vega.events.v1.BusEvent.position_state_event:type_name -> vega.events.v1.PositionStateEvent
	37, // 79: vega.events.v1.BusEvent.ethereum_key_rotation:type_name -> vega.events.v1.EthereumKeyRotation
	38, // 80: vega.events.v1.BusEvent.protocol_upgrade_event:type_name -> vega.events.v1.ProtocolUpgradeEvent
	40, // 81: vega.events.v1.BusEvent.begin_block:type_name -> vega.events.v1.BeginBlock
	41, // 82: vega.events.v1.BusEvent.end_block:type_name -> vega.events.v1.EndBlock
	42, // 83: vega.events.v1.BusEvent.protocol_upgrade_started:type_name -> vega.events.v1.ProtocolUpgradeStarted
	29, // 84: vega.events.v1.BusEvent.settle_market:type_name -> vega.events.v1.SettleMarket
	20, // 85: vega.events.v1.BusEvent.market:type_name -> vega.events.v1.MarketEvent
	21, // 86: vega.events.v1.BusEvent.tx_err_event:type_name -> vega.events.v1.TxErrorEvent
