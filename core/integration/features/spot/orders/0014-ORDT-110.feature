Feature: Spot market
  ...
  Scenario: Submit an aggressive iceberg order for size 100. There are multiple matching orders of size 20,30.
            Ensure the orders are matched and filled in time priority of the orders. Ensure remaining volume on
            the iceberg order is (100 - (20+30)) (0014-ORDT-110)

    # Place the 3 passive orders to rest on the book
    And the parties place the following orders:
      | party  | market id | side | volume | price | resulting trades | type       | tif     | reference |
      | party4 | BTC/ETH   | sell | 20     | 1000  | 0                | TYPE_LIMIT | TIF_GTC | sell1     |
      | party5 | BTC/ETH   | sell | 30     | 1000  | 0                | TYPE_LIMIT | TIF_GTC | sell2     |
    ...
    When the parties place the following iceberg orders:
      ...
      | party1 | BTC/ETH   | buy  | 100    | 1000  | 2                | TYPE_LIMIT | TIF_GTC | 5         | 1                    | iceberg1  |

    Then the orders should have the following states:
      | party  | market id | side | price | remaining | volume | reference | status         |
      | party4 | BTC/ETH   | sell | 1000  | 0         | 20     | sell1     | STATUS_FILLED  | 
      | party5 | BTC/ETH   | sell | 1000  | 0         | 30     | sell2     | STATUS_FILLED  |             
      | party1 | BTC/ETH   | buy  | 1000  | 5         | 100    | iceberg1  | STATUS_ACTIVE  |             

    # THe iceberg order has 50 volume left to fill, 5 visible and 45 hidden
