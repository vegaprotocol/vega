Feature: Test allow lists, based on team_rewards.feature test in rewards set.
  ...
  Background:
    ...
    Given the parties deposit on asset's general account the following amount:
      ...
      | referrer2                                                        | USD-1-10 | 10000000    |
      | referrer3                                                        | USD-1-10 | 10000000    |
      | referee1                                                         | USD-1-10 | 10000000    |
      | referee2                                                         | USD-1-10 | 10000000    |
      | referee3                                                         | USD-1-10 | 10000000    |
      | another1                                                         | USD-1-10 | 10000000    |
      | another2                                                         | USD-1-10 | 10000000    |
    ...
    Given the parties create the following referral codes:
      | party     | code            | is_team | team  | closed | allow list        |
      | referrer1 | referral-code-1 | true    | team1 | true   | referee1,another1 |
      | referrer2 | referral-code-2 | true    | team2 | false  |                   |
      | referrer3 | referral-code-3 | true    | team3 | true   |                   |
    ...
    And the team "team2" has the following members:
      ...
      | referee2  |
      | referee3  |
    And the team "team3" has the following members:
      | party     |
      | referrer3 |

  @Closed
  Scenario: 0083-RFPR-062 adding parties to non-closed team works as expected.
    ...
    When the parties apply the following referral codes:
      | party    | code            | is_team | team  |
      | another1 | referral-code-1 | true    | team1 |
    ...
    Then "referee1" should have vesting account balance of "3999" for asset "USD-1-10"
    And "referee2" should have vesting account balance of "3000" for asset "USD-1-10"
    And "referee3" should have vesting account balance of "3000" for asset "USD-1-10"
