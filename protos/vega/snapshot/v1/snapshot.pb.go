...
var file_vega_snapshot_v1_snapshot_proto_rawDesc = []byte{
	...
	0x62, 0x4b, 0x65, 0x79, 0x49, 0x6e, 0x64, 0x65, 0x78, 0x22, 0x79, 0x0a, 0x1a, 0x50, 0x65, 0x6e,
	...
	0x72, 0x65, 0x73, 0x73, 0x22, 0xa3, 0x03, 0x0a, 0x08, 0x54, 0x6f, 0x70, 0x6f, 0x6c, 0x6f, 0x67,
	...
	0x79, 0x52, 0x6f, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x22, 0xf2, 0x03, 0x0a, 0x0e, 0x56,
	...
	0x61, 0x72, 0x6b, 0x65, 0x74, 0x49, 0x64, 0x22, 0xb9, 0x01, 0x0a, 0x16, 0x46, 0x6c, 0x6f, 0x61,
	...
	0x73, 0x22, 0xe0, 0x02, 0x0a, 0x0b, 0x50, 0x72, 0x6f, 0x6f, 0x66, 0x4f, 0x66, 0x57, 0x6f, 0x72,
	...
	0x72, 0x61, 0x6d, 0x73, 0x22, 0x84, 0x03, 0x0a, 0x11, 0x50, 0x72, 0x6f, 0x6f, 0x66, 0x4f, 0x66,
	...
	0x0a, 0x75, 0x6e, 0x74, 0x69, 0x6c, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x22, 0x52, 0x0a, 0x14, 0x54,
	...
	0x65, 0x70, 0x74, 0x65, 0x64, 0x50, 0x72, 0x6f, 0x70, 0x6f, 0x73, 0x61, 0x6c, 0x22, 0xb0, 0x01,
	...
	0x65, 0x67, 0x61, 0x52, 0x65, 0x6c, 0x65, 0x61, 0x73, 0x65, 0x54, 0x61, 0x67, 0x12, 0x31, 0x0a,
	0x15, 0x64, 0x61, 0x74, 0x61, 0x5f, 0x6e, 0x6f, 0x64, 0x65, 0x5f, 0x72, 0x65, 0x6c, 0x65, 0x61,
	0x73, 0x65, 0x5f, 0x74, 0x61, 0x67, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x12, 0x64, 0x61,
	0x74, 0x61, 0x4e, 0x6f, 0x64, 0x65, 0x52, 0x65, 0x6c, 0x65, 0x61, 0x73, 0x65, 0x54, 0x61, 0x67,
...
var file_vega_snapshot_v1_snapshot_proto_goTypes = []interface{}{
	...
	(*v11.BridgeState)(nil),                    // 122: vega.checkpoint.v1.BridgeState
	(*vega.Delegation)(nil),                    // 123: vega.Delegation
	(*vega.Proposal)(nil),                      // 124: vega.Proposal
	(*vega.Vote)(nil),                          // 125: vega.Vote
	(*v12.StakeLinking)(nil),                   // 126: vega.events.v1.StakeLinking
	(*vega.Order)(nil),                         // 127: vega.Order
	(*vega.NetworkParameter)(nil),              // 128: vega.NetworkParameter
	(*vega.PriceMonitoringTrigger)(nil),        // 129: vega.PriceMonitoringTrigger
	(vega.Market_TradingMode)(0),               // 130: vega.Market.TradingMode
	(vega.AuctionTrigger)(0),                   // 131: vega.AuctionTrigger
	(*vega.AuctionDuration)(nil),               // 132: vega.AuctionDuration
	(*vega.Market)(nil),                        // 133: vega.Market
	(*v12.ValidatorUpdate)(nil),                // 134: vega.events.v1.ValidatorUpdate
	(*vega.RankingScore)(nil),                  // 135: vega.RankingScore
	(*vega.LiquidityProvision)(nil),            // 136: vega.LiquidityProvision
	(*vega.KeyValueBundle)(nil),                // 137: vega.KeyValueBundle
	(*v11.MarketActivityTracker)(nil),          // 138: vega.checkpoint.v1.MarketActivityTracker
	(*v12.ERC20MultiSigSignerEvent)(nil),       // 139: vega.events.v1.ERC20MultiSigSignerEvent
	(*v12.ERC20MultiSigThresholdSetEvent)(nil), // 140: vega.events.v1.ERC20MultiSigThresholdSetEvent
	(*v12.ProtocolUpgradeEvent)(nil),           // 141: vega.events.v1.ProtocolUpgradeEvent
}
var file_vega_snapshot_v1_snapshot_proto_depIdxs = []int32{
	...
	111, // 63: vega.snapshot.v1.EventForwarder.acked_events:type_name -> vega.commands.v1.ChainEvent
	112, // 64: vega.snapshot.v1.CollateralAccounts.accounts:type_name -> vega.Account
	113, // 65: vega.snapshot.v1.CollateralAssets.assets:type_name -> vega.Asset
	113, // 66: vega.snapshot.v1.ActiveAssets.assets:type_name -> vega.Asset
	113, // 67: vega.snapshot.v1.PendingAssets.assets:type_name -> vega.Asset
	113, // 68: vega.snapshot.v1.PendingAssetUpdates.assets:type_name -> vega.Asset
	114, // 69: vega.snapshot.v1.Withdrawal.withdrawal:type_name -> vega.Withdrawal
	115, // 70: vega.snapshot.v1.Deposit.deposit:type_name -> vega.Deposit
	116, // 71: vega.snapshot.v1.AssetAction.builtin_deposit:type_name -> vega.BuiltinAssetDeposit
	117, // 72: vega.snapshot.v1.AssetAction.erc20_deposit:type_name -> vega.ERC20Deposit
	118, // 73: vega.snapshot.v1.AssetAction.asset_list:type_name -> vega.ERC20AssetList
	119, // 74: vega.snapshot.v1.AssetAction.erc20_asset_limits_updated:type_name -> vega.ERC20AssetLimitsUpdated
	...
	120, // 79: vega.snapshot.v1.BankingRecurringTransfers.recurring_tranfers:type_name -> vega.checkpoint.v1.RecurringTransfers
	121, // 80: vega.snapshot.v1.BankingScheduledTransfers.transfers_at_time:type_name -> vega.checkpoint.v1.ScheduledTransferAtTime
	122, // 81: vega.snapshot.v1.BankingBridgeState.bridge_state:type_name -> vega.checkpoint.v1.BridgeState
	123, // 82: vega.snapshot.v1.DelegationActive.delegations:type_name -> vega.Delegation
	123, // 83: vega.snapshot.v1.DelegationPending.delegations:type_name -> vega.Delegation
	123, // 84: vega.snapshot.v1.DelegationPending.undelegation:type_name -> vega.Delegation
	124, // 85: vega.snapshot.v1.ProposalData.proposal:type_name -> vega.Proposal
	125, // 86: vega.snapshot.v1.ProposalData.yes:type_name -> vega.Vote
	125, // 87: vega.snapshot.v1.ProposalData.no:type_name -> vega.Vote
	125, // 88: vega.snapshot.v1.ProposalData.invalid:type_name -> vega.Vote
	...
	124, // 91: vega.snapshot.v1.GovernanceNode.proposals:type_name -> vega.Proposal
	126, // 92: vega.snapshot.v1.StakingAccount.events:type_name -> vega.events.v1.StakeLinking
	41,  // 93: vega.snapshot.v1.StakingAccounts.accounts:type_name -> vega.snapshot.v1.StakingAccount
	127, // 94: vega.snapshot.v1.MatchingBook.buy:type_name -> vega.Order
	127, // 95: vega.snapshot.v1.MatchingBook.sell:type_name -> vega.Order
	128, // 96: vega.snapshot.v1.NetParams.params:type_name -> vega.NetworkParameter
	129, // 97: vega.snapshot.v1.PriceBound.trigger:type_name -> vega.PriceMonitoringTrigger
	...
	130, // 106: vega.snapshot.v1.AuctionState.mode:type_name -> vega.Market.TradingMode
	130, // 107: vega.snapshot.v1.AuctionState.default_mode:type_name -> vega.Market.TradingMode
	131, // 108: vega.snapshot.v1.AuctionState.trigger:type_name -> vega.AuctionTrigger
	132, // 109: vega.snapshot.v1.AuctionState.end:type_name -> vega.AuctionDuration
	131, // 110: vega.snapshot.v1.AuctionState.extension:type_name -> vega.AuctionTrigger
	55,  // 111: vega.snapshot.v1.EquityShare.lps:type_name -> vega.snapshot.v1.EquityShareLP
	133, // 112: vega.snapshot.v1.Market.market:type_name -> vega.Market
	...
	127, // 116: vega.snapshot.v1.Market.expiring_orders:type_name -> vega.Order
	...
	127, // 119: vega.snapshot.v1.PeggedOrders.parked_orders:type_name -> vega.Order
	...
	88,  // 136: vega.snapshot.v1.Topology.validator_data:type_name -> vega.snapshot.v1.ValidatorState
	85,  // 137: vega.snapshot.v1.Topology.pending_pub_key_rotations:type_name -> vega.snapshot.v1.PendingKeyRotation
	91,  // 138: vega.snapshot.v1.Topology.validator_performance:type_name -> vega.snapshot.v1.ValidatorPerformance
	86,  // 139: vega.snapshot.v1.Topology.pending_ethereum_key_rotations:type_name -> vega.snapshot.v1.PendingEthereumKeyRotation
	134, // 140: vega.snapshot.v1.ValidatorState.validator_update:type_name -> vega.events.v1.ValidatorUpdate
	89,  // 141: vega.snapshot.v1.ValidatorState.heartbeat_tracker:type_name -> vega.snapshot.v1.HeartbeatTracker
	135, // 142: vega.snapshot.v1.ValidatorState.ranking_score:type_name -> vega.RankingScore
	...
	127, // 145: vega.snapshot.v1.PartyOrders.orders:type_name -> vega.Order
	95,  // 146: vega.snapshot.v1.LiquidityPartiesOrders.party_orders:type_name -> vega.snapshot.v1.PartyOrders
	136, // 147: vega.snapshot.v1.LiquidityProvisions.liquidity_provisions:type_name -> vega.LiquidityProvision
	101, // 148: vega.snapshot.v1.FloatingPointConsensus.next_time_trigger:type_name -> vega.snapshot.v1.NextTimeTrigger
	99,  // 149: vega.snapshot.v1.FloatingPointConsensus.state_variables:type_name -> vega.snapshot.v1.StateVarInternalState
	100, // 150: vega.snapshot.v1.StateVarInternalState.validators_results:type_name -> vega.snapshot.v1.FloatingPointValidatorResult
	137, // 151: vega.snapshot.v1.FloatingPointValidatorResult.bundle:type_name -> vega.KeyValueBundle
	138, // 152: vega.snapshot.v1.MarketTracker.market_activity:type_name -> vega.checkpoint.v1.MarketActivityTracker
	139, // 153: vega.snapshot.v1.SignerEventsPerAddress.events:type_name -> vega.events.v1.ERC20MultiSigSignerEvent
	103, // 154: vega.snapshot.v1.ERC20MultiSigTopologyVerified.events_per_address:type_name -> vega.snapshot.v1.SignerEventsPerAddress
	140, // 155: vega.snapshot.v1.ERC20MultiSigTopologyVerified.threshold:type_name -> vega.events.v1.ERC20MultiSigThresholdSetEvent
	139, // 156: vega.snapshot.v1.ERC20MultiSigTopologyPending.pending_signers:type_name -> vega.events.v1.ERC20MultiSigSignerEvent
	140, // 157: vega.snapshot.v1.ERC20MultiSigTopologyPending.pending_threshold_set:type_name -> vega.events.v1.ERC20MultiSigThresholdSetEvent
	108, // 158: vega.snapshot.v1.ProofOfWork.tx_at_height:type_name -> vega.snapshot.v1.TransactionsAtHeight
	108, // 159: vega.snapshot.v1.ProofOfWork.tid_at_height:type_name -> vega.snapshot.v1.TransactionsAtHeight
	72,  // 160: vega.snapshot.v1.ProofOfWork.banned:type_name -> vega.snapshot.v1.BannedParty
	107, // 161: vega.snapshot.v1.ProofOfWork.pow_params:type_name -> vega.snapshot.v1.ProofOfWorkParams
	141, // 162: vega.snapshot.v1.ProtocolUpgradeProposals.active_proposals:type_name -> vega.events.v1.ProtocolUpgradeEvent
	110, // 163: vega.snapshot.v1.ProtocolUpgradeProposals.accepted_proposal:type_name -> vega.snapshot.v1.AcceptedProtocolUpgradeProposal
