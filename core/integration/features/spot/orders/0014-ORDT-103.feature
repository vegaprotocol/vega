Feature: Spot market
  ...
  Scenario: In Spot market, amend an iceberg order to decrease size so that the displayed quantity is decreased.
            Total, displayed and remaining quantity is decreased, margin is recalculated and released and time
            priority is not lost. (0014-ORDT-103)
    ...
    When the parties place the following iceberg orders:
      ...
      | party1 | BTC/ETH   | buy  | 5      | 1000  | 0                | TYPE_LIMIT | TIF_GTC | 4         | 4                    | post | iceberg1  |

    And the parties place the following orders:
      | party  | market id | side | volume | price | resulting trades | type       | tif     | reference |
      | party2 | BTC/ETH   | buy  | 1      | 1000  | 0                | TYPE_LIMIT | TIF_GTC | buy2      |

    # Check the holding account amount before we amend
    And "party1" should have holding account balance of "50" for asset "ETH"
    ...
    # Check the holding account balance has been reduced to reflect the smaller iceberg volume
    And "party1" should have holding account balance of "20" for asset "ETH"

    # Check that the iceberg details have been modified correctly
      ...
      | party1 | BTC/ETH   | buy  | 2              | 1000  | STATUS_ACTIVE    | 0               | iceberg1   |
