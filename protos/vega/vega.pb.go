...
var file_vega_vega_proto_depIdxs = []int32{
	...
	107, // 54: vega.PerpetualData.index_price_type:type_name -> vega.CompositePriceType
	64,  // 55: vega.ProductData.perpetual_data:type_name -> vega.PerpetualData
	108, // 56: vega.MarketData.market_trading_mode:type_name -> vega.Market.TradingMode
	...
	109, // 61: vega.MarketData.market_state:type_name -> vega.Market.State
	...
	107, // 64: vega.MarketData.mark_price_type:type_name -> vega.CompositePriceType
	110, // 65: vega.PriceMonitoringBounds.trigger:type_name -> vega.PriceMonitoringTrigger
	...
	77,  // 71: vega.EthereumConfig.collateral_bridge_contract:type_name -> vega.EthereumContractConfig
	77,  // 72: vega.EthereumConfig.staking_bridge_contract:type_name -> vega.EthereumContractConfig
	77,  // 73: vega.EthereumConfig.token_vesting_contract:type_name -> vega.EthereumContractConfig
	77,  // 74: vega.EthereumConfig.multisig_control_contract:type_name -> vega.EthereumContractConfig
	78,  // 75: vega.Epoch.timestamps:type_name -> vega.EpochTimestamps
	84,  // 76: vega.Epoch.validators:type_name -> vega.Node
	87,  // 77: vega.Epoch.delegations:type_name -> vega.Delegation
	79,  // 78: vega.EpochParticipation.epoch:type_name -> vega.Epoch
	15,  // 79: vega.RankingScore.previous_status:type_name -> vega.ValidatorNodeStatus
	15,  // 80: vega.RankingScore.status:type_name -> vega.ValidatorNodeStatus
	15,  // 81: vega.RewardScore.validator_status:type_name -> vega.ValidatorNodeStatus
	81,  // 82: vega.Node.epoch_data:type_name -> vega.EpochData
	13,  // 83: vega.Node.status:type_name -> vega.NodeStatus
	87,  // 84: vega.Node.delegations:type_name -> vega.Delegation
	83,  // 85: vega.Node.reward_score:type_name -> vega.RewardScore
	82,  // 86: vega.Node.ranking_score:type_name -> vega.RankingScore
	85,  // 87: vega.NodeData.tendermint_nodes:type_name -> vega.NodeSet
	85,  // 88: vega.NodeData.ersatz_nodes:type_name -> vega.NodeSet
	85,  // 89: vega.NodeData.pending_nodes:type_name -> vega.NodeSet
	92,  // 90: vega.StateValueProposal.kvb:type_name -> vega.KeyValueBundle
	93,  // 91: vega.KeyValueBundle.value:type_name -> vega.StateVarValue
	94,  // 92: vega.StateVarValue.scalar_val:type_name -> vega.ScalarValue
	95,  // 93: vega.StateVarValue.vector_val:type_name -> vega.VectorValue
	96,  // 94: vega.StateVarValue.matrix_val:type_name -> vega.MatrixValue
	95,  // 95: vega.MatrixValue.value:type_name -> vega.VectorValue
	99,  // 96: vega.ReferralProgram.benefit_tiers:type_name -> vega.BenefitTier
	102, // 97: vega.ReferralProgram.staking_tiers:type_name -> vega.StakingTier
	101, // 98: vega.VestingBenefitTiers.tiers:type_name -> vega.VestingBenefitTier
	98,  // 99: vega.VolumeDiscountProgram.benefit_tiers:type_name -> vega.VolumeBenefitTier
	105, // 100: vega.ActivityStreakBenefitTiers.tiers:type_name -> vega.ActivityStreakBenefitTier
