Feature: Spot market SLA
  ...
  Scenario:
    ...
    When the parties submit the following liquidity provision:
      ...
      | lp1 | lpprov | BTC/ETH   | 2000              | 0.1 | submission |
    ...
    Then "lpprov" should have general account balance of "2000" for asset "ETH"
    ...
    Then the market data for the market "BTC/ETH" should be:
      ...
      | 0          | TRADING_MODE_OPENING_AUCTION | AUCTION_TRIGGER_OPENING | 20000        | 2000           | 0             |
