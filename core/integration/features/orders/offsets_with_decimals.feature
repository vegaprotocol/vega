Feature: Test how offsets are applied with decimals
  ...
  Scenario:
    ...
    Then the orders should have the following states:
      ...
      | lp1   | USD/DEC19 | buy  | 66667  | 2         | 999999  | STATUS_ACTIVE |
      | lp1   | USD/DEC19 | buy  | 33334  | 2         | 999999  | STATUS_ACTIVE |
      | lp1   | USD/DEC19 | sell | 33334  | 2         | 1000001 | STATUS_ACTIVE |
      | lp1   | USD/DEC19 | sell | 66667  | 2         | 1000001 | STATUS_ACTIVE |
    ...
    Then the orders should have the following states:
      ...
      | lp1    | USD/DEC19 | sell | 33334  | 2         | 1000001 | STATUS_ACTIVE |
      | lp1    | USD/DEC19 | sell | 66667  | 2         | 1000001 | STATUS_ACTIVE |
      | party3 | USD/DEC19 | buy  | 5      | 5         | 999999  | STATUS_ACTIVE |
      | party3 | USD/DEC19 | buy  | 4      | 4         | 999999  | STATUS_ACTIVE |
      | party3 | USD/DEC19 | sell | 3      | 3         | 1000001 | STATUS_ACTIVE |
      | party3 | USD/DEC19 | sell | 2      | 2         | 1000001 | STATUS_ACTIVE |
