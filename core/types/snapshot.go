...
const (
	...
	SecondaryEventForwarderSnapshot        SnapshotNamespace = "eventforwarder.secondary"
	...
	SecondaryERC20MultiSigTopologySnapshot SnapshotNamespace = "erc20multisigtopology.secondary"
