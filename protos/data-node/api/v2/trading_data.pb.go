...
var file_data_node_api_v2_trading_data_proto_rawDesc = []byte{
	...
	0x01, 0x20, 0x01, 0x28, 0x08, 0x52, 0x05, 0x72, 0x65, 0x61, 0x64, 0x79, 0x2a, 0xaa, 0x01, 0x0a,
	...
	0x54, 0x4f, 0x5f, 0x4f, 0x52, 0x5f, 0x46, 0x52, 0x4f, 0x4d, 0x10, 0x03, 0x32, 0xcb, 0x3e, 0x0a,
	...
	0x75, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x81, 0x01, 0x5a, 0x31, 0x63,
...
var file_data_node_api_v2_trading_data_proto_msgTypes = make([]protoimpl.MessageInfo, 241)
var file_data_node_api_v2_trading_data_proto_goTypes = []interface{}{
	...
	(vega.AccountType)(0),                                 // 245: vega.AccountType
	(*vega.Order)(nil),                                    // 246: vega.Order
	(*vega.Position)(nil),                                 // 247: vega.Position
	(vega.TransferType)(0),                                // 248: vega.TransferType
	(*vega.MarketDepth)(nil),                              // 249: vega.MarketDepth
	(*vega.MarketDepthUpdate)(nil),                        // 250: vega.MarketDepthUpdate
	(*vega.MarketData)(nil),                               // 251: vega.MarketData
	(*vega.PriceLevel)(nil),                               // 252: vega.PriceLevel
	(*vega.Trade)(nil),                                    // 253: vega.Trade
	(*v1.Transfer)(nil),                                   // 254: vega.events.v1.Transfer
	(*vega.NetworkLimits)(nil),                            // 255: vega.NetworkLimits
	(vega.Interval)(0),                                    // 256: vega.Interval
	(*vega.Vote)(nil),                                     // 257: vega.Vote
	(*v1.ERC20MultiSigSignerAdded)(nil),                   // 258: vega.events.v1.ERC20MultiSigSignerAdded
	(*v1.ERC20MultiSigSignerRemoved)(nil),                 // 259: vega.events.v1.ERC20MultiSigSignerRemoved
	(*v11.OracleSpec)(nil),                                // 260: oracles.v1.OracleSpec
	(*v11.OracleData)(nil),                                // 261: oracles.v1.OracleData
	(*vega.Market)(nil),                                   // 262: vega.Market
	(*vega.Party)(nil),                                    // 263: vega.Party
	(*vega.MarginLevels)(nil),                             // 264: vega.MarginLevels
	(*vega.Reward)(nil),                                   // 265: vega.Reward
	(*vega.RewardSummary)(nil),                            // 266: vega.RewardSummary
	(*vega.Deposit)(nil),                                  // 267: vega.Deposit
	(*vega.Withdrawal)(nil),                               // 268: vega.Withdrawal
	(*vega.Asset)(nil),                                    // 269: vega.Asset
	(*vega.LiquidityProvision)(nil),                       // 270: vega.LiquidityProvision
	(*vega.GovernanceData)(nil),                           // 271: vega.GovernanceData
	(vega.Proposal_State)(0),                              // 272: vega.Proposal.State
	(*vega.Delegation)(nil),                               // 273: vega.Delegation
	(*vega.NodeData)(nil),                                 // 274: vega.NodeData
	(*vega.Node)(nil),                                     // 275: vega.Node
	(*v12.NodeSignature)(nil),                             // 276: vega.commands.v1.NodeSignature
	(*vega.Epoch)(nil),                                    // 277: vega.Epoch
	(*vega.Fee)(nil),                                      // 278: vega.Fee
	(vega.Side)(0),                                        // 279: vega.Side
	(vega.Order_Type)(0),                                  // 280: vega.Order.Type
	(*vega.NetworkParameter)(nil),                         // 281: vega.NetworkParameter
	(*v1.StakeLinking)(nil),                               // 282: vega.events.v1.StakeLinking
	(*vega.RiskFactor)(nil),                               // 283: vega.RiskFactor
	(v1.BusEventType)(0),                                  // 284: vega.events.v1.BusEventType
	(*v1.BusEvent)(nil),                                   // 285: vega.events.v1.BusEvent
	(*vega.LedgerMovement)(nil),                           // 286: vega.LedgerMovement
	(*v1.KeyRotation)(nil),                                // 287: vega.events.v1.KeyRotation
	(*v1.EthereumKeyRotation)(nil),                        // 288: vega.events.v1.EthereumKeyRotation
}
var file_data_node_api_v2_trading_data_proto_depIdxs = []int32{
	245, // 0: datanode.api.v2.AccountBalance.type:type_name -> vega.AccountType
	...
	245, // 7: datanode.api.v2.ObserveAccountsRequest.type:type_name -> vega.AccountType
	...
	246, // 12: datanode.api.v2.GetOrderResponse.order:type_name -> vega.Order
	...
	246, // 20: datanode.api.v2.OrderSnapshotPage.orders:type_name -> vega.Order
	246, // 21: datanode.api.v2.OrderUpdates.orders:type_name -> vega.Order
	...
	247, // 24: datanode.api.v2.PositionEdge.node:type_name -> vega.Position
	...
	247, // 29: datanode.api.v2.PositionSnapshotPage.positions:type_name -> vega.Position
	247, // 30: datanode.api.v2.PositionUpdates.positions:type_name -> vega.Position
	...
	248, // 33: datanode.api.v2.LedgerEntryFilter.transfer_types:type_name -> vega.TransferType
	248, // 34: datanode.api.v2.AggregatedLedgerEntries.transfer_type:type_name -> vega.TransferType
	245, // 35: datanode.api.v2.AggregatedLedgerEntries.account_type:type_name -> vega.AccountType
	...
	245, // 58: datanode.api.v2.AccountFilter.account_types:type_name -> vega.AccountType
	245, // 59: datanode.api.v2.AggregatedBalance.account_type:type_name -> vega.AccountType
	249, // 60: datanode.api.v2.ObserveMarketsDepthResponse.market_depth:type_name -> vega.MarketDepth
	250, // 61: datanode.api.v2.ObserveMarketsDepthUpdatesResponse.update:type_name -> vega.MarketDepthUpdate
	251, // 62: datanode.api.v2.ObserveMarketsDataResponse.market_data:type_name -> vega.MarketData
	252, // 63: datanode.api.v2.GetLatestMarketDepthResponse.buy:type_name -> vega.PriceLevel
	252, // 64: datanode.api.v2.GetLatestMarketDepthResponse.sell:type_name -> vega.PriceLevel
	253, // 65: datanode.api.v2.GetLatestMarketDepthResponse.last_trade:type_name -> vega.Trade
	251, // 66: datanode.api.v2.ListLatestMarketDataResponse.markets_data:type_name -> vega.MarketData
	251, // 67: datanode.api.v2.GetLatestMarketDataResponse.market_data:type_name -> vega.MarketData
	...
	251, // 71: datanode.api.v2.MarketDataEdge.node:type_name -> vega.MarketData
	...
	251, // 74: datanode.api.v2.MarketsDataSubscribeResponse.market_data:type_name -> vega.MarketData
	...
	254, // 78: datanode.api.v2.TransferEdge.node:type_name -> vega.events.v1.Transfer
	...
	255, // 81: datanode.api.v2.GetNetworkLimitsResponse.limits:type_name -> vega.NetworkLimits
	...
	256, // 84: datanode.api.v2.ListCandleDataRequest.interval:type_name -> vega.Interval
	...
	257, // 92: datanode.api.v2.VoteEdge.node:type_name -> vega.Vote
	...
	257, // 95: datanode.api.v2.ObserveVotesResponse.vote:type_name -> vega.Vote
	...
	258, // 98: datanode.api.v2.ERC20MultiSigSignerAddedEdge.node:type_name -> vega.events.v1.ERC20MultiSigSignerAdded
	...
	259, // 104: datanode.api.v2.ERC20MultiSigSignerRemovedEdge.node:type_name -> vega.events.v1.ERC20MultiSigSignerRemoved
	...
	253, // 108: datanode.api.v2.GetLastTradeResponse.trade:type_name -> vega.Trade
	...
	253, // 114: datanode.api.v2.TradeEdge.node:type_name -> vega.Trade
	253, // 115: datanode.api.v2.ObserveTradesResponse.trades:type_name -> vega.Trade
	260, // 116: datanode.api.v2.GetOracleSpecResponse.oracle_spec:type_name -> oracles.v1.OracleSpec
	...
	260, // 121: datanode.api.v2.OracleSpecEdge.node:type_name -> oracles.v1.OracleSpec
	...
	261, // 124: datanode.api.v2.OracleDataEdge.node:type_name -> oracles.v1.OracleData
	...
	262, // 127: datanode.api.v2.GetMarketResponse.market:type_name -> vega.Market
	...
	262, // 130: datanode.api.v2.MarketEdge.node:type_name -> vega.Market
	...
	263, // 133: datanode.api.v2.GetPartyResponse.party:type_name -> vega.Party
	...
	263, // 136: datanode.api.v2.PartyEdge.node:type_name -> vega.Party
	...
	246, // 139: datanode.api.v2.OrderEdge.node:type_name -> vega.Order
	...
	264, // 142: datanode.api.v2.ObserveMarginLevelsResponse.margin_levels:type_name -> vega.MarginLevels
	...
	264, // 145: datanode.api.v2.MarginEdge.node:type_name -> vega.MarginLevels
	...
	265, // 150: datanode.api.v2.RewardEdge.node:type_name -> vega.Reward
	...
	266, // 154: datanode.api.v2.ListRewardSummariesResponse.summaries:type_name -> vega.RewardSummary
	265, // 155: datanode.api.v2.ObserveRewardsResponse.reward:type_name -> vega.Reward
	267, // 156: datanode.api.v2.GetDepositResponse.deposit:type_name -> vega.Deposit
	...
	267, // 160: datanode.api.v2.DepositEdge.node:type_name -> vega.Deposit
	...
	268, // 163: datanode.api.v2.GetWithdrawalResponse.withdrawal:type_name -> vega.Withdrawal
	...
	268, // 167: datanode.api.v2.WithdrawalEdge.node:type_name -> vega.Withdrawal
	...
	269, // 170: datanode.api.v2.GetAssetResponse.asset:type_name -> vega.Asset
	...
	269, // 173: datanode.api.v2.AssetEdge.node:type_name -> vega.Asset
	...
	270, // 178: datanode.api.v2.LiquidityProvisionsEdge.node:type_name -> vega.LiquidityProvision
	...
	270, // 181: datanode.api.v2.ObserveLiquidityProvisionsResponse.liquidity_provisions:type_name -> vega.LiquidityProvision
	271, // 182: datanode.api.v2.GetGovernanceDataResponse.data:type_name -> vega.GovernanceData
	272, // 183: datanode.api.v2.ListGovernanceDataRequest.proposal_state:type_name -> vega.Proposal.State
	...
	271, // 187: datanode.api.v2.GovernanceDataEdge.node:type_name -> vega.GovernanceData
	...
	271, // 190: datanode.api.v2.ObserveGovernanceResponse.data:type_name -> vega.GovernanceData
	...
	273, // 193: datanode.api.v2.DelegationEdge.node:type_name -> vega.Delegation
	...
	273, // 196: datanode.api.v2.ObserveDelegationsResponse.delegation:type_name -> vega.Delegation
	274, // 197: datanode.api.v2.GetNetworkDataResponse.node_data:type_name -> vega.NodeData
	275, // 198: datanode.api.v2.GetNodeResponse.node:type_name -> vega.Node
	...
	275, // 201: datanode.api.v2.NodeEdge.node:type_name -> vega.Node
	...
	276, // 206: datanode.api.v2.NodeSignatureEdge.node:type_name -> vega.commands.v1.NodeSignature
	...
	277, // 209: datanode.api.v2.GetEpochResponse.epoch:type_name -> vega.Epoch
	278, // 210: datanode.api.v2.EstimateFeeResponse.fee:type_name -> vega.Fee
	279, // 211: datanode.api.v2.EstimateMarginRequest.side:type_name -> vega.Side
	280, // 212: datanode.api.v2.EstimateMarginRequest.type:type_name -> vega.Order.Type
	264, // 213: datanode.api.v2.EstimateMarginResponse.margin_levels:type_name -> vega.MarginLevels
	...
	281, // 216: datanode.api.v2.GetNetworkParameterResponse.network_parameter:type_name -> vega.NetworkParameter
	281, // 217: datanode.api.v2.NetworkParameterEdge.node:type_name -> vega.NetworkParameter
	...
	282, // 227: datanode.api.v2.StakeLinkingEdge.node:type_name -> vega.events.v1.StakeLinking
	...
	283, // 230: datanode.api.v2.GetRiskFactorsResponse.risk_factor:type_name -> vega.RiskFactor
	284, // 231: datanode.api.v2.ObserveEventBusRequest.type:type_name -> vega.events.v1.BusEventType
	285, // 232: datanode.api.v2.ObserveEventBusResponse.events:type_name -> vega.events.v1.BusEvent
	286, // 233: datanode.api.v2.ObserveLedgerMovementsResponse.ledger_movement:type_name -> vega.LedgerMovement
	...
	287, // 236: datanode.api.v2.KeyRotationEdge.node:type_name -> vega.events.v1.KeyRotation
	...
	288, // 243: datanode.api.v2.EthereumKeyRotationEdge.ethereum_key_rotation:type_name -> vega.events.v1.EthereumKeyRotation
	8,   // 244: datanode.api.v2.TradingDataService.ListAccounts:input_type -> datanode.api.v2.ListAccountsRequest
	12,  // 245: datanode.api.v2.TradingDataService.ObserveAccounts:input_type -> datanode.api.v2.ObserveAccountsRequest
	16,  // 246: datanode.api.v2.TradingDataService.Info:input_type -> datanode.api.v2.InfoRequest
	18,  // 247: datanode.api.v2.TradingDataService.GetOrder:input_type -> datanode.api.v2.GetOrderRequest
	20,  // 248: datanode.api.v2.TradingDataService.ListOrders:input_type -> datanode.api.v2.ListOrdersRequest
	22,  // 249: datanode.api.v2.TradingDataService.ListOrderVersions:input_type -> datanode.api.v2.ListOrderVersionsRequest
	24,  // 250: datanode.api.v2.TradingDataService.ObserveOrders:input_type -> datanode.api.v2.ObserveOrdersRequest
	28,  // 251: datanode.api.v2.TradingDataService.ListPositions:input_type -> datanode.api.v2.ListPositionsRequest
	32,  // 252: datanode.api.v2.TradingDataService.ObservePositions:input_type -> datanode.api.v2.ObservePositionsRequest
	39,  // 253: datanode.api.v2.TradingDataService.ListLedgerEntries:input_type -> datanode.api.v2.ListLedgerEntriesRequest
	43,  // 254: datanode.api.v2.TradingDataService.ListBalanceChanges:input_type -> datanode.api.v2.ListBalanceChangesRequest
	61,  // 255: datanode.api.v2.TradingDataService.GetLatestMarketData:input_type -> datanode.api.v2.GetLatestMarketDataRequest
	59,  // 256: datanode.api.v2.TradingDataService.ListLatestMarketData:input_type -> datanode.api.v2.ListLatestMarketDataRequest
	57,  // 257: datanode.api.v2.TradingDataService.GetLatestMarketDepth:input_type -> datanode.api.v2.GetLatestMarketDepthRequest
	51,  // 258: datanode.api.v2.TradingDataService.ObserveMarketsDepth:input_type -> datanode.api.v2.ObserveMarketsDepthRequest
	53,  // 259: datanode.api.v2.TradingDataService.ObserveMarketsDepthUpdates:input_type -> datanode.api.v2.ObserveMarketsDepthUpdatesRequest
	55,  // 260: datanode.api.v2.TradingDataService.ObserveMarketsData:input_type -> datanode.api.v2.ObserveMarketsDataRequest
	63,  // 261: datanode.api.v2.TradingDataService.GetMarketDataHistoryByID:input_type -> datanode.api.v2.GetMarketDataHistoryByIDRequest
	69,  // 262: datanode.api.v2.TradingDataService.ListTransfers:input_type -> datanode.api.v2.ListTransfersRequest
	73,  // 263: datanode.api.v2.TradingDataService.GetNetworkLimits:input_type -> datanode.api.v2.GetNetworkLimitsRequest
	81,  // 264: datanode.api.v2.TradingDataService.ListCandleData:input_type -> datanode.api.v2.ListCandleDataRequest
	79,  // 265: datanode.api.v2.TradingDataService.ObserveCandleData:input_type -> datanode.api.v2.ObserveCandleDataRequest
	75,  // 266: datanode.api.v2.TradingDataService.ListCandleIntervals:input_type -> datanode.api.v2.ListCandleIntervalsRequest
	85,  // 267: datanode.api.v2.TradingDataService.ListVotes:input_type -> datanode.api.v2.ListVotesRequest
	89,  // 268: datanode.api.v2.TradingDataService.ObserveVotes:input_type -> datanode.api.v2.ObserveVotesRequest
	91,  // 269: datanode.api.v2.TradingDataService.ListERC20MultiSigSignerAddedBundles:input_type -> datanode.api.v2.ListERC20MultiSigSignerAddedBundlesRequest
	97,  // 270: datanode.api.v2.TradingDataService.ListERC20MultiSigSignerRemovedBundles:input_type -> datanode.api.v2.ListERC20MultiSigSignerRemovedBundlesRequest
	103, // 271: datanode.api.v2.TradingDataService.GetERC20ListAssetBundle:input_type -> datanode.api.v2.GetERC20ListAssetBundleRequest
	105, // 272: datanode.api.v2.TradingDataService.GetERC20SetAssetLimitsBundle:input_type -> datanode.api.v2.GetERC20SetAssetLimitsBundleRequest
	107, // 273: datanode.api.v2.TradingDataService.GetERC20WithdrawalApproval:input_type -> datanode.api.v2.GetERC20WithdrawalApprovalRequest
	109, // 274: datanode.api.v2.TradingDataService.GetLastTrade:input_type -> datanode.api.v2.GetLastTradeRequest
	111, // 275: datanode.api.v2.TradingDataService.ListTrades:input_type -> datanode.api.v2.ListTradesRequest
	115, // 276: datanode.api.v2.TradingDataService.ObserveTrades:input_type -> datanode.api.v2.ObserveTradesRequest
	117, // 277: datanode.api.v2.TradingDataService.GetOracleSpec:input_type -> datanode.api.v2.GetOracleSpecRequest
	119, // 278: datanode.api.v2.TradingDataService.ListOracleSpecs:input_type -> datanode.api.v2.ListOracleSpecsRequest
	121, // 279: datanode.api.v2.TradingDataService.ListOracleData:input_type -> datanode.api.v2.ListOracleDataRequest
	127, // 280: datanode.api.v2.TradingDataService.GetMarket:input_type -> datanode.api.v2.GetMarketRequest
	129, // 281: datanode.api.v2.TradingDataService.ListMarkets:input_type -> datanode.api.v2.ListMarketsRequest
	133, // 282: datanode.api.v2.TradingDataService.GetParty:input_type -> datanode.api.v2.GetPartyRequest
	135, // 283: datanode.api.v2.TradingDataService.ListParties:input_type -> datanode.api.v2.ListPartiesRequest
	140, // 284: datanode.api.v2.TradingDataService.ListMarginLevels:input_type -> datanode.api.v2.ListMarginLevelsRequest
	142, // 285: datanode.api.v2.TradingDataService.ObserveMarginLevels:input_type -> datanode.api.v2.ObserveMarginLevelsRequest
	147, // 286: datanode.api.v2.TradingDataService.ListRewards:input_type -> datanode.api.v2.ListRewardsRequest
	151, // 287: datanode.api.v2.TradingDataService.ListRewardSummaries:input_type -> datanode.api.v2.ListRewardSummariesRequest
	153, // 288: datanode.api.v2.TradingDataService.ObserveRewards:input_type -> datanode.api.v2.ObserveRewardsRequest
	155, // 289: datanode.api.v2.TradingDataService.GetDeposit:input_type -> datanode.api.v2.GetDepositRequest
	157, // 290: datanode.api.v2.TradingDataService.ListDeposits:input_type -> datanode.api.v2.ListDepositsRequest
	161, // 291: datanode.api.v2.TradingDataService.GetWithdrawal:input_type -> datanode.api.v2.GetWithdrawalRequest
	163, // 292: datanode.api.v2.TradingDataService.ListWithdrawals:input_type -> datanode.api.v2.ListWithdrawalsRequest
	167, // 293: datanode.api.v2.TradingDataService.GetAsset:input_type -> datanode.api.v2.GetAssetRequest
	169, // 294: datanode.api.v2.TradingDataService.ListAssets:input_type -> datanode.api.v2.ListAssetsRequest
	173, // 295: datanode.api.v2.TradingDataService.ListLiquidityProvisions:input_type -> datanode.api.v2.ListLiquidityProvisionsRequest
	177, // 296: datanode.api.v2.TradingDataService.ObserveLiquidityProvisions:input_type -> datanode.api.v2.ObserveLiquidityProvisionsRequest
	179, // 297: datanode.api.v2.TradingDataService.GetGovernanceData:input_type -> datanode.api.v2.GetGovernanceDataRequest
	181, // 298: datanode.api.v2.TradingDataService.ListGovernanceData:input_type -> datanode.api.v2.ListGovernanceDataRequest
	185, // 299: datanode.api.v2.TradingDataService.ObserveGovernance:input_type -> datanode.api.v2.ObserveGovernanceRequest
	187, // 300: datanode.api.v2.TradingDataService.ListDelegations:input_type -> datanode.api.v2.ListDelegationsRequest
	191, // 301: datanode.api.v2.TradingDataService.ObserveDelegations:input_type -> datanode.api.v2.ObserveDelegationsRequest
	193, // 302: datanode.api.v2.TradingDataService.GetNetworkData:input_type -> datanode.api.v2.GetNetworkDataRequest
	195, // 303: datanode.api.v2.TradingDataService.GetNode:input_type -> datanode.api.v2.GetNodeRequest
	197, // 304: datanode.api.v2.TradingDataService.ListNodes:input_type -> datanode.api.v2.ListNodesRequest
	201, // 305: datanode.api.v2.TradingDataService.ListNodeSignatures:input_type -> datanode.api.v2.ListNodeSignaturesRequest
	205, // 306: datanode.api.v2.TradingDataService.GetEpoch:input_type -> datanode.api.v2.GetEpochRequest
	207, // 307: datanode.api.v2.TradingDataService.EstimateFee:input_type -> datanode.api.v2.EstimateFeeRequest
	209, // 308: datanode.api.v2.TradingDataService.EstimateMargin:input_type -> datanode.api.v2.EstimateMarginRequest
	211, // 309: datanode.api.v2.TradingDataService.ListNetworkParameters:input_type -> datanode.api.v2.ListNetworkParametersRequest
	213, // 310: datanode.api.v2.TradingDataService.GetNetworkParameter:input_type -> datanode.api.v2.GetNetworkParameterRequest
	218, // 311: datanode.api.v2.TradingDataService.ListCheckpoints:input_type -> datanode.api.v2.ListCheckpointsRequest
	222, // 312: datanode.api.v2.TradingDataService.GetStake:input_type -> datanode.api.v2.GetStakeRequest
	226, // 313: datanode.api.v2.TradingDataService.GetRiskFactors:input_type -> datanode.api.v2.GetRiskFactorsRequest
	228, // 314: datanode.api.v2.TradingDataService.ObserveEventBus:input_type -> datanode.api.v2.ObserveEventBusRequest
	230, // 315: datanode.api.v2.TradingDataService.ObserveLedgerMovements:input_type -> datanode.api.v2.ObserveLedgerMovementsRequest
	232, // 316: datanode.api.v2.TradingDataService.ListKeyRotations:input_type -> datanode.api.v2.ListKeyRotationsRequest
	236, // 317: datanode.api.v2.TradingDataService.ListEthereumKeyRotations:input_type -> datanode.api.v2.ListEthereumKeyRotationsRequest
	240, // 318: datanode.api.v2.TradingDataService.GetVegaTime:input_type -> datanode.api.v2.GetVegaTimeRequest
	243, // 319: datanode.api.v2.TradingDataService.GetProtocolUpgradeStatus:input_type -> datanode.api.v2.GetProtocolUpgradeStatusRequest
	9,   // 320: datanode.api.v2.TradingDataService.ListAccounts:output_type -> datanode.api.v2.ListAccountsResponse
	13,  // 321: datanode.api.v2.TradingDataService.ObserveAccounts:output_type -> datanode.api.v2.ObserveAccountsResponse
	17,  // 322: datanode.api.v2.TradingDataService.Info:output_type -> datanode.api.v2.InfoResponse
	19,  // 323: datanode.api.v2.TradingDataService.GetOrder:output_type -> datanode.api.v2.GetOrderResponse
	21,  // 324: datanode.api.v2.TradingDataService.ListOrders:output_type -> datanode.api.v2.ListOrdersResponse
	23,  // 325: datanode.api.v2.TradingDataService.ListOrderVersions:output_type -> datanode.api.v2.ListOrderVersionsResponse
	25,  // 326: datanode.api.v2.TradingDataService.ObserveOrders:output_type -> datanode.api.v2.ObserveOrdersResponse
	29,  // 327: datanode.api.v2.TradingDataService.ListPositions:output_type -> datanode.api.v2.ListPositionsResponse
	33,  // 328: datanode.api.v2.TradingDataService.ObservePositions:output_type -> datanode.api.v2.ObservePositionsResponse
	40,  // 329: datanode.api.v2.TradingDataService.ListLedgerEntries:output_type -> datanode.api.v2.ListLedgerEntriesResponse
	44,  // 330: datanode.api.v2.TradingDataService.ListBalanceChanges:output_type -> datanode.api.v2.ListBalanceChangesResponse
	62,  // 331: datanode.api.v2.TradingDataService.GetLatestMarketData:output_type -> datanode.api.v2.GetLatestMarketDataResponse
	60,  // 332: datanode.api.v2.TradingDataService.ListLatestMarketData:output_type -> datanode.api.v2.ListLatestMarketDataResponse
	58,  // 333: datanode.api.v2.TradingDataService.GetLatestMarketDepth:output_type -> datanode.api.v2.GetLatestMarketDepthResponse
	52,  // 334: datanode.api.v2.TradingDataService.ObserveMarketsDepth:output_type -> datanode.api.v2.ObserveMarketsDepthResponse
	54,  // 335: datanode.api.v2.TradingDataService.ObserveMarketsDepthUpdates:output_type -> datanode.api.v2.ObserveMarketsDepthUpdatesResponse
	56,  // 336: datanode.api.v2.TradingDataService.ObserveMarketsData:output_type -> datanode.api.v2.ObserveMarketsDataResponse
	64,  // 337: datanode.api.v2.TradingDataService.GetMarketDataHistoryByID:output_type -> datanode.api.v2.GetMarketDataHistoryByIDResponse
	70,  // 338: datanode.api.v2.TradingDataService.ListTransfers:output_type -> datanode.api.v2.ListTransfersResponse
	74,  // 339: datanode.api.v2.TradingDataService.GetNetworkLimits:output_type -> datanode.api.v2.GetNetworkLimitsResponse
	82,  // 340: datanode.api.v2.TradingDataService.ListCandleData:output_type -> datanode.api.v2.ListCandleDataResponse
	80,  // 341: datanode.api.v2.TradingDataService.ObserveCandleData:output_type -> datanode.api.v2.ObserveCandleDataResponse
	77,  // 342: datanode.api.v2.TradingDataService.ListCandleIntervals:output_type -> datanode.api.v2.ListCandleIntervalsResponse
	86,  // 343: datanode.api.v2.TradingDataService.ListVotes:output_type -> datanode.api.v2.ListVotesResponse
	90,  // 344: datanode.api.v2.TradingDataService.ObserveVotes:output_type -> datanode.api.v2.ObserveVotesResponse
	92,  // 345: datanode.api.v2.TradingDataService.ListERC20MultiSigSignerAddedBundles:output_type -> datanode.api.v2.ListERC20MultiSigSignerAddedBundlesResponse
	98,  // 346: datanode.api.v2.TradingDataService.ListERC20MultiSigSignerRemovedBundles:output_type -> datanode.api.v2.ListERC20MultiSigSignerRemovedBundlesResponse
	104, // 347: datanode.api.v2.TradingDataService.GetERC20ListAssetBundle:output_type -> datanode.api.v2.GetERC20ListAssetBundleResponse
	106, // 348: datanode.api.v2.TradingDataService.GetERC20SetAssetLimitsBundle:output_type -> datanode.api.v2.GetERC20SetAssetLimitsBundleResponse
	108, // 349: datanode.api.v2.TradingDataService.GetERC20WithdrawalApproval:output_type -> datanode.api.v2.GetERC20WithdrawalApprovalResponse
	110, // 350: datanode.api.v2.TradingDataService.GetLastTrade:output_type -> datanode.api.v2.GetLastTradeResponse
	112, // 351: datanode.api.v2.TradingDataService.ListTrades:output_type -> datanode.api.v2.ListTradesResponse
	116, // 352: datanode.api.v2.TradingDataService.ObserveTrades:output_type -> datanode.api.v2.ObserveTradesResponse
	118, // 353: datanode.api.v2.TradingDataService.GetOracleSpec:output_type -> datanode.api.v2.GetOracleSpecResponse
	120, // 354: datanode.api.v2.TradingDataService.ListOracleSpecs:output_type -> datanode.api.v2.ListOracleSpecsResponse
	122, // 355: datanode.api.v2.TradingDataService.ListOracleData:output_type -> datanode.api.v2.ListOracleDataResponse
	128, // 356: datanode.api.v2.TradingDataService.GetMarket:output_type -> datanode.api.v2.GetMarketResponse
	130, // 357: datanode.api.v2.TradingDataService.ListMarkets:output_type -> datanode.api.v2.ListMarketsResponse
	134, // 358: datanode.api.v2.TradingDataService.GetParty:output_type -> datanode.api.v2.GetPartyResponse
	136, // 359: datanode.api.v2.TradingDataService.ListParties:output_type -> datanode.api.v2.ListPartiesResponse
	141, // 360: datanode.api.v2.TradingDataService.ListMarginLevels:output_type -> datanode.api.v2.ListMarginLevelsResponse
	143, // 361: datanode.api.v2.TradingDataService.ObserveMarginLevels:output_type -> datanode.api.v2.ObserveMarginLevelsResponse
	148, // 362: datanode.api.v2.TradingDataService.ListRewards:output_type -> datanode.api.v2.ListRewardsResponse
	152, // 363: datanode.api.v2.TradingDataService.ListRewardSummaries:output_type -> datanode.api.v2.ListRewardSummariesResponse
	154, // 364: datanode.api.v2.TradingDataService.ObserveRewards:output_type -> datanode.api.v2.ObserveRewardsResponse
	156, // 365: datanode.api.v2.TradingDataService.GetDeposit:output_type -> datanode.api.v2.GetDepositResponse
	158, // 366: datanode.api.v2.TradingDataService.ListDeposits:output_type -> datanode.api.v2.ListDepositsResponse
	162, // 367: datanode.api.v2.TradingDataService.GetWithdrawal:output_type -> datanode.api.v2.GetWithdrawalResponse
	164, // 368: datanode.api.v2.TradingDataService.ListWithdrawals:output_type -> datanode.api.v2.ListWithdrawalsResponse
	168, // 369: datanode.api.v2.TradingDataService.GetAsset:output_type -> datanode.api.v2.GetAssetResponse
	170, // 370: datanode.api.v2.TradingDataService.ListAssets:output_type -> datanode.api.v2.ListAssetsResponse
	174, // 371: datanode.api.v2.TradingDataService.ListLiquidityProvisions:output_type -> datanode.api.v2.ListLiquidityProvisionsResponse
	178, // 372: datanode.api.v2.TradingDataService.ObserveLiquidityProvisions:output_type -> datanode.api.v2.ObserveLiquidityProvisionsResponse
	180, // 373: datanode.api.v2.TradingDataService.GetGovernanceData:output_type -> datanode.api.v2.GetGovernanceDataResponse
	182, // 374: datanode.api.v2.TradingDataService.ListGovernanceData:output_type -> datanode.api.v2.ListGovernanceDataResponse
	186, // 375: datanode.api.v2.TradingDataService.ObserveGovernance:output_type -> datanode.api.v2.ObserveGovernanceResponse
	188, // 376: datanode.api.v2.TradingDataService.ListDelegations:output_type -> datanode.api.v2.ListDelegationsResponse
	192, // 377: datanode.api.v2.TradingDataService.ObserveDelegations:output_type -> datanode.api.v2.ObserveDelegationsResponse
	194, // 378: datanode.api.v2.TradingDataService.GetNetworkData:output_type -> datanode.api.v2.GetNetworkDataResponse
	196, // 379: datanode.api.v2.TradingDataService.GetNode:output_type -> datanode.api.v2.GetNodeResponse
	198, // 380: datanode.api.v2.TradingDataService.ListNodes:output_type -> datanode.api.v2.ListNodesResponse
	202, // 381: datanode.api.v2.TradingDataService.ListNodeSignatures:output_type -> datanode.api.v2.ListNodeSignaturesResponse
	206, // 382: datanode.api.v2.TradingDataService.GetEpoch:output_type -> datanode.api.v2.GetEpochResponse
	208, // 383: datanode.api.v2.TradingDataService.EstimateFee:output_type -> datanode.api.v2.EstimateFeeResponse
	210, // 384: datanode.api.v2.TradingDataService.EstimateMargin:output_type -> datanode.api.v2.EstimateMarginResponse
	212, // 385: datanode.api.v2.TradingDataService.ListNetworkParameters:output_type -> datanode.api.v2.ListNetworkParametersResponse
	214, // 386: datanode.api.v2.TradingDataService.GetNetworkParameter:output_type -> datanode.api.v2.GetNetworkParameterResponse
	219, // 387: datanode.api.v2.TradingDataService.ListCheckpoints:output_type -> datanode.api.v2.ListCheckpointsResponse
	223, // 388: datanode.api.v2.TradingDataService.GetStake:output_type -> datanode.api.v2.GetStakeResponse
	227, // 389: datanode.api.v2.TradingDataService.GetRiskFactors:output_type -> datanode.api.v2.GetRiskFactorsResponse
	229, // 390: datanode.api.v2.TradingDataService.ObserveEventBus:output_type -> datanode.api.v2.ObserveEventBusResponse
	231, // 391: datanode.api.v2.TradingDataService.ObserveLedgerMovements:output_type -> datanode.api.v2.ObserveLedgerMovementsResponse
	233, // 392: datanode.api.v2.TradingDataService.ListKeyRotations:output_type -> datanode.api.v2.ListKeyRotationsResponse
	237, // 393: datanode.api.v2.TradingDataService.ListEthereumKeyRotations:output_type -> datanode.api.v2.ListEthereumKeyRotationsResponse
	241, // 394: datanode.api.v2.TradingDataService.GetVegaTime:output_type -> datanode.api.v2.GetVegaTimeResponse
	244, // 395: datanode.api.v2.TradingDataService.GetProtocolUpgradeStatus:output_type -> datanode.api.v2.GetProtocolUpgradeStatusResponse
	320, // [320:396] is the sub-list for method output_type
	244, // [244:320] is the sub-list for method input_type
