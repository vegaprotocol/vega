Feature: vAMM behaviour when a market settles
  ...
  Scenario Outline: 0090-VAMM-031: When an AMM is active on a market at time of settlement with a position in a well collateralised state, the market can settle successfully and then all funds on the AMM key are transferred back to the main party's account.
    ...
    And the parties should have the following account balances:
      ...
      | vamm1    | USD   |           | 0       |        |        |
      | vamm1-id | USD   | ETH/MAR22 | 778     | 223     | true   |
    ...
    Examples:
      ...
      | 106          | 223    | 1001        | 1001            | # settle price = market price: +1 from fees
      | 105          | 224     | 1002        | 1002            | # settle price < market price: +1 from fees +1 from final settlement
      | 107          | 222     | 1000        | 1000            | # settle price > market price: +1 from fees, -1 from final settlement
      | 104          | 225     | 1003        | 1003            | # settle price < market price: +1 from fees +2 from final settlement
      | 108          | 221     | 999         | 999             | # settle price > market price: +1 from fees, -2 from final settlement
