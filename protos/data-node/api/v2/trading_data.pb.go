...
type TransferInstructionDirection int32

const (
	TransferInstructionDirection_TRANSFER_INSTRUCTION_DIRECTION_UNSPECIFIED         TransferInstructionDirection = 0
	TransferInstructionDirection_TRANSFER_INSTRUCTION_DIRECTION_TRANSFER_FROM       TransferInstructionDirection = 1
	TransferInstructionDirection_TRANSFER_INSTRUCTION_DIRECTION_TRANSFER_TO         TransferInstructionDirection = 2
	TransferInstructionDirection_TRANSFER_INSTRUCTION_DIRECTION_TRANSFER_TO_OR_FROM TransferInstructionDirection = 3
)

// Enum value maps for TransferInstructionDirection.
var (
	TransferInstructionDirection_name = map[int32]string{
		0: "TRANSFER_INSTRUCTION_DIRECTION_UNSPECIFIED",
		1: "TRANSFER_INSTRUCTION_DIRECTION_TRANSFER_FROM",
		2: "TRANSFER_INSTRUCTION_DIRECTION_TRANSFER_TO",
		3: "TRANSFER_INSTRUCTION_DIRECTION_TRANSFER_TO_OR_FROM",
	}
	TransferInstructionDirection_value = map[string]int32{
		"TRANSFER_INSTRUCTION_DIRECTION_UNSPECIFIED":         0,
		"TRANSFER_INSTRUCTION_DIRECTION_TRANSFER_FROM":       1,
		"TRANSFER_INSTRUCTION_DIRECTION_TRANSFER_TO":         2,
		"TRANSFER_INSTRUCTION_DIRECTION_TRANSFER_TO_OR_FROM": 3,
	}
)

func (x TransferInstructionDirection) Enum() *TransferInstructionDirection {
	p := new(TransferInstructionDirection)
	*p = x
	return p
}

func (x TransferInstructionDirection) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (TransferInstructionDirection) Descriptor() protoreflect.EnumDescriptor {
	return file_data_node_api_v2_trading_data_proto_enumTypes[1].Descriptor()
}

func (TransferInstructionDirection) Type() protoreflect.EnumType {
	return &file_data_node_api_v2_trading_data_proto_enumTypes[1]
}

func (x TransferInstructionDirection) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use TransferInstructionDirection.Descriptor instead.
func (TransferInstructionDirection) EnumDescriptor() ([]byte, []int) {
...
func (ListGovernanceDataRequest_Type) EnumDescriptor() ([]byte, []int) {
	return file_data_node_api_v2_trading_data_proto_rawDescGZIP(), []int{167, 0}
}
...
func (x *AccountSnapshotPage) GetAccounts() []*vega.Account {
	if x != nil {
		return x.Accounts
	}
	return nil
...
func (x *AccountUpdates) GetAccounts() []*vega.Account {
	if x != nil {
		return x.Accounts
	}
	return nil
...
type ListTransferInstructionsRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// Public key of which transfer instructions to request
	...
	Direction TransferInstructionDirection `protobuf:"varint,2,opt,name=direction,proto3,enum=datanode.api.v2.TransferInstructionDirection" json:"direction,omitempty"`
	// Optional pagination cntrol
	Pagination *Pagination `protobuf:"bytes,3,opt,name=pagination,proto3,oneof" json:"pagination,omitempty"`
}

func (x *ListTransferInstructionsRequest) Reset() {
	*x = ListTransferInstructionsRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *ListTransferInstructionsRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ListTransferInstructionsRequest) ProtoMessage() {}

func (x *ListTransferInstructionsRequest) ProtoReflect() protoreflect.Message {
	mi := &file_data_node_api_v2_trading_data_proto_msgTypes[55]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ListTransferInstructionsRequest.ProtoReflect.Descriptor instead.
func (*ListTransferInstructionsRequest) Descriptor() ([]byte, []int) {
	return file_data_node_api_v2_trading_data_proto_rawDescGZIP(), []int{55}
}

func (x *ListTransferInstructionsRequest) GetPubkey() string {
...
func (x *ListTransferInstructionsRequest) GetDirection() TransferInstructionDirection {
	if x != nil {
		return x.Direction
	}
	return TransferInstructionDirection_TRANSFER_INSTRUCTION_DIRECTION_UNSPECIFIED
}

func (x *ListTransferInstructionsRequest) GetPagination() *Pagination {
	if x != nil {
		return x.Pagination
	}
	return nil
...
// Response for transfer instructions
type ListTransferInstructionsResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	TransferInstructions *TransferInstructionConnection `protobuf:"bytes,1,opt,name=transfer_instructions,json=transferInstructions,proto3" json:"transfer_instructions,omitempty"`
}

func (x *ListTransferInstructionsResponse) Reset() {
	*x = ListTransferInstructionsResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *ListTransferInstructionsResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ListTransferInstructionsResponse) ProtoMessage() {}

func (x *ListTransferInstructionsResponse) ProtoReflect() protoreflect.Message {
	mi := &file_data_node_api_v2_trading_data_proto_msgTypes[56]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ListTransferInstructionsResponse.ProtoReflect.Descriptor instead.
func (*ListTransferInstructionsResponse) Descriptor() ([]byte, []int) {
	return file_data_node_api_v2_trading_data_proto_rawDescGZIP(), []int{56}
}

func (x *ListTransferInstructionsResponse) GetTransferInstructions() *TransferInstructionConnection {
	if x != nil {
		return x.TransferInstructions
	}
	return nil
}

type TransferInstructionEdge struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Node   *v1.TransferInstruction `protobuf:"bytes,1,opt,name=node,proto3" json:"node,omitempty"`
	Cursor string                  `protobuf:"bytes,2,opt,name=cursor,proto3" json:"cursor,omitempty"`
}

func (x *TransferInstructionEdge) Reset() {
	*x = TransferInstructionEdge{}
	if protoimpl.UnsafeEnabled {
...
func (x *TransferInstructionEdge) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TransferInstructionEdge) ProtoMessage() {}

func (x *TransferInstructionEdge) ProtoReflect() protoreflect.Message {
	mi := &file_data_node_api_v2_trading_data_proto_msgTypes[57]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TransferInstructionEdge.ProtoReflect.Descriptor instead.
func (*TransferInstructionEdge) Descriptor() ([]byte, []int) {
	return file_data_node_api_v2_trading_data_proto_rawDescGZIP(), []int{57}
}

func (x *TransferInstructionEdge) GetNode() *v1.TransferInstruction {
	if x != nil {
		return x.Node
	}
	return nil
...
func (x *TransferInstructionEdge) GetCursor() string {
	if x != nil {
		return x.Cursor
	}
	return ""
...
type TransferInstructionConnection struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Edges    []*TransferInstructionEdge `protobuf:"bytes,1,rep,name=edges,proto3" json:"edges,omitempty"`
	PageInfo *PageInfo                  `protobuf:"bytes,2,opt,name=page_info,json=pageInfo,proto3" json:"page_info,omitempty"`
}

func (x *TransferInstructionConnection) Reset() {
	*x = TransferInstructionConnection{}
	if protoimpl.UnsafeEnabled {
...
func (x *TransferInstructionConnection) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TransferInstructionConnection) ProtoMessage() {}

func (x *TransferInstructionConnection) ProtoReflect() protoreflect.Message {
	mi := &file_data_node_api_v2_trading_data_proto_msgTypes[58]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TransferInstructionConnection.ProtoReflect.Descriptor instead.
func (*TransferInstructionConnection) Descriptor() ([]byte, []int) {
	return file_data_node_api_v2_trading_data_proto_rawDescGZIP(), []int{58}
}

func (x *TransferInstructionConnection) GetEdges() []*TransferInstructionEdge {
	if x != nil {
		return x.Edges
	}
	return nil
...
func (x *TransferInstructionConnection) GetPageInfo() *PageInfo {
	if x != nil {
		return x.PageInfo
	}
	return nil
...
// -- Transfer Instruction Responses --
type ObserveTransferInstructionResponsesRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *ObserveTransferInstructionResponsesRequest) Reset() {
	*x = ObserveTransferInstructionResponsesRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *ObserveTransferInstructionResponsesRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ObserveTransferInstructionResponsesRequest) ProtoMessage() {}

func (x *ObserveTransferInstructionResponsesRequest) ProtoReflect() protoreflect.Message {
	mi := &file_data_node_api_v2_trading_data_proto_msgTypes[216]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ObserveTransferInstructionResponsesRequest.ProtoReflect.Descriptor instead.
func (*ObserveTransferInstructionResponsesRequest) Descriptor() ([]byte, []int) {
	return file_data_node_api_v2_trading_data_proto_rawDescGZIP(), []int{216}
}

type ObserveTransferInstructionResponsesResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Response *vega.TransferInstructionResponse `protobuf:"bytes,1,opt,name=response,proto3" json:"response,omitempty"`
}

func (x *ObserveTransferInstructionResponsesResponse) Reset() {
	*x = ObserveTransferInstructionResponsesResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *ObserveTransferInstructionResponsesResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ObserveTransferInstructionResponsesResponse) ProtoMessage() {}

func (x *ObserveTransferInstructionResponsesResponse) ProtoReflect() protoreflect.Message {
	mi := &file_data_node_api_v2_trading_data_proto_msgTypes[217]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ObserveTransferInstructionResponsesResponse.ProtoReflect.Descriptor instead.
func (*ObserveTransferInstructionResponsesResponse) Descriptor() ([]byte, []int) {
	return file_data_node_api_v2_trading_data_proto_rawDescGZIP(), []int{217}
}

func (x *ObserveTransferInstructionResponsesResponse) GetResponse() *vega.TransferInstructionResponse {
	if x != nil {
		return x.Response
	}
	return nil
...
var file_data_node_api_v2_trading_data_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x09, 0x52, 0x09, 0x65, 0x6e, 0x64, 0x43, 0x75, 0x72, 0x73, 0x6f, 0x72, 0x22, 0x9e,
	...
	0x6f, 0x52, 0x08, 0x70, 0x61, 0x67, 0x65, 0x49, 0x6e, 0x66, 0x6f, 0x22, 0x4e, 0x0a, 0x0b, 0x41,
	0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x45, 0x64, 0x67, 0x65, 0x12, 0x27, 0x0a, 0x07, 0x61, 0x63,
	0x63, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0d, 0x2e, 0x76, 0x65,
	0x67, 0x61, 0x2e, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x52, 0x07, 0x61, 0x63, 0x63, 0x6f,
	0x75, 0x6e, 0x74, 0x12, 0x16, 0x0a, 0x06, 0x63, 0x75, 0x72, 0x73, 0x6f, 0x72, 0x18, 0x02, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x06, 0x63, 0x75, 0x72, 0x73, 0x6f, 0x72, 0x22, 0x8d, 0x01, 0x0a, 0x16,
	...
	,
	...
	0x63, 0x6f, 0x75, 0x6e, 0x74, 0x73, 0x12, 0x1b, 0x0a, 0x09, 0x6c, 0x61, 0x73, 0x74, 0x5f, 0x70,
	0x61, 0x67, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x08, 0x52, 0x08, 0x6c, 0x61, 0x73, 0x74, 0x50,
	0x61, 0x67, 0x65, 0x22, 0x3b, 0x0a, 0x0e, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x55, 0x70,
	0x64, 0x61, 0x74, 0x65, 0x73, 0x12, 0x29, 0x0a, 0x08, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74,
	0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x0d, 0x2e, 0x76, 0x65, 0x67, 0x61, 0x2e, 0x41,
	...
	0x63, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x48, 0x61, 0x73, 0x68, 0x22, 0x57, 0x0a, 0x0f, 0x47, 0x65,
	...
	0x07, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x49, 0x64, 0x12, 0x1d, 0x0a, 0x07, 0x76, 0x65, 0x72, 0x73,
	0x69, 0x6f, 0x6e, 0x18, 0x02, 0x20, 0x01, 0x28, 0x05, 0x48, 0x00, 0x52, 0x07, 0x76, 0x65, 0x72,
	0x73, 0x69, 0x6f, 0x6e, 0x88, 0x01, 0x01, 0x42, 0x0a, 0x0a, 0x08, 0x5f, 0x76, 0x65, 0x72, 0x73,
	0x69, 0x6f, 0x6e, 0x22, 0x35, 0x0a, 0x10, 0x47, 0x65, 0x74, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x52,
	...
	0x64, 0x65, 0x72, 0x52, 0x05, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x22, 0xf1, 0x02, 0x0a, 0x11, 0x4c,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x88, 0x01, 0x01, 0x12, 0x20, 0x0a, 0x09, 0x6c, 0x69, 0x76, 0x65, 0x5f,
	0x6f, 0x6e, 0x6c, 0x79, 0x18, 0x05, 0x20, 0x01, 0x28, 0x08, 0x48, 0x04, 0x52, 0x08, 0x6c, 0x69,
	0x76, 0x65, 0x4f, 0x6e, 0x6c, 0x79, 0x88, 0x01, 0x01, 0x12, 0x3e, 0x0a, 0x0a, 0x64, 0x61, 0x74,
	...
	0x44, 0x61, 0x74, 0x65, 0x52, 0x61, 0x6e, 0x67, 0x65, 0x48, 0x05, 0x52, 0x09, 0x64, 0x61, 0x74,
	0x65, 0x52, 0x61, 0x6e, 0x67, 0x65, 0x88, 0x01, 0x01, 0x42, 0x0b, 0x0a, 0x09, 0x5f, 0x70, 0x61,
	0x72, 0x74, 0x79, 0x5f, 0x69, 0x64, 0x42, 0x0c, 0x0a, 0x0a, 0x5f, 0x6d, 0x61, 0x72, 0x6b, 0x65,
	0x74, 0x5f, 0x69, 0x64, 0x42, 0x0c, 0x0a, 0x0a, 0x5f, 0x72, 0x65, 0x66, 0x65, 0x72, 0x65, 0x6e,
	0x63, 0x65, 0x42, 0x0d, 0x0a, 0x0b, 0x5f, 0x70, 0x61, 0x67, 0x69, 0x6e, 0x61, 0x74, 0x69, 0x6f,
	0x6e, 0x42, 0x0c, 0x0a, 0x0a, 0x5f, 0x6c, 0x69, 0x76, 0x65, 0x5f, 0x6f, 0x6e, 0x6c, 0x79, 0x42,
	...
	,
	...
	0x69, 0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x55, 0x0a, 0x19, 0x4c, 0x69, 0x73, 0x74, 0x4f,
	0x72, 0x64, 0x65, 0x72, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x73, 0x52, 0x65, 0x73, 0x70,
	0x6f, 0x6e, 0x73, 0x65, 0x12, 0x38, 0x0a, 0x06, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x73, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x20, 0x2e, 0x64, 0x61, 0x74, 0x61, 0x6e, 0x6f, 0x64, 0x65, 0x2e,
	0x61, 0x70, 0x69, 0x2e, 0x76, 0x32, 0x2e, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x43, 0x6f, 0x6e, 0x6e,
	0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x06, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x73, 0x22, 0x73,
	0x0a, 0x14, 0x4f, 0x62, 0x73, 0x65, 0x72, 0x76, 0x65, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x73, 0x52,
	...
	0x5f, 0x69, 0x64, 0x22, 0xa0, 0x01, 0x0a, 0x15, 0x4f, 0x62, 0x73, 0x65, 0x72, 0x76, 0x65, 0x4f,
	...
	,
	...
	0x01, 0x28, 0x08, 0x52, 0x08, 0x6c, 0x61, 0x73, 0x74, 0x50, 0x61, 0x67, 0x65, 0x22, 0x33, 0x0a,
	0x0c, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x73, 0x12, 0x23, 0x0a,
	...
	0x72, 0x73, 0x22, 0x9f, 0x01, 0x0a, 0x14, 0x4c, 0x69, 0x73, 0x74, 0x50, 0x6f, 0x73, 0x69, 0x74,
	0x69, 0x6f, 0x6e, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x19, 0x0a, 0x08, 0x70,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x22, 0x5a, 0x0a, 0x15, 0x4c, 0x69, 0x73, 0x74, 0x50, 0x6f, 0x73, 0x69,
	...
	0x6f, 0x73, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x22, 0xac, 0x02, 0x0a, 0x18, 0x47, 0x65, 0x74,
	...
	0x52, 0x0c, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x54, 0x79, 0x70, 0x65, 0x73, 0x22, 0xbe,
	...
	0x01, 0x28, 0x09, 0x52, 0x07, 0x62, 0x61, 0x6c, 0x61, 0x6e, 0x63, 0x65, 0x12, 0x22, 0x0a, 0x0a,
	...
	0x12, 0x1e, 0x0a, 0x08, 0x70, 0x61, 0x72, 0x74, 0x79, 0x5f, 0x69, 0x64, 0x18, 0x04, 0x20, 0x01,
	...
	0x28, 0x09, 0x48, 0x02, 0x52, 0x07, 0x61, 0x73, 0x73, 0x65, 0x74, 0x49, 0x64, 0x88, 0x01, 0x01,
	0x12, 0x20, 0x0a, 0x09, 0x6d, 0x61, 0x72, 0x6b, 0x65, 0x74, 0x5f, 0x69, 0x64, 0x18, 0x06, 0x20,
	0x01, 0x28, 0x09, 0x48, 0x03, 0x52, 0x08, 0x6d, 0x61, 0x72, 0x6b, 0x65, 0x74, 0x49, 0x64, 0x88,
	0x01, 0x01, 0x12, 0x34, 0x0a, 0x0c, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x5f, 0x74, 0x79,
	...
	0x6f, 0x75, 0x6e, 0x74, 0x54, 0x79, 0x70, 0x65, 0x42, 0x0d, 0x0a, 0x0b, 0x5f, 0x61, 0x63, 0x63,
	0x6f, 0x75, 0x6e, 0x74, 0x5f, 0x69, 0x64, 0x42, 0x0b, 0x0a, 0x09, 0x5f, 0x70, 0x61, 0x72, 0x74,
	0x79, 0x5f, 0x69, 0x64, 0x42, 0x0b, 0x0a, 0x09, 0x5f, 0x61, 0x73, 0x73, 0x65, 0x74, 0x5f, 0x69,
	0x64, 0x42, 0x0c, 0x0a, 0x0a, 0x5f, 0x6d, 0x61, 0x72, 0x6b, 0x65, 0x74, 0x5f, 0x69, 0x64, 0x22,
	...
	,
	...
	0x42, 0x0d, 0x0a, 0x0b, 0x5f, 0x70, 0x61, 0x67, 0x69, 0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22,
	0x87, 0x01, 0x0a, 0x20, 0x4c, 0x69, 0x73, 0x74, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x66, 0x65, 0x72,
	0x49, 0x6e, 0x73, 0x74, 0x72, 0x75, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x52, 0x65, 0x73, 0x70,
	0x6f, 0x6e, 0x73, 0x65, 0x12, 0x63, 0x0a, 0x15, 0x74, 0x72, 0x61, 0x6e, 0x73, 0x66, 0x65, 0x72,
	...
	0x70, 0x69, 0x2e, 0x76, 0x32, 0x2e, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x66, 0x65, 0x72, 0x49, 0x6e,
	0x73, 0x74, 0x72, 0x75, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x43, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74,
	0x69, 0x6f, 0x6e, 0x52, 0x14, 0x74, 0x72, 0x61, 0x6e, 0x73, 0x66, 0x65, 0x72, 0x49, 0x6e, 0x73,
	0x74, 0x72, 0x75, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x22, 0x6a, 0x0a, 0x17, 0x54, 0x72, 0x61,
	...
	0x2e, 0x76, 0x31, 0x2e, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x66, 0x65, 0x72, 0x49, 0x6e, 0x73, 0x74,
	0x72, 0x75, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x04, 0x6e, 0x6f, 0x64, 0x65, 0x12, 0x16, 0x0a,
	0x06, 0x63, 0x75, 0x72, 0x73, 0x6f, 0x72, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x63,
	0x75, 0x72, 0x73, 0x6f, 0x72, 0x22, 0x97, 0x01, 0x0a, 0x1d, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x66,
	0x65, 0x72, 0x49, 0x6e, 0x73, 0x74, 0x72, 0x75, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x43, 0x6f, 0x6e,
	...
	0x72, 0x49, 0x6e, 0x73, 0x74, 0x72, 0x75, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x45, 0x64, 0x67, 0x65,
	...
	0x74, 0x65, 0x22, 0xbc, 0x01, 0x0a, 0x29, 0x47, 0x65, 0x74, 0x45, 0x52, 0x43, 0x32, 0x30, 0x4d,
	...
	0x6e, 0x22, 0x7b, 0x0a, 0x2a, 0x47, 0x65, 0x74, 0x45, 0x52, 0x43, 0x32, 0x30, 0x4d, 0x75, 0x6c,
	...
	0x53, 0x65, 0x71, 0x22, 0xbe, 0x01, 0x0a, 0x2b, 0x47, 0x65, 0x74, 0x45, 0x52, 0x43, 0x32, 0x30,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x22, 0x7f, 0x0a, 0x2c, 0x47, 0x65, 0x74, 0x45, 0x52, 0x43, 0x32, 0x30,
	0x4d, 0x75, 0x6c, 0x74, 0x69, 0x53, 0x69, 0x67, 0x53, 0x69, 0x67, 0x6e, 0x65, 0x72, 0x52, 0x65,
	...
	0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x4d, 0x0a, 0x13, 0x4c, 0x69, 0x73, 0x74, 0x50, 0x61, 0x72,
	0x74, 0x69, 0x65, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x36, 0x0a, 0x05,
	0x70, 0x61, 0x72, 0x74, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x20, 0x2e, 0x64, 0x61,
	0x74, 0x61, 0x6e, 0x6f, 0x64, 0x65, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x76, 0x32, 0x2e, 0x50, 0x61,
	0x72, 0x74, 0x79, 0x43, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x05, 0x70,
	0x61, 0x72, 0x74, 0x79, 0x22, 0x44, 0x0a, 0x09, 0x50, 0x61, 0x72, 0x74, 0x79, 0x45, 0x64, 0x67,
	...
	0x05, 0x65, 0x70, 0x6f, 0x63, 0x68, 0x22, 0x37, 0x0a, 0x12, 0x45, 0x73, 0x74, 0x69, 0x6d, 0x61,
	0x74, 0x65, 0x46, 0x65, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x21, 0x0a, 0x05,
	...
	0x66, 0x65, 0x65, 0x22, 0x3a, 0x0a, 0x15, 0x45, 0x73, 0x74, 0x69, 0x6d, 0x61, 0x74, 0x65, 0x4d,
	0x61, 0x72, 0x67, 0x69, 0x6e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x21, 0x0a, 0x05,
	0x6f, 0x72, 0x64, 0x65, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0b, 0x2e, 0x76, 0x65,
	0x67, 0x61, 0x2e, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x52, 0x05, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x22,
	...
	0x74, 0x73, 0x22, 0x2c, 0x0a, 0x2a, 0x4f, 0x62, 0x73, 0x65, 0x72, 0x76, 0x65, 0x54, 0x72, 0x61,
	0x6e, 0x73, 0x66, 0x65, 0x72, 0x49, 0x6e, 0x73, 0x74, 0x72, 0x75, 0x63, 0x74, 0x69, 0x6f, 0x6e,
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	0x22, 0x6c, 0x0a, 0x2b, 0x4f, 0x62, 0x73, 0x65, 0x72, 0x76, 0x65, 0x54, 0x72, 0x61, 0x6e, 0x73,
	0x66, 0x65, 0x72, 0x49, 0x6e, 0x73, 0x74, 0x72, 0x75, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x65,
	...
	0x0b, 0x32, 0x21, 0x2e, 0x76, 0x65, 0x67, 0x61, 0x2e, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x66, 0x65,
	0x72, 0x49, 0x6e, 0x73, 0x74, 0x72, 0x75, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x73, 0x70,
	...
	0x6f, 0x22, 0x8a, 0x01, 0x0a, 0x17, 0x45, 0x74, 0x68, 0x65, 0x72, 0x65, 0x75, 0x6d, 0x4b, 0x65,
	0x79, 0x52, 0x6f, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x45, 0x64, 0x67, 0x65, 0x12, 0x57, 0x0a,
	0x15, 0x65, 0x74, 0x68, 0x65, 0x72, 0x65, 0x75, 0x6d, 0x5f, 0x6b, 0x65, 0x79, 0x5f, 0x72, 0x6f,
	0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x23, 0x2e, 0x76,
	...
	0x6e, 0x52, 0x13, 0x65, 0x74, 0x68, 0x65, 0x72, 0x65, 0x75, 0x6d, 0x4b, 0x65, 0x79, 0x52, 0x6f,
	0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x16, 0x0a, 0x06, 0x63, 0x75, 0x72, 0x73, 0x6f, 0x72,
	...
	0x73, 0x74, 0x61, 0x6d, 0x70, 0x2a, 0xb0, 0x01, 0x0a, 0x0c, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e,
	...
	,
	...
	0x6e, 0x73, 0x65, 0x30, 0x01, 0x12, 0x6c, 0x0a, 0x11, 0x47, 0x65, 0x74, 0x42, 0x61, 0x6c, 0x61,
	0x6e, 0x63, 0x65, 0x48, 0x69, 0x73, 0x74, 0x6f, 0x72, 0x79, 0x12, 0x29, 0x2e, 0x64, 0x61, 0x74,
	...
	0x7f, 0x0a, 0x18, 0x4c, 0x69, 0x73, 0x74, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x66, 0x65, 0x72, 0x49,
	0x6e, 0x73, 0x74, 0x72, 0x75, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x12, 0x30, 0x2e, 0x64, 0x61,
	0x74, 0x61, 0x6e, 0x6f, 0x64, 0x65, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x76, 0x32, 0x2e, 0x4c, 0x69,
	0x73, 0x74, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x66, 0x65, 0x72, 0x49, 0x6e, 0x73, 0x74, 0x72, 0x75,
	0x63, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x31, 0x2e,
	0x64, 0x61, 0x74, 0x61, 0x6e, 0x6f, 0x64, 0x65, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x76, 0x32, 0x2e,
	0x4c, 0x69, 0x73, 0x74, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x66, 0x65, 0x72, 0x49, 0x6e, 0x73, 0x74,
	...
	0x9d, 0x01, 0x0a, 0x22, 0x47, 0x65, 0x74, 0x45, 0x52, 0x43, 0x32, 0x30, 0x4d, 0x75, 0x6c, 0x74,
	0x69, 0x53, 0x69, 0x67, 0x53, 0x69, 0x67, 0x6e, 0x65, 0x72, 0x41, 0x64, 0x64, 0x65, 0x64, 0x42,
	0x75, 0x6e, 0x64, 0x6c, 0x65, 0x73, 0x12, 0x3a, 0x2e, 0x64, 0x61, 0x74, 0x61, 0x6e, 0x6f, 0x64,
	...
	0x74, 0x69, 0x53, 0x69, 0x67, 0x53, 0x69, 0x67, 0x6e, 0x65, 0x72, 0x41, 0x64, 0x64, 0x65, 0x64,
	0x42, 0x75, 0x6e, 0x64, 0x6c, 0x65, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12,
	0xa3, 0x01, 0x0a, 0x24, 0x47, 0x65, 0x74, 0x45, 0x52, 0x43, 0x32, 0x30, 0x4d, 0x75, 0x6c, 0x74,
	0x69, 0x53, 0x69, 0x67, 0x53, 0x69, 0x67, 0x6e, 0x65, 0x72, 0x52, 0x65, 0x6d, 0x6f, 0x76, 0x65,
	0x64, 0x42, 0x75, 0x6e, 0x64, 0x6c, 0x65, 0x73, 0x12, 0x3c, 0x2e, 0x64, 0x61, 0x74, 0x61, 0x6e,
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x28, 0x01, 0x30, 0x01, 0x12, 0xa2, 0x01, 0x0a, 0x23, 0x4f, 0x62,
	0x73, 0x65, 0x72, 0x76, 0x65, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x66, 0x65, 0x72, 0x49, 0x6e, 0x73,
	...
	0x66, 0x65, 0x72, 0x49, 0x6e, 0x73, 0x74, 0x72, 0x75, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x65,
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x3c,
	0x2e, 0x64, 0x61, 0x74, 0x61, 0x6e, 0x6f, 0x64, 0x65, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x76, 0x32,
	0x2e, 0x4f, 0x62, 0x73, 0x65, 0x72, 0x76, 0x65, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x66, 0x65, 0x72,
	0x49, 0x6e, 0x73, 0x74, 0x72, 0x75, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f,
	0x6e, 0x73, 0x65, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x30, 0x01, 0x12, 0x67,
	...
	0x73, 0x65, 0x42, 0x7c, 0x5a, 0x31, 0x63, 0x6f, 0x64, 0x65, 0x2e, 0x76, 0x65, 0x67, 0x61, 0x70,
	...
	0x2f, 0x61, 0x70, 0x69, 0x2f, 0x76, 0x32, 0x92, 0x41, 0x46, 0x12, 0x1d, 0x0a, 0x13, 0x56, 0x65,
	0x67, 0x61, 0x20, 0x64, 0x61, 0x74, 0x61, 0x20, 0x6e, 0x6f, 0x64, 0x65, 0x20, 0x41, 0x50, 0x49,
	0x73, 0x32, 0x06, 0x30, 0x2e, 0x35, 0x35, 0x2e, 0x30, 0x1a, 0x21, 0x6c, 0x62, 0x2e, 0x74, 0x65,
...
var file_data_node_api_v2_trading_data_proto_msgTypes = make([]protoimpl.MessageInfo, 229)
var file_data_node_api_v2_trading_data_proto_goTypes = []interface{}{
	(AccountField)(0),                                    // 0: datanode.api.v2.AccountField
	(TransferInstructionDirection)(0),                    // 1: datanode.api.v2.TransferInstructionDirection
	...
	(*AccountSnapshotPage)(nil),                          // 12: datanode.api.v2.AccountSnapshotPage
	(*AccountUpdates)(nil),                               // 13: datanode.api.v2.AccountUpdates
	(*InfoRequest)(nil),                                  // 14: datanode.api.v2.InfoRequest
	(*InfoResponse)(nil),                                 // 15: datanode.api.v2.InfoResponse
	(*GetOrderRequest)(nil),                              // 16: datanode.api.v2.GetOrderRequest
	(*GetOrderResponse)(nil),                             // 17: datanode.api.v2.GetOrderResponse
	(*ListOrdersRequest)(nil),                            // 18: datanode.api.v2.ListOrdersRequest
	(*ListOrdersResponse)(nil),                           // 19: datanode.api.v2.ListOrdersResponse
	(*ListOrderVersionsRequest)(nil),                     // 20: datanode.api.v2.ListOrderVersionsRequest
	(*ListOrderVersionsResponse)(nil),                    // 21: datanode.api.v2.ListOrderVersionsResponse
	(*ObserveOrdersRequest)(nil),                         // 22: datanode.api.v2.ObserveOrdersRequest
	(*ObserveOrdersResponse)(nil),                        // 23: datanode.api.v2.ObserveOrdersResponse
	(*OrderSnapshotPage)(nil),                            // 24: datanode.api.v2.OrderSnapshotPage
	(*OrderUpdates)(nil),                                 // 25: datanode.api.v2.OrderUpdates
	(*ListPositionsRequest)(nil),                         // 26: datanode.api.v2.ListPositionsRequest
	(*ListPositionsResponse)(nil),                        // 27: datanode.api.v2.ListPositionsResponse
	(*PositionEdge)(nil),                                 // 28: datanode.api.v2.PositionEdge
	(*PositionConnection)(nil),                           // 29: datanode.api.v2.PositionConnection
	(*ObservePositionsRequest)(nil),                      // 30: datanode.api.v2.ObservePositionsRequest
	(*ObservePositionsResponse)(nil),                     // 31: datanode.api.v2.ObservePositionsResponse
	(*PositionSnapshotPage)(nil),                         // 32: datanode.api.v2.PositionSnapshotPage
	(*PositionUpdates)(nil),                              // 33: datanode.api.v2.PositionUpdates
	(*GetBalanceHistoryRequest)(nil),                     // 34: datanode.api.v2.GetBalanceHistoryRequest
	(*GetBalanceHistoryResponse)(nil),                    // 35: datanode.api.v2.GetBalanceHistoryResponse
	(*AggregatedBalanceEdge)(nil),                        // 36: datanode.api.v2.AggregatedBalanceEdge
	(*AggregatedBalanceConnection)(nil),                  // 37: datanode.api.v2.AggregatedBalanceConnection
	(*AccountFilter)(nil),                                // 38: datanode.api.v2.AccountFilter
	(*AggregatedBalance)(nil),                            // 39: datanode.api.v2.AggregatedBalance
	(*ObserveMarketsDepthRequest)(nil),                   // 40: datanode.api.v2.ObserveMarketsDepthRequest
	(*ObserveMarketsDepthResponse)(nil),                  // 41: datanode.api.v2.ObserveMarketsDepthResponse
	(*ObserveMarketsDepthUpdatesRequest)(nil),            // 42: datanode.api.v2.ObserveMarketsDepthUpdatesRequest
	(*ObserveMarketsDepthUpdatesResponse)(nil),           // 43: datanode.api.v2.ObserveMarketsDepthUpdatesResponse
	(*ObserveMarketsDataRequest)(nil),                    // 44: datanode.api.v2.ObserveMarketsDataRequest
	(*ObserveMarketsDataResponse)(nil),                   // 45: datanode.api.v2.ObserveMarketsDataResponse
	(*GetLatestMarketDepthRequest)(nil),                  // 46: datanode.api.v2.GetLatestMarketDepthRequest
	(*GetLatestMarketDepthResponse)(nil),                 // 47: datanode.api.v2.GetLatestMarketDepthResponse
	(*ListLatestMarketDataRequest)(nil),                  // 48: datanode.api.v2.ListLatestMarketDataRequest
	(*ListLatestMarketDataResponse)(nil),                 // 49: datanode.api.v2.ListLatestMarketDataResponse
	(*GetLatestMarketDataRequest)(nil),                   // 50: datanode.api.v2.GetLatestMarketDataRequest
	(*GetLatestMarketDataResponse)(nil),                  // 51: datanode.api.v2.GetLatestMarketDataResponse
	(*GetMarketDataHistoryByIDRequest)(nil),              // 52: datanode.api.v2.GetMarketDataHistoryByIDRequest
	(*GetMarketDataHistoryByIDResponse)(nil),             // 53: datanode.api.v2.GetMarketDataHistoryByIDResponse
	(*MarketDataEdge)(nil),                               // 54: datanode.api.v2.MarketDataEdge
	(*MarketDataConnection)(nil),                         // 55: datanode.api.v2.MarketDataConnection
	(*MarketsDataSubscribeRequest)(nil),                  // 56: datanode.api.v2.MarketsDataSubscribeRequest
	(*MarketsDataSubscribeResponse)(nil),                 // 57: datanode.api.v2.MarketsDataSubscribeResponse
	(*ListTransferInstructionsRequest)(nil),              // 58: datanode.api.v2.ListTransferInstructionsRequest
	(*ListTransferInstructionsResponse)(nil),             // 59: datanode.api.v2.ListTransferInstructionsResponse
	(*TransferInstructionEdge)(nil),                      // 60: datanode.api.v2.TransferInstructionEdge
	(*TransferInstructionConnection)(nil),                // 61: datanode.api.v2.TransferInstructionConnection
	(*GetNetworkLimitsRequest)(nil),                      // 62: datanode.api.v2.GetNetworkLimitsRequest
	(*GetNetworkLimitsResponse)(nil),                     // 63: datanode.api.v2.GetNetworkLimitsResponse
	(*ListCandleIntervalsRequest)(nil),                   // 64: datanode.api.v2.ListCandleIntervalsRequest
	(*IntervalToCandleId)(nil),                           // 65: datanode.api.v2.IntervalToCandleId
	(*ListCandleIntervalsResponse)(nil),                  // 66: datanode.api.v2.ListCandleIntervalsResponse
	(*Candle)(nil),                                       // 67: datanode.api.v2.Candle
	(*ObserveCandleDataRequest)(nil),                     // 68: datanode.api.v2.ObserveCandleDataRequest
	(*ObserveCandleDataResponse)(nil),                    // 69: datanode.api.v2.ObserveCandleDataResponse
	(*ListCandleDataRequest)(nil),                        // 70: datanode.api.v2.ListCandleDataRequest
	(*ListCandleDataResponse)(nil),                       // 71: datanode.api.v2.ListCandleDataResponse
	(*CandleEdge)(nil),                                   // 72: datanode.api.v2.CandleEdge
	(*CandleDataConnection)(nil),                         // 73: datanode.api.v2.CandleDataConnection
	(*ListVotesRequest)(nil),                             // 74: datanode.api.v2.ListVotesRequest
	(*ListVotesResponse)(nil),                            // 75: datanode.api.v2.ListVotesResponse
	(*VoteEdge)(nil),                                     // 76: datanode.api.v2.VoteEdge
	(*VoteConnection)(nil),                               // 77: datanode.api.v2.VoteConnection
	(*ObserveVotesRequest)(nil),                          // 78: datanode.api.v2.ObserveVotesRequest
	(*ObserveVotesResponse)(nil),                         // 79: datanode.api.v2.ObserveVotesResponse
	(*GetERC20MultiSigSignerAddedBundlesRequest)(nil),    // 80: datanode.api.v2.GetERC20MultiSigSignerAddedBundlesRequest
	(*GetERC20MultiSigSignerAddedBundlesResponse)(nil),   // 81: datanode.api.v2.GetERC20MultiSigSignerAddedBundlesResponse
	(*ERC20MultiSigSignerAddedEdge)(nil),                 // 82: datanode.api.v2.ERC20MultiSigSignerAddedEdge
	(*ERC20MultiSigSignerAddedBundleEdge)(nil),           // 83: datanode.api.v2.ERC20MultiSigSignerAddedBundleEdge
	(*ERC20MultiSigSignerAddedConnection)(nil),           // 84: datanode.api.v2.ERC20MultiSigSignerAddedConnection
	(*ERC20MultiSigSignerAddedBundle)(nil),               // 85: datanode.api.v2.ERC20MultiSigSignerAddedBundle
	(*GetERC20MultiSigSignerRemovedBundlesRequest)(nil),  // 86: datanode.api.v2.GetERC20MultiSigSignerRemovedBundlesRequest
	(*GetERC20MultiSigSignerRemovedBundlesResponse)(nil), // 87: datanode.api.v2.GetERC20MultiSigSignerRemovedBundlesResponse
	(*ERC20MultiSigSignerRemovedEdge)(nil),               // 88: datanode.api.v2.ERC20MultiSigSignerRemovedEdge
	(*ERC20MultiSigSignerRemovedBundleEdge)(nil),         // 89: datanode.api.v2.ERC20MultiSigSignerRemovedBundleEdge
	(*ERC20MultiSigSignerRemovedConnection)(nil),         // 90: datanode.api.v2.ERC20MultiSigSignerRemovedConnection
	(*ERC20MultiSigSignerRemovedBundle)(nil),             // 91: datanode.api.v2.ERC20MultiSigSignerRemovedBundle
	(*GetERC20ListAssetBundleRequest)(nil),               // 92: datanode.api.v2.GetERC20ListAssetBundleRequest
	(*GetERC20ListAssetBundleResponse)(nil),              // 93: datanode.api.v2.GetERC20ListAssetBundleResponse
	(*GetERC20SetAssetLimitsBundleRequest)(nil),          // 94: datanode.api.v2.GetERC20SetAssetLimitsBundleRequest
	(*GetERC20SetAssetLimitsBundleResponse)(nil),         // 95: datanode.api.v2.GetERC20SetAssetLimitsBundleResponse
	(*GetERC20WithdrawalApprovalRequest)(nil),            // 96: datanode.api.v2.GetERC20WithdrawalApprovalRequest
	(*GetERC20WithdrawalApprovalResponse)(nil),           // 97: datanode.api.v2.GetERC20WithdrawalApprovalResponse
	(*GetLastTradeRequest)(nil),                          // 98: datanode.api.v2.GetLastTradeRequest
	(*GetLastTradeResponse)(nil),                         // 99: datanode.api.v2.GetLastTradeResponse
	(*ListTradesRequest)(nil),                            // 100: datanode.api.v2.ListTradesRequest
	(*ListTradesResponse)(nil),                           // 101: datanode.api.v2.ListTradesResponse
	(*TradeConnection)(nil),                              // 102: datanode.api.v2.TradeConnection
	(*TradeEdge)(nil),                                    // 103: datanode.api.v2.TradeEdge
	(*ObserveTradesRequest)(nil),                         // 104: datanode.api.v2.ObserveTradesRequest
	(*ObserveTradesResponse)(nil),                        // 105: datanode.api.v2.ObserveTradesResponse
	(*GetOracleSpecRequest)(nil),                         // 106: datanode.api.v2.GetOracleSpecRequest
	(*GetOracleSpecResponse)(nil),                        // 107: datanode.api.v2.GetOracleSpecResponse
	(*ListOracleSpecsRequest)(nil),                       // 108: datanode.api.v2.ListOracleSpecsRequest
	(*ListOracleSpecsResponse)(nil),                      // 109: datanode.api.v2.ListOracleSpecsResponse
	(*ListOracleDataRequest)(nil),                        // 110: datanode.api.v2.ListOracleDataRequest
	(*ListOracleDataResponse)(nil),                       // 111: datanode.api.v2.ListOracleDataResponse
	(*OracleSpecEdge)(nil),                               // 112: datanode.api.v2.OracleSpecEdge
	(*OracleSpecsConnection)(nil),                        // 113: datanode.api.v2.OracleSpecsConnection
	(*OracleDataEdge)(nil),                               // 114: datanode.api.v2.OracleDataEdge
	(*OracleDataConnection)(nil),                         // 115: datanode.api.v2.OracleDataConnection
	(*GetMarketRequest)(nil),                             // 116: datanode.api.v2.GetMarketRequest
	(*GetMarketResponse)(nil),                            // 117: datanode.api.v2.GetMarketResponse
	(*ListMarketsRequest)(nil),                           // 118: datanode.api.v2.ListMarketsRequest
	(*ListMarketsResponse)(nil),                          // 119: datanode.api.v2.ListMarketsResponse
	(*MarketEdge)(nil),                                   // 120: datanode.api.v2.MarketEdge
	(*MarketConnection)(nil),                             // 121: datanode.api.v2.MarketConnection
	(*GetPartyRequest)(nil),                              // 122: datanode.api.v2.GetPartyRequest
	(*GetPartyResponse)(nil),                             // 123: datanode.api.v2.GetPartyResponse
	(*ListPartiesRequest)(nil),                           // 124: datanode.api.v2.ListPartiesRequest
	(*ListPartiesResponse)(nil),                          // 125: datanode.api.v2.ListPartiesResponse
	(*PartyEdge)(nil),                                    // 126: datanode.api.v2.PartyEdge
	(*PartyConnection)(nil),                              // 127: datanode.api.v2.PartyConnection
	(*OrderEdge)(nil),                                    // 128: datanode.api.v2.OrderEdge
	(*ListMarginLevelsRequest)(nil),                      // 129: datanode.api.v2.ListMarginLevelsRequest
	(*ListMarginLevelsResponse)(nil),                     // 130: datanode.api.v2.ListMarginLevelsResponse
	(*ObserveMarginLevelsRequest)(nil),                   // 131: datanode.api.v2.ObserveMarginLevelsRequest
	(*ObserveMarginLevelsResponse)(nil),                  // 132: datanode.api.v2.ObserveMarginLevelsResponse
	(*OrderConnection)(nil),                              // 133: datanode.api.v2.OrderConnection
	(*MarginEdge)(nil),                                   // 134: datanode.api.v2.MarginEdge
	(*MarginConnection)(nil),                             // 135: datanode.api.v2.MarginConnection
	(*ListRewardsRequest)(nil),                           // 136: datanode.api.v2.ListRewardsRequest
	(*ListRewardsResponse)(nil),                          // 137: datanode.api.v2.ListRewardsResponse
	(*RewardEdge)(nil),                                   // 138: datanode.api.v2.RewardEdge
	(*RewardsConnection)(nil),                            // 139: datanode.api.v2.RewardsConnection
	(*ListRewardSummariesRequest)(nil),                   // 140: datanode.api.v2.ListRewardSummariesRequest
	(*ListRewardSummariesResponse)(nil),                  // 141: datanode.api.v2.ListRewardSummariesResponse
	(*ObserveRewardsRequest)(nil),                        // 142: datanode.api.v2.ObserveRewardsRequest
	(*ObserveRewardsResponse)(nil),                       // 143: datanode.api.v2.ObserveRewardsResponse
	(*GetDepositRequest)(nil),                            // 144: datanode.api.v2.GetDepositRequest
	(*GetDepositResponse)(nil),                           // 145: datanode.api.v2.GetDepositResponse
	(*ListDepositsRequest)(nil),                          // 146: datanode.api.v2.ListDepositsRequest
	(*ListDepositsResponse)(nil),                         // 147: datanode.api.v2.ListDepositsResponse
	(*DepositEdge)(nil),                                  // 148: datanode.api.v2.DepositEdge
	(*DepositsConnection)(nil),                           // 149: datanode.api.v2.DepositsConnection
	(*GetWithdrawalRequest)(nil),                         // 150: datanode.api.v2.GetWithdrawalRequest
	(*GetWithdrawalResponse)(nil),                        // 151: datanode.api.v2.GetWithdrawalResponse
	(*ListWithdrawalsRequest)(nil),                       // 152: datanode.api.v2.ListWithdrawalsRequest
	(*ListWithdrawalsResponse)(nil),                      // 153: datanode.api.v2.ListWithdrawalsResponse
	(*WithdrawalEdge)(nil),                               // 154: datanode.api.v2.WithdrawalEdge
	(*WithdrawalsConnection)(nil),                        // 155: datanode.api.v2.WithdrawalsConnection
	(*GetAssetRequest)(nil),                              // 156: datanode.api.v2.GetAssetRequest
	(*GetAssetResponse)(nil),                             // 157: datanode.api.v2.GetAssetResponse
	(*ListAssetsRequest)(nil),                            // 158: datanode.api.v2.ListAssetsRequest
	(*ListAssetsResponse)(nil),                           // 159: datanode.api.v2.ListAssetsResponse
	(*AssetEdge)(nil),                                    // 160: datanode.api.v2.AssetEdge
	(*AssetsConnection)(nil),                             // 161: datanode.api.v2.AssetsConnection
	(*ListLiquidityProvisionsRequest)(nil),               // 162: datanode.api.v2.ListLiquidityProvisionsRequest
	(*ListLiquidityProvisionsResponse)(nil),              // 163: datanode.api.v2.ListLiquidityProvisionsResponse
	(*LiquidityProvisionsEdge)(nil),                      // 164: datanode.api.v2.LiquidityProvisionsEdge
	(*LiquidityProvisionsConnection)(nil),                // 165: datanode.api.v2.LiquidityProvisionsConnection
	(*ObserveLiquidityProvisionsRequest)(nil),            // 166: datanode.api.v2.ObserveLiquidityProvisionsRequest
	(*ObserveLiquidityProvisionsResponse)(nil),           // 167: datanode.api.v2.ObserveLiquidityProvisionsResponse
	(*GetGovernanceDataRequest)(nil),                     // 168: datanode.api.v2.GetGovernanceDataRequest
	(*GetGovernanceDataResponse)(nil),                    // 169: datanode.api.v2.GetGovernanceDataResponse
	(*ListGovernanceDataRequest)(nil),                    // 170: datanode.api.v2.ListGovernanceDataRequest
	(*ListGovernanceDataResponse)(nil),                   // 171: datanode.api.v2.ListGovernanceDataResponse
	(*GovernanceDataEdge)(nil),                           // 172: datanode.api.v2.GovernanceDataEdge
	(*GovernanceDataConnection)(nil),                     // 173: datanode.api.v2.GovernanceDataConnection
	(*ObserveGovernanceRequest)(nil),                     // 174: datanode.api.v2.ObserveGovernanceRequest
	(*ObserveGovernanceResponse)(nil),                    // 175: datanode.api.v2.ObserveGovernanceResponse
	(*ListDelegationsRequest)(nil),                       // 176: datanode.api.v2.ListDelegationsRequest
	(*ListDelegationsResponse)(nil),                      // 177: datanode.api.v2.ListDelegationsResponse
	(*DelegationEdge)(nil),                               // 178: datanode.api.v2.DelegationEdge
	(*DelegationsConnection)(nil),                        // 179: datanode.api.v2.DelegationsConnection
	(*ObserveDelegationsRequest)(nil),                    // 180: datanode.api.v2.ObserveDelegationsRequest
	(*ObserveDelegationsResponse)(nil),                   // 181: datanode.api.v2.ObserveDelegationsResponse
	(*GetNetworkDataRequest)(nil),                        // 182: datanode.api.v2.GetNetworkDataRequest
	(*GetNetworkDataResponse)(nil),                       // 183: datanode.api.v2.GetNetworkDataResponse
	(*GetNodeRequest)(nil),                               // 184: datanode.api.v2.GetNodeRequest
	(*GetNodeResponse)(nil),                              // 185: datanode.api.v2.GetNodeResponse
	(*ListNodesRequest)(nil),                             // 186: datanode.api.v2.ListNodesRequest
	(*ListNodesResponse)(nil),                            // 187: datanode.api.v2.ListNodesResponse
	(*NodeEdge)(nil),                                     // 188: datanode.api.v2.NodeEdge
	(*NodesConnection)(nil),                              // 189: datanode.api.v2.NodesConnection
	(*ListNodeSignaturesRequest)(nil),                    // 190: datanode.api.v2.ListNodeSignaturesRequest
	(*ListNodeSignaturesResponse)(nil),                   // 191: datanode.api.v2.ListNodeSignaturesResponse
	(*NodeSignatureEdge)(nil),                            // 192: datanode.api.v2.NodeSignatureEdge
	(*NodeSignaturesConnection)(nil),                     // 193: datanode.api.v2.NodeSignaturesConnection
	(*GetEpochRequest)(nil),                              // 194: datanode.api.v2.GetEpochRequest
	(*GetEpochResponse)(nil),                             // 195: datanode.api.v2.GetEpochResponse
	(*EstimateFeeRequest)(nil),                           // 196: datanode.api.v2.EstimateFeeRequest
	(*EstimateFeeResponse)(nil),                          // 197: datanode.api.v2.EstimateFeeResponse
	(*EstimateMarginRequest)(nil),                        // 198: datanode.api.v2.EstimateMarginRequest
	(*EstimateMarginResponse)(nil),                       // 199: datanode.api.v2.EstimateMarginResponse
	(*ListNetworkParametersRequest)(nil),                 // 200: datanode.api.v2.ListNetworkParametersRequest
	(*ListNetworkParametersResponse)(nil),                // 201: datanode.api.v2.ListNetworkParametersResponse
	(*GetNetworkParameterRequest)(nil),                   // 202: datanode.api.v2.GetNetworkParameterRequest
	(*GetNetworkParameterResponse)(nil),                  // 203: datanode.api.v2.GetNetworkParameterResponse
	(*NetworkParameterEdge)(nil),                         // 204: datanode.api.v2.NetworkParameterEdge
	(*NetworkParameterConnection)(nil),                   // 205: datanode.api.v2.NetworkParameterConnection
	(*Checkpoint)(nil),                                   // 206: datanode.api.v2.Checkpoint
	(*ListCheckpointsRequest)(nil),                       // 207: datanode.api.v2.ListCheckpointsRequest
	(*ListCheckpointsResponse)(nil),                      // 208: datanode.api.v2.ListCheckpointsResponse
	(*CheckpointEdge)(nil),                               // 209: datanode.api.v2.CheckpointEdge
	(*CheckpointsConnection)(nil),                        // 210: datanode.api.v2.CheckpointsConnection
	(*GetStakeRequest)(nil),                              // 211: datanode.api.v2.GetStakeRequest
	(*GetStakeResponse)(nil),                             // 212: datanode.api.v2.GetStakeResponse
	(*StakeLinkingEdge)(nil),                             // 213: datanode.api.v2.StakeLinkingEdge
	(*StakesConnection)(nil),                             // 214: datanode.api.v2.StakesConnection
	(*GetRiskFactorsRequest)(nil),                        // 215: datanode.api.v2.GetRiskFactorsRequest
	(*GetRiskFactorsResponse)(nil),                       // 216: datanode.api.v2.GetRiskFactorsResponse
	(*ObserveEventBusRequest)(nil),                       // 217: datanode.api.v2.ObserveEventBusRequest
	(*ObserveEventBusResponse)(nil),                      // 218: datanode.api.v2.ObserveEventBusResponse
	(*ObserveTransferInstructionResponsesRequest)(nil),   // 219: datanode.api.v2.ObserveTransferInstructionResponsesRequest
	(*ObserveTransferInstructionResponsesResponse)(nil),  // 220: datanode.api.v2.ObserveTransferInstructionResponsesResponse
	(*ListKeyRotationsRequest)(nil),                      // 221: datanode.api.v2.ListKeyRotationsRequest
	(*ListKeyRotationsResponse)(nil),                     // 222: datanode.api.v2.ListKeyRotationsResponse
	(*KeyRotationEdge)(nil),                              // 223: datanode.api.v2.KeyRotationEdge
	(*KeyRotationConnection)(nil),                        // 224: datanode.api.v2.KeyRotationConnection
	(*ListEthereumKeyRotationsRequest)(nil),              // 225: datanode.api.v2.ListEthereumKeyRotationsRequest
	(*ListEthereumKeyRotationsResponse)(nil),             // 226: datanode.api.v2.ListEthereumKeyRotationsResponse
	(*EthereumKeyRotationsConnection)(nil),               // 227: datanode.api.v2.EthereumKeyRotationsConnection
	(*EthereumKeyRotationEdge)(nil),                      // 228: datanode.api.v2.EthereumKeyRotationEdge
	(*GetVegaTimeRequest)(nil),                           // 229: datanode.api.v2.GetVegaTimeRequest
	(*GetVegaTimeResponse)(nil),                          // 230: datanode.api.v2.GetVegaTimeResponse
	(*DateRange)(nil),                                    // 231: datanode.api.v2.DateRange
	(*vega.Account)(nil),                                 // 232: vega.Account
	(vega.AccountType)(0),                                // 233: vega.AccountType
	(*vega.Order)(nil),                                   // 234: vega.Order
	(*vega.Position)(nil),                                // 235: vega.Position
	(*vega.MarketDepth)(nil),                             // 236: vega.MarketDepth
	(*vega.MarketDepthUpdate)(nil),                       // 237: vega.MarketDepthUpdate
	(*vega.MarketData)(nil),                              // 238: vega.MarketData
	(*vega.PriceLevel)(nil),                              // 239: vega.PriceLevel
	(*vega.Trade)(nil),                                   // 240: vega.Trade
	(*v1.TransferInstruction)(nil),                       // 241: vega.events.v1.TransferInstruction
	(*vega.NetworkLimits)(nil),                           // 242: vega.NetworkLimits
	(vega.Interval)(0),                                   // 243: vega.Interval
	(*vega.Vote)(nil),                                    // 244: vega.Vote
	(*v1.ERC20MultiSigSignerAdded)(nil),                  // 245: vega.events.v1.ERC20MultiSigSignerAdded
	(*v1.ERC20MultiSigSignerRemoved)(nil),                // 246: vega.events.v1.ERC20MultiSigSignerRemoved
	(*v11.OracleSpec)(nil),                               // 247: oracles.v1.OracleSpec
	(*v11.OracleData)(nil),                               // 248: oracles.v1.OracleData
	(*vega.Market)(nil),                                  // 249: vega.Market
	(*vega.Party)(nil),                                   // 250: vega.Party
	(*vega.MarginLevels)(nil),                            // 251: vega.MarginLevels
	(*vega.Reward)(nil),                                  // 252: vega.Reward
	(*vega.RewardSummary)(nil),                           // 253: vega.RewardSummary
	(*vega.Deposit)(nil),                                 // 254: vega.Deposit
	(*vega.Withdrawal)(nil),                              // 255: vega.Withdrawal
	(*vega.Asset)(nil),                                   // 256: vega.Asset
	(*vega.LiquidityProvision)(nil),                      // 257: vega.LiquidityProvision
	(*vega.GovernanceData)(nil),                          // 258: vega.GovernanceData
	(vega.Proposal_State)(0),                             // 259: vega.Proposal.State
	(*vega.Delegation)(nil),                              // 260: vega.Delegation
	(*vega.NodeData)(nil),                                // 261: vega.NodeData
	(*vega.Node)(nil),                                    // 262: vega.Node
	(*v12.NodeSignature)(nil),                            // 263: vega.commands.v1.NodeSignature
	(*vega.Epoch)(nil),                                   // 264: vega.Epoch
	(*vega.Fee)(nil),                                     // 265: vega.Fee
	(*vega.NetworkParameter)(nil),                        // 266: vega.NetworkParameter
	(*v1.StakeLinking)(nil),                              // 267: vega.events.v1.StakeLinking
	(*vega.RiskFactor)(nil),                              // 268: vega.RiskFactor
	(v1.BusEventType)(0),                                 // 269: vega.events.v1.BusEventType
	(*v1.BusEvent)(nil),                                  // 270: vega.events.v1.BusEvent
	(*vega.TransferInstructionResponse)(nil),             // 271: vega.TransferInstructionResponse
	(*v1.KeyRotation)(nil),                               // 272: vega.events.v1.KeyRotation
	(*v1.EthereumKeyRotation)(nil),                       // 273: vega.events.v1.EthereumKeyRotation
}
var file_data_node_api_v2_trading_data_proto_depIdxs = []int32{
	38,  // 0: datanode.api.v2.ListAccountsRequest.filter:type_name -> datanode.api.v2.AccountFilter
	...
	232, // 5: datanode.api.v2.AccountEdge.account:type_name -> vega.Account
	233, // 6: datanode.api.v2.ObserveAccountsRequest.type:type_name -> vega.AccountType
	12,  // 7: datanode.api.v2.ObserveAccountsResponse.snapshot:type_name -> datanode.api.v2.AccountSnapshotPage
	13,  // 8: datanode.api.v2.ObserveAccountsResponse.updates:type_name -> datanode.api.v2.AccountUpdates
	232, // 9: datanode.api.v2.AccountSnapshotPage.accounts:type_name -> vega.Account
	232, // 10: datanode.api.v2.AccountUpdates.accounts:type_name -> vega.Account
	234, // 11: datanode.api.v2.GetOrderResponse.order:type_name -> vega.Order
	4,   // 12: datanode.api.v2.ListOrdersRequest.pagination:type_name -> datanode.api.v2.Pagination
	231, // 13: datanode.api.v2.ListOrdersRequest.date_range:type_name -> datanode.api.v2.DateRange
	133, // 14: datanode.api.v2.ListOrdersResponse.orders:type_name -> datanode.api.v2.OrderConnection
	4,   // 15: datanode.api.v2.ListOrderVersionsRequest.pagination:type_name -> datanode.api.v2.Pagination
	133, // 16: datanode.api.v2.ListOrderVersionsResponse.orders:type_name -> datanode.api.v2.OrderConnection
	24,  // 17: datanode.api.v2.ObserveOrdersResponse.snapshot:type_name -> datanode.api.v2.OrderSnapshotPage
	25,  // 18: datanode.api.v2.ObserveOrdersResponse.updates:type_name -> datanode.api.v2.OrderUpdates
	234, // 19: datanode.api.v2.OrderSnapshotPage.orders:type_name -> vega.Order
	234, // 20: datanode.api.v2.OrderUpdates.orders:type_name -> vega.Order
	4,   // 21: datanode.api.v2.ListPositionsRequest.pagination:type_name -> datanode.api.v2.Pagination
	29,  // 22: datanode.api.v2.ListPositionsResponse.positions:type_name -> datanode.api.v2.PositionConnection
	235, // 23: datanode.api.v2.PositionEdge.node:type_name -> vega.Position
	28,  // 24: datanode.api.v2.PositionConnection.edges:type_name -> datanode.api.v2.PositionEdge
	5,   // 25: datanode.api.v2.PositionConnection.page_info:type_name -> datanode.api.v2.PageInfo
	32,  // 26: datanode.api.v2.ObservePositionsResponse.snapshot:type_name -> datanode.api.v2.PositionSnapshotPage
	33,  // 27: datanode.api.v2.ObservePositionsResponse.updates:type_name -> datanode.api.v2.PositionUpdates
	235, // 28: datanode.api.v2.PositionSnapshotPage.positions:type_name -> vega.Position
	235, // 29: datanode.api.v2.PositionUpdates.positions:type_name -> vega.Position
	38,  // 30: datanode.api.v2.GetBalanceHistoryRequest.filter:type_name -> datanode.api.v2.AccountFilter
	0,   // 31: datanode.api.v2.GetBalanceHistoryRequest.group_by:type_name -> datanode.api.v2.AccountField
	4,   // 32: datanode.api.v2.GetBalanceHistoryRequest.pagination:type_name -> datanode.api.v2.Pagination
	231, // 33: datanode.api.v2.GetBalanceHistoryRequest.date_range:type_name -> datanode.api.v2.DateRange
	37,  // 34: datanode.api.v2.GetBalanceHistoryResponse.balances:type_name -> datanode.api.v2.AggregatedBalanceConnection
	39,  // 35: datanode.api.v2.AggregatedBalanceEdge.node:type_name -> datanode.api.v2.AggregatedBalance
	36,  // 36: datanode.api.v2.AggregatedBalanceConnection.edges:type_name -> datanode.api.v2.AggregatedBalanceEdge
	5,   // 37: datanode.api.v2.AggregatedBalanceConnection.page_info:type_name -> datanode.api.v2.PageInfo
	233, // 38: datanode.api.v2.AccountFilter.account_types:type_name -> vega.AccountType
	233, // 39: datanode.api.v2.AggregatedBalance.account_type:type_name -> vega.AccountType
	236, // 40: datanode.api.v2.ObserveMarketsDepthResponse.market_depth:type_name -> vega.MarketDepth
	237, // 41: datanode.api.v2.ObserveMarketsDepthUpdatesResponse.update:type_name -> vega.MarketDepthUpdate
	238, // 42: datanode.api.v2.ObserveMarketsDataResponse.market_data:type_name -> vega.MarketData
	239, // 43: datanode.api.v2.GetLatestMarketDepthResponse.buy:type_name -> vega.PriceLevel
	239, // 44: datanode.api.v2.GetLatestMarketDepthResponse.sell:type_name -> vega.PriceLevel
	240, // 45: datanode.api.v2.GetLatestMarketDepthResponse.last_trade:type_name -> vega.Trade
	238, // 46: datanode.api.v2.ListLatestMarketDataResponse.markets_data:type_name -> vega.MarketData
	238, // 47: datanode.api.v2.GetLatestMarketDataResponse.market_data:type_name -> vega.MarketData
	4,   // 48: datanode.api.v2.GetMarketDataHistoryByIDRequest.pagination:type_name -> datanode.api.v2.Pagination
	3,   // 49: datanode.api.v2.GetMarketDataHistoryByIDRequest.offset_pagination:type_name -> datanode.api.v2.OffsetPagination
	55,  // 50: datanode.api.v2.GetMarketDataHistoryByIDResponse.market_data:type_name -> datanode.api.v2.MarketDataConnection
	238, // 51: datanode.api.v2.MarketDataEdge.node:type_name -> vega.MarketData
	54,  // 52: datanode.api.v2.MarketDataConnection.edges:type_name -> datanode.api.v2.MarketDataEdge
	5,   // 53: datanode.api.v2.MarketDataConnection.page_info:type_name -> datanode.api.v2.PageInfo
	238, // 54: datanode.api.v2.MarketsDataSubscribeResponse.market_data:type_name -> vega.MarketData
	1,   // 55: datanode.api.v2.ListTransferInstructionsRequest.direction:type_name -> datanode.api.v2.TransferInstructionDirection
	4,   // 56: datanode.api.v2.ListTransferInstructionsRequest.pagination:type_name -> datanode.api.v2.Pagination
	61,  // 57: datanode.api.v2.ListTransferInstructionsResponse.transfer_instructions:type_name -> datanode.api.v2.TransferInstructionConnection
	241, // 58: datanode.api.v2.TransferInstructionEdge.node:type_name -> vega.events.v1.TransferInstruction
	60,  // 59: datanode.api.v2.TransferInstructionConnection.edges:type_name -> datanode.api.v2.TransferInstructionEdge
	5,   // 60: datanode.api.v2.TransferInstructionConnection.page_info:type_name -> datanode.api.v2.PageInfo
	242, // 61: datanode.api.v2.GetNetworkLimitsResponse.limits:type_name -> vega.NetworkLimits
	65,  // 62: datanode.api.v2.ListCandleIntervalsResponse.interval_to_candle_id:type_name -> datanode.api.v2.IntervalToCandleId
	67,  // 63: datanode.api.v2.ObserveCandleDataResponse.candle:type_name -> datanode.api.v2.Candle
	243, // 64: datanode.api.v2.ListCandleDataRequest.interval:type_name -> vega.Interval
	4,   // 65: datanode.api.v2.ListCandleDataRequest.pagination:type_name -> datanode.api.v2.Pagination
	73,  // 66: datanode.api.v2.ListCandleDataResponse.candles:type_name -> datanode.api.v2.CandleDataConnection
	67,  // 67: datanode.api.v2.CandleEdge.node:type_name -> datanode.api.v2.Candle
	72,  // 68: datanode.api.v2.CandleDataConnection.edges:type_name -> datanode.api.v2.CandleEdge
	5,   // 69: datanode.api.v2.CandleDataConnection.page_info:type_name -> datanode.api.v2.PageInfo
	4,   // 70: datanode.api.v2.ListVotesRequest.pagination:type_name -> datanode.api.v2.Pagination
	77,  // 71: datanode.api.v2.ListVotesResponse.votes:type_name -> datanode.api.v2.VoteConnection
	244, // 72: datanode.api.v2.VoteEdge.node:type_name -> vega.Vote
	76,  // 73: datanode.api.v2.VoteConnection.edges:type_name -> datanode.api.v2.VoteEdge
	5,   // 74: datanode.api.v2.VoteConnection.page_info:type_name -> datanode.api.v2.PageInfo
	244, // 75: datanode.api.v2.ObserveVotesResponse.vote:type_name -> vega.Vote
	4,   // 76: datanode.api.v2.GetERC20MultiSigSignerAddedBundlesRequest.pagination:type_name -> datanode.api.v2.Pagination
	84,  // 77: datanode.api.v2.GetERC20MultiSigSignerAddedBundlesResponse.bundles:type_name -> datanode.api.v2.ERC20MultiSigSignerAddedConnection
	245, // 78: datanode.api.v2.ERC20MultiSigSignerAddedEdge.node:type_name -> vega.events.v1.ERC20MultiSigSignerAdded
	85,  // 79: datanode.api.v2.ERC20MultiSigSignerAddedBundleEdge.node:type_name -> datanode.api.v2.ERC20MultiSigSignerAddedBundle
	83,  // 80: datanode.api.v2.ERC20MultiSigSignerAddedConnection.edges:type_name -> datanode.api.v2.ERC20MultiSigSignerAddedBundleEdge
	5,   // 81: datanode.api.v2.ERC20MultiSigSignerAddedConnection.page_info:type_name -> datanode.api.v2.PageInfo
	4,   // 82: datanode.api.v2.GetERC20MultiSigSignerRemovedBundlesRequest.pagination:type_name -> datanode.api.v2.Pagination
	90,  // 83: datanode.api.v2.GetERC20MultiSigSignerRemovedBundlesResponse.bundles:type_name -> datanode.api.v2.ERC20MultiSigSignerRemovedConnection
	246, // 84: datanode.api.v2.ERC20MultiSigSignerRemovedEdge.node:type_name -> vega.events.v1.ERC20MultiSigSignerRemoved
	91,  // 85: datanode.api.v2.ERC20MultiSigSignerRemovedBundleEdge.node:type_name -> datanode.api.v2.ERC20MultiSigSignerRemovedBundle
	89,  // 86: datanode.api.v2.ERC20MultiSigSignerRemovedConnection.edges:type_name -> datanode.api.v2.ERC20MultiSigSignerRemovedBundleEdge
	5,   // 87: datanode.api.v2.ERC20MultiSigSignerRemovedConnection.page_info:type_name -> datanode.api.v2.PageInfo
	240, // 88: datanode.api.v2.GetLastTradeResponse.trade:type_name -> vega.Trade
	4,   // 89: datanode.api.v2.ListTradesRequest.pagination:type_name -> datanode.api.v2.Pagination
	231, // 90: datanode.api.v2.ListTradesRequest.date_range:type_name -> datanode.api.v2.DateRange
	102, // 91: datanode.api.v2.ListTradesResponse.trades:type_name -> datanode.api.v2.TradeConnection
	103, // 92: datanode.api.v2.TradeConnection.edges:type_name -> datanode.api.v2.TradeEdge
	5,   // 93: datanode.api.v2.TradeConnection.page_info:type_name -> datanode.api.v2.PageInfo
	240, // 94: datanode.api.v2.TradeEdge.node:type_name -> vega.Trade
	240, // 95: datanode.api.v2.ObserveTradesResponse.trades:type_name -> vega.Trade
	247, // 96: datanode.api.v2.GetOracleSpecResponse.oracle_spec:type_name -> oracles.v1.OracleSpec
	4,   // 97: datanode.api.v2.ListOracleSpecsRequest.pagination:type_name -> datanode.api.v2.Pagination
	113, // 98: datanode.api.v2.ListOracleSpecsResponse.oracle_specs:type_name -> datanode.api.v2.OracleSpecsConnection
	4,   // 99: datanode.api.v2.ListOracleDataRequest.pagination:type_name -> datanode.api.v2.Pagination
	115, // 100: datanode.api.v2.ListOracleDataResponse.oracle_data:type_name -> datanode.api.v2.OracleDataConnection
	247, // 101: datanode.api.v2.OracleSpecEdge.node:type_name -> oracles.v1.OracleSpec
	112, // 102: datanode.api.v2.OracleSpecsConnection.edges:type_name -> datanode.api.v2.OracleSpecEdge
	5,   // 103: datanode.api.v2.OracleSpecsConnection.page_info:type_name -> datanode.api.v2.PageInfo
	248, // 104: datanode.api.v2.OracleDataEdge.node:type_name -> oracles.v1.OracleData
	114, // 105: datanode.api.v2.OracleDataConnection.edges:type_name -> datanode.api.v2.OracleDataEdge
	5,   // 106: datanode.api.v2.OracleDataConnection.page_info:type_name -> datanode.api.v2.PageInfo
	249, // 107: datanode.api.v2.GetMarketResponse.market:type_name -> vega.Market
	4,   // 108: datanode.api.v2.ListMarketsRequest.pagination:type_name -> datanode.api.v2.Pagination
	121, // 109: datanode.api.v2.ListMarketsResponse.markets:type_name -> datanode.api.v2.MarketConnection
	249, // 110: datanode.api.v2.MarketEdge.node:type_name -> vega.Market
	120, // 111: datanode.api.v2.MarketConnection.edges:type_name -> datanode.api.v2.MarketEdge
	5,   // 112: datanode.api.v2.MarketConnection.page_info:type_name -> datanode.api.v2.PageInfo
	250, // 113: datanode.api.v2.GetPartyResponse.party:type_name -> vega.Party
	4,   // 114: datanode.api.v2.ListPartiesRequest.pagination:type_name -> datanode.api.v2.Pagination
	127, // 115: datanode.api.v2.ListPartiesResponse.party:type_name -> datanode.api.v2.PartyConnection
	250, // 116: datanode.api.v2.PartyEdge.node:type_name -> vega.Party
	126, // 117: datanode.api.v2.PartyConnection.edges:type_name -> datanode.api.v2.PartyEdge
	5,   // 118: datanode.api.v2.PartyConnection.page_info:type_name -> datanode.api.v2.PageInfo
	234, // 119: datanode.api.v2.OrderEdge.node:type_name -> vega.Order
	4,   // 120: datanode.api.v2.ListMarginLevelsRequest.pagination:type_name -> datanode.api.v2.Pagination
	135, // 121: datanode.api.v2.ListMarginLevelsResponse.margin_levels:type_name -> datanode.api.v2.MarginConnection
	251, // 122: datanode.api.v2.ObserveMarginLevelsResponse.margin_levels:type_name -> vega.MarginLevels
	128, // 123: datanode.api.v2.OrderConnection.edges:type_name -> datanode.api.v2.OrderEdge
	5,   // 124: datanode.api.v2.OrderConnection.page_info:type_name -> datanode.api.v2.PageInfo
	251, // 125: datanode.api.v2.MarginEdge.node:type_name -> vega.MarginLevels
	134, // 126: datanode.api.v2.MarginConnection.edges:type_name -> datanode.api.v2.MarginEdge
	5,   // 127: datanode.api.v2.MarginConnection.page_info:type_name -> datanode.api.v2.PageInfo
	4,   // 128: datanode.api.v2.ListRewardsRequest.pagination:type_name -> datanode.api.v2.Pagination
	139, // 129: datanode.api.v2.ListRewardsResponse.rewards:type_name -> datanode.api.v2.RewardsConnection
	252, // 130: datanode.api.v2.RewardEdge.node:type_name -> vega.Reward
	138, // 131: datanode.api.v2.RewardsConnection.edges:type_name -> datanode.api.v2.RewardEdge
	5,   // 132: datanode.api.v2.RewardsConnection.page_info:type_name -> datanode.api.v2.PageInfo
	4,   // 133: datanode.api.v2.ListRewardSummariesRequest.pagination:type_name -> datanode.api.v2.Pagination
	253, // 134: datanode.api.v2.ListRewardSummariesResponse.summaries:type_name -> vega.RewardSummary
	252, // 135: datanode.api.v2.ObserveRewardsResponse.reward:type_name -> vega.Reward
	254, // 136: datanode.api.v2.GetDepositResponse.deposit:type_name -> vega.Deposit
	4,   // 137: datanode.api.v2.ListDepositsRequest.pagination:type_name -> datanode.api.v2.Pagination
	231, // 138: datanode.api.v2.ListDepositsRequest.date_range:type_name -> datanode.api.v2.DateRange
	149, // 139: datanode.api.v2.ListDepositsResponse.deposits:type_name -> datanode.api.v2.DepositsConnection
	254, // 140: datanode.api.v2.DepositEdge.node:type_name -> vega.Deposit
	148, // 141: datanode.api.v2.DepositsConnection.edges:type_name -> datanode.api.v2.DepositEdge
	5,   // 142: datanode.api.v2.DepositsConnection.page_info:type_name -> datanode.api.v2.PageInfo
	255, // 143: datanode.api.v2.GetWithdrawalResponse.withdrawal:type_name -> vega.Withdrawal
	4,   // 144: datanode.api.v2.ListWithdrawalsRequest.pagination:type_name -> datanode.api.v2.Pagination
	231, // 145: datanode.api.v2.ListWithdrawalsRequest.date_range:type_name -> datanode.api.v2.DateRange
	155, // 146: datanode.api.v2.ListWithdrawalsResponse.withdrawals:type_name -> datanode.api.v2.WithdrawalsConnection
	255, // 147: datanode.api.v2.WithdrawalEdge.node:type_name -> vega.Withdrawal
	154, // 148: datanode.api.v2.WithdrawalsConnection.edges:type_name -> datanode.api.v2.WithdrawalEdge
	5,   // 149: datanode.api.v2.WithdrawalsConnection.page_info:type_name -> datanode.api.v2.PageInfo
	256, // 150: datanode.api.v2.GetAssetResponse.asset:type_name -> vega.Asset
	4,   // 151: datanode.api.v2.ListAssetsRequest.pagination:type_name -> datanode.api.v2.Pagination
	161, // 152: datanode.api.v2.ListAssetsResponse.assets:type_name -> datanode.api.v2.AssetsConnection
	256, // 153: datanode.api.v2.AssetEdge.node:type_name -> vega.Asset
	160, // 154: datanode.api.v2.AssetsConnection.edges:type_name -> datanode.api.v2.AssetEdge
	5,   // 155: datanode.api.v2.AssetsConnection.page_info:type_name -> datanode.api.v2.PageInfo
	4,   // 156: datanode.api.v2.ListLiquidityProvisionsRequest.pagination:type_name -> datanode.api.v2.Pagination
	165, // 157: datanode.api.v2.ListLiquidityProvisionsResponse.liquidity_provisions:type_name -> datanode.api.v2.LiquidityProvisionsConnection
	257, // 158: datanode.api.v2.LiquidityProvisionsEdge.node:type_name -> vega.LiquidityProvision
	164, // 159: datanode.api.v2.LiquidityProvisionsConnection.edges:type_name -> datanode.api.v2.LiquidityProvisionsEdge
	5,   // 160: datanode.api.v2.LiquidityProvisionsConnection.page_info:type_name -> datanode.api.v2.PageInfo
	257, // 161: datanode.api.v2.ObserveLiquidityProvisionsResponse.liquidity_provisions:type_name -> vega.LiquidityProvision
	258, // 162: datanode.api.v2.GetGovernanceDataResponse.data:type_name -> vega.GovernanceData
	259, // 163: datanode.api.v2.ListGovernanceDataRequest.proposal_state:type_name -> vega.Proposal.State
	2,   // 164: datanode.api.v2.ListGovernanceDataRequest.proposal_type:type_name -> datanode.api.v2.ListGovernanceDataRequest.Type
	4,   // 165: datanode.api.v2.ListGovernanceDataRequest.pagination:type_name -> datanode.api.v2.Pagination
	173, // 166: datanode.api.v2.ListGovernanceDataResponse.connection:type_name -> datanode.api.v2.GovernanceDataConnection
	258, // 167: datanode.api.v2.GovernanceDataEdge.node:type_name -> vega.GovernanceData
	172, // 168: datanode.api.v2.GovernanceDataConnection.edges:type_name -> datanode.api.v2.GovernanceDataEdge
	5,   // 169: datanode.api.v2.GovernanceDataConnection.page_info:type_name -> datanode.api.v2.PageInfo
	258, // 170: datanode.api.v2.ObserveGovernanceResponse.data:type_name -> vega.GovernanceData
	4,   // 171: datanode.api.v2.ListDelegationsRequest.pagination:type_name -> datanode.api.v2.Pagination
	179, // 172: datanode.api.v2.ListDelegationsResponse.delegations:type_name -> datanode.api.v2.DelegationsConnection
	260, // 173: datanode.api.v2.DelegationEdge.node:type_name -> vega.Delegation
	178, // 174: datanode.api.v2.DelegationsConnection.edges:type_name -> datanode.api.v2.DelegationEdge
	5,   // 175: datanode.api.v2.DelegationsConnection.page_info:type_name -> datanode.api.v2.PageInfo
	260, // 176: datanode.api.v2.ObserveDelegationsResponse.delegation:type_name -> vega.Delegation
	261, // 177: datanode.api.v2.GetNetworkDataResponse.node_data:type_name -> vega.NodeData
	262, // 178: datanode.api.v2.GetNodeResponse.node:type_name -> vega.Node
	4,   // 179: datanode.api.v2.ListNodesRequest.pagination:type_name -> datanode.api.v2.Pagination
	189, // 180: datanode.api.v2.ListNodesResponse.nodes:type_name -> datanode.api.v2.NodesConnection
	262, // 181: datanode.api.v2.NodeEdge.node:type_name -> vega.Node
	188, // 182: datanode.api.v2.NodesConnection.edges:type_name -> datanode.api.v2.NodeEdge
	5,   // 183: datanode.api.v2.NodesConnection.page_info:type_name -> datanode.api.v2.PageInfo
	4,   // 184: datanode.api.v2.ListNodeSignaturesRequest.pagination:type_name -> datanode.api.v2.Pagination
	193, // 185: datanode.api.v2.ListNodeSignaturesResponse.signatures:type_name -> datanode.api.v2.NodeSignaturesConnection
	263, // 186: datanode.api.v2.NodeSignatureEdge.node:type_name -> vega.commands.v1.NodeSignature
	192, // 187: datanode.api.v2.NodeSignaturesConnection.edges:type_name -> datanode.api.v2.NodeSignatureEdge
	5,   // 188: datanode.api.v2.NodeSignaturesConnection.page_info:type_name -> datanode.api.v2.PageInfo
	264, // 189: datanode.api.v2.GetEpochResponse.epoch:type_name -> vega.Epoch
	234, // 190: datanode.api.v2.EstimateFeeRequest.order:type_name -> vega.Order
	265, // 191: datanode.api.v2.EstimateFeeResponse.fee:type_name -> vega.Fee
	234, // 192: datanode.api.v2.EstimateMarginRequest.order:type_name -> vega.Order
	251, // 193: datanode.api.v2.EstimateMarginResponse.margin_levels:type_name -> vega.MarginLevels
	4,   // 194: datanode.api.v2.ListNetworkParametersRequest.pagination:type_name -> datanode.api.v2.Pagination
	205, // 195: datanode.api.v2.ListNetworkParametersResponse.network_parameters:type_name -> datanode.api.v2.NetworkParameterConnection
	266, // 196: datanode.api.v2.GetNetworkParameterResponse.network_parameter:type_name -> vega.NetworkParameter
	266, // 197: datanode.api.v2.NetworkParameterEdge.node:type_name -> vega.NetworkParameter
	204, // 198: datanode.api.v2.NetworkParameterConnection.edges:type_name -> datanode.api.v2.NetworkParameterEdge
	5,   // 199: datanode.api.v2.NetworkParameterConnection.page_info:type_name -> datanode.api.v2.PageInfo
	4,   // 200: datanode.api.v2.ListCheckpointsRequest.pagination:type_name -> datanode.api.v2.Pagination
	210, // 201: datanode.api.v2.ListCheckpointsResponse.checkpoints:type_name -> datanode.api.v2.CheckpointsConnection
	206, // 202: datanode.api.v2.CheckpointEdge.node:type_name -> datanode.api.v2.Checkpoint
	209, // 203: datanode.api.v2.CheckpointsConnection.edges:type_name -> datanode.api.v2.CheckpointEdge
	5,   // 204: datanode.api.v2.CheckpointsConnection.page_info:type_name -> datanode.api.v2.PageInfo
	4,   // 205: datanode.api.v2.GetStakeRequest.pagination:type_name -> datanode.api.v2.Pagination
	214, // 206: datanode.api.v2.GetStakeResponse.stake_linkings:type_name -> datanode.api.v2.StakesConnection
	267, // 207: datanode.api.v2.StakeLinkingEdge.node:type_name -> vega.events.v1.StakeLinking
	213, // 208: datanode.api.v2.StakesConnection.edges:type_name -> datanode.api.v2.StakeLinkingEdge
	5,   // 209: datanode.api.v2.StakesConnection.page_info:type_name -> datanode.api.v2.PageInfo
	268, // 210: datanode.api.v2.GetRiskFactorsResponse.risk_factor:type_name -> vega.RiskFactor
	269, // 211: datanode.api.v2.ObserveEventBusRequest.type:type_name -> vega.events.v1.BusEventType
	270, // 212: datanode.api.v2.ObserveEventBusResponse.events:type_name -> vega.events.v1.BusEvent
	271, // 213: datanode.api.v2.ObserveTransferInstructionResponsesResponse.response:type_name -> vega.TransferInstructionResponse
	4,   // 214: datanode.api.v2.ListKeyRotationsRequest.pagination:type_name -> datanode.api.v2.Pagination
	224, // 215: datanode.api.v2.ListKeyRotationsResponse.rotations:type_name -> datanode.api.v2.KeyRotationConnection
	272, // 216: datanode.api.v2.KeyRotationEdge.node:type_name -> vega.events.v1.KeyRotation
	223, // 217: datanode.api.v2.KeyRotationConnection.edges:type_name -> datanode.api.v2.KeyRotationEdge
	5,   // 218: datanode.api.v2.KeyRotationConnection.page_info:type_name -> datanode.api.v2.PageInfo
	4,   // 219: datanode.api.v2.ListEthereumKeyRotationsRequest.pagination:type_name -> datanode.api.v2.Pagination
	227, // 220: datanode.api.v2.ListEthereumKeyRotationsResponse.key_rotations:type_name -> datanode.api.v2.EthereumKeyRotationsConnection
	228, // 221: datanode.api.v2.EthereumKeyRotationsConnection.edges:type_name -> datanode.api.v2.EthereumKeyRotationEdge
	5,   // 222: datanode.api.v2.EthereumKeyRotationsConnection.page_info:type_name -> datanode.api.v2.PageInfo
	273, // 223: datanode.api.v2.EthereumKeyRotationEdge.ethereum_key_rotation:type_name -> vega.events.v1.EthereumKeyRotation
	6,   // 224: datanode.api.v2.TradingDataService.ListAccounts:input_type -> datanode.api.v2.ListAccountsRequest
	10,  // 225: datanode.api.v2.TradingDataService.ObserveAccounts:input_type -> datanode.api.v2.ObserveAccountsRequest
	14,  // 226: datanode.api.v2.TradingDataService.Info:input_type -> datanode.api.v2.InfoRequest
	16,  // 227: datanode.api.v2.TradingDataService.GetOrder:input_type -> datanode.api.v2.GetOrderRequest
	18,  // 228: datanode.api.v2.TradingDataService.ListOrders:input_type -> datanode.api.v2.ListOrdersRequest
	20,  // 229: datanode.api.v2.TradingDataService.ListOrderVersions:input_type -> datanode.api.v2.ListOrderVersionsRequest
	22,  // 230: datanode.api.v2.TradingDataService.ObserveOrders:input_type -> datanode.api.v2.ObserveOrdersRequest
	26,  // 231: datanode.api.v2.TradingDataService.ListPositions:input_type -> datanode.api.v2.ListPositionsRequest
	30,  // 232: datanode.api.v2.TradingDataService.ObservePositions:input_type -> datanode.api.v2.ObservePositionsRequest
	34,  // 233: datanode.api.v2.TradingDataService.GetBalanceHistory:input_type -> datanode.api.v2.GetBalanceHistoryRequest
	50,  // 234: datanode.api.v2.TradingDataService.GetLatestMarketData:input_type -> datanode.api.v2.GetLatestMarketDataRequest
	48,  // 235: datanode.api.v2.TradingDataService.ListLatestMarketData:input_type -> datanode.api.v2.ListLatestMarketDataRequest
	46,  // 236: datanode.api.v2.TradingDataService.GetLatestMarketDepth:input_type -> datanode.api.v2.GetLatestMarketDepthRequest
	40,  // 237: datanode.api.v2.TradingDataService.ObserveMarketsDepth:input_type -> datanode.api.v2.ObserveMarketsDepthRequest
	42,  // 238: datanode.api.v2.TradingDataService.ObserveMarketsDepthUpdates:input_type -> datanode.api.v2.ObserveMarketsDepthUpdatesRequest
	44,  // 239: datanode.api.v2.TradingDataService.ObserveMarketsData:input_type -> datanode.api.v2.ObserveMarketsDataRequest
	52,  // 240: datanode.api.v2.TradingDataService.GetMarketDataHistoryByID:input_type -> datanode.api.v2.GetMarketDataHistoryByIDRequest
	58,  // 241: datanode.api.v2.TradingDataService.ListTransferInstructions:input_type -> datanode.api.v2.ListTransferInstructionsRequest
	62,  // 242: datanode.api.v2.TradingDataService.GetNetworkLimits:input_type -> datanode.api.v2.GetNetworkLimitsRequest
	70,  // 243: datanode.api.v2.TradingDataService.ListCandleData:input_type -> datanode.api.v2.ListCandleDataRequest
	68,  // 244: datanode.api.v2.TradingDataService.ObserveCandleData:input_type -> datanode.api.v2.ObserveCandleDataRequest
	64,  // 245: datanode.api.v2.TradingDataService.ListCandleIntervals:input_type -> datanode.api.v2.ListCandleIntervalsRequest
	74,  // 246: datanode.api.v2.TradingDataService.ListVotes:input_type -> datanode.api.v2.ListVotesRequest
	78,  // 247: datanode.api.v2.TradingDataService.ObserveVotes:input_type -> datanode.api.v2.ObserveVotesRequest
	80,  // 248: datanode.api.v2.TradingDataService.GetERC20MultiSigSignerAddedBundles:input_type -> datanode.api.v2.GetERC20MultiSigSignerAddedBundlesRequest
	86,  // 249: datanode.api.v2.TradingDataService.GetERC20MultiSigSignerRemovedBundles:input_type -> datanode.api.v2.GetERC20MultiSigSignerRemovedBundlesRequest
	92,  // 250: datanode.api.v2.TradingDataService.GetERC20ListAssetBundle:input_type -> datanode.api.v2.GetERC20ListAssetBundleRequest
	94,  // 251: datanode.api.v2.TradingDataService.GetERC20SetAssetLimitsBundle:input_type -> datanode.api.v2.GetERC20SetAssetLimitsBundleRequest
	96,  // 252: datanode.api.v2.TradingDataService.GetERC20WithdrawalApproval:input_type -> datanode.api.v2.GetERC20WithdrawalApprovalRequest
	98,  // 253: datanode.api.v2.TradingDataService.GetLastTrade:input_type -> datanode.api.v2.GetLastTradeRequest
	100, // 254: datanode.api.v2.TradingDataService.ListTrades:input_type -> datanode.api.v2.ListTradesRequest
	104, // 255: datanode.api.v2.TradingDataService.ObserveTrades:input_type -> datanode.api.v2.ObserveTradesRequest
	106, // 256: datanode.api.v2.TradingDataService.GetOracleSpec:input_type -> datanode.api.v2.GetOracleSpecRequest
	108, // 257: datanode.api.v2.TradingDataService.ListOracleSpecs:input_type -> datanode.api.v2.ListOracleSpecsRequest
	110, // 258: datanode.api.v2.TradingDataService.ListOracleData:input_type -> datanode.api.v2.ListOracleDataRequest
	116, // 259: datanode.api.v2.TradingDataService.GetMarket:input_type -> datanode.api.v2.GetMarketRequest
	118, // 260: datanode.api.v2.TradingDataService.ListMarkets:input_type -> datanode.api.v2.ListMarketsRequest
	122, // 261: datanode.api.v2.TradingDataService.GetParty:input_type -> datanode.api.v2.GetPartyRequest
	124, // 262: datanode.api.v2.TradingDataService.ListParties:input_type -> datanode.api.v2.ListPartiesRequest
	129, // 263: datanode.api.v2.TradingDataService.ListMarginLevels:input_type -> datanode.api.v2.ListMarginLevelsRequest
	131, // 264: datanode.api.v2.TradingDataService.ObserveMarginLevels:input_type -> datanode.api.v2.ObserveMarginLevelsRequest
	136, // 265: datanode.api.v2.TradingDataService.ListRewards:input_type -> datanode.api.v2.ListRewardsRequest
	140, // 266: datanode.api.v2.TradingDataService.ListRewardSummaries:input_type -> datanode.api.v2.ListRewardSummariesRequest
	142, // 267: datanode.api.v2.TradingDataService.ObserveRewards:input_type -> datanode.api.v2.ObserveRewardsRequest
	144, // 268: datanode.api.v2.TradingDataService.GetDeposit:input_type -> datanode.api.v2.GetDepositRequest
	146, // 269: datanode.api.v2.TradingDataService.ListDeposits:input_type -> datanode.api.v2.ListDepositsRequest
	150, // 270: datanode.api.v2.TradingDataService.GetWithdrawal:input_type -> datanode.api.v2.GetWithdrawalRequest
	152, // 271: datanode.api.v2.TradingDataService.ListWithdrawals:input_type -> datanode.api.v2.ListWithdrawalsRequest
	156, // 272: datanode.api.v2.TradingDataService.GetAsset:input_type -> datanode.api.v2.GetAssetRequest
	158, // 273: datanode.api.v2.TradingDataService.ListAssets:input_type -> datanode.api.v2.ListAssetsRequest
	162, // 274: datanode.api.v2.TradingDataService.ListLiquidityProvisions:input_type -> datanode.api.v2.ListLiquidityProvisionsRequest
	166, // 275: datanode.api.v2.TradingDataService.ObserveLiquidityProvisions:input_type -> datanode.api.v2.ObserveLiquidityProvisionsRequest
	168, // 276: datanode.api.v2.TradingDataService.GetGovernanceData:input_type -> datanode.api.v2.GetGovernanceDataRequest
	170, // 277: datanode.api.v2.TradingDataService.ListGovernanceData:input_type -> datanode.api.v2.ListGovernanceDataRequest
	174, // 278: datanode.api.v2.TradingDataService.ObserveGovernance:input_type -> datanode.api.v2.ObserveGovernanceRequest
	176, // 279: datanode.api.v2.TradingDataService.ListDelegations:input_type -> datanode.api.v2.ListDelegationsRequest
	180, // 280: datanode.api.v2.TradingDataService.ObserveDelegations:input_type -> datanode.api.v2.ObserveDelegationsRequest
	182, // 281: datanode.api.v2.TradingDataService.GetNetworkData:input_type -> datanode.api.v2.GetNetworkDataRequest
	184, // 282: datanode.api.v2.TradingDataService.GetNode:input_type -> datanode.api.v2.GetNodeRequest
	186, // 283: datanode.api.v2.TradingDataService.ListNodes:input_type -> datanode.api.v2.ListNodesRequest
	190, // 284: datanode.api.v2.TradingDataService.ListNodeSignatures:input_type -> datanode.api.v2.ListNodeSignaturesRequest
	194, // 285: datanode.api.v2.TradingDataService.GetEpoch:input_type -> datanode.api.v2.GetEpochRequest
	196, // 286: datanode.api.v2.TradingDataService.EstimateFee:input_type -> datanode.api.v2.EstimateFeeRequest
	198, // 287: datanode.api.v2.TradingDataService.EstimateMargin:input_type -> datanode.api.v2.EstimateMarginRequest
	200, // 288: datanode.api.v2.TradingDataService.ListNetworkParameters:input_type -> datanode.api.v2.ListNetworkParametersRequest
	202, // 289: datanode.api.v2.TradingDataService.GetNetworkParameter:input_type -> datanode.api.v2.GetNetworkParameterRequest
	207, // 290: datanode.api.v2.TradingDataService.ListCheckpoints:input_type -> datanode.api.v2.ListCheckpointsRequest
	211, // 291: datanode.api.v2.TradingDataService.GetStake:input_type -> datanode.api.v2.GetStakeRequest
	215, // 292: datanode.api.v2.TradingDataService.GetRiskFactors:input_type -> datanode.api.v2.GetRiskFactorsRequest
	217, // 293: datanode.api.v2.TradingDataService.ObserveEventBus:input_type -> datanode.api.v2.ObserveEventBusRequest
	219, // 294: datanode.api.v2.TradingDataService.ObserveTransferInstructionResponses:input_type -> datanode.api.v2.ObserveTransferInstructionResponsesRequest
	221, // 295: datanode.api.v2.TradingDataService.ListKeyRotations:input_type -> datanode.api.v2.ListKeyRotationsRequest
	225, // 296: datanode.api.v2.TradingDataService.ListEthereumKeyRotations:input_type -> datanode.api.v2.ListEthereumKeyRotationsRequest
	229, // 297: datanode.api.v2.TradingDataService.GetVegaTime:input_type -> datanode.api.v2.GetVegaTimeRequest
	7,   // 298: datanode.api.v2.TradingDataService.ListAccounts:output_type -> datanode.api.v2.ListAccountsResponse
	11,  // 299: datanode.api.v2.TradingDataService.ObserveAccounts:output_type -> datanode.api.v2.ObserveAccountsResponse
	15,  // 300: datanode.api.v2.TradingDataService.Info:output_type -> datanode.api.v2.InfoResponse
	17,  // 301: datanode.api.v2.TradingDataService.GetOrder:output_type -> datanode.api.v2.GetOrderResponse
	19,  // 302: datanode.api.v2.TradingDataService.ListOrders:output_type -> datanode.api.v2.ListOrdersResponse
	21,  // 303: datanode.api.v2.TradingDataService.ListOrderVersions:output_type -> datanode.api.v2.ListOrderVersionsResponse
	23,  // 304: datanode.api.v2.TradingDataService.ObserveOrders:output_type -> datanode.api.v2.ObserveOrdersResponse
	27,  // 305: datanode.api.v2.TradingDataService.ListPositions:output_type -> datanode.api.v2.ListPositionsResponse
	31,  // 306: datanode.api.v2.TradingDataService.ObservePositions:output_type -> datanode.api.v2.ObservePositionsResponse
	35,  // 307: datanode.api.v2.TradingDataService.GetBalanceHistory:output_type -> datanode.api.v2.GetBalanceHistoryResponse
	51,  // 308: datanode.api.v2.TradingDataService.GetLatestMarketData:output_type -> datanode.api.v2.GetLatestMarketDataResponse
	49,  // 309: datanode.api.v2.TradingDataService.ListLatestMarketData:output_type -> datanode.api.v2.ListLatestMarketDataResponse
	47,  // 310: datanode.api.v2.TradingDataService.GetLatestMarketDepth:output_type -> datanode.api.v2.GetLatestMarketDepthResponse
	41,  // 311: datanode.api.v2.TradingDataService.ObserveMarketsDepth:output_type -> datanode.api.v2.ObserveMarketsDepthResponse
	43,  // 312: datanode.api.v2.TradingDataService.ObserveMarketsDepthUpdates:output_type -> datanode.api.v2.ObserveMarketsDepthUpdatesResponse
	45,  // 313: datanode.api.v2.TradingDataService.ObserveMarketsData:output_type -> datanode.api.v2.ObserveMarketsDataResponse
	53,  // 314: datanode.api.v2.TradingDataService.GetMarketDataHistoryByID:output_type -> datanode.api.v2.GetMarketDataHistoryByIDResponse
	59,  // 315: datanode.api.v2.TradingDataService.ListTransferInstructions:output_type -> datanode.api.v2.ListTransferInstructionsResponse
	63,  // 316: datanode.api.v2.TradingDataService.GetNetworkLimits:output_type -> datanode.api.v2.GetNetworkLimitsResponse
	71,  // 317: datanode.api.v2.TradingDataService.ListCandleData:output_type -> datanode.api.v2.ListCandleDataResponse
	69,  // 318: datanode.api.v2.TradingDataService.ObserveCandleData:output_type -> datanode.api.v2.ObserveCandleDataResponse
	66,  // 319: datanode.api.v2.TradingDataService.ListCandleIntervals:output_type -> datanode.api.v2.ListCandleIntervalsResponse
	75,  // 320: datanode.api.v2.TradingDataService.ListVotes:output_type -> datanode.api.v2.ListVotesResponse
	79,  // 321: datanode.api.v2.TradingDataService.ObserveVotes:output_type -> datanode.api.v2.ObserveVotesResponse
	81,  // 322: datanode.api.v2.TradingDataService.GetERC20MultiSigSignerAddedBundles:output_type -> datanode.api.v2.GetERC20MultiSigSignerAddedBundlesResponse
	87,  // 323: datanode.api.v2.TradingDataService.GetERC20MultiSigSignerRemovedBundles:output_type -> datanode.api.v2.GetERC20MultiSigSignerRemovedBundlesResponse
	93,  // 324: datanode.api.v2.TradingDataService.GetERC20ListAssetBundle:output_type -> datanode.api.v2.GetERC20ListAssetBundleResponse
	95,  // 325: datanode.api.v2.TradingDataService.GetERC20SetAssetLimitsBundle:output_type -> datanode.api.v2.GetERC20SetAssetLimitsBundleResponse
	97,  // 326: datanode.api.v2.TradingDataService.GetERC20WithdrawalApproval:output_type -> datanode.api.v2.GetERC20WithdrawalApprovalResponse
	99,  // 327: datanode.api.v2.TradingDataService.GetLastTrade:output_type -> datanode.api.v2.GetLastTradeResponse
	101, // 328: datanode.api.v2.TradingDataService.ListTrades:output_type -> datanode.api.v2.ListTradesResponse
	105, // 329: datanode.api.v2.TradingDataService.ObserveTrades:output_type -> datanode.api.v2.ObserveTradesResponse
	107, // 330: datanode.api.v2.TradingDataService.GetOracleSpec:output_type -> datanode.api.v2.GetOracleSpecResponse
	109, // 331: datanode.api.v2.TradingDataService.ListOracleSpecs:output_type -> datanode.api.v2.ListOracleSpecsResponse
	111, // 332: datanode.api.v2.TradingDataService.ListOracleData:output_type -> datanode.api.v2.ListOracleDataResponse
	117, // 333: datanode.api.v2.TradingDataService.GetMarket:output_type -> datanode.api.v2.GetMarketResponse
	119, // 334: datanode.api.v2.TradingDataService.ListMarkets:output_type -> datanode.api.v2.ListMarketsResponse
	123, // 335: datanode.api.v2.TradingDataService.GetParty:output_type -> datanode.api.v2.GetPartyResponse
	125, // 336: datanode.api.v2.TradingDataService.ListParties:output_type -> datanode.api.v2.ListPartiesResponse
	130, // 337: datanode.api.v2.TradingDataService.ListMarginLevels:output_type -> datanode.api.v2.ListMarginLevelsResponse
	132, // 338: datanode.api.v2.TradingDataService.ObserveMarginLevels:output_type -> datanode.api.v2.ObserveMarginLevelsResponse
	137, // 339: datanode.api.v2.TradingDataService.ListRewards:output_type -> datanode.api.v2.ListRewardsResponse
	141, // 340: datanode.api.v2.TradingDataService.ListRewardSummaries:output_type -> datanode.api.v2.ListRewardSummariesResponse
	143, // 341: datanode.api.v2.TradingDataService.ObserveRewards:output_type -> datanode.api.v2.ObserveRewardsResponse
	145, // 342: datanode.api.v2.TradingDataService.GetDeposit:output_type -> datanode.api.v2.GetDepositResponse
	147, // 343: datanode.api.v2.TradingDataService.ListDeposits:output_type -> datanode.api.v2.ListDepositsResponse
	151, // 344: datanode.api.v2.TradingDataService.GetWithdrawal:output_type -> datanode.api.v2.GetWithdrawalResponse
	153, // 345: datanode.api.v2.TradingDataService.ListWithdrawals:output_type -> datanode.api.v2.ListWithdrawalsResponse
	157, // 346: datanode.api.v2.TradingDataService.GetAsset:output_type -> datanode.api.v2.GetAssetResponse
	159, // 347: datanode.api.v2.TradingDataService.ListAssets:output_type -> datanode.api.v2.ListAssetsResponse
	163, // 348: datanode.api.v2.TradingDataService.ListLiquidityProvisions:output_type -> datanode.api.v2.ListLiquidityProvisionsResponse
	167, // 349: datanode.api.v2.TradingDataService.ObserveLiquidityProvisions:output_type -> datanode.api.v2.ObserveLiquidityProvisionsResponse
	169, // 350: datanode.api.v2.TradingDataService.GetGovernanceData:output_type -> datanode.api.v2.GetGovernanceDataResponse
	171, // 351: datanode.api.v2.TradingDataService.ListGovernanceData:output_type -> datanode.api.v2.ListGovernanceDataResponse
	175, // 352: datanode.api.v2.TradingDataService.ObserveGovernance:output_type -> datanode.api.v2.ObserveGovernanceResponse
	177, // 353: datanode.api.v2.TradingDataService.ListDelegations:output_type -> datanode.api.v2.ListDelegationsResponse
	181, // 354: datanode.api.v2.TradingDataService.ObserveDelegations:output_type -> datanode.api.v2.ObserveDelegationsResponse
	183, // 355: datanode.api.v2.TradingDataService.GetNetworkData:output_type -> datanode.api.v2.GetNetworkDataResponse
	185, // 356: datanode.api.v2.TradingDataService.GetNode:output_type -> datanode.api.v2.GetNodeResponse
	187, // 357: datanode.api.v2.TradingDataService.ListNodes:output_type -> datanode.api.v2.ListNodesResponse
	191, // 358: datanode.api.v2.TradingDataService.ListNodeSignatures:output_type -> datanode.api.v2.ListNodeSignaturesResponse
	195, // 359: datanode.api.v2.TradingDataService.GetEpoch:output_type -> datanode.api.v2.GetEpochResponse
	197, // 360: datanode.api.v2.TradingDataService.EstimateFee:output_type -> datanode.api.v2.EstimateFeeResponse
	199, // 361: datanode.api.v2.TradingDataService.EstimateMargin:output_type -> datanode.api.v2.EstimateMarginResponse
	201, // 362: datanode.api.v2.TradingDataService.ListNetworkParameters:output_type -> datanode.api.v2.ListNetworkParametersResponse
	203, // 363: datanode.api.v2.TradingDataService.GetNetworkParameter:output_type -> datanode.api.v2.GetNetworkParameterResponse
	208, // 364: datanode.api.v2.TradingDataService.ListCheckpoints:output_type -> datanode.api.v2.ListCheckpointsResponse
	212, // 365: datanode.api.v2.TradingDataService.GetStake:output_type -> datanode.api.v2.GetStakeResponse
	216, // 366: datanode.api.v2.TradingDataService.GetRiskFactors:output_type -> datanode.api.v2.GetRiskFactorsResponse
	218, // 367: datanode.api.v2.TradingDataService.ObserveEventBus:output_type -> datanode.api.v2.ObserveEventBusResponse
	220, // 368: datanode.api.v2.TradingDataService.ObserveTransferInstructionResponses:output_type -> datanode.api.v2.ObserveTransferInstructionResponsesResponse
	222, // 369: datanode.api.v2.TradingDataService.ListKeyRotations:output_type -> datanode.api.v2.ListKeyRotationsResponse
	226, // 370: datanode.api.v2.TradingDataService.ListEthereumKeyRotations:output_type -> datanode.api.v2.ListEthereumKeyRotationsResponse
	230, // 371: datanode.api.v2.TradingDataService.GetVegaTime:output_type -> datanode.api.v2.GetVegaTimeResponse
	298, // [298:372] is the sub-list for method output_type
	224, // [224:298] is the sub-list for method input_type
...
func file_data_node_api_v2_trading_data_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_data_node_api_v2_trading_data_proto_msgTypes[55].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ListTransferInstructionsRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_data_node_api_v2_trading_data_proto_msgTypes[56].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ListTransferInstructionsResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_data_node_api_v2_trading_data_proto_msgTypes[57].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TransferInstructionEdge); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_data_node_api_v2_trading_data_proto_msgTypes[58].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TransferInstructionConnection); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_data_node_api_v2_trading_data_proto_msgTypes[216].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ObserveTransferInstructionResponsesRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_data_node_api_v2_trading_data_proto_msgTypes[217].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ObserveTransferInstructionResponsesResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_data_node_api_v2_trading_data_proto_msgTypes[101].OneofWrappers = []interface{}{}
