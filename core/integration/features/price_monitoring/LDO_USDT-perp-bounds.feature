Feature: Reproduce LDO/USDT-PERP market configuration as voted in on mainnet on February 4th 2024
  ...
  Background:
    ...
    And the perpetual oracles from "0xCAFECAFE1":
      ...
      | perp-oracle | TUSDT | ldo.price           | TYPE_INTEGER    | perp.funding.cue  | TYPE_TIMESTAMP | 0                     | 0             | 0                 | 0                 | ETH        | 18                  |
    And the markets:
  ...
  Scenario: Check the resulting bounds
    ...
    Then the market data for the market "LDO/USDT-PERP" should be:
      | mark price | trading mode            | ref price | horizon | min bound | max bound | horizon | min bound | max bound | horizon | min bound | max bound | horizon | min bound | max bound |
      | 32000      | TRADING_MODE_CONTINUOUS | 32000     | 360     | 31148     | 32874     | 1440    | 30318     | 33772     | 4320    | 29140     | 35130     | 21600   | 25944     | 39409     |