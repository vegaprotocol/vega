	...
	if rows != nil {
		copyCount, err := ts.CopyFrom(
			...
			[]string{
				...
				"buyer_liquidity_fee", "buyer_buy_back_fee", "buyer_treasury_fee", "buyer_high_volume_maker_fee",
				"seller_maker_fee", "seller_infrastructure_fee", "seller_liquidity_fee", "seller_buy_back_fee", "seller_treasury_fee", "seller_high_volume_maker_fee",
