...
var file_vega_snapshot_v1_snapshot_proto_rawDesc = []byte{
	...
	0x22, 0xe0, 0x02, 0x0a, 0x0b, 0x50, 0x72, 0x6f, 0x6f, 0x66, 0x4f, 0x66, 0x57, 0x6f, 0x72, 0x6b,
	...
	0x61, 0x6d, 0x73, 0x22, 0x84, 0x03, 0x0a, 0x11, 0x50, 0x72, 0x6f, 0x6f, 0x66, 0x4f, 0x66, 0x57,
	...
	0x75, 0x6e, 0x74, 0x69, 0x6c, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x22, 0x52, 0x0a, 0x14, 0x54, 0x72,
...
var file_vega_snapshot_v1_snapshot_proto_goTypes = []interface{}{
	...
	(*v1.Signer)(nil),                            // 113: vega.data.v1.Signer
	...
	(*v11.RecurringTransfers)(nil),               // 122: vega.checkpoint.v1.RecurringTransfers
	(*v11.ScheduledTransferAtTime)(nil),          // 123: vega.checkpoint.v1.ScheduledTransferAtTime
...
var file_vega_snapshot_v1_snapshot_proto_depIdxs = []int32{
	...
	111, // 52: vega.snapshot.v1.Payload.protocol_upgrade_proposals:type_name -> vega.snapshot.v1.ProtocolUpgradeProposals
	...
	113, // 60: vega.snapshot.v1.OracleData.signers:type_name -> vega.data.v1.Signer
	...
	114, // 63: vega.snapshot.v1.CollateralAccounts.accounts:type_name -> vega.Account
	115, // 64: vega.snapshot.v1.CollateralAssets.assets:type_name -> vega.Asset
	115, // 65: vega.snapshot.v1.ActiveAssets.assets:type_name -> vega.Asset
	115, // 66: vega.snapshot.v1.PendingAssets.assets:type_name -> vega.Asset
	115, // 67: vega.snapshot.v1.PendingAssetUpdates.assets:type_name -> vega.Asset
	116, // 68: vega.snapshot.v1.Withdrawal.withdrawal:type_name -> vega.Withdrawal
	117, // 69: vega.snapshot.v1.Deposit.deposit:type_name -> vega.Deposit
	118, // 70: vega.snapshot.v1.AssetAction.builtin_deposit:type_name -> vega.BuiltinAssetDeposit
	119, // 71: vega.snapshot.v1.AssetAction.erc20_deposit:type_name -> vega.ERC20Deposit
	120, // 72: vega.snapshot.v1.AssetAction.asset_list:type_name -> vega.ERC20AssetList
	121, // 73: vega.snapshot.v1.AssetAction.erc20_asset_limits_updated:type_name -> vega.ERC20AssetLimitsUpdated
	...
	122, // 77: vega.snapshot.v1.BankingRecurringTransfers.recurring_transfers:type_name -> vega.checkpoint.v1.RecurringTransfers
	123, // 78: vega.snapshot.v1.BankingScheduledTransfers.transfers_at_time:type_name -> vega.checkpoint.v1.ScheduledTransferAtTime
	124, // 79: vega.snapshot.v1.BankingBridgeState.bridge_state:type_name -> vega.checkpoint.v1.BridgeState
	125, // 80: vega.snapshot.v1.DelegationActive.delegations:type_name -> vega.Delegation
	125, // 81: vega.snapshot.v1.DelegationPending.delegations:type_name -> vega.Delegation
	125, // 82: vega.snapshot.v1.DelegationPending.undelegation:type_name -> vega.Delegation
	126, // 83: vega.snapshot.v1.ProposalData.proposal:type_name -> vega.Proposal
	127, // 84: vega.snapshot.v1.ProposalData.yes:type_name -> vega.Vote
	127, // 85: vega.snapshot.v1.ProposalData.no:type_name -> vega.Vote
	127, // 86: vega.snapshot.v1.ProposalData.invalid:type_name -> vega.Vote
	...
	126, // 89: vega.snapshot.v1.GovernanceNode.proposals:type_name -> vega.Proposal
	128, // 90: vega.snapshot.v1.StakingAccount.events:type_name -> vega.events.v1.StakeLinking
	41,  // 91: vega.snapshot.v1.StakingAccounts.accounts:type_name -> vega.snapshot.v1.StakingAccount
	129, // 92: vega.snapshot.v1.MatchingBook.buy:type_name -> vega.Order
	129, // 93: vega.snapshot.v1.MatchingBook.sell:type_name -> vega.Order
	130, // 94: vega.snapshot.v1.NetParams.params:type_name -> vega.NetworkParameter
	131, // 95: vega.snapshot.v1.PriceBound.trigger:type_name -> vega.PriceMonitoringTrigger
	...
	132, // 104: vega.snapshot.v1.AuctionState.mode:type_name -> vega.Market.TradingMode
	132, // 105: vega.snapshot.v1.AuctionState.default_mode:type_name -> vega.Market.TradingMode
	133, // 106: vega.snapshot.v1.AuctionState.trigger:type_name -> vega.AuctionTrigger
	134, // 107: vega.snapshot.v1.AuctionState.end:type_name -> vega.AuctionDuration
	133, // 108: vega.snapshot.v1.AuctionState.extension:type_name -> vega.AuctionTrigger
	55,  // 109: vega.snapshot.v1.EquityShare.lps:type_name -> vega.snapshot.v1.EquityShareLP
	135, // 110: vega.snapshot.v1.Market.market:type_name -> vega.Market
	...
	129, // 114: vega.snapshot.v1.Market.expiring_orders:type_name -> vega.Order
	...
	129, // 117: vega.snapshot.v1.PeggedOrders.parked_orders:type_name -> vega.Order
	...
	75,  // 162: vega.snapshot.v1.ProofOfWork.banned:type_name -> vega.snapshot.v1.BannedParty
