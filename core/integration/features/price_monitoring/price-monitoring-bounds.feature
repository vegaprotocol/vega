Feature: Price monitoring triggers test on or around monitoring bounds with decimals
  ...
  Scenario: Trades below minimum price bound by 1 decimal trigger auction
    ...
    And the market data for the market "ETH/DEC20" should be:
      ...
      | 10000000000 | TRADING_MODE_CONTINUOUS | 5       | 9989799714 | 10010204357 | 743400000000000 | 9000000000000000 | 1             |
    ...
    And the parties place the following orders:
      | party  | market id | side | volume | price      | resulting trades | type       | tif     |
      | party1 | ETH/DEC20 | sell | 1      | 9989799713 | 0                | TYPE_LIMIT | TIF_GTC |
      | party2 | ETH/DEC20 | buy  | 1      | 9989799713 | 0                | TYPE_LIMIT | TIF_GTC |
    Then the market data for the market "ETH/DEC20" should be:
      | mark price  | trading mode                    | auction trigger       | target stake     | supplied stake   | open interest |
      | 10000000000 | TRADING_MODE_MONITORING_AUCTION | AUCTION_TRIGGER_PRICE | 1485283421328840 | 9000000000000000 | 1             |
    ...
    Then the market data for the market "ETH/DEC20" should be:
      ...
      | 9989799713 | TRADING_MODE_CONTINUOUS | 1485283421328840 | 9000000000000000 | 2             |
  ...
  Scenario: Trades above maximum price bound by 1 decimal trigger auction
    ...
    And the parties place the following orders:
      | party  | market id | side | volume | price       | resulting trades | type       | tif     |
      | party1 | ETH/DEC20 | sell | 1      | 10010204358 | 0                | TYPE_LIMIT | TIF_GTC |
      | party2 | ETH/DEC20 | buy  | 1      | 10010204358 | 0                | TYPE_LIMIT | TIF_GTC |
    Then the market data for the market "ETH/DEC20" should be:
      | mark price  | trading mode                    | auction trigger       | target stake     | supplied stake   | open interest |
      | 10000000000 | TRADING_MODE_MONITORING_AUCTION | AUCTION_TRIGGER_PRICE | 1488317183947440 | 9000000000000000 | 1             |
    ...
    Then the market data for the market "ETH/DEC20" should be:
      | mark price  | trading mode            | target stake     | supplied stake   | open interest |
      | 10010204358 | TRADING_MODE_CONTINUOUS | 1488317183947440 | 9000000000000000 | 2             |
