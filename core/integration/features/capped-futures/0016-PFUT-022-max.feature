Feature: When max_price is specified and the market is ran in a fully-collateralised mode and it has parties with open positions settling it at a price of 0 works correctly
  ...
  Scenario: 0016-PFUT-022: Same as the settlement at price 0 test, only with a settlement at max price.
    ...
    And the following transfers should happen:
      ...
      | aux2     |          | ACCOUNT_TYPE_MARGIN     | ACCOUNT_TYPE_SETTLEMENT | ETH/DEC21 | 3      | USD   | TRANSFER_TYPE_LOSS          |
      | aux5     |          | ACCOUNT_TYPE_MARGIN     | ACCOUNT_TYPE_SETTLEMENT | ETH/DEC21 | 2      | USD   | TRANSFER_TYPE_LOSS          |
      | party2   |          | ACCOUNT_TYPE_MARGIN     | ACCOUNT_TYPE_SETTLEMENT | ETH/DEC21 | 5      | USD   | TRANSFER_TYPE_LOSS          |
      | market   | aux1     | ACCOUNT_TYPE_SETTLEMENT | ACCOUNT_TYPE_MARGIN     | ETH/DEC21 | 1      | USD   | TRANSFER_TYPE_WIN           |
    ...
    And the parties should have the following account balances:
      | party  | asset | market id | margin | general |
      | party1 | USD   | ETH/DEC21 | 0      | 12500   |
      | party2 | USD   | ETH/DEC21 | 0      | 7500    |
      | aux1   | USD   | ETH/DEC21 | 0      | 100406  |
      | aux2   | USD   | ETH/DEC21 | 0      | 99585   |
      | aux3   | USD   | ETH/DEC21 | 0      | 99927   |
      | aux4   | USD   | ETH/DEC21 | 0      | 100017  |
      | aux5   | USD   | ETH/DEC21 | 0      | 99923   |
