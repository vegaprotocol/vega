Feature: test risk model parameter change in margin calculation
  ...
  Scenario: lognormal risk model 001 with different risk parameters 
    ...
    And the parties should have the following account balances:
      ...
      | party1 | USD   | ETH/MAR21 | 3117   | 99996883 | 0     |
      | party2 | USD   | ETH/MAR21 | 3429   | 99996571 | 0     |
  ...
  Scenario: lognormal risk model 002 with different risk parameters 
  ...
  Scenario: lognormal risk model 003 with different risk parameters 
    And the following network parameters are set:
      | name                                          | value |
      | market.stake.target.timeWindow                | 24h   |
      | market.stake.target.scalingFactor             | 1     |
  ...
  Scenario: lognormal risk model 004 with different risk parameters 
    ...
    And the parties submit the following liquidity provision:
      ...
      | lp1 | party0 | ETH/MAR24 | 50000             | 0.001 | buy  | BID              | 500        | 20     | amendment  |
