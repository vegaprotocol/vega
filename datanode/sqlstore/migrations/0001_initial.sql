...
select create_hypertable('blocks', 'vega_time', chunk_time_interval => INTERVAL '1 day', if_not_exists => true);
...
select create_hypertable('balances', 'vega_time', chunk_time_interval => INTERVAL '1 day', if_not_exists => true);
...
SELECT create_hypertable('ledger', 'ledger_entry_time', chunk_time_interval => INTERVAL '1 day', if_not_exists => true);
...
SELECT create_hypertable('orders', 'vega_time', chunk_time_interval => INTERVAL '1 day', if_not_exists => true);
...
SELECT create_hypertable('trades', 'synthetic_time', chunk_time_interval => INTERVAL '1 day', if_not_exists => true);
...
select create_hypertable('market_data', 'synthetic_time', chunk_time_interval => INTERVAL '1 day', if_not_exists => true);
...
select create_hypertable('delegations', 'vega_time', chunk_time_interval => INTERVAL '1 day', if_not_exists => true);
...
select create_hypertable('markets', 'vega_time', chunk_time_interval => INTERVAL '1 day', if_not_exists => true);
...
select create_hypertable('deposits', 'vega_time', chunk_time_interval => INTERVAL '1 day', if_not_exists => true);
...
select create_hypertable('withdrawals', 'vega_time', chunk_time_interval => INTERVAL '1 day', if_not_exists => true);
...
select create_hypertable('margin_levels', 'vega_time', chunk_time_interval => INTERVAL '1 day', if_not_exists => true);
...
SELECT create_hypertable('checkpoints', 'vega_time', chunk_time_interval => INTERVAL '1 day', if_not_exists => true);
...
select create_hypertable('positions', 'vega_time', chunk_time_interval => INTERVAL '1 day', if_not_exists => true);
...
select create_hypertable('liquidity_provisions', 'vega_time', chunk_time_interval => INTERVAL '1 day', if_not_exists => true);
