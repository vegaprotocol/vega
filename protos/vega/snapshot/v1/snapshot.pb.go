...
var file_vega_snapshot_v1_snapshot_proto_goTypes = []interface{}{
	...
	(*v11.AssetAction)(nil),                      // 123: vega.checkpoint.v1.AssetAction
	(*v11.RecurringTransfers)(nil),               // 124: vega.checkpoint.v1.RecurringTransfers
	(*v11.ScheduledTransferAtTime)(nil),          // 125: vega.checkpoint.v1.ScheduledTransferAtTime
	(*v11.BridgeState)(nil),                      // 126: vega.checkpoint.v1.BridgeState
	(*vega.Delegation)(nil),                      // 127: vega.Delegation
	(*vega.Proposal)(nil),                        // 128: vega.Proposal
	(*vega.Vote)(nil),                            // 129: vega.Vote
	(*v12.StakeLinking)(nil),                     // 130: vega.events.v1.StakeLinking
	(*vega.StakeTotalSupply)(nil),                // 131: vega.StakeTotalSupply
...
var file_vega_snapshot_v1_snapshot_proto_depIdxs = []int32{
	...
	123, // 73: vega.snapshot.v1.BankingAssetActions.asset_action:type_name -> vega.checkpoint.v1.AssetAction
	124, // 74: vega.snapshot.v1.BankingRecurringTransfers.recurring_transfers:type_name -> vega.checkpoint.v1.RecurringTransfers
	125, // 75: vega.snapshot.v1.BankingScheduledTransfers.transfers_at_time:type_name -> vega.checkpoint.v1.ScheduledTransferAtTime
	126, // 76: vega.snapshot.v1.BankingBridgeState.bridge_state:type_name -> vega.checkpoint.v1.BridgeState
	127, // 77: vega.snapshot.v1.DelegationActive.delegations:type_name -> vega.Delegation
	127, // 78: vega.snapshot.v1.DelegationPending.delegations:type_name -> vega.Delegation
	127, // 79: vega.snapshot.v1.DelegationPending.undelegation:type_name -> vega.Delegation
	128, // 80: vega.snapshot.v1.ProposalData.proposal:type_name -> vega.Proposal
	129, // 81: vega.snapshot.v1.ProposalData.yes:type_name -> vega.Vote
	129, // 82: vega.snapshot.v1.ProposalData.no:type_name -> vega.Vote
	129, // 83: vega.snapshot.v1.ProposalData.invalid:type_name -> vega.Vote
	...
	128, // 86: vega.snapshot.v1.GovernanceNode.proposals:type_name -> vega.Proposal
	130, // 87: vega.snapshot.v1.StakingAccount.events:type_name -> vega.events.v1.StakeLinking
	40,  // 88: vega.snapshot.v1.StakingAccounts.accounts:type_name -> vega.snapshot.v1.StakingAccount
	131, // 89: vega.snapshot.v1.StakingAccounts.pending_stake_total_supply:type_name -> vega.StakeTotalSupply
	132, // 90: vega.snapshot.v1.MatchingBook.buy:type_name -> vega.Order
	132, // 91: vega.snapshot.v1.MatchingBook.sell:type_name -> vega.Order
	133, // 92: vega.snapshot.v1.NetParams.params:type_name -> vega.NetworkParameter
	134, // 93: vega.snapshot.v1.PriceBound.trigger:type_name -> vega.PriceMonitoringTrigger
	...
	135, // 102: vega.snapshot.v1.AuctionState.mode:type_name -> vega.Market.TradingMode
	135, // 103: vega.snapshot.v1.AuctionState.default_mode:type_name -> vega.Market.TradingMode
	136, // 104: vega.snapshot.v1.AuctionState.trigger:type_name -> vega.AuctionTrigger
	137, // 105: vega.snapshot.v1.AuctionState.end:type_name -> vega.AuctionDuration
	136, // 106: vega.snapshot.v1.AuctionState.extension:type_name -> vega.AuctionTrigger
	54,  // 107: vega.snapshot.v1.EquityShare.lps:type_name -> vega.snapshot.v1.EquityShareLP
	138, // 108: vega.snapshot.v1.Market.market:type_name -> vega.Market
	...
	132, // 112: vega.snapshot.v1.Market.expiring_orders:type_name -> vega.Order
	...
	132, // 115: vega.snapshot.v1.PeggedOrders.parked_orders:type_name -> vega.Order
	...
	110, // 124: vega.snapshot.v1.VoteSpamPolicy.banned_parties:type_name -> vega.snapshot.v1.BannedParty
	...
	110, // 128: vega.snapshot.v1.SimpleSpamPolicy.banned_parties:type_name -> vega.snapshot.v1.BannedParty
	...
	89,  // 133: vega.snapshot.v1.Topology.validator_data:type_name -> vega.snapshot.v1.ValidatorState
	83,  // 134: vega.snapshot.v1.Topology.pending_pub_key_rotations:type_name -> vega.snapshot.v1.PendingKeyRotation
	92,  // 135: vega.snapshot.v1.Topology.validator_performance:type_name -> vega.snapshot.v1.ValidatorPerformance
	...
	88,  // 140: vega.snapshot.v1.ToplogySignatures.issued_signatures:type_name -> vega.snapshot.v1.IssuedERC20MultisigControlSignature
	139, // 141: vega.snapshot.v1.ValidatorState.validator_update:type_name -> vega.events.v1.ValidatorUpdate
	90,  // 142: vega.snapshot.v1.ValidatorState.heartbeat_tracker:type_name -> vega.snapshot.v1.HeartbeatTracker
	140, // 143: vega.snapshot.v1.ValidatorState.ranking_score:type_name -> vega.RankingScore
	...
	132, // 146: vega.snapshot.v1.PartyOrders.orders:type_name -> vega.Order
	96,  // 147: vega.snapshot.v1.LiquidityPartiesOrders.party_orders:type_name -> vega.snapshot.v1.PartyOrders
	141, // 148: vega.snapshot.v1.LiquidityProvisions.liquidity_provisions:type_name -> vega.LiquidityProvision
	100, // 149: vega.snapshot.v1.LiquidityScores.scores:type_name -> vega.snapshot.v1.LiquidityScore
	104, // 150: vega.snapshot.v1.FloatingPointConsensus.next_time_trigger:type_name -> vega.snapshot.v1.NextTimeTrigger
	102, // 151: vega.snapshot.v1.FloatingPointConsensus.state_variables:type_name -> vega.snapshot.v1.StateVarInternalState
	103, // 152: vega.snapshot.v1.StateVarInternalState.validators_results:type_name -> vega.snapshot.v1.FloatingPointValidatorResult
	...
	106, // 156: vega.snapshot.v1.ERC20MultiSigTopologyVerified.events_per_address:type_name -> vega.snapshot.v1.SignerEventsPerAddress
	...
	115, // 160: vega.snapshot.v1.ProofOfWork.tx_at_height:type_name -> vega.snapshot.v1.TransactionsAtHeight
	115, // 161: vega.snapshot.v1.ProofOfWork.tid_at_height:type_name -> vega.snapshot.v1.TransactionsAtHeight
	110, // 162: vega.snapshot.v1.ProofOfWork.banned:type_name -> vega.snapshot.v1.BannedParty
	111, // 163: vega.snapshot.v1.ProofOfWork.pow_params:type_name -> vega.snapshot.v1.ProofOfWorkParams
	112, // 164: vega.snapshot.v1.ProofOfWork.pow_state:type_name -> vega.snapshot.v1.ProofOfWorkState
	113, // 165: vega.snapshot.v1.ProofOfWorkState.pow_state:type_name -> vega.snapshot.v1.ProofOfWorkBlockState
	114, // 166: vega.snapshot.v1.ProofOfWorkBlockState.party_state:type_name -> vega.snapshot.v1.ProofOfWorkPartyStateForBlock
	146, // 167: vega.snapshot.v1.ProtocolUpgradeProposals.active_proposals:type_name -> vega.events.v1.ProtocolUpgradeEvent
	117, // 168: vega.snapshot.v1.ProtocolUpgradeProposals.accepted_proposal:type_name -> vega.snapshot.v1.AcceptedProtocolUpgradeProposal
