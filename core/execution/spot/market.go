...
// 		m.TerminateTrading(ctx, true)
// 		n := num.Numeric{}
// 		n.SetUint(changes.SettlementPrice)
// 		m.settlementData(ctx, &n)
// 	} else if changes.UpdateType == types.MarketStateUpdateTypeSuspend {
// 		m.mkt.State = types.MarketStateSuspendedViaGovernance
// 		m.mkt.TradingMode = types.MarketTradingModeSuspended
// 		m.as.StartGovernanceSuspenstioneAuction(m.timeService.GetTimeNow())
// 		m.enterAuction(ctx)
...
// 		m.as.EndGovernanceSuspenstioneAuction()
