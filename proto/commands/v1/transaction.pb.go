...
func (*InputData) Descriptor() ([]byte, []int) {
	return fileDescriptor_transaction_f6f8f99c78ccbb81, []int{0}
}
...
func (dst *InputData) XXX_Merge(src proto.Message) {
	xxx_messageInfo_InputData.Merge(dst, src)
}
...
func (*InputData) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _InputData_OneofMarshaler, _InputData_OneofUnmarshaler, _InputData_OneofSizer, []interface{}{
...
func _InputData_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	m := msg.(*InputData)
	// command
	switch x := m.Command.(type) {
	case *InputData_OrderSubmission:
		b.EncodeVarint(1001<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.OrderSubmission); err != nil {
			return err
		}
	case *InputData_OrderCancellation:
		b.EncodeVarint(1002<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.OrderCancellation); err != nil {
			return err
		}
	case *InputData_OrderAmendment:
		b.EncodeVarint(1003<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.OrderAmendment); err != nil {
			return err
		}
	case *InputData_WithdrawSubmission:
		b.EncodeVarint(1004<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.WithdrawSubmission); err != nil {
			return err
		}
	case *InputData_ProposalSubmission:
		b.EncodeVarint(1005<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.ProposalSubmission); err != nil {
			return err
		}
	case *InputData_VoteSubmission:
		b.EncodeVarint(1006<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.VoteSubmission); err != nil {
			return err
		}
	case *InputData_LiquidityProvisionSubmission:
		b.EncodeVarint(1007<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.LiquidityProvisionSubmission); err != nil {
			return err
		}
	case *InputData_NodeRegistration:
		b.EncodeVarint(2001<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.NodeRegistration); err != nil {
			return err
		}
	case *InputData_NodeVote:
		b.EncodeVarint(2002<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.NodeVote); err != nil {
			return err
		}
	case *InputData_NodeSignature:
		b.EncodeVarint(2003<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.NodeSignature); err != nil {
			return err
		}
	case *InputData_ChainEvent:
		b.EncodeVarint(2004<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.ChainEvent); err != nil {
			return err
		}
	case *InputData_OracleDataSubmission:
		b.EncodeVarint(3001<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.OracleDataSubmission); err != nil {
			return err
		}
	case nil:
	default:
		return fmt.Errorf("InputData.Command has unexpected type %T", x)
	}
	return nil
}

func _InputData_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	m := msg.(*InputData)
	switch tag {
	case 1001: // command.order_submission
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(OrderSubmission)
		err := b.DecodeMessage(msg)
		m.Command = &InputData_OrderSubmission{msg}
		return true, err
	case 1002: // command.order_cancellation
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(OrderCancellation)
		err := b.DecodeMessage(msg)
		m.Command = &InputData_OrderCancellation{msg}
		return true, err
	case 1003: // command.order_amendment
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(OrderAmendment)
		err := b.DecodeMessage(msg)
		m.Command = &InputData_OrderAmendment{msg}
		return true, err
	case 1004: // command.withdraw_submission
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(WithdrawSubmission)
		err := b.DecodeMessage(msg)
		m.Command = &InputData_WithdrawSubmission{msg}
		return true, err
	case 1005: // command.proposal_submission
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(ProposalSubmission)
		err := b.DecodeMessage(msg)
		m.Command = &InputData_ProposalSubmission{msg}
		return true, err
	case 1006: // command.vote_submission
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(VoteSubmission)
		err := b.DecodeMessage(msg)
		m.Command = &InputData_VoteSubmission{msg}
		return true, err
	case 1007: // command.liquidity_provision_submission
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(LiquidityProvisionSubmission)
		err := b.DecodeMessage(msg)
		m.Command = &InputData_LiquidityProvisionSubmission{msg}
		return true, err
	case 2001: // command.node_registration
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(NodeRegistration)
		err := b.DecodeMessage(msg)
		m.Command = &InputData_NodeRegistration{msg}
		return true, err
	case 2002: // command.node_vote
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(NodeVote)
		err := b.DecodeMessage(msg)
		m.Command = &InputData_NodeVote{msg}
		return true, err
	case 2003: // command.node_signature
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(NodeSignature)
		err := b.DecodeMessage(msg)
		m.Command = &InputData_NodeSignature{msg}
		return true, err
	case 2004: // command.chain_event
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(ChainEvent)
		err := b.DecodeMessage(msg)
		m.Command = &InputData_ChainEvent{msg}
		return true, err
	case 3001: // command.oracle_data_submission
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(OracleDataSubmission)
		err := b.DecodeMessage(msg)
		m.Command = &InputData_OracleDataSubmission{msg}
		return true, err
	default:
		return false, nil
	}
...
func _InputData_OneofSizer(msg proto.Message) (n int) {
	m := msg.(*InputData)
	// command
	switch x := m.Command.(type) {
	case *InputData_OrderSubmission:
	...
	case *InputData_WithdrawSubmission:
		...
		n += s
	case *InputData_ProposalSubmission:
		s := proto.Size(x.ProposalSubmission)
		n += 2 // tag and wire
		n += proto.SizeVarint(uint64(s))
		n += s
	case *InputData_VoteSubmission:
	...
	case *InputData_LiquidityProvisionSubmission:
		...
		n += s
	case *InputData_NodeRegistration:
		s := proto.Size(x.NodeRegistration)
		n += 2 // tag and wire
		n += proto.SizeVarint(uint64(s))
		n += s
	case *InputData_NodeVote:
		s := proto.Size(x.NodeVote)
		n += 2 // tag and wire
		n += proto.SizeVarint(uint64(s))
		n += s
	case *InputData_NodeSignature:
		...
		n += s
	case *InputData_ChainEvent:
		s := proto.Size(x.ChainEvent)
		n += 2 // tag and wire
		n += proto.SizeVarint(uint64(s))
		n += s
	case *InputData_OracleDataSubmission:
		s := proto.Size(x.OracleDataSubmission)
		n += 3 // tag and wire
		n += proto.SizeVarint(uint64(s))
		n += s
	case nil:
...
func (*Transaction) Descriptor() ([]byte, []int) {
	return fileDescriptor_transaction_f6f8f99c78ccbb81, []int{1}
}
...
func _Transaction_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	case *Transaction_Address:
		b.EncodeVarint(1001<<3 | proto.WireBytes)
		b.EncodeRawBytes(x.Address)
	case *Transaction_PubKey:
		b.EncodeVarint(1002<<3 | proto.WireBytes)
		b.EncodeRawBytes(x.PubKey)
	case nil:
	default:
		return fmt.Errorf("Transaction.From has unexpected type %T", x)
	}
	return nil
}
...
func _Transaction_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	m := msg.(*Transaction)
	switch tag {
	case 1001: // from.address
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		x, err := b.DecodeRawBytes(true)
		m.From = &Transaction_Address{x}
		return true, err
	case 1002: // from.pub_key
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		x, err := b.DecodeRawBytes(true)
		m.From = &Transaction_PubKey{x}
		return true, err
	default:
		return false, nil
	}
...
func _Transaction_OneofSizer(msg proto.Message) (n int) {
	...
	case *Transaction_PubKey:
		n += 2 // tag and wire
		n += proto.SizeVarint(uint64(len(x.PubKey)))
		n += len(x.PubKey)
	case nil:
	default:
		panic(fmt.Sprintf("proto: unexpected type %T in oneof", x))
...
func (*Signature) Descriptor() ([]byte, []int) {
	return fileDescriptor_transaction_f6f8f99c78ccbb81, []int{2}
}
...
func init() {
	proto.RegisterFile("commands/v1/transaction.proto", fileDescriptor_transaction_f6f8f99c78ccbb81)
}

var fileDescriptor_transaction_f6f8f99c78ccbb81 = []byte{
