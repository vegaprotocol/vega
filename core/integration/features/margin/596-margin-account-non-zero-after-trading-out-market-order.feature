Feature: Regression test for issue 596
  ...
  Scenario: Traded out position but monies left in margin account
    ...
    When the parties place the following orders:
      ...
      | party2 | ETH/DEC19 | sell | 1      | 100   | 0                | TYPE_LIMIT | TIF_GTC | party2-2  |
    ...
    And the mark price should be "103" for the market "ETH/DEC19"
    ...
    And the parties should have the following margin levels:
      ...
      | edd   | ETH/DEC19 | 1178        | 1295   | 1413    | 1649    |
    ...
    And the parties should have the following margin levels:
      | party  | market id | maintenance | search | initial | release |
      | edd    | ETH/DEC19 | 1479        | 1626   | 1774    | 2070    |
      | barney | ETH/DEC19 | 3175        | 3492   | 3810    | 4445    |
