...
| ---- | ------ | ----------- |
| MODE_UNSPECIFIED | 0 | Default value, this is invalid |
| MODE_CONTINUOUS | 1 | Normal trading |
| MODE_BATCH_AUCTION | 2 | Auction trading (FBA) |
| MODE_OPENING_AUCTION | 3 | Opening auction |
| MODE_MONITORING_AUCTION | 4 | Auction triggered by monitoring |
...
| marketMode | [Market.Mode](#vega.Market.Mode) |  | the current state of the market |
