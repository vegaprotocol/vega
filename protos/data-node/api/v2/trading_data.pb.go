...
func (ListGovernanceDataRequest_Type) EnumDescriptor() ([]byte, []int) {
	return file_data_node_api_v2_trading_data_proto_rawDescGZIP(), []int{179, 0}
}

type ListProposalsRequest_Type int32

const (
	ListProposalsRequest_TYPE_UNSPECIFIED ListProposalsRequest_Type = 0
	// List all proposals
	ListProposalsRequest_TYPE_ALL ListProposalsRequest_Type = 1
	// List new market proposals
	ListProposalsRequest_TYPE_NEW_MARKET ListProposalsRequest_Type = 2
	// List update market proposals
	ListProposalsRequest_TYPE_UPDATE_MARKET ListProposalsRequest_Type = 3
	// List change Vega network parameter proposals
	ListProposalsRequest_TYPE_NETWORK_PARAMETERS ListProposalsRequest_Type = 4
	// New asset proposals
	ListProposalsRequest_TYPE_NEW_ASSET ListProposalsRequest_Type = 5
	// Proposals for creating a new free form proposal
	ListProposalsRequest_TYPE_NEW_FREE_FORM ListProposalsRequest_Type = 6
	// Update asset proposals
	ListProposalsRequest_TYPE_UPDATE_ASSET ListProposalsRequest_Type = 7
)

// Enum value maps for ListProposalsRequest_Type.
var (
	ListProposalsRequest_Type_name = map[int32]string{
		0: "TYPE_UNSPECIFIED",
		1: "TYPE_ALL",
		2: "TYPE_NEW_MARKET",
		3: "TYPE_UPDATE_MARKET",
	...
	ListProposalsRequest_Type_value = map[string]int32{
		"TYPE_UNSPECIFIED":        0,
		"TYPE_ALL":                1,
		"TYPE_NEW_MARKET":         2,
		"TYPE_UPDATE_MARKET":      3,
...
func (x ListProposalsRequest_Type) Enum() *ListProposalsRequest_Type {
	p := new(ListProposalsRequest_Type)
	*p = x
	return p
}

func (x ListProposalsRequest_Type) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (ListProposalsRequest_Type) Descriptor() protoreflect.EnumDescriptor {
	return file_data_node_api_v2_trading_data_proto_enumTypes[4].Descriptor()
}

func (ListProposalsRequest_Type) Type() protoreflect.EnumType {
	return &file_data_node_api_v2_trading_data_proto_enumTypes[4]
}

func (x ListProposalsRequest_Type) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use ListProposalsRequest_Type.Descriptor instead.
func (ListProposalsRequest_Type) EnumDescriptor() ([]byte, []int) {
	return file_data_node_api_v2_trading_data_proto_rawDescGZIP(), []int{180, 0}
}
...
func (x *GetProposalRequest) GetReference() string {
	if x != nil && x.Reference != nil {
		return *x.Reference
	}
	return ""
...
type GetProposalResponse struct {
	...
	Data *vega.Proposal `protobuf:"bytes,1,opt,name=data,proto3" json:"data,omitempty"`
}
...
func (x *GetProposalResponse) GetData() *vega.Proposal {
	if x != nil {
		return x.Data
	}
	return nil
...
type ListProposalsRequest struct {
	...
	ProposalState     *vega.Proposal_State       `protobuf:"varint,1,opt,name=proposal_state,json=proposalState,proto3,enum=vega.Proposal_State,oneof" json:"proposal_state,omitempty"`
	ProposalType      *ListProposalsRequest_Type `protobuf:"varint,2,opt,name=proposal_type,json=proposalType,proto3,enum=datanode.api.v2.ListProposalsRequest_Type,oneof" json:"proposal_type,omitempty"`
	ProposerPartyId   *string                    `protobuf:"bytes,3,opt,name=proposer_party_id,json=proposerPartyId,proto3,oneof" json:"proposer_party_id,omitempty"`
	ProposalReference *string                    `protobuf:"bytes,4,opt,name=proposal_reference,json=proposalReference,proto3,oneof" json:"proposal_reference,omitempty"`
	Pagination        *Pagination                `protobuf:"bytes,5,opt,name=pagination,proto3,oneof" json:"pagination,omitempty"`
}
...
func (x *ListProposalsRequest) GetProposalState() vega.Proposal_State {
	if x != nil && x.ProposalState != nil {
		return *x.ProposalState
	}
	return vega.Proposal_State(0)
...
func (x *ListProposalsRequest) GetProposalType() ListProposalsRequest_Type {
	if x != nil && x.ProposalType != nil {
		return *x.ProposalType
	}
	return ListProposalsRequest_TYPE_UNSPECIFIED
}

func (x *ListProposalsRequest) GetProposerPartyId() string {
	if x != nil && x.ProposerPartyId != nil {
		return *x.ProposerPartyId
	}
	return ""
...
func (x *ListProposalsRequest) GetProposalReference() string {
	if x != nil && x.ProposalReference != nil {
		return *x.ProposalReference
	}
	return ""
...
type ListProposalsResponse struct {
	...
	Connection *ProposalsConnection `protobuf:"bytes,1,opt,name=connection,proto3" json:"connection,omitempty"`
}
...
func (x *ListProposalsResponse) GetConnection() *ProposalsConnection {
	if x != nil {
		return x.Connection
	}
	return nil
...
type ProposalsEdge struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Node   *ProposalData `protobuf:"bytes,1,opt,name=node,proto3" json:"node,omitempty"`
	Cursor string        `protobuf:"bytes,2,opt,name=cursor,proto3" json:"cursor,omitempty"`
}

func (x *ProposalsEdge) Reset() {
	*x = ProposalsEdge{}
	if protoimpl.UnsafeEnabled {
...
func (x *ProposalsEdge) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ProposalsEdge) ProtoMessage() {}

func (x *ProposalsEdge) ProtoReflect() protoreflect.Message {
	mi := &file_data_node_api_v2_trading_data_proto_msgTypes[182]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ProposalsEdge.ProtoReflect.Descriptor instead.
func (*ProposalsEdge) Descriptor() ([]byte, []int) {
	return file_data_node_api_v2_trading_data_proto_rawDescGZIP(), []int{182}
}

func (x *ProposalsEdge) GetNode() *ProposalData {
	if x != nil {
		return x.Node
	}
	return nil
...
func (x *ProposalsEdge) GetCursor() string {
	if x != nil {
		return x.Cursor
	}
	return ""
...
type ProposalData struct {
	...
	YesVotes uint64         `protobuf:"varint,2,opt,name=yes_votes,json=yesVotes,proto3" json:"yes_votes,omitempty"`
	NoVotes  uint64         `protobuf:"varint,3,opt,name=no_votes,json=noVotes,proto3" json:"no_votes,omitempty"`
}
...
func (x *ProposalData) GetYesVotes() uint64 {
	if x != nil {
		return x.YesVotes
	}
	return 0
...
func (x *ProposalData) GetNoVotes() uint64 {
	if x != nil {
		return x.NoVotes
	}
	return 0
...
type ProposalsConnection struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Edges    []*ProposalsEdge `protobuf:"bytes,1,rep,name=edges,proto3" json:"edges,omitempty"`
	PageInfo *PageInfo        `protobuf:"bytes,2,opt,name=page_info,json=pageInfo,proto3" json:"page_info,omitempty"`
}

func (x *ProposalsConnection) Reset() {
	*x = ProposalsConnection{}
	if protoimpl.UnsafeEnabled {
...
func (x *ProposalsConnection) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ProposalsConnection) ProtoMessage() {}

func (x *ProposalsConnection) ProtoReflect() protoreflect.Message {
	mi := &file_data_node_api_v2_trading_data_proto_msgTypes[184]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ProposalsConnection.ProtoReflect.Descriptor instead.
func (*ProposalsConnection) Descriptor() ([]byte, []int) {
	return file_data_node_api_v2_trading_data_proto_rawDescGZIP(), []int{184}
}

func (x *ProposalsConnection) GetEdges() []*ProposalsEdge {
	if x != nil {
		return x.Edges
	}
	return nil
...
func (x *ProposalsConnection) GetPageInfo() *PageInfo {
	if x != nil {
		return x.PageInfo
	}
	return nil
...
var file_data_node_api_v2_trading_data_proto_rawDesc = []byte{
	...
	0x65, 0x72, 0x22, 0xd1, 0x01, 0x0a, 0x0b, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x46, 0x69, 0x6c, 0x74,
	...
	0x75, 0x69, 0x64, 0x69, 0x74, 0x79, 0x22, 0xb7, 0x03, 0x0a, 0x11, 0x4c, 0x69, 0x73, 0x74, 0x4f,
	0x72, 0x64, 0x65, 0x72, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x1e, 0x0a, 0x08,
	...
	0x01, 0x52, 0x08, 0x6d, 0x61, 0x72, 0x6b, 0x65, 0x74, 0x49, 0x64, 0x88, 0x01, 0x01, 0x12, 0x21,
	...
	0x18, 0x05, 0x20, 0x01, 0x28, 0x08, 0x48, 0x04, 0x52, 0x08, 0x6c, 0x69, 0x76, 0x65, 0x4f, 0x6e,
	0x6c, 0x79, 0x88, 0x01, 0x01, 0x12, 0x3e, 0x0a, 0x0a, 0x64, 0x61, 0x74, 0x65, 0x5f, 0x72, 0x61,
	...
	0x52, 0x61, 0x6e, 0x67, 0x65, 0x48, 0x05, 0x52, 0x09, 0x64, 0x61, 0x74, 0x65, 0x52, 0x61, 0x6e,
	0x67, 0x65, 0x88, 0x01, 0x01, 0x12, 0x39, 0x0a, 0x06, 0x66, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x18,
	0x07, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1c, 0x2e, 0x64, 0x61, 0x74, 0x61, 0x6e, 0x6f, 0x64, 0x65,
	0x2e, 0x61, 0x70, 0x69, 0x2e, 0x76, 0x32, 0x2e, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x46, 0x69, 0x6c,
	0x74, 0x65, 0x72, 0x48, 0x06, 0x52, 0x06, 0x66, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x88, 0x01, 0x01,
	...
	0x67, 0x69, 0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x42, 0x0c, 0x0a, 0x0a, 0x5f, 0x6c, 0x69, 0x76,
	0x65, 0x5f, 0x6f, 0x6e, 0x6c, 0x79, 0x42, 0x0d, 0x0a, 0x0b, 0x5f, 0x64, 0x61, 0x74, 0x65, 0x5f,
	0x72, 0x61, 0x6e, 0x67, 0x65, 0x42, 0x09, 0x0a, 0x07, 0x5f, 0x66, 0x69, 0x6c, 0x74, 0x65, 0x72,
	0x22, 0x4e, 0x0a, 0x12, 0x4c, 0x69, 0x73, 0x74, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x73, 0x52, 0x65,
	...
	0x22, 0x86, 0x01, 0x0a, 0x18, 0x4c, 0x69, 0x73, 0x74, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x56, 0x65,
	...
	0x07, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x49, 0x64, 0x12, 0x40, 0x0a, 0x0a, 0x70, 0x61, 0x67, 0x69,
	...
	,
	...
	,
	...
	,
	...
	0x6f, 0x52, 0x08, 0x70, 0x61, 0x67, 0x65, 0x49, 0x6e, 0x66, 0x6f, 0x22, 0x76, 0x0a, 0x17, 0x4f,
	...
	,
	...
	,
	...
	,
	...
	0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x22, 0x2e, 0x64, 0x61, 0x74, 0x61, 0x6e, 0x6f, 0x64,
	0x65, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x76, 0x32, 0x2e, 0x4c, 0x65, 0x64, 0x67, 0x65, 0x72, 0x45,
	...
	0x67, 0x65, 0x22, 0x76, 0x0a, 0x19, 0x4c, 0x69, 0x73, 0x74, 0x4c, 0x65, 0x64, 0x67, 0x65, 0x72,
	0x45, 0x6e, 0x74, 0x72, 0x69, 0x65, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12,
	0x59, 0x0a, 0x0e, 0x6c, 0x65, 0x64, 0x67, 0x65, 0x72, 0x5f, 0x65, 0x6e, 0x74, 0x72, 0x69, 0x65,
	0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x32, 0x2e, 0x64, 0x61, 0x74, 0x61, 0x6e, 0x6f,
	...
	,
	...
	0xf3, 0x01, 0x0a, 0x19, 0x4c, 0x69, 0x73, 0x74, 0x42, 0x61, 0x6c, 0x61, 0x6e, 0x63, 0x65, 0x43,
	0x68, 0x61, 0x6e, 0x67, 0x65, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x36, 0x0a,
	...
	0x69, 0x6c, 0x74, 0x65, 0x72, 0x12, 0x40, 0x0a, 0x0a, 0x70, 0x61, 0x67, 0x69, 0x6e, 0x61, 0x74,
	...
	0x72, 0x61, 0x6e, 0x67, 0x65, 0x22, 0x66, 0x0a, 0x1a, 0x4c, 0x69, 0x73, 0x74, 0x42, 0x61, 0x6c,
	...
	0x69, 0x6f, 0x6e, 0x52, 0x08, 0x62, 0x61, 0x6c, 0x61, 0x6e, 0x63, 0x65, 0x73, 0x22, 0xac, 0x02,
	0x0a, 0x18, 0x47, 0x65, 0x74, 0x42, 0x61, 0x6c, 0x61, 0x6e, 0x63, 0x65, 0x48, 0x69, 0x73, 0x74,
	0x6f, 0x72, 0x79, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x36, 0x0a, 0x06, 0x66, 0x69,
	...
	0x65, 0x72, 0x12, 0x38, 0x0a, 0x08, 0x67, 0x72, 0x6f, 0x75, 0x70, 0x5f, 0x62, 0x79, 0x18, 0x02,
	0x20, 0x03, 0x28, 0x0e, 0x32, 0x1d, 0x2e, 0x64, 0x61, 0x74, 0x61, 0x6e, 0x6f, 0x64, 0x65, 0x2e,
	0x61, 0x70, 0x69, 0x2e, 0x76, 0x32, 0x2e, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x46, 0x69,
	0x65, 0x6c, 0x64, 0x52, 0x07, 0x67, 0x72, 0x6f, 0x75, 0x70, 0x42, 0x79, 0x12, 0x40, 0x0a, 0x0a,
	...
	0x0a, 0x0a, 0x64, 0x61, 0x74, 0x65, 0x5f, 0x72, 0x61, 0x6e, 0x67, 0x65, 0x18, 0x04, 0x20, 0x01,
	...
	0x0b, 0x5f, 0x64, 0x61, 0x74, 0x65, 0x5f, 0x72, 0x61, 0x6e, 0x67, 0x65, 0x22, 0x65, 0x0a, 0x19,
	0x47, 0x65, 0x74, 0x42, 0x61, 0x6c, 0x61, 0x6e, 0x63, 0x65, 0x48, 0x69, 0x73, 0x74, 0x6f, 0x72,
	0x79, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x48, 0x0a, 0x08, 0x62, 0x61, 0x6c,
	0x61, 0x6e, 0x63, 0x65, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2c, 0x2e, 0x64, 0x61,
	...
	,
	...
	0x66, 0x6f, 0x22, 0x9e, 0x01, 0x0a, 0x0d, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x46, 0x69,
	...
	0x70, 0x65, 0x73, 0x22, 0xa1, 0x02, 0x0a, 0x11, 0x41, 0x67, 0x67, 0x72, 0x65, 0x67, 0x61, 0x74,
	...
	,
	...
	0x6b, 0x65, 0x74, 0x5f, 0x69, 0x64, 0x42, 0x0f, 0x0a, 0x0d, 0x5f, 0x61, 0x63, 0x63, 0x6f, 0x75,
	0x6e, 0x74, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x22, 0x3b, 0x0a, 0x1a, 0x4f, 0x62, 0x73, 0x65, 0x72,
	...
	,
	...
	0x03, 0x28, 0x0b, 0x32, 0x17, 0x2e, 0x76, 0x65, 0x67, 0x61, 0x2e, 0x4d, 0x61, 0x72, 0x6b, 0x65,
	0x74, 0x44, 0x65, 0x70, 0x74, 0x68, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x52, 0x06, 0x75, 0x70,
	0x64, 0x61, 0x74, 0x65, 0x22, 0x3a, 0x0a, 0x19, 0x4f, 0x62, 0x73, 0x65, 0x72, 0x76, 0x65, 0x4d,
	...
	0x22, 0x4f, 0x0a, 0x1a, 0x4f, 0x62, 0x73, 0x65, 0x72, 0x76, 0x65, 0x4d, 0x61, 0x72, 0x6b, 0x65,
	0x74, 0x73, 0x44, 0x61, 0x74, 0x61, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x31,
	...
	0x61, 0x22, 0x6a, 0x0a, 0x1b, 0x47, 0x65, 0x74, 0x4c, 0x61, 0x74, 0x65, 0x73, 0x74, 0x4d, 0x61,
	...
	0x01, 0x28, 0x09, 0x52, 0x08, 0x6d, 0x61, 0x72, 0x6b, 0x65, 0x74, 0x49, 0x64, 0x12, 0x20, 0x0a,
	0x09, 0x6d, 0x61, 0x78, 0x5f, 0x64, 0x65, 0x70, 0x74, 0x68, 0x18, 0x02, 0x20, 0x01, 0x28, 0x04,
	0x48, 0x00, 0x52, 0x08, 0x6d, 0x61, 0x78, 0x44, 0x65, 0x70, 0x74, 0x68, 0x88, 0x01, 0x01, 0x42,
	0x0c, 0x0a, 0x0a, 0x5f, 0x6d, 0x61, 0x78, 0x5f, 0x64, 0x65, 0x70, 0x74, 0x68, 0x22, 0xda, 0x01,
	0x0a, 0x1c, 0x47, 0x65, 0x74, 0x4c, 0x61, 0x74, 0x65, 0x73, 0x74, 0x4d, 0x61, 0x72, 0x6b, 0x65,
	0x74, 0x44, 0x65, 0x70, 0x74, 0x68, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x1b,
	...
	0x04, 0x73, 0x65, 0x6c, 0x6c, 0x12, 0x2a, 0x0a, 0x0a, 0x6c, 0x61, 0x73, 0x74, 0x5f, 0x74, 0x72,
	0x61, 0x64, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0b, 0x2e, 0x76, 0x65, 0x67, 0x61,
	0x2e, 0x54, 0x72, 0x61, 0x64, 0x65, 0x52, 0x09, 0x6c, 0x61, 0x73, 0x74, 0x54, 0x72, 0x61, 0x64,
	...
	0x65, 0x6e, 0x63, 0x65, 0x4e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x22, 0x1d, 0x0a, 0x1b, 0x4c, 0x69,
	0x73, 0x74, 0x4c, 0x61, 0x74, 0x65, 0x73, 0x74, 0x4d, 0x61, 0x72, 0x6b, 0x65, 0x74, 0x44, 0x61,
	0x74, 0x61, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0x53, 0x0a, 0x1c, 0x4c, 0x69, 0x73,
	...
	0x61, 0x52, 0x0b, 0x6d, 0x61, 0x72, 0x6b, 0x65, 0x74, 0x73, 0x44, 0x61, 0x74, 0x61, 0x22, 0x39,
	0x0a, 0x1a, 0x47, 0x65, 0x74, 0x4c, 0x61, 0x74, 0x65, 0x73, 0x74, 0x4d, 0x61, 0x72, 0x6b, 0x65,
	...
	0x0a, 0x6d, 0x61, 0x72, 0x6b, 0x65, 0x74, 0x44, 0x61, 0x74, 0x61, 0x22, 0xfc, 0x02, 0x0a, 0x1f,
	...
	0x28, 0x09, 0x52, 0x08, 0x6d, 0x61, 0x72, 0x6b, 0x65, 0x74, 0x49, 0x64, 0x12, 0x2c, 0x0a, 0x0f,
	0x73, 0x74, 0x61, 0x72, 0x74, 0x5f, 0x74, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x18,
	0x02, 0x20, 0x01, 0x28, 0x03, 0x48, 0x00, 0x52, 0x0e, 0x73, 0x74, 0x61, 0x72, 0x74, 0x54, 0x69,
	...
	0x70, 0x88, 0x01, 0x01, 0x12, 0x40, 0x0a, 0x0a, 0x70, 0x61, 0x67, 0x69, 0x6e, 0x61, 0x74, 0x69,
	...
	0x69, 0x6f, 0x6e, 0x88, 0x01, 0x01, 0x12, 0x57, 0x0a, 0x11, 0x6f, 0x66, 0x66, 0x73, 0x65, 0x74,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x42, 0x02, 0x18, 0x01, 0x48, 0x03, 0x52, 0x10, 0x6f, 0x66, 0x66, 0x73,
	0x65, 0x74, 0x50, 0x61, 0x67, 0x69, 0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x88, 0x01, 0x01, 0x42,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x42, 0x14, 0x0a, 0x12, 0x5f, 0x6f, 0x66, 0x66, 0x73, 0x65, 0x74, 0x5f,
	0x70, 0x61, 0x67, 0x69, 0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x6a, 0x0a, 0x20, 0x47, 0x65,
	...
	0x0a, 0x1b, 0x4d, 0x61, 0x72, 0x6b, 0x65, 0x74, 0x73, 0x44, 0x61, 0x74, 0x61, 0x53, 0x75, 0x62,
	...
	,
	...
	0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x40, 0x0a, 0x0a, 0x70, 0x61, 0x67, 0x69, 0x6e, 0x61, 0x74,
	...
	,
	...
	0x6e, 0x73, 0x66, 0x65, 0x72, 0x52, 0x04, 0x6e, 0x6f, 0x64, 0x65, 0x12, 0x16, 0x0a, 0x06, 0x63,
	0x75, 0x72, 0x73, 0x6f, 0x72, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x63, 0x75, 0x72,
	0x73, 0x6f, 0x72, 0x22, 0x81, 0x01, 0x0a, 0x12, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x66, 0x65, 0x72,
	0x43, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x33, 0x0a, 0x05, 0x65, 0x64,
	0x67, 0x65, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1d, 0x2e, 0x64, 0x61, 0x74, 0x61,
	...
	0x69, 0x74, 0x73, 0x52, 0x06, 0x6c, 0x69, 0x6d, 0x69, 0x74, 0x73, 0x22, 0x39, 0x0a, 0x1a, 0x4c,
	0x69, 0x73, 0x74, 0x43, 0x61, 0x6e, 0x64, 0x6c, 0x65, 0x49, 0x6e, 0x74, 0x65, 0x72, 0x76, 0x61,
	0x6c, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x1b, 0x0a, 0x09, 0x6d, 0x61, 0x72,
	...
	0x64, 0x6c, 0x65, 0x49, 0x64, 0x22, 0x75, 0x0a, 0x1b, 0x4c, 0x69, 0x73, 0x74, 0x43, 0x61, 0x6e,
	...
	0x76, 0x6f, 0x6c, 0x75, 0x6d, 0x65, 0x22, 0x37, 0x0a, 0x18, 0x4f, 0x62, 0x73, 0x65, 0x72, 0x76,
	...
	0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x63, 0x61, 0x6e, 0x64, 0x6c, 0x65, 0x49, 0x64, 0x22,
	0x4c, 0x0a, 0x19, 0x4f, 0x62, 0x73, 0x65, 0x72, 0x76, 0x65, 0x43, 0x61, 0x6e, 0x64, 0x6c, 0x65,
	0x44, 0x61, 0x74, 0x61, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x2f, 0x0a, 0x06,
	0x63, 0x61, 0x6e, 0x64, 0x6c, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x17, 0x2e, 0x64,
	0x61, 0x74, 0x61, 0x6e, 0x6f, 0x64, 0x65, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x76, 0x32, 0x2e, 0x43,
	0x61, 0x6e, 0x64, 0x6c, 0x65, 0x52, 0x06, 0x63, 0x61, 0x6e, 0x64, 0x6c, 0x65, 0x22, 0xfb, 0x01,
	0x0a, 0x15, 0x4c, 0x69, 0x73, 0x74, 0x43, 0x61, 0x6e, 0x64, 0x6c, 0x65, 0x44, 0x61, 0x74, 0x61,
	...
	0x52, 0x08, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x76, 0x61, 0x6c, 0x12, 0x40, 0x0a, 0x0a, 0x70, 0x61,
	...
	,
	...
	0x2e, 0x76, 0x32, 0x2e, 0x43, 0x61, 0x6e, 0x64, 0x6c, 0x65, 0x45, 0x64, 0x67, 0x65, 0x52, 0x05,
	...
	0x6e, 0x66, 0x6f, 0x52, 0x08, 0x70, 0x61, 0x67, 0x65, 0x49, 0x6e, 0x66, 0x6f, 0x22, 0xc6, 0x01,
	...
	0x73, 0x61, 0x6c, 0x49, 0x64, 0x88, 0x01, 0x01, 0x12, 0x40, 0x0a, 0x0a, 0x70, 0x61, 0x67, 0x69,
	...
	,
	...
	0x64, 0x65, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x76, 0x32, 0x2e, 0x56, 0x6f, 0x74, 0x65, 0x45, 0x64,
	...
	0x6f, 0x22, 0x78, 0x0a, 0x13, 0x4f, 0x62, 0x73, 0x65, 0x72, 0x76, 0x65, 0x56, 0x6f, 0x74, 0x65,
	...
	0x72, 0x74, 0x79, 0x49, 0x64, 0x88, 0x01, 0x01, 0x12, 0x24, 0x0a, 0x0b, 0x70, 0x72, 0x6f, 0x70,
	0x6f, 0x73, 0x61, 0x6c, 0x5f, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x48, 0x01, 0x52,
	0x0a, 0x70, 0x72, 0x6f, 0x70, 0x6f, 0x73, 0x61, 0x6c, 0x49, 0x64, 0x88, 0x01, 0x01, 0x42, 0x0b,
	0x0a, 0x09, 0x5f, 0x70, 0x61, 0x72, 0x74, 0x79, 0x5f, 0x69, 0x64, 0x42, 0x0e, 0x0a, 0x0c, 0x5f,
	0x70, 0x72, 0x6f, 0x70, 0x6f, 0x73, 0x61, 0x6c, 0x5f, 0x69, 0x64, 0x22, 0x36, 0x0a, 0x14, 0x4f,
	...
	0x6f, 0x74, 0x65, 0x22, 0xbd, 0x01, 0x0a, 0x2a, 0x4c, 0x69, 0x73, 0x74, 0x45, 0x52, 0x43, 0x32,
	...
	0x73, 0x75, 0x62, 0x6d, 0x69, 0x74, 0x74, 0x65, 0x72, 0x12, 0x1b, 0x0a, 0x09, 0x65, 0x70, 0x6f,
	0x63, 0x68, 0x5f, 0x73, 0x65, 0x71, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x65, 0x70,
	0x6f, 0x63, 0x68, 0x53, 0x65, 0x71, 0x12, 0x3b, 0x0a, 0x0a, 0x70, 0x61, 0x67, 0x69, 0x6e, 0x61,
	...
	0x69, 0x6f, 0x6e, 0x22, 0x7c, 0x0a, 0x2b, 0x4c, 0x69, 0x73, 0x74, 0x45, 0x52, 0x43, 0x32, 0x30,
	...
	,
	...
	0x67, 0x6e, 0x65, 0x72, 0x41, 0x64, 0x64, 0x65, 0x64, 0x52, 0x04, 0x6e, 0x6f, 0x64, 0x65, 0x12,
	0x16, 0x0a, 0x06, 0x63, 0x75, 0x72, 0x73, 0x6f, 0x72, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x06, 0x63, 0x75, 0x72, 0x73, 0x6f, 0x72, 0x22, 0x81, 0x01, 0x0a, 0x22, 0x45, 0x52, 0x43, 0x32,
	0x30, 0x4d, 0x75, 0x6c, 0x74, 0x69, 0x53, 0x69, 0x67, 0x53, 0x69, 0x67, 0x6e, 0x65, 0x72, 0x41,
	0x64, 0x64, 0x65, 0x64, 0x42, 0x75, 0x6e, 0x64, 0x6c, 0x65, 0x45, 0x64, 0x67, 0x65, 0x12, 0x43,
	0x0a, 0x04, 0x6e, 0x6f, 0x64, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2f, 0x2e, 0x64,
	...
	0x65, 0x72, 0x41, 0x64, 0x64, 0x65, 0x64, 0x42, 0x75, 0x6e, 0x64, 0x6c, 0x65, 0x52, 0x04, 0x6e,
	0x6f, 0x64, 0x65, 0x12, 0x16, 0x0a, 0x06, 0x63, 0x75, 0x72, 0x73, 0x6f, 0x72, 0x18, 0x02, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x06, 0x63, 0x75, 0x72, 0x73, 0x6f, 0x72, 0x22, 0xa7, 0x01, 0x0a, 0x22,
	...
	0x6f, 0x6e, 0x12, 0x49, 0x0a, 0x05, 0x65, 0x64, 0x67, 0x65, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28,
	0x0b, 0x32, 0x33, 0x2e, 0x64, 0x61, 0x74, 0x61, 0x6e, 0x6f, 0x64, 0x65, 0x2e, 0x61, 0x70, 0x69,
	...
	0x65, 0x49, 0x6e, 0x66, 0x6f, 0x22, 0xce, 0x01, 0x0a, 0x1e, 0x45, 0x52, 0x43, 0x32, 0x30, 0x4d,
	...
	0x63, 0x68, 0x5f, 0x73, 0x65, 0x71, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x65, 0x70,
	0x6f, 0x63, 0x68, 0x53, 0x65, 0x71, 0x22, 0xbf, 0x01, 0x0a, 0x2c, 0x4c, 0x69, 0x73, 0x74, 0x45,
	0x52, 0x43, 0x32, 0x30, 0x4d, 0x75, 0x6c, 0x74, 0x69, 0x53, 0x69, 0x67, 0x53, 0x69, 0x67, 0x6e,
	...
	0x67, 0x69, 0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x80, 0x01, 0x0a, 0x2d, 0x4c, 0x69, 0x73,
	...
	0x65, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x4f, 0x0a, 0x07, 0x62, 0x75,
	0x6e, 0x64, 0x6c, 0x65, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x35, 0x2e, 0x64, 0x61,
	...
	0x6f, 0x6e, 0x52, 0x07, 0x62, 0x75, 0x6e, 0x64, 0x6c, 0x65, 0x73, 0x22, 0x78, 0x0a, 0x1e, 0x45,
	0x52, 0x43, 0x32, 0x30, 0x4d, 0x75, 0x6c, 0x74, 0x69, 0x53, 0x69, 0x67, 0x53, 0x69, 0x67, 0x6e,
	0x65, 0x72, 0x52, 0x65, 0x6d, 0x6f, 0x76, 0x65, 0x64, 0x45, 0x64, 0x67, 0x65, 0x12, 0x3e, 0x0a,
	0x04, 0x6e, 0x6f, 0x64, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2a, 0x2e, 0x76, 0x65,
	...
	,
	...
	0x65, 0x64, 0x42, 0x75, 0x6e, 0x64, 0x6c, 0x65, 0x45, 0x64, 0x67, 0x65, 0x52, 0x05, 0x65, 0x64,
	0x67, 0x65, 0x73, 0x12, 0x36, 0x0a, 0x09, 0x70, 0x61, 0x67, 0x65, 0x5f, 0x69, 0x6e, 0x66, 0x6f,
	0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x64, 0x61, 0x74, 0x61, 0x6e, 0x6f, 0x64,
	0x65, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x76, 0x32, 0x2e, 0x50, 0x61, 0x67, 0x65, 0x49, 0x6e, 0x66,
	0x6f, 0x52, 0x08, 0x70, 0x61, 0x67, 0x65, 0x49, 0x6e, 0x66, 0x6f, 0x22, 0xd0, 0x01, 0x0a, 0x20,
	0x45, 0x52, 0x43, 0x32, 0x30, 0x4d, 0x75, 0x6c, 0x74, 0x69, 0x53, 0x69, 0x67, 0x53, 0x69, 0x67,
	...
	0x28, 0x03, 0x52, 0x08, 0x63, 0x72, 0x65, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x32, 0x0a, 0x13,
	...
	0x72, 0x6b, 0x65, 0x74, 0x22, 0x65, 0x0a, 0x12, 0x4c, 0x69, 0x73, 0x74, 0x4d, 0x61, 0x72, 0x6b,
	...
	0x2e, 0x50, 0x61, 0x67, 0x69, 0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x48, 0x00, 0x52, 0x0a, 0x70,
	0x61, 0x67, 0x69, 0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x88, 0x01, 0x01, 0x42, 0x0d, 0x0a, 0x0b,
	0x5f, 0x70, 0x61, 0x67, 0x69, 0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x52, 0x0a, 0x13, 0x4c,
	...
	0x46, 0x0a, 0x0a, 0x4d, 0x61, 0x72, 0x6b, 0x65, 0x74, 0x45, 0x64, 0x67, 0x65, 0x12, 0x20, 0x0a,
	0x04, 0x6e, 0x6f, 0x64, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0c, 0x2e, 0x76, 0x65,
	0x67, 0x61, 0x2e, 0x4d, 0x61, 0x72, 0x6b, 0x65, 0x74, 0x52, 0x04, 0x6e, 0x6f, 0x64, 0x65, 0x12,
	0x16, 0x0a, 0x06, 0x63, 0x75, 0x72, 0x73, 0x6f, 0x72, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x06, 0x63, 0x75, 0x72, 0x73, 0x6f, 0x72, 0x22, 0x7d, 0x0a, 0x10, 0x4d, 0x61, 0x72, 0x6b, 0x65,
	0x74, 0x43, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x31, 0x0a, 0x05, 0x65,
	...
	0x67, 0x65, 0x49, 0x6e, 0x66, 0x6f, 0x22, 0x2c, 0x0a, 0x0f, 0x47, 0x65, 0x74, 0x50, 0x61, 0x72,
	...
	0x32, 0x19, 0x2e, 0x64, 0x61, 0x74, 0x61, 0x6e, 0x6f, 0x64, 0x65, 0x2e, 0x61, 0x70, 0x69, 0x2e,
	0x76, 0x32, 0x2e, 0x50, 0x61, 0x67, 0x65, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x08, 0x70, 0x61, 0x67,
	0x65, 0x49, 0x6e, 0x66, 0x6f, 0x22, 0xad, 0x01, 0x0a, 0x12, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x65,
	...
	0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x88, 0x01, 0x01, 0x42, 0x0b, 0x0a, 0x09, 0x5f, 0x61, 0x73,
	0x73, 0x65, 0x74, 0x5f, 0x69, 0x64, 0x42, 0x0d, 0x0a, 0x0b, 0x5f, 0x70, 0x61, 0x67, 0x69, 0x6e,
	0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x53, 0x0a, 0x13, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x77,
	...
	0x61, 0x72, 0x79, 0x52, 0x09, 0x73, 0x75, 0x6d, 0x6d, 0x61, 0x72, 0x69, 0x65, 0x73, 0x22, 0x71,
	...
	,
	...
	0x74, 0x65, 0x5f, 0x72, 0x61, 0x6e, 0x67, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1a,
	0x2e, 0x64, 0x61, 0x74, 0x61, 0x6e, 0x6f, 0x64, 0x65, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x76, 0x32,
	...
	,
	...
	,
	...
	0x6c, 0x22, 0xd3, 0x01, 0x0a, 0x16, 0x4c, 0x69, 0x73, 0x74, 0x57, 0x69, 0x74, 0x68, 0x64, 0x72,
	0x61, 0x77, 0x61, 0x6c, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x19, 0x0a, 0x08,
	0x70, 0x61, 0x72, 0x74, 0x79, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07,
	...
	0x32, 0x19, 0x2e, 0x64, 0x61, 0x74, 0x61, 0x6e, 0x6f, 0x64, 0x65, 0x2e, 0x61, 0x70, 0x69, 0x2e,
	0x76, 0x32, 0x2e, 0x50, 0x61, 0x67, 0x65, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x08, 0x70, 0x61, 0x67,
	0x65, 0x49, 0x6e, 0x66, 0x6f, 0x22, 0x2c, 0x0a, 0x0f, 0x47, 0x65, 0x74, 0x41, 0x73, 0x73, 0x65,
	...
	0x74, 0x49, 0x64, 0x22, 0x35, 0x0a, 0x10, 0x47, 0x65, 0x74, 0x41, 0x73, 0x73, 0x65, 0x74, 0x52,
	...
	0x73, 0x65, 0x74, 0x52, 0x05, 0x61, 0x73, 0x73, 0x65, 0x74, 0x22, 0x91, 0x01, 0x0a, 0x11, 0x4c,
	...
	0x0d, 0x0a, 0x0b, 0x5f, 0x70, 0x61, 0x67, 0x69, 0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x4f,
	...
	0x74, 0x61, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0x7b, 0x0a, 0x12, 0x47, 0x65, 0x74, 0x50,
	0x72, 0x6f, 0x70, 0x6f, 0x73, 0x61, 0x6c, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x24,
	...
	0x72, 0x65, 0x6e, 0x63, 0x65, 0x22, 0x39, 0x0a, 0x13, 0x47, 0x65, 0x74, 0x50, 0x72, 0x6f, 0x70,
	0x6f, 0x73, 0x61, 0x6c, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x22, 0x0a, 0x04,
	0x64, 0x61, 0x74, 0x61, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0e, 0x2e, 0x76, 0x65, 0x67,
	0x61, 0x2e, 0x50, 0x72, 0x6f, 0x70, 0x6f, 0x73, 0x61, 0x6c, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61,
	...
	0x0a, 0x0b, 0x5f, 0x70, 0x61, 0x67, 0x69, 0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0xf0, 0x04,
	...
	0x53, 0x74, 0x61, 0x74, 0x65, 0x88, 0x01, 0x01, 0x12, 0x54, 0x0a, 0x0d, 0x70, 0x72, 0x6f, 0x70,
	...
	0x32, 0x2e, 0x4c, 0x69, 0x73, 0x74, 0x50, 0x72, 0x6f, 0x70, 0x6f, 0x73, 0x61, 0x6c, 0x73, 0x52,
	...
	,
	...
	,
	...
	0x6c, 0x65, 0x67, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x17, 0x0a, 0x15, 0x47, 0x65, 0x74, 0x4e,
	...
	0x04, 0x6e, 0x6f, 0x64, 0x65, 0x12, 0x16, 0x0a, 0x06, 0x63, 0x75, 0x72, 0x73, 0x6f, 0x72, 0x18,
	0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x63, 0x75, 0x72, 0x73, 0x6f, 0x72, 0x22, 0xd6, 0x01,
	...
	0x20, 0x01, 0x28, 0x03, 0x52, 0x08, 0x74, 0x6f, 0x48, 0x65, 0x69, 0x67, 0x68, 0x74, 0x12, 0x19,
	0x0a, 0x08, 0x63, 0x68, 0x61, 0x69, 0x6e, 0x5f, 0x69, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x07, 0x63, 0x68, 0x61, 0x69, 0x6e, 0x49, 0x64, 0x12, 0x2c, 0x0a, 0x12, 0x68, 0x69, 0x73,
	0x74, 0x6f, 0x72, 0x79, 0x5f, 0x73, 0x65, 0x67, 0x6d, 0x65, 0x6e, 0x74, 0x5f, 0x69, 0x64, 0x18,
	0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x10, 0x68, 0x69, 0x73, 0x74, 0x6f, 0x72, 0x79, 0x53, 0x65,
	...
	0x65, 0x6e, 0x74, 0x5f, 0x69, 0x64, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x18, 0x70, 0x72,
	0x65, 0x76, 0x69, 0x6f, 0x75, 0x73, 0x48, 0x69, 0x73, 0x74, 0x6f, 0x72, 0x79, 0x53, 0x65, 0x67,
	0x6d, 0x65, 0x6e, 0x74, 0x49, 0x64, 0x22, 0x26, 0x0a, 0x24, 0x47, 0x65, 0x74, 0x4d, 0x6f, 0x73,
	0x74, 0x52, 0x65, 0x63, 0x65, 0x6e, 0x74, 0x44, 0x65, 0x48, 0x69, 0x73, 0x74, 0x6f, 0x72, 0x79,
	0x53, 0x65, 0x67, 0x6d, 0x65, 0x6e, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0x62,
	0x0a, 0x25, 0x47, 0x65, 0x74, 0x4d, 0x6f, 0x73, 0x74, 0x52, 0x65, 0x63, 0x65, 0x6e, 0x74, 0x44,
	...
	0x6e, 0x74, 0x22, 0x21, 0x0a, 0x1f, 0x4c, 0x69, 0x73, 0x74, 0x41, 0x6c, 0x6c, 0x44, 0x65, 0x48,
	0x69, 0x73, 0x74, 0x6f, 0x72, 0x79, 0x53, 0x65, 0x67, 0x6d, 0x65, 0x6e, 0x74, 0x73, 0x52, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0x5f, 0x0a, 0x20, 0x4c, 0x69, 0x73, 0x74, 0x41, 0x6c, 0x6c,
	...
	0x67, 0x6d, 0x65, 0x6e, 0x74, 0x73, 0x22, 0x4c, 0x0a, 0x1c, 0x46, 0x65, 0x74, 0x63, 0x68, 0x44,
	0x65, 0x48, 0x69, 0x73, 0x74, 0x6f, 0x72, 0x79, 0x53, 0x65, 0x67, 0x6d, 0x65, 0x6e, 0x74, 0x52,
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x2c, 0x0a, 0x12, 0x68, 0x69, 0x73, 0x74, 0x6f, 0x72,
	0x79, 0x5f, 0x73, 0x65, 0x67, 0x6d, 0x65, 0x6e, 0x74, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x10, 0x68, 0x69, 0x73, 0x74, 0x6f, 0x72, 0x79, 0x53, 0x65, 0x67, 0x6d, 0x65,
	0x6e, 0x74, 0x49, 0x64, 0x22, 0x5a, 0x0a, 0x1d, 0x46, 0x65, 0x74, 0x63, 0x68, 0x44, 0x65, 0x48,
	...
	0x22, 0x28, 0x0a, 0x26, 0x47, 0x65, 0x74, 0x41, 0x63, 0x74, 0x69, 0x76, 0x65, 0x44, 0x65, 0x48,
	0x69, 0x73, 0x74, 0x6f, 0x72, 0x79, 0x50, 0x65, 0x65, 0x72, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73,
	0x73, 0x65, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0x4c, 0x0a, 0x27, 0x47, 0x65,
	...
	,
	...
	0x5f, 0x54, 0x4f, 0x5f, 0x4f, 0x52, 0x5f, 0x46, 0x52, 0x4f, 0x4d, 0x10, 0x03, 0x32, 0xfa, 0x46,
	0x0a, 0x12, 0x54, 0x72, 0x61, 0x64, 0x69, 0x6e, 0x67, 0x44, 0x61, 0x74, 0x61, 0x53, 0x65, 0x72,
	0x76, 0x69, 0x63, 0x65, 0x12, 0x5b, 0x0a, 0x0c, 0x4c, 0x69, 0x73, 0x74, 0x41, 0x63, 0x63, 0x6f,
	0x75, 0x6e, 0x74, 0x73, 0x12, 0x24, 0x2e, 0x64, 0x61, 0x74, 0x61, 0x6e, 0x6f, 0x64, 0x65, 0x2e,
	...
	0x65, 0x12, 0x66, 0x0a, 0x0f, 0x4f, 0x62, 0x73, 0x65, 0x72, 0x76, 0x65, 0x41, 0x63, 0x63, 0x6f,
	...
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x30, 0x01, 0x12, 0x43, 0x0a, 0x04, 0x49, 0x6e, 0x66,
	...
	0x32, 0x2e, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x4f,
	...
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x6a, 0x0a, 0x11, 0x4c, 0x69, 0x73, 0x74, 0x4f, 0x72,
	...
	0x73, 0x65, 0x12, 0x60, 0x0a, 0x0d, 0x4f, 0x62, 0x73, 0x65, 0x72, 0x76, 0x65, 0x4f, 0x72, 0x64,
	...
	0x73, 0x65, 0x30, 0x01, 0x12, 0x5e, 0x0a, 0x0d, 0x4c, 0x69, 0x73, 0x74, 0x50, 0x6f, 0x73, 0x69,
	...
	0x6f, 0x6e, 0x73, 0x65, 0x12, 0x69, 0x0a, 0x10, 0x4f, 0x62, 0x73, 0x65, 0x72, 0x76, 0x65, 0x50,
	...
	0x6c, 0x0a, 0x11, 0x4c, 0x69, 0x73, 0x74, 0x4c, 0x65, 0x64, 0x67, 0x65, 0x72, 0x45, 0x6e, 0x74,
	...
	0x69, 0x65, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x6f, 0x0a,
	...
	0x6e, 0x67, 0x65, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x70,
	...
	0x12, 0x73, 0x0a, 0x14, 0x4c, 0x69, 0x73, 0x74, 0x4c, 0x61, 0x74, 0x65, 0x73, 0x74, 0x4d, 0x61,
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x73, 0x0a, 0x14, 0x47, 0x65, 0x74, 0x4c, 0x61, 0x74, 0x65,
	0x73, 0x74, 0x4d, 0x61, 0x72, 0x6b, 0x65, 0x74, 0x44, 0x65, 0x70, 0x74, 0x68, 0x12, 0x2c, 0x2e,
	0x64, 0x61, 0x74, 0x61, 0x6e, 0x6f, 0x64, 0x65, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x76, 0x32, 0x2e,
	0x47, 0x65, 0x74, 0x4c, 0x61, 0x74, 0x65, 0x73, 0x74, 0x4d, 0x61, 0x72, 0x6b, 0x65, 0x74, 0x44,
	0x65, 0x70, 0x74, 0x68, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x2d, 0x2e, 0x64, 0x61,
	...
	0x74, 0x68, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x72, 0x0a, 0x13, 0x4f, 0x62,
	...
	0x65, 0x70, 0x74, 0x68, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x30, 0x01, 0x12, 0x87,
	0x01, 0x0a, 0x1a, 0x4f, 0x62, 0x73, 0x65, 0x72, 0x76, 0x65, 0x4d, 0x61, 0x72, 0x6b, 0x65, 0x74,
	0x73, 0x44, 0x65, 0x70, 0x74, 0x68, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x73, 0x12, 0x32, 0x2e,
	0x64, 0x61, 0x74, 0x61, 0x6e, 0x6f, 0x64, 0x65, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x76, 0x32, 0x2e,
	0x4f, 0x62, 0x73, 0x65, 0x72, 0x76, 0x65, 0x4d, 0x61, 0x72, 0x6b, 0x65, 0x74, 0x73, 0x44, 0x65,
	0x70, 0x74, 0x68, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	...
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x30, 0x01, 0x12, 0x6f, 0x0a, 0x12, 0x4f, 0x62, 0x73, 0x65,
	...
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x30, 0x01, 0x12, 0x7f, 0x0a, 0x18, 0x47, 0x65, 0x74,
	...
	0x49, 0x44, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x5e, 0x0a, 0x0d, 0x4c, 0x69,
	...
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x30, 0x01, 0x12, 0xa0, 0x01, 0x0a, 0x23, 0x4c, 0x69,
	...
	0x64, 0x6c, 0x65, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0xa6, 0x01, 0x0a,
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x7c, 0x0a, 0x17, 0x47, 0x65, 0x74, 0x45, 0x52, 0x43, 0x32,
	...
	0x6e, 0x73, 0x65, 0x12, 0x8b, 0x01, 0x0a, 0x1c, 0x47, 0x65, 0x74, 0x45, 0x52, 0x43, 0x32, 0x30,
	...
	0x65, 0x12, 0x85, 0x01, 0x0a, 0x1a, 0x47, 0x65, 0x74, 0x45, 0x52, 0x43, 0x32, 0x30, 0x57, 0x69,
	...
	0x6c, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x5b, 0x0a, 0x0c, 0x47, 0x65, 0x74,
	...
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x55, 0x0a, 0x0a, 0x4c, 0x69, 0x73, 0x74, 0x54, 0x72,
	...
	0x72, 0x61, 0x64, 0x65, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x60, 0x0a,
	...
	0x72, 0x61, 0x64, 0x65, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x30, 0x01, 0x12,
	0x5e, 0x0a, 0x0d, 0x47, 0x65, 0x74, 0x4f, 0x72, 0x61, 0x63, 0x6c, 0x65, 0x53, 0x70, 0x65, 0x63,
	...
	0x64, 0x0a, 0x0f, 0x4c, 0x69, 0x73, 0x74, 0x4f, 0x72, 0x61, 0x63, 0x6c, 0x65, 0x53, 0x70, 0x65,
	...
	0x72, 0x6b, 0x65, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x58, 0x0a, 0x0b,
	0x4c, 0x69, 0x73, 0x74, 0x4d, 0x61, 0x72, 0x6b, 0x65, 0x74, 0x73, 0x12, 0x23, 0x2e, 0x64, 0x61,
	0x74, 0x61, 0x6e, 0x6f, 0x64, 0x65, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x76, 0x32, 0x2e, 0x4c, 0x69,
	...
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x4f, 0x0a, 0x08, 0x47, 0x65, 0x74, 0x50, 0x61, 0x72,
	...
	0x6c, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x72, 0x0a, 0x13, 0x4f, 0x62,
	0x73, 0x65, 0x72, 0x76, 0x65, 0x4d, 0x61, 0x72, 0x67, 0x69, 0x6e, 0x4c, 0x65, 0x76, 0x65, 0x6c,
	...
	0x76, 0x65, 0x6c, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x30, 0x01, 0x12, 0x58,
	...
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x70, 0x0a, 0x13, 0x4c, 0x69, 0x73, 0x74,
	...
	0x61, 0x72, 0x69, 0x65, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x2c, 0x2e, 0x64,
	0x61, 0x74, 0x61, 0x6e, 0x6f, 0x64, 0x65, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x76, 0x32, 0x2e, 0x4c,
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x58, 0x0a, 0x0b, 0x47, 0x65, 0x74, 0x50, 0x72, 0x6f, 0x70,
	0x6f, 0x73, 0x61, 0x6c, 0x12, 0x23, 0x2e, 0x64, 0x61, 0x74, 0x61, 0x6e, 0x6f, 0x64, 0x65, 0x2e,
	0x61, 0x70, 0x69, 0x2e, 0x76, 0x32, 0x2e, 0x47, 0x65, 0x74, 0x50, 0x72, 0x6f, 0x70, 0x6f, 0x73,
	0x61, 0x6c, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x24, 0x2e, 0x64, 0x61, 0x74, 0x61,
	...
	0x63, 0x65, 0x44, 0x61, 0x74, 0x61, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x5e,
	...
	0x70, 0x6f, 0x73, 0x61, 0x6c, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x6c,
	...
	0x63, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x30, 0x01, 0x12, 0x64, 0x0a, 0x0f,
	...
	0x73, 0x65, 0x12, 0x6f, 0x0a, 0x12, 0x4f, 0x62, 0x73, 0x65, 0x72, 0x76, 0x65, 0x44, 0x65, 0x6c,
	0x65, 0x67, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x12, 0x2a, 0x2e, 0x64, 0x61, 0x74, 0x61, 0x6e,
	0x6f, 0x64, 0x65, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x76, 0x32, 0x2e, 0x4f, 0x62, 0x73, 0x65, 0x72,
	...
	,
	...
	0x6f, 0x6e, 0x73, 0x65, 0x12, 0x52, 0x0a, 0x09, 0x4c, 0x69, 0x73, 0x74, 0x4e, 0x6f, 0x64, 0x65,
	...
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x4f, 0x0a, 0x08, 0x47, 0x65, 0x74, 0x45, 0x70,
	...
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x58, 0x0a, 0x0b, 0x45, 0x73, 0x74, 0x69,
	...
	,
	...
	0x64, 0x0a, 0x0f, 0x4c, 0x69, 0x73, 0x74, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x70, 0x6f, 0x69, 0x6e,
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x4f, 0x0a, 0x08, 0x47, 0x65, 0x74, 0x53, 0x74, 0x61, 0x6b,
	...
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x61, 0x0a, 0x0e, 0x47, 0x65, 0x74, 0x52, 0x69, 0x73,
	...
	0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x68, 0x0a, 0x0f, 0x4f, 0x62, 0x73,
	...
	0x76, 0x65, 0x6e, 0x74, 0x42, 0x75, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x28,
	0x01, 0x30, 0x01, 0x12, 0x7b, 0x0a, 0x16, 0x4f, 0x62, 0x73, 0x65, 0x72, 0x76, 0x65, 0x4c, 0x65,
	...
	0x64, 0x61, 0x74, 0x61, 0x6e, 0x6f, 0x64, 0x65, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x76, 0x32, 0x2e,
	0x4f, 0x62, 0x73, 0x65, 0x72, 0x76, 0x65, 0x4c, 0x65, 0x64, 0x67, 0x65, 0x72, 0x4d, 0x6f, 0x76,
	0x65, 0x6d, 0x65, 0x6e, 0x74, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x30, 0x01,
	0x12, 0x67, 0x0a, 0x10, 0x4c, 0x69, 0x73, 0x74, 0x4b, 0x65, 0x79, 0x52, 0x6f, 0x74, 0x61, 0x74,
	...
	0x6f, 0x6e, 0x73, 0x65, 0x12, 0x7f, 0x0a, 0x18, 0x47, 0x65, 0x74, 0x50, 0x72, 0x6f, 0x74, 0x6f,
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x8b, 0x01, 0x0a, 0x1c, 0x4c, 0x69, 0x73, 0x74, 0x50, 0x72,
	...
	0x6e, 0x73, 0x65, 0x12, 0x8e, 0x01, 0x0a, 0x1d, 0x47, 0x65, 0x74, 0x4d, 0x6f, 0x73, 0x74, 0x52,
	0x65, 0x63, 0x65, 0x6e, 0x74, 0x44, 0x65, 0x48, 0x69, 0x73, 0x74, 0x6f, 0x72, 0x79, 0x53, 0x65,
	0x67, 0x6d, 0x65, 0x6e, 0x74, 0x12, 0x35, 0x2e, 0x64, 0x61, 0x74, 0x61, 0x6e, 0x6f, 0x64, 0x65,
	0x2e, 0x61, 0x70, 0x69, 0x2e, 0x76, 0x32, 0x2e, 0x47, 0x65, 0x74, 0x4d, 0x6f, 0x73, 0x74, 0x52,
	0x65, 0x63, 0x65, 0x6e, 0x74, 0x44, 0x65, 0x48, 0x69, 0x73, 0x74, 0x6f, 0x72, 0x79, 0x53, 0x65,
	0x67, 0x6d, 0x65, 0x6e, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x36, 0x2e, 0x64,
	0x61, 0x74, 0x61, 0x6e, 0x6f, 0x64, 0x65, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x76, 0x32, 0x2e, 0x47,
	...
	,
	...
	0x67, 0x6d, 0x65, 0x6e, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x94, 0x01,
	0x0a, 0x1f, 0x47, 0x65, 0x74, 0x41, 0x63, 0x74, 0x69, 0x76, 0x65, 0x44, 0x65, 0x48, 0x69, 0x73,
	...
	,
	...
	0x6e, 0x67, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x81, 0x01, 0x5a, 0x31, 0x63,
	...
	0x92, 0x41, 0x4b, 0x12, 0x22, 0x0a, 0x13, 0x56, 0x65, 0x67, 0x61, 0x20, 0x64, 0x61, 0x74, 0x61,
	0x20, 0x6e, 0x6f, 0x64, 0x65, 0x20, 0x41, 0x50, 0x49, 0x73, 0x32, 0x0b, 0x76, 0x30, 0x2e, 0x36,
	0x33, 0x2e, 0x30, 0x2b, 0x64, 0x65, 0x76, 0x1a, 0x21, 0x6c, 0x62, 0x2e, 0x74, 0x65, 0x73, 0x74,
...
var file_data_node_api_v2_trading_data_proto_msgTypes = make([]protoimpl.MessageInfo, 265)
var file_data_node_api_v2_trading_data_proto_goTypes = []interface{}{
	...
	(ListProposalsRequest_Type)(0),                        // 4: datanode.api.v2.ListProposalsRequest.Type
	...
	(*PositionEdge)(nil),                                  // 32: datanode.api.v2.PositionEdge
	(*PositionConnection)(nil),                            // 33: datanode.api.v2.PositionConnection
	(*ObservePositionsRequest)(nil),                       // 34: datanode.api.v2.ObservePositionsRequest
	(*ObservePositionsResponse)(nil),                      // 35: datanode.api.v2.ObservePositionsResponse
	(*PositionSnapshotPage)(nil),                          // 36: datanode.api.v2.PositionSnapshotPage
	(*PositionUpdates)(nil),                               // 37: datanode.api.v2.PositionUpdates
	(*LedgerEntryFilter)(nil),                             // 38: datanode.api.v2.LedgerEntryFilter
	(*AggregatedLedgerEntry)(nil),                         // 39: datanode.api.v2.AggregatedLedgerEntry
	(*ListLedgerEntriesRequest)(nil),                      // 40: datanode.api.v2.ListLedgerEntriesRequest
	(*ListLedgerEntriesResponse)(nil),                     // 41: datanode.api.v2.ListLedgerEntriesResponse
	(*AggregatedLedgerEntriesEdge)(nil),                   // 42: datanode.api.v2.AggregatedLedgerEntriesEdge
	(*AggregatedLedgerEntriesConnection)(nil),             // 43: datanode.api.v2.AggregatedLedgerEntriesConnection
	(*ListBalanceChangesRequest)(nil),                     // 44: datanode.api.v2.ListBalanceChangesRequest
	(*ListBalanceChangesResponse)(nil),                    // 45: datanode.api.v2.ListBalanceChangesResponse
	(*GetBalanceHistoryRequest)(nil),                      // 46: datanode.api.v2.GetBalanceHistoryRequest
	(*GetBalanceHistoryResponse)(nil),                     // 47: datanode.api.v2.GetBalanceHistoryResponse
	(*AggregatedBalanceEdge)(nil),                         // 48: datanode.api.v2.AggregatedBalanceEdge
	(*AggregatedBalanceConnection)(nil),                   // 49: datanode.api.v2.AggregatedBalanceConnection
	(*AccountFilter)(nil),                                 // 50: datanode.api.v2.AccountFilter
	(*AggregatedBalance)(nil),                             // 51: datanode.api.v2.AggregatedBalance
	(*ObserveMarketsDepthRequest)(nil),                    // 52: datanode.api.v2.ObserveMarketsDepthRequest
	(*ObserveMarketsDepthResponse)(nil),                   // 53: datanode.api.v2.ObserveMarketsDepthResponse
	(*ObserveMarketsDepthUpdatesRequest)(nil),             // 54: datanode.api.v2.ObserveMarketsDepthUpdatesRequest
	(*ObserveMarketsDepthUpdatesResponse)(nil),            // 55: datanode.api.v2.ObserveMarketsDepthUpdatesResponse
	(*ObserveMarketsDataRequest)(nil),                     // 56: datanode.api.v2.ObserveMarketsDataRequest
	(*ObserveMarketsDataResponse)(nil),                    // 57: datanode.api.v2.ObserveMarketsDataResponse
	(*GetLatestMarketDepthRequest)(nil),                   // 58: datanode.api.v2.GetLatestMarketDepthRequest
	(*GetLatestMarketDepthResponse)(nil),                  // 59: datanode.api.v2.GetLatestMarketDepthResponse
	(*ListLatestMarketDataRequest)(nil),                   // 60: datanode.api.v2.ListLatestMarketDataRequest
	(*ListLatestMarketDataResponse)(nil),                  // 61: datanode.api.v2.ListLatestMarketDataResponse
	(*GetLatestMarketDataRequest)(nil),                    // 62: datanode.api.v2.GetLatestMarketDataRequest
	(*GetLatestMarketDataResponse)(nil),                   // 63: datanode.api.v2.GetLatestMarketDataResponse
	(*GetMarketDataHistoryByIDRequest)(nil),               // 64: datanode.api.v2.GetMarketDataHistoryByIDRequest
	(*GetMarketDataHistoryByIDResponse)(nil),              // 65: datanode.api.v2.GetMarketDataHistoryByIDResponse
	(*MarketDataEdge)(nil),                                // 66: datanode.api.v2.MarketDataEdge
	(*MarketDataConnection)(nil),                          // 67: datanode.api.v2.MarketDataConnection
	(*MarketsDataSubscribeRequest)(nil),                   // 68: datanode.api.v2.MarketsDataSubscribeRequest
	(*MarketsDataSubscribeResponse)(nil),                  // 69: datanode.api.v2.MarketsDataSubscribeResponse
	(*ListTransfersRequest)(nil),                          // 70: datanode.api.v2.ListTransfersRequest
	(*ListTransfersResponse)(nil),                         // 71: datanode.api.v2.ListTransfersResponse
	(*TransferEdge)(nil),                                  // 72: datanode.api.v2.TransferEdge
	(*TransferConnection)(nil),                            // 73: datanode.api.v2.TransferConnection
	(*GetNetworkLimitsRequest)(nil),                       // 74: datanode.api.v2.GetNetworkLimitsRequest
	(*GetNetworkLimitsResponse)(nil),                      // 75: datanode.api.v2.GetNetworkLimitsResponse
	(*ListCandleIntervalsRequest)(nil),                    // 76: datanode.api.v2.ListCandleIntervalsRequest
	(*IntervalToCandleId)(nil),                            // 77: datanode.api.v2.IntervalToCandleId
	(*ListCandleIntervalsResponse)(nil),                   // 78: datanode.api.v2.ListCandleIntervalsResponse
	(*Candle)(nil),                                        // 79: datanode.api.v2.Candle
	(*ObserveCandleDataRequest)(nil),                      // 80: datanode.api.v2.ObserveCandleDataRequest
	(*ObserveCandleDataResponse)(nil),                     // 81: datanode.api.v2.ObserveCandleDataResponse
	(*ListCandleDataRequest)(nil),                         // 82: datanode.api.v2.ListCandleDataRequest
	(*ListCandleDataResponse)(nil),                        // 83: datanode.api.v2.ListCandleDataResponse
	(*CandleEdge)(nil),                                    // 84: datanode.api.v2.CandleEdge
	(*CandleDataConnection)(nil),                          // 85: datanode.api.v2.CandleDataConnection
	(*ListVotesRequest)(nil),                              // 86: datanode.api.v2.ListVotesRequest
	(*ListVotesResponse)(nil),                             // 87: datanode.api.v2.ListVotesResponse
	(*VoteEdge)(nil),                                      // 88: datanode.api.v2.VoteEdge
	(*VoteConnection)(nil),                                // 89: datanode.api.v2.VoteConnection
	(*ObserveVotesRequest)(nil),                           // 90: datanode.api.v2.ObserveVotesRequest
	(*ObserveVotesResponse)(nil),                          // 91: datanode.api.v2.ObserveVotesResponse
	(*ListERC20MultiSigSignerAddedBundlesRequest)(nil),    // 92: datanode.api.v2.ListERC20MultiSigSignerAddedBundlesRequest
	(*ListERC20MultiSigSignerAddedBundlesResponse)(nil),   // 93: datanode.api.v2.ListERC20MultiSigSignerAddedBundlesResponse
	(*ERC20MultiSigSignerAddedEdge)(nil),                  // 94: datanode.api.v2.ERC20MultiSigSignerAddedEdge
	(*ERC20MultiSigSignerAddedBundleEdge)(nil),            // 95: datanode.api.v2.ERC20MultiSigSignerAddedBundleEdge
	(*ERC20MultiSigSignerAddedConnection)(nil),            // 96: datanode.api.v2.ERC20MultiSigSignerAddedConnection
	(*ERC20MultiSigSignerAddedBundle)(nil),                // 97: datanode.api.v2.ERC20MultiSigSignerAddedBundle
	(*ListERC20MultiSigSignerRemovedBundlesRequest)(nil),  // 98: datanode.api.v2.ListERC20MultiSigSignerRemovedBundlesRequest
	(*ListERC20MultiSigSignerRemovedBundlesResponse)(nil), // 99: datanode.api.v2.ListERC20MultiSigSignerRemovedBundlesResponse
	(*ERC20MultiSigSignerRemovedEdge)(nil),                // 100: datanode.api.v2.ERC20MultiSigSignerRemovedEdge
	(*ERC20MultiSigSignerRemovedBundleEdge)(nil),          // 101: datanode.api.v2.ERC20MultiSigSignerRemovedBundleEdge
	(*ERC20MultiSigSignerRemovedConnection)(nil),          // 102: datanode.api.v2.ERC20MultiSigSignerRemovedConnection
	(*ERC20MultiSigSignerRemovedBundle)(nil),              // 103: datanode.api.v2.ERC20MultiSigSignerRemovedBundle
	(*GetERC20ListAssetBundleRequest)(nil),                // 104: datanode.api.v2.GetERC20ListAssetBundleRequest
	(*GetERC20ListAssetBundleResponse)(nil),               // 105: datanode.api.v2.GetERC20ListAssetBundleResponse
	(*GetERC20SetAssetLimitsBundleRequest)(nil),           // 106: datanode.api.v2.GetERC20SetAssetLimitsBundleRequest
	(*GetERC20SetAssetLimitsBundleResponse)(nil),          // 107: datanode.api.v2.GetERC20SetAssetLimitsBundleResponse
	(*GetERC20WithdrawalApprovalRequest)(nil),             // 108: datanode.api.v2.GetERC20WithdrawalApprovalRequest
	(*GetERC20WithdrawalApprovalResponse)(nil),            // 109: datanode.api.v2.GetERC20WithdrawalApprovalResponse
	(*GetLastTradeRequest)(nil),                           // 110: datanode.api.v2.GetLastTradeRequest
	(*GetLastTradeResponse)(nil),                          // 111: datanode.api.v2.GetLastTradeResponse
	(*ListTradesRequest)(nil),                             // 112: datanode.api.v2.ListTradesRequest
	(*ListTradesResponse)(nil),                            // 113: datanode.api.v2.ListTradesResponse
	(*TradeConnection)(nil),                               // 114: datanode.api.v2.TradeConnection
	(*TradeEdge)(nil),                                     // 115: datanode.api.v2.TradeEdge
	(*ObserveTradesRequest)(nil),                          // 116: datanode.api.v2.ObserveTradesRequest
	(*ObserveTradesResponse)(nil),                         // 117: datanode.api.v2.ObserveTradesResponse
	(*GetOracleSpecRequest)(nil),                          // 118: datanode.api.v2.GetOracleSpecRequest
	(*GetOracleSpecResponse)(nil),                         // 119: datanode.api.v2.GetOracleSpecResponse
	(*ListOracleSpecsRequest)(nil),                        // 120: datanode.api.v2.ListOracleSpecsRequest
	(*ListOracleSpecsResponse)(nil),                       // 121: datanode.api.v2.ListOracleSpecsResponse
	(*ListOracleDataRequest)(nil),                         // 122: datanode.api.v2.ListOracleDataRequest
	(*ListOracleDataResponse)(nil),                        // 123: datanode.api.v2.ListOracleDataResponse
	(*OracleSpecEdge)(nil),                                // 124: datanode.api.v2.OracleSpecEdge
	(*OracleSpecsConnection)(nil),                         // 125: datanode.api.v2.OracleSpecsConnection
	(*OracleDataEdge)(nil),                                // 126: datanode.api.v2.OracleDataEdge
	(*OracleDataConnection)(nil),                          // 127: datanode.api.v2.OracleDataConnection
	(*GetMarketRequest)(nil),                              // 128: datanode.api.v2.GetMarketRequest
	(*GetMarketResponse)(nil),                             // 129: datanode.api.v2.GetMarketResponse
	(*ListMarketsRequest)(nil),                            // 130: datanode.api.v2.ListMarketsRequest
	(*ListMarketsResponse)(nil),                           // 131: datanode.api.v2.ListMarketsResponse
	(*MarketEdge)(nil),                                    // 132: datanode.api.v2.MarketEdge
	(*MarketConnection)(nil),                              // 133: datanode.api.v2.MarketConnection
	(*GetPartyRequest)(nil),                               // 134: datanode.api.v2.GetPartyRequest
	(*GetPartyResponse)(nil),                              // 135: datanode.api.v2.GetPartyResponse
	(*ListPartiesRequest)(nil),                            // 136: datanode.api.v2.ListPartiesRequest
	(*ListPartiesResponse)(nil),                           // 137: datanode.api.v2.ListPartiesResponse
	(*PartyEdge)(nil),                                     // 138: datanode.api.v2.PartyEdge
	(*PartyConnection)(nil),                               // 139: datanode.api.v2.PartyConnection
	(*OrderEdge)(nil),                                     // 140: datanode.api.v2.OrderEdge
	(*ListMarginLevelsRequest)(nil),                       // 141: datanode.api.v2.ListMarginLevelsRequest
	(*ListMarginLevelsResponse)(nil),                      // 142: datanode.api.v2.ListMarginLevelsResponse
	(*ObserveMarginLevelsRequest)(nil),                    // 143: datanode.api.v2.ObserveMarginLevelsRequest
	(*ObserveMarginLevelsResponse)(nil),                   // 144: datanode.api.v2.ObserveMarginLevelsResponse
	(*OrderConnection)(nil),                               // 145: datanode.api.v2.OrderConnection
	(*MarginEdge)(nil),                                    // 146: datanode.api.v2.MarginEdge
	(*MarginConnection)(nil),                              // 147: datanode.api.v2.MarginConnection
	(*ListRewardsRequest)(nil),                            // 148: datanode.api.v2.ListRewardsRequest
	(*ListRewardsResponse)(nil),                           // 149: datanode.api.v2.ListRewardsResponse
	(*RewardEdge)(nil),                                    // 150: datanode.api.v2.RewardEdge
	(*RewardsConnection)(nil),                             // 151: datanode.api.v2.RewardsConnection
	(*ListRewardSummariesRequest)(nil),                    // 152: datanode.api.v2.ListRewardSummariesRequest
	(*ListRewardSummariesResponse)(nil),                   // 153: datanode.api.v2.ListRewardSummariesResponse
	(*ObserveRewardsRequest)(nil),                         // 154: datanode.api.v2.ObserveRewardsRequest
	(*ObserveRewardsResponse)(nil),                        // 155: datanode.api.v2.ObserveRewardsResponse
	(*GetDepositRequest)(nil),                             // 156: datanode.api.v2.GetDepositRequest
	(*GetDepositResponse)(nil),                            // 157: datanode.api.v2.GetDepositResponse
	(*ListDepositsRequest)(nil),                           // 158: datanode.api.v2.ListDepositsRequest
	(*ListDepositsResponse)(nil),                          // 159: datanode.api.v2.ListDepositsResponse
	(*DepositEdge)(nil),                                   // 160: datanode.api.v2.DepositEdge
	(*DepositsConnection)(nil),                            // 161: datanode.api.v2.DepositsConnection
	(*GetWithdrawalRequest)(nil),                          // 162: datanode.api.v2.GetWithdrawalRequest
	(*GetWithdrawalResponse)(nil),                         // 163: datanode.api.v2.GetWithdrawalResponse
	(*ListWithdrawalsRequest)(nil),                        // 164: datanode.api.v2.ListWithdrawalsRequest
	(*ListWithdrawalsResponse)(nil),                       // 165: datanode.api.v2.ListWithdrawalsResponse
	(*WithdrawalEdge)(nil),                                // 166: datanode.api.v2.WithdrawalEdge
	(*WithdrawalsConnection)(nil),                         // 167: datanode.api.v2.WithdrawalsConnection
	(*GetAssetRequest)(nil),                               // 168: datanode.api.v2.GetAssetRequest
	(*GetAssetResponse)(nil),                              // 169: datanode.api.v2.GetAssetResponse
	(*ListAssetsRequest)(nil),                             // 170: datanode.api.v2.ListAssetsRequest
	(*ListAssetsResponse)(nil),                            // 171: datanode.api.v2.ListAssetsResponse
	(*AssetEdge)(nil),                                     // 172: datanode.api.v2.AssetEdge
	(*AssetsConnection)(nil),                              // 173: datanode.api.v2.AssetsConnection
	(*ListLiquidityProvisionsRequest)(nil),                // 174: datanode.api.v2.ListLiquidityProvisionsRequest
	(*ListLiquidityProvisionsResponse)(nil),               // 175: datanode.api.v2.ListLiquidityProvisionsResponse
	(*LiquidityProvisionsEdge)(nil),                       // 176: datanode.api.v2.LiquidityProvisionsEdge
	(*LiquidityProvisionsConnection)(nil),                 // 177: datanode.api.v2.LiquidityProvisionsConnection
	(*ObserveLiquidityProvisionsRequest)(nil),             // 178: datanode.api.v2.ObserveLiquidityProvisionsRequest
	(*ObserveLiquidityProvisionsResponse)(nil),            // 179: datanode.api.v2.ObserveLiquidityProvisionsResponse
	(*GetGovernanceDataRequest)(nil),                      // 180: datanode.api.v2.GetGovernanceDataRequest
	(*GetGovernanceDataResponse)(nil),                     // 181: datanode.api.v2.GetGovernanceDataResponse
	(*GetProposalRequest)(nil),                            // 182: datanode.api.v2.GetProposalRequest
	(*GetProposalResponse)(nil),                           // 183: datanode.api.v2.GetProposalResponse
	(*ListGovernanceDataRequest)(nil),                     // 184: datanode.api.v2.ListGovernanceDataRequest
	(*ListProposalsRequest)(nil),                          // 185: datanode.api.v2.ListProposalsRequest
	(*ListProposalsResponse)(nil),                         // 186: datanode.api.v2.ListProposalsResponse
	(*ProposalsEdge)(nil),                                 // 187: datanode.api.v2.ProposalsEdge
	(*ProposalData)(nil),                                  // 188: datanode.api.v2.ProposalData
	(*ProposalsConnection)(nil),                           // 189: datanode.api.v2.ProposalsConnection
	...
	(*HistorySegment)(nil),                                // 257: datanode.api.v2.HistorySegment
	(*GetMostRecentDeHistorySegmentRequest)(nil),          // 258: datanode.api.v2.GetMostRecentDeHistorySegmentRequest
	(*GetMostRecentDeHistorySegmentResponse)(nil),         // 259: datanode.api.v2.GetMostRecentDeHistorySegmentResponse
	(*ListAllDeHistorySegmentsRequest)(nil),               // 260: datanode.api.v2.ListAllDeHistorySegmentsRequest
	(*ListAllDeHistorySegmentsResponse)(nil),              // 261: datanode.api.v2.ListAllDeHistorySegmentsResponse
	(*FetchDeHistorySegmentRequest)(nil),                  // 262: datanode.api.v2.FetchDeHistorySegmentRequest
	(*FetchDeHistorySegmentResponse)(nil),                 // 263: datanode.api.v2.FetchDeHistorySegmentResponse
	(*GetActiveDeHistoryPeerAddressesRequest)(nil),        // 264: datanode.api.v2.GetActiveDeHistoryPeerAddressesRequest
	(*GetActiveDeHistoryPeerAddressesResponse)(nil),       // 265: datanode.api.v2.GetActiveDeHistoryPeerAddressesResponse
	(*CopyHistorySegmentToFileRequest)(nil),               // 266: datanode.api.v2.CopyHistorySegmentToFileRequest
	(*CopyHistorySegmentToFileResponse)(nil),              // 267: datanode.api.v2.CopyHistorySegmentToFileResponse
	(*PingRequest)(nil),                                   // 268: datanode.api.v2.PingRequest
	(*PingResponse)(nil),                                  // 269: datanode.api.v2.PingResponse
	(vega.AccountType)(0),                                 // 270: vega.AccountType
	(*vega.Order)(nil),                                    // 271: vega.Order
	(vega.Order_Status)(0),                                // 272: vega.Order.Status
	(vega.Order_Type)(0),                                  // 273: vega.Order.Type
	(vega.Order_TimeInForce)(0),                           // 274: vega.Order.TimeInForce
	(*vega.Position)(nil),                                 // 275: vega.Position
	(vega.TransferType)(0),                                // 276: vega.TransferType
	(*vega.MarketDepth)(nil),                              // 277: vega.MarketDepth
	(*vega.MarketDepthUpdate)(nil),                        // 278: vega.MarketDepthUpdate
	(*vega.MarketData)(nil),                               // 279: vega.MarketData
	(*vega.PriceLevel)(nil),                               // 280: vega.PriceLevel
	(*vega.Trade)(nil),                                    // 281: vega.Trade
	(*v1.Transfer)(nil),                                   // 282: vega.events.v1.Transfer
	(*vega.NetworkLimits)(nil),                            // 283: vega.NetworkLimits
	(vega.Interval)(0),                                    // 284: vega.Interval
	(*vega.Vote)(nil),                                     // 285: vega.Vote
	(*v1.ERC20MultiSigSignerAdded)(nil),                   // 286: vega.events.v1.ERC20MultiSigSignerAdded
	(*v1.ERC20MultiSigSignerRemoved)(nil),                 // 287: vega.events.v1.ERC20MultiSigSignerRemoved
	(*vega.OracleSpec)(nil),                               // 288: vega.OracleSpec
	(*vega.OracleData)(nil),                               // 289: vega.OracleData
	(*vega.Market)(nil),                                   // 290: vega.Market
	(*vega.Party)(nil),                                    // 291: vega.Party
	(*vega.MarginLevels)(nil),                             // 292: vega.MarginLevels
	(*vega.Reward)(nil),                                   // 293: vega.Reward
	(*vega.RewardSummary)(nil),                            // 294: vega.RewardSummary
	(*vega.Deposit)(nil),                                  // 295: vega.Deposit
	(*vega.Withdrawal)(nil),                               // 296: vega.Withdrawal
	(*vega.Asset)(nil),                                    // 297: vega.Asset
	(*vega.LiquidityProvision)(nil),                       // 298: vega.LiquidityProvision
	(*vega.GovernanceData)(nil),                           // 299: vega.GovernanceData
	(*vega.Proposal)(nil),                                 // 300: vega.Proposal
	(vega.Proposal_State)(0),                              // 301: vega.Proposal.State
	(*vega.Delegation)(nil),                               // 302: vega.Delegation
	(*vega.NodeData)(nil),                                 // 303: vega.NodeData
	(*vega.Node)(nil),                                     // 304: vega.Node
	(*v11.NodeSignature)(nil),                             // 305: vega.commands.v1.NodeSignature
	(*vega.Epoch)(nil),                                    // 306: vega.Epoch
	(*vega.Fee)(nil),                                      // 307: vega.Fee
	(vega.Side)(0),                                        // 308: vega.Side
	(*vega.NetworkParameter)(nil),                         // 309: vega.NetworkParameter
	(*v1.StakeLinking)(nil),                               // 310: vega.events.v1.StakeLinking
	(*vega.RiskFactor)(nil),                               // 311: vega.RiskFactor
	(v1.BusEventType)(0),                                  // 312: vega.events.v1.BusEventType
	(*v1.BusEvent)(nil),                                   // 313: vega.events.v1.BusEvent
	(*vega.LedgerMovement)(nil),                           // 314: vega.LedgerMovement
	(*v1.KeyRotation)(nil),                                // 315: vega.events.v1.KeyRotation
	(*v1.EthereumKeyRotation)(nil),                        // 316: vega.events.v1.EthereumKeyRotation
	(v1.ProtocolUpgradeProposalStatus)(0),                 // 317: vega.events.v1.ProtocolUpgradeProposalStatus
	(*v1.ProtocolUpgradeEvent)(nil),                       // 318: vega.events.v1.ProtocolUpgradeEvent
}
var file_data_node_api_v2_trading_data_proto_depIdxs = []int32{
	270, // 0: datanode.api.v2.AccountBalance.type:type_name -> vega.AccountType
	50,  // 1: datanode.api.v2.ListAccountsRequest.filter:type_name -> datanode.api.v2.AccountFilter
	...
	270, // 7: datanode.api.v2.ObserveAccountsRequest.type:type_name -> vega.AccountType
	...
	271, // 12: datanode.api.v2.GetOrderResponse.order:type_name -> vega.Order
	272, // 13: datanode.api.v2.OrderFilter.statuses:type_name -> vega.Order.Status
	273, // 14: datanode.api.v2.OrderFilter.types:type_name -> vega.Order.Type
	274, // 15: datanode.api.v2.OrderFilter.time_in_forces:type_name -> vega.Order.TimeInForce
	6,   // 16: datanode.api.v2.ListOrdersRequest.pagination:type_name -> datanode.api.v2.Pagination
	250, // 17: datanode.api.v2.ListOrdersRequest.date_range:type_name -> datanode.api.v2.DateRange
	21,  // 18: datanode.api.v2.ListOrdersRequest.filter:type_name -> datanode.api.v2.OrderFilter
	145, // 19: datanode.api.v2.ListOrdersResponse.orders:type_name -> datanode.api.v2.OrderConnection
	6,   // 20: datanode.api.v2.ListOrderVersionsRequest.pagination:type_name -> datanode.api.v2.Pagination
	145, // 21: datanode.api.v2.ListOrderVersionsResponse.orders:type_name -> datanode.api.v2.OrderConnection
	...
	271, // 24: datanode.api.v2.OrderSnapshotPage.orders:type_name -> vega.Order
	271, // 25: datanode.api.v2.OrderUpdates.orders:type_name -> vega.Order
	6,   // 26: datanode.api.v2.ListPositionsRequest.pagination:type_name -> datanode.api.v2.Pagination
	33,  // 27: datanode.api.v2.ListPositionsResponse.positions:type_name -> datanode.api.v2.PositionConnection
	275, // 28: datanode.api.v2.PositionEdge.node:type_name -> vega.Position
	32,  // 29: datanode.api.v2.PositionConnection.edges:type_name -> datanode.api.v2.PositionEdge
	7,   // 30: datanode.api.v2.PositionConnection.page_info:type_name -> datanode.api.v2.PageInfo
	36,  // 31: datanode.api.v2.ObservePositionsResponse.snapshot:type_name -> datanode.api.v2.PositionSnapshotPage
	37,  // 32: datanode.api.v2.ObservePositionsResponse.updates:type_name -> datanode.api.v2.PositionUpdates
	275, // 33: datanode.api.v2.PositionSnapshotPage.positions:type_name -> vega.Position
	275, // 34: datanode.api.v2.PositionUpdates.positions:type_name -> vega.Position
	50,  // 35: datanode.api.v2.LedgerEntryFilter.account_from_filter:type_name -> datanode.api.v2.AccountFilter
	50,  // 36: datanode.api.v2.LedgerEntryFilter.account_to_filter:type_name -> datanode.api.v2.AccountFilter
	276, // 37: datanode.api.v2.LedgerEntryFilter.transfer_types:type_name -> vega.TransferType
	276, // 38: datanode.api.v2.AggregatedLedgerEntry.transfer_type:type_name -> vega.TransferType
	270, // 39: datanode.api.v2.AggregatedLedgerEntry.sender_account_type:type_name -> vega.AccountType
	270, // 40: datanode.api.v2.AggregatedLedgerEntry.receiver_account_type:type_name -> vega.AccountType
	38,  // 41: datanode.api.v2.ListLedgerEntriesRequest.filter:type_name -> datanode.api.v2.LedgerEntryFilter
	6,   // 42: datanode.api.v2.ListLedgerEntriesRequest.pagination:type_name -> datanode.api.v2.Pagination
	250, // 43: datanode.api.v2.ListLedgerEntriesRequest.date_range:type_name -> datanode.api.v2.DateRange
	43,  // 44: datanode.api.v2.ListLedgerEntriesResponse.ledger_entries:type_name -> datanode.api.v2.AggregatedLedgerEntriesConnection
	39,  // 45: datanode.api.v2.AggregatedLedgerEntriesEdge.node:type_name -> datanode.api.v2.AggregatedLedgerEntry
	42,  // 46: datanode.api.v2.AggregatedLedgerEntriesConnection.edges:type_name -> datanode.api.v2.AggregatedLedgerEntriesEdge
	7,   // 47: datanode.api.v2.AggregatedLedgerEntriesConnection.page_info:type_name -> datanode.api.v2.PageInfo
	50,  // 48: datanode.api.v2.ListBalanceChangesRequest.filter:type_name -> datanode.api.v2.AccountFilter
	6,   // 49: datanode.api.v2.ListBalanceChangesRequest.pagination:type_name -> datanode.api.v2.Pagination
	250, // 50: datanode.api.v2.ListBalanceChangesRequest.date_range:type_name -> datanode.api.v2.DateRange
	49,  // 51: datanode.api.v2.ListBalanceChangesResponse.balances:type_name -> datanode.api.v2.AggregatedBalanceConnection
	50,  // 52: datanode.api.v2.GetBalanceHistoryRequest.filter:type_name -> datanode.api.v2.AccountFilter
	1,   // 53: datanode.api.v2.GetBalanceHistoryRequest.group_by:type_name -> datanode.api.v2.AccountField
	6,   // 54: datanode.api.v2.GetBalanceHistoryRequest.pagination:type_name -> datanode.api.v2.Pagination
	250, // 55: datanode.api.v2.GetBalanceHistoryRequest.date_range:type_name -> datanode.api.v2.DateRange
	49,  // 56: datanode.api.v2.GetBalanceHistoryResponse.balances:type_name -> datanode.api.v2.AggregatedBalanceConnection
	51,  // 57: datanode.api.v2.AggregatedBalanceEdge.node:type_name -> datanode.api.v2.AggregatedBalance
	48,  // 58: datanode.api.v2.AggregatedBalanceConnection.edges:type_name -> datanode.api.v2.AggregatedBalanceEdge
	7,   // 59: datanode.api.v2.AggregatedBalanceConnection.page_info:type_name -> datanode.api.v2.PageInfo
	270, // 60: datanode.api.v2.AccountFilter.account_types:type_name -> vega.AccountType
	270, // 61: datanode.api.v2.AggregatedBalance.account_type:type_name -> vega.AccountType
	277, // 62: datanode.api.v2.ObserveMarketsDepthResponse.market_depth:type_name -> vega.MarketDepth
	278, // 63: datanode.api.v2.ObserveMarketsDepthUpdatesResponse.update:type_name -> vega.MarketDepthUpdate
	279, // 64: datanode.api.v2.ObserveMarketsDataResponse.market_data:type_name -> vega.MarketData
	280, // 65: datanode.api.v2.GetLatestMarketDepthResponse.buy:type_name -> vega.PriceLevel
	280, // 66: datanode.api.v2.GetLatestMarketDepthResponse.sell:type_name -> vega.PriceLevel
	281, // 67: datanode.api.v2.GetLatestMarketDepthResponse.last_trade:type_name -> vega.Trade
	279, // 68: datanode.api.v2.ListLatestMarketDataResponse.markets_data:type_name -> vega.MarketData
	279, // 69: datanode.api.v2.GetLatestMarketDataResponse.market_data:type_name -> vega.MarketData
	6,   // 70: datanode.api.v2.GetMarketDataHistoryByIDRequest.pagination:type_name -> datanode.api.v2.Pagination
	5,   // 71: datanode.api.v2.GetMarketDataHistoryByIDRequest.offset_pagination:type_name -> datanode.api.v2.OffsetPagination
	67,  // 72: datanode.api.v2.GetMarketDataHistoryByIDResponse.market_data:type_name -> datanode.api.v2.MarketDataConnection
	279, // 73: datanode.api.v2.MarketDataEdge.node:type_name -> vega.MarketData
	66,  // 74: datanode.api.v2.MarketDataConnection.edges:type_name -> datanode.api.v2.MarketDataEdge
	7,   // 75: datanode.api.v2.MarketDataConnection.page_info:type_name -> datanode.api.v2.PageInfo
	279, // 76: datanode.api.v2.MarketsDataSubscribeResponse.market_data:type_name -> vega.MarketData
	2,   // 77: datanode.api.v2.ListTransfersRequest.direction:type_name -> datanode.api.v2.TransferDirection
	6,   // 78: datanode.api.v2.ListTransfersRequest.pagination:type_name -> datanode.api.v2.Pagination
	73,  // 79: datanode.api.v2.ListTransfersResponse.transfers:type_name -> datanode.api.v2.TransferConnection
	282, // 80: datanode.api.v2.TransferEdge.node:type_name -> vega.events.v1.Transfer
	72,  // 81: datanode.api.v2.TransferConnection.edges:type_name -> datanode.api.v2.TransferEdge
	7,   // 82: datanode.api.v2.TransferConnection.page_info:type_name -> datanode.api.v2.PageInfo
	283, // 83: datanode.api.v2.GetNetworkLimitsResponse.limits:type_name -> vega.NetworkLimits
	77,  // 84: datanode.api.v2.ListCandleIntervalsResponse.interval_to_candle_id:type_name -> datanode.api.v2.IntervalToCandleId
	79,  // 85: datanode.api.v2.ObserveCandleDataResponse.candle:type_name -> datanode.api.v2.Candle
	284, // 86: datanode.api.v2.ListCandleDataRequest.interval:type_name -> vega.Interval
	6,   // 87: datanode.api.v2.ListCandleDataRequest.pagination:type_name -> datanode.api.v2.Pagination
	85,  // 88: datanode.api.v2.ListCandleDataResponse.candles:type_name -> datanode.api.v2.CandleDataConnection
	79,  // 89: datanode.api.v2.CandleEdge.node:type_name -> datanode.api.v2.Candle
	84,  // 90: datanode.api.v2.CandleDataConnection.edges:type_name -> datanode.api.v2.CandleEdge
	7,   // 91: datanode.api.v2.CandleDataConnection.page_info:type_name -> datanode.api.v2.PageInfo
	6,   // 92: datanode.api.v2.ListVotesRequest.pagination:type_name -> datanode.api.v2.Pagination
	89,  // 93: datanode.api.v2.ListVotesResponse.votes:type_name -> datanode.api.v2.VoteConnection
	285, // 94: datanode.api.v2.VoteEdge.node:type_name -> vega.Vote
	88,  // 95: datanode.api.v2.VoteConnection.edges:type_name -> datanode.api.v2.VoteEdge
	7,   // 96: datanode.api.v2.VoteConnection.page_info:type_name -> datanode.api.v2.PageInfo
	285, // 97: datanode.api.v2.ObserveVotesResponse.vote:type_name -> vega.Vote
	6,   // 98: datanode.api.v2.ListERC20MultiSigSignerAddedBundlesRequest.pagination:type_name -> datanode.api.v2.Pagination
	96,  // 99: datanode.api.v2.ListERC20MultiSigSignerAddedBundlesResponse.bundles:type_name -> datanode.api.v2.ERC20MultiSigSignerAddedConnection
	286, // 100: datanode.api.v2.ERC20MultiSigSignerAddedEdge.node:type_name -> vega.events.v1.ERC20MultiSigSignerAdded
	97,  // 101: datanode.api.v2.ERC20MultiSigSignerAddedBundleEdge.node:type_name -> datanode.api.v2.ERC20MultiSigSignerAddedBundle
	95,  // 102: datanode.api.v2.ERC20MultiSigSignerAddedConnection.edges:type_name -> datanode.api.v2.ERC20MultiSigSignerAddedBundleEdge
	7,   // 103: datanode.api.v2.ERC20MultiSigSignerAddedConnection.page_info:type_name -> datanode.api.v2.PageInfo
	6,   // 104: datanode.api.v2.ListERC20MultiSigSignerRemovedBundlesRequest.pagination:type_name -> datanode.api.v2.Pagination
	102, // 105: datanode.api.v2.ListERC20MultiSigSignerRemovedBundlesResponse.bundles:type_name -> datanode.api.v2.ERC20MultiSigSignerRemovedConnection
	287, // 106: datanode.api.v2.ERC20MultiSigSignerRemovedEdge.node:type_name -> vega.events.v1.ERC20MultiSigSignerRemoved
	103, // 107: datanode.api.v2.ERC20MultiSigSignerRemovedBundleEdge.node:type_name -> datanode.api.v2.ERC20MultiSigSignerRemovedBundle
	101, // 108: datanode.api.v2.ERC20MultiSigSignerRemovedConnection.edges:type_name -> datanode.api.v2.ERC20MultiSigSignerRemovedBundleEdge
	7,   // 109: datanode.api.v2.ERC20MultiSigSignerRemovedConnection.page_info:type_name -> datanode.api.v2.PageInfo
	281, // 110: datanode.api.v2.GetLastTradeResponse.trade:type_name -> vega.Trade
	6,   // 111: datanode.api.v2.ListTradesRequest.pagination:type_name -> datanode.api.v2.Pagination
	250, // 112: datanode.api.v2.ListTradesRequest.date_range:type_name -> datanode.api.v2.DateRange
	114, // 113: datanode.api.v2.ListTradesResponse.trades:type_name -> datanode.api.v2.TradeConnection
	115, // 114: datanode.api.v2.TradeConnection.edges:type_name -> datanode.api.v2.TradeEdge
	7,   // 115: datanode.api.v2.TradeConnection.page_info:type_name -> datanode.api.v2.PageInfo
	281, // 116: datanode.api.v2.TradeEdge.node:type_name -> vega.Trade
	281, // 117: datanode.api.v2.ObserveTradesResponse.trades:type_name -> vega.Trade
	288, // 118: datanode.api.v2.GetOracleSpecResponse.oracle_spec:type_name -> vega.OracleSpec
	6,   // 119: datanode.api.v2.ListOracleSpecsRequest.pagination:type_name -> datanode.api.v2.Pagination
	125, // 120: datanode.api.v2.ListOracleSpecsResponse.oracle_specs:type_name -> datanode.api.v2.OracleSpecsConnection
	6,   // 121: datanode.api.v2.ListOracleDataRequest.pagination:type_name -> datanode.api.v2.Pagination
	127, // 122: datanode.api.v2.ListOracleDataResponse.oracle_data:type_name -> datanode.api.v2.OracleDataConnection
	288, // 123: datanode.api.v2.OracleSpecEdge.node:type_name -> vega.OracleSpec
	124, // 124: datanode.api.v2.OracleSpecsConnection.edges:type_name -> datanode.api.v2.OracleSpecEdge
	7,   // 125: datanode.api.v2.OracleSpecsConnection.page_info:type_name -> datanode.api.v2.PageInfo
	289, // 126: datanode.api.v2.OracleDataEdge.node:type_name -> vega.OracleData
	126, // 127: datanode.api.v2.OracleDataConnection.edges:type_name -> datanode.api.v2.OracleDataEdge
	7,   // 128: datanode.api.v2.OracleDataConnection.page_info:type_name -> datanode.api.v2.PageInfo
	290, // 129: datanode.api.v2.GetMarketResponse.market:type_name -> vega.Market
	6,   // 130: datanode.api.v2.ListMarketsRequest.pagination:type_name -> datanode.api.v2.Pagination
	133, // 131: datanode.api.v2.ListMarketsResponse.markets:type_name -> datanode.api.v2.MarketConnection
	290, // 132: datanode.api.v2.MarketEdge.node:type_name -> vega.Market
	132, // 133: datanode.api.v2.MarketConnection.edges:type_name -> datanode.api.v2.MarketEdge
	7,   // 134: datanode.api.v2.MarketConnection.page_info:type_name -> datanode.api.v2.PageInfo
	291, // 135: datanode.api.v2.GetPartyResponse.party:type_name -> vega.Party
	6,   // 136: datanode.api.v2.ListPartiesRequest.pagination:type_name -> datanode.api.v2.Pagination
	139, // 137: datanode.api.v2.ListPartiesResponse.parties:type_name -> datanode.api.v2.PartyConnection
	291, // 138: datanode.api.v2.PartyEdge.node:type_name -> vega.Party
	138, // 139: datanode.api.v2.PartyConnection.edges:type_name -> datanode.api.v2.PartyEdge
	7,   // 140: datanode.api.v2.PartyConnection.page_info:type_name -> datanode.api.v2.PageInfo
	271, // 141: datanode.api.v2.OrderEdge.node:type_name -> vega.Order
	6,   // 142: datanode.api.v2.ListMarginLevelsRequest.pagination:type_name -> datanode.api.v2.Pagination
	147, // 143: datanode.api.v2.ListMarginLevelsResponse.margin_levels:type_name -> datanode.api.v2.MarginConnection
	292, // 144: datanode.api.v2.ObserveMarginLevelsResponse.margin_levels:type_name -> vega.MarginLevels
	140, // 145: datanode.api.v2.OrderConnection.edges:type_name -> datanode.api.v2.OrderEdge
	7,   // 146: datanode.api.v2.OrderConnection.page_info:type_name -> datanode.api.v2.PageInfo
	292, // 147: datanode.api.v2.MarginEdge.node:type_name -> vega.MarginLevels
	146, // 148: datanode.api.v2.MarginConnection.edges:type_name -> datanode.api.v2.MarginEdge
	7,   // 149: datanode.api.v2.MarginConnection.page_info:type_name -> datanode.api.v2.PageInfo
	6,   // 150: datanode.api.v2.ListRewardsRequest.pagination:type_name -> datanode.api.v2.Pagination
	151, // 151: datanode.api.v2.ListRewardsResponse.rewards:type_name -> datanode.api.v2.RewardsConnection
	293, // 152: datanode.api.v2.RewardEdge.node:type_name -> vega.Reward
	150, // 153: datanode.api.v2.RewardsConnection.edges:type_name -> datanode.api.v2.RewardEdge
	7,   // 154: datanode.api.v2.RewardsConnection.page_info:type_name -> datanode.api.v2.PageInfo
	6,   // 155: datanode.api.v2.ListRewardSummariesRequest.pagination:type_name -> datanode.api.v2.Pagination
	294, // 156: datanode.api.v2.ListRewardSummariesResponse.summaries:type_name -> vega.RewardSummary
	293, // 157: datanode.api.v2.ObserveRewardsResponse.reward:type_name -> vega.Reward
	295, // 158: datanode.api.v2.GetDepositResponse.deposit:type_name -> vega.Deposit
	6,   // 159: datanode.api.v2.ListDepositsRequest.pagination:type_name -> datanode.api.v2.Pagination
	250, // 160: datanode.api.v2.ListDepositsRequest.date_range:type_name -> datanode.api.v2.DateRange
	161, // 161: datanode.api.v2.ListDepositsResponse.deposits:type_name -> datanode.api.v2.DepositsConnection
	295, // 162: datanode.api.v2.DepositEdge.node:type_name -> vega.Deposit
	160, // 163: datanode.api.v2.DepositsConnection.edges:type_name -> datanode.api.v2.DepositEdge
	7,   // 164: datanode.api.v2.DepositsConnection.page_info:type_name -> datanode.api.v2.PageInfo
	296, // 165: datanode.api.v2.GetWithdrawalResponse.withdrawal:type_name -> vega.Withdrawal
	6,   // 166: datanode.api.v2.ListWithdrawalsRequest.pagination:type_name -> datanode.api.v2.Pagination
	250, // 167: datanode.api.v2.ListWithdrawalsRequest.date_range:type_name -> datanode.api.v2.DateRange
	167, // 168: datanode.api.v2.ListWithdrawalsResponse.withdrawals:type_name -> datanode.api.v2.WithdrawalsConnection
	296, // 169: datanode.api.v2.WithdrawalEdge.node:type_name -> vega.Withdrawal
	166, // 170: datanode.api.v2.WithdrawalsConnection.edges:type_name -> datanode.api.v2.WithdrawalEdge
	7,   // 171: datanode.api.v2.WithdrawalsConnection.page_info:type_name -> datanode.api.v2.PageInfo
	297, // 172: datanode.api.v2.GetAssetResponse.asset:type_name -> vega.Asset
	6,   // 173: datanode.api.v2.ListAssetsRequest.pagination:type_name -> datanode.api.v2.Pagination
	173, // 174: datanode.api.v2.ListAssetsResponse.assets:type_name -> datanode.api.v2.AssetsConnection
	297, // 175: datanode.api.v2.AssetEdge.node:type_name -> vega.Asset
	172, // 176: datanode.api.v2.AssetsConnection.edges:type_name -> datanode.api.v2.AssetEdge
	7,   // 177: datanode.api.v2.AssetsConnection.page_info:type_name -> datanode.api.v2.PageInfo
	6,   // 178: datanode.api.v2.ListLiquidityProvisionsRequest.pagination:type_name -> datanode.api.v2.Pagination
	177, // 179: datanode.api.v2.ListLiquidityProvisionsResponse.liquidity_provisions:type_name -> datanode.api.v2.LiquidityProvisionsConnection
	298, // 180: datanode.api.v2.LiquidityProvisionsEdge.node:type_name -> vega.LiquidityProvision
	176, // 181: datanode.api.v2.LiquidityProvisionsConnection.edges:type_name -> datanode.api.v2.LiquidityProvisionsEdge
	7,   // 182: datanode.api.v2.LiquidityProvisionsConnection.page_info:type_name -> datanode.api.v2.PageInfo
	298, // 183: datanode.api.v2.ObserveLiquidityProvisionsResponse.liquidity_provisions:type_name -> vega.LiquidityProvision
	299, // 184: datanode.api.v2.GetGovernanceDataResponse.data:type_name -> vega.GovernanceData
	300, // 185: datanode.api.v2.GetProposalResponse.data:type_name -> vega.Proposal
	301, // 186: datanode.api.v2.ListGovernanceDataRequest.proposal_state:type_name -> vega.Proposal.State
	3,   // 187: datanode.api.v2.ListGovernanceDataRequest.proposal_type:type_name -> datanode.api.v2.ListGovernanceDataRequest.Type
	6,   // 188: datanode.api.v2.ListGovernanceDataRequest.pagination:type_name -> datanode.api.v2.Pagination
	301, // 189: datanode.api.v2.ListProposalsRequest.proposal_state:type_name -> vega.Proposal.State
	4,   // 190: datanode.api.v2.ListProposalsRequest.proposal_type:type_name -> datanode.api.v2.ListProposalsRequest.Type
	6,   // 191: datanode.api.v2.ListProposalsRequest.pagination:type_name -> datanode.api.v2.Pagination
	189, // 192: datanode.api.v2.ListProposalsResponse.connection:type_name -> datanode.api.v2.ProposalsConnection
	188, // 193: datanode.api.v2.ProposalsEdge.node:type_name -> datanode.api.v2.ProposalData
	300, // 194: datanode.api.v2.ProposalData.proposal:type_name -> vega.Proposal
	187, // 195: datanode.api.v2.ProposalsConnection.edges:type_name -> datanode.api.v2.ProposalsEdge
	7,   // 196: datanode.api.v2.ProposalsConnection.page_info:type_name -> datanode.api.v2.PageInfo
	192, // 197: datanode.api.v2.ListGovernanceDataResponse.connection:type_name -> datanode.api.v2.GovernanceDataConnection
	299, // 198: datanode.api.v2.GovernanceDataEdge.node:type_name -> vega.GovernanceData
	191, // 199: datanode.api.v2.GovernanceDataConnection.edges:type_name -> datanode.api.v2.GovernanceDataEdge
	7,   // 200: datanode.api.v2.GovernanceDataConnection.page_info:type_name -> datanode.api.v2.PageInfo
	299, // 201: datanode.api.v2.ObserveGovernanceResponse.data:type_name -> vega.GovernanceData
	6,   // 202: datanode.api.v2.ListDelegationsRequest.pagination:type_name -> datanode.api.v2.Pagination
	198, // 203: datanode.api.v2.ListDelegationsResponse.delegations:type_name -> datanode.api.v2.DelegationsConnection
	302, // 204: datanode.api.v2.DelegationEdge.node:type_name -> vega.Delegation
	197, // 205: datanode.api.v2.DelegationsConnection.edges:type_name -> datanode.api.v2.DelegationEdge
	7,   // 206: datanode.api.v2.DelegationsConnection.page_info:type_name -> datanode.api.v2.PageInfo
	302, // 207: datanode.api.v2.ObserveDelegationsResponse.delegation:type_name -> vega.Delegation
	303, // 208: datanode.api.v2.GetNetworkDataResponse.node_data:type_name -> vega.NodeData
	304, // 209: datanode.api.v2.GetNodeResponse.node:type_name -> vega.Node
	6,   // 210: datanode.api.v2.ListNodesRequest.pagination:type_name -> datanode.api.v2.Pagination
	208, // 211: datanode.api.v2.ListNodesResponse.nodes:type_name -> datanode.api.v2.NodesConnection
	304, // 212: datanode.api.v2.NodeEdge.node:type_name -> vega.Node
	207, // 213: datanode.api.v2.NodesConnection.edges:type_name -> datanode.api.v2.NodeEdge
	7,   // 214: datanode.api.v2.NodesConnection.page_info:type_name -> datanode.api.v2.PageInfo
	6,   // 215: datanode.api.v2.ListNodeSignaturesRequest.pagination:type_name -> datanode.api.v2.Pagination
	212, // 216: datanode.api.v2.ListNodeSignaturesResponse.signatures:type_name -> datanode.api.v2.NodeSignaturesConnection
	305, // 217: datanode.api.v2.NodeSignatureEdge.node:type_name -> vega.commands.v1.NodeSignature
	211, // 218: datanode.api.v2.NodeSignaturesConnection.edges:type_name -> datanode.api.v2.NodeSignatureEdge
	7,   // 219: datanode.api.v2.NodeSignaturesConnection.page_info:type_name -> datanode.api.v2.PageInfo
	306, // 220: datanode.api.v2.GetEpochResponse.epoch:type_name -> vega.Epoch
	307, // 221: datanode.api.v2.EstimateFeeResponse.fee:type_name -> vega.Fee
	308, // 222: datanode.api.v2.EstimateMarginRequest.side:type_name -> vega.Side
	273, // 223: datanode.api.v2.EstimateMarginRequest.type:type_name -> vega.Order.Type
	292, // 224: datanode.api.v2.EstimateMarginResponse.margin_levels:type_name -> vega.MarginLevels
	6,   // 225: datanode.api.v2.ListNetworkParametersRequest.pagination:type_name -> datanode.api.v2.Pagination
	224, // 226: datanode.api.v2.ListNetworkParametersResponse.network_parameters:type_name -> datanode.api.v2.NetworkParameterConnection
	309, // 227: datanode.api.v2.GetNetworkParameterResponse.network_parameter:type_name -> vega.NetworkParameter
	309, // 228: datanode.api.v2.NetworkParameterEdge.node:type_name -> vega.NetworkParameter
	223, // 229: datanode.api.v2.NetworkParameterConnection.edges:type_name -> datanode.api.v2.NetworkParameterEdge
	7,   // 230: datanode.api.v2.NetworkParameterConnection.page_info:type_name -> datanode.api.v2.PageInfo
	6,   // 231: datanode.api.v2.ListCheckpointsRequest.pagination:type_name -> datanode.api.v2.Pagination
	229, // 232: datanode.api.v2.ListCheckpointsResponse.checkpoints:type_name -> datanode.api.v2.CheckpointsConnection
	225, // 233: datanode.api.v2.CheckpointEdge.node:type_name -> datanode.api.v2.Checkpoint
	228, // 234: datanode.api.v2.CheckpointsConnection.edges:type_name -> datanode.api.v2.CheckpointEdge
	7,   // 235: datanode.api.v2.CheckpointsConnection.page_info:type_name -> datanode.api.v2.PageInfo
	6,   // 236: datanode.api.v2.GetStakeRequest.pagination:type_name -> datanode.api.v2.Pagination
	233, // 237: datanode.api.v2.GetStakeResponse.stake_linkings:type_name -> datanode.api.v2.StakesConnection
	310, // 238: datanode.api.v2.StakeLinkingEdge.node:type_name -> vega.events.v1.StakeLinking
	232, // 239: datanode.api.v2.StakesConnection.edges:type_name -> datanode.api.v2.StakeLinkingEdge
	7,   // 240: datanode.api.v2.StakesConnection.page_info:type_name -> datanode.api.v2.PageInfo
	311, // 241: datanode.api.v2.GetRiskFactorsResponse.risk_factor:type_name -> vega.RiskFactor
	312, // 242: datanode.api.v2.ObserveEventBusRequest.type:type_name -> vega.events.v1.BusEventType
	313, // 243: datanode.api.v2.ObserveEventBusResponse.events:type_name -> vega.events.v1.BusEvent
	314, // 244: datanode.api.v2.ObserveLedgerMovementsResponse.ledger_movement:type_name -> vega.LedgerMovement
	6,   // 245: datanode.api.v2.ListKeyRotationsRequest.pagination:type_name -> datanode.api.v2.Pagination
	243, // 246: datanode.api.v2.ListKeyRotationsResponse.rotations:type_name -> datanode.api.v2.KeyRotationConnection
	315, // 247: datanode.api.v2.KeyRotationEdge.node:type_name -> vega.events.v1.KeyRotation
	242, // 248: datanode.api.v2.KeyRotationConnection.edges:type_name -> datanode.api.v2.KeyRotationEdge
	7,   // 249: datanode.api.v2.KeyRotationConnection.page_info:type_name -> datanode.api.v2.PageInfo
	6,   // 250: datanode.api.v2.ListEthereumKeyRotationsRequest.pagination:type_name -> datanode.api.v2.Pagination
	246, // 251: datanode.api.v2.ListEthereumKeyRotationsResponse.key_rotations:type_name -> datanode.api.v2.EthereumKeyRotationsConnection
	247, // 252: datanode.api.v2.EthereumKeyRotationsConnection.edges:type_name -> datanode.api.v2.EthereumKeyRotationEdge
	7,   // 253: datanode.api.v2.EthereumKeyRotationsConnection.page_info:type_name -> datanode.api.v2.PageInfo
	316, // 254: datanode.api.v2.EthereumKeyRotationEdge.node:type_name -> vega.events.v1.EthereumKeyRotation
	317, // 255: datanode.api.v2.ListProtocolUpgradeProposalsRequest.status:type_name -> vega.events.v1.ProtocolUpgradeProposalStatus
	6,   // 256: datanode.api.v2.ListProtocolUpgradeProposalsRequest.pagination:type_name -> datanode.api.v2.Pagination
	255, // 257: datanode.api.v2.ListProtocolUpgradeProposalsResponse.protocol_upgrade_proposals:type_name -> datanode.api.v2.ProtocolUpgradeProposalConnection
	256, // 258: datanode.api.v2.ProtocolUpgradeProposalConnection.edges:type_name -> datanode.api.v2.ProtocolUpgradeProposalEdge
	7,   // 259: datanode.api.v2.ProtocolUpgradeProposalConnection.page_info:type_name -> datanode.api.v2.PageInfo
	318, // 260: datanode.api.v2.ProtocolUpgradeProposalEdge.node:type_name -> vega.events.v1.ProtocolUpgradeEvent
	257, // 261: datanode.api.v2.GetMostRecentDeHistorySegmentResponse.segment:type_name -> datanode.api.v2.HistorySegment
	257, // 262: datanode.api.v2.ListAllDeHistorySegmentsResponse.segments:type_name -> datanode.api.v2.HistorySegment
	257, // 263: datanode.api.v2.FetchDeHistorySegmentResponse.segment:type_name -> datanode.api.v2.HistorySegment
	9,   // 264: datanode.api.v2.TradingDataService.ListAccounts:input_type -> datanode.api.v2.ListAccountsRequest
	13,  // 265: datanode.api.v2.TradingDataService.ObserveAccounts:input_type -> datanode.api.v2.ObserveAccountsRequest
	17,  // 266: datanode.api.v2.TradingDataService.Info:input_type -> datanode.api.v2.InfoRequest
	19,  // 267: datanode.api.v2.TradingDataService.GetOrder:input_type -> datanode.api.v2.GetOrderRequest
	22,  // 268: datanode.api.v2.TradingDataService.ListOrders:input_type -> datanode.api.v2.ListOrdersRequest
	24,  // 269: datanode.api.v2.TradingDataService.ListOrderVersions:input_type -> datanode.api.v2.ListOrderVersionsRequest
	26,  // 270: datanode.api.v2.TradingDataService.ObserveOrders:input_type -> datanode.api.v2.ObserveOrdersRequest
	30,  // 271: datanode.api.v2.TradingDataService.ListPositions:input_type -> datanode.api.v2.ListPositionsRequest
	34,  // 272: datanode.api.v2.TradingDataService.ObservePositions:input_type -> datanode.api.v2.ObservePositionsRequest
	40,  // 273: datanode.api.v2.TradingDataService.ListLedgerEntries:input_type -> datanode.api.v2.ListLedgerEntriesRequest
	44,  // 274: datanode.api.v2.TradingDataService.ListBalanceChanges:input_type -> datanode.api.v2.ListBalanceChangesRequest
	62,  // 275: datanode.api.v2.TradingDataService.GetLatestMarketData:input_type -> datanode.api.v2.GetLatestMarketDataRequest
	60,  // 276: datanode.api.v2.TradingDataService.ListLatestMarketData:input_type -> datanode.api.v2.ListLatestMarketDataRequest
	58,  // 277: datanode.api.v2.TradingDataService.GetLatestMarketDepth:input_type -> datanode.api.v2.GetLatestMarketDepthRequest
	52,  // 278: datanode.api.v2.TradingDataService.ObserveMarketsDepth:input_type -> datanode.api.v2.ObserveMarketsDepthRequest
	54,  // 279: datanode.api.v2.TradingDataService.ObserveMarketsDepthUpdates:input_type -> datanode.api.v2.ObserveMarketsDepthUpdatesRequest
	56,  // 280: datanode.api.v2.TradingDataService.ObserveMarketsData:input_type -> datanode.api.v2.ObserveMarketsDataRequest
	64,  // 281: datanode.api.v2.TradingDataService.GetMarketDataHistoryByID:input_type -> datanode.api.v2.GetMarketDataHistoryByIDRequest
	70,  // 282: datanode.api.v2.TradingDataService.ListTransfers:input_type -> datanode.api.v2.ListTransfersRequest
	74,  // 283: datanode.api.v2.TradingDataService.GetNetworkLimits:input_type -> datanode.api.v2.GetNetworkLimitsRequest
	82,  // 284: datanode.api.v2.TradingDataService.ListCandleData:input_type -> datanode.api.v2.ListCandleDataRequest
	80,  // 285: datanode.api.v2.TradingDataService.ObserveCandleData:input_type -> datanode.api.v2.ObserveCandleDataRequest
	76,  // 286: datanode.api.v2.TradingDataService.ListCandleIntervals:input_type -> datanode.api.v2.ListCandleIntervalsRequest
	86,  // 287: datanode.api.v2.TradingDataService.ListVotes:input_type -> datanode.api.v2.ListVotesRequest
	90,  // 288: datanode.api.v2.TradingDataService.ObserveVotes:input_type -> datanode.api.v2.ObserveVotesRequest
	92,  // 289: datanode.api.v2.TradingDataService.ListERC20MultiSigSignerAddedBundles:input_type -> datanode.api.v2.ListERC20MultiSigSignerAddedBundlesRequest
	98,  // 290: datanode.api.v2.TradingDataService.ListERC20MultiSigSignerRemovedBundles:input_type -> datanode.api.v2.ListERC20MultiSigSignerRemovedBundlesRequest
	104, // 291: datanode.api.v2.TradingDataService.GetERC20ListAssetBundle:input_type -> datanode.api.v2.GetERC20ListAssetBundleRequest
	106, // 292: datanode.api.v2.TradingDataService.GetERC20SetAssetLimitsBundle:input_type -> datanode.api.v2.GetERC20SetAssetLimitsBundleRequest
	108, // 293: datanode.api.v2.TradingDataService.GetERC20WithdrawalApproval:input_type -> datanode.api.v2.GetERC20WithdrawalApprovalRequest
	110, // 294: datanode.api.v2.TradingDataService.GetLastTrade:input_type -> datanode.api.v2.GetLastTradeRequest
	112, // 295: datanode.api.v2.TradingDataService.ListTrades:input_type -> datanode.api.v2.ListTradesRequest
	116, // 296: datanode.api.v2.TradingDataService.ObserveTrades:input_type -> datanode.api.v2.ObserveTradesRequest
	118, // 297: datanode.api.v2.TradingDataService.GetOracleSpec:input_type -> datanode.api.v2.GetOracleSpecRequest
	120, // 298: datanode.api.v2.TradingDataService.ListOracleSpecs:input_type -> datanode.api.v2.ListOracleSpecsRequest
	122, // 299: datanode.api.v2.TradingDataService.ListOracleData:input_type -> datanode.api.v2.ListOracleDataRequest
	128, // 300: datanode.api.v2.TradingDataService.GetMarket:input_type -> datanode.api.v2.GetMarketRequest
	130, // 301: datanode.api.v2.TradingDataService.ListMarkets:input_type -> datanode.api.v2.ListMarketsRequest
	134, // 302: datanode.api.v2.TradingDataService.GetParty:input_type -> datanode.api.v2.GetPartyRequest
	136, // 303: datanode.api.v2.TradingDataService.ListParties:input_type -> datanode.api.v2.ListPartiesRequest
	141, // 304: datanode.api.v2.TradingDataService.ListMarginLevels:input_type -> datanode.api.v2.ListMarginLevelsRequest
	143, // 305: datanode.api.v2.TradingDataService.ObserveMarginLevels:input_type -> datanode.api.v2.ObserveMarginLevelsRequest
	148, // 306: datanode.api.v2.TradingDataService.ListRewards:input_type -> datanode.api.v2.ListRewardsRequest
	152, // 307: datanode.api.v2.TradingDataService.ListRewardSummaries:input_type -> datanode.api.v2.ListRewardSummariesRequest
	154, // 308: datanode.api.v2.TradingDataService.ObserveRewards:input_type -> datanode.api.v2.ObserveRewardsRequest
	156, // 309: datanode.api.v2.TradingDataService.GetDeposit:input_type -> datanode.api.v2.GetDepositRequest
	158, // 310: datanode.api.v2.TradingDataService.ListDeposits:input_type -> datanode.api.v2.ListDepositsRequest
	162, // 311: datanode.api.v2.TradingDataService.GetWithdrawal:input_type -> datanode.api.v2.GetWithdrawalRequest
	164, // 312: datanode.api.v2.TradingDataService.ListWithdrawals:input_type -> datanode.api.v2.ListWithdrawalsRequest
	168, // 313: datanode.api.v2.TradingDataService.GetAsset:input_type -> datanode.api.v2.GetAssetRequest
	170, // 314: datanode.api.v2.TradingDataService.ListAssets:input_type -> datanode.api.v2.ListAssetsRequest
	174, // 315: datanode.api.v2.TradingDataService.ListLiquidityProvisions:input_type -> datanode.api.v2.ListLiquidityProvisionsRequest
	178, // 316: datanode.api.v2.TradingDataService.ObserveLiquidityProvisions:input_type -> datanode.api.v2.ObserveLiquidityProvisionsRequest
	180, // 317: datanode.api.v2.TradingDataService.GetGovernanceData:input_type -> datanode.api.v2.GetGovernanceDataRequest
	182, // 318: datanode.api.v2.TradingDataService.GetProposal:input_type -> datanode.api.v2.GetProposalRequest
	184, // 319: datanode.api.v2.TradingDataService.ListGovernanceData:input_type -> datanode.api.v2.ListGovernanceDataRequest
	185, // 320: datanode.api.v2.TradingDataService.ListProposals:input_type -> datanode.api.v2.ListProposalsRequest
	193, // 321: datanode.api.v2.TradingDataService.ObserveGovernance:input_type -> datanode.api.v2.ObserveGovernanceRequest
	195, // 322: datanode.api.v2.TradingDataService.ListDelegations:input_type -> datanode.api.v2.ListDelegationsRequest
	199, // 323: datanode.api.v2.TradingDataService.ObserveDelegations:input_type -> datanode.api.v2.ObserveDelegationsRequest
	201, // 324: datanode.api.v2.TradingDataService.GetNetworkData:input_type -> datanode.api.v2.GetNetworkDataRequest
	203, // 325: datanode.api.v2.TradingDataService.GetNode:input_type -> datanode.api.v2.GetNodeRequest
	205, // 326: datanode.api.v2.TradingDataService.ListNodes:input_type -> datanode.api.v2.ListNodesRequest
	209, // 327: datanode.api.v2.TradingDataService.ListNodeSignatures:input_type -> datanode.api.v2.ListNodeSignaturesRequest
	213, // 328: datanode.api.v2.TradingDataService.GetEpoch:input_type -> datanode.api.v2.GetEpochRequest
	215, // 329: datanode.api.v2.TradingDataService.EstimateFee:input_type -> datanode.api.v2.EstimateFeeRequest
	217, // 330: datanode.api.v2.TradingDataService.EstimateMargin:input_type -> datanode.api.v2.EstimateMarginRequest
	219, // 331: datanode.api.v2.TradingDataService.ListNetworkParameters:input_type -> datanode.api.v2.ListNetworkParametersRequest
	221, // 332: datanode.api.v2.TradingDataService.GetNetworkParameter:input_type -> datanode.api.v2.GetNetworkParameterRequest
	226, // 333: datanode.api.v2.TradingDataService.ListCheckpoints:input_type -> datanode.api.v2.ListCheckpointsRequest
	230, // 334: datanode.api.v2.TradingDataService.GetStake:input_type -> datanode.api.v2.GetStakeRequest
	234, // 335: datanode.api.v2.TradingDataService.GetRiskFactors:input_type -> datanode.api.v2.GetRiskFactorsRequest
	236, // 336: datanode.api.v2.TradingDataService.ObserveEventBus:input_type -> datanode.api.v2.ObserveEventBusRequest
	238, // 337: datanode.api.v2.TradingDataService.ObserveLedgerMovements:input_type -> datanode.api.v2.ObserveLedgerMovementsRequest
	240, // 338: datanode.api.v2.TradingDataService.ListKeyRotations:input_type -> datanode.api.v2.ListKeyRotationsRequest
	244, // 339: datanode.api.v2.TradingDataService.ListEthereumKeyRotations:input_type -> datanode.api.v2.ListEthereumKeyRotationsRequest
	248, // 340: datanode.api.v2.TradingDataService.GetVegaTime:input_type -> datanode.api.v2.GetVegaTimeRequest
	251, // 341: datanode.api.v2.TradingDataService.GetProtocolUpgradeStatus:input_type -> datanode.api.v2.GetProtocolUpgradeStatusRequest
	253, // 342: datanode.api.v2.TradingDataService.ListProtocolUpgradeProposals:input_type -> datanode.api.v2.ListProtocolUpgradeProposalsRequest
	258, // 343: datanode.api.v2.TradingDataService.GetMostRecentDeHistorySegment:input_type -> datanode.api.v2.GetMostRecentDeHistorySegmentRequest
	260, // 344: datanode.api.v2.TradingDataService.ListAllDeHistorySegments:input_type -> datanode.api.v2.ListAllDeHistorySegmentsRequest
	262, // 345: datanode.api.v2.TradingDataService.FetchDeHistorySegment:input_type -> datanode.api.v2.FetchDeHistorySegmentRequest
	264, // 346: datanode.api.v2.TradingDataService.GetActiveDeHistoryPeerAddresses:input_type -> datanode.api.v2.GetActiveDeHistoryPeerAddressesRequest
	266, // 347: datanode.api.v2.TradingDataService.CopyHistorySegmentToFile:input_type -> datanode.api.v2.CopyHistorySegmentToFileRequest
	268, // 348: datanode.api.v2.TradingDataService.Ping:input_type -> datanode.api.v2.PingRequest
	10,  // 349: datanode.api.v2.TradingDataService.ListAccounts:output_type -> datanode.api.v2.ListAccountsResponse
	14,  // 350: datanode.api.v2.TradingDataService.ObserveAccounts:output_type -> datanode.api.v2.ObserveAccountsResponse
	18,  // 351: datanode.api.v2.TradingDataService.Info:output_type -> datanode.api.v2.InfoResponse
	20,  // 352: datanode.api.v2.TradingDataService.GetOrder:output_type -> datanode.api.v2.GetOrderResponse
	23,  // 353: datanode.api.v2.TradingDataService.ListOrders:output_type -> datanode.api.v2.ListOrdersResponse
	25,  // 354: datanode.api.v2.TradingDataService.ListOrderVersions:output_type -> datanode.api.v2.ListOrderVersionsResponse
	27,  // 355: datanode.api.v2.TradingDataService.ObserveOrders:output_type -> datanode.api.v2.ObserveOrdersResponse
	31,  // 356: datanode.api.v2.TradingDataService.ListPositions:output_type -> datanode.api.v2.ListPositionsResponse
	35,  // 357: datanode.api.v2.TradingDataService.ObservePositions:output_type -> datanode.api.v2.ObservePositionsResponse
	41,  // 358: datanode.api.v2.TradingDataService.ListLedgerEntries:output_type -> datanode.api.v2.ListLedgerEntriesResponse
	45,  // 359: datanode.api.v2.TradingDataService.ListBalanceChanges:output_type -> datanode.api.v2.ListBalanceChangesResponse
	63,  // 360: datanode.api.v2.TradingDataService.GetLatestMarketData:output_type -> datanode.api.v2.GetLatestMarketDataResponse
	61,  // 361: datanode.api.v2.TradingDataService.ListLatestMarketData:output_type -> datanode.api.v2.ListLatestMarketDataResponse
	59,  // 362: datanode.api.v2.TradingDataService.GetLatestMarketDepth:output_type -> datanode.api.v2.GetLatestMarketDepthResponse
	53,  // 363: datanode.api.v2.TradingDataService.ObserveMarketsDepth:output_type -> datanode.api.v2.ObserveMarketsDepthResponse
	55,  // 364: datanode.api.v2.TradingDataService.ObserveMarketsDepthUpdates:output_type -> datanode.api.v2.ObserveMarketsDepthUpdatesResponse
	57,  // 365: datanode.api.v2.TradingDataService.ObserveMarketsData:output_type -> datanode.api.v2.ObserveMarketsDataResponse
	65,  // 366: datanode.api.v2.TradingDataService.GetMarketDataHistoryByID:output_type -> datanode.api.v2.GetMarketDataHistoryByIDResponse
	71,  // 367: datanode.api.v2.TradingDataService.ListTransfers:output_type -> datanode.api.v2.ListTransfersResponse
	75,  // 368: datanode.api.v2.TradingDataService.GetNetworkLimits:output_type -> datanode.api.v2.GetNetworkLimitsResponse
	83,  // 369: datanode.api.v2.TradingDataService.ListCandleData:output_type -> datanode.api.v2.ListCandleDataResponse
	81,  // 370: datanode.api.v2.TradingDataService.ObserveCandleData:output_type -> datanode.api.v2.ObserveCandleDataResponse
	78,  // 371: datanode.api.v2.TradingDataService.ListCandleIntervals:output_type -> datanode.api.v2.ListCandleIntervalsResponse
	87,  // 372: datanode.api.v2.TradingDataService.ListVotes:output_type -> datanode.api.v2.ListVotesResponse
	91,  // 373: datanode.api.v2.TradingDataService.ObserveVotes:output_type -> datanode.api.v2.ObserveVotesResponse
	93,  // 374: datanode.api.v2.TradingDataService.ListERC20MultiSigSignerAddedBundles:output_type -> datanode.api.v2.ListERC20MultiSigSignerAddedBundlesResponse
	99,  // 375: datanode.api.v2.TradingDataService.ListERC20MultiSigSignerRemovedBundles:output_type -> datanode.api.v2.ListERC20MultiSigSignerRemovedBundlesResponse
	105, // 376: datanode.api.v2.TradingDataService.GetERC20ListAssetBundle:output_type -> datanode.api.v2.GetERC20ListAssetBundleResponse
	107, // 377: datanode.api.v2.TradingDataService.GetERC20SetAssetLimitsBundle:output_type -> datanode.api.v2.GetERC20SetAssetLimitsBundleResponse
	109, // 378: datanode.api.v2.TradingDataService.GetERC20WithdrawalApproval:output_type -> datanode.api.v2.GetERC20WithdrawalApprovalResponse
	111, // 379: datanode.api.v2.TradingDataService.GetLastTrade:output_type -> datanode.api.v2.GetLastTradeResponse
	113, // 380: datanode.api.v2.TradingDataService.ListTrades:output_type -> datanode.api.v2.ListTradesResponse
	117, // 381: datanode.api.v2.TradingDataService.ObserveTrades:output_type -> datanode.api.v2.ObserveTradesResponse
	119, // 382: datanode.api.v2.TradingDataService.GetOracleSpec:output_type -> datanode.api.v2.GetOracleSpecResponse
	121, // 383: datanode.api.v2.TradingDataService.ListOracleSpecs:output_type -> datanode.api.v2.ListOracleSpecsResponse
	123, // 384: datanode.api.v2.TradingDataService.ListOracleData:output_type -> datanode.api.v2.ListOracleDataResponse
	129, // 385: datanode.api.v2.TradingDataService.GetMarket:output_type -> datanode.api.v2.GetMarketResponse
	131, // 386: datanode.api.v2.TradingDataService.ListMarkets:output_type -> datanode.api.v2.ListMarketsResponse
	135, // 387: datanode.api.v2.TradingDataService.GetParty:output_type -> datanode.api.v2.GetPartyResponse
	137, // 388: datanode.api.v2.TradingDataService.ListParties:output_type -> datanode.api.v2.ListPartiesResponse
	142, // 389: datanode.api.v2.TradingDataService.ListMarginLevels:output_type -> datanode.api.v2.ListMarginLevelsResponse
	144, // 390: datanode.api.v2.TradingDataService.ObserveMarginLevels:output_type -> datanode.api.v2.ObserveMarginLevelsResponse
	149, // 391: datanode.api.v2.TradingDataService.ListRewards:output_type -> datanode.api.v2.ListRewardsResponse
	153, // 392: datanode.api.v2.TradingDataService.ListRewardSummaries:output_type -> datanode.api.v2.ListRewardSummariesResponse
	155, // 393: datanode.api.v2.TradingDataService.ObserveRewards:output_type -> datanode.api.v2.ObserveRewardsResponse
	157, // 394: datanode.api.v2.TradingDataService.GetDeposit:output_type -> datanode.api.v2.GetDepositResponse
	159, // 395: datanode.api.v2.TradingDataService.ListDeposits:output_type -> datanode.api.v2.ListDepositsResponse
	163, // 396: datanode.api.v2.TradingDataService.GetWithdrawal:output_type -> datanode.api.v2.GetWithdrawalResponse
	165, // 397: datanode.api.v2.TradingDataService.ListWithdrawals:output_type -> datanode.api.v2.ListWithdrawalsResponse
	169, // 398: datanode.api.v2.TradingDataService.GetAsset:output_type -> datanode.api.v2.GetAssetResponse
	171, // 399: datanode.api.v2.TradingDataService.ListAssets:output_type -> datanode.api.v2.ListAssetsResponse
	175, // 400: datanode.api.v2.TradingDataService.ListLiquidityProvisions:output_type -> datanode.api.v2.ListLiquidityProvisionsResponse
	179, // 401: datanode.api.v2.TradingDataService.ObserveLiquidityProvisions:output_type -> datanode.api.v2.ObserveLiquidityProvisionsResponse
	181, // 402: datanode.api.v2.TradingDataService.GetGovernanceData:output_type -> datanode.api.v2.GetGovernanceDataResponse
	183, // 403: datanode.api.v2.TradingDataService.GetProposal:output_type -> datanode.api.v2.GetProposalResponse
	190, // 404: datanode.api.v2.TradingDataService.ListGovernanceData:output_type -> datanode.api.v2.ListGovernanceDataResponse
	186, // 405: datanode.api.v2.TradingDataService.ListProposals:output_type -> datanode.api.v2.ListProposalsResponse
	194, // 406: datanode.api.v2.TradingDataService.ObserveGovernance:output_type -> datanode.api.v2.ObserveGovernanceResponse
	196, // 407: datanode.api.v2.TradingDataService.ListDelegations:output_type -> datanode.api.v2.ListDelegationsResponse
	200, // 408: datanode.api.v2.TradingDataService.ObserveDelegations:output_type -> datanode.api.v2.ObserveDelegationsResponse
	202, // 409: datanode.api.v2.TradingDataService.GetNetworkData:output_type -> datanode.api.v2.GetNetworkDataResponse
	204, // 410: datanode.api.v2.TradingDataService.GetNode:output_type -> datanode.api.v2.GetNodeResponse
	206, // 411: datanode.api.v2.TradingDataService.ListNodes:output_type -> datanode.api.v2.ListNodesResponse
	210, // 412: datanode.api.v2.TradingDataService.ListNodeSignatures:output_type -> datanode.api.v2.ListNodeSignaturesResponse
	214, // 413: datanode.api.v2.TradingDataService.GetEpoch:output_type -> datanode.api.v2.GetEpochResponse
	216, // 414: datanode.api.v2.TradingDataService.EstimateFee:output_type -> datanode.api.v2.EstimateFeeResponse
	218, // 415: datanode.api.v2.TradingDataService.EstimateMargin:output_type -> datanode.api.v2.EstimateMarginResponse
	220, // 416: datanode.api.v2.TradingDataService.ListNetworkParameters:output_type -> datanode.api.v2.ListNetworkParametersResponse
	222, // 417: datanode.api.v2.TradingDataService.GetNetworkParameter:output_type -> datanode.api.v2.GetNetworkParameterResponse
	227, // 418: datanode.api.v2.TradingDataService.ListCheckpoints:output_type -> datanode.api.v2.ListCheckpointsResponse
	231, // 419: datanode.api.v2.TradingDataService.GetStake:output_type -> datanode.api.v2.GetStakeResponse
	235, // 420: datanode.api.v2.TradingDataService.GetRiskFactors:output_type -> datanode.api.v2.GetRiskFactorsResponse
	237, // 421: datanode.api.v2.TradingDataService.ObserveEventBus:output_type -> datanode.api.v2.ObserveEventBusResponse
	239, // 422: datanode.api.v2.TradingDataService.ObserveLedgerMovements:output_type -> datanode.api.v2.ObserveLedgerMovementsResponse
	241, // 423: datanode.api.v2.TradingDataService.ListKeyRotations:output_type -> datanode.api.v2.ListKeyRotationsResponse
	245, // 424: datanode.api.v2.TradingDataService.ListEthereumKeyRotations:output_type -> datanode.api.v2.ListEthereumKeyRotationsResponse
	249, // 425: datanode.api.v2.TradingDataService.GetVegaTime:output_type -> datanode.api.v2.GetVegaTimeResponse
	252, // 426: datanode.api.v2.TradingDataService.GetProtocolUpgradeStatus:output_type -> datanode.api.v2.GetProtocolUpgradeStatusResponse
	254, // 427: datanode.api.v2.TradingDataService.ListProtocolUpgradeProposals:output_type -> datanode.api.v2.ListProtocolUpgradeProposalsResponse
	259, // 428: datanode.api.v2.TradingDataService.GetMostRecentDeHistorySegment:output_type -> datanode.api.v2.GetMostRecentDeHistorySegmentResponse
	261, // 429: datanode.api.v2.TradingDataService.ListAllDeHistorySegments:output_type -> datanode.api.v2.ListAllDeHistorySegmentsResponse
	263, // 430: datanode.api.v2.TradingDataService.FetchDeHistorySegment:output_type -> datanode.api.v2.FetchDeHistorySegmentResponse
	265, // 431: datanode.api.v2.TradingDataService.GetActiveDeHistoryPeerAddresses:output_type -> datanode.api.v2.GetActiveDeHistoryPeerAddressesResponse
	267, // 432: datanode.api.v2.TradingDataService.CopyHistorySegmentToFile:output_type -> datanode.api.v2.CopyHistorySegmentToFileResponse
	269, // 433: datanode.api.v2.TradingDataService.Ping:output_type -> datanode.api.v2.PingResponse
	349, // [349:434] is the sub-list for method output_type
	264, // [264:349] is the sub-list for method input_type
...
func file_data_node_api_v2_trading_data_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_data_node_api_v2_trading_data_proto_msgTypes[184].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ProposalsConnection); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
