Feature: Spot market
  ...
  Scenario: Double entry accounting is maintained at all points i.e. every transfer event has a source account and destination account
            and the balance of the source account before the transfer equals to the balance of source account minus the transfer amount
            after the transfer and balance of the destination account before the transfer plus the transfer amount equals to the balance
            of the destination account after the transfer. (0013-ACCT-024)
  ...
  Background:
    ...
    Then "party1" should have general account balance of "9990" for asset "ETH"
    ...
    Then the following transfers should happen:
      ...
      | party2 | party1  | ACCOUNT_TYPE_GENERAL    | ACCOUNT_TYPE_GENERAL             |           | 1      | BTC   |
      | party1 | party2  | ACCOUNT_TYPE_GENERAL    | ACCOUNT_TYPE_GENERAL             |           | 10     | ETH   |

    # party1 started with 9990 ETH but sold 9 to leave 9981
    ...
    # ETH = 9,981 + 18 + 1 = 10,000
    # BTC = 2 + 98 = 100
    Then "party1" should have general account balance of "9981" for asset "ETH"
    Then "party1" should have holding account balance of "0" for asset "ETH"
