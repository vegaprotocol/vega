...
var file_vega_vega_proto_msgTypes = make([]protoimpl.MessageInfo, 61)
var file_vega_vega_proto_goTypes = []interface{}{
	...
	(*IcebergOrder)(nil),                  // 23: vega.IcebergOrder
	(*Order)(nil),                         // 24: vega.Order
	(*OrderCancellationConfirmation)(nil), // 25: vega.OrderCancellationConfirmation
	(*OrderConfirmation)(nil),             // 26: vega.OrderConfirmation
	(*AuctionIndicativeState)(nil),        // 27: vega.AuctionIndicativeState
	(*Trade)(nil),                         // 28: vega.Trade
	(*Fee)(nil),                           // 29: vega.Fee
	(*TradeSet)(nil),                      // 30: vega.TradeSet
	(*Candle)(nil),                        // 31: vega.Candle
	(*PriceLevel)(nil),                    // 32: vega.PriceLevel
	(*MarketDepth)(nil),                   // 33: vega.MarketDepth
	(*MarketDepthUpdate)(nil),             // 34: vega.MarketDepthUpdate
	(*Position)(nil),                      // 35: vega.Position
	(*PositionTrade)(nil),                 // 36: vega.PositionTrade
	(*Deposit)(nil),                       // 37: vega.Deposit
	(*Withdrawal)(nil),                    // 38: vega.Withdrawal
	(*WithdrawExt)(nil),                   // 39: vega.WithdrawExt
	(*Erc20WithdrawExt)(nil),              // 40: vega.Erc20WithdrawExt
	(*Account)(nil),                       // 41: vega.Account
	(*FinancialAmount)(nil),               // 42: vega.FinancialAmount
	(*Transfer)(nil),                      // 43: vega.Transfer
	(*DispatchStrategy)(nil),              // 44: vega.DispatchStrategy
	(*TransferRequest)(nil),               // 45: vega.TransferRequest
	(*AccountDetails)(nil),                // 46: vega.AccountDetails
	(*LedgerEntry)(nil),                   // 47: vega.LedgerEntry
	(*PostTransferBalance)(nil),           // 48: vega.PostTransferBalance
	(*LedgerMovement)(nil),                // 49: vega.LedgerMovement
	(*MarginLevels)(nil),                  // 50: vega.MarginLevels
	(*MarketData)(nil),                    // 51: vega.MarketData
	(*LiquidityProviderFeeShare)(nil),     // 52: vega.LiquidityProviderFeeShare
	(*PriceMonitoringBounds)(nil),         // 53: vega.PriceMonitoringBounds
	(*ErrorDetail)(nil),                   // 54: vega.ErrorDetail
	(*NetworkParameter)(nil),              // 55: vega.NetworkParameter
	(*NetworkLimits)(nil),                 // 56: vega.NetworkLimits
	(*LiquidityOrder)(nil),                // 57: vega.LiquidityOrder
	(*LiquidityOrderReference)(nil),       // 58: vega.LiquidityOrderReference
	(*LiquidityProvision)(nil),            // 59: vega.LiquidityProvision
	(*EthereumConfig)(nil),                // 60: vega.EthereumConfig
	(*EthereumContractConfig)(nil),        // 61: vega.EthereumContractConfig
	(*EpochTimestamps)(nil),               // 62: vega.EpochTimestamps
	(*Epoch)(nil),                         // 63: vega.Epoch
	(*EpochParticipation)(nil),            // 64: vega.EpochParticipation
	(*EpochData)(nil),                     // 65: vega.EpochData
	(*RankingScore)(nil),                  // 66: vega.RankingScore
	(*RewardScore)(nil),                   // 67: vega.RewardScore
	(*Node)(nil),                          // 68: vega.Node
	(*NodeSet)(nil),                       // 69: vega.NodeSet
	(*NodeData)(nil),                      // 70: vega.NodeData
	(*Delegation)(nil),                    // 71: vega.Delegation
	(*Reward)(nil),                        // 72: vega.Reward
	(*RewardSummary)(nil),                 // 73: vega.RewardSummary
	(*EpochRewardSummary)(nil),            // 74: vega.EpochRewardSummary
	(*StateValueProposal)(nil),            // 75: vega.StateValueProposal
	(*KeyValueBundle)(nil),                // 76: vega.KeyValueBundle
	(*StateVarValue)(nil),                 // 77: vega.StateVarValue
	(*ScalarValue)(nil),                   // 78: vega.ScalarValue
	(*VectorValue)(nil),                   // 79: vega.VectorValue
	(*MatrixValue)(nil),                   // 80: vega.MatrixValue
	(Market_TradingMode)(0),               // 81: vega.Market.TradingMode
	(Market_State)(0),                     // 82: vega.Market.State
	(*PriceMonitoringTrigger)(nil),        // 83: vega.PriceMonitoringTrigger
}
var file_vega_vega_proto_depIdxs = []int32{
	...
	23, // 7: vega.Order.iceberg_order:type_name -> vega.IcebergOrder
	24, // 8: vega.OrderCancellationConfirmation.order:type_name -> vega.Order
	24, // 9: vega.OrderConfirmation.order:type_name -> vega.Order
	28, // 10: vega.OrderConfirmation.trades:type_name -> vega.Trade
	24, // 11: vega.OrderConfirmation.passive_orders_affected:type_name -> vega.Order
	0,  // 12: vega.Trade.aggressor:type_name -> vega.Side
	16, // 13: vega.Trade.type:type_name -> vega.Trade.Type
	29, // 14: vega.Trade.buyer_fee:type_name -> vega.Fee
	29, // 15: vega.Trade.seller_fee:type_name -> vega.Fee
	28, // 16: vega.TradeSet.trades:type_name -> vega.Trade
	1,  // 17: vega.Candle.interval:type_name -> vega.Interval
	32, // 18: vega.MarketDepth.buy:type_name -> vega.PriceLevel
	32, // 19: vega.MarketDepth.sell:type_name -> vega.PriceLevel
	32, // 20: vega.MarketDepthUpdate.buy:type_name -> vega.PriceLevel
	32, // 21: vega.MarketDepthUpdate.sell:type_name -> vega.PriceLevel
	...
	39, // 25: vega.Withdrawal.ext:type_name -> vega.WithdrawExt
	40, // 26: vega.WithdrawExt.erc20:type_name -> vega.Erc20WithdrawExt
	7,  // 27: vega.Account.type:type_name -> vega.AccountType
	42, // 28: vega.Transfer.amount:type_name -> vega.FinancialAmount
	8,  // 29: vega.Transfer.type:type_name -> vega.TransferType
	9,  // 30: vega.DispatchStrategy.metric:type_name -> vega.DispatchMetric
	41, // 31: vega.TransferRequest.from_account:type_name -> vega.Account
	41, // 32: vega.TransferRequest.to_account:type_name -> vega.Account
	8,  // 33: vega.TransferRequest.type:type_name -> vega.TransferType
	7,  // 34: vega.AccountDetails.type:type_name -> vega.AccountType
	46, // 35: vega.LedgerEntry.from_account:type_name -> vega.AccountDetails
	46, // 36: vega.LedgerEntry.to_account:type_name -> vega.AccountDetails
	8,  // 37: vega.LedgerEntry.type:type_name -> vega.TransferType
	46, // 38: vega.PostTransferBalance.account:type_name -> vega.AccountDetails
	47, // 39: vega.LedgerMovement.entries:type_name -> vega.LedgerEntry
	48, // 40: vega.LedgerMovement.balances:type_name -> vega.PostTransferBalance
	81, // 41: vega.MarketData.market_trading_mode:type_name -> vega.Market.TradingMode
	...
	53, // 44: vega.MarketData.price_monitoring_bounds:type_name -> vega.PriceMonitoringBounds
	52, // 45: vega.MarketData.liquidity_provider_fee_share:type_name -> vega.LiquidityProviderFeeShare
	82, // 46: vega.MarketData.market_state:type_name -> vega.Market.State
	83, // 47: vega.PriceMonitoringBounds.trigger:type_name -> vega.PriceMonitoringTrigger
	4,  // 48: vega.LiquidityOrder.reference:type_name -> vega.PeggedReference
	57, // 49: vega.LiquidityOrderReference.liquidity_order:type_name -> vega.LiquidityOrder
	58, // 50: vega.LiquidityProvision.sells:type_name -> vega.LiquidityOrderReference
	58, // 51: vega.LiquidityProvision.buys:type_name -> vega.LiquidityOrderReference
	19, // 52: vega.LiquidityProvision.status:type_name -> vega.LiquidityProvision.Status
	61, // 53: vega.EthereumConfig.collateral_bridge_contract:type_name -> vega.EthereumContractConfig
	61, // 54: vega.EthereumConfig.staking_bridge_contract:type_name -> vega.EthereumContractConfig
	61, // 55: vega.EthereumConfig.token_vesting_contract:type_name -> vega.EthereumContractConfig
	61, // 56: vega.EthereumConfig.multisig_control_contract:type_name -> vega.EthereumContractConfig
	62, // 57: vega.Epoch.timestamps:type_name -> vega.EpochTimestamps
	68, // 58: vega.Epoch.validators:type_name -> vega.Node
	71, // 59: vega.Epoch.delegations:type_name -> vega.Delegation
	63, // 60: vega.EpochParticipation.epoch:type_name -> vega.Epoch
	12, // 61: vega.RankingScore.previous_status:type_name -> vega.ValidatorNodeStatus
	12, // 62: vega.RankingScore.status:type_name -> vega.ValidatorNodeStatus
	12, // 63: vega.RewardScore.validator_status:type_name -> vega.ValidatorNodeStatus
	65, // 64: vega.Node.epoch_data:type_name -> vega.EpochData
	10, // 65: vega.Node.status:type_name -> vega.NodeStatus
	71, // 66: vega.Node.delegations:type_name -> vega.Delegation
	67, // 67: vega.Node.reward_score:type_name -> vega.RewardScore
	66, // 68: vega.Node.ranking_score:type_name -> vega.RankingScore
	69, // 69: vega.NodeData.tendermint_nodes:type_name -> vega.NodeSet
	69, // 70: vega.NodeData.ersatz_nodes:type_name -> vega.NodeSet
	69, // 71: vega.NodeData.pending_nodes:type_name -> vega.NodeSet
	76, // 72: vega.StateValueProposal.kvb:type_name -> vega.KeyValueBundle
	77, // 73: vega.KeyValueBundle.value:type_name -> vega.StateVarValue
	78, // 74: vega.StateVarValue.scalar_val:type_name -> vega.ScalarValue
	79, // 75: vega.StateVarValue.vector_val:type_name -> vega.VectorValue
	80, // 76: vega.StateVarValue.matrix_val:type_name -> vega.MatrixValue
	79, // 77: vega.MatrixValue.value:type_name -> vega.VectorValue
...
func file_vega_vega_proto_init() {
	...
	file_vega_vega_proto_msgTypes[49].OneofWrappers = []interface{}{}
