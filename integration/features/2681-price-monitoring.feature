Feature: Price monitoring test for issue 2681
  ...
  Background:
    ...
    And the execution engine have these markets:
      ...
      | ETH/DEC20 | ETH        | ETH   | forward    | 0.000001  | 0.00011407711613050422 | 0              | 0.016           | 0.8   | 1.4            | 1.2            | 1.1           | 1                | 0         | 0                  | 0             | 1                  | 43200          | 0.9999999   | 300             |                  | 0xDEADBEEF,0xCAFEDOOD | prices.ETH.value     | TYPE_INTEGER              | prices.ETH.value    |
