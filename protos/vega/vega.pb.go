...
var file_vega_vega_proto_rawDesc = []byte{
	...
	0x61, 0x6c, 0x75, 0x65, 0x2a, 0x39, 0x0a, 0x04, 0x53, 0x69, 0x64, 0x65, 0x12, 0x14, 0x0a, 0x10,
	...
	0x4e, 0x43, 0x45, 0x5f, 0x42, 0x45, 0x53, 0x54, 0x5f, 0x41, 0x53, 0x4b, 0x10, 0x03, 0x2a, 0xdf,
	...
	0x52, 0x53, 0x10, 0x30, 0x22, 0x04, 0x08, 0x26, 0x10, 0x26, 0x22, 0x04, 0x08, 0x27, 0x10, 0x27,
	...
	0x54, 0x45, 0x44, 0x10, 0x03, 0x2a, 0xc4, 0x04, 0x0a, 0x0b, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e,
	...
	0x53, 0x45, 0x52, 0x53, 0x10, 0x11, 0x22, 0x04, 0x08, 0x08, 0x10, 0x08, 0x2a, 0xc8, 0x06, 0x0a,
	...
	0x41, 0x53, 0x48, 0x49, 0x4e, 0x47, 0x10, 0x14, 0x12, 0x1e, 0x0a, 0x1a, 0x54, 0x52, 0x41, 0x4e,
	0x53, 0x46, 0x45, 0x52, 0x5f, 0x54, 0x59, 0x50, 0x45, 0x5f, 0x53, 0x54, 0x41, 0x4b, 0x45, 0x5f,
	0x52, 0x45, 0x57, 0x41, 0x52, 0x44, 0x10, 0x15, 0x12, 0x25, 0x0a, 0x21, 0x54, 0x52, 0x41, 0x4e,
	...
	0x45, 0x5f, 0x52, 0x45, 0x53, 0x54, 0x4f, 0x52, 0x45, 0x10, 0x19, 0x22, 0x04, 0x08, 0x03, 0x10,
...
var file_vega_vega_proto_msgTypes = make([]protoimpl.MessageInfo, 59)
var file_vega_vega_proto_goTypes = []interface{}{
	...
	(*NodeSet)(nil),                       // 67: vega.NodeSet
	(*NodeData)(nil),                      // 68: vega.NodeData
	(*Delegation)(nil),                    // 69: vega.Delegation
	(*Reward)(nil),                        // 70: vega.Reward
	(*RewardSummary)(nil),                 // 71: vega.RewardSummary
	(*StateValueProposal)(nil),            // 72: vega.StateValueProposal
	(*KeyValueBundle)(nil),                // 73: vega.KeyValueBundle
	(*StateVarValue)(nil),                 // 74: vega.StateVarValue
	(*ScalarValue)(nil),                   // 75: vega.ScalarValue
	(*VectorValue)(nil),                   // 76: vega.VectorValue
	(*MatrixValue)(nil),                   // 77: vega.MatrixValue
	(Market_TradingMode)(0),               // 78: vega.Market.TradingMode
	(Market_State)(0),                     // 79: vega.Market.State
	(*PriceMonitoringTrigger)(nil),        // 80: vega.PriceMonitoringTrigger
}
var file_vega_vega_proto_depIdxs = []int32{
	...
	78, // 39: vega.MarketData.market_trading_mode:type_name -> vega.Market.TradingMode
	...
	79, // 44: vega.MarketData.market_state:type_name -> vega.Market.State
	80, // 45: vega.PriceMonitoringBounds.trigger:type_name -> vega.PriceMonitoringTrigger
	...
	69, // 57: vega.Epoch.delegations:type_name -> vega.Delegation
	...
	69, // 64: vega.Node.delegations:type_name -> vega.Delegation
	65, // 65: vega.Node.reward_score:type_name -> vega.RewardScore
	64, // 66: vega.Node.ranking_score:type_name -> vega.RankingScore
	67, // 67: vega.NodeData.tendermint_nodes:type_name -> vega.NodeSet
	67, // 68: vega.NodeData.ersatz_nodes:type_name -> vega.NodeSet
	67, // 69: vega.NodeData.pending_nodes:type_name -> vega.NodeSet
	73, // 70: vega.StateValueProposal.kvb:type_name -> vega.KeyValueBundle
	74, // 71: vega.KeyValueBundle.value:type_name -> vega.StateVarValue
	75, // 72: vega.StateVarValue.scalar_val:type_name -> vega.ScalarValue
	76, // 73: vega.StateVarValue.vector_val:type_name -> vega.VectorValue
	77, // 74: vega.StateVarValue.matrix_val:type_name -> vega.MatrixValue
	76, // 75: vega.MatrixValue.value:type_name -> vega.VectorValue
