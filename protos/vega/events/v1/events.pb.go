...
var file_vega_events_v1_events_proto_rawDesc = []byte{
	...
	0x67, 0x72, 0x61, 0x64, 0x65, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x22, 0xc2, 0x1f, 0x0a, 0x08, 0x42,
	...
	0x44, 0x61, 0x74, 0x61, 0x4e, 0x6f, 0x64, 0x65, 0x52, 0x65, 0x61, 0x64, 0x79, 0x12, 0x36, 0x0a,
	...
	0xf5, 0x0f, 0x0a, 0x0c, 0x42, 0x75, 0x73, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x54, 0x79, 0x70, 0x65,
	...
	0x41, 0x5f, 0x4e, 0x4f, 0x44, 0x45, 0x5f, 0x52, 0x45, 0x41, 0x44, 0x59, 0x10, 0x37, 0x12, 0x19,
...
var file_vega_events_v1_events_proto_msgTypes = make([]protoimpl.MessageInfo, 43)
var file_vega_events_v1_events_proto_goTypes = []interface{}{
	...
	(*ProtocolUpgradeDataNodeReady)(nil),        // 44: vega.events.v1.ProtocolUpgradeDataNodeReady
	(*CoreSnapshotData)(nil),                    // 45: vega.events.v1.CoreSnapshotData
	(*BusEvent)(nil),                            // 46: vega.events.v1.BusEvent
	(*TransactionResult_SuccessDetails)(nil),    // 47: vega.events.v1.TransactionResult.SuccessDetails
	(*TransactionResult_FailureDetails)(nil),    // 48: vega.events.v1.TransactionResult.FailureDetails
	(vega.AccountType)(0),                       // 49: vega.AccountType
	(*vega.DispatchStrategy)(nil),               // 50: vega.DispatchStrategy
	(*v1.OrderSubmission)(nil),                  // 51: vega.commands.v1.OrderSubmission
	(*v1.OrderAmendment)(nil),                   // 52: vega.commands.v1.OrderAmendment
	(*v1.OrderCancellation)(nil),                // 53: vega.commands.v1.OrderCancellation
	(*v1.ProposalSubmission)(nil),               // 54: vega.commands.v1.ProposalSubmission
	(*v1.VoteSubmission)(nil),                   // 55: vega.commands.v1.VoteSubmission
	(*v1.LiquidityProvisionSubmission)(nil),     // 56: vega.commands.v1.LiquidityProvisionSubmission
	(*v1.WithdrawSubmission)(nil),               // 57: vega.commands.v1.WithdrawSubmission
	(*v1.DelegateSubmission)(nil),               // 58: vega.commands.v1.DelegateSubmission
	(*v1.UndelegateSubmission)(nil),             // 59: vega.commands.v1.UndelegateSubmission
	(*v1.LiquidityProvisionCancellation)(nil),   // 60: vega.commands.v1.LiquidityProvisionCancellation
	(*v1.LiquidityProvisionAmendment)(nil),      // 61: vega.commands.v1.LiquidityProvisionAmendment
	(*v1.Transfer)(nil),                         // 62: vega.commands.v1.Transfer
	(*v1.CancelTransfer)(nil),                   // 63: vega.commands.v1.CancelTransfer
	(*v1.AnnounceNode)(nil),                     // 64: vega.commands.v1.AnnounceNode
	(*v1.OracleDataSubmission)(nil),             // 65: vega.commands.v1.OracleDataSubmission
	(*v1.ProtocolUpgradeProposal)(nil),          // 66: vega.commands.v1.ProtocolUpgradeProposal
	(*v1.IssueSignatures)(nil),                  // 67: vega.commands.v1.IssueSignatures
	(*v1.BatchMarketInstructions)(nil),          // 68: vega.commands.v1.BatchMarketInstructions
	(*v1.KeyRotateSubmission)(nil),              // 69: vega.commands.v1.KeyRotateSubmission
	(*v1.EthereumKeyRotateSubmission)(nil),      // 70: vega.commands.v1.EthereumKeyRotateSubmission
	(vega.EpochAction)(0),                       // 71: vega.EpochAction
	(*vega.LedgerMovement)(nil),                 // 72: vega.LedgerMovement
	(vega.AuctionTrigger)(0),                    // 73: vega.AuctionTrigger
	(*vega.Order)(nil),                          // 74: vega.Order
	(*vega.Account)(nil),                        // 75: vega.Account
	(*vega.Party)(nil),                          // 76: vega.Party
	(*vega.Trade)(nil),                          // 77: vega.Trade
	(*vega.MarginLevels)(nil),                   // 78: vega.MarginLevels
	(*vega.Proposal)(nil),                       // 79: vega.Proposal
	(*vega.Vote)(nil),                           // 80: vega.Vote
	(*vega.MarketData)(nil),                     // 81: vega.MarketData
	(*v1.NodeSignature)(nil),                    // 82: vega.commands.v1.NodeSignature
	(*vega.Market)(nil),                         // 83: vega.Market
	(*vega.Asset)(nil),                          // 84: vega.Asset
	(*vega.Withdrawal)(nil),                     // 85: vega.Withdrawal
	(*vega.Deposit)(nil),                        // 86: vega.Deposit
	(*vega.RiskFactor)(nil),                     // 87: vega.RiskFactor
	(*vega.NetworkParameter)(nil),               // 88: vega.NetworkParameter
	(*vega.LiquidityProvision)(nil),             // 89: vega.LiquidityProvision
	(*vega.OracleSpec)(nil),                     // 90: vega.OracleSpec
	(*vega.OracleData)(nil),                     // 91: vega.OracleData
	(*vega.NetworkLimits)(nil),                  // 92: vega.NetworkLimits
}
var file_vega_events_v1_events_proto_depIdxs = []int32{
	...
	49,  // 1: vega.events.v1.Transfer.from_account_type:type_name -> vega.AccountType
	49,  // 2: vega.events.v1.Transfer.to_account_type:type_name -> vega.AccountType
	...
	50,  // 6: vega.events.v1.RecurringTransfer.dispatch_strategy:type_name -> vega.DispatchStrategy
	...
	51,  // 10: vega.events.v1.TransactionResult.order_submission:type_name -> vega.commands.v1.OrderSubmission
	52,  // 11: vega.events.v1.TransactionResult.order_amendment:type_name -> vega.commands.v1.OrderAmendment
	53,  // 12: vega.events.v1.TransactionResult.order_cancellation:type_name -> vega.commands.v1.OrderCancellation
	54,  // 13: vega.events.v1.TransactionResult.proposal:type_name -> vega.commands.v1.ProposalSubmission
	55,  // 14: vega.events.v1.TransactionResult.vote_submission:type_name -> vega.commands.v1.VoteSubmission
	56,  // 15: vega.events.v1.TransactionResult.liquidity_provision_submission:type_name -> vega.commands.v1.LiquidityProvisionSubmission
	57,  // 16: vega.events.v1.TransactionResult.withdraw_submission:type_name -> vega.commands.v1.WithdrawSubmission
	58,  // 17: vega.events.v1.TransactionResult.delegate_submission:type_name -> vega.commands.v1.DelegateSubmission
	59,  // 18: vega.events.v1.TransactionResult.undelegate_submission:type_name -> vega.commands.v1.UndelegateSubmission
	60,  // 19: vega.events.v1.TransactionResult.liquidity_provision_cancellation:type_name -> vega.commands.v1.LiquidityProvisionCancellation
	61,  // 20: vega.events.v1.TransactionResult.liquidity_provision_amendment:type_name -> vega.commands.v1.LiquidityProvisionAmendment
	62,  // 21: vega.events.v1.TransactionResult.transfer:type_name -> vega.commands.v1.Transfer
	63,  // 22: vega.events.v1.TransactionResult.cancel_transfer:type_name -> vega.commands.v1.CancelTransfer
	64,  // 23: vega.events.v1.TransactionResult.announce_node:type_name -> vega.commands.v1.AnnounceNode
	65,  // 24: vega.events.v1.TransactionResult.oracle_data_submission:type_name -> vega.commands.v1.OracleDataSubmission
	66,  // 25: vega.events.v1.TransactionResult.protocol_upgrade_proposal:type_name -> vega.commands.v1.ProtocolUpgradeProposal
	67,  // 26: vega.events.v1.TransactionResult.issue_signatures:type_name -> vega.commands.v1.IssueSignatures
	68,  // 27: vega.events.v1.TransactionResult.batch_market_instructions:type_name -> vega.commands.v1.BatchMarketInstructions
	69,  // 28: vega.events.v1.TransactionResult.key_rotate_submission:type_name -> vega.commands.v1.KeyRotateSubmission
	70,  // 29: vega.events.v1.TransactionResult.ethereum_key_rotate_submission:type_name -> vega.commands.v1.EthereumKeyRotateSubmission
	47,  // 30: vega.events.v1.TransactionResult.success:type_name -> vega.events.v1.TransactionResult.SuccessDetails
	48,  // 31: vega.events.v1.TransactionResult.failure:type_name -> vega.events.v1.TransactionResult.FailureDetails
	51,  // 32: vega.events.v1.TxErrorEvent.order_submission:type_name -> vega.commands.v1.OrderSubmission
	52,  // 33: vega.events.v1.TxErrorEvent.order_amendment:type_name -> vega.commands.v1.OrderAmendment
	53,  // 34: vega.events.v1.TxErrorEvent.order_cancellation:type_name -> vega.commands.v1.OrderCancellation
	54,  // 35: vega.events.v1.TxErrorEvent.proposal:type_name -> vega.commands.v1.ProposalSubmission
	55,  // 36: vega.events.v1.TxErrorEvent.vote_submission:type_name -> vega.commands.v1.VoteSubmission
	56,  // 37: vega.events.v1.TxErrorEvent.liquidity_provision_submission:type_name -> vega.commands.v1.LiquidityProvisionSubmission
	57,  // 38: vega.events.v1.TxErrorEvent.withdraw_submission:type_name -> vega.commands.v1.WithdrawSubmission
	58,  // 39: vega.events.v1.TxErrorEvent.delegate_submission:type_name -> vega.commands.v1.DelegateSubmission
	59,  // 40: vega.events.v1.TxErrorEvent.undelegate_submission:type_name -> vega.commands.v1.UndelegateSubmission
	60,  // 41: vega.events.v1.TxErrorEvent.liquidity_provision_cancellation:type_name -> vega.commands.v1.LiquidityProvisionCancellation
	61,  // 42: vega.events.v1.TxErrorEvent.liquidity_provision_amendment:type_name -> vega.commands.v1.LiquidityProvisionAmendment
	62,  // 43: vega.events.v1.TxErrorEvent.transfer:type_name -> vega.commands.v1.Transfer
	63,  // 44: vega.events.v1.TxErrorEvent.cancel_transfer:type_name -> vega.commands.v1.CancelTransfer
	64,  // 45: vega.events.v1.TxErrorEvent.announce_node:type_name -> vega.commands.v1.AnnounceNode
	65,  // 46: vega.events.v1.TxErrorEvent.oracle_data_submission:type_name -> vega.commands.v1.OracleDataSubmission
	66,  // 47: vega.events.v1.TxErrorEvent.protocol_upgrade_proposal:type_name -> vega.commands.v1.ProtocolUpgradeProposal
	67,  // 48: vega.events.v1.TxErrorEvent.issue_signatures:type_name -> vega.commands.v1.IssueSignatures
	68,  // 49: vega.events.v1.TxErrorEvent.batch_market_instructions:type_name -> vega.commands.v1.BatchMarketInstructions
	71,  // 50: vega.events.v1.EpochEvent.action:type_name -> vega.EpochAction
	72,  // 51: vega.events.v1.LedgerMovements.ledger_movements:type_name -> vega.LedgerMovement
	28,  // 52: vega.events.v1.SettlePosition.trade_settlements:type_name -> vega.events.v1.TradeSettlement
	73,  // 53: vega.events.v1.AuctionEvent.trigger:type_name -> vega.AuctionTrigger
	73,  // 54: vega.events.v1.AuctionEvent.extension_trigger:type_name -> vega.AuctionTrigger
	...
	74,  // 60: vega.events.v1.BusEvent.order:type_name -> vega.Order
	75,  // 61: vega.events.v1.BusEvent.account:type_name -> vega.Account
	76,  // 62: vega.events.v1.BusEvent.party:type_name -> vega.Party
	77,  // 63: vega.events.v1.BusEvent.trade:type_name -> vega.Trade
	78,  // 64: vega.events.v1.BusEvent.margin_levels:type_name -> vega.MarginLevels
	79,  // 65: vega.events.v1.BusEvent.proposal:type_name -> vega.Proposal
	80,  // 66: vega.events.v1.BusEvent.vote:type_name -> vega.Vote
	81,  // 67: vega.events.v1.BusEvent.market_data:type_name -> vega.MarketData
	82,  // 68: vega.events.v1.BusEvent.node_signature:type_name -> vega.commands.v1.NodeSignature
	...
	83,  // 72: vega.events.v1.BusEvent.market_created:type_name -> vega.Market
	84,  // 73: vega.events.v1.BusEvent.asset:type_name -> vega.Asset
	33,  // 74: vega.events.v1.BusEvent.market_tick:type_name -> vega.events.v1.MarketTick
	85,  // 75: vega.events.v1.BusEvent.withdrawal:type_name -> vega.Withdrawal
	86,  // 76: vega.events.v1.BusEvent.deposit:type_name -> vega.Deposit
	34,  // 77: vega.events.v1.BusEvent.auction:type_name -> vega.events.v1.AuctionEvent
	87,  // 78: vega.events.v1.BusEvent.risk_factor:type_name -> vega.RiskFactor
	88,  // 79: vega.events.v1.BusEvent.network_parameter:type_name -> vega.NetworkParameter
	89,  // 80: vega.events.v1.BusEvent.liquidity_provision:type_name -> vega.LiquidityProvision
	83,  // 81: vega.events.v1.BusEvent.market_updated:type_name -> vega.Market
	90,  // 82: vega.events.v1.BusEvent.oracle_spec:type_name -> vega.OracleSpec
	91,  // 83: vega.events.v1.BusEvent.oracle_data:type_name -> vega.OracleData
	...
	92,  // 93: vega.events.v1.BusEvent.network_limits:type_name -> vega.NetworkLimits
	...
	45,  // 108: vega.events.v1.BusEvent.core_snapshot_event:type_name -> vega.events.v1.CoreSnapshotData
	44,  // 109: vega.events.v1.BusEvent.protocol_upgrade_data_node_ready:type_name -> vega.events.v1.ProtocolUpgradeDataNodeReady
	20,  // 110: vega.events.v1.BusEvent.market:type_name -> vega.events.v1.MarketEvent
	22,  // 111: vega.events.v1.BusEvent.tx_err_event:type_name -> vega.events.v1.TxErrorEvent
