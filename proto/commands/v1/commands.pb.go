...
func (*OrderSubmission) Descriptor() ([]byte, []int) {
	return fileDescriptor_commands_a7c9f061fe422928, []int{0}
}
...
func (dst *OrderSubmission) XXX_Merge(src proto.Message) {
	xxx_messageInfo_OrderSubmission.Merge(dst, src)
}
...
func (*OrderCancellation) Descriptor() ([]byte, []int) {
	return fileDescriptor_commands_a7c9f061fe422928, []int{1}
}
...
func (*OrderAmendment) Descriptor() ([]byte, []int) {
	return fileDescriptor_commands_a7c9f061fe422928, []int{2}
}
...
func (dst *OrderAmendment) XXX_Merge(src proto.Message) {
	xxx_messageInfo_OrderAmendment.Merge(dst, src)
}
...
func (*LiquidityProvisionSubmission) Descriptor() ([]byte, []int) {
	return fileDescriptor_commands_a7c9f061fe422928, []int{3}
}
...
func (dst *LiquidityProvisionSubmission) XXX_Merge(src proto.Message) {
	xxx_messageInfo_LiquidityProvisionSubmission.Merge(dst, src)
}
...
func (*WithdrawSubmission) Descriptor() ([]byte, []int) {
	return fileDescriptor_commands_a7c9f061fe422928, []int{4}
}
...
func (dst *WithdrawSubmission) XXX_Merge(src proto.Message) {
	xxx_messageInfo_WithdrawSubmission.Merge(dst, src)
}
...
func (*ProposalSubmission) Descriptor() ([]byte, []int) {
	return fileDescriptor_commands_a7c9f061fe422928, []int{5}
}
...
func (dst *ProposalSubmission) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ProposalSubmission.Merge(dst, src)
}
...
func (*VoteSubmission) Descriptor() ([]byte, []int) {
	return fileDescriptor_commands_a7c9f061fe422928, []int{6}
}
...
func (dst *VoteSubmission) XXX_Merge(src proto.Message) {
	xxx_messageInfo_VoteSubmission.Merge(dst, src)
}
...
func init() {
	proto.RegisterFile("commands/v1/commands.proto", fileDescriptor_commands_a7c9f061fe422928)
}

var fileDescriptor_commands_a7c9f061fe422928 = []byte{
