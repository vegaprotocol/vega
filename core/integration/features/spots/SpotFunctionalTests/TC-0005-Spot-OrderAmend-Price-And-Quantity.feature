Feature: Amend the price and quantity amend to match and fill the order with counter party
  ...
  Background:
    ...
    And the parties place the following orders:
      ...
      | party1 | BTC/ETH   | buy  | 2      | 300   | 0                | TYPE_LIMIT | TIF_GTC | t1-b-1    |
      | party2 | BTC/ETH   | sell | 2      | 400   | 0                | TYPE_LIMIT | TIF_GTC | t2-s-1    |
    ...
    And the mark price should be "350" for the market "BTC/ETH"
