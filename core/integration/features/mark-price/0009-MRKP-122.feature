Feature: Test setting of mark price
  Background:
    ...
    And the markets:
      ...
      | ETH/FEB23 | ETH        | USD   | lqm-params           | simple-risk-model | default-margin-calculator | 1                | default-none | default-none     | default-eth-for-future | 0.25                   | 0                         | default-futures | weight     | 0.5          | 2           | 100000      | 0,1,0,0        | 6s,4s,24h0m0s,1h25m0s      | future      |
      | ETH/FEB22 | ETH        | USD   | lqm-params           | simple-risk-model | default-margin-calculator | 1                | default-none | default-none     | perp-oracle            | 0.25                   | 0                         | default-futures | weight     | 0.5          | 2           | 100000      | 0,1,0,0        | 6s,4s,24h0m0s,1h25m0s      | perp        |
  ...
  Scenario: 001 check mark price using order price with cash amount 100 USD
    ...
    And the parties place the following orders:
      ...
      | buySideProvider1  | ETH/FEB22 | buy  | 20     | 15000  | 0                | TYPE_LIMIT | TIF_GTC |           |
      | buySideProvider1  | ETH/FEB22 | buy  | 3      | 15900  | 0                | TYPE_LIMIT | TIF_GTC |           |
      | party1            | ETH/FEB22 | sell | 3      | 15900  | 0                | TYPE_LIMIT | TIF_GTC |           |
      | sellSideProvider1 | ETH/FEB22 | sell | 20     | 15940  | 0                | TYPE_LIMIT | TIF_GTC | sell-1-p  |
      | sellSideProvider1 | ETH/FEB22 | sell | 20     | 100100 | 0                | TYPE_LIMIT | TIF_GTC |           |

    #AC 0009-MRKP-122,0009-MRKP-123
    ...
    Then the mark price should be "15470" for the market "ETH/FEB22"
    ...
    Then the mark price should be "15845" for the market "ETH/FEB22"
