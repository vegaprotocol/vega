...
// Source: code.vegaprotocol.io/vega/core/datasource/external/ethverifier (interfaces: OracleDataBroadcaster)
...
func (m *MockOracleDataBroadcaster) BroadcastData(arg0 context.Context, arg1 common.Data) error {
	m.ctrl.T.Helper()
