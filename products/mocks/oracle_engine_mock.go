...
// Source: code.vegaprotocol.io/data-node/products (interfaces: OracleEngine)
...
import (
	...
	products "code.vegaprotocol.io/data-node/products"
	context "context"
...
func (m *MockOracleEngine) Subscribe(arg0 context.Context, arg1 oracles.OracleSpec, arg2 products.OnMatchedOracleData) products.SubscriptionID {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Subscribe", arg0, arg1, arg2)
	ret0, _ := ret[0].(products.SubscriptionID)
	return ret0
}
...
func (m *MockOracleEngine) Unsubscribe(arg0 context.Context, arg1 products.SubscriptionID) {
	m.ctrl.T.Helper()
