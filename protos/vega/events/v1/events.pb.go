...
var file_vega_events_v1_events_proto_rawDesc = []byte{
	...
	0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x22, 0xdd, 0x20, 0x0a, 0x08, 0x42, 0x75, 0x73, 0x45, 0x76, 0x65,
	...
	0x65, 0x72, 0x73, 0x12, 0x36, 0x0a, 0x06, 0x6d, 0x61, 0x72, 0x6b, 0x65, 0x74, 0x18, 0xe9, 0x07,
	...
	0x65, 0x76, 0x65, 0x6e, 0x74, 0x22, 0x49, 0x0a, 0x0d, 0x45, 0x78, 0x70, 0x69, 0x72, 0x65, 0x64,
	...
	0x2a, 0xc5, 0x10, 0x0a, 0x0c, 0x42, 0x75, 0x73, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x54, 0x79, 0x70,
...
var file_vega_events_v1_events_proto_msgTypes = make([]protoimpl.MessageInfo, 45)
var file_vega_events_v1_events_proto_goTypes = []interface{}{
	...
	(*ExpiredOrders)(nil),                       // 48: vega.events.v1.ExpiredOrders
	(*TransactionResult_SuccessDetails)(nil),    // 49: vega.events.v1.TransactionResult.SuccessDetails
	(*TransactionResult_FailureDetails)(nil),    // 50: vega.events.v1.TransactionResult.FailureDetails
	(vega.AccountType)(0),                       // 51: vega.AccountType
	(*vega.DispatchStrategy)(nil),               // 52: vega.DispatchStrategy
	(*v1.OrderSubmission)(nil),                  // 53: vega.commands.v1.OrderSubmission
	(*v1.OrderAmendment)(nil),                   // 54: vega.commands.v1.OrderAmendment
	(*v1.OrderCancellation)(nil),                // 55: vega.commands.v1.OrderCancellation
	(*v1.ProposalSubmission)(nil),               // 56: vega.commands.v1.ProposalSubmission
	(*v1.VoteSubmission)(nil),                   // 57: vega.commands.v1.VoteSubmission
	(*v1.LiquidityProvisionSubmission)(nil),     // 58: vega.commands.v1.LiquidityProvisionSubmission
	(*v1.WithdrawSubmission)(nil),               // 59: vega.commands.v1.WithdrawSubmission
	(*v1.DelegateSubmission)(nil),               // 60: vega.commands.v1.DelegateSubmission
	(*v1.UndelegateSubmission)(nil),             // 61: vega.commands.v1.UndelegateSubmission
	(*v1.LiquidityProvisionCancellation)(nil),   // 62: vega.commands.v1.LiquidityProvisionCancellation
	(*v1.LiquidityProvisionAmendment)(nil),      // 63: vega.commands.v1.LiquidityProvisionAmendment
	(*v1.Transfer)(nil),                         // 64: vega.commands.v1.Transfer
	(*v1.CancelTransfer)(nil),                   // 65: vega.commands.v1.CancelTransfer
	(*v1.AnnounceNode)(nil),                     // 66: vega.commands.v1.AnnounceNode
	(*v1.OracleDataSubmission)(nil),             // 67: vega.commands.v1.OracleDataSubmission
	(*v1.ProtocolUpgradeProposal)(nil),          // 68: vega.commands.v1.ProtocolUpgradeProposal
	(*v1.IssueSignatures)(nil),                  // 69: vega.commands.v1.IssueSignatures
	(*v1.BatchMarketInstructions)(nil),          // 70: vega.commands.v1.BatchMarketInstructions
	(*v1.KeyRotateSubmission)(nil),              // 71: vega.commands.v1.KeyRotateSubmission
	(*v1.EthereumKeyRotateSubmission)(nil),      // 72: vega.commands.v1.EthereumKeyRotateSubmission
	(vega.EpochAction)(0),                       // 73: vega.EpochAction
	(*vega.LedgerMovement)(nil),                 // 74: vega.LedgerMovement
	(vega.AuctionTrigger)(0),                    // 75: vega.AuctionTrigger
	(*vega.Order)(nil),                          // 76: vega.Order
	(*vega.Account)(nil),                        // 77: vega.Account
	(*vega.Party)(nil),                          // 78: vega.Party
	(*vega.Trade)(nil),                          // 79: vega.Trade
	(*vega.MarginLevels)(nil),                   // 80: vega.MarginLevels
	(*vega.Proposal)(nil),                       // 81: vega.Proposal
	(*vega.Vote)(nil),                           // 82: vega.Vote
	(*vega.MarketData)(nil),                     // 83: vega.MarketData
	(*v1.NodeSignature)(nil),                    // 84: vega.commands.v1.NodeSignature
	(*vega.Market)(nil),                         // 85: vega.Market
	(*vega.Asset)(nil),                          // 86: vega.Asset
	(*vega.Withdrawal)(nil),                     // 87: vega.Withdrawal
	(*vega.Deposit)(nil),                        // 88: vega.Deposit
	(*vega.RiskFactor)(nil),                     // 89: vega.RiskFactor
	(*vega.NetworkParameter)(nil),               // 90: vega.NetworkParameter
	(*vega.LiquidityProvision)(nil),             // 91: vega.LiquidityProvision
	(*vega.OracleSpec)(nil),                     // 92: vega.OracleSpec
	(*vega.OracleData)(nil),                     // 93: vega.OracleData
	(*vega.NetworkLimits)(nil),                  // 94: vega.NetworkLimits
}
var file_vega_events_v1_events_proto_depIdxs = []int32{
	...
	51,  // 1: vega.events.v1.Transfer.from_account_type:type_name -> vega.AccountType
	51,  // 2: vega.events.v1.Transfer.to_account_type:type_name -> vega.AccountType
	...
	52,  // 6: vega.events.v1.RecurringTransfer.dispatch_strategy:type_name -> vega.DispatchStrategy
	...
	53,  // 10: vega.events.v1.TransactionResult.order_submission:type_name -> vega.commands.v1.OrderSubmission
	54,  // 11: vega.events.v1.TransactionResult.order_amendment:type_name -> vega.commands.v1.OrderAmendment
	55,  // 12: vega.events.v1.TransactionResult.order_cancellation:type_name -> vega.commands.v1.OrderCancellation
	56,  // 13: vega.events.v1.TransactionResult.proposal:type_name -> vega.commands.v1.ProposalSubmission
	57,  // 14: vega.events.v1.TransactionResult.vote_submission:type_name -> vega.commands.v1.VoteSubmission
	58,  // 15: vega.events.v1.TransactionResult.liquidity_provision_submission:type_name -> vega.commands.v1.LiquidityProvisionSubmission
	59,  // 16: vega.events.v1.TransactionResult.withdraw_submission:type_name -> vega.commands.v1.WithdrawSubmission
	60,  // 17: vega.events.v1.TransactionResult.delegate_submission:type_name -> vega.commands.v1.DelegateSubmission
	61,  // 18: vega.events.v1.TransactionResult.undelegate_submission:type_name -> vega.commands.v1.UndelegateSubmission
	62,  // 19: vega.events.v1.TransactionResult.liquidity_provision_cancellation:type_name -> vega.commands.v1.LiquidityProvisionCancellation
	63,  // 20: vega.events.v1.TransactionResult.liquidity_provision_amendment:type_name -> vega.commands.v1.LiquidityProvisionAmendment
	64,  // 21: vega.events.v1.TransactionResult.transfer:type_name -> vega.commands.v1.Transfer
	65,  // 22: vega.events.v1.TransactionResult.cancel_transfer:type_name -> vega.commands.v1.CancelTransfer
	66,  // 23: vega.events.v1.TransactionResult.announce_node:type_name -> vega.commands.v1.AnnounceNode
	67,  // 24: vega.events.v1.TransactionResult.oracle_data_submission:type_name -> vega.commands.v1.OracleDataSubmission
	68,  // 25: vega.events.v1.TransactionResult.protocol_upgrade_proposal:type_name -> vega.commands.v1.ProtocolUpgradeProposal
	69,  // 26: vega.events.v1.TransactionResult.issue_signatures:type_name -> vega.commands.v1.IssueSignatures
	70,  // 27: vega.events.v1.TransactionResult.batch_market_instructions:type_name -> vega.commands.v1.BatchMarketInstructions
	71,  // 28: vega.events.v1.TransactionResult.key_rotate_submission:type_name -> vega.commands.v1.KeyRotateSubmission
	72,  // 29: vega.events.v1.TransactionResult.ethereum_key_rotate_submission:type_name -> vega.commands.v1.EthereumKeyRotateSubmission
	49,  // 30: vega.events.v1.TransactionResult.success:type_name -> vega.events.v1.TransactionResult.SuccessDetails
	50,  // 31: vega.events.v1.TransactionResult.failure:type_name -> vega.events.v1.TransactionResult.FailureDetails
	53,  // 32: vega.events.v1.TxErrorEvent.order_submission:type_name -> vega.commands.v1.OrderSubmission
	54,  // 33: vega.events.v1.TxErrorEvent.order_amendment:type_name -> vega.commands.v1.OrderAmendment
	55,  // 34: vega.events.v1.TxErrorEvent.order_cancellation:type_name -> vega.commands.v1.OrderCancellation
	56,  // 35: vega.events.v1.TxErrorEvent.proposal:type_name -> vega.commands.v1.ProposalSubmission
	57,  // 36: vega.events.v1.TxErrorEvent.vote_submission:type_name -> vega.commands.v1.VoteSubmission
	58,  // 37: vega.events.v1.TxErrorEvent.liquidity_provision_submission:type_name -> vega.commands.v1.LiquidityProvisionSubmission
	59,  // 38: vega.events.v1.TxErrorEvent.withdraw_submission:type_name -> vega.commands.v1.WithdrawSubmission
	60,  // 39: vega.events.v1.TxErrorEvent.delegate_submission:type_name -> vega.commands.v1.DelegateSubmission
	61,  // 40: vega.events.v1.TxErrorEvent.undelegate_submission:type_name -> vega.commands.v1.UndelegateSubmission
	62,  // 41: vega.events.v1.TxErrorEvent.liquidity_provision_cancellation:type_name -> vega.commands.v1.LiquidityProvisionCancellation
	63,  // 42: vega.events.v1.TxErrorEvent.liquidity_provision_amendment:type_name -> vega.commands.v1.LiquidityProvisionAmendment
	64,  // 43: vega.events.v1.TxErrorEvent.transfer:type_name -> vega.commands.v1.Transfer
	65,  // 44: vega.events.v1.TxErrorEvent.cancel_transfer:type_name -> vega.commands.v1.CancelTransfer
	66,  // 45: vega.events.v1.TxErrorEvent.announce_node:type_name -> vega.commands.v1.AnnounceNode
	67,  // 46: vega.events.v1.TxErrorEvent.oracle_data_submission:type_name -> vega.commands.v1.OracleDataSubmission
	68,  // 47: vega.events.v1.TxErrorEvent.protocol_upgrade_proposal:type_name -> vega.commands.v1.ProtocolUpgradeProposal
	69,  // 48: vega.events.v1.TxErrorEvent.issue_signatures:type_name -> vega.commands.v1.IssueSignatures
	70,  // 49: vega.events.v1.TxErrorEvent.batch_market_instructions:type_name -> vega.commands.v1.BatchMarketInstructions
	73,  // 50: vega.events.v1.EpochEvent.action:type_name -> vega.EpochAction
	74,  // 51: vega.events.v1.LedgerMovements.ledger_movements:type_name -> vega.LedgerMovement
	28,  // 52: vega.events.v1.SettlePosition.trade_settlements:type_name -> vega.events.v1.TradeSettlement
	75,  // 53: vega.events.v1.AuctionEvent.trigger:type_name -> vega.AuctionTrigger
	75,  // 54: vega.events.v1.AuctionEvent.extension_trigger:type_name -> vega.AuctionTrigger
	...
	76,  // 60: vega.events.v1.BusEvent.order:type_name -> vega.Order
	77,  // 61: vega.events.v1.BusEvent.account:type_name -> vega.Account
	78,  // 62: vega.events.v1.BusEvent.party:type_name -> vega.Party
	79,  // 63: vega.events.v1.BusEvent.trade:type_name -> vega.Trade
	80,  // 64: vega.events.v1.BusEvent.margin_levels:type_name -> vega.MarginLevels
	81,  // 65: vega.events.v1.BusEvent.proposal:type_name -> vega.Proposal
	82,  // 66: vega.events.v1.BusEvent.vote:type_name -> vega.Vote
	83,  // 67: vega.events.v1.BusEvent.market_data:type_name -> vega.MarketData
	84,  // 68: vega.events.v1.BusEvent.node_signature:type_name -> vega.commands.v1.NodeSignature
	...
	85,  // 72: vega.events.v1.BusEvent.market_created:type_name -> vega.Market
	86,  // 73: vega.events.v1.BusEvent.asset:type_name -> vega.Asset
	34,  // 74: vega.events.v1.BusEvent.market_tick:type_name -> vega.events.v1.MarketTick
	87,  // 75: vega.events.v1.BusEvent.withdrawal:type_name -> vega.Withdrawal
	88,  // 76: vega.events.v1.BusEvent.deposit:type_name -> vega.Deposit
	35,  // 77: vega.events.v1.BusEvent.auction:type_name -> vega.events.v1.AuctionEvent
	89,  // 78: vega.events.v1.BusEvent.risk_factor:type_name -> vega.RiskFactor
	90,  // 79: vega.events.v1.BusEvent.network_parameter:type_name -> vega.NetworkParameter
	91,  // 80: vega.events.v1.BusEvent.liquidity_provision:type_name -> vega.LiquidityProvision
	85,  // 81: vega.events.v1.BusEvent.market_updated:type_name -> vega.Market
	92,  // 82: vega.events.v1.BusEvent.oracle_spec:type_name -> vega.OracleSpec
	93,  // 83: vega.events.v1.BusEvent.oracle_data:type_name -> vega.OracleData
	...
	94,  // 93: vega.events.v1.BusEvent.network_limits:type_name -> vega.NetworkLimits
	...
	48,  // 111: vega.events.v1.BusEvent.expired_orders:type_name -> vega.events.v1.ExpiredOrders
	20,  // 112: vega.events.v1.BusEvent.market:type_name -> vega.events.v1.MarketEvent
	22,  // 113: vega.events.v1.BusEvent.tx_err_event:type_name -> vega.events.v1.TxErrorEvent
