...
type MarketStore interface {
	...
	ListSuccessorMarkets(ctx context.Context, marketID string, fullHistory bool, pagination entities.CursorPagination) ([]entities.Market, entities.PageInfo, error)
}
...
func (m *Markets) ListSuccessorMarkets(ctx context.Context, marketID string, childrenOnly bool, pagination entities.CursorPagination) ([]entities.Market, entities.PageInfo, error) {
