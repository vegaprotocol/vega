...
func buildPeggedOrder(reference types.PeggedReference, offset uint64) *types.PeggedOrder {
...
func TestParkingOrder(t *testing.T) {
	...
	order1 := buildOrder("Order1", types.SideBuy, types.OrderTypeLimit, 101, 10, 10)
	order1.PeggedOrder = buildPeggedOrder(types.PeggedReferenceBestBid, 1)
	event1 := events.NewOrderEvent(ctx, order1)
	mdb.Push(event1)

	// Park it
	order2 := buildOrder("Order1", types.SideBuy, types.OrderTypeLimit, 0, 10, 10)
	order2.PeggedOrder = buildPeggedOrder(types.PeggedReferenceBestBid, 1)
	...
	order3.PeggedOrder = buildPeggedOrder(types.PeggedReferenceBestBid, 1)
...
func TestParkedOrder2(t *testing.T) {
	...
	order5.PeggedOrder = buildPeggedOrder(types.PeggedReferenceBestBid, 1)
	...
	order7.PeggedOrder = buildPeggedOrder(types.PeggedReferenceBestBid, 1)
	...
	order10.PeggedOrder = buildPeggedOrder(types.PeggedReferenceBestBid, 1)
