...
// Source: code.vegaprotocol.io/vega/core/execution/liquidation (interfaces: Book,IDGen,Positions,PriceMonitor,AMM)
...
// GetVolumeAtPrice mocks base method.
func (m *MockAMM) GetVolumeAtPrice(arg0 *num.Uint, arg1 vega.Side) uint64 {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetVolumeAtPrice", arg0, arg1)
	ret0, _ := ret[0].(uint64)
	return ret0
...
func (mr *MockAMMMockRecorder) GetVolumeAtPrice(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetVolumeAtPrice", reflect.TypeOf((*MockAMM)(nil).GetVolumeAtPrice), arg0, arg1)
}
