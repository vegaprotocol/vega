Feature: Test closeout type 1: margin >= cost of closeout
  ...
  Scenario: case 1 (using simple risk model) from https://docs.google.com/spreadsheets/d/1CIPH0aQmIKj6YeFW9ApP_l-jwB4OcsNQ/edit#gid=1555964910 (0015-INSR-001, 0015-INSR-003, 0018-RSKM-001, 0018-RSKM-003, 0010-MARG-004, 0010-MARG-005, 0010-MARG-006, 0010-MARG-007, 0010-MARG-008. 0010-MARG-009)
    ...
    And the markets:
      ...
      | ETH/DEC19 | USD        | USD   | simple-risk-model-1 | margin-calculator-1 | 1                | default-none | default-none     | default-eth-for-future | 0.25                   | 0                         | default-futures |
    ...
    When the parties place the following orders:
      ...
      | lpprov | ETH/DEC19 | buy  | 1286   | 70    | 0                | TYPE_LIMIT | TIF_GTC | peg-1     |
      | lpprov | ETH/DEC19 | sell | 563    | 160   | 0                | TYPE_LIMIT | TIF_GTC | peg-2     |
    ...
    Then the parties should have the following margin levels:
      ...
      | party1 | ETH/DEC19 | 22500       |
      | party2 | ETH/DEC19 | 12500       |
    ...
    Then the parties place the following orders:
      | party  | market id | side | volume | price | resulting trades | type       | tif     | reference |
      | lpprov | ETH/DEC19 | buy  | 2286   | 70    | 0                | TYPE_LIMIT | TIF_GTC | peg-5     |
    ...
    Then the parties should have the following account balances:
      ...
      | party2           | USD   | ETH/DEC19 | 21500  | 49980100  |
      | party3           | USD   | ETH/DEC19 | 426    | 30061     |
    ...
    And the parties should have the following account balances:
      | party  | asset | market id | margin | general  |
      | party2 | USD   | ETH/DEC19 | 33312  | 49968288 |
      | party3 | USD   | ETH/DEC19 | 426    | 30061    |

    Then the parties should have the following margin levels:
      | party  | market id | maintenance |
      | party2 | ETH/DEC19 | 22208       |
      | party3 | ETH/DEC19 | 284         |
    ...
    And the insurance pool balance should be "38500" for the market "ETH/DEC19"
    Then the mark price should be "70" for the market "ETH/DEC19"
      # Then the order book should have the following volumes for market "ETH/DEC19":
      | side | price | volume |
      | sell | 500   | 1000   |
      | sell | 300   | 1      |
    ...
    And the parties should have the following account balances:
      | party  | asset | market id | margin | general  |
      | party2 | USD   | ETH/DEC19 | 18507  | 49977437 |
      | party3 | USD   | ETH/DEC19 | 12049  | 18144    |

    Then the parties should have the following margin levels:
      | party  | market id | maintenance |
      | party2 | ETH/DEC19 | 12338       |
      | party3 | ETH/DEC19 | 8033        |
...
#calculated risk factor long: 0.336895684; risk factor short: 0.4878731
    ...
    And the parties place the following pegged iceberg orders:
      ...
      | lpprov | ETH/DEC19 | 2280      | 1                    | buy  | BID              | 2280   | 10     |
      | lpprov | ETH/DEC19 | 400       | 1                    | sell | ASK              | 400    | 10     |
