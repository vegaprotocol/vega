...
const (
	...
	OrderError_INVALID_TYPE                OrderError = 19
)
...
const (
	...
	// good til cancelled
	Order_GTC Order_TimeInForce = 1
	// good til time
	Order_GTT Order_TimeInForce = 2
	// immediate or cancel
	Order_IOC Order_TimeInForce = 3
	// fill or kill
	Order_FOK Order_TimeInForce = 4
)
...
type OrderSubmission struct {
	...
	// Types that are valid to be assigned to TifOptions:
	//	*OrderSubmission_GtcOptions
	//	*OrderSubmission_GttOptions
	//	*OrderSubmission_IocOptions
	//	*OrderSubmission_FocOptions
	TifOptions           isOrderSubmission_TifOptions `protobuf_oneof:"tifOptions"`
	XXX_NoUnkeyedLiteral struct{}                     `json:"-"`
	XXX_unrecognized     []byte                       `json:"-"`
	XXX_sizecache        int32                        `json:"-"`
}
...
type isOrderSubmission_TifOptions interface {
	isOrderSubmission_TifOptions()
}

type OrderSubmission_GtcOptions struct {
	GtcOptions *GTCOptions `protobuf:"bytes,100,opt,name=gtcOptions,proto3,oneof"`
}

type OrderSubmission_GttOptions struct {
	GttOptions *GTTOptions `protobuf:"bytes,101,opt,name=gttOptions,proto3,oneof"`
}

type OrderSubmission_IocOptions struct {
	IocOptions *IOCOptions `protobuf:"bytes,102,opt,name=iocOptions,proto3,oneof"`
}

type OrderSubmission_FocOptions struct {
	FocOptions *FOKOptions `protobuf:"bytes,103,opt,name=focOptions,proto3,oneof"`
}

func (*OrderSubmission_GtcOptions) isOrderSubmission_TifOptions() {}

func (*OrderSubmission_GttOptions) isOrderSubmission_TifOptions() {}

func (*OrderSubmission_IocOptions) isOrderSubmission_TifOptions() {}

func (*OrderSubmission_FocOptions) isOrderSubmission_TifOptions() {}

func (m *OrderSubmission) GetTifOptions() isOrderSubmission_TifOptions {
	if m != nil {
		return m.TifOptions
	}
	return nil
...
func (m *OrderSubmission) GetGtcOptions() *GTCOptions {
	if x, ok := m.GetTifOptions().(*OrderSubmission_GtcOptions); ok {
		return x.GtcOptions
	}
	return nil
}

func (m *OrderSubmission) GetGttOptions() *GTTOptions {
	if x, ok := m.GetTifOptions().(*OrderSubmission_GttOptions); ok {
		return x.GttOptions
	}
	return nil
}

func (m *OrderSubmission) GetIocOptions() *IOCOptions {
	if x, ok := m.GetTifOptions().(*OrderSubmission_IocOptions); ok {
		return x.IocOptions
	}
	return nil
}

func (m *OrderSubmission) GetFocOptions() *FOKOptions {
	if x, ok := m.GetTifOptions().(*OrderSubmission_FocOptions); ok {
		return x.FocOptions
	}
	return nil
}
...
func (*OrderSubmission) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*OrderSubmission_GtcOptions)(nil),
		(*OrderSubmission_GttOptions)(nil),
		(*OrderSubmission_IocOptions)(nil),
		(*OrderSubmission_FocOptions)(nil),
	}
}

type GTCOptions struct {
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *GTCOptions) Reset()         { *m = GTCOptions{} }
func (m *GTCOptions) String() string { return proto.CompactTextString(m) }
func (*GTCOptions) ProtoMessage()    {}
func (*GTCOptions) Descriptor() ([]byte, []int) {
	return fileDescriptor_bb6b8173ee11af27, []int{21}
}

func (m *GTCOptions) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_GTCOptions.Unmarshal(m, b)
}
func (m *GTCOptions) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_GTCOptions.Marshal(b, m, deterministic)
}
func (m *GTCOptions) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GTCOptions.Merge(m, src)
}
func (m *GTCOptions) XXX_Size() int {
	return xxx_messageInfo_GTCOptions.Size(m)
}
func (m *GTCOptions) XXX_DiscardUnknown() {
	xxx_messageInfo_GTCOptions.DiscardUnknown(m)
}
...
func (m *GTTOptions) Reset()         { *m = GTTOptions{} }
func (m *GTTOptions) String() string { return proto.CompactTextString(m) }
func (*GTTOptions) ProtoMessage()    {}
func (*GTTOptions) Descriptor() ([]byte, []int) {
	return fileDescriptor_bb6b8173ee11af27, []int{22}
}

func (m *GTTOptions) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_GTTOptions.Unmarshal(m, b)
}
func (m *GTTOptions) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_GTTOptions.Marshal(b, m, deterministic)
}
func (m *GTTOptions) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GTTOptions.Merge(m, src)
}
func (m *GTTOptions) XXX_Size() int {
	return xxx_messageInfo_GTTOptions.Size(m)
}
func (m *GTTOptions) XXX_DiscardUnknown() {
	xxx_messageInfo_GTTOptions.DiscardUnknown(m)
}

var xxx_messageInfo_GTTOptions proto.InternalMessageInfo

func (m *GTTOptions) GetExpiresAt() int64 {
	if m != nil {
		return m.ExpiresAt
	}
	return 0
...
func (m *IOCOptions) Reset()         { *m = IOCOptions{} }
func (m *IOCOptions) String() string { return proto.CompactTextString(m) }
func (*IOCOptions) ProtoMessage()    {}
func (*IOCOptions) Descriptor() ([]byte, []int) {
	return fileDescriptor_bb6b8173ee11af27, []int{23}
}

func (m *IOCOptions) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_IOCOptions.Unmarshal(m, b)
}
func (m *IOCOptions) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_IOCOptions.Marshal(b, m, deterministic)
}
func (m *IOCOptions) XXX_Merge(src proto.Message) {
	xxx_messageInfo_IOCOptions.Merge(m, src)
}
func (m *IOCOptions) XXX_Size() int {
	return xxx_messageInfo_IOCOptions.Size(m)
}
func (m *IOCOptions) XXX_DiscardUnknown() {
	xxx_messageInfo_IOCOptions.DiscardUnknown(m)
}

var xxx_messageInfo_IOCOptions proto.InternalMessageInfo

type FOKOptions struct {
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *FOKOptions) Reset()         { *m = FOKOptions{} }
func (m *FOKOptions) String() string { return proto.CompactTextString(m) }
func (*FOKOptions) ProtoMessage()    {}
func (*FOKOptions) Descriptor() ([]byte, []int) {
	return fileDescriptor_bb6b8173ee11af27, []int{24}
}

func (m *FOKOptions) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_FOKOptions.Unmarshal(m, b)
}
func (m *FOKOptions) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_FOKOptions.Marshal(b, m, deterministic)
}
func (m *FOKOptions) XXX_Merge(src proto.Message) {
	xxx_messageInfo_FOKOptions.Merge(m, src)
}
func (m *FOKOptions) XXX_Size() int {
	return xxx_messageInfo_FOKOptions.Size(m)
}
func (m *FOKOptions) XXX_DiscardUnknown() {
	xxx_messageInfo_FOKOptions.DiscardUnknown(m)
}

var xxx_messageInfo_FOKOptions proto.InternalMessageInfo
...
func init() {
	...
	proto.RegisterType((*GTCOptions)(nil), "vega.GTCOptions")
	proto.RegisterType((*GTTOptions)(nil), "vega.GTTOptions")
	proto.RegisterType((*IOCOptions)(nil), "vega.IOCOptions")
	proto.RegisterType((*FOKOptions)(nil), "vega.FOKOptions")
...
var fileDescriptor_bb6b8173ee11af27 = []byte{
	...
	,
}
